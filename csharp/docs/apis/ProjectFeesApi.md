...
<a id="cancelpayout"></a>
# **CancelPayout**
> ApplyRoleFeaturePreset200Response CancelPayout (string payoutId, PlatformAdminDetachMemberRequest platformAdminDetachMemberRequest = null)
...
# **GetPendingPayouts**
> GetPendingPayouts200Response GetPendingPayouts (string status = null, string currency = null, int limit = null, int page = null)
...
# **ProcessPayout**
> ApplyRoleFeaturePreset200Response ProcessPayout (string payoutId)
