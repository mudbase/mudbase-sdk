# Mudbase.Sdk.Model.GetSupportedCurrencies200ResponseDataCurrenciesInner
...
**Networks** | **List&lt;string&gt;** | For USDT only; networks on which USDT is supported (ETH, BSC, TRX, SOL, POLYGON) | [optional] 
