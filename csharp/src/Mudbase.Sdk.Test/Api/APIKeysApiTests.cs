...
namespace Mudbase.Sdk.Test.Api
{
    ...
    public sealed class APIKeysApiTests : ApiTestsBase
    {
        ...
        public async Task CreateApiKeyAsyncTest()
        {
            ...
            var response = await _instance.CreateApiKeyAsync(createApiKeyRequest);
            var model = response.BadRequest();
            Assert.IsType<CreateApiKey400Response>(model);
        }
        ...
        {
            string id = default!;
            var response = await _instance.DeleteApiKeyAsync(id);
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetApiKeyUsageAsyncTest()
        {
            string id = default!;
            var response = await _instance.GetApiKeyUsageAsync(id);
            var model = response.Ok();
            Assert.IsType<ApiKeyUsageResponse>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task ListApiKeysAsyncTest()
        {
            var response = await _instance.ListApiKeysAsync();
            var model = response.Ok();
            Assert.IsType<ListApiKeys200Response>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task RegenerateApiKeyAsyncTest()
        {
            string id = default!;
            var response = await _instance.RegenerateApiKeyAsync(id);
            var model = response.Ok();
            Assert.IsType<RegenerateApiKey200Response>(model);
        }
        ...
        public async Task UpdateApiKeyAsyncTest()
        {
            ...
            var response = await _instance.UpdateApiKeyAsync(id, updateApiKeyRequest);
            var model = response.Ok();
            Assert.IsType<UpdateApiKey200Response>(model);
        }
    }
}
