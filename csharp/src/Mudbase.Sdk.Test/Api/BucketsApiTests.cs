...
namespace Mudbase.Sdk.Test.Api
{
    ...
    /// </summary>
    public sealed class BucketsApiTests : ApiTestsBase
    {
        private readonly IBucketsApi _instance;

        public BucketsApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IBucketsApi>();
        }
        ...
        public async Task CreateBucketAsyncTest()
        {
            ...
            var response = await _instance.CreateBucketAsync(projectId, createBucketRequest);
        ...
        public async Task DeleteBucketAsyncTest()
        {
            ...
            var response = await _instance.DeleteBucketAsync(projectId, bucketId);
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetBucketAsyncTest()
        {
            string projectId = default!;
            string bucketId = default!;
            var response = await _instance.GetBucketAsync(projectId, bucketId);
            var model = response.Ok();
            Assert.IsType<BucketResponse>(model);
        }
        ...
        public async Task ListBucketsAsyncTest()
        {
            ...
            var response = await _instance.ListBucketsAsync(projectId, page, limit, search);
            var model = response.Ok();
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task UpdateBucketAsyncTest()
        {
            string projectId = default!;
            string bucketId = default!;
            UpdateBucketRequest updateBucketRequest = default!;
            var response = await _instance.UpdateBucketAsync(projectId, bucketId, updateBucketRequest);
            var model = response.Ok();
            Assert.IsType<BucketResponse>(model);
        }
    }
