...
{
    /// <summary>
    ///  Class for testing BugAnalysisApi
    /// </summary>
    public sealed class BugAnalysisApiTests : ApiTestsBase
    {
        private readonly IBugAnalysisApi _instance;

        public BugAnalysisApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IBugAnalysisApi>();
        }

        /// <summary>
        /// Test StartBugAnalysisScan
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task StartBugAnalysisScanAsyncTest()
        {
            Client.Option<StartBugAnalysisScanRequest> startBugAnalysisScanRequest = default!;
            await _instance.StartBugAnalysisScanAsync(startBugAnalysisScanRequest);
        }

        /// <summary>
        /// Test StartBugAnalysisScanByProject
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task StartBugAnalysisScanByProjectAsyncTest()
        {
            string projectId = default!;
            Client.Option<StartBugAnalysisScanByProjectRequest> startBugAnalysisScanByProjectRequest = default!;
            await _instance.StartBugAnalysisScanByProjectAsync(projectId, startBugAnalysisScanByProjectRequest);
        }
    }
}
