...
namespace Mudbase.Sdk.Test.Api
{
    ...
    /// </summary>
    public sealed class ComplianceApiTests : ApiTestsBase
    {
        private readonly IComplianceApi _instance;

        public ComplianceApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IComplianceApi>();
        }
        ...
        public async Task ApiGdprErasePostAsyncTest()
        {
            ApiGdprErasePostRequest apiGdprErasePostRequest = default!;
            var response = await _instance.ApiGdprErasePostAsync(apiGdprErasePostRequest);
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task ApiGdprExportGetAsyncTest()
        {
            var response = await _instance.ApiGdprExportGetAsync();
            var model = response.Ok();
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GenerateAccessReviewAsyncTest()
        {
            GenerateAccessReviewRequest generateAccessReviewRequest = default!;
            var response = await _instance.GenerateAccessReviewAsync(generateAccessReviewRequest);
            var model = response.Ok();
            Assert.IsType<GenerateAccessReview200Response>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GenerateDataProcessingRecordAsyncTest()
        {
            GenerateDataProcessingRecordRequest generateDataProcessingRecordRequest = default!;
            var response = await _instance.GenerateDataProcessingRecordAsync(generateDataProcessingRecordRequest);
            var model = response.Ok();
            Assert.IsType<GenerateDataProcessingRecord200Response>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetComplianceSummaryAsyncTest()
        {
            var response = await _instance.GetComplianceSummaryAsync();
            var model = response.Ok();
            Assert.IsType<GetComplianceSummary200Response>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task LogSecurityEventAsyncTest()
        {
            LogSecurityEventRequest logSecurityEventRequest = default!;
            var response = await _instance.LogSecurityEventAsync(logSecurityEventRequest);
            var model = response.Ok();
            Assert.IsType<LogSecurityEvent200Response>(model);
        }
    }
}
