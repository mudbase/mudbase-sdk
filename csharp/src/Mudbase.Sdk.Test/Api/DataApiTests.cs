...
namespace Mudbase.Sdk.Test.Api
{
    ...
    public sealed class DataApiTests : ApiTestsBase
    {
        ...
        public async Task CreateDataAsyncTest()
        {
            ...
            Object body = default!;
            var response = await _instance.CreateDataAsync(projectId, collectionId, body);
        ...
        public async Task DeleteDataAsyncTest()
        {
            ...
            var response = await _instance.DeleteDataAsync(projectId, collectionId, documentId);
        ...
        public async Task GetDataAsyncTest()
        {
            ...
            string collectionId = default!;
            string documentId = default!;
            var response = await _instance.GetDataAsync(projectId, collectionId, documentId);
            var model = response.Ok();
            Assert.IsType<DataResponse>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task ListDataAsyncTest()
        {
            string projectId = default!;
            string collectionId = default!;
            ...
            var response = await _instance.ListDataAsync(projectId, collectionId, page, limit, sort, filter);
            var model = response.Ok();
        ...
        public async Task UpdateDataAsyncTest()
        {
            ...
            string documentId = default!;
            Object body = default!;
            var response = await _instance.UpdateDataAsync(projectId, collectionId, documentId, body);
            var model = response.Ok();
            Assert.IsType<DataResponse>(model);
        }
    }
