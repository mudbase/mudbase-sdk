...
namespace Mudbase.Sdk.Test.Api
{
    ...
    public sealed class SearchApiTests : ApiTestsBase
    {
        ...
        public async Task GetSearchAnalyticsAsyncTest()
        {
            string projectId = default!;
            Client.Option<string> timeframe = default!;
            var response = await _instance.GetSearchAnalyticsAsync(projectId, timeframe);
            var model = response.Ok();
            Assert.IsType<GetSearchAnalytics200Response>(model);
        }
        ...
        public async Task GetSearchSuggestionsAsyncTest()
        {
            ...
            var response = await _instance.GetSearchSuggestionsAsync(projectId, q, limit);
            var model = response.Ok();
            Assert.IsType<GetSearchSuggestions200Response>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task SearchDataAsyncTest()
        {
            string projectId = default!;
            string q = default!;
            Client.Option<string> collections = default!;
            Client.Option<string> fields = default!;
            Client.Option<int> limit = default!;
            Client.Option<int> page = default!;
            var response = await _instance.SearchDataAsync(projectId, q, collections, fields, limit, page);
            var model = response.Ok();
