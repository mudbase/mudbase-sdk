...
namespace Mudbase.Sdk.Test.Api
{
    ...
    public sealed class WebhooksApiTests : ApiTestsBase
    {
        ...
        /// <summary>
        /// Test ConfigureWebhook
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task ConfigureWebhookAsyncTest()
        {
            string projectId = default!;
            Client.Option<ConfigureWebhookRequest> configureWebhookRequest = default!;
            var response = await _instance.ConfigureWebhookAsync(projectId, configureWebhookRequest);
            var model = response.Ok();
            Assert.IsType<ConfigureWebhook200Response>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetWebhookConfigAsyncTest()
        {
            string projectId = default!;
            var response = await _instance.GetWebhookConfigAsync(projectId);
            var model = response.Ok();
            Assert.IsType<GetWebhookConfig200Response>(model);
        }

        /// <summary>
        /// Test GetWebhookStats
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetWebhookStatsAsyncTest()
        {
            Client.Option<string> projectId = default!;
            Client.Option<int> days = default!;
            var response = await _instance.GetWebhookStatsAsync(projectId, days);
            var model = response.Ok();
            Assert.IsType<WebhookStatsResponse>(model);
        }

        /// <summary>
        /// Test ListProjectWebhookLogs
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task ListProjectWebhookLogsAsyncTest()
        {
            string projectId = default!;
            ...
            var response = await _instance.ListProjectWebhookLogsAsync(projectId, page, limit, status, varEvent);
            var model = response.Ok();
            Assert.IsType<WebhookListResponse>(model);
        }
        ...
        public async Task ListWebhooksAsyncTest()
        {
            ...
            Client.Option<string> varEvent = default!;
            Client.Option<string> projectId = default!;
            var response = await _instance.ListWebhooksAsync(page, limit, status, varEvent, projectId);
            var model = response.Ok();
            Assert.IsType<WebhookListResponse>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task RetryWebhookAsyncTest()
        {
            string webhookId = default!;
            var response = await _instance.RetryWebhookAsync(webhookId);
            var model = response.Ok();
            Assert.IsType<RetryWebhookResponse>(model);
        }

        /// <summary>
        /// Test TestWebhookTransformation
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task TestWebhookTransformationAsyncTest()
        {
            string projectId = default!;
            TestWebhookTransformationRequest testWebhookTransformationRequest = default!;
            var response = await _instance.TestWebhookTransformationAsync(projectId, testWebhookTransformationRequest);
            var model = response.Ok();
            Assert.IsType<TestWebhookTransformation200Response>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task TriggerWebhookAsyncTest()
        {
            TriggerWebhookRequest triggerWebhookRequest = default!;
            var response = await _instance.TriggerWebhookAsync(triggerWebhookRequest);
            var model = response.Ok();
            Assert.IsType<TriggerWebhookResponse>(model);
        }
    }
}
