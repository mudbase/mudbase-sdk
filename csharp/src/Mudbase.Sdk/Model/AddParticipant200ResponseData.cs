...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class AddParticipant200ResponseData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddParticipant200ResponseData" /> class.
        /// </summary>
        /// <param name="participants">participants</param>
        [JsonConstructor]
        public AddParticipant200ResponseData(Option<List<AddParticipant200ResponseDataParticipantsInner>?> participants = default)
        {
        ...
        public Option<List<AddParticipant200ResponseDataParticipantsInner>?> ParticipantsOption { get; private set; }
    ...
    public partial class AddParticipant200ResponseDataJsonConverter : JsonConverter<AddParticipant200ResponseData>
    {
        ...
        public override AddParticipant200ResponseData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<AddParticipant200ResponseDataParticipantsInner>?> participants = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "participants":
                            participants = new Option<List<AddParticipant200ResponseDataParticipantsInner>?>(JsonSerializer.Deserialize<List<AddParticipant200ResponseDataParticipantsInner>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (participants.IsSet && participants.Value == null)
                throw new ArgumentNullException(nameof(participants), "Property is not nullable for class AddParticipant200ResponseData.");

            return new AddParticipant200ResponseData(participants);
        }

        /// <summary>
        /// Serializes a <see cref="AddParticipant200ResponseData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="addParticipant200ResponseData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, AddParticipant200ResponseData addParticipant200ResponseData, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, addParticipant200ResponseData, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="AddParticipant200ResponseData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="addParticipant200ResponseData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, AddParticipant200ResponseData addParticipant200ResponseData, JsonSerializerOptions jsonSerializerOptions)
        {
            if (addParticipant200ResponseData.ParticipantsOption.IsSet && addParticipant200ResponseData.Participants == null)
                throw new ArgumentNullException(nameof(addParticipant200ResponseData.Participants), "Property is required for class AddParticipant200ResponseData.");

            if (addParticipant200ResponseData.ParticipantsOption.IsSet)
            {
                writer.WritePropertyName("participants");
                JsonSerializer.Serialize(writer, addParticipant200ResponseData.Participants, jsonSerializerOptions);
            }
        }
    }
}
