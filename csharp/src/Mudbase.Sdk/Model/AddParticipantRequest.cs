...
namespace Mudbase.Sdk.Model
{
    ...
    public partial class AddParticipantRequest : IValidatableObject
    {
        ...
        [JsonConstructor]
        public AddParticipantRequest(string userId, Option<RoleEnum?> role = default)
        {
            UserId = userId;
            RoleOption = role;
            OnCreated();
    ...
    public partial class AddParticipantRequestJsonConverter : JsonConverter<AddParticipantRequest>
    {
        ...
        public override AddParticipantRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<AddParticipantRequest.RoleEnum?> role = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "role":
                            ...
                            if (roleRawValue != null)
                                role = new Option<AddParticipantRequest.RoleEnum?>(AddParticipantRequest.RoleEnumFromStringOrDefault(roleRawValue));
                            break;
                        default:
                            break;
                    }
            ...
            if (!userId.IsSet)
                throw new ArgumentException("Property is required for class AddParticipantRequest.", nameof(userId));

            if (userId.IsSet && userId.Value == null)
                throw new ArgumentNullException(nameof(userId), "Property is not nullable for class AddParticipantRequest.");

            if (role.IsSet && role.Value == null)
                throw new ArgumentNullException(nameof(role), "Property is not nullable for class AddParticipantRequest.");

            return new AddParticipantRequest(userId.Value!, role);
        }

        /// <summary>
        /// Serializes a <see cref="AddParticipantRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="addParticipantRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, AddParticipantRequest addParticipantRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, addParticipantRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="AddParticipantRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="addParticipantRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, AddParticipantRequest addParticipantRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (addParticipantRequest.UserId == null)
                throw new ArgumentNullException(nameof(addParticipantRequest.UserId), "Property is required for class AddParticipantRequest.");

            writer.WriteString("userId", addParticipantRequest.UserId);

            var roleRawValue = AddParticipantRequest.RoleEnumToJsonValue(addParticipantRequest.RoleOption.Value!.Value);
