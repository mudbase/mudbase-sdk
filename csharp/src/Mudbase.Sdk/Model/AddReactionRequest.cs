...
namespace Mudbase.Sdk.Model
{
    ...
    /// AddReactionRequest
    /// </summary>
    public partial class AddReactionRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddReactionRequest" /> class.
        /// </summary>
    ...
    public class AddReactionRequestJsonConverter : JsonConverter<AddReactionRequest>
    {
        ...
        public override AddReactionRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!emoji.IsSet)
                throw new ArgumentException("Property is required for class AddReactionRequest.", nameof(emoji));

            if (emoji.IsSet && emoji.Value == null)
                throw new ArgumentNullException(nameof(emoji), "Property is not nullable for class AddReactionRequest.");

            return new AddReactionRequest(emoji.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="AddReactionRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="addReactionRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, AddReactionRequest addReactionRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, addReactionRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="AddReactionRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="addReactionRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, AddReactionRequest addReactionRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (addReactionRequest.Emoji == null)
                throw new ArgumentNullException(nameof(addReactionRequest.Emoji), "Property is required for class AddReactionRequest.");

            writer.WriteString("emoji", addReactionRequest.Emoji);
        }
    }
}
