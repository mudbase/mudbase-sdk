...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class ApiAddonsGet200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiAddonsGet200Response" /> class.
        /// </summary>
        /// <param name="addons">addons</param>
        [JsonConstructor]
        public ApiAddonsGet200Response(Option<List<Object>?> addons = default)
        {
            AddonsOption = addons;
            OnCreated();
        }
        ...
        /// <summary>
        /// Used to track the state of Addons
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<Object>?> AddonsOption { get; private set; }
    ...
    public partial class ApiAddonsGet200ResponseJsonConverter : JsonConverter<ApiAddonsGet200Response>
    {
        ...
        public override ApiAddonsGet200Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<Object>?> addons = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "addons":
                            addons = new Option<List<Object>?>(JsonSerializer.Deserialize<List<Object>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (addons.IsSet && addons.Value == null)
                throw new ArgumentNullException(nameof(addons), "Property is not nullable for class ApiAddonsGet200Response.");

            return new ApiAddonsGet200Response(addons);
        }

        /// <summary>
        /// Serializes a <see cref="ApiAddonsGet200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="apiAddonsGet200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ApiAddonsGet200Response apiAddonsGet200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, apiAddonsGet200Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ApiAddonsGet200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="apiAddonsGet200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ApiAddonsGet200Response apiAddonsGet200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (apiAddonsGet200Response.AddonsOption.IsSet && apiAddonsGet200Response.Addons == null)
                throw new ArgumentNullException(nameof(apiAddonsGet200Response.Addons), "Property is required for class ApiAddonsGet200Response.");

            if (apiAddonsGet200Response.AddonsOption.IsSet)
            {
                writer.WritePropertyName("addons");
                JsonSerializer.Serialize(writer, apiAddonsGet200Response.Addons, jsonSerializerOptions);
            }
        }
    }
}
