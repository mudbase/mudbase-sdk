...
namespace Mudbase.Sdk.Model
{
    ...
    public partial class ApiKycSessionsPostRequest : IValidatableObject
    {
        ...
        [JsonConstructor]
        public ApiKycSessionsPostRequest(Option<string?> language = default)
        {
    ...
    public class ApiKycSessionsPostRequestJsonConverter : JsonConverter<ApiKycSessionsPostRequest>
    {
        ...
        public override ApiKycSessionsPostRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (language.IsSet && language.Value == null)
                throw new ArgumentNullException(nameof(language), "Property is not nullable for class ApiKycSessionsPostRequest.");

            return new ApiKycSessionsPostRequest(language);
        }

        /// <summary>
        /// Serializes a <see cref="ApiKycSessionsPostRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="apiKycSessionsPostRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ApiKycSessionsPostRequest apiKycSessionsPostRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, apiKycSessionsPostRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ApiKycSessionsPostRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="apiKycSessionsPostRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ApiKycSessionsPostRequest apiKycSessionsPostRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (apiKycSessionsPostRequest.LanguageOption.IsSet && apiKycSessionsPostRequest.Language == null)
                throw new ArgumentNullException(nameof(apiKycSessionsPostRequest.Language), "Property is required for class ApiKycSessionsPostRequest.");

            if (apiKycSessionsPostRequest.LanguageOption.IsSet)
                writer.WriteString("language", apiKycSessionsPostRequest.Language);
        }
    }
}
