...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class ApproveRoleElevation200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApproveRoleElevation200Response" /> class.
        /// </summary>
        /// <param name="message">message</param>
        /// <param name="request">request</param>
        [JsonConstructor]
        public ApproveRoleElevation200Response(Option<string?> message = default, Option<Object?> request = default)
        {
    ...
    public partial class ApproveRoleElevation200ResponseJsonConverter : JsonConverter<ApproveRoleElevation200Response>
    {
        ...
        public override ApproveRoleElevation200Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (message.IsSet && message.Value == null)
                throw new ArgumentNullException(nameof(message), "Property is not nullable for class ApproveRoleElevation200Response.");

            if (request.IsSet && request.Value == null)
                throw new ArgumentNullException(nameof(request), "Property is not nullable for class ApproveRoleElevation200Response.");

            return new ApproveRoleElevation200Response(message, request);
        }

        /// <summary>
        /// Serializes a <see cref="ApproveRoleElevation200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="approveRoleElevation200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ApproveRoleElevation200Response approveRoleElevation200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, approveRoleElevation200Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ApproveRoleElevation200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="approveRoleElevation200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ApproveRoleElevation200Response approveRoleElevation200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (approveRoleElevation200Response.MessageOption.IsSet && approveRoleElevation200Response.Message == null)
                throw new ArgumentNullException(nameof(approveRoleElevation200Response.Message), "Property is required for class ApproveRoleElevation200Response.");

            if (approveRoleElevation200Response.RequestOption.IsSet && approveRoleElevation200Response.Request == null)
                throw new ArgumentNullException(nameof(approveRoleElevation200Response.Request), "Property is required for class ApproveRoleElevation200Response.");

            if (approveRoleElevation200Response.MessageOption.IsSet)
                writer.WriteString("message", approveRoleElevation200Response.Message);

            if (approveRoleElevation200Response.RequestOption.IsSet)
            {
                writer.WritePropertyName("request");
                JsonSerializer.Serialize(writer, approveRoleElevation200Response.Request, jsonSerializerOptions);
            }
        }
    }
}
