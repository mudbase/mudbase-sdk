...
namespace Mudbase.Sdk.Model
{
    ...
    /// AssignRoleRequest
    /// </summary>
    public partial class AssignRoleRequest : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public AssignRoleRequest(string roleSlug)
        {
            RoleSlug = roleSlug;
            OnCreated();
        }
    ...
    public partial class AssignRoleRequestJsonConverter : JsonConverter<AssignRoleRequest>
    {
        ...
        public override AssignRoleRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!roleSlug.IsSet)
                throw new ArgumentException("Property is required for class AssignRoleRequest.", nameof(roleSlug));

            if (roleSlug.IsSet && roleSlug.Value == null)
                throw new ArgumentNullException(nameof(roleSlug), "Property is not nullable for class AssignRoleRequest.");

            return new AssignRoleRequest(roleSlug.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="AssignRoleRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="assignRoleRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, AssignRoleRequest assignRoleRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, assignRoleRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="AssignRoleRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="assignRoleRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, AssignRoleRequest assignRoleRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (assignRoleRequest.RoleSlug == null)
                throw new ArgumentNullException(nameof(assignRoleRequest.RoleSlug), "Property is required for class AssignRoleRequest.");

            writer.WriteString("roleSlug", assignRoleRequest.RoleSlug);
        }
    }
}
