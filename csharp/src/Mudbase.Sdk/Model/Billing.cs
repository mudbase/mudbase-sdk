...
namespace Mudbase.Sdk.Model
{
    ...
    public partial class Billing : IValidatableObject
    {
        ...
        [JsonConstructor]
        public Billing(Option<DateTime?> nextBillingDate = default, Option<string?> paymentMethod = default, Option<BillingLastPayment?> lastPayment = default)
        {
            NextBillingDateOption = nextBillingDate;
            PaymentMethodOption = paymentMethod;
            LastPaymentOption = lastPayment;
            OnCreated();
        }
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<BillingLastPayment?> LastPaymentOption { get; private set; }
    ...
    public partial class BillingJsonConverter : JsonConverter<Billing>
    {
        ...
        public override Billing Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<BillingLastPayment?> lastPayment = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "paymentMethod":
                            ...
                            break;
                        case "lastPayment":
                            lastPayment = new Option<BillingLastPayment?>(JsonSerializer.Deserialize<BillingLastPayment>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (nextBillingDate.IsSet && nextBillingDate.Value == null)
                throw new ArgumentNullException(nameof(nextBillingDate), "Property is not nullable for class Billing.");

            if (paymentMethod.IsSet && paymentMethod.Value == null)
                throw new ArgumentNullException(nameof(paymentMethod), "Property is not nullable for class Billing.");

            if (lastPayment.IsSet && lastPayment.Value == null)
                throw new ArgumentNullException(nameof(lastPayment), "Property is not nullable for class Billing.");

            return new Billing(nextBillingDate, paymentMethod, lastPayment);
        }

        /// <summary>
        /// Serializes a <see cref="Billing" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="billing"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, Billing billing, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, billing, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="Billing" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="billing"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, Billing billing, JsonSerializerOptions jsonSerializerOptions)
        {
            if (billing.PaymentMethodOption.IsSet && billing.PaymentMethod == null)
                throw new ArgumentNullException(nameof(billing.PaymentMethod), "Property is required for class Billing.");

            if (billing.LastPaymentOption.IsSet && billing.LastPayment == null)
                throw new ArgumentNullException(nameof(billing.LastPayment), "Property is required for class Billing.");

            if (billing.NextBillingDateOption.IsSet)
                writer.WriteString("nextBillingDate", billing.NextBillingDateOption.Value!.Value.ToString(NextBillingDateFormat));

            if (billing.PaymentMethodOption.IsSet)
                writer.WriteString("paymentMethod", billing.PaymentMethod);

            if (billing.LastPaymentOption.IsSet)
            {
                writer.WritePropertyName("lastPayment");
                JsonSerializer.Serialize(writer, billing.LastPayment, jsonSerializerOptions);
            }
        }
    }
}
