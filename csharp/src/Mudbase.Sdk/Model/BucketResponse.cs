...
namespace Mudbase.Sdk.Model
{
    ...
    public partial class BucketResponse : IValidatableObject
    {
        ...
        public Bucket? Bucket { get { return this.BucketOption.Value; } set { this.BucketOption = new(value); } }
    ...
    /// </summary>
    public partial class BucketResponseJsonConverter : JsonConverter<BucketResponse>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="BucketResponseJsonConverter" /> class.
        /// </summary>
        public BucketResponseJsonConverter()
        {
            OnCreated();
        }
