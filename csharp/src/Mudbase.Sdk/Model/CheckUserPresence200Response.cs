...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class CheckUserPresence200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CheckUserPresence200Response" /> class.
        /// </summary>
        /// <param name="presence">presence</param>
        /// <param name="timestamp">timestamp</param>
        [JsonConstructor]
        public CheckUserPresence200Response(Option<Dictionary<string, CheckUserPresence200ResponsePresenceValue>?> presence = default, Option<DateTime?> timestamp = default)
        {
        ...
        public Option<Dictionary<string, CheckUserPresence200ResponsePresenceValue>?> PresenceOption { get; private set; }
    ...
    public partial class CheckUserPresence200ResponseJsonConverter : JsonConverter<CheckUserPresence200Response>
    {
        ...
        public override CheckUserPresence200Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<Dictionary<string, CheckUserPresence200ResponsePresenceValue>?> presence = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "presence":
                            presence = new Option<Dictionary<string, CheckUserPresence200ResponsePresenceValue>?>(JsonSerializer.Deserialize<Dictionary<string, CheckUserPresence200ResponsePresenceValue>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "timestamp":
            ...
            if (presence.IsSet && presence.Value == null)
                throw new ArgumentNullException(nameof(presence), "Property is not nullable for class CheckUserPresence200Response.");

            if (timestamp.IsSet && timestamp.Value == null)
                throw new ArgumentNullException(nameof(timestamp), "Property is not nullable for class CheckUserPresence200Response.");

            return new CheckUserPresence200Response(presence, timestamp);
        }

        /// <summary>
        /// Serializes a <see cref="CheckUserPresence200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="checkUserPresence200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, CheckUserPresence200Response checkUserPresence200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, checkUserPresence200Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="CheckUserPresence200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="checkUserPresence200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, CheckUserPresence200Response checkUserPresence200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (checkUserPresence200Response.PresenceOption.IsSet && checkUserPresence200Response.Presence == null)
                throw new ArgumentNullException(nameof(checkUserPresence200Response.Presence), "Property is required for class CheckUserPresence200Response.");

            if (checkUserPresence200Response.PresenceOption.IsSet)
            {
                writer.WritePropertyName("presence");
                JsonSerializer.Serialize(writer, checkUserPresence200Response.Presence, jsonSerializerOptions);
            }
            if (checkUserPresence200Response.TimestampOption.IsSet)
                writer.WriteString("timestamp", checkUserPresence200Response.TimestampOption.Value!.Value.ToString(TimestampFormat));
        }
    }
}
