...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class ConfigureOAuthProvider200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConfigureOAuthProvider200Response" /> class.
        /// </summary>
        /// <param name="message">message</param>
        /// <param name="provider">provider</param>
        [JsonConstructor]
        public ConfigureOAuthProvider200Response(Option<string?> message = default, Option<ConfigureOAuthProvider200ResponseProvider?> provider = default)
        {
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<ConfigureOAuthProvider200ResponseProvider?> ProviderOption { get; private set; }
    ...
    public partial class ConfigureOAuthProvider200ResponseJsonConverter : JsonConverter<ConfigureOAuthProvider200Response>
    {
        ...
        public override ConfigureOAuthProvider200Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<ConfigureOAuthProvider200ResponseProvider?> provider = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "message":
                            ...
                            break;
                        case "provider":
                            provider = new Option<ConfigureOAuthProvider200ResponseProvider?>(JsonSerializer.Deserialize<ConfigureOAuthProvider200ResponseProvider>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (message.IsSet && message.Value == null)
                throw new ArgumentNullException(nameof(message), "Property is not nullable for class ConfigureOAuthProvider200Response.");

            if (provider.IsSet && provider.Value == null)
                throw new ArgumentNullException(nameof(provider), "Property is not nullable for class ConfigureOAuthProvider200Response.");

            return new ConfigureOAuthProvider200Response(message, provider);
        }

        /// <summary>
        /// Serializes a <see cref="ConfigureOAuthProvider200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="configureOAuthProvider200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ConfigureOAuthProvider200Response configureOAuthProvider200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, configureOAuthProvider200Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ConfigureOAuthProvider200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="configureOAuthProvider200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ConfigureOAuthProvider200Response configureOAuthProvider200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (configureOAuthProvider200Response.MessageOption.IsSet && configureOAuthProvider200Response.Message == null)
                throw new ArgumentNullException(nameof(configureOAuthProvider200Response.Message), "Property is required for class ConfigureOAuthProvider200Response.");

            if (configureOAuthProvider200Response.ProviderOption.IsSet && configureOAuthProvider200Response.Provider == null)
                throw new ArgumentNullException(nameof(configureOAuthProvider200Response.Provider), "Property is required for class ConfigureOAuthProvider200Response.");

            if (configureOAuthProvider200Response.MessageOption.IsSet)
                writer.WriteString("message", configureOAuthProvider200Response.Message);

            if (configureOAuthProvider200Response.ProviderOption.IsSet)
            {
                writer.WritePropertyName("provider");
                JsonSerializer.Serialize(writer, configureOAuthProvider200Response.Provider, jsonSerializerOptions);
            }
        }
    }
}
