...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class ConfirmAddressVerificationRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConfirmAddressVerificationRequest" /> class.
        /// </summary>
        /// <param name="txHash">txHash</param>
        [JsonConstructor]
        public ConfirmAddressVerificationRequest(string txHash)
        {
            TxHash = txHash;
            OnCreated();
        }
    ...
    public partial class ConfirmAddressVerificationRequestJsonConverter : JsonConverter<ConfirmAddressVerificationRequest>
    {
        ...
        public override ConfirmAddressVerificationRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!txHash.IsSet)
                throw new ArgumentException("Property is required for class ConfirmAddressVerificationRequest.", nameof(txHash));

            if (txHash.IsSet && txHash.Value == null)
                throw new ArgumentNullException(nameof(txHash), "Property is not nullable for class ConfirmAddressVerificationRequest.");

            return new ConfirmAddressVerificationRequest(txHash.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="ConfirmAddressVerificationRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="confirmAddressVerificationRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ConfirmAddressVerificationRequest confirmAddressVerificationRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, confirmAddressVerificationRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ConfirmAddressVerificationRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="confirmAddressVerificationRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ConfirmAddressVerificationRequest confirmAddressVerificationRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (confirmAddressVerificationRequest.TxHash == null)
                throw new ArgumentNullException(nameof(confirmAddressVerificationRequest.TxHash), "Property is required for class ConfirmAddressVerificationRequest.");

            writer.WriteString("txHash", confirmAddressVerificationRequest.TxHash);
        }
    }
}
