...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class CreateApiKey400Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateApiKey400Response" /> class.
        /// </summary>
        /// <param name="error">error</param>
        /// <param name="details">details</param>
        [JsonConstructor]
        public CreateApiKey400Response(Option<string?> error = default, Option<List<string>?> details = default)
        {
            ErrorOption = error;
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<string>?> DetailsOption { get; private set; }
    ...
    public partial class CreateApiKey400ResponseJsonConverter : JsonConverter<CreateApiKey400Response>
    {
        ...
        public override CreateApiKey400Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<string>?> details = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "error":
                            ...
                            break;
                        case "details":
                            details = new Option<List<string>?>(JsonSerializer.Deserialize<List<string>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (error.IsSet && error.Value == null)
                throw new ArgumentNullException(nameof(error), "Property is not nullable for class CreateApiKey400Response.");

            if (details.IsSet && details.Value == null)
                throw new ArgumentNullException(nameof(details), "Property is not nullable for class CreateApiKey400Response.");

            return new CreateApiKey400Response(error, details);
        }

        /// <summary>
        /// Serializes a <see cref="CreateApiKey400Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="createApiKey400Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, CreateApiKey400Response createApiKey400Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, createApiKey400Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="CreateApiKey400Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="createApiKey400Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, CreateApiKey400Response createApiKey400Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (createApiKey400Response.ErrorOption.IsSet && createApiKey400Response.Error == null)
                throw new ArgumentNullException(nameof(createApiKey400Response.Error), "Property is required for class CreateApiKey400Response.");

            if (createApiKey400Response.DetailsOption.IsSet && createApiKey400Response.Details == null)
                throw new ArgumentNullException(nameof(createApiKey400Response.Details), "Property is required for class CreateApiKey400Response.");

            if (createApiKey400Response.ErrorOption.IsSet)
                writer.WriteString("error", createApiKey400Response.Error);

            if (createApiKey400Response.DetailsOption.IsSet)
            {
                writer.WritePropertyName("details");
                JsonSerializer.Serialize(writer, createApiKey400Response.Details, jsonSerializerOptions);
            }
        }
    }
}
