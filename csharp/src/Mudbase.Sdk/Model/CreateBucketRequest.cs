...
namespace Mudbase.Sdk.Model
{
    ...
    public partial class CreateBucketRequest : IValidatableObject
    {
        ...
        [JsonConstructor]
        public CreateBucketRequest(string name, Option<bool?> isPublic = default, Option<Object?> settings = default)
        {
            Name = name;
    ...
    public partial class CreateBucketRequestJsonConverter : JsonConverter<CreateBucketRequest>
    {
        ...
        public override CreateBucketRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!name.IsSet)
                throw new ArgumentException("Property is required for class CreateBucketRequest.", nameof(name));

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class CreateBucketRequest.");

            if (isPublic.IsSet && isPublic.Value == null)
                throw new ArgumentNullException(nameof(isPublic), "Property is not nullable for class CreateBucketRequest.");

            if (settings.IsSet && settings.Value == null)
                throw new ArgumentNullException(nameof(settings), "Property is not nullable for class CreateBucketRequest.");

            return new CreateBucketRequest(name.Value!, isPublic, settings);
        }

        /// <summary>
        /// Serializes a <see cref="CreateBucketRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="createBucketRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, CreateBucketRequest createBucketRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, createBucketRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="CreateBucketRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="createBucketRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, CreateBucketRequest createBucketRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (createBucketRequest.Name == null)
                throw new ArgumentNullException(nameof(createBucketRequest.Name), "Property is required for class CreateBucketRequest.");

            if (createBucketRequest.SettingsOption.IsSet && createBucketRequest.Settings == null)
                throw new ArgumentNullException(nameof(createBucketRequest.Settings), "Property is required for class CreateBucketRequest.");

            writer.WriteString("name", createBucketRequest.Name);

            if (createBucketRequest.IsPublicOption.IsSet)
                writer.WriteBoolean("isPublic", createBucketRequest.IsPublicOption.Value!.Value);

            if (createBucketRequest.SettingsOption.IsSet)
            {
                writer.WritePropertyName("settings");
                JsonSerializer.Serialize(writer, createBucketRequest.Settings, jsonSerializerOptions);
            }
        }
    }
}
