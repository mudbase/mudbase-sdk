...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class CreateCheckoutSessionRequestCustomerInfo : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateCheckoutSessionRequestCustomerInfo" /> class.
        /// </summary>
        /// <param name="email">email</param>
        /// <param name="name">name</param>
        [JsonConstructor]
        public CreateCheckoutSessionRequestCustomerInfo(string email, Option<string?> name = default)
        {
            Email = email;
            NameOption = name;
            OnCreated();
    ...
    public partial class CreateCheckoutSessionRequestCustomerInfoJsonConverter : JsonConverter<CreateCheckoutSessionRequestCustomerInfo>
    {
        ...
        public override CreateCheckoutSessionRequestCustomerInfo Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!email.IsSet)
                throw new ArgumentException("Property is required for class CreateCheckoutSessionRequestCustomerInfo.", nameof(email));

            if (email.IsSet && email.Value == null)
                throw new ArgumentNullException(nameof(email), "Property is not nullable for class CreateCheckoutSessionRequestCustomerInfo.");

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class CreateCheckoutSessionRequestCustomerInfo.");

            return new CreateCheckoutSessionRequestCustomerInfo(email.Value!, name);
        }

        /// <summary>
        /// Serializes a <see cref="CreateCheckoutSessionRequestCustomerInfo" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="createCheckoutSessionRequestCustomerInfo"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, CreateCheckoutSessionRequestCustomerInfo createCheckoutSessionRequestCustomerInfo, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, createCheckoutSessionRequestCustomerInfo, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="CreateCheckoutSessionRequestCustomerInfo" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="createCheckoutSessionRequestCustomerInfo"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, CreateCheckoutSessionRequestCustomerInfo createCheckoutSessionRequestCustomerInfo, JsonSerializerOptions jsonSerializerOptions)
        {
            if (createCheckoutSessionRequestCustomerInfo.Email == null)
                throw new ArgumentNullException(nameof(createCheckoutSessionRequestCustomerInfo.Email), "Property is required for class CreateCheckoutSessionRequestCustomerInfo.");

            if (createCheckoutSessionRequestCustomerInfo.NameOption.IsSet && createCheckoutSessionRequestCustomerInfo.Name == null)
                throw new ArgumentNullException(nameof(createCheckoutSessionRequestCustomerInfo.Name), "Property is required for class CreateCheckoutSessionRequestCustomerInfo.");

            writer.WriteString("email", createCheckoutSessionRequestCustomerInfo.Email);

            if (createCheckoutSessionRequestCustomerInfo.NameOption.IsSet)
                writer.WriteString("name", createCheckoutSessionRequestCustomerInfo.Name);
        }
    }
}
