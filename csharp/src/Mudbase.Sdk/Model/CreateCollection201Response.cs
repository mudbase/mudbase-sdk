...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class CreateCollection201Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateCollection201Response" /> class.
        /// </summary>
        /// <param name="message">message</param>
        /// <param name="collection">collection</param>
        [JsonConstructor]
        public CreateCollection201Response(Option<string?> message = default, Option<Collection?> collection = default)
        {
    ...
    public class CreateCollection201ResponseJsonConverter : JsonConverter<CreateCollection201Response>
    {
        ...
        public override CreateCollection201Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (message.IsSet && message.Value == null)
                throw new ArgumentNullException(nameof(message), "Property is not nullable for class CreateCollection201Response.");

            if (collection.IsSet && collection.Value == null)
                throw new ArgumentNullException(nameof(collection), "Property is not nullable for class CreateCollection201Response.");

            return new CreateCollection201Response(message, collection);
        }

        /// <summary>
        /// Serializes a <see cref="CreateCollection201Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="createCollection201Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, CreateCollection201Response createCollection201Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, createCollection201Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="CreateCollection201Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="createCollection201Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, CreateCollection201Response createCollection201Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (createCollection201Response.MessageOption.IsSet && createCollection201Response.Message == null)
                throw new ArgumentNullException(nameof(createCollection201Response.Message), "Property is required for class CreateCollection201Response.");

            if (createCollection201Response.CollectionOption.IsSet && createCollection201Response.Collection == null)
                throw new ArgumentNullException(nameof(createCollection201Response.Collection), "Property is required for class CreateCollection201Response.");

            if (createCollection201Response.MessageOption.IsSet)
                writer.WriteString("message", createCollection201Response.Message);

            if (createCollection201Response.CollectionOption.IsSet)
            {
                writer.WritePropertyName("collection");
                JsonSerializer.Serialize(writer, createCollection201Response.Collection, jsonSerializerOptions);
            }
        }
    }
}
