...
namespace Mudbase.Sdk.Model
{
    ...
    public partial class CreateOrganizationRequest : IValidatableObject
    {
        ...
        [JsonConstructor]
        public CreateOrganizationRequest(string name, Option<string?> description = default, Option<string?> logo = default, Option<string?> website = default, Option<string?> parentOrgId = default)
        {
            Name = name;
            DescriptionOption = description;
            LogoOption = logo;
            WebsiteOption = website;
            ParentOrgIdOption = parentOrgId;
            OnCreated();
        }
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<string?> ParentOrgIdOption { get; private set; }
    ...
    public partial class CreateOrganizationRequestJsonConverter : JsonConverter<CreateOrganizationRequest>
    {
        ...
        public override CreateOrganizationRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<string?> parentOrgId = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "website":
                            ...
                            break;
                        case "parentOrgId":
                            parentOrgId = new Option<string?>(utf8JsonReader.GetString()!);
                            break;
                        default:
                            break;
                    }
            ...
            if (description.IsSet && description.Value == null)
                throw new ArgumentNullException(nameof(description), "Property is not nullable for class CreateOrganizationRequest.");

            if (logo.IsSet && logo.Value == null)
                throw new ArgumentNullException(nameof(logo), "Property is not nullable for class CreateOrganizationRequest.");

            if (website.IsSet && website.Value == null)
                throw new ArgumentNullException(nameof(website), "Property is not nullable for class CreateOrganizationRequest.");

            if (parentOrgId.IsSet && parentOrgId.Value == null)
                throw new ArgumentNullException(nameof(parentOrgId), "Property is not nullable for class CreateOrganizationRequest.");

            return new CreateOrganizationRequest(name.Value!, description, logo, website, parentOrgId);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, CreateOrganizationRequest createOrganizationRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (createOrganizationRequest.DescriptionOption.IsSet && createOrganizationRequest.Description == null)
                throw new ArgumentNullException(nameof(createOrganizationRequest.Description), "Property is required for class CreateOrganizationRequest.");

            if (createOrganizationRequest.LogoOption.IsSet && createOrganizationRequest.Logo == null)
                throw new ArgumentNullException(nameof(createOrganizationRequest.Logo), "Property is required for class CreateOrganizationRequest.");

            if (createOrganizationRequest.WebsiteOption.IsSet && createOrganizationRequest.Website == null)
                throw new ArgumentNullException(nameof(createOrganizationRequest.Website), "Property is required for class CreateOrganizationRequest.");

            if (createOrganizationRequest.ParentOrgIdOption.IsSet && createOrganizationRequest.ParentOrgId == null)
                throw new ArgumentNullException(nameof(createOrganizationRequest.ParentOrgId), "Property is required for class CreateOrganizationRequest.");

            writer.WriteString("name", createOrganizationRequest.Name);

            if (createOrganizationRequest.DescriptionOption.IsSet)
                writer.WriteString("description", createOrganizationRequest.Description);

            if (createOrganizationRequest.LogoOption.IsSet)
                writer.WriteString("logo", createOrganizationRequest.Logo);

            if (createOrganizationRequest.WebsiteOption.IsSet)
                writer.WriteString("website", createOrganizationRequest.Website);

            if (createOrganizationRequest.ParentOrgIdOption.IsSet)
                writer.WriteString("parentOrgId", createOrganizationRequest.ParentOrgId);
        }
    }
}
