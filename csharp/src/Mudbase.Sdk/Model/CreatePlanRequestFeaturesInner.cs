...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class CreatePlanRequestFeaturesInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreatePlanRequestFeaturesInner" /> class.
        /// </summary>
        /// <param name="string"></param>
        public CreatePlanRequestFeaturesInner(string @string)
        {
            String = @string;
            OnCreated();
        }
        ...
        public CreatePlanRequestFeaturesInner(CreatePlanRequestFeaturesInnerOneOf createPlanRequestFeaturesInnerOneOf)
        {
        ...
        /// <summary>
        /// Gets or Sets CreatePlanRequestFeaturesInnerOneOf
        /// </summary>
        public CreatePlanRequestFeaturesInnerOneOf? CreatePlanRequestFeaturesInnerOneOf { get; set; }
    ...
    public class CreatePlanRequestFeaturesInnerJsonConverter : JsonConverter<CreatePlanRequestFeaturesInner>
    {
        ...
        public override CreatePlanRequestFeaturesInner Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            CreatePlanRequestFeaturesInnerOneOf? createPlanRequestFeaturesInnerOneOf = default;
            ...
            while (utf8JsonReaderOneOf.Read())
            {
                ...
                if (utf8JsonReaderOneOf.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReaderOneOf.CurrentDepth - 1)
                {
                    ...
                    Utf8JsonReader utf8JsonReaderCreatePlanRequestFeaturesInnerOneOf = utf8JsonReader;
                    ClientUtils.TryDeserialize<CreatePlanRequestFeaturesInnerOneOf?>(ref utf8JsonReaderCreatePlanRequestFeaturesInnerOneOf, jsonSerializerOptions, out createPlanRequestFeaturesInnerOneOf);
                }
            }
            ...
            if (varString != null)
                return new CreatePlanRequestFeaturesInner(varString);

            if (createPlanRequestFeaturesInnerOneOf != null)
                return new CreatePlanRequestFeaturesInner(createPlanRequestFeaturesInnerOneOf);

            throw new JsonException();
        }

        /// <summary>
        /// Serializes a <see cref="CreatePlanRequestFeaturesInner" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="createPlanRequestFeaturesInner"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, CreatePlanRequestFeaturesInner createPlanRequestFeaturesInner, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, createPlanRequestFeaturesInner, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="CreatePlanRequestFeaturesInner" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="createPlanRequestFeaturesInner"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, CreatePlanRequestFeaturesInner createPlanRequestFeaturesInner, JsonSerializerOptions jsonSerializerOptions)
        {
