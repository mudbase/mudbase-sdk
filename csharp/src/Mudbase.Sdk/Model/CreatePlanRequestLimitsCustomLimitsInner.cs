...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class CreatePlanRequestLimitsCustomLimitsInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreatePlanRequestLimitsCustomLimitsInner" /> class.
        /// </summary>
        /// <param name="name">name</param>
        /// <param name="value">value</param>
        [JsonConstructor]
        public CreatePlanRequestLimitsCustomLimitsInner(Option<string?> name = default, Option<decimal?> value = default)
        {
            NameOption = name;
            ValueOption = value;
            OnCreated();
    ...
    public class CreatePlanRequestLimitsCustomLimitsInnerJsonConverter : JsonConverter<CreatePlanRequestLimitsCustomLimitsInner>
    {
        ...
        public override CreatePlanRequestLimitsCustomLimitsInner Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class CreatePlanRequestLimitsCustomLimitsInner.");

            if (value.IsSet && value.Value == null)
                throw new ArgumentNullException(nameof(value), "Property is not nullable for class CreatePlanRequestLimitsCustomLimitsInner.");

            return new CreatePlanRequestLimitsCustomLimitsInner(name, value);
        }

        /// <summary>
        /// Serializes a <see cref="CreatePlanRequestLimitsCustomLimitsInner" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="createPlanRequestLimitsCustomLimitsInner"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, CreatePlanRequestLimitsCustomLimitsInner createPlanRequestLimitsCustomLimitsInner, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, createPlanRequestLimitsCustomLimitsInner, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="CreatePlanRequestLimitsCustomLimitsInner" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="createPlanRequestLimitsCustomLimitsInner"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, CreatePlanRequestLimitsCustomLimitsInner createPlanRequestLimitsCustomLimitsInner, JsonSerializerOptions jsonSerializerOptions)
        {
            if (createPlanRequestLimitsCustomLimitsInner.NameOption.IsSet && createPlanRequestLimitsCustomLimitsInner.Name == null)
                throw new ArgumentNullException(nameof(createPlanRequestLimitsCustomLimitsInner.Name), "Property is required for class CreatePlanRequestLimitsCustomLimitsInner.");

            if (createPlanRequestLimitsCustomLimitsInner.NameOption.IsSet)
                writer.WriteString("name", createPlanRequestLimitsCustomLimitsInner.Name);

            if (createPlanRequestLimitsCustomLimitsInner.ValueOption.IsSet)
                writer.WriteNumber("value", createPlanRequestLimitsCustomLimitsInner.ValueOption.Value!.Value);
        }
    }
}
