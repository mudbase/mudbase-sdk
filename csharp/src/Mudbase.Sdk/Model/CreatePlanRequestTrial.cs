...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class CreatePlanRequestTrial : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreatePlanRequestTrial" /> class.
        /// </summary>
        /// <param name="enabled">enabled</param>
        /// <param name="days">days</param>
        [JsonConstructor]
        public CreatePlanRequestTrial(Option<bool?> enabled = default, Option<decimal?> days = default)
        {
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<decimal?> DaysOption { get; private set; }
    ...
    public partial class CreatePlanRequestTrialJsonConverter : JsonConverter<CreatePlanRequestTrial>
    {
        ...
        public override CreatePlanRequestTrial Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "enabled":
                            ...
                            break;
                        case "days":
                            days = new Option<decimal?>(utf8JsonReader.TokenType == JsonTokenType.Null ? (decimal?)null : utf8JsonReader.GetDecimal());
                            break;
                        default:
                            break;
                    }
            ...
            if (enabled.IsSet && enabled.Value == null)
                throw new ArgumentNullException(nameof(enabled), "Property is not nullable for class CreatePlanRequestTrial.");

            if (days.IsSet && days.Value == null)
                throw new ArgumentNullException(nameof(days), "Property is not nullable for class CreatePlanRequestTrial.");

            return new CreatePlanRequestTrial(enabled, days);
        }

        /// <summary>
        /// Serializes a <see cref="CreatePlanRequestTrial" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="createPlanRequestTrial"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, CreatePlanRequestTrial createPlanRequestTrial, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, createPlanRequestTrial, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="CreatePlanRequestTrial" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="createPlanRequestTrial"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, CreatePlanRequestTrial createPlanRequestTrial, JsonSerializerOptions jsonSerializerOptions)
        {
            if (createPlanRequestTrial.EnabledOption.IsSet)
                writer.WriteBoolean("enabled", createPlanRequestTrial.EnabledOption.Value!.Value);

            if (createPlanRequestTrial.DaysOption.IsSet)
                writer.WriteNumber("days", createPlanRequestTrial.DaysOption.Value!.Value);
        }
    }
}
