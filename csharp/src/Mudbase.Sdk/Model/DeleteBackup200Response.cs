...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class DeleteBackup200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteBackup200Response" /> class.
        /// </summary>
        /// <param name="message">message</param>
        [JsonConstructor]
        public DeleteBackup200Response(Option<string?> message = default)
        {
        ...
        /// </summary>
        /* <example>Backup deleted successfully</example> */
    ...
    /// <summary>
    /// A Json converter for type <see cref="DeleteBackup200Response" />
    /// </summary>
    public partial class DeleteBackup200ResponseJsonConverter : JsonConverter<DeleteBackup200Response>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteBackup200ResponseJsonConverter" /> class.
        /// </summary>
        public DeleteBackup200ResponseJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="DeleteBackup200Response" />
        /// </summary>
        ...
        public override DeleteBackup200Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (message.IsSet && message.Value == null)
                throw new ArgumentNullException(nameof(message), "Property is not nullable for class DeleteBackup200Response.");

            return new DeleteBackup200Response(message);
        }

        /// <summary>
        /// Serializes a <see cref="DeleteBackup200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="deleteBackup200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, DeleteBackup200Response deleteBackup200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, deleteBackup200Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="DeleteBackup200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="deleteBackup200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, DeleteBackup200Response deleteBackup200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (deleteBackup200Response.MessageOption.IsSet && deleteBackup200Response.Message == null)
                throw new ArgumentNullException(nameof(deleteBackup200Response.Message), "Property is required for class DeleteBackup200Response.");

            if (deleteBackup200Response.MessageOption.IsSet)
                writer.WriteString("message", deleteBackup200Response.Message);
        }
    }
}
