...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class DeleteFunction200Response : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public DeleteFunction200Response(Option<bool?> success = default, Option<string?> message = default)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="DeleteFunction200Response" />
    /// </summary>
    public partial class DeleteFunction200ResponseJsonConverter : JsonConverter<DeleteFunction200Response>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteFunction200ResponseJsonConverter" /> class.
        /// </summary>
        public DeleteFunction200ResponseJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="DeleteFunction200Response" />
        /// </summary>
        ...
        public override DeleteFunction200Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (success.IsSet && success.Value == null)
                throw new ArgumentNullException(nameof(success), "Property is not nullable for class DeleteFunction200Response.");

            if (message.IsSet && message.Value == null)
                throw new ArgumentNullException(nameof(message), "Property is not nullable for class DeleteFunction200Response.");

            return new DeleteFunction200Response(success, message);
        }

        /// <summary>
        /// Serializes a <see cref="DeleteFunction200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="deleteFunction200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, DeleteFunction200Response deleteFunction200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, deleteFunction200Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="DeleteFunction200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="deleteFunction200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, DeleteFunction200Response deleteFunction200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (deleteFunction200Response.MessageOption.IsSet && deleteFunction200Response.Message == null)
                throw new ArgumentNullException(nameof(deleteFunction200Response.Message), "Property is required for class DeleteFunction200Response.");

            if (deleteFunction200Response.SuccessOption.IsSet)
                writer.WriteBoolean("success", deleteFunction200Response.SuccessOption.Value!.Value);

            if (deleteFunction200Response.MessageOption.IsSet)
                writer.WriteString("message", deleteFunction200Response.Message);
        }
    }
}
