...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class DeleteRole200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteRole200Response" /> class.
        /// </summary>
        /// <param name="message">message</param>
        [JsonConstructor]
        public DeleteRole200Response(Option<string?> message = default)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="DeleteRole200Response" />
    /// </summary>
    public partial class DeleteRole200ResponseJsonConverter : JsonConverter<DeleteRole200Response>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteRole200ResponseJsonConverter" /> class.
        /// </summary>
        public DeleteRole200ResponseJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="DeleteRole200Response" />
        /// </summary>
        ...
        public override DeleteRole200Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (message.IsSet && message.Value == null)
                throw new ArgumentNullException(nameof(message), "Property is not nullable for class DeleteRole200Response.");

            return new DeleteRole200Response(message);
        }

        /// <summary>
        /// Serializes a <see cref="DeleteRole200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="deleteRole200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, DeleteRole200Response deleteRole200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, deleteRole200Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="DeleteRole200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="deleteRole200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, DeleteRole200Response deleteRole200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (deleteRole200Response.MessageOption.IsSet && deleteRole200Response.Message == null)
                throw new ArgumentNullException(nameof(deleteRole200Response.Message), "Property is required for class DeleteRole200Response.");

            if (deleteRole200Response.MessageOption.IsSet)
                writer.WriteString("message", deleteRole200Response.Message);
        }
    }
}
