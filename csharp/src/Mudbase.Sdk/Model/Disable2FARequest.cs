...
namespace Mudbase.Sdk.Model
{
    ...
    public partial class Disable2FARequest : IValidatableObject
    {
        ...
        [JsonConstructor]
        public Disable2FARequest(string password, string token)
        {
            Password = password;
            Token = token;
            OnCreated();
    ...
    public partial class Disable2FARequestJsonConverter : JsonConverter<Disable2FARequest>
    {
        ...
        public override Disable2FARequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!token.IsSet)
                throw new ArgumentException("Property is required for class Disable2FARequest.", nameof(token));
            ...
            if (token.IsSet && token.Value == null)
                throw new ArgumentNullException(nameof(token), "Property is not nullable for class Disable2FARequest.");

            return new Disable2FARequest(password.Value!, token.Value!);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, Disable2FARequest disable2FARequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (disable2FARequest.Token == null)
                throw new ArgumentNullException(nameof(disable2FARequest.Token), "Property is required for class Disable2FARequest.");

            writer.WriteString("password", disable2FARequest.Password);

            writer.WriteString("token", disable2FARequest.Token);
        }
    }
}
