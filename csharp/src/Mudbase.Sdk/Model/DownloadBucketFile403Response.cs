...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class DownloadBucketFile403Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DownloadBucketFile403Response" /> class.
        /// </summary>
        /// <param name="error">error</param>
        [JsonConstructor]
        public DownloadBucketFile403Response(Option<string?> error = default)
        {
            ErrorOption = error;
            OnCreated();
        }
    ...
    public class DownloadBucketFile403ResponseJsonConverter : JsonConverter<DownloadBucketFile403Response>
    {
        ...
        public override DownloadBucketFile403Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (error.IsSet && error.Value == null)
                throw new ArgumentNullException(nameof(error), "Property is not nullable for class DownloadBucketFile403Response.");

            return new DownloadBucketFile403Response(error);
        }

        /// <summary>
        /// Serializes a <see cref="DownloadBucketFile403Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="downloadBucketFile403Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, DownloadBucketFile403Response downloadBucketFile403Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, downloadBucketFile403Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="DownloadBucketFile403Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="downloadBucketFile403Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, DownloadBucketFile403Response downloadBucketFile403Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (downloadBucketFile403Response.ErrorOption.IsSet && downloadBucketFile403Response.Error == null)
                throw new ArgumentNullException(nameof(downloadBucketFile403Response.Error), "Property is required for class DownloadBucketFile403Response.");

            if (downloadBucketFile403Response.ErrorOption.IsSet)
                writer.WriteString("error", downloadBucketFile403Response.Error);
        }
    }
}
