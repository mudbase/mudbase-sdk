...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class DownloadBucketFile404Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DownloadBucketFile404Response" /> class.
        /// </summary>
        /// <param name="error">error</param>
        [JsonConstructor]
        public DownloadBucketFile404Response(Option<string?> error = default)
        {
            ErrorOption = error;
            OnCreated();
        }
    ...
    /// <summary>
    /// A Json converter for type <see cref="DownloadBucketFile404Response" />
    /// </summary>
    public partial class DownloadBucketFile404ResponseJsonConverter : JsonConverter<DownloadBucketFile404Response>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="DownloadBucketFile404ResponseJsonConverter" /> class.
        /// </summary>
        public DownloadBucketFile404ResponseJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="DownloadBucketFile404Response" />
        /// </summary>
        ...
        public override DownloadBucketFile404Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (error.IsSet && error.Value == null)
                throw new ArgumentNullException(nameof(error), "Property is not nullable for class DownloadBucketFile404Response.");

            return new DownloadBucketFile404Response(error);
        }

        /// <summary>
        /// Serializes a <see cref="DownloadBucketFile404Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="downloadBucketFile404Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, DownloadBucketFile404Response downloadBucketFile404Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, downloadBucketFile404Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="DownloadBucketFile404Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="downloadBucketFile404Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, DownloadBucketFile404Response downloadBucketFile404Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (downloadBucketFile404Response.ErrorOption.IsSet && downloadBucketFile404Response.Error == null)
                throw new ArgumentNullException(nameof(downloadBucketFile404Response.Error), "Property is required for class DownloadBucketFile404Response.");

            if (downloadBucketFile404Response.ErrorOption.IsSet)
                writer.WriteString("error", downloadBucketFile404Response.Error);
        }
    }
}
