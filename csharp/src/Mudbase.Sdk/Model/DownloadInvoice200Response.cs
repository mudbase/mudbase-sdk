...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class DownloadInvoice200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DownloadInvoice200Response" /> class.
        /// </summary>
        /// <param name="url">url</param>
        /// <param name="message">message</param>
        [JsonConstructor]
        public DownloadInvoice200Response(Option<string?> url = default, Option<string?> message = default)
        {
            UrlOption = url;
    ...
    public partial class DownloadInvoice200ResponseJsonConverter : JsonConverter<DownloadInvoice200Response>
    {
        ...
        public override DownloadInvoice200Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (url.IsSet && url.Value == null)
                throw new ArgumentNullException(nameof(url), "Property is not nullable for class DownloadInvoice200Response.");

            if (message.IsSet && message.Value == null)
                throw new ArgumentNullException(nameof(message), "Property is not nullable for class DownloadInvoice200Response.");

            return new DownloadInvoice200Response(url, message);
        }

        /// <summary>
        /// Serializes a <see cref="DownloadInvoice200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="downloadInvoice200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, DownloadInvoice200Response downloadInvoice200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, downloadInvoice200Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="DownloadInvoice200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="downloadInvoice200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, DownloadInvoice200Response downloadInvoice200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (downloadInvoice200Response.UrlOption.IsSet && downloadInvoice200Response.Url == null)
                throw new ArgumentNullException(nameof(downloadInvoice200Response.Url), "Property is required for class DownloadInvoice200Response.");

            if (downloadInvoice200Response.MessageOption.IsSet && downloadInvoice200Response.Message == null)
                throw new ArgumentNullException(nameof(downloadInvoice200Response.Message), "Property is required for class DownloadInvoice200Response.");

            if (downloadInvoice200Response.UrlOption.IsSet)
                writer.WriteString("url", downloadInvoice200Response.Url);

            if (downloadInvoice200Response.MessageOption.IsSet)
                writer.WriteString("message", downloadInvoice200Response.Message);
        }
    }
}
