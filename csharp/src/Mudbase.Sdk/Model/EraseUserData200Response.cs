...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class EraseUserData200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EraseUserData200Response" /> class.
        /// </summary>
        /// <param name="success">success</param>
        /// <param name="message">message</param>
        /// <param name="data">data</param>
        [JsonConstructor]
        public EraseUserData200Response(Option<bool?> success = default, Option<string?> message = default, Option<EraseUserData200ResponseData?> data = default)
        {
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<EraseUserData200ResponseData?> DataOption { get; private set; }
    ...
    public class EraseUserData200ResponseJsonConverter : JsonConverter<EraseUserData200Response>
    {
        ...
        public override EraseUserData200Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<EraseUserData200ResponseData?> data = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "message":
                            ...
                            break;
                        case "data":
                            data = new Option<EraseUserData200ResponseData?>(JsonSerializer.Deserialize<EraseUserData200ResponseData>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (success.IsSet && success.Value == null)
                throw new ArgumentNullException(nameof(success), "Property is not nullable for class EraseUserData200Response.");

            if (message.IsSet && message.Value == null)
                throw new ArgumentNullException(nameof(message), "Property is not nullable for class EraseUserData200Response.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class EraseUserData200Response.");

            return new EraseUserData200Response(success, message, data);
        }

        /// <summary>
        /// Serializes a <see cref="EraseUserData200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="eraseUserData200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EraseUserData200Response eraseUserData200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, eraseUserData200Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EraseUserData200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="eraseUserData200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EraseUserData200Response eraseUserData200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (eraseUserData200Response.MessageOption.IsSet && eraseUserData200Response.Message == null)
                throw new ArgumentNullException(nameof(eraseUserData200Response.Message), "Property is required for class EraseUserData200Response.");

            if (eraseUserData200Response.DataOption.IsSet && eraseUserData200Response.Data == null)
                throw new ArgumentNullException(nameof(eraseUserData200Response.Data), "Property is required for class EraseUserData200Response.");

            if (eraseUserData200Response.SuccessOption.IsSet)
                writer.WriteBoolean("success", eraseUserData200Response.SuccessOption.Value!.Value);

            if (eraseUserData200Response.MessageOption.IsSet)
                writer.WriteString("message", eraseUserData200Response.Message);

            if (eraseUserData200Response.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, eraseUserData200Response.Data, jsonSerializerOptions);
            }
        }
    }
}
