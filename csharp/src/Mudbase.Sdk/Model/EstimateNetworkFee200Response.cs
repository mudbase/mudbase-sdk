...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class EstimateNetworkFee200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EstimateNetworkFee200Response" /> class.
        /// </summary>
        /// <param name="success">success</param>
        /// <param name="data">Same shape as POST /api/wallet/calculate-fee response (chain, networkFee, estimatedTime, currency, and chain-specific fields).</param>
        [JsonConstructor]
        public EstimateNetworkFee200Response(Option<bool?> success = default, Option<Object?> data = default)
        {
    ...
    public class EstimateNetworkFee200ResponseJsonConverter : JsonConverter<EstimateNetworkFee200Response>
    {
        ...
        public override EstimateNetworkFee200Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (success.IsSet && success.Value == null)
                throw new ArgumentNullException(nameof(success), "Property is not nullable for class EstimateNetworkFee200Response.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class EstimateNetworkFee200Response.");

            return new EstimateNetworkFee200Response(success, data);
        }

        /// <summary>
        /// Serializes a <see cref="EstimateNetworkFee200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="estimateNetworkFee200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EstimateNetworkFee200Response estimateNetworkFee200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, estimateNetworkFee200Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EstimateNetworkFee200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="estimateNetworkFee200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EstimateNetworkFee200Response estimateNetworkFee200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (estimateNetworkFee200Response.DataOption.IsSet && estimateNetworkFee200Response.Data == null)
                throw new ArgumentNullException(nameof(estimateNetworkFee200Response.Data), "Property is required for class EstimateNetworkFee200Response.");

            if (estimateNetworkFee200Response.SuccessOption.IsSet)
                writer.WriteBoolean("success", estimateNetworkFee200Response.SuccessOption.Value!.Value);

            if (estimateNetworkFee200Response.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, estimateNetworkFee200Response.Data, jsonSerializerOptions);
            }
        }
    }
}
