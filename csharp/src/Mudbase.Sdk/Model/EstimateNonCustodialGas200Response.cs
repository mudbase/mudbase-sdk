...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class EstimateNonCustodialGas200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EstimateNonCustodialGas200Response" /> class.
        /// </summary>
        /// <param name="success">success</param>
        /// <param name="data">data</param>
        [JsonConstructor]
        public EstimateNonCustodialGas200Response(Option<bool?> success = default, Option<EstimateNonCustodialGas200ResponseData?> data = default)
        {
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<EstimateNonCustodialGas200ResponseData?> DataOption { get; private set; }
    ...
    public partial class EstimateNonCustodialGas200ResponseJsonConverter : JsonConverter<EstimateNonCustodialGas200Response>
    {
        ...
        public override EstimateNonCustodialGas200Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<EstimateNonCustodialGas200ResponseData?> data = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "success":
                            ...
                            break;
                        case "data":
                            data = new Option<EstimateNonCustodialGas200ResponseData?>(JsonSerializer.Deserialize<EstimateNonCustodialGas200ResponseData>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (success.IsSet && success.Value == null)
                throw new ArgumentNullException(nameof(success), "Property is not nullable for class EstimateNonCustodialGas200Response.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class EstimateNonCustodialGas200Response.");

            return new EstimateNonCustodialGas200Response(success, data);
        }

        /// <summary>
        /// Serializes a <see cref="EstimateNonCustodialGas200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="estimateNonCustodialGas200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, EstimateNonCustodialGas200Response estimateNonCustodialGas200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, estimateNonCustodialGas200Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="EstimateNonCustodialGas200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="estimateNonCustodialGas200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, EstimateNonCustodialGas200Response estimateNonCustodialGas200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (estimateNonCustodialGas200Response.DataOption.IsSet && estimateNonCustodialGas200Response.Data == null)
                throw new ArgumentNullException(nameof(estimateNonCustodialGas200Response.Data), "Property is required for class EstimateNonCustodialGas200Response.");

            if (estimateNonCustodialGas200Response.SuccessOption.IsSet)
                writer.WriteBoolean("success", estimateNonCustodialGas200Response.SuccessOption.Value!.Value);

            if (estimateNonCustodialGas200Response.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, estimateNonCustodialGas200Response.Data, jsonSerializerOptions);
            }
        }
    }
}
