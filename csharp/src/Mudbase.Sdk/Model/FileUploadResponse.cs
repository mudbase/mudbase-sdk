...
namespace Mudbase.Sdk.Model
{
    ...
    public partial class FileUploadResponse : IValidatableObject
    {
        ...
        [JsonConstructor]
        public FileUploadResponse(Option<string?> message = default, Option<FileMetadata?> file = default)
        {
    ...
    /// </summary>
    public partial class FileUploadResponseJsonConverter : JsonConverter<FileUploadResponse>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="FileUploadResponseJsonConverter" /> class.
        /// </summary>
        public FileUploadResponseJsonConverter()
        {
            OnCreated();
        }
        ...
        public override FileUploadResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (message.IsSet && message.Value == null)
                throw new ArgumentNullException(nameof(message), "Property is not nullable for class FileUploadResponse.");

            if (file.IsSet && file.Value == null)
                throw new ArgumentNullException(nameof(file), "Property is not nullable for class FileUploadResponse.");

            return new FileUploadResponse(message, file);
        }
        ...
        {
            if (fileUploadResponse.MessageOption.IsSet && fileUploadResponse.Message == null)
                throw new ArgumentNullException(nameof(fileUploadResponse.Message), "Property is required for class FileUploadResponse.");

            if (fileUploadResponse.FileOption.IsSet && fileUploadResponse.File == null)
                throw new ArgumentNullException(nameof(fileUploadResponse.File), "Property is required for class FileUploadResponse.");

            if (fileUploadResponse.MessageOption.IsSet)
                writer.WriteString("message", fileUploadResponse.Message);

            if (fileUploadResponse.FileOption.IsSet)
            {
                writer.WritePropertyName("file");
                JsonSerializer.Serialize(writer, fileUploadResponse.File, jsonSerializerOptions);
            }
        }
    }
}
