...
namespace Mudbase.Sdk.Model
{
    ...
    public partial class FunctionResponse : IValidatableObject
    {
        ...
        [JsonConstructor]
        public FunctionResponse(Option<bool?> success = default, Option<Function?> data = default)
        {
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<Function?> DataOption { get; private set; }

        /// <summary>
        /// Gets or Sets Data
        /// </summary>
        [JsonPropertyName("data")]
        public Function? Data { get { return this.DataOption.Value; } set { this.DataOption = new(value); } }
    ...
    /// </summary>
    public partial class FunctionResponseJsonConverter : JsonConverter<FunctionResponse>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="FunctionResponseJsonConverter" /> class.
        /// </summary>
        public FunctionResponseJsonConverter()
        {
            OnCreated();
        }
        ...
        public override FunctionResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "success":
                            ...
                            break;
                        case "data":
                            data = new Option<Function?>(JsonSerializer.Deserialize<Function>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (success.IsSet && success.Value == null)
                throw new ArgumentNullException(nameof(success), "Property is not nullable for class FunctionResponse.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class FunctionResponse.");

            return new FunctionResponse(success, data);
        }
        ...
        {
            if (functionResponse.DataOption.IsSet && functionResponse.Data == null)
                throw new ArgumentNullException(nameof(functionResponse.Data), "Property is required for class FunctionResponse.");

            if (functionResponse.SuccessOption.IsSet)
                writer.WriteBoolean("success", functionResponse.SuccessOption.Value!.Value);

            if (functionResponse.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, functionResponse.Data, jsonSerializerOptions);
            }
        }
    }
}
