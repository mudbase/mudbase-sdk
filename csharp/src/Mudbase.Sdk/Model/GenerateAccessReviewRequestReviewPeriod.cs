...
namespace Mudbase.Sdk.Model
{
    ...
    public partial class GenerateAccessReviewRequestReviewPeriod : IValidatableObject
    {
        ...
        [JsonConstructor]
        public GenerateAccessReviewRequestReviewPeriod(DateTime start, DateTime end)
        {
            Start = start;
            End = end;
            OnCreated();
    ...
    public partial class GenerateAccessReviewRequestReviewPeriodJsonConverter : JsonConverter<GenerateAccessReviewRequestReviewPeriod>
    {
        ...
        public override GenerateAccessReviewRequestReviewPeriod Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!start.IsSet)
                throw new ArgumentException("Property is required for class GenerateAccessReviewRequestReviewPeriod.", nameof(start));

            if (!end.IsSet)
                throw new ArgumentException("Property is required for class GenerateAccessReviewRequestReviewPeriod.", nameof(end));

            if (start.IsSet && start.Value == null)
                throw new ArgumentNullException(nameof(start), "Property is not nullable for class GenerateAccessReviewRequestReviewPeriod.");

            if (end.IsSet && end.Value == null)
                throw new ArgumentNullException(nameof(end), "Property is not nullable for class GenerateAccessReviewRequestReviewPeriod.");

            return new GenerateAccessReviewRequestReviewPeriod(start.Value!.Value!, end.Value!.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="GenerateAccessReviewRequestReviewPeriod" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="generateAccessReviewRequestReviewPeriod"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, GenerateAccessReviewRequestReviewPeriod generateAccessReviewRequestReviewPeriod, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, generateAccessReviewRequestReviewPeriod, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="GenerateAccessReviewRequestReviewPeriod" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="generateAccessReviewRequestReviewPeriod"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, GenerateAccessReviewRequestReviewPeriod generateAccessReviewRequestReviewPeriod, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteString("start", generateAccessReviewRequestReviewPeriod.Start.ToString(StartFormat));

            writer.WriteString("end", generateAccessReviewRequestReviewPeriod.End.ToString(EndFormat));
        }
    }
}
