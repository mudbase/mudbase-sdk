...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class GenerateDataProcessingRecord200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GenerateDataProcessingRecord200Response" /> class.
        /// </summary>
        /// <param name="record">record</param>
        [JsonConstructor]
        public GenerateDataProcessingRecord200Response(Option<GenerateDataProcessingRecord200ResponseRecord?> record = default)
        {
            RecordOption = record;
            OnCreated();
        }
        ...
        public Option<GenerateDataProcessingRecord200ResponseRecord?> RecordOption { get; private set; }
    ...
    public partial class GenerateDataProcessingRecord200ResponseJsonConverter : JsonConverter<GenerateDataProcessingRecord200Response>
    {
        ...
        public override GenerateDataProcessingRecord200Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<GenerateDataProcessingRecord200ResponseRecord?> record = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "record":
                            record = new Option<GenerateDataProcessingRecord200ResponseRecord?>(JsonSerializer.Deserialize<GenerateDataProcessingRecord200ResponseRecord>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (record.IsSet && record.Value == null)
                throw new ArgumentNullException(nameof(record), "Property is not nullable for class GenerateDataProcessingRecord200Response.");

            return new GenerateDataProcessingRecord200Response(record);
        }

        /// <summary>
        /// Serializes a <see cref="GenerateDataProcessingRecord200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="generateDataProcessingRecord200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, GenerateDataProcessingRecord200Response generateDataProcessingRecord200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, generateDataProcessingRecord200Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="GenerateDataProcessingRecord200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="generateDataProcessingRecord200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, GenerateDataProcessingRecord200Response generateDataProcessingRecord200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (generateDataProcessingRecord200Response.RecordOption.IsSet && generateDataProcessingRecord200Response.Record == null)
                throw new ArgumentNullException(nameof(generateDataProcessingRecord200Response.Record), "Property is required for class GenerateDataProcessingRecord200Response.");

            if (generateDataProcessingRecord200Response.RecordOption.IsSet)
            {
                writer.WritePropertyName("record");
                JsonSerializer.Serialize(writer, generateDataProcessingRecord200Response.Record, jsonSerializerOptions);
            }
        }
    }
}
