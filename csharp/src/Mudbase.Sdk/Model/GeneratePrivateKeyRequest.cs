...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class GeneratePrivateKeyRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GeneratePrivateKeyRequest" /> class.
        /// </summary>
        /// <param name="currency">currency</param>
        [JsonConstructor]
        public GeneratePrivateKeyRequest(CurrencyEnum currency)
        {
            Currency = currency;
            OnCreated();
        }
    ...
    public partial class GeneratePrivateKeyRequestJsonConverter : JsonConverter<GeneratePrivateKeyRequest>
    {
        ...
        public override GeneratePrivateKeyRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<GeneratePrivateKeyRequest.CurrencyEnum?> currency = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "currency":
                            ...
                            if (currencyRawValue != null)
                                currency = new Option<GeneratePrivateKeyRequest.CurrencyEnum?>(GeneratePrivateKeyRequest.CurrencyEnumFromStringOrDefault(currencyRawValue));
                            break;
                        default:
                            break;
                    }
            ...
            if (!currency.IsSet)
                throw new ArgumentException("Property is required for class GeneratePrivateKeyRequest.", nameof(currency));

            if (currency.IsSet && currency.Value == null)
                throw new ArgumentNullException(nameof(currency), "Property is not nullable for class GeneratePrivateKeyRequest.");

            return new GeneratePrivateKeyRequest(currency.Value!.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="GeneratePrivateKeyRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="generatePrivateKeyRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, GeneratePrivateKeyRequest generatePrivateKeyRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, generatePrivateKeyRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="GeneratePrivateKeyRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="generatePrivateKeyRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, GeneratePrivateKeyRequest generatePrivateKeyRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            var currencyRawValue = GeneratePrivateKeyRequest.CurrencyEnumToJsonValue(generatePrivateKeyRequest.Currency);
