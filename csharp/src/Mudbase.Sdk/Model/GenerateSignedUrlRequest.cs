...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class GenerateSignedUrlRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GenerateSignedUrlRequest" /> class.
        /// </summary>
        /// <param name="expiresIn">expiresIn (default to 3600)</param>
        [JsonConstructor]
        public GenerateSignedUrlRequest(Option<int?> expiresIn = default)
        {
    ...
    public class GenerateSignedUrlRequestJsonConverter : JsonConverter<GenerateSignedUrlRequest>
    {
        ...
        public override GenerateSignedUrlRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (expiresIn.IsSet && expiresIn.Value == null)
                throw new ArgumentNullException(nameof(expiresIn), "Property is not nullable for class GenerateSignedUrlRequest.");

            return new GenerateSignedUrlRequest(expiresIn);
        }

        /// <summary>
        /// Serializes a <see cref="GenerateSignedUrlRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="generateSignedUrlRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, GenerateSignedUrlRequest generateSignedUrlRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, generateSignedUrlRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="GenerateSignedUrlRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="generateSignedUrlRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, GenerateSignedUrlRequest generateSignedUrlRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (generateSignedUrlRequest.ExpiresInOption.IsSet)
                writer.WriteNumber("expiresIn", generateSignedUrlRequest.ExpiresInOption.Value!.Value);
        }
    }
}
