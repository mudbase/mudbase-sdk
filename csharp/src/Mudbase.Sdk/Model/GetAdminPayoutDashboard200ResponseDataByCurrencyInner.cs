...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class GetAdminPayoutDashboard200ResponseDataByCurrencyInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAdminPayoutDashboard200ResponseDataByCurrencyInner" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public GetAdminPayoutDashboard200ResponseDataByCurrencyInner(Option<string?> currency = default, Option<int?> pending = default, Option<int?> completed = default, Option<int?> failed = default)
        {
    ...
    public class GetAdminPayoutDashboard200ResponseDataByCurrencyInnerJsonConverter : JsonConverter<GetAdminPayoutDashboard200ResponseDataByCurrencyInner>
    {
        ...
        public override GetAdminPayoutDashboard200ResponseDataByCurrencyInner Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (currency.IsSet && currency.Value == null)
                throw new ArgumentNullException(nameof(currency), "Property is not nullable for class GetAdminPayoutDashboard200ResponseDataByCurrencyInner.");

            if (pending.IsSet && pending.Value == null)
                throw new ArgumentNullException(nameof(pending), "Property is not nullable for class GetAdminPayoutDashboard200ResponseDataByCurrencyInner.");

            if (completed.IsSet && completed.Value == null)
                throw new ArgumentNullException(nameof(completed), "Property is not nullable for class GetAdminPayoutDashboard200ResponseDataByCurrencyInner.");

            if (failed.IsSet && failed.Value == null)
                throw new ArgumentNullException(nameof(failed), "Property is not nullable for class GetAdminPayoutDashboard200ResponseDataByCurrencyInner.");

            return new GetAdminPayoutDashboard200ResponseDataByCurrencyInner(currency, pending, completed, failed);
        }

        /// <summary>
        /// Serializes a <see cref="GetAdminPayoutDashboard200ResponseDataByCurrencyInner" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getAdminPayoutDashboard200ResponseDataByCurrencyInner"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, GetAdminPayoutDashboard200ResponseDataByCurrencyInner getAdminPayoutDashboard200ResponseDataByCurrencyInner, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, getAdminPayoutDashboard200ResponseDataByCurrencyInner, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="GetAdminPayoutDashboard200ResponseDataByCurrencyInner" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getAdminPayoutDashboard200ResponseDataByCurrencyInner"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, GetAdminPayoutDashboard200ResponseDataByCurrencyInner getAdminPayoutDashboard200ResponseDataByCurrencyInner, JsonSerializerOptions jsonSerializerOptions)
        {
            if (getAdminPayoutDashboard200ResponseDataByCurrencyInner.CurrencyOption.IsSet && getAdminPayoutDashboard200ResponseDataByCurrencyInner.Currency == null)
                throw new ArgumentNullException(nameof(getAdminPayoutDashboard200ResponseDataByCurrencyInner.Currency), "Property is required for class GetAdminPayoutDashboard200ResponseDataByCurrencyInner.");

            if (getAdminPayoutDashboard200ResponseDataByCurrencyInner.CurrencyOption.IsSet)
                writer.WriteString("currency", getAdminPayoutDashboard200ResponseDataByCurrencyInner.Currency);

            if (getAdminPayoutDashboard200ResponseDataByCurrencyInner.PendingOption.IsSet)
                writer.WriteNumber("pending", getAdminPayoutDashboard200ResponseDataByCurrencyInner.PendingOption.Value!.Value);

            if (getAdminPayoutDashboard200ResponseDataByCurrencyInner.CompletedOption.IsSet)
                writer.WriteNumber("completed", getAdminPayoutDashboard200ResponseDataByCurrencyInner.CompletedOption.Value!.Value);

            if (getAdminPayoutDashboard200ResponseDataByCurrencyInner.FailedOption.IsSet)
                writer.WriteNumber("failed", getAdminPayoutDashboard200ResponseDataByCurrencyInner.FailedOption.Value!.Value);
        }
    }
}
