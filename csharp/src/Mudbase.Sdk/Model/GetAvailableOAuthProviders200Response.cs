...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class GetAvailableOAuthProviders200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAvailableOAuthProviders200Response" /> class.
        /// </summary>
        /// <param name="providers">providers</param>
        /// <param name="total">total</param>
        [JsonConstructor]
        public GetAvailableOAuthProviders200Response(Option<List<GetAvailableOAuthProviders200ResponseProvidersInner>?> providers = default, Option<int?> total = default)
        {
        ...
        public Option<List<GetAvailableOAuthProviders200ResponseProvidersInner>?> ProvidersOption { get; private set; }
    ...
    public class GetAvailableOAuthProviders200ResponseJsonConverter : JsonConverter<GetAvailableOAuthProviders200Response>
    {
        ...
        public override GetAvailableOAuthProviders200Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<GetAvailableOAuthProviders200ResponseProvidersInner>?> providers = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "providers":
                            providers = new Option<List<GetAvailableOAuthProviders200ResponseProvidersInner>?>(JsonSerializer.Deserialize<List<GetAvailableOAuthProviders200ResponseProvidersInner>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "total":
            ...
            if (providers.IsSet && providers.Value == null)
                throw new ArgumentNullException(nameof(providers), "Property is not nullable for class GetAvailableOAuthProviders200Response.");

            if (total.IsSet && total.Value == null)
                throw new ArgumentNullException(nameof(total), "Property is not nullable for class GetAvailableOAuthProviders200Response.");

            return new GetAvailableOAuthProviders200Response(providers, total);
        }

        /// <summary>
        /// Serializes a <see cref="GetAvailableOAuthProviders200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getAvailableOAuthProviders200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, GetAvailableOAuthProviders200Response getAvailableOAuthProviders200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, getAvailableOAuthProviders200Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="GetAvailableOAuthProviders200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getAvailableOAuthProviders200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, GetAvailableOAuthProviders200Response getAvailableOAuthProviders200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (getAvailableOAuthProviders200Response.ProvidersOption.IsSet && getAvailableOAuthProviders200Response.Providers == null)
                throw new ArgumentNullException(nameof(getAvailableOAuthProviders200Response.Providers), "Property is required for class GetAvailableOAuthProviders200Response.");

            if (getAvailableOAuthProviders200Response.ProvidersOption.IsSet)
            {
                writer.WritePropertyName("providers");
                JsonSerializer.Serialize(writer, getAvailableOAuthProviders200Response.Providers, jsonSerializerOptions);
            }
            if (getAvailableOAuthProviders200Response.TotalOption.IsSet)
                writer.WriteNumber("total", getAvailableOAuthProviders200Response.TotalOption.Value!.Value);
        }
    }
}
