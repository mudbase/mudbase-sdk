...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class GetCurrentUser200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetCurrentUser200Response" /> class.
        /// </summary>
        /// <param name="user">user</param>
        [JsonConstructor]
        public GetCurrentUser200Response(Option<User?> user = default)
        {
            UserOption = user;
            OnCreated();
        }
    ...
    public partial class GetCurrentUser200ResponseJsonConverter : JsonConverter<GetCurrentUser200Response>
    {
        ...
        public override GetCurrentUser200Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (user.IsSet && user.Value == null)
                throw new ArgumentNullException(nameof(user), "Property is not nullable for class GetCurrentUser200Response.");

            return new GetCurrentUser200Response(user);
        }

        /// <summary>
        /// Serializes a <see cref="GetCurrentUser200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getCurrentUser200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, GetCurrentUser200Response getCurrentUser200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, getCurrentUser200Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="GetCurrentUser200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getCurrentUser200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, GetCurrentUser200Response getCurrentUser200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (getCurrentUser200Response.UserOption.IsSet && getCurrentUser200Response.User == null)
                throw new ArgumentNullException(nameof(getCurrentUser200Response.User), "Property is required for class GetCurrentUser200Response.");

            if (getCurrentUser200Response.UserOption.IsSet)
            {
                writer.WritePropertyName("user");
                JsonSerializer.Serialize(writer, getCurrentUser200Response.User, jsonSerializerOptions);
            }
        }
    }
}
