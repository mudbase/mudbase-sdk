...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class GetDashboardOrganizationDetail200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetDashboardOrganizationDetail200Response" /> class.
        /// </summary>
        /// <param name="success">success</param>
        /// <param name="organization">organization</param>
        [JsonConstructor]
        public GetDashboardOrganizationDetail200Response(Option<bool?> success = default, Option<GetDashboardOrganizationDetail200ResponseOrganization?> organization = default)
        {
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<GetDashboardOrganizationDetail200ResponseOrganization?> OrganizationOption { get; private set; }
    ...
    public partial class GetDashboardOrganizationDetail200ResponseJsonConverter : JsonConverter<GetDashboardOrganizationDetail200Response>
    {
        ...
        public override GetDashboardOrganizationDetail200Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<GetDashboardOrganizationDetail200ResponseOrganization?> organization = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "success":
                            ...
                            break;
                        case "organization":
                            organization = new Option<GetDashboardOrganizationDetail200ResponseOrganization?>(JsonSerializer.Deserialize<GetDashboardOrganizationDetail200ResponseOrganization>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (success.IsSet && success.Value == null)
                throw new ArgumentNullException(nameof(success), "Property is not nullable for class GetDashboardOrganizationDetail200Response.");

            if (organization.IsSet && organization.Value == null)
                throw new ArgumentNullException(nameof(organization), "Property is not nullable for class GetDashboardOrganizationDetail200Response.");

            return new GetDashboardOrganizationDetail200Response(success, organization);
        }

        /// <summary>
        /// Serializes a <see cref="GetDashboardOrganizationDetail200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getDashboardOrganizationDetail200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, GetDashboardOrganizationDetail200Response getDashboardOrganizationDetail200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, getDashboardOrganizationDetail200Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="GetDashboardOrganizationDetail200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getDashboardOrganizationDetail200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, GetDashboardOrganizationDetail200Response getDashboardOrganizationDetail200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (getDashboardOrganizationDetail200Response.OrganizationOption.IsSet && getDashboardOrganizationDetail200Response.Organization == null)
                throw new ArgumentNullException(nameof(getDashboardOrganizationDetail200Response.Organization), "Property is required for class GetDashboardOrganizationDetail200Response.");

            if (getDashboardOrganizationDetail200Response.SuccessOption.IsSet)
                writer.WriteBoolean("success", getDashboardOrganizationDetail200Response.SuccessOption.Value!.Value);

            if (getDashboardOrganizationDetail200Response.OrganizationOption.IsSet)
            {
                writer.WritePropertyName("organization");
                JsonSerializer.Serialize(writer, getDashboardOrganizationDetail200Response.Organization, jsonSerializerOptions);
            }
        }
    }
}
