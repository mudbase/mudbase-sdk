...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class GetFunctionVersions200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetFunctionVersions200Response" /> class.
        /// </summary>
        /// <param name="success">success</param>
        /// <param name="data">data</param>
        [JsonConstructor]
        public GetFunctionVersions200Response(Option<bool?> success = default, Option<GetFunctionVersions200ResponseData?> data = default)
        {
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<GetFunctionVersions200ResponseData?> DataOption { get; private set; }
    ...
    public partial class GetFunctionVersions200ResponseJsonConverter : JsonConverter<GetFunctionVersions200Response>
    {
        ...
        public override GetFunctionVersions200Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<GetFunctionVersions200ResponseData?> data = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "success":
                            ...
                            break;
                        case "data":
                            data = new Option<GetFunctionVersions200ResponseData?>(JsonSerializer.Deserialize<GetFunctionVersions200ResponseData>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (success.IsSet && success.Value == null)
                throw new ArgumentNullException(nameof(success), "Property is not nullable for class GetFunctionVersions200Response.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class GetFunctionVersions200Response.");

            return new GetFunctionVersions200Response(success, data);
        }

        /// <summary>
        /// Serializes a <see cref="GetFunctionVersions200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getFunctionVersions200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, GetFunctionVersions200Response getFunctionVersions200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, getFunctionVersions200Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="GetFunctionVersions200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getFunctionVersions200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, GetFunctionVersions200Response getFunctionVersions200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (getFunctionVersions200Response.DataOption.IsSet && getFunctionVersions200Response.Data == null)
                throw new ArgumentNullException(nameof(getFunctionVersions200Response.Data), "Property is required for class GetFunctionVersions200Response.");

            if (getFunctionVersions200Response.SuccessOption.IsSet)
                writer.WriteBoolean("success", getFunctionVersions200Response.SuccessOption.Value!.Value);

            if (getFunctionVersions200Response.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, getFunctionVersions200Response.Data, jsonSerializerOptions);
            }
        }
    }
}
