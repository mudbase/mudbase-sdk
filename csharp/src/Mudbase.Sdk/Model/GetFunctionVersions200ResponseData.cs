...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class GetFunctionVersions200ResponseData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetFunctionVersions200ResponseData" /> class.
        /// </summary>
        /// <param name="versions">versions</param>
        [JsonConstructor]
        public GetFunctionVersions200ResponseData(Option<List<GetFunctionVersions200ResponseDataVersionsInner>?> versions = default)
        {
        ...
        public Option<List<GetFunctionVersions200ResponseDataVersionsInner>?> VersionsOption { get; private set; }
    ...
    public class GetFunctionVersions200ResponseDataJsonConverter : JsonConverter<GetFunctionVersions200ResponseData>
    {
        ...
        public override GetFunctionVersions200ResponseData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<GetFunctionVersions200ResponseDataVersionsInner>?> versions = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "versions":
                            versions = new Option<List<GetFunctionVersions200ResponseDataVersionsInner>?>(JsonSerializer.Deserialize<List<GetFunctionVersions200ResponseDataVersionsInner>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (versions.IsSet && versions.Value == null)
                throw new ArgumentNullException(nameof(versions), "Property is not nullable for class GetFunctionVersions200ResponseData.");

            return new GetFunctionVersions200ResponseData(versions);
        }

        /// <summary>
        /// Serializes a <see cref="GetFunctionVersions200ResponseData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getFunctionVersions200ResponseData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, GetFunctionVersions200ResponseData getFunctionVersions200ResponseData, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, getFunctionVersions200ResponseData, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="GetFunctionVersions200ResponseData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getFunctionVersions200ResponseData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, GetFunctionVersions200ResponseData getFunctionVersions200ResponseData, JsonSerializerOptions jsonSerializerOptions)
        {
            if (getFunctionVersions200ResponseData.VersionsOption.IsSet && getFunctionVersions200ResponseData.Versions == null)
                throw new ArgumentNullException(nameof(getFunctionVersions200ResponseData.Versions), "Property is required for class GetFunctionVersions200ResponseData.");

            if (getFunctionVersions200ResponseData.VersionsOption.IsSet)
            {
                writer.WritePropertyName("versions");
                JsonSerializer.Serialize(writer, getFunctionVersions200ResponseData.Versions, jsonSerializerOptions);
            }
        }
    }
}
