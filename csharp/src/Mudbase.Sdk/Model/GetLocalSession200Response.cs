...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class GetLocalSession200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetLocalSession200Response" /> class.
        /// </summary>
        /// <param name="user">user</param>
        /// <param name="authenticated">authenticated</param>
        [JsonConstructor]
        public GetLocalSession200Response(Option<Object?> user = default, Option<bool?> authenticated = default)
        {
            UserOption = user;
    ...
    /// <summary>
    /// A Json converter for type <see cref="GetLocalSession200Response" />
    /// </summary>
    public partial class GetLocalSession200ResponseJsonConverter : JsonConverter<GetLocalSession200Response>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="GetLocalSession200ResponseJsonConverter" /> class.
        /// </summary>
        public GetLocalSession200ResponseJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="GetLocalSession200Response" />
        /// </summary>
        ...
        public override GetLocalSession200Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (user.IsSet && user.Value == null)
                throw new ArgumentNullException(nameof(user), "Property is not nullable for class GetLocalSession200Response.");

            if (authenticated.IsSet && authenticated.Value == null)
                throw new ArgumentNullException(nameof(authenticated), "Property is not nullable for class GetLocalSession200Response.");

            return new GetLocalSession200Response(user, authenticated);
        }

        /// <summary>
        /// Serializes a <see cref="GetLocalSession200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getLocalSession200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, GetLocalSession200Response getLocalSession200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, getLocalSession200Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="GetLocalSession200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getLocalSession200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, GetLocalSession200Response getLocalSession200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (getLocalSession200Response.UserOption.IsSet && getLocalSession200Response.User == null)
                throw new ArgumentNullException(nameof(getLocalSession200Response.User), "Property is required for class GetLocalSession200Response.");

            if (getLocalSession200Response.UserOption.IsSet)
            {
                writer.WritePropertyName("user");
                JsonSerializer.Serialize(writer, getLocalSession200Response.User, jsonSerializerOptions);
            }
            if (getLocalSession200Response.AuthenticatedOption.IsSet)
                writer.WriteBoolean("authenticated", getLocalSession200Response.AuthenticatedOption.Value!.Value);
        }
    }
}
