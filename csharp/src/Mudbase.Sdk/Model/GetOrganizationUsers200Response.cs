...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class GetOrganizationUsers200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetOrganizationUsers200Response" /> class.
        /// </summary>
        /// <param name="users">users</param>
        /// <param name="total">total</param>
        [JsonConstructor]
        public GetOrganizationUsers200Response(Option<List<GetOrganizationUsers200ResponseUsersInner>?> users = default, Option<int?> total = default)
        {
            UsersOption = users;
            TotalOption = total;
            OnCreated();
    ...
    public partial class GetOrganizationUsers200ResponseJsonConverter : JsonConverter<GetOrganizationUsers200Response>
    {
        ...
        public override GetOrganizationUsers200Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (users.IsSet && users.Value == null)
                throw new ArgumentNullException(nameof(users), "Property is not nullable for class GetOrganizationUsers200Response.");

            if (total.IsSet && total.Value == null)
                throw new ArgumentNullException(nameof(total), "Property is not nullable for class GetOrganizationUsers200Response.");

            return new GetOrganizationUsers200Response(users, total);
        }

        /// <summary>
        /// Serializes a <see cref="GetOrganizationUsers200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getOrganizationUsers200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, GetOrganizationUsers200Response getOrganizationUsers200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, getOrganizationUsers200Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="GetOrganizationUsers200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getOrganizationUsers200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, GetOrganizationUsers200Response getOrganizationUsers200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (getOrganizationUsers200Response.UsersOption.IsSet && getOrganizationUsers200Response.Users == null)
                throw new ArgumentNullException(nameof(getOrganizationUsers200Response.Users), "Property is required for class GetOrganizationUsers200Response.");

            if (getOrganizationUsers200Response.UsersOption.IsSet)
            {
                writer.WritePropertyName("users");
                JsonSerializer.Serialize(writer, getOrganizationUsers200Response.Users, jsonSerializerOptions);
            }
            if (getOrganizationUsers200Response.TotalOption.IsSet)
                writer.WriteNumber("total", getOrganizationUsers200Response.TotalOption.Value!.Value);
        }
    }
}
