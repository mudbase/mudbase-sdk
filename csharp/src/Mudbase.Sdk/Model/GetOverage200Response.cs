...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class GetOverage200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetOverage200Response" /> class.
        /// </summary>
        /// <param name="overage">overage</param>
        [JsonConstructor]
        public GetOverage200Response(Option<List<GetOverage200ResponseOverageInner>?> overage = default)
        {
            OverageOption = overage;
            OnCreated();
        }
        ...
        /// <summary>
        /// Used to track the state of Overage
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<GetOverage200ResponseOverageInner>?> OverageOption { get; private set; }
    ...
    public partial class GetOverage200ResponseJsonConverter : JsonConverter<GetOverage200Response>
    {
        ...
        public override GetOverage200Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<GetOverage200ResponseOverageInner>?> overage = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "overage":
                            overage = new Option<List<GetOverage200ResponseOverageInner>?>(JsonSerializer.Deserialize<List<GetOverage200ResponseOverageInner>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (overage.IsSet && overage.Value == null)
                throw new ArgumentNullException(nameof(overage), "Property is not nullable for class GetOverage200Response.");

            return new GetOverage200Response(overage);
        }

        /// <summary>
        /// Serializes a <see cref="GetOverage200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getOverage200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, GetOverage200Response getOverage200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, getOverage200Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="GetOverage200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getOverage200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, GetOverage200Response getOverage200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (getOverage200Response.OverageOption.IsSet && getOverage200Response.Overage == null)
                throw new ArgumentNullException(nameof(getOverage200Response.Overage), "Property is required for class GetOverage200Response.");

            if (getOverage200Response.OverageOption.IsSet)
            {
                writer.WritePropertyName("overage");
                JsonSerializer.Serialize(writer, getOverage200Response.Overage, jsonSerializerOptions);
            }
        }
    }
}
