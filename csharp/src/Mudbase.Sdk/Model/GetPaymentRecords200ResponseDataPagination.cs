...
namespace Mudbase.Sdk.Model
{
    ...
    public partial class GetPaymentRecords200ResponseDataPagination : IValidatableObject
    {
        ...
        [JsonConstructor]
        public GetPaymentRecords200ResponseDataPagination(Option<int?> page = default, Option<int?> limit = default, Option<int?> total = default, Option<int?> pages = default)
        {
            PageOption = page;
            LimitOption = limit;
            TotalOption = total;
    ...
    public partial class GetPaymentRecords200ResponseDataPaginationJsonConverter : JsonConverter<GetPaymentRecords200ResponseDataPagination>
    {
        ...
        public override GetPaymentRecords200ResponseDataPagination Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (page.IsSet && page.Value == null)
                throw new ArgumentNullException(nameof(page), "Property is not nullable for class GetPaymentRecords200ResponseDataPagination.");

            if (limit.IsSet && limit.Value == null)
                throw new ArgumentNullException(nameof(limit), "Property is not nullable for class GetPaymentRecords200ResponseDataPagination.");

            if (total.IsSet && total.Value == null)
                throw new ArgumentNullException(nameof(total), "Property is not nullable for class GetPaymentRecords200ResponseDataPagination.");

            if (pages.IsSet && pages.Value == null)
                throw new ArgumentNullException(nameof(pages), "Property is not nullable for class GetPaymentRecords200ResponseDataPagination.");

            return new GetPaymentRecords200ResponseDataPagination(page, limit, total, pages);
        }

        /// <summary>
        /// Serializes a <see cref="GetPaymentRecords200ResponseDataPagination" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getPaymentRecords200ResponseDataPagination"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, GetPaymentRecords200ResponseDataPagination getPaymentRecords200ResponseDataPagination, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, getPaymentRecords200ResponseDataPagination, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="GetPaymentRecords200ResponseDataPagination" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getPaymentRecords200ResponseDataPagination"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, GetPaymentRecords200ResponseDataPagination getPaymentRecords200ResponseDataPagination, JsonSerializerOptions jsonSerializerOptions)
        {
            if (getPaymentRecords200ResponseDataPagination.PageOption.IsSet)
                writer.WriteNumber("page", getPaymentRecords200ResponseDataPagination.PageOption.Value!.Value);

            if (getPaymentRecords200ResponseDataPagination.LimitOption.IsSet)
                writer.WriteNumber("limit", getPaymentRecords200ResponseDataPagination.LimitOption.Value!.Value);

            if (getPaymentRecords200ResponseDataPagination.TotalOption.IsSet)
                writer.WriteNumber("total", getPaymentRecords200ResponseDataPagination.TotalOption.Value!.Value);

            if (getPaymentRecords200ResponseDataPagination.PagesOption.IsSet)
                writer.WriteNumber("pages", getPaymentRecords200ResponseDataPagination.PagesOption.Value!.Value);
        }
    }
}
