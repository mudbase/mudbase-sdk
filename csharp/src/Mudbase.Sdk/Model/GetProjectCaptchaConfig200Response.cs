...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class GetProjectCaptchaConfig200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetProjectCaptchaConfig200Response" /> class.
        /// </summary>
        /// <param name="captcha">captcha</param>
        [JsonConstructor]
        public GetProjectCaptchaConfig200Response(Option<GetProjectCaptchaConfig200ResponseCaptcha?> captcha = default)
        {
        ...
        /// <summary>
        /// Used to track the state of Captcha
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<GetProjectCaptchaConfig200ResponseCaptcha?> CaptchaOption { get; private set; }
    ...
    public partial class GetProjectCaptchaConfig200ResponseJsonConverter : JsonConverter<GetProjectCaptchaConfig200Response>
    {
        ...
        public override GetProjectCaptchaConfig200Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<GetProjectCaptchaConfig200ResponseCaptcha?> captcha = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "captcha":
                            captcha = new Option<GetProjectCaptchaConfig200ResponseCaptcha?>(JsonSerializer.Deserialize<GetProjectCaptchaConfig200ResponseCaptcha>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (captcha.IsSet && captcha.Value == null)
                throw new ArgumentNullException(nameof(captcha), "Property is not nullable for class GetProjectCaptchaConfig200Response.");

            return new GetProjectCaptchaConfig200Response(captcha);
        }

        /// <summary>
        /// Serializes a <see cref="GetProjectCaptchaConfig200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getProjectCaptchaConfig200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, GetProjectCaptchaConfig200Response getProjectCaptchaConfig200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, getProjectCaptchaConfig200Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="GetProjectCaptchaConfig200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getProjectCaptchaConfig200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, GetProjectCaptchaConfig200Response getProjectCaptchaConfig200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (getProjectCaptchaConfig200Response.CaptchaOption.IsSet && getProjectCaptchaConfig200Response.Captcha == null)
                throw new ArgumentNullException(nameof(getProjectCaptchaConfig200Response.Captcha), "Property is required for class GetProjectCaptchaConfig200Response.");

            if (getProjectCaptchaConfig200Response.CaptchaOption.IsSet)
            {
                writer.WritePropertyName("captcha");
                JsonSerializer.Serialize(writer, getProjectCaptchaConfig200Response.Captcha, jsonSerializerOptions);
            }
        }
    }
}
