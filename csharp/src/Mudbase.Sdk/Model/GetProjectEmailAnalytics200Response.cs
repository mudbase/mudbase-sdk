...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class GetProjectEmailAnalytics200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetProjectEmailAnalytics200Response" /> class.
        /// </summary>
        /// <param name="success">success</param>
        /// <param name="data">data</param>
        [JsonConstructor]
        public GetProjectEmailAnalytics200Response(Option<bool?> success = default, Option<Dictionary<string, Object>?> data = default)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="GetProjectEmailAnalytics200Response" />
    /// </summary>
    public partial class GetProjectEmailAnalytics200ResponseJsonConverter : JsonConverter<GetProjectEmailAnalytics200Response>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="GetProjectEmailAnalytics200ResponseJsonConverter" /> class.
        /// </summary>
        public GetProjectEmailAnalytics200ResponseJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="GetProjectEmailAnalytics200Response" />
        /// </summary>
        ...
        public override GetProjectEmailAnalytics200Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (success.IsSet && success.Value == null)
                throw new ArgumentNullException(nameof(success), "Property is not nullable for class GetProjectEmailAnalytics200Response.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class GetProjectEmailAnalytics200Response.");

            return new GetProjectEmailAnalytics200Response(success, data);
        }

        /// <summary>
        /// Serializes a <see cref="GetProjectEmailAnalytics200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getProjectEmailAnalytics200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, GetProjectEmailAnalytics200Response getProjectEmailAnalytics200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, getProjectEmailAnalytics200Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="GetProjectEmailAnalytics200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getProjectEmailAnalytics200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, GetProjectEmailAnalytics200Response getProjectEmailAnalytics200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (getProjectEmailAnalytics200Response.DataOption.IsSet && getProjectEmailAnalytics200Response.Data == null)
                throw new ArgumentNullException(nameof(getProjectEmailAnalytics200Response.Data), "Property is required for class GetProjectEmailAnalytics200Response.");

            if (getProjectEmailAnalytics200Response.SuccessOption.IsSet)
                writer.WriteBoolean("success", getProjectEmailAnalytics200Response.SuccessOption.Value!.Value);

            if (getProjectEmailAnalytics200Response.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, getProjectEmailAnalytics200Response.Data, jsonSerializerOptions);
            }
        }
    }
}
