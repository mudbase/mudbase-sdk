...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class GetPublicPlans200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetPublicPlans200Response" /> class.
        /// </summary>
        /// <param name="plans">plans</param>
        [JsonConstructor]
        public GetPublicPlans200Response(Option<List<Plan>?> plans = default)
        {
            PlansOption = plans;
            OnCreated();
        }
    ...
    public partial class GetPublicPlans200ResponseJsonConverter : JsonConverter<GetPublicPlans200Response>
    {
        ...
        public override GetPublicPlans200Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (plans.IsSet && plans.Value == null)
                throw new ArgumentNullException(nameof(plans), "Property is not nullable for class GetPublicPlans200Response.");

            return new GetPublicPlans200Response(plans);
        }

        /// <summary>
        /// Serializes a <see cref="GetPublicPlans200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getPublicPlans200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, GetPublicPlans200Response getPublicPlans200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, getPublicPlans200Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="GetPublicPlans200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getPublicPlans200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, GetPublicPlans200Response getPublicPlans200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (getPublicPlans200Response.PlansOption.IsSet && getPublicPlans200Response.Plans == null)
                throw new ArgumentNullException(nameof(getPublicPlans200Response.Plans), "Property is required for class GetPublicPlans200Response.");

            if (getPublicPlans200Response.PlansOption.IsSet)
            {
                writer.WritePropertyName("plans");
                JsonSerializer.Serialize(writer, getPublicPlans200Response.Plans, jsonSerializerOptions);
            }
        }
    }
}
