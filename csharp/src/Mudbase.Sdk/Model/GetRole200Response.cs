...
namespace Mudbase.Sdk.Model
{
    ...
    /// GetRole200Response
    /// </summary>
    public partial class GetRole200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetRole200Response" /> class.
        /// </summary>
        /// <param name="role">role</param>
        [JsonConstructor]
        public GetRole200Response(Option<Object?> role = default)
        {
            RoleOption = role;
            OnCreated();
        }
    ...
    public class GetRole200ResponseJsonConverter : JsonConverter<GetRole200Response>
    {
        ...
        public override GetRole200Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (role.IsSet && role.Value == null)
                throw new ArgumentNullException(nameof(role), "Property is not nullable for class GetRole200Response.");

            return new GetRole200Response(role);
        }

        /// <summary>
        /// Serializes a <see cref="GetRole200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getRole200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, GetRole200Response getRole200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, getRole200Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="GetRole200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getRole200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, GetRole200Response getRole200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (getRole200Response.RoleOption.IsSet && getRole200Response.Role == null)
                throw new ArgumentNullException(nameof(getRole200Response.Role), "Property is required for class GetRole200Response.");

            if (getRole200Response.RoleOption.IsSet)
            {
                writer.WritePropertyName("role");
                JsonSerializer.Serialize(writer, getRole200Response.Role, jsonSerializerOptions);
            }
        }
    }
}
