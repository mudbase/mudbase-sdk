...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class GetRoleElevationStatus200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetRoleElevationStatus200Response" /> class.
        /// </summary>
        /// <param name="requests">requests</param>
        [JsonConstructor]
        public GetRoleElevationStatus200Response(Option<List<Object>?> requests = default)
        {
    ...
    public partial class GetRoleElevationStatus200ResponseJsonConverter : JsonConverter<GetRoleElevationStatus200Response>
    {
        ...
        public override GetRoleElevationStatus200Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (requests.IsSet && requests.Value == null)
                throw new ArgumentNullException(nameof(requests), "Property is not nullable for class GetRoleElevationStatus200Response.");

            return new GetRoleElevationStatus200Response(requests);
        }

        /// <summary>
        /// Serializes a <see cref="GetRoleElevationStatus200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getRoleElevationStatus200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, GetRoleElevationStatus200Response getRoleElevationStatus200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, getRoleElevationStatus200Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="GetRoleElevationStatus200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getRoleElevationStatus200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, GetRoleElevationStatus200Response getRoleElevationStatus200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (getRoleElevationStatus200Response.RequestsOption.IsSet && getRoleElevationStatus200Response.Requests == null)
                throw new ArgumentNullException(nameof(getRoleElevationStatus200Response.Requests), "Property is required for class GetRoleElevationStatus200Response.");

            if (getRoleElevationStatus200Response.RequestsOption.IsSet)
            {
                writer.WritePropertyName("requests");
                JsonSerializer.Serialize(writer, getRoleElevationStatus200Response.Requests, jsonSerializerOptions);
            }
        }
    }
}
