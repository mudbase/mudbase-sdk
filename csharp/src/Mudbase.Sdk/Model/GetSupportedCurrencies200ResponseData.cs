...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class GetSupportedCurrencies200ResponseData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetSupportedCurrencies200ResponseData" /> class.
        /// </summary>
        /// <param name="currencies">currencies</param>
        /// <param name="count">Number of supported currencies/chains</param>
        [JsonConstructor]
        public GetSupportedCurrencies200ResponseData(Option<List<GetSupportedCurrencies200ResponseDataCurrenciesInner>?> currencies = default, Option<int?> count = default)
        {
        ...
        public Option<List<GetSupportedCurrencies200ResponseDataCurrenciesInner>?> CurrenciesOption { get; private set; }
    ...
    public class GetSupportedCurrencies200ResponseDataJsonConverter : JsonConverter<GetSupportedCurrencies200ResponseData>
    {
        ...
        public override GetSupportedCurrencies200ResponseData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<GetSupportedCurrencies200ResponseDataCurrenciesInner>?> currencies = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "currencies":
                            currencies = new Option<List<GetSupportedCurrencies200ResponseDataCurrenciesInner>?>(JsonSerializer.Deserialize<List<GetSupportedCurrencies200ResponseDataCurrenciesInner>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "count":
            ...
            if (currencies.IsSet && currencies.Value == null)
                throw new ArgumentNullException(nameof(currencies), "Property is not nullable for class GetSupportedCurrencies200ResponseData.");

            if (count.IsSet && count.Value == null)
                throw new ArgumentNullException(nameof(count), "Property is not nullable for class GetSupportedCurrencies200ResponseData.");

            return new GetSupportedCurrencies200ResponseData(currencies, count);
        }

        /// <summary>
        /// Serializes a <see cref="GetSupportedCurrencies200ResponseData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getSupportedCurrencies200ResponseData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, GetSupportedCurrencies200ResponseData getSupportedCurrencies200ResponseData, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, getSupportedCurrencies200ResponseData, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="GetSupportedCurrencies200ResponseData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getSupportedCurrencies200ResponseData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, GetSupportedCurrencies200ResponseData getSupportedCurrencies200ResponseData, JsonSerializerOptions jsonSerializerOptions)
        {
            if (getSupportedCurrencies200ResponseData.CurrenciesOption.IsSet && getSupportedCurrencies200ResponseData.Currencies == null)
                throw new ArgumentNullException(nameof(getSupportedCurrencies200ResponseData.Currencies), "Property is required for class GetSupportedCurrencies200ResponseData.");

            if (getSupportedCurrencies200ResponseData.CurrenciesOption.IsSet)
            {
                writer.WritePropertyName("currencies");
                JsonSerializer.Serialize(writer, getSupportedCurrencies200ResponseData.Currencies, jsonSerializerOptions);
            }
            if (getSupportedCurrencies200ResponseData.CountOption.IsSet)
                writer.WriteNumber("count", getSupportedCurrencies200ResponseData.CountOption.Value!.Value);
        }
    }
}
