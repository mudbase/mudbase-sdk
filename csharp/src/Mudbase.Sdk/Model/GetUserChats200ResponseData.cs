...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class GetUserChats200ResponseData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetUserChats200ResponseData" /> class.
        /// </summary>
        /// <param name="chats">chats</param>
        /// <param name="total">total</param>
        [JsonConstructor]
        public GetUserChats200ResponseData(Option<List<GetUserChats200ResponseDataChatsInner>?> chats = default, Option<int?> total = default)
        {
            ChatsOption = chats;
            TotalOption = total;
            OnCreated();
        ...
        public Option<List<GetUserChats200ResponseDataChatsInner>?> ChatsOption { get; private set; }
    ...
    public partial class GetUserChats200ResponseDataJsonConverter : JsonConverter<GetUserChats200ResponseData>
    {
        ...
        public override GetUserChats200ResponseData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<GetUserChats200ResponseDataChatsInner>?> chats = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "chats":
                            chats = new Option<List<GetUserChats200ResponseDataChatsInner>?>(JsonSerializer.Deserialize<List<GetUserChats200ResponseDataChatsInner>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "total":
            ...
            if (chats.IsSet && chats.Value == null)
                throw new ArgumentNullException(nameof(chats), "Property is not nullable for class GetUserChats200ResponseData.");

            if (total.IsSet && total.Value == null)
                throw new ArgumentNullException(nameof(total), "Property is not nullable for class GetUserChats200ResponseData.");

            return new GetUserChats200ResponseData(chats, total);
        }

        /// <summary>
        /// Serializes a <see cref="GetUserChats200ResponseData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getUserChats200ResponseData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, GetUserChats200ResponseData getUserChats200ResponseData, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, getUserChats200ResponseData, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="GetUserChats200ResponseData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getUserChats200ResponseData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, GetUserChats200ResponseData getUserChats200ResponseData, JsonSerializerOptions jsonSerializerOptions)
        {
            if (getUserChats200ResponseData.ChatsOption.IsSet && getUserChats200ResponseData.Chats == null)
                throw new ArgumentNullException(nameof(getUserChats200ResponseData.Chats), "Property is required for class GetUserChats200ResponseData.");

            if (getUserChats200ResponseData.ChatsOption.IsSet)
            {
                writer.WritePropertyName("chats");
                JsonSerializer.Serialize(writer, getUserChats200ResponseData.Chats, jsonSerializerOptions);
            }
            if (getUserChats200ResponseData.TotalOption.IsSet)
                writer.WriteNumber("total", getUserChats200ResponseData.TotalOption.Value!.Value);
        }
    }
}
