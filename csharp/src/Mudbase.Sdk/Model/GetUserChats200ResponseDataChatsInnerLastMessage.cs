...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class GetUserChats200ResponseDataChatsInnerLastMessage : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetUserChats200ResponseDataChatsInnerLastMessage" /> class.
        /// </summary>
        /// <param name="content">content</param>
        [JsonConstructor]
        public GetUserChats200ResponseDataChatsInnerLastMessage(Option<string?> content = default)
        {
    ...
    public class GetUserChats200ResponseDataChatsInnerLastMessageJsonConverter : JsonConverter<GetUserChats200ResponseDataChatsInnerLastMessage>
    {
        ...
        public override GetUserChats200ResponseDataChatsInnerLastMessage Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (content.IsSet && content.Value == null)
                throw new ArgumentNullException(nameof(content), "Property is not nullable for class GetUserChats200ResponseDataChatsInnerLastMessage.");

            return new GetUserChats200ResponseDataChatsInnerLastMessage(content);
        }

        /// <summary>
        /// Serializes a <see cref="GetUserChats200ResponseDataChatsInnerLastMessage" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getUserChats200ResponseDataChatsInnerLastMessage"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, GetUserChats200ResponseDataChatsInnerLastMessage getUserChats200ResponseDataChatsInnerLastMessage, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, getUserChats200ResponseDataChatsInnerLastMessage, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="GetUserChats200ResponseDataChatsInnerLastMessage" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getUserChats200ResponseDataChatsInnerLastMessage"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, GetUserChats200ResponseDataChatsInnerLastMessage getUserChats200ResponseDataChatsInnerLastMessage, JsonSerializerOptions jsonSerializerOptions)
        {
            if (getUserChats200ResponseDataChatsInnerLastMessage.ContentOption.IsSet && getUserChats200ResponseDataChatsInnerLastMessage.Content == null)
                throw new ArgumentNullException(nameof(getUserChats200ResponseDataChatsInnerLastMessage.Content), "Property is required for class GetUserChats200ResponseDataChatsInnerLastMessage.");

            if (getUserChats200ResponseDataChatsInnerLastMessage.ContentOption.IsSet)
                writer.WriteString("content", getUserChats200ResponseDataChatsInnerLastMessage.Content);
        }
    }
}
