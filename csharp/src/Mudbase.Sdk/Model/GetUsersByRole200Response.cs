...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class GetUsersByRole200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetUsersByRole200Response" /> class.
        /// </summary>
        /// <param name="users">users</param>
        /// <param name="total">total</param>
        [JsonConstructor]
        public GetUsersByRole200Response(Option<List<Object>?> users = default, Option<int?> total = default)
        {
            UsersOption = users;
            TotalOption = total;
            OnCreated();
    ...
    /// <summary>
    /// A Json converter for type <see cref="GetUsersByRole200Response" />
    /// </summary>
    public partial class GetUsersByRole200ResponseJsonConverter : JsonConverter<GetUsersByRole200Response>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="GetUsersByRole200ResponseJsonConverter" /> class.
        /// </summary>
        public GetUsersByRole200ResponseJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="GetUsersByRole200Response" />
        /// </summary>
        ...
        public override GetUsersByRole200Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (users.IsSet && users.Value == null)
                throw new ArgumentNullException(nameof(users), "Property is not nullable for class GetUsersByRole200Response.");

            if (total.IsSet && total.Value == null)
                throw new ArgumentNullException(nameof(total), "Property is not nullable for class GetUsersByRole200Response.");

            return new GetUsersByRole200Response(users, total);
        }

        /// <summary>
        /// Serializes a <see cref="GetUsersByRole200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getUsersByRole200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, GetUsersByRole200Response getUsersByRole200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, getUsersByRole200Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="GetUsersByRole200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getUsersByRole200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, GetUsersByRole200Response getUsersByRole200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (getUsersByRole200Response.UsersOption.IsSet && getUsersByRole200Response.Users == null)
                throw new ArgumentNullException(nameof(getUsersByRole200Response.Users), "Property is required for class GetUsersByRole200Response.");

            if (getUsersByRole200Response.UsersOption.IsSet)
            {
                writer.WritePropertyName("users");
                JsonSerializer.Serialize(writer, getUsersByRole200Response.Users, jsonSerializerOptions);
            }
            if (getUsersByRole200Response.TotalOption.IsSet)
                writer.WriteNumber("total", getUsersByRole200Response.TotalOption.Value!.Value);
        }
    }
}
