...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class GetWebhookConfig404Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetWebhookConfig404Response" /> class.
        /// </summary>
        /// <param name="success">success</param>
        /// <param name="error">error</param>
        [JsonConstructor]
        public GetWebhookConfig404Response(Option<bool?> success = default, Option<string?> error = default)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="GetWebhookConfig404Response" />
    /// </summary>
    public partial class GetWebhookConfig404ResponseJsonConverter : JsonConverter<GetWebhookConfig404Response>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="GetWebhookConfig404ResponseJsonConverter" /> class.
        /// </summary>
        public GetWebhookConfig404ResponseJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="GetWebhookConfig404Response" />
        /// </summary>
        ...
        public override GetWebhookConfig404Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (success.IsSet && success.Value == null)
                throw new ArgumentNullException(nameof(success), "Property is not nullable for class GetWebhookConfig404Response.");

            if (error.IsSet && error.Value == null)
                throw new ArgumentNullException(nameof(error), "Property is not nullable for class GetWebhookConfig404Response.");

            return new GetWebhookConfig404Response(success, error);
        }

        /// <summary>
        /// Serializes a <see cref="GetWebhookConfig404Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getWebhookConfig404Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, GetWebhookConfig404Response getWebhookConfig404Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, getWebhookConfig404Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="GetWebhookConfig404Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getWebhookConfig404Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, GetWebhookConfig404Response getWebhookConfig404Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (getWebhookConfig404Response.ErrorOption.IsSet && getWebhookConfig404Response.Error == null)
                throw new ArgumentNullException(nameof(getWebhookConfig404Response.Error), "Property is required for class GetWebhookConfig404Response.");

            if (getWebhookConfig404Response.SuccessOption.IsSet)
                writer.WriteBoolean("success", getWebhookConfig404Response.SuccessOption.Value!.Value);

            if (getWebhookConfig404Response.ErrorOption.IsSet)
                writer.WriteString("error", getWebhookConfig404Response.Error);
        }
    }
}
