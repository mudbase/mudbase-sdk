...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class HandleFlutterwaveWebhookRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HandleFlutterwaveWebhookRequest" /> class.
        /// </summary>
        /// <param name="event">Event type (e.g. charge.completed, payment.successful)</param>
        /// <param name="data">data</param>
        [JsonConstructor]
        public HandleFlutterwaveWebhookRequest(Option<string?> @event = default, Option<HandleFlutterwaveWebhookRequestData?> data = default)
        {
            EventOption = @event;
            DataOption = data;
            OnCreated();
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<HandleFlutterwaveWebhookRequestData?> DataOption { get; private set; }
    ...
    public class HandleFlutterwaveWebhookRequestJsonConverter : JsonConverter<HandleFlutterwaveWebhookRequest>
    {
        ...
        public override HandleFlutterwaveWebhookRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<HandleFlutterwaveWebhookRequestData?> data = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "event":
                            ...
                            break;
                        case "data":
                            data = new Option<HandleFlutterwaveWebhookRequestData?>(JsonSerializer.Deserialize<HandleFlutterwaveWebhookRequestData>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (varEvent.IsSet && varEvent.Value == null)
                throw new ArgumentNullException(nameof(varEvent), "Property is not nullable for class HandleFlutterwaveWebhookRequest.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class HandleFlutterwaveWebhookRequest.");

            return new HandleFlutterwaveWebhookRequest(varEvent, data);
        }

        /// <summary>
        /// Serializes a <see cref="HandleFlutterwaveWebhookRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="handleFlutterwaveWebhookRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, HandleFlutterwaveWebhookRequest handleFlutterwaveWebhookRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, handleFlutterwaveWebhookRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="HandleFlutterwaveWebhookRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="handleFlutterwaveWebhookRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, HandleFlutterwaveWebhookRequest handleFlutterwaveWebhookRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (handleFlutterwaveWebhookRequest.EventOption.IsSet && handleFlutterwaveWebhookRequest.Event == null)
                throw new ArgumentNullException(nameof(handleFlutterwaveWebhookRequest.Event), "Property is required for class HandleFlutterwaveWebhookRequest.");

            if (handleFlutterwaveWebhookRequest.DataOption.IsSet && handleFlutterwaveWebhookRequest.Data == null)
                throw new ArgumentNullException(nameof(handleFlutterwaveWebhookRequest.Data), "Property is required for class HandleFlutterwaveWebhookRequest.");

            if (handleFlutterwaveWebhookRequest.EventOption.IsSet)
                writer.WriteString("event", handleFlutterwaveWebhookRequest.Event);

            if (handleFlutterwaveWebhookRequest.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, handleFlutterwaveWebhookRequest.Data, jsonSerializerOptions);
            }
        }
    }
}
