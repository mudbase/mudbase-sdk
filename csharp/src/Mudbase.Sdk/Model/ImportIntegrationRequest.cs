...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class ImportIntegrationRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ImportIntegrationRequest" /> class.
        /// </summary>
        /// <param name="integrationData">integrationData</param>
        [JsonConstructor]
        public ImportIntegrationRequest(Object integrationData)
        {
    ...
    public class ImportIntegrationRequestJsonConverter : JsonConverter<ImportIntegrationRequest>
    {
        ...
        public override ImportIntegrationRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<Object?> integrationData = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "integrationData":
                            integrationData = new Option<Object?>(JsonSerializer.Deserialize<Object>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (!integrationData.IsSet)
                throw new ArgumentException("Property is required for class ImportIntegrationRequest.", nameof(integrationData));

            if (integrationData.IsSet && integrationData.Value == null)
                throw new ArgumentNullException(nameof(integrationData), "Property is not nullable for class ImportIntegrationRequest.");

            return new ImportIntegrationRequest(integrationData.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="ImportIntegrationRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="importIntegrationRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ImportIntegrationRequest importIntegrationRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, importIntegrationRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ImportIntegrationRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="importIntegrationRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ImportIntegrationRequest importIntegrationRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (importIntegrationRequest.IntegrationData == null)
                throw new ArgumentNullException(nameof(importIntegrationRequest.IntegrationData), "Property is required for class ImportIntegrationRequest.");

            writer.WritePropertyName("integrationData");
            JsonSerializer.Serialize(writer, importIntegrationRequest.IntegrationData, jsonSerializerOptions);
        }
    }
}
