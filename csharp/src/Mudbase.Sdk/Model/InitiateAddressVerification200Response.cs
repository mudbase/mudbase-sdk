...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class InitiateAddressVerification200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InitiateAddressVerification200Response" /> class.
        /// </summary>
        /// <param name="success">success</param>
        /// <param name="message">message</param>
        /// <param name="verificationStatus">verificationStatus</param>
        [JsonConstructor]
        public InitiateAddressVerification200Response(Option<bool?> success = default, Option<string?> message = default, Option<string?> verificationStatus = default)
        {
    ...
    public partial class InitiateAddressVerification200ResponseJsonConverter : JsonConverter<InitiateAddressVerification200Response>
    {
        ...
        public override InitiateAddressVerification200Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (success.IsSet && success.Value == null)
                throw new ArgumentNullException(nameof(success), "Property is not nullable for class InitiateAddressVerification200Response.");

            if (message.IsSet && message.Value == null)
                throw new ArgumentNullException(nameof(message), "Property is not nullable for class InitiateAddressVerification200Response.");

            if (verificationStatus.IsSet && verificationStatus.Value == null)
                throw new ArgumentNullException(nameof(verificationStatus), "Property is not nullable for class InitiateAddressVerification200Response.");

            return new InitiateAddressVerification200Response(success, message, verificationStatus);
        }

        /// <summary>
        /// Serializes a <see cref="InitiateAddressVerification200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="initiateAddressVerification200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, InitiateAddressVerification200Response initiateAddressVerification200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, initiateAddressVerification200Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="InitiateAddressVerification200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="initiateAddressVerification200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, InitiateAddressVerification200Response initiateAddressVerification200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (initiateAddressVerification200Response.MessageOption.IsSet && initiateAddressVerification200Response.Message == null)
                throw new ArgumentNullException(nameof(initiateAddressVerification200Response.Message), "Property is required for class InitiateAddressVerification200Response.");

            if (initiateAddressVerification200Response.VerificationStatusOption.IsSet && initiateAddressVerification200Response.VerificationStatus == null)
                throw new ArgumentNullException(nameof(initiateAddressVerification200Response.VerificationStatus), "Property is required for class InitiateAddressVerification200Response.");

            if (initiateAddressVerification200Response.SuccessOption.IsSet)
                writer.WriteBoolean("success", initiateAddressVerification200Response.SuccessOption.Value!.Value);

            if (initiateAddressVerification200Response.MessageOption.IsSet)
                writer.WriteString("message", initiateAddressVerification200Response.Message);

            if (initiateAddressVerification200Response.VerificationStatusOption.IsSet)
                writer.WriteString("verificationStatus", initiateAddressVerification200Response.VerificationStatus);
        }
    }
}
