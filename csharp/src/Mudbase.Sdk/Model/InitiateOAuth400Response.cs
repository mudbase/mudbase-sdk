...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class InitiateOAuth400Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InitiateOAuth400Response" /> class.
        /// </summary>
        /// <param name="error">error</param>
        [JsonConstructor]
        public InitiateOAuth400Response(Option<string?> error = default)
        {
            ErrorOption = error;
            OnCreated();
        }
    ...
    public class InitiateOAuth400ResponseJsonConverter : JsonConverter<InitiateOAuth400Response>
    {
        ...
        public override InitiateOAuth400Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (error.IsSet && error.Value == null)
                throw new ArgumentNullException(nameof(error), "Property is not nullable for class InitiateOAuth400Response.");

            return new InitiateOAuth400Response(error);
        }

        /// <summary>
        /// Serializes a <see cref="InitiateOAuth400Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="initiateOAuth400Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, InitiateOAuth400Response initiateOAuth400Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, initiateOAuth400Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="InitiateOAuth400Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="initiateOAuth400Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, InitiateOAuth400Response initiateOAuth400Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (initiateOAuth400Response.ErrorOption.IsSet && initiateOAuth400Response.Error == null)
                throw new ArgumentNullException(nameof(initiateOAuth400Response.Error), "Property is required for class InitiateOAuth400Response.");

            if (initiateOAuth400Response.ErrorOption.IsSet)
                writer.WriteString("error", initiateOAuth400Response.Error);
        }
    }
}
