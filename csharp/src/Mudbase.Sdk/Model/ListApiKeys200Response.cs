...
namespace Mudbase.Sdk.Model
{
    ...
    public partial class ListApiKeys200Response : IValidatableObject
    {
        ...
        [JsonConstructor]
        public ListApiKeys200Response(Option<List<ApiKey>?> apiKeys = default, Option<int?> total = default)
        {
        ...
        public Option<List<ApiKey>?> ApiKeysOption { get; private set; }
    ...
    public partial class ListApiKeys200ResponseJsonConverter : JsonConverter<ListApiKeys200Response>
    {
        ...
        public override ListApiKeys200Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<ApiKey>?> apiKeys = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "apiKeys":
                            apiKeys = new Option<List<ApiKey>?>(JsonSerializer.Deserialize<List<ApiKey>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "total":
            ...
            if (apiKeys.IsSet && apiKeys.Value == null)
                throw new ArgumentNullException(nameof(apiKeys), "Property is not nullable for class ListApiKeys200Response.");

            if (total.IsSet && total.Value == null)
                throw new ArgumentNullException(nameof(total), "Property is not nullable for class ListApiKeys200Response.");

            return new ListApiKeys200Response(apiKeys, total);
        }

        /// <summary>
        /// Serializes a <see cref="ListApiKeys200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="listApiKeys200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ListApiKeys200Response listApiKeys200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, listApiKeys200Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ListApiKeys200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="listApiKeys200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ListApiKeys200Response listApiKeys200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (listApiKeys200Response.ApiKeysOption.IsSet && listApiKeys200Response.ApiKeys == null)
                throw new ArgumentNullException(nameof(listApiKeys200Response.ApiKeys), "Property is required for class ListApiKeys200Response.");

            if (listApiKeys200Response.ApiKeysOption.IsSet)
            {
                writer.WritePropertyName("apiKeys");
                JsonSerializer.Serialize(writer, listApiKeys200Response.ApiKeys, jsonSerializerOptions);
            }
            if (listApiKeys200Response.TotalOption.IsSet)
                writer.WriteNumber("total", listApiKeys200Response.TotalOption.Value!.Value);
        }
    }
}
