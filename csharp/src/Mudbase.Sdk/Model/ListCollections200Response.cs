...
namespace Mudbase.Sdk.Model
{
    ...
    public partial class ListCollections200Response : IValidatableObject
    {
        ...
        [JsonConstructor]
        public ListCollections200Response(Option<List<Collection>?> collections = default, Option<int?> total = default)
        {
        ...
        public List<Collection>? Collections { get { return this.CollectionsOption.Value; } set { this.CollectionsOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="ListCollections200Response" />
    /// </summary>
    public partial class ListCollections200ResponseJsonConverter : JsonConverter<ListCollections200Response>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="ListCollections200ResponseJsonConverter" /> class.
        /// </summary>
        public ListCollections200ResponseJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="ListCollections200Response" />
        /// </summary>
        ...
        public override ListCollections200Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (collections.IsSet && collections.Value == null)
                throw new ArgumentNullException(nameof(collections), "Property is not nullable for class ListCollections200Response.");

            if (total.IsSet && total.Value == null)
                throw new ArgumentNullException(nameof(total), "Property is not nullable for class ListCollections200Response.");

            return new ListCollections200Response(collections, total);
        }

        /// <summary>
        /// Serializes a <see cref="ListCollections200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="listCollections200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ListCollections200Response listCollections200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, listCollections200Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ListCollections200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="listCollections200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ListCollections200Response listCollections200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (listCollections200Response.CollectionsOption.IsSet && listCollections200Response.Collections == null)
                throw new ArgumentNullException(nameof(listCollections200Response.Collections), "Property is required for class ListCollections200Response.");

            if (listCollections200Response.CollectionsOption.IsSet)
            {
                writer.WritePropertyName("collections");
                JsonSerializer.Serialize(writer, listCollections200Response.Collections, jsonSerializerOptions);
            }
            if (listCollections200Response.TotalOption.IsSet)
                writer.WriteNumber("total", listCollections200Response.TotalOption.Value!.Value);
        }
    }
}
