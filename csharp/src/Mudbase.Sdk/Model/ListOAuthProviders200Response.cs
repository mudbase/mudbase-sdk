...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class ListOAuthProviders200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListOAuthProviders200Response" /> class.
        /// </summary>
        /// <param name="providers">providers</param>
        [JsonConstructor]
        public ListOAuthProviders200Response(Option<List<ListOAuthProviders200ResponseProvidersInner>?> providers = default)
        {
        ...
        public Option<List<ListOAuthProviders200ResponseProvidersInner>?> ProvidersOption { get; private set; }
    ...
    public class ListOAuthProviders200ResponseJsonConverter : JsonConverter<ListOAuthProviders200Response>
    {
        ...
        public override ListOAuthProviders200Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<ListOAuthProviders200ResponseProvidersInner>?> providers = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "providers":
                            providers = new Option<List<ListOAuthProviders200ResponseProvidersInner>?>(JsonSerializer.Deserialize<List<ListOAuthProviders200ResponseProvidersInner>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (providers.IsSet && providers.Value == null)
                throw new ArgumentNullException(nameof(providers), "Property is not nullable for class ListOAuthProviders200Response.");

            return new ListOAuthProviders200Response(providers);
        }

        /// <summary>
        /// Serializes a <see cref="ListOAuthProviders200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="listOAuthProviders200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ListOAuthProviders200Response listOAuthProviders200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, listOAuthProviders200Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ListOAuthProviders200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="listOAuthProviders200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ListOAuthProviders200Response listOAuthProviders200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (listOAuthProviders200Response.ProvidersOption.IsSet && listOAuthProviders200Response.Providers == null)
                throw new ArgumentNullException(nameof(listOAuthProviders200Response.Providers), "Property is required for class ListOAuthProviders200Response.");

            if (listOAuthProviders200Response.ProvidersOption.IsSet)
            {
                writer.WritePropertyName("providers");
                JsonSerializer.Serialize(writer, listOAuthProviders200Response.Providers, jsonSerializerOptions);
            }
        }
    }
}
