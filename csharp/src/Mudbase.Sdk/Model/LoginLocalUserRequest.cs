...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class LoginLocalUserRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LoginLocalUserRequest" /> class.
        /// </summary>
        /// <param name="email">email</param>
        /// <param name="password">password</param>
        /// <param name="projectId">projectId</param>
        [JsonConstructor]
        public LoginLocalUserRequest(string email, string password, Option<string?> projectId = default)
        {
            Email = email;
            Password = password;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LoginLocalUserRequest {\n");
    ...
    public partial class LoginLocalUserRequestJsonConverter : JsonConverter<LoginLocalUserRequest>
    {
        ...
        public override LoginLocalUserRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!email.IsSet)
                throw new ArgumentException("Property is required for class LoginLocalUserRequest.", nameof(email));

            if (!password.IsSet)
                throw new ArgumentException("Property is required for class LoginLocalUserRequest.", nameof(password));

            if (email.IsSet && email.Value == null)
                throw new ArgumentNullException(nameof(email), "Property is not nullable for class LoginLocalUserRequest.");

            if (password.IsSet && password.Value == null)
                throw new ArgumentNullException(nameof(password), "Property is not nullable for class LoginLocalUserRequest.");

            if (projectId.IsSet && projectId.Value == null)
                throw new ArgumentNullException(nameof(projectId), "Property is not nullable for class LoginLocalUserRequest.");

            return new LoginLocalUserRequest(email.Value!, password.Value!, projectId);
        }

        /// <summary>
        /// Serializes a <see cref="LoginLocalUserRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="loginLocalUserRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, LoginLocalUserRequest loginLocalUserRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, loginLocalUserRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="LoginLocalUserRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="loginLocalUserRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, LoginLocalUserRequest loginLocalUserRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (loginLocalUserRequest.Email == null)
                throw new ArgumentNullException(nameof(loginLocalUserRequest.Email), "Property is required for class LoginLocalUserRequest.");

            if (loginLocalUserRequest.Password == null)
                throw new ArgumentNullException(nameof(loginLocalUserRequest.Password), "Property is required for class LoginLocalUserRequest.");

            if (loginLocalUserRequest.ProjectIdOption.IsSet && loginLocalUserRequest.ProjectId == null)
                throw new ArgumentNullException(nameof(loginLocalUserRequest.ProjectId), "Property is required for class LoginLocalUserRequest.");

            writer.WriteString("email", loginLocalUserRequest.Email);

            writer.WriteString("password", loginLocalUserRequest.Password);

            if (loginLocalUserRequest.ProjectIdOption.IsSet)
                writer.WriteString("projectId", loginLocalUserRequest.ProjectId);
        }
    }
}
