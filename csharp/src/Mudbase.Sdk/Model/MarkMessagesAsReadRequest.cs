...
namespace Mudbase.Sdk.Model
{
    ...
    public partial class MarkMessagesAsReadRequest : IValidatableObject
    {
        ...
        [JsonConstructor]
        public MarkMessagesAsReadRequest(List<string> messageIds)
        {
    ...
    public class MarkMessagesAsReadRequestJsonConverter : JsonConverter<MarkMessagesAsReadRequest>
    {
        ...
        public override MarkMessagesAsReadRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!messageIds.IsSet)
                throw new ArgumentException("Property is required for class MarkMessagesAsReadRequest.", nameof(messageIds));

            if (messageIds.IsSet && messageIds.Value == null)
                throw new ArgumentNullException(nameof(messageIds), "Property is not nullable for class MarkMessagesAsReadRequest.");

            return new MarkMessagesAsReadRequest(messageIds.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="MarkMessagesAsReadRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="markMessagesAsReadRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, MarkMessagesAsReadRequest markMessagesAsReadRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, markMessagesAsReadRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="MarkMessagesAsReadRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="markMessagesAsReadRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, MarkMessagesAsReadRequest markMessagesAsReadRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (markMessagesAsReadRequest.MessageIds == null)
                throw new ArgumentNullException(nameof(markMessagesAsReadRequest.MessageIds), "Property is required for class MarkMessagesAsReadRequest.");

            writer.WritePropertyName("messageIds");
            JsonSerializer.Serialize(writer, markMessagesAsReadRequest.MessageIds, jsonSerializerOptions);
        }
    }
}
