...
namespace Mudbase.Sdk.Model
{
    ...
    public partial class MessageResponse : IValidatableObject
    {
        ...
        [JsonConstructor]
        public MessageResponse(Option<string?> message = default)
        {
    ...
    public class MessageResponseJsonConverter : JsonConverter<MessageResponse>
    {
        ...
        public override MessageResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (message.IsSet && message.Value == null)
                throw new ArgumentNullException(nameof(message), "Property is not nullable for class MessageResponse.");
        ...
        {
            if (messageResponse.MessageOption.IsSet && messageResponse.Message == null)
                throw new ArgumentNullException(nameof(messageResponse.Message), "Property is required for class MessageResponse.");

            if (messageResponse.MessageOption.IsSet)
                writer.WriteString("message", messageResponse.Message);
        }
    }
}
