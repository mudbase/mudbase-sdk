...
namespace Mudbase.Sdk.Model
{
    ...
    public partial class MessageSentResponse : IValidatableObject
    {
        ...
        [JsonConstructor]
        public MessageSentResponse(Option<bool?> success = default, Option<MessageSentResponseData?> data = default)
        {
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<MessageSentResponseData?> DataOption { get; private set; }

        /// <summary>
        /// Gets or Sets Data
        /// </summary>
        [JsonPropertyName("data")]
        public MessageSentResponseData? Data { get { return this.DataOption.Value; } set { this.DataOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="MessageSentResponse" />
    /// </summary>
    public partial class MessageSentResponseJsonConverter : JsonConverter<MessageSentResponse>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="MessageSentResponseJsonConverter" /> class.
        /// </summary>
        public MessageSentResponseJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="MessageSentResponse" />
        /// </summary>
        ...
        public override MessageSentResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<MessageSentResponseData?> data = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "success":
                            ...
                            break;
                        case "data":
                            data = new Option<MessageSentResponseData?>(JsonSerializer.Deserialize<MessageSentResponseData>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (success.IsSet && success.Value == null)
                throw new ArgumentNullException(nameof(success), "Property is not nullable for class MessageSentResponse.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class MessageSentResponse.");

            return new MessageSentResponse(success, data);
        }

        /// <summary>
        /// Serializes a <see cref="MessageSentResponse" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="messageSentResponse"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, MessageSentResponse messageSentResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, messageSentResponse, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="MessageSentResponse" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="messageSentResponse"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, MessageSentResponse messageSentResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            if (messageSentResponse.DataOption.IsSet && messageSentResponse.Data == null)
                throw new ArgumentNullException(nameof(messageSentResponse.Data), "Property is required for class MessageSentResponse.");

            if (messageSentResponse.SuccessOption.IsSet)
                writer.WriteBoolean("success", messageSentResponse.SuccessOption.Value!.Value);

            if (messageSentResponse.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, messageSentResponse.Data, jsonSerializerOptions);
            }
        }
    }
}
