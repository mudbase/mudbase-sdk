...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class MonitoringLogsResponseLogsInnerUser : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MonitoringLogsResponseLogsInnerUser" /> class.
        /// </summary>
        /// <param name="id">id</param>
        /// <param name="email">email</param>
        [JsonConstructor]
        public MonitoringLogsResponseLogsInnerUser(Option<string?> id = default, Option<string?> email = default)
        {
            IdOption = id;
            EmailOption = email;
            OnCreated();
    ...
    public partial class MonitoringLogsResponseLogsInnerUserJsonConverter : JsonConverter<MonitoringLogsResponseLogsInnerUser>
    {
        ...
        public override MonitoringLogsResponseLogsInnerUser Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class MonitoringLogsResponseLogsInnerUser.");

            if (email.IsSet && email.Value == null)
                throw new ArgumentNullException(nameof(email), "Property is not nullable for class MonitoringLogsResponseLogsInnerUser.");

            return new MonitoringLogsResponseLogsInnerUser(id, email);
        }

        /// <summary>
        /// Serializes a <see cref="MonitoringLogsResponseLogsInnerUser" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="monitoringLogsResponseLogsInnerUser"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, MonitoringLogsResponseLogsInnerUser monitoringLogsResponseLogsInnerUser, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, monitoringLogsResponseLogsInnerUser, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="MonitoringLogsResponseLogsInnerUser" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="monitoringLogsResponseLogsInnerUser"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, MonitoringLogsResponseLogsInnerUser monitoringLogsResponseLogsInnerUser, JsonSerializerOptions jsonSerializerOptions)
        {
            if (monitoringLogsResponseLogsInnerUser.IdOption.IsSet && monitoringLogsResponseLogsInnerUser.Id == null)
                throw new ArgumentNullException(nameof(monitoringLogsResponseLogsInnerUser.Id), "Property is required for class MonitoringLogsResponseLogsInnerUser.");

            if (monitoringLogsResponseLogsInnerUser.EmailOption.IsSet && monitoringLogsResponseLogsInnerUser.Email == null)
                throw new ArgumentNullException(nameof(monitoringLogsResponseLogsInnerUser.Email), "Property is required for class MonitoringLogsResponseLogsInnerUser.");

            if (monitoringLogsResponseLogsInnerUser.IdOption.IsSet)
                writer.WriteString("id", monitoringLogsResponseLogsInnerUser.Id);

            if (monitoringLogsResponseLogsInnerUser.EmailOption.IsSet)
                writer.WriteString("email", monitoringLogsResponseLogsInnerUser.Email);
        }
    }
}
