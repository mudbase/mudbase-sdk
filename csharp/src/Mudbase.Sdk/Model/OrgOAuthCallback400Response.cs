...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class OrgOAuthCallback400Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrgOAuthCallback400Response" /> class.
        /// </summary>
        /// <param name="error">error</param>
        [JsonConstructor]
        public OrgOAuthCallback400Response(Option<string?> error = default)
        {
            ErrorOption = error;
            OnCreated();
        }
    ...
    public partial class OrgOAuthCallback400ResponseJsonConverter : JsonConverter<OrgOAuthCallback400Response>
    {
        ...
        public override OrgOAuthCallback400Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (error.IsSet && error.Value == null)
                throw new ArgumentNullException(nameof(error), "Property is not nullable for class OrgOAuthCallback400Response.");

            return new OrgOAuthCallback400Response(error);
        }

        /// <summary>
        /// Serializes a <see cref="OrgOAuthCallback400Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="orgOAuthCallback400Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, OrgOAuthCallback400Response orgOAuthCallback400Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, orgOAuthCallback400Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="OrgOAuthCallback400Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="orgOAuthCallback400Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, OrgOAuthCallback400Response orgOAuthCallback400Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (orgOAuthCallback400Response.ErrorOption.IsSet && orgOAuthCallback400Response.Error == null)
                throw new ArgumentNullException(nameof(orgOAuthCallback400Response.Error), "Property is required for class OrgOAuthCallback400Response.");

            if (orgOAuthCallback400Response.ErrorOption.IsSet)
                writer.WriteString("error", orgOAuthCallback400Response.Error);
        }
    }
}
