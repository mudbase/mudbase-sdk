...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class PatchOrgDomainRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PatchOrgDomainRequest" /> class.
        /// </summary>
        /// <param name="status">Org self-serve reset only; go-live is via admin activate.</param>
        /// <param name="regenerateToken">regenerateToken</param>
        [JsonConstructor]
        public PatchOrgDomainRequest(Option<StatusEnum?> status = default, Option<bool?> regenerateToken = default)
        {
            StatusOption = status;
    ...
    public partial class PatchOrgDomainRequestJsonConverter : JsonConverter<PatchOrgDomainRequest>
    {
        ...
        public override PatchOrgDomainRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<PatchOrgDomainRequest.StatusEnum?> status = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "status":
                            ...
                            if (statusRawValue != null)
                                status = new Option<PatchOrgDomainRequest.StatusEnum?>(PatchOrgDomainRequest.StatusEnumFromStringOrDefault(statusRawValue));
                            break;
            ...
            if (status.IsSet && status.Value == null)
                throw new ArgumentNullException(nameof(status), "Property is not nullable for class PatchOrgDomainRequest.");

            if (regenerateToken.IsSet && regenerateToken.Value == null)
                throw new ArgumentNullException(nameof(regenerateToken), "Property is not nullable for class PatchOrgDomainRequest.");

            return new PatchOrgDomainRequest(status, regenerateToken);
        }

        /// <summary>
        /// Serializes a <see cref="PatchOrgDomainRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="patchOrgDomainRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, PatchOrgDomainRequest patchOrgDomainRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, patchOrgDomainRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="PatchOrgDomainRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="patchOrgDomainRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, PatchOrgDomainRequest patchOrgDomainRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            var statusRawValue = PatchOrgDomainRequest.StatusEnumToJsonValue(patchOrgDomainRequest.StatusOption.Value!.Value);
            writer.WriteString("status", statusRawValue);
            if (patchOrgDomainRequest.RegenerateTokenOption.IsSet)
                writer.WriteBoolean("regenerateToken", patchOrgDomainRequest.RegenerateTokenOption.Value!.Value);
        }
    }
}
