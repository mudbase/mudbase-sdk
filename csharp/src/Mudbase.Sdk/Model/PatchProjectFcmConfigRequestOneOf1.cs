...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class PatchProjectFcmConfigRequestOneOf1 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PatchProjectFcmConfigRequestOneOf1" /> class.
        /// </summary>
        /// <param name="clear">clear</param>
        [JsonConstructor]
        public PatchProjectFcmConfigRequestOneOf1(bool clear)
        {
            Clear = clear;
            OnCreated();
        }
    ...
    /// <summary>
    /// A Json converter for type <see cref="PatchProjectFcmConfigRequestOneOf1" />
    /// </summary>
    public partial class PatchProjectFcmConfigRequestOneOf1JsonConverter : JsonConverter<PatchProjectFcmConfigRequestOneOf1>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="PatchProjectFcmConfigRequestOneOf1JsonConverter" /> class.
        /// </summary>
        public PatchProjectFcmConfigRequestOneOf1JsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="PatchProjectFcmConfigRequestOneOf1" />
        /// </summary>
        ...
        public override PatchProjectFcmConfigRequestOneOf1 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "clear":
                            clear = new Option<bool?>(utf8JsonReader.TokenType == JsonTokenType.Null ? (bool?)null : utf8JsonReader.GetBoolean());
                            break;
                        default:
                            break;
                    }
            ...
            if (!clear.IsSet)
                throw new ArgumentException("Property is required for class PatchProjectFcmConfigRequestOneOf1.", nameof(clear));

            if (clear.IsSet && clear.Value == null)
                throw new ArgumentNullException(nameof(clear), "Property is not nullable for class PatchProjectFcmConfigRequestOneOf1.");

            return new PatchProjectFcmConfigRequestOneOf1(clear.Value!.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="PatchProjectFcmConfigRequestOneOf1" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="patchProjectFcmConfigRequestOneOf1"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, PatchProjectFcmConfigRequestOneOf1 patchProjectFcmConfigRequestOneOf1, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, patchProjectFcmConfigRequestOneOf1, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="PatchProjectFcmConfigRequestOneOf1" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="patchProjectFcmConfigRequestOneOf1"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, PatchProjectFcmConfigRequestOneOf1 patchProjectFcmConfigRequestOneOf1, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteBoolean("clear", patchProjectFcmConfigRequestOneOf1.Clear);
        }
    }
}
