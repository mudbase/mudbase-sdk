...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class PlatformAdminActivateOrgCustomDomainRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PlatformAdminActivateOrgCustomDomainRequest" /> class.
        /// </summary>
        /// <param name="notifyOrg">Email org billing contact when domain goes live (default true)</param>
        [JsonConstructor]
        public PlatformAdminActivateOrgCustomDomainRequest(Option<bool?> notifyOrg = default)
        {
    ...
    public class PlatformAdminActivateOrgCustomDomainRequestJsonConverter : JsonConverter<PlatformAdminActivateOrgCustomDomainRequest>
    {
        ...
        public override PlatformAdminActivateOrgCustomDomainRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (notifyOrg.IsSet && notifyOrg.Value == null)
                throw new ArgumentNullException(nameof(notifyOrg), "Property is not nullable for class PlatformAdminActivateOrgCustomDomainRequest.");

            return new PlatformAdminActivateOrgCustomDomainRequest(notifyOrg);
        }

        /// <summary>
        /// Serializes a <see cref="PlatformAdminActivateOrgCustomDomainRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="platformAdminActivateOrgCustomDomainRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, PlatformAdminActivateOrgCustomDomainRequest platformAdminActivateOrgCustomDomainRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, platformAdminActivateOrgCustomDomainRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="PlatformAdminActivateOrgCustomDomainRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="platformAdminActivateOrgCustomDomainRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, PlatformAdminActivateOrgCustomDomainRequest platformAdminActivateOrgCustomDomainRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (platformAdminActivateOrgCustomDomainRequest.NotifyOrgOption.IsSet)
                writer.WriteBoolean("notifyOrg", platformAdminActivateOrgCustomDomainRequest.NotifyOrgOption.Value!.Value);
        }
    }
}
