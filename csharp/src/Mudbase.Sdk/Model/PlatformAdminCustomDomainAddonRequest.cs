...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class PlatformAdminCustomDomainAddonRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PlatformAdminCustomDomainAddonRequest" /> class.
        /// </summary>
        /// <param name="enabled">enabled</param>
        [JsonConstructor]
        public PlatformAdminCustomDomainAddonRequest(bool enabled)
        {
            Enabled = enabled;
            OnCreated();
        }
    ...
    public partial class PlatformAdminCustomDomainAddonRequestJsonConverter : JsonConverter<PlatformAdminCustomDomainAddonRequest>
    {
        ...
        public override PlatformAdminCustomDomainAddonRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!enabled.IsSet)
                throw new ArgumentException("Property is required for class PlatformAdminCustomDomainAddonRequest.", nameof(enabled));

            if (enabled.IsSet && enabled.Value == null)
                throw new ArgumentNullException(nameof(enabled), "Property is not nullable for class PlatformAdminCustomDomainAddonRequest.");

            return new PlatformAdminCustomDomainAddonRequest(enabled.Value!.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="PlatformAdminCustomDomainAddonRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="platformAdminCustomDomainAddonRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, PlatformAdminCustomDomainAddonRequest platformAdminCustomDomainAddonRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, platformAdminCustomDomainAddonRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="PlatformAdminCustomDomainAddonRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="platformAdminCustomDomainAddonRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, PlatformAdminCustomDomainAddonRequest platformAdminCustomDomainAddonRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteBoolean("enabled", platformAdminCustomDomainAddonRequest.Enabled);
        }
    }
}
