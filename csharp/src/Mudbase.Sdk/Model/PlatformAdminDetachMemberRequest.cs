...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class PlatformAdminDetachMemberRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PlatformAdminDetachMemberRequest" /> class.
        /// </summary>
        /// <param name="reason">reason</param>
        [JsonConstructor]
        public PlatformAdminDetachMemberRequest(Option<string?> reason = default)
        {
            ReasonOption = reason;
            OnCreated();
        }
    ...
    public class PlatformAdminDetachMemberRequestJsonConverter : JsonConverter<PlatformAdminDetachMemberRequest>
    {
        ...
        public override PlatformAdminDetachMemberRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (reason.IsSet && reason.Value == null)
                throw new ArgumentNullException(nameof(reason), "Property is not nullable for class PlatformAdminDetachMemberRequest.");

            return new PlatformAdminDetachMemberRequest(reason);
        }

        /// <summary>
        /// Serializes a <see cref="PlatformAdminDetachMemberRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="platformAdminDetachMemberRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, PlatformAdminDetachMemberRequest platformAdminDetachMemberRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, platformAdminDetachMemberRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="PlatformAdminDetachMemberRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="platformAdminDetachMemberRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, PlatformAdminDetachMemberRequest platformAdminDetachMemberRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (platformAdminDetachMemberRequest.ReasonOption.IsSet && platformAdminDetachMemberRequest.Reason == null)
                throw new ArgumentNullException(nameof(platformAdminDetachMemberRequest.Reason), "Property is required for class PlatformAdminDetachMemberRequest.");

            if (platformAdminDetachMemberRequest.ReasonOption.IsSet)
                writer.WriteString("reason", platformAdminDetachMemberRequest.Reason);
        }
    }
}
