...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class ProjectUsageSummaryResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectUsageSummaryResponse" /> class.
        /// </summary>
        /// <param name="success">success</param>
        /// <param name="data">Contains requests, activeUsers, requestVolume14d, latency, platformUptimePct30d, platformUptimeSamples</param>
        [JsonConstructor]
        public ProjectUsageSummaryResponse(Option<bool?> success = default, Option<Object?> data = default)
        {
        ...
        /// </summary>
        /// <value>Contains requests, activeUsers, requestVolume14d, latency, platformUptimePct30d, platformUptimeSamples</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProjectUsageSummaryResponse {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="ProjectUsageSummaryResponse" />
    /// </summary>
    public partial class ProjectUsageSummaryResponseJsonConverter : JsonConverter<ProjectUsageSummaryResponse>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectUsageSummaryResponseJsonConverter" /> class.
        /// </summary>
        public ProjectUsageSummaryResponseJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="ProjectUsageSummaryResponse" />
        /// </summary>
        ...
        public override ProjectUsageSummaryResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (success.IsSet && success.Value == null)
                throw new ArgumentNullException(nameof(success), "Property is not nullable for class ProjectUsageSummaryResponse.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class ProjectUsageSummaryResponse.");

            return new ProjectUsageSummaryResponse(success, data);
        }

        /// <summary>
        /// Serializes a <see cref="ProjectUsageSummaryResponse" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="projectUsageSummaryResponse"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ProjectUsageSummaryResponse projectUsageSummaryResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, projectUsageSummaryResponse, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ProjectUsageSummaryResponse" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="projectUsageSummaryResponse"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ProjectUsageSummaryResponse projectUsageSummaryResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            if (projectUsageSummaryResponse.DataOption.IsSet && projectUsageSummaryResponse.Data == null)
                throw new ArgumentNullException(nameof(projectUsageSummaryResponse.Data), "Property is required for class ProjectUsageSummaryResponse.");

            if (projectUsageSummaryResponse.SuccessOption.IsSet)
                writer.WriteBoolean("success", projectUsageSummaryResponse.SuccessOption.Value!.Value);

            if (projectUsageSummaryResponse.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, projectUsageSummaryResponse.Data, jsonSerializerOptions);
            }
        }
    }
}
