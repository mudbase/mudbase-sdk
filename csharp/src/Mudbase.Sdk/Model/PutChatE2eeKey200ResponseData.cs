...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class PutChatE2eeKey200ResponseData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PutChatE2eeKey200ResponseData" /> class.
        /// </summary>
        /// <param name="identityPublicKey">identityPublicKey</param>
        /// <param name="keyVersion">keyVersion</param>
        /// <param name="updatedAt">updatedAt</param>
        [JsonConstructor]
        public PutChatE2eeKey200ResponseData(Option<string?> identityPublicKey = default, Option<int?> keyVersion = default, Option<DateTime?> updatedAt = default)
        {
    ...
    public partial class PutChatE2eeKey200ResponseDataJsonConverter : JsonConverter<PutChatE2eeKey200ResponseData>
    {
        ...
        public override PutChatE2eeKey200ResponseData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (identityPublicKey.IsSet && identityPublicKey.Value == null)
                throw new ArgumentNullException(nameof(identityPublicKey), "Property is not nullable for class PutChatE2eeKey200ResponseData.");

            if (keyVersion.IsSet && keyVersion.Value == null)
                throw new ArgumentNullException(nameof(keyVersion), "Property is not nullable for class PutChatE2eeKey200ResponseData.");

            if (updatedAt.IsSet && updatedAt.Value == null)
                throw new ArgumentNullException(nameof(updatedAt), "Property is not nullable for class PutChatE2eeKey200ResponseData.");

            return new PutChatE2eeKey200ResponseData(identityPublicKey, keyVersion, updatedAt);
        }

        /// <summary>
        /// Serializes a <see cref="PutChatE2eeKey200ResponseData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="putChatE2eeKey200ResponseData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, PutChatE2eeKey200ResponseData putChatE2eeKey200ResponseData, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, putChatE2eeKey200ResponseData, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="PutChatE2eeKey200ResponseData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="putChatE2eeKey200ResponseData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, PutChatE2eeKey200ResponseData putChatE2eeKey200ResponseData, JsonSerializerOptions jsonSerializerOptions)
        {
            if (putChatE2eeKey200ResponseData.IdentityPublicKeyOption.IsSet && putChatE2eeKey200ResponseData.IdentityPublicKey == null)
                throw new ArgumentNullException(nameof(putChatE2eeKey200ResponseData.IdentityPublicKey), "Property is required for class PutChatE2eeKey200ResponseData.");

            if (putChatE2eeKey200ResponseData.IdentityPublicKeyOption.IsSet)
                writer.WriteString("identityPublicKey", putChatE2eeKey200ResponseData.IdentityPublicKey);

            if (putChatE2eeKey200ResponseData.KeyVersionOption.IsSet)
                writer.WriteNumber("keyVersion", putChatE2eeKey200ResponseData.KeyVersionOption.Value!.Value);

            if (putChatE2eeKey200ResponseData.UpdatedAtOption.IsSet)
                writer.WriteString("updatedAt", putChatE2eeKey200ResponseData.UpdatedAtOption.Value!.Value.ToString(UpdatedAtFormat));
        }
    }
}
