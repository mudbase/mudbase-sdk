...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class PutChatE2eeKeyRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PutChatE2eeKeyRequest" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public PutChatE2eeKeyRequest(string identityPublicKey, Option<int?> keyVersion = default)
        {
    ...
    public partial class PutChatE2eeKeyRequestJsonConverter : JsonConverter<PutChatE2eeKeyRequest>
    {
        ...
        public override PutChatE2eeKeyRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!identityPublicKey.IsSet)
                throw new ArgumentException("Property is required for class PutChatE2eeKeyRequest.", nameof(identityPublicKey));

            if (identityPublicKey.IsSet && identityPublicKey.Value == null)
                throw new ArgumentNullException(nameof(identityPublicKey), "Property is not nullable for class PutChatE2eeKeyRequest.");

            if (keyVersion.IsSet && keyVersion.Value == null)
                throw new ArgumentNullException(nameof(keyVersion), "Property is not nullable for class PutChatE2eeKeyRequest.");

            return new PutChatE2eeKeyRequest(identityPublicKey.Value!, keyVersion);
        }

        /// <summary>
        /// Serializes a <see cref="PutChatE2eeKeyRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="putChatE2eeKeyRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, PutChatE2eeKeyRequest putChatE2eeKeyRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, putChatE2eeKeyRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="PutChatE2eeKeyRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="putChatE2eeKeyRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, PutChatE2eeKeyRequest putChatE2eeKeyRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (putChatE2eeKeyRequest.IdentityPublicKey == null)
                throw new ArgumentNullException(nameof(putChatE2eeKeyRequest.IdentityPublicKey), "Property is required for class PutChatE2eeKeyRequest.");

            writer.WriteString("identityPublicKey", putChatE2eeKeyRequest.IdentityPublicKey);

            if (putChatE2eeKeyRequest.KeyVersionOption.IsSet)
                writer.WriteNumber("keyVersion", putChatE2eeKeyRequest.KeyVersionOption.Value!.Value);
        }
    }
}
