...
namespace Mudbase.Sdk.Model
{
    ...
    /// RecordUsageRequest
    /// </summary>
    public partial class RecordUsageRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RecordUsageRequest" /> class.
        /// </summary>
        /// <param name="email">Customer email</param>
        /// <param name="metric">Usage metric name (e.g. api_calls, storage_mb)</param>
        /// <param name="quantity">Quantity to record</param>
        [JsonConstructor]
        public RecordUsageRequest(string email, string metric, decimal quantity)
        {
            Email = email;
            Metric = metric;
            Quantity = quantity;
        ...
        /// </summary>
        /// <value>Usage metric name (e.g. api_calls, storage_mb)</value>
        ...
        /// Quantity to record
        /// </summary>
        /// <value>Quantity to record</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RecordUsageRequest {\n");
    ...
    public class RecordUsageRequestJsonConverter : JsonConverter<RecordUsageRequest>
    {
        ...
        public override RecordUsageRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!email.IsSet)
                throw new ArgumentException("Property is required for class RecordUsageRequest.", nameof(email));

            if (!metric.IsSet)
                throw new ArgumentException("Property is required for class RecordUsageRequest.", nameof(metric));

            if (!quantity.IsSet)
                throw new ArgumentException("Property is required for class RecordUsageRequest.", nameof(quantity));

            if (email.IsSet && email.Value == null)
                throw new ArgumentNullException(nameof(email), "Property is not nullable for class RecordUsageRequest.");

            if (metric.IsSet && metric.Value == null)
                throw new ArgumentNullException(nameof(metric), "Property is not nullable for class RecordUsageRequest.");

            if (quantity.IsSet && quantity.Value == null)
                throw new ArgumentNullException(nameof(quantity), "Property is not nullable for class RecordUsageRequest.");

            return new RecordUsageRequest(email.Value!, metric.Value!, quantity.Value!.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="RecordUsageRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="recordUsageRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, RecordUsageRequest recordUsageRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, recordUsageRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="RecordUsageRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="recordUsageRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, RecordUsageRequest recordUsageRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (recordUsageRequest.Email == null)
                throw new ArgumentNullException(nameof(recordUsageRequest.Email), "Property is required for class RecordUsageRequest.");

            if (recordUsageRequest.Metric == null)
                throw new ArgumentNullException(nameof(recordUsageRequest.Metric), "Property is required for class RecordUsageRequest.");

            writer.WriteString("email", recordUsageRequest.Email);

            writer.WriteString("metric", recordUsageRequest.Metric);

            writer.WriteNumber("quantity", recordUsageRequest.Quantity);
        }
    }
}
