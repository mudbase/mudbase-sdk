...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class RefreshToken200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RefreshToken200Response" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public RefreshToken200Response(Option<string?> message = default, Option<string?> token = default, Option<string?> refreshToken = default, Option<int?> expiresIn = default)
        {
    ...
    public class RefreshToken200ResponseJsonConverter : JsonConverter<RefreshToken200Response>
    {
        ...
        public override RefreshToken200Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (message.IsSet && message.Value == null)
                throw new ArgumentNullException(nameof(message), "Property is not nullable for class RefreshToken200Response.");

            if (token.IsSet && token.Value == null)
                throw new ArgumentNullException(nameof(token), "Property is not nullable for class RefreshToken200Response.");

            if (refreshToken.IsSet && refreshToken.Value == null)
                throw new ArgumentNullException(nameof(refreshToken), "Property is not nullable for class RefreshToken200Response.");

            if (expiresIn.IsSet && expiresIn.Value == null)
                throw new ArgumentNullException(nameof(expiresIn), "Property is not nullable for class RefreshToken200Response.");

            return new RefreshToken200Response(message, token, refreshToken, expiresIn);
        }

        /// <summary>
        /// Serializes a <see cref="RefreshToken200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="refreshToken200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, RefreshToken200Response refreshToken200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, refreshToken200Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="RefreshToken200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="refreshToken200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, RefreshToken200Response refreshToken200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (refreshToken200Response.MessageOption.IsSet && refreshToken200Response.Message == null)
                throw new ArgumentNullException(nameof(refreshToken200Response.Message), "Property is required for class RefreshToken200Response.");

            if (refreshToken200Response.TokenOption.IsSet && refreshToken200Response.Token == null)
                throw new ArgumentNullException(nameof(refreshToken200Response.Token), "Property is required for class RefreshToken200Response.");

            if (refreshToken200Response.RefreshTokenOption.IsSet && refreshToken200Response.RefreshToken == null)
                throw new ArgumentNullException(nameof(refreshToken200Response.RefreshToken), "Property is required for class RefreshToken200Response.");

            if (refreshToken200Response.MessageOption.IsSet)
                writer.WriteString("message", refreshToken200Response.Message);

            if (refreshToken200Response.TokenOption.IsSet)
                writer.WriteString("token", refreshToken200Response.Token);

            if (refreshToken200Response.RefreshTokenOption.IsSet)
                writer.WriteString("refreshToken", refreshToken200Response.RefreshToken);

            if (refreshToken200Response.ExpiresInOption.IsSet)
                writer.WriteNumber("expiresIn", refreshToken200Response.ExpiresInOption.Value!.Value);
        }
    }
}
