...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class RegenerateApiKey200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RegenerateApiKey200Response" /> class.
        /// </summary>
        /// <param name="message">message</param>
        /// <param name="secret">secret</param>
        [JsonConstructor]
        public RegenerateApiKey200Response(Option<string?> message = default, Option<string?> secret = default)
        {
    ...
    public partial class RegenerateApiKey200ResponseJsonConverter : JsonConverter<RegenerateApiKey200Response>
    {
        ...
        public override RegenerateApiKey200Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (message.IsSet && message.Value == null)
                throw new ArgumentNullException(nameof(message), "Property is not nullable for class RegenerateApiKey200Response.");

            if (secret.IsSet && secret.Value == null)
                throw new ArgumentNullException(nameof(secret), "Property is not nullable for class RegenerateApiKey200Response.");

            return new RegenerateApiKey200Response(message, secret);
        }

        /// <summary>
        /// Serializes a <see cref="RegenerateApiKey200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="regenerateApiKey200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, RegenerateApiKey200Response regenerateApiKey200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, regenerateApiKey200Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="RegenerateApiKey200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="regenerateApiKey200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, RegenerateApiKey200Response regenerateApiKey200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (regenerateApiKey200Response.MessageOption.IsSet && regenerateApiKey200Response.Message == null)
                throw new ArgumentNullException(nameof(regenerateApiKey200Response.Message), "Property is required for class RegenerateApiKey200Response.");

            if (regenerateApiKey200Response.SecretOption.IsSet && regenerateApiKey200Response.Secret == null)
                throw new ArgumentNullException(nameof(regenerateApiKey200Response.Secret), "Property is required for class RegenerateApiKey200Response.");

            if (regenerateApiKey200Response.MessageOption.IsSet)
                writer.WriteString("message", regenerateApiKey200Response.Message);

            if (regenerateApiKey200Response.SecretOption.IsSet)
                writer.WriteString("secret", regenerateApiKey200Response.Secret);
        }
    }
}
