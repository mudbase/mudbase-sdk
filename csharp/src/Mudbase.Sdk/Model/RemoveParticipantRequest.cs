...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class RemoveParticipantRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveParticipantRequest" /> class.
        /// </summary>
        /// <param name="userId">userId</param>
        [JsonConstructor]
        public RemoveParticipantRequest(string userId)
        {
            UserId = userId;
            OnCreated();
        }
    ...
    public partial class RemoveParticipantRequestJsonConverter : JsonConverter<RemoveParticipantRequest>
    {
        ...
        public override RemoveParticipantRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!userId.IsSet)
                throw new ArgumentException("Property is required for class RemoveParticipantRequest.", nameof(userId));

            if (userId.IsSet && userId.Value == null)
                throw new ArgumentNullException(nameof(userId), "Property is not nullable for class RemoveParticipantRequest.");

            return new RemoveParticipantRequest(userId.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="RemoveParticipantRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="removeParticipantRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, RemoveParticipantRequest removeParticipantRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, removeParticipantRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="RemoveParticipantRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="removeParticipantRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, RemoveParticipantRequest removeParticipantRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (removeParticipantRequest.UserId == null)
                throw new ArgumentNullException(nameof(removeParticipantRequest.UserId), "Property is required for class RemoveParticipantRequest.");

            writer.WriteString("userId", removeParticipantRequest.UserId);
        }
    }
}
