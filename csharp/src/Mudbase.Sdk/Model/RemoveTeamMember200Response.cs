...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class RemoveTeamMember200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveTeamMember200Response" /> class.
        /// </summary>
        /// <param name="message">message</param>
        [JsonConstructor]
        public RemoveTeamMember200Response(Option<string?> message = default)
        {
        ...
        /// </summary>
        /* <example>Member removed successfully</example> */
    ...
    /// <summary>
    /// A Json converter for type <see cref="RemoveTeamMember200Response" />
    /// </summary>
    public partial class RemoveTeamMember200ResponseJsonConverter : JsonConverter<RemoveTeamMember200Response>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveTeamMember200ResponseJsonConverter" /> class.
        /// </summary>
        public RemoveTeamMember200ResponseJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="RemoveTeamMember200Response" />
        /// </summary>
        ...
        public override RemoveTeamMember200Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (message.IsSet && message.Value == null)
                throw new ArgumentNullException(nameof(message), "Property is not nullable for class RemoveTeamMember200Response.");

            return new RemoveTeamMember200Response(message);
        }

        /// <summary>
        /// Serializes a <see cref="RemoveTeamMember200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="removeTeamMember200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, RemoveTeamMember200Response removeTeamMember200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, removeTeamMember200Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="RemoveTeamMember200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="removeTeamMember200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, RemoveTeamMember200Response removeTeamMember200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (removeTeamMember200Response.MessageOption.IsSet && removeTeamMember200Response.Message == null)
                throw new ArgumentNullException(nameof(removeTeamMember200Response.Message), "Property is required for class RemoveTeamMember200Response.");

            if (removeTeamMember200Response.MessageOption.IsSet)
                writer.WriteString("message", removeTeamMember200Response.Message);
        }
    }
}
