...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class RequestLocalPasswordResetRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RequestLocalPasswordResetRequest" /> class.
        /// </summary>
        /// <param name="email">email</param>
        /// <param name="projectId">Required for project-based reset (sends OTP). Omit for org token link.</param>
        [JsonConstructor]
        public RequestLocalPasswordResetRequest(string email, Option<string?> projectId = default)
        {
            Email = email;
    ...
    public partial class RequestLocalPasswordResetRequestJsonConverter : JsonConverter<RequestLocalPasswordResetRequest>
    {
        ...
        public override RequestLocalPasswordResetRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!email.IsSet)
                throw new ArgumentException("Property is required for class RequestLocalPasswordResetRequest.", nameof(email));

            if (email.IsSet && email.Value == null)
                throw new ArgumentNullException(nameof(email), "Property is not nullable for class RequestLocalPasswordResetRequest.");

            if (projectId.IsSet && projectId.Value == null)
                throw new ArgumentNullException(nameof(projectId), "Property is not nullable for class RequestLocalPasswordResetRequest.");

            return new RequestLocalPasswordResetRequest(email.Value!, projectId);
        }

        /// <summary>
        /// Serializes a <see cref="RequestLocalPasswordResetRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="requestLocalPasswordResetRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, RequestLocalPasswordResetRequest requestLocalPasswordResetRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, requestLocalPasswordResetRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="RequestLocalPasswordResetRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="requestLocalPasswordResetRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, RequestLocalPasswordResetRequest requestLocalPasswordResetRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (requestLocalPasswordResetRequest.Email == null)
                throw new ArgumentNullException(nameof(requestLocalPasswordResetRequest.Email), "Property is required for class RequestLocalPasswordResetRequest.");

            if (requestLocalPasswordResetRequest.ProjectIdOption.IsSet && requestLocalPasswordResetRequest.ProjectId == null)
                throw new ArgumentNullException(nameof(requestLocalPasswordResetRequest.ProjectId), "Property is required for class RequestLocalPasswordResetRequest.");

            writer.WriteString("email", requestLocalPasswordResetRequest.Email);

            if (requestLocalPasswordResetRequest.ProjectIdOption.IsSet)
                writer.WriteString("projectId", requestLocalPasswordResetRequest.ProjectId);
        }
    }
}
