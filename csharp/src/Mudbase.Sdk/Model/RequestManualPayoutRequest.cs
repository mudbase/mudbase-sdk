...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class RequestManualPayoutRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RequestManualPayoutRequest" /> class.
        /// </summary>
        /// <param name="currency">currency</param>
        [JsonConstructor]
        public RequestManualPayoutRequest(string currency)
        {
            Currency = currency;
            OnCreated();
        }
    ...
    public class RequestManualPayoutRequestJsonConverter : JsonConverter<RequestManualPayoutRequest>
    {
        ...
        public override RequestManualPayoutRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!currency.IsSet)
                throw new ArgumentException("Property is required for class RequestManualPayoutRequest.", nameof(currency));

            if (currency.IsSet && currency.Value == null)
                throw new ArgumentNullException(nameof(currency), "Property is not nullable for class RequestManualPayoutRequest.");

            return new RequestManualPayoutRequest(currency.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="RequestManualPayoutRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="requestManualPayoutRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, RequestManualPayoutRequest requestManualPayoutRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, requestManualPayoutRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="RequestManualPayoutRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="requestManualPayoutRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, RequestManualPayoutRequest requestManualPayoutRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (requestManualPayoutRequest.Currency == null)
                throw new ArgumentNullException(nameof(requestManualPayoutRequest.Currency), "Property is required for class RequestManualPayoutRequest.");

            writer.WriteString("currency", requestManualPayoutRequest.Currency);
        }
    }
}
