...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class ResetLocalPasswordRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResetLocalPasswordRequest" /> class.
        /// </summary>
        /// <param name="password">password</param>
        /// <param name="projectId">projectId</param>
        [JsonConstructor]
        public ResetLocalPasswordRequest(string password, Option<string?> projectId = default)
        {
            Password = password;
    ...
    public partial class ResetLocalPasswordRequestJsonConverter : JsonConverter<ResetLocalPasswordRequest>
    {
        ...
        public override ResetLocalPasswordRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!password.IsSet)
                throw new ArgumentException("Property is required for class ResetLocalPasswordRequest.", nameof(password));

            if (password.IsSet && password.Value == null)
                throw new ArgumentNullException(nameof(password), "Property is not nullable for class ResetLocalPasswordRequest.");

            if (projectId.IsSet && projectId.Value == null)
                throw new ArgumentNullException(nameof(projectId), "Property is not nullable for class ResetLocalPasswordRequest.");

            return new ResetLocalPasswordRequest(password.Value!, projectId);
        }

        /// <summary>
        /// Serializes a <see cref="ResetLocalPasswordRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="resetLocalPasswordRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ResetLocalPasswordRequest resetLocalPasswordRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, resetLocalPasswordRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ResetLocalPasswordRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="resetLocalPasswordRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ResetLocalPasswordRequest resetLocalPasswordRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (resetLocalPasswordRequest.Password == null)
                throw new ArgumentNullException(nameof(resetLocalPasswordRequest.Password), "Property is required for class ResetLocalPasswordRequest.");

            if (resetLocalPasswordRequest.ProjectIdOption.IsSet && resetLocalPasswordRequest.ProjectId == null)
                throw new ArgumentNullException(nameof(resetLocalPasswordRequest.ProjectId), "Property is required for class ResetLocalPasswordRequest.");

            writer.WriteString("password", resetLocalPasswordRequest.Password);

            if (resetLocalPasswordRequest.ProjectIdOption.IsSet)
                writer.WriteString("projectId", resetLocalPasswordRequest.ProjectId);
        }
    }
}
