...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class RestoreBackup200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RestoreBackup200Response" /> class.
        /// </summary>
        /// <param name="message">message</param>
        /// <param name="restore">restore</param>
        [JsonConstructor]
        public RestoreBackup200Response(Option<string?> message = default, Option<RestoreBackup200ResponseRestore?> restore = default)
        {
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<RestoreBackup200ResponseRestore?> RestoreOption { get; private set; }
    ...
    public class RestoreBackup200ResponseJsonConverter : JsonConverter<RestoreBackup200Response>
    {
        ...
        public override RestoreBackup200Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<RestoreBackup200ResponseRestore?> restore = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "message":
                            ...
                            break;
                        case "restore":
                            restore = new Option<RestoreBackup200ResponseRestore?>(JsonSerializer.Deserialize<RestoreBackup200ResponseRestore>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (message.IsSet && message.Value == null)
                throw new ArgumentNullException(nameof(message), "Property is not nullable for class RestoreBackup200Response.");

            if (restore.IsSet && restore.Value == null)
                throw new ArgumentNullException(nameof(restore), "Property is not nullable for class RestoreBackup200Response.");

            return new RestoreBackup200Response(message, restore);
        }

        /// <summary>
        /// Serializes a <see cref="RestoreBackup200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="restoreBackup200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, RestoreBackup200Response restoreBackup200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, restoreBackup200Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="RestoreBackup200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="restoreBackup200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, RestoreBackup200Response restoreBackup200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (restoreBackup200Response.MessageOption.IsSet && restoreBackup200Response.Message == null)
                throw new ArgumentNullException(nameof(restoreBackup200Response.Message), "Property is required for class RestoreBackup200Response.");

            if (restoreBackup200Response.RestoreOption.IsSet && restoreBackup200Response.Restore == null)
                throw new ArgumentNullException(nameof(restoreBackup200Response.Restore), "Property is required for class RestoreBackup200Response.");

            if (restoreBackup200Response.MessageOption.IsSet)
                writer.WriteString("message", restoreBackup200Response.Message);

            if (restoreBackup200Response.RestoreOption.IsSet)
            {
                writer.WritePropertyName("restore");
                JsonSerializer.Serialize(writer, restoreBackup200Response.Restore, jsonSerializerOptions);
            }
        }
    }
}
