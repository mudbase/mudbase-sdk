...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class RetryWebhook400Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RetryWebhook400Response" /> class.
        /// </summary>
        /// <param name="error">error</param>
        [JsonConstructor]
        public RetryWebhook400Response(Option<string?> error = default)
        {
            ErrorOption = error;
            OnCreated();
        }
        ...
        /// Gets or Sets Error
        /// </summary>
        /* <example>Webhook already succeeded</example> */
    ...
    /// <summary>
    /// A Json converter for type <see cref="RetryWebhook400Response" />
    /// </summary>
    public partial class RetryWebhook400ResponseJsonConverter : JsonConverter<RetryWebhook400Response>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="RetryWebhook400ResponseJsonConverter" /> class.
        /// </summary>
        public RetryWebhook400ResponseJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="RetryWebhook400Response" />
        /// </summary>
        ...
        public override RetryWebhook400Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (error.IsSet && error.Value == null)
                throw new ArgumentNullException(nameof(error), "Property is not nullable for class RetryWebhook400Response.");

            return new RetryWebhook400Response(error);
        }

        /// <summary>
        /// Serializes a <see cref="RetryWebhook400Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="retryWebhook400Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, RetryWebhook400Response retryWebhook400Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, retryWebhook400Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="RetryWebhook400Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="retryWebhook400Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, RetryWebhook400Response retryWebhook400Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (retryWebhook400Response.ErrorOption.IsSet && retryWebhook400Response.Error == null)
                throw new ArgumentNullException(nameof(retryWebhook400Response.Error), "Property is required for class RetryWebhook400Response.");

            if (retryWebhook400Response.ErrorOption.IsSet)
                writer.WriteString("error", retryWebhook400Response.Error);
        }
    }
}
