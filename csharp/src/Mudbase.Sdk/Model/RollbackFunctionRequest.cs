...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class RollbackFunctionRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RollbackFunctionRequest" /> class.
        /// </summary>
        /// <param name="varVersion">Version number to rollback to</param>
        [JsonConstructor]
        public RollbackFunctionRequest(int varVersion)
        {
        ...
        /// </summary>
        /// <value>Version number to rollback to</value>
    ...
    public partial class RollbackFunctionRequestJsonConverter : JsonConverter<RollbackFunctionRequest>
    {
        ...
        public override RollbackFunctionRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!varVersion.IsSet)
                throw new ArgumentException("Property is required for class RollbackFunctionRequest.", nameof(varVersion));

            if (varVersion.IsSet && varVersion.Value == null)
                throw new ArgumentNullException(nameof(varVersion), "Property is not nullable for class RollbackFunctionRequest.");

            return new RollbackFunctionRequest(varVersion.Value!.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="RollbackFunctionRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="rollbackFunctionRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, RollbackFunctionRequest rollbackFunctionRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, rollbackFunctionRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="RollbackFunctionRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="rollbackFunctionRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, RollbackFunctionRequest rollbackFunctionRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteNumber("version", rollbackFunctionRequest.VarVersion);
        }
    }
}
