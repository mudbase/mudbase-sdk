...
namespace Mudbase.Sdk.Model
{
    ...
    public partial class SearchResponse : IValidatableObject
    {
        ...
        [JsonConstructor]
        public SearchResponse(Option<bool?> success = default, Option<SearchResponseData?> data = default)
        {
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<SearchResponseData?> DataOption { get; private set; }

        /// <summary>
        /// Gets or Sets Data
        /// </summary>
        [JsonPropertyName("data")]
        public SearchResponseData? Data { get { return this.DataOption.Value; } set { this.DataOption = new(value); } }
    ...
    public partial class SearchResponseJsonConverter : JsonConverter<SearchResponse>
    {
        ...
        public override SearchResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<SearchResponseData?> data = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "success":
                            ...
                            break;
                        case "data":
                            data = new Option<SearchResponseData?>(JsonSerializer.Deserialize<SearchResponseData>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (success.IsSet && success.Value == null)
                throw new ArgumentNullException(nameof(success), "Property is not nullable for class SearchResponse.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class SearchResponse.");

            return new SearchResponse(success, data);
        }
        ...
        {
            if (searchResponse.DataOption.IsSet && searchResponse.Data == null)
                throw new ArgumentNullException(nameof(searchResponse.Data), "Property is required for class SearchResponse.");

            if (searchResponse.SuccessOption.IsSet)
                writer.WriteBoolean("success", searchResponse.SuccessOption.Value!.Value);

            if (searchResponse.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, searchResponse.Data, jsonSerializerOptions);
            }
        }
    }
}
