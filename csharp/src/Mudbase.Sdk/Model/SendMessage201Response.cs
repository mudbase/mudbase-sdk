...
namespace Mudbase.Sdk.Model
{
    ...
    public partial class SendMessage201Response : IValidatableObject
    {
        ...
        [JsonConstructor]
        public SendMessage201Response(Option<bool?> success = default, Option<SendMessage201ResponseData?> data = default)
        {
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<SendMessage201ResponseData?> DataOption { get; private set; }
    ...
    public class SendMessage201ResponseJsonConverter : JsonConverter<SendMessage201Response>
    {
        ...
        public override SendMessage201Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<SendMessage201ResponseData?> data = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "success":
                            ...
                            break;
                        case "data":
                            data = new Option<SendMessage201ResponseData?>(JsonSerializer.Deserialize<SendMessage201ResponseData>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (success.IsSet && success.Value == null)
                throw new ArgumentNullException(nameof(success), "Property is not nullable for class SendMessage201Response.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class SendMessage201Response.");

            return new SendMessage201Response(success, data);
        }

        /// <summary>
        /// Serializes a <see cref="SendMessage201Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="sendMessage201Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, SendMessage201Response sendMessage201Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, sendMessage201Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="SendMessage201Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="sendMessage201Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, SendMessage201Response sendMessage201Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (sendMessage201Response.DataOption.IsSet && sendMessage201Response.Data == null)
                throw new ArgumentNullException(nameof(sendMessage201Response.Data), "Property is required for class SendMessage201Response.");

            if (sendMessage201Response.SuccessOption.IsSet)
                writer.WriteBoolean("success", sendMessage201Response.SuccessOption.Value!.Value);

            if (sendMessage201Response.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, sendMessage201Response.Data, jsonSerializerOptions);
            }
        }
    }
}
