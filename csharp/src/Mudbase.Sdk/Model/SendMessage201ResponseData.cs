...
namespace Mudbase.Sdk.Model
{
    ...
    public partial class SendMessage201ResponseData : IValidatableObject
    {
        ...
        [JsonConstructor]
        public SendMessage201ResponseData(Option<string?> id = default, Option<string?> content = default, Option<string?> sender = default, Option<DateTime?> createdAt = default)
        {
            IdOption = id;
    ...
    public class SendMessage201ResponseDataJsonConverter : JsonConverter<SendMessage201ResponseData>
    {
        ...
        public override SendMessage201ResponseData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class SendMessage201ResponseData.");

            if (content.IsSet && content.Value == null)
                throw new ArgumentNullException(nameof(content), "Property is not nullable for class SendMessage201ResponseData.");

            if (sender.IsSet && sender.Value == null)
                throw new ArgumentNullException(nameof(sender), "Property is not nullable for class SendMessage201ResponseData.");

            if (createdAt.IsSet && createdAt.Value == null)
                throw new ArgumentNullException(nameof(createdAt), "Property is not nullable for class SendMessage201ResponseData.");

            return new SendMessage201ResponseData(id, content, sender, createdAt);
        }

        /// <summary>
        /// Serializes a <see cref="SendMessage201ResponseData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="sendMessage201ResponseData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, SendMessage201ResponseData sendMessage201ResponseData, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, sendMessage201ResponseData, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="SendMessage201ResponseData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="sendMessage201ResponseData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, SendMessage201ResponseData sendMessage201ResponseData, JsonSerializerOptions jsonSerializerOptions)
        {
            if (sendMessage201ResponseData.IdOption.IsSet && sendMessage201ResponseData.Id == null)
                throw new ArgumentNullException(nameof(sendMessage201ResponseData.Id), "Property is required for class SendMessage201ResponseData.");

            if (sendMessage201ResponseData.ContentOption.IsSet && sendMessage201ResponseData.Content == null)
                throw new ArgumentNullException(nameof(sendMessage201ResponseData.Content), "Property is required for class SendMessage201ResponseData.");

            if (sendMessage201ResponseData.SenderOption.IsSet && sendMessage201ResponseData.Sender == null)
                throw new ArgumentNullException(nameof(sendMessage201ResponseData.Sender), "Property is required for class SendMessage201ResponseData.");

            if (sendMessage201ResponseData.IdOption.IsSet)
                writer.WriteString("_id", sendMessage201ResponseData.Id);

            if (sendMessage201ResponseData.ContentOption.IsSet)
                writer.WriteString("content", sendMessage201ResponseData.Content);

            if (sendMessage201ResponseData.SenderOption.IsSet)
                writer.WriteString("sender", sendMessage201ResponseData.Sender);

            if (sendMessage201ResponseData.CreatedAtOption.IsSet)
                writer.WriteString("createdAt", sendMessage201ResponseData.CreatedAtOption.Value!.Value.ToString(CreatedAtFormat));
        }
    }
}
