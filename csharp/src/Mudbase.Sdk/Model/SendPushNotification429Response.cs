...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class SendPushNotification429Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SendPushNotification429Response" /> class.
        /// </summary>
        /// <param name="success">success</param>
        /// <param name="error">error</param>
        /// <param name="message">message</param>
        [JsonConstructor]
        public SendPushNotification429Response(Option<bool?> success = default, Option<string?> error = default, Option<string?> message = default)
        {
    ...
    public partial class SendPushNotification429ResponseJsonConverter : JsonConverter<SendPushNotification429Response>
    {
        ...
        public override SendPushNotification429Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (success.IsSet && success.Value == null)
                throw new ArgumentNullException(nameof(success), "Property is not nullable for class SendPushNotification429Response.");

            if (error.IsSet && error.Value == null)
                throw new ArgumentNullException(nameof(error), "Property is not nullable for class SendPushNotification429Response.");

            if (message.IsSet && message.Value == null)
                throw new ArgumentNullException(nameof(message), "Property is not nullable for class SendPushNotification429Response.");

            return new SendPushNotification429Response(success, error, message);
        }

        /// <summary>
        /// Serializes a <see cref="SendPushNotification429Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="sendPushNotification429Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, SendPushNotification429Response sendPushNotification429Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, sendPushNotification429Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="SendPushNotification429Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="sendPushNotification429Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, SendPushNotification429Response sendPushNotification429Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (sendPushNotification429Response.ErrorOption.IsSet && sendPushNotification429Response.Error == null)
                throw new ArgumentNullException(nameof(sendPushNotification429Response.Error), "Property is required for class SendPushNotification429Response.");

            if (sendPushNotification429Response.MessageOption.IsSet && sendPushNotification429Response.Message == null)
                throw new ArgumentNullException(nameof(sendPushNotification429Response.Message), "Property is required for class SendPushNotification429Response.");

            if (sendPushNotification429Response.SuccessOption.IsSet)
                writer.WriteBoolean("success", sendPushNotification429Response.SuccessOption.Value!.Value);

            if (sendPushNotification429Response.ErrorOption.IsSet)
                writer.WriteString("error", sendPushNotification429Response.Error);

            if (sendPushNotification429Response.MessageOption.IsSet)
                writer.WriteString("message", sendPushNotification429Response.Message);
        }
    }
}
