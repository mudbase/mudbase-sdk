...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class SetOrgPrimaryDomainRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SetOrgPrimaryDomainRequest" /> class.
        /// </summary>
        /// <param name="hostname">hostname</param>
        [JsonConstructor]
        public SetOrgPrimaryDomainRequest(string hostname)
        {
            Hostname = hostname;
            OnCreated();
        }
    ...
    public partial class SetOrgPrimaryDomainRequestJsonConverter : JsonConverter<SetOrgPrimaryDomainRequest>
    {
        ...
        public override SetOrgPrimaryDomainRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!hostname.IsSet)
                throw new ArgumentException("Property is required for class SetOrgPrimaryDomainRequest.", nameof(hostname));

            if (hostname.IsSet && hostname.Value == null)
                throw new ArgumentNullException(nameof(hostname), "Property is not nullable for class SetOrgPrimaryDomainRequest.");

            return new SetOrgPrimaryDomainRequest(hostname.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="SetOrgPrimaryDomainRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="setOrgPrimaryDomainRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, SetOrgPrimaryDomainRequest setOrgPrimaryDomainRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, setOrgPrimaryDomainRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="SetOrgPrimaryDomainRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="setOrgPrimaryDomainRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, SetOrgPrimaryDomainRequest setOrgPrimaryDomainRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (setOrgPrimaryDomainRequest.Hostname == null)
                throw new ArgumentNullException(nameof(setOrgPrimaryDomainRequest.Hostname), "Property is required for class SetOrgPrimaryDomainRequest.");

            writer.WriteString("hostname", setOrgPrimaryDomainRequest.Hostname);
        }
    }
}
