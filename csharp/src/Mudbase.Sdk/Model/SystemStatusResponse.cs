...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class SystemStatusResponse : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public SystemStatusResponse(Option<bool?> success = default, Option<SystemStatusResponseData?> data = default)
        {
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<SystemStatusResponseData?> DataOption { get; private set; }

        /// <summary>
        /// Gets or Sets Data
        /// </summary>
        [JsonPropertyName("data")]
        public SystemStatusResponseData? Data { get { return this.DataOption.Value; } set { this.DataOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="SystemStatusResponse" />
    /// </summary>
    public partial class SystemStatusResponseJsonConverter : JsonConverter<SystemStatusResponse>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="SystemStatusResponseJsonConverter" /> class.
        /// </summary>
        public SystemStatusResponseJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="SystemStatusResponse" />
        /// </summary>
        ...
        public override SystemStatusResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<SystemStatusResponseData?> data = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "success":
                            ...
                            break;
                        case "data":
                            data = new Option<SystemStatusResponseData?>(JsonSerializer.Deserialize<SystemStatusResponseData>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (success.IsSet && success.Value == null)
                throw new ArgumentNullException(nameof(success), "Property is not nullable for class SystemStatusResponse.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class SystemStatusResponse.");

            return new SystemStatusResponse(success, data);
        }

        /// <summary>
        /// Serializes a <see cref="SystemStatusResponse" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="systemStatusResponse"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, SystemStatusResponse systemStatusResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, systemStatusResponse, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="SystemStatusResponse" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="systemStatusResponse"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, SystemStatusResponse systemStatusResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            if (systemStatusResponse.DataOption.IsSet && systemStatusResponse.Data == null)
                throw new ArgumentNullException(nameof(systemStatusResponse.Data), "Property is required for class SystemStatusResponse.");

            if (systemStatusResponse.SuccessOption.IsSet)
                writer.WriteBoolean("success", systemStatusResponse.SuccessOption.Value!.Value);

            if (systemStatusResponse.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, systemStatusResponse.Data, jsonSerializerOptions);
            }
        }
    }
}
