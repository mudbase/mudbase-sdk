...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class SystemStatusResponseDataCpu : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SystemStatusResponseDataCpu" /> class.
        /// </summary>
        /// <param name="usage">usage</param>
        /// <param name="cores">cores</param>
        [JsonConstructor]
        public SystemStatusResponseDataCpu(Option<decimal?> usage = default, Option<int?> cores = default)
        {
            UsageOption = usage;
            CoresOption = cores;
            OnCreated();
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<int?> CoresOption { get; private set; }
    ...
    public class SystemStatusResponseDataCpuJsonConverter : JsonConverter<SystemStatusResponseDataCpu>
    {
        ...
        public override SystemStatusResponseDataCpu Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (usage.IsSet && usage.Value == null)
                throw new ArgumentNullException(nameof(usage), "Property is not nullable for class SystemStatusResponseDataCpu.");

            if (cores.IsSet && cores.Value == null)
                throw new ArgumentNullException(nameof(cores), "Property is not nullable for class SystemStatusResponseDataCpu.");

            return new SystemStatusResponseDataCpu(usage, cores);
        }

        /// <summary>
        /// Serializes a <see cref="SystemStatusResponseDataCpu" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="systemStatusResponseDataCpu"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, SystemStatusResponseDataCpu systemStatusResponseDataCpu, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, systemStatusResponseDataCpu, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="SystemStatusResponseDataCpu" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="systemStatusResponseDataCpu"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, SystemStatusResponseDataCpu systemStatusResponseDataCpu, JsonSerializerOptions jsonSerializerOptions)
        {
            if (systemStatusResponseDataCpu.UsageOption.IsSet)
                writer.WriteNumber("usage", systemStatusResponseDataCpu.UsageOption.Value!.Value);

            if (systemStatusResponseDataCpu.CoresOption.IsSet)
                writer.WriteNumber("cores", systemStatusResponseDataCpu.CoresOption.Value!.Value);
        }
    }
}
