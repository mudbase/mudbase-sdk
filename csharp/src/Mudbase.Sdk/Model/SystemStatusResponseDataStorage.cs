...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class SystemStatusResponseDataStorage : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SystemStatusResponseDataStorage" /> class.
        /// </summary>
        /// <param name="used">used</param>
        /// <param name="available">available</param>
        /// <param name="percentage">percentage</param>
        [JsonConstructor]
        public SystemStatusResponseDataStorage(Option<int?> used = default, Option<int?> available = default, Option<decimal?> percentage = default)
        {
            UsedOption = used;
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<int?> AvailableOption { get; private set; }
    ...
    public class SystemStatusResponseDataStorageJsonConverter : JsonConverter<SystemStatusResponseDataStorage>
    {
        ...
        public override SystemStatusResponseDataStorage Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "used":
                            ...
                            break;
                        case "available":
                            available = new Option<int?>(utf8JsonReader.TokenType == JsonTokenType.Null ? (int?)null : utf8JsonReader.GetInt32());
                            break;
                        case "percentage":
            ...
            if (used.IsSet && used.Value == null)
                throw new ArgumentNullException(nameof(used), "Property is not nullable for class SystemStatusResponseDataStorage.");

            if (available.IsSet && available.Value == null)
                throw new ArgumentNullException(nameof(available), "Property is not nullable for class SystemStatusResponseDataStorage.");

            if (percentage.IsSet && percentage.Value == null)
                throw new ArgumentNullException(nameof(percentage), "Property is not nullable for class SystemStatusResponseDataStorage.");

            return new SystemStatusResponseDataStorage(used, available, percentage);
        }

        /// <summary>
        /// Serializes a <see cref="SystemStatusResponseDataStorage" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="systemStatusResponseDataStorage"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, SystemStatusResponseDataStorage systemStatusResponseDataStorage, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, systemStatusResponseDataStorage, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="SystemStatusResponseDataStorage" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="systemStatusResponseDataStorage"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, SystemStatusResponseDataStorage systemStatusResponseDataStorage, JsonSerializerOptions jsonSerializerOptions)
        {
            if (systemStatusResponseDataStorage.UsedOption.IsSet)
                writer.WriteNumber("used", systemStatusResponseDataStorage.UsedOption.Value!.Value);

            if (systemStatusResponseDataStorage.AvailableOption.IsSet)
                writer.WriteNumber("available", systemStatusResponseDataStorage.AvailableOption.Value!.Value);

            if (systemStatusResponseDataStorage.PercentageOption.IsSet)
                writer.WriteNumber("percentage", systemStatusResponseDataStorage.PercentageOption.Value!.Value);
        }
    }
}
