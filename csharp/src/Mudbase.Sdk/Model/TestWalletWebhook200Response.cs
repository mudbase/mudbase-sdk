...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class TestWalletWebhook200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TestWalletWebhook200Response" /> class.
        /// </summary>
        /// <param name="success">success</param>
        /// <param name="data">data</param>
        [JsonConstructor]
        public TestWalletWebhook200Response(Option<bool?> success = default, Option<Object?> data = default)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="TestWalletWebhook200Response" />
    /// </summary>
    public partial class TestWalletWebhook200ResponseJsonConverter : JsonConverter<TestWalletWebhook200Response>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="TestWalletWebhook200ResponseJsonConverter" /> class.
        /// </summary>
        public TestWalletWebhook200ResponseJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="TestWalletWebhook200Response" />
        /// </summary>
        ...
        public override TestWalletWebhook200Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (success.IsSet && success.Value == null)
                throw new ArgumentNullException(nameof(success), "Property is not nullable for class TestWalletWebhook200Response.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class TestWalletWebhook200Response.");

            return new TestWalletWebhook200Response(success, data);
        }

        /// <summary>
        /// Serializes a <see cref="TestWalletWebhook200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="testWalletWebhook200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, TestWalletWebhook200Response testWalletWebhook200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, testWalletWebhook200Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="TestWalletWebhook200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="testWalletWebhook200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, TestWalletWebhook200Response testWalletWebhook200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (testWalletWebhook200Response.DataOption.IsSet && testWalletWebhook200Response.Data == null)
                throw new ArgumentNullException(nameof(testWalletWebhook200Response.Data), "Property is required for class TestWalletWebhook200Response.");

            if (testWalletWebhook200Response.SuccessOption.IsSet)
                writer.WriteBoolean("success", testWalletWebhook200Response.SuccessOption.Value!.Value);

            if (testWalletWebhook200Response.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, testWalletWebhook200Response.Data, jsonSerializerOptions);
            }
        }
    }
}
