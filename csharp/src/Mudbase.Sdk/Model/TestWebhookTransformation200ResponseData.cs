...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class TestWebhookTransformation200ResponseData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TestWebhookTransformation200ResponseData" /> class.
        /// </summary>
        /// <param name="original">original</param>
        /// <param name="transformed">transformed</param>
        [JsonConstructor]
        public TestWebhookTransformation200ResponseData(Option<Object?> original = default, Option<Object?> transformed = default)
        {
            OriginalOption = original;
            TransformedOption = transformed;
            OnCreated();
        }
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<Object?> TransformedOption { get; private set; }
    ...
    public class TestWebhookTransformation200ResponseDataJsonConverter : JsonConverter<TestWebhookTransformation200ResponseData>
    {
        ...
        public override TestWebhookTransformation200ResponseData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<Object?> transformed = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "original":
                            ...
                            break;
                        case "transformed":
                            transformed = new Option<Object?>(JsonSerializer.Deserialize<Object>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (original.IsSet && original.Value == null)
                throw new ArgumentNullException(nameof(original), "Property is not nullable for class TestWebhookTransformation200ResponseData.");

            if (transformed.IsSet && transformed.Value == null)
                throw new ArgumentNullException(nameof(transformed), "Property is not nullable for class TestWebhookTransformation200ResponseData.");

            return new TestWebhookTransformation200ResponseData(original, transformed);
        }

        /// <summary>
        /// Serializes a <see cref="TestWebhookTransformation200ResponseData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="testWebhookTransformation200ResponseData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, TestWebhookTransformation200ResponseData testWebhookTransformation200ResponseData, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, testWebhookTransformation200ResponseData, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="TestWebhookTransformation200ResponseData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="testWebhookTransformation200ResponseData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, TestWebhookTransformation200ResponseData testWebhookTransformation200ResponseData, JsonSerializerOptions jsonSerializerOptions)
        {
            if (testWebhookTransformation200ResponseData.OriginalOption.IsSet && testWebhookTransformation200ResponseData.Original == null)
                throw new ArgumentNullException(nameof(testWebhookTransformation200ResponseData.Original), "Property is required for class TestWebhookTransformation200ResponseData.");

            if (testWebhookTransformation200ResponseData.TransformedOption.IsSet && testWebhookTransformation200ResponseData.Transformed == null)
                throw new ArgumentNullException(nameof(testWebhookTransformation200ResponseData.Transformed), "Property is required for class TestWebhookTransformation200ResponseData.");

            if (testWebhookTransformation200ResponseData.OriginalOption.IsSet)
            {
                writer.WritePropertyName("original");
                JsonSerializer.Serialize(writer, testWebhookTransformation200ResponseData.Original, jsonSerializerOptions);
            }
            if (testWebhookTransformation200ResponseData.TransformedOption.IsSet)
            {
                writer.WritePropertyName("transformed");
                JsonSerializer.Serialize(writer, testWebhookTransformation200ResponseData.Transformed, jsonSerializerOptions);
            }
        }
    }
}
