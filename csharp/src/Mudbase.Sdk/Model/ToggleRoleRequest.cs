...
namespace Mudbase.Sdk.Model
{
    ...
    /// ToggleRoleRequest
    /// </summary>
    public partial class ToggleRoleRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ToggleRoleRequest" /> class.
        /// </summary>
        /// <param name="isEnabled">isEnabled</param>
        [JsonConstructor]
        public ToggleRoleRequest(bool isEnabled)
        {
            IsEnabled = isEnabled;
            OnCreated();
        }
    ...
    public partial class ToggleRoleRequestJsonConverter : JsonConverter<ToggleRoleRequest>
    {
        ...
        public override ToggleRoleRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!isEnabled.IsSet)
                throw new ArgumentException("Property is required for class ToggleRoleRequest.", nameof(isEnabled));

            if (isEnabled.IsSet && isEnabled.Value == null)
                throw new ArgumentNullException(nameof(isEnabled), "Property is not nullable for class ToggleRoleRequest.");

            return new ToggleRoleRequest(isEnabled.Value!.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="ToggleRoleRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="toggleRoleRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ToggleRoleRequest toggleRoleRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, toggleRoleRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ToggleRoleRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="toggleRoleRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ToggleRoleRequest toggleRoleRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteBoolean("isEnabled", toggleRoleRequest.IsEnabled);
        }
    }
}
