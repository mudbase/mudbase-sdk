...
namespace Mudbase.Sdk.Model
{
    ...
    public partial class TriggerFunctionWebhook200Response : IValidatableObject
    {
        ...
        [JsonConstructor]
        public TriggerFunctionWebhook200Response(Option<bool?> success = default, Option<int?> triggered = default, Option<List<Object>?> results = default)
        {
    ...
    public partial class TriggerFunctionWebhook200ResponseJsonConverter : JsonConverter<TriggerFunctionWebhook200Response>
    {
        ...
        public override TriggerFunctionWebhook200Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (success.IsSet && success.Value == null)
                throw new ArgumentNullException(nameof(success), "Property is not nullable for class TriggerFunctionWebhook200Response.");

            if (triggered.IsSet && triggered.Value == null)
                throw new ArgumentNullException(nameof(triggered), "Property is not nullable for class TriggerFunctionWebhook200Response.");

            if (results.IsSet && results.Value == null)
                throw new ArgumentNullException(nameof(results), "Property is not nullable for class TriggerFunctionWebhook200Response.");

            return new TriggerFunctionWebhook200Response(success, triggered, results);
        }

        /// <summary>
        /// Serializes a <see cref="TriggerFunctionWebhook200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="triggerFunctionWebhook200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, TriggerFunctionWebhook200Response triggerFunctionWebhook200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, triggerFunctionWebhook200Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="TriggerFunctionWebhook200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="triggerFunctionWebhook200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, TriggerFunctionWebhook200Response triggerFunctionWebhook200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (triggerFunctionWebhook200Response.ResultsOption.IsSet && triggerFunctionWebhook200Response.Results == null)
                throw new ArgumentNullException(nameof(triggerFunctionWebhook200Response.Results), "Property is required for class TriggerFunctionWebhook200Response.");

            if (triggerFunctionWebhook200Response.SuccessOption.IsSet)
                writer.WriteBoolean("success", triggerFunctionWebhook200Response.SuccessOption.Value!.Value);

            if (triggerFunctionWebhook200Response.TriggeredOption.IsSet)
                writer.WriteNumber("triggered", triggerFunctionWebhook200Response.TriggeredOption.Value!.Value);

            if (triggerFunctionWebhook200Response.ResultsOption.IsSet)
            {
                writer.WritePropertyName("results");
                JsonSerializer.Serialize(writer, triggerFunctionWebhook200Response.Results, jsonSerializerOptions);
            }
        }
    }
}
