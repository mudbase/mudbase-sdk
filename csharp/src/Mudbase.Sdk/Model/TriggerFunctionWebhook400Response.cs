...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class TriggerFunctionWebhook400Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TriggerFunctionWebhook400Response" /> class.
        /// </summary>
        /// <param name="success">success</param>
        /// <param name="error">error</param>
        [JsonConstructor]
        public TriggerFunctionWebhook400Response(Option<bool?> success = default, Option<string?> error = default)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="TriggerFunctionWebhook400Response" />
    /// </summary>
    public partial class TriggerFunctionWebhook400ResponseJsonConverter : JsonConverter<TriggerFunctionWebhook400Response>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="TriggerFunctionWebhook400ResponseJsonConverter" /> class.
        /// </summary>
        public TriggerFunctionWebhook400ResponseJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="TriggerFunctionWebhook400Response" />
        /// </summary>
        ...
        public override TriggerFunctionWebhook400Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (success.IsSet && success.Value == null)
                throw new ArgumentNullException(nameof(success), "Property is not nullable for class TriggerFunctionWebhook400Response.");

            if (error.IsSet && error.Value == null)
                throw new ArgumentNullException(nameof(error), "Property is not nullable for class TriggerFunctionWebhook400Response.");

            return new TriggerFunctionWebhook400Response(success, error);
        }

        /// <summary>
        /// Serializes a <see cref="TriggerFunctionWebhook400Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="triggerFunctionWebhook400Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, TriggerFunctionWebhook400Response triggerFunctionWebhook400Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, triggerFunctionWebhook400Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="TriggerFunctionWebhook400Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="triggerFunctionWebhook400Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, TriggerFunctionWebhook400Response triggerFunctionWebhook400Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (triggerFunctionWebhook400Response.ErrorOption.IsSet && triggerFunctionWebhook400Response.Error == null)
                throw new ArgumentNullException(nameof(triggerFunctionWebhook400Response.Error), "Property is required for class TriggerFunctionWebhook400Response.");

            if (triggerFunctionWebhook400Response.SuccessOption.IsSet)
                writer.WriteBoolean("success", triggerFunctionWebhook400Response.SuccessOption.Value!.Value);

            if (triggerFunctionWebhook400Response.ErrorOption.IsSet)
                writer.WriteString("error", triggerFunctionWebhook400Response.Error);
        }
    }
}
