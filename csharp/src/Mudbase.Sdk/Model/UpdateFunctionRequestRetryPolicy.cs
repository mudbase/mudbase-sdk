...
namespace Mudbase.Sdk.Model
{
    ...
    public partial class UpdateFunctionRequestRetryPolicy : IValidatableObject
    {
        ...
        [JsonConstructor]
        public UpdateFunctionRequestRetryPolicy(Option<bool?> enabled = default, Option<int?> maxRetries = default, Option<int?> backoffMs = default)
        {
            EnabledOption = enabled;
            MaxRetriesOption = maxRetries;
            BackoffMsOption = backoffMs;
            OnCreated();
        }
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<int?> BackoffMsOption { get; private set; }
    ...
    public class UpdateFunctionRequestRetryPolicyJsonConverter : JsonConverter<UpdateFunctionRequestRetryPolicy>
    {
        ...
        public override UpdateFunctionRequestRetryPolicy Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "maxRetries":
                            ...
                            break;
                        case "backoffMs":
                            backoffMs = new Option<int?>(utf8JsonReader.TokenType == JsonTokenType.Null ? (int?)null : utf8JsonReader.GetInt32());
                            break;
                        default:
                            break;
                    }
            ...
            if (enabled.IsSet && enabled.Value == null)
                throw new ArgumentNullException(nameof(enabled), "Property is not nullable for class UpdateFunctionRequestRetryPolicy.");

            if (maxRetries.IsSet && maxRetries.Value == null)
                throw new ArgumentNullException(nameof(maxRetries), "Property is not nullable for class UpdateFunctionRequestRetryPolicy.");

            if (backoffMs.IsSet && backoffMs.Value == null)
                throw new ArgumentNullException(nameof(backoffMs), "Property is not nullable for class UpdateFunctionRequestRetryPolicy.");

            return new UpdateFunctionRequestRetryPolicy(enabled, maxRetries, backoffMs);
        }

        /// <summary>
        /// Serializes a <see cref="UpdateFunctionRequestRetryPolicy" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="updateFunctionRequestRetryPolicy"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, UpdateFunctionRequestRetryPolicy updateFunctionRequestRetryPolicy, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, updateFunctionRequestRetryPolicy, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="UpdateFunctionRequestRetryPolicy" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="updateFunctionRequestRetryPolicy"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, UpdateFunctionRequestRetryPolicy updateFunctionRequestRetryPolicy, JsonSerializerOptions jsonSerializerOptions)
        {
            if (updateFunctionRequestRetryPolicy.EnabledOption.IsSet)
                writer.WriteBoolean("enabled", updateFunctionRequestRetryPolicy.EnabledOption.Value!.Value);

            if (updateFunctionRequestRetryPolicy.MaxRetriesOption.IsSet)
                writer.WriteNumber("maxRetries", updateFunctionRequestRetryPolicy.MaxRetriesOption.Value!.Value);

            if (updateFunctionRequestRetryPolicy.BackoffMsOption.IsSet)
                writer.WriteNumber("backoffMs", updateFunctionRequestRetryPolicy.BackoffMsOption.Value!.Value);
        }
    }
}
