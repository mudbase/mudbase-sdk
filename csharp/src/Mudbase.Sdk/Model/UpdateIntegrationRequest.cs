...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class UpdateIntegrationRequest : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public UpdateIntegrationRequest(Option<string?> name = default, Option<Object?> config = default, Option<Object?> credentials = default)
        {
            NameOption = name;
            ConfigOption = config;
    ...
    public class UpdateIntegrationRequestJsonConverter : JsonConverter<UpdateIntegrationRequest>
    {
        ...
        public override UpdateIntegrationRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class UpdateIntegrationRequest.");

            if (config.IsSet && config.Value == null)
                throw new ArgumentNullException(nameof(config), "Property is not nullable for class UpdateIntegrationRequest.");

            if (credentials.IsSet && credentials.Value == null)
                throw new ArgumentNullException(nameof(credentials), "Property is not nullable for class UpdateIntegrationRequest.");

            return new UpdateIntegrationRequest(name, config, credentials);
        }

        /// <summary>
        /// Serializes a <see cref="UpdateIntegrationRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="updateIntegrationRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, UpdateIntegrationRequest updateIntegrationRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, updateIntegrationRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="UpdateIntegrationRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="updateIntegrationRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, UpdateIntegrationRequest updateIntegrationRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (updateIntegrationRequest.NameOption.IsSet && updateIntegrationRequest.Name == null)
                throw new ArgumentNullException(nameof(updateIntegrationRequest.Name), "Property is required for class UpdateIntegrationRequest.");

            if (updateIntegrationRequest.ConfigOption.IsSet && updateIntegrationRequest.Config == null)
                throw new ArgumentNullException(nameof(updateIntegrationRequest.Config), "Property is required for class UpdateIntegrationRequest.");

            if (updateIntegrationRequest.CredentialsOption.IsSet && updateIntegrationRequest.Credentials == null)
                throw new ArgumentNullException(nameof(updateIntegrationRequest.Credentials), "Property is required for class UpdateIntegrationRequest.");

            if (updateIntegrationRequest.NameOption.IsSet)
                writer.WriteString("name", updateIntegrationRequest.Name);

            if (updateIntegrationRequest.ConfigOption.IsSet)
            {
                writer.WritePropertyName("config");
                JsonSerializer.Serialize(writer, updateIntegrationRequest.Config, jsonSerializerOptions);
            }
            if (updateIntegrationRequest.CredentialsOption.IsSet)
            {
                writer.WritePropertyName("credentials");
                JsonSerializer.Serialize(writer, updateIntegrationRequest.Credentials, jsonSerializerOptions);
            }
        }
    }
}
