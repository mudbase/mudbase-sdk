...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class UpdateMemberRoleRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateMemberRoleRequest" /> class.
        /// </summary>
        /// <param name="role">role</param>
        [JsonConstructor]
        public UpdateMemberRoleRequest(RoleEnum role)
        {
            Role = role;
            OnCreated();
        }
    ...
    /// <summary>
    /// A Json converter for type <see cref="UpdateMemberRoleRequest" />
    /// </summary>
    public partial class UpdateMemberRoleRequestJsonConverter : JsonConverter<UpdateMemberRoleRequest>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateMemberRoleRequestJsonConverter" /> class.
        /// </summary>
        public UpdateMemberRoleRequestJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="UpdateMemberRoleRequest" />
        /// </summary>
        ...
        public override UpdateMemberRoleRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<UpdateMemberRoleRequest.RoleEnum?> role = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "role":
                            ...
                            if (roleRawValue != null)
                                role = new Option<UpdateMemberRoleRequest.RoleEnum?>(UpdateMemberRoleRequest.RoleEnumFromStringOrDefault(roleRawValue));
                            break;
                        default:
                            break;
                    }
            ...
            if (!role.IsSet)
                throw new ArgumentException("Property is required for class UpdateMemberRoleRequest.", nameof(role));

            if (role.IsSet && role.Value == null)
                throw new ArgumentNullException(nameof(role), "Property is not nullable for class UpdateMemberRoleRequest.");

            return new UpdateMemberRoleRequest(role.Value!.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="UpdateMemberRoleRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="updateMemberRoleRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, UpdateMemberRoleRequest updateMemberRoleRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, updateMemberRoleRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="UpdateMemberRoleRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="updateMemberRoleRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, UpdateMemberRoleRequest updateMemberRoleRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            var roleRawValue = UpdateMemberRoleRequest.RoleEnumToJsonValue(updateMemberRoleRequest.Role);
