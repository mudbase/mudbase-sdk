...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class UpdateMultiRoleSettings200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateMultiRoleSettings200Response" /> class.
        /// </summary>
        /// <param name="success">success</param>
        /// <param name="message">message</param>
        /// <param name="data">Same shape as GET &#x60;/multi-role&#x60; — &#x60;isEnabled&#x60;, &#x60;defaultRole&#x60;, &#x60;settings&#x60;, and &#x60;roles&#x60; (no raw MultiRoleFeature document).</param>
        [JsonConstructor]
        public UpdateMultiRoleSettings200Response(Option<bool?> success = default, Option<string?> message = default, Option<Object?> data = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateMultiRoleSettings200Response {\n");
    ...
    public class UpdateMultiRoleSettings200ResponseJsonConverter : JsonConverter<UpdateMultiRoleSettings200Response>
    {
        ...
        public override UpdateMultiRoleSettings200Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (success.IsSet && success.Value == null)
                throw new ArgumentNullException(nameof(success), "Property is not nullable for class UpdateMultiRoleSettings200Response.");

            if (message.IsSet && message.Value == null)
                throw new ArgumentNullException(nameof(message), "Property is not nullable for class UpdateMultiRoleSettings200Response.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class UpdateMultiRoleSettings200Response.");

            return new UpdateMultiRoleSettings200Response(success, message, data);
        }

        /// <summary>
        /// Serializes a <see cref="UpdateMultiRoleSettings200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="updateMultiRoleSettings200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, UpdateMultiRoleSettings200Response updateMultiRoleSettings200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, updateMultiRoleSettings200Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="UpdateMultiRoleSettings200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="updateMultiRoleSettings200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, UpdateMultiRoleSettings200Response updateMultiRoleSettings200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (updateMultiRoleSettings200Response.MessageOption.IsSet && updateMultiRoleSettings200Response.Message == null)
                throw new ArgumentNullException(nameof(updateMultiRoleSettings200Response.Message), "Property is required for class UpdateMultiRoleSettings200Response.");

            if (updateMultiRoleSettings200Response.DataOption.IsSet && updateMultiRoleSettings200Response.Data == null)
                throw new ArgumentNullException(nameof(updateMultiRoleSettings200Response.Data), "Property is required for class UpdateMultiRoleSettings200Response.");

            if (updateMultiRoleSettings200Response.SuccessOption.IsSet)
                writer.WriteBoolean("success", updateMultiRoleSettings200Response.SuccessOption.Value!.Value);

            if (updateMultiRoleSettings200Response.MessageOption.IsSet)
                writer.WriteString("message", updateMultiRoleSettings200Response.Message);

            if (updateMultiRoleSettings200Response.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, updateMultiRoleSettings200Response.Data, jsonSerializerOptions);
            }
        }
    }
}
