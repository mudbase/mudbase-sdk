...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class UpdateOrganizationPlan200ResponseOneOf1 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateOrganizationPlan200ResponseOneOf1" /> class.
        /// </summary>
        /// <param name="error">error</param>
        /// <param name="message">message</param>
        [JsonConstructor]
        public UpdateOrganizationPlan200ResponseOneOf1(Option<string?> error = default, Option<string?> message = default)
        {
            ErrorOption = error;
    ...
    public class UpdateOrganizationPlan200ResponseOneOf1JsonConverter : JsonConverter<UpdateOrganizationPlan200ResponseOneOf1>
    {
        ...
        public override UpdateOrganizationPlan200ResponseOneOf1 Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (error.IsSet && error.Value == null)
                throw new ArgumentNullException(nameof(error), "Property is not nullable for class UpdateOrganizationPlan200ResponseOneOf1.");

            if (message.IsSet && message.Value == null)
                throw new ArgumentNullException(nameof(message), "Property is not nullable for class UpdateOrganizationPlan200ResponseOneOf1.");

            return new UpdateOrganizationPlan200ResponseOneOf1(error, message);
        }

        /// <summary>
        /// Serializes a <see cref="UpdateOrganizationPlan200ResponseOneOf1" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="updateOrganizationPlan200ResponseOneOf1"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, UpdateOrganizationPlan200ResponseOneOf1 updateOrganizationPlan200ResponseOneOf1, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, updateOrganizationPlan200ResponseOneOf1, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="UpdateOrganizationPlan200ResponseOneOf1" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="updateOrganizationPlan200ResponseOneOf1"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, UpdateOrganizationPlan200ResponseOneOf1 updateOrganizationPlan200ResponseOneOf1, JsonSerializerOptions jsonSerializerOptions)
        {
            if (updateOrganizationPlan200ResponseOneOf1.ErrorOption.IsSet && updateOrganizationPlan200ResponseOneOf1.Error == null)
                throw new ArgumentNullException(nameof(updateOrganizationPlan200ResponseOneOf1.Error), "Property is required for class UpdateOrganizationPlan200ResponseOneOf1.");

            if (updateOrganizationPlan200ResponseOneOf1.MessageOption.IsSet && updateOrganizationPlan200ResponseOneOf1.Message == null)
                throw new ArgumentNullException(nameof(updateOrganizationPlan200ResponseOneOf1.Message), "Property is required for class UpdateOrganizationPlan200ResponseOneOf1.");

            if (updateOrganizationPlan200ResponseOneOf1.ErrorOption.IsSet)
                writer.WriteString("error", updateOrganizationPlan200ResponseOneOf1.Error);

            if (updateOrganizationPlan200ResponseOneOf1.MessageOption.IsSet)
                writer.WriteString("message", updateOrganizationPlan200ResponseOneOf1.Message);
        }
    }
}
