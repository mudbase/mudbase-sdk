...
namespace Mudbase.Sdk.Model
{
    ...
    public partial class UpdateWalletFeeConfigRequest : IValidatableObject
    {
        ...
        [JsonConstructor]
        public UpdateWalletFeeConfigRequest(Option<bool?> enabled = default, Option<decimal?> feePercentage = default)
        {
    ...
    public partial class UpdateWalletFeeConfigRequestJsonConverter : JsonConverter<UpdateWalletFeeConfigRequest>
    {
        ...
        public override UpdateWalletFeeConfigRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (enabled.IsSet && enabled.Value == null)
                throw new ArgumentNullException(nameof(enabled), "Property is not nullable for class UpdateWalletFeeConfigRequest.");

            if (feePercentage.IsSet && feePercentage.Value == null)
                throw new ArgumentNullException(nameof(feePercentage), "Property is not nullable for class UpdateWalletFeeConfigRequest.");

            return new UpdateWalletFeeConfigRequest(enabled, feePercentage);
        }

        /// <summary>
        /// Serializes a <see cref="UpdateWalletFeeConfigRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="updateWalletFeeConfigRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, UpdateWalletFeeConfigRequest updateWalletFeeConfigRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, updateWalletFeeConfigRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="UpdateWalletFeeConfigRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="updateWalletFeeConfigRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, UpdateWalletFeeConfigRequest updateWalletFeeConfigRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (updateWalletFeeConfigRequest.EnabledOption.IsSet)
                writer.WriteBoolean("enabled", updateWalletFeeConfigRequest.EnabledOption.Value!.Value);

            if (updateWalletFeeConfigRequest.FeePercentageOption.IsSet)
                writer.WriteNumber("feePercentage", updateWalletFeeConfigRequest.FeePercentageOption.Value!.Value);
        }
    }
}
