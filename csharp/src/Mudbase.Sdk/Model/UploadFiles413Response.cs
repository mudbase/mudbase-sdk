...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class UploadFiles413Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UploadFiles413Response" /> class.
        /// </summary>
        /// <param name="error">error</param>
        /// <param name="maxFileUploadBytes">maxFileUploadBytes</param>
        [JsonConstructor]
        public UploadFiles413Response(Option<string?> error = default, Option<long?> maxFileUploadBytes = default)
        {
            ErrorOption = error;
    ...
    public partial class UploadFiles413ResponseJsonConverter : JsonConverter<UploadFiles413Response>
    {
        ...
        public override UploadFiles413Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (error.IsSet && error.Value == null)
                throw new ArgumentNullException(nameof(error), "Property is not nullable for class UploadFiles413Response.");

            if (maxFileUploadBytes.IsSet && maxFileUploadBytes.Value == null)
                throw new ArgumentNullException(nameof(maxFileUploadBytes), "Property is not nullable for class UploadFiles413Response.");

            return new UploadFiles413Response(error, maxFileUploadBytes);
        }

        /// <summary>
        /// Serializes a <see cref="UploadFiles413Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="uploadFiles413Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, UploadFiles413Response uploadFiles413Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, uploadFiles413Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="UploadFiles413Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="uploadFiles413Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, UploadFiles413Response uploadFiles413Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (uploadFiles413Response.ErrorOption.IsSet && uploadFiles413Response.Error == null)
                throw new ArgumentNullException(nameof(uploadFiles413Response.Error), "Property is required for class UploadFiles413Response.");

            if (uploadFiles413Response.ErrorOption.IsSet)
                writer.WriteString("error", uploadFiles413Response.Error);

            if (uploadFiles413Response.MaxFileUploadBytesOption.IsSet)
                writer.WriteNumber("maxFileUploadBytes", uploadFiles413Response.MaxFileUploadBytesOption.Value!.Value);
        }
    }
}
