...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class UploadVerificationDocumentsRequestDocumentsInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UploadVerificationDocumentsRequestDocumentsInner" /> class.
        /// </summary>
        /// <param name="type">type</param>
        /// <param name="url">url</param>
        [JsonConstructor]
        public UploadVerificationDocumentsRequestDocumentsInner(Option<string?> type = default, Option<string?> url = default)
        {
            TypeOption = type;
            UrlOption = url;
            OnCreated();
    ...
    public partial class UploadVerificationDocumentsRequestDocumentsInnerJsonConverter : JsonConverter<UploadVerificationDocumentsRequestDocumentsInner>
    {
        ...
        public override UploadVerificationDocumentsRequestDocumentsInner Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class UploadVerificationDocumentsRequestDocumentsInner.");

            if (url.IsSet && url.Value == null)
                throw new ArgumentNullException(nameof(url), "Property is not nullable for class UploadVerificationDocumentsRequestDocumentsInner.");

            return new UploadVerificationDocumentsRequestDocumentsInner(type, url);
        }

        /// <summary>
        /// Serializes a <see cref="UploadVerificationDocumentsRequestDocumentsInner" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="uploadVerificationDocumentsRequestDocumentsInner"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, UploadVerificationDocumentsRequestDocumentsInner uploadVerificationDocumentsRequestDocumentsInner, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, uploadVerificationDocumentsRequestDocumentsInner, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="UploadVerificationDocumentsRequestDocumentsInner" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="uploadVerificationDocumentsRequestDocumentsInner"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, UploadVerificationDocumentsRequestDocumentsInner uploadVerificationDocumentsRequestDocumentsInner, JsonSerializerOptions jsonSerializerOptions)
        {
            if (uploadVerificationDocumentsRequestDocumentsInner.TypeOption.IsSet && uploadVerificationDocumentsRequestDocumentsInner.Type == null)
                throw new ArgumentNullException(nameof(uploadVerificationDocumentsRequestDocumentsInner.Type), "Property is required for class UploadVerificationDocumentsRequestDocumentsInner.");

            if (uploadVerificationDocumentsRequestDocumentsInner.UrlOption.IsSet && uploadVerificationDocumentsRequestDocumentsInner.Url == null)
                throw new ArgumentNullException(nameof(uploadVerificationDocumentsRequestDocumentsInner.Url), "Property is required for class UploadVerificationDocumentsRequestDocumentsInner.");

            if (uploadVerificationDocumentsRequestDocumentsInner.TypeOption.IsSet)
                writer.WriteString("type", uploadVerificationDocumentsRequestDocumentsInner.Type);

            if (uploadVerificationDocumentsRequestDocumentsInner.UrlOption.IsSet)
                writer.WriteString("url", uploadVerificationDocumentsRequestDocumentsInner.Url);
        }
    }
}
