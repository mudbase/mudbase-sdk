...
namespace Mudbase.Sdk.Model
{
    ...
    public partial class UsageStatsResponsePercentages : IValidatableObject
    {
        ...
        [JsonConstructor]
        public UsageStatsResponsePercentages(Option<decimal?> apiCalls = default, Option<decimal?> storage = default, Option<decimal?> bandwidth = default)
        {
    ...
    public partial class UsageStatsResponsePercentagesJsonConverter : JsonConverter<UsageStatsResponsePercentages>
    {
        ...
        public override UsageStatsResponsePercentages Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (apiCalls.IsSet && apiCalls.Value == null)
                throw new ArgumentNullException(nameof(apiCalls), "Property is not nullable for class UsageStatsResponsePercentages.");

            if (storage.IsSet && storage.Value == null)
                throw new ArgumentNullException(nameof(storage), "Property is not nullable for class UsageStatsResponsePercentages.");

            if (bandwidth.IsSet && bandwidth.Value == null)
                throw new ArgumentNullException(nameof(bandwidth), "Property is not nullable for class UsageStatsResponsePercentages.");

            return new UsageStatsResponsePercentages(apiCalls, storage, bandwidth);
        }

        /// <summary>
        /// Serializes a <see cref="UsageStatsResponsePercentages" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="usageStatsResponsePercentages"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, UsageStatsResponsePercentages usageStatsResponsePercentages, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, usageStatsResponsePercentages, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="UsageStatsResponsePercentages" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="usageStatsResponsePercentages"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, UsageStatsResponsePercentages usageStatsResponsePercentages, JsonSerializerOptions jsonSerializerOptions)
        {
            if (usageStatsResponsePercentages.ApiCallsOption.IsSet)
                writer.WriteNumber("apiCalls", usageStatsResponsePercentages.ApiCallsOption.Value!.Value);

            if (usageStatsResponsePercentages.StorageOption.IsSet)
                writer.WriteNumber("storage", usageStatsResponsePercentages.StorageOption.Value!.Value);

            if (usageStatsResponsePercentages.BandwidthOption.IsSet)
                writer.WriteNumber("bandwidth", usageStatsResponsePercentages.BandwidthOption.Value!.Value);
        }
    }
}
