...
namespace Mudbase.Sdk.Model
{
    ...
    public partial class ValidateAddress200ResponseData : IValidatableObject
    {
        ...
        [JsonConstructor]
        public ValidateAddress200ResponseData(Option<bool?> isValid = default, Option<string?> currency = default, Option<string?> address = default)
        {
    ...
    public partial class ValidateAddress200ResponseDataJsonConverter : JsonConverter<ValidateAddress200ResponseData>
    {
        ...
        public override ValidateAddress200ResponseData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (isValid.IsSet && isValid.Value == null)
                throw new ArgumentNullException(nameof(isValid), "Property is not nullable for class ValidateAddress200ResponseData.");

            if (currency.IsSet && currency.Value == null)
                throw new ArgumentNullException(nameof(currency), "Property is not nullable for class ValidateAddress200ResponseData.");

            if (address.IsSet && address.Value == null)
                throw new ArgumentNullException(nameof(address), "Property is not nullable for class ValidateAddress200ResponseData.");

            return new ValidateAddress200ResponseData(isValid, currency, address);
        }

        /// <summary>
        /// Serializes a <see cref="ValidateAddress200ResponseData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="validateAddress200ResponseData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ValidateAddress200ResponseData validateAddress200ResponseData, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, validateAddress200ResponseData, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ValidateAddress200ResponseData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="validateAddress200ResponseData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ValidateAddress200ResponseData validateAddress200ResponseData, JsonSerializerOptions jsonSerializerOptions)
        {
            if (validateAddress200ResponseData.CurrencyOption.IsSet && validateAddress200ResponseData.Currency == null)
                throw new ArgumentNullException(nameof(validateAddress200ResponseData.Currency), "Property is required for class ValidateAddress200ResponseData.");

            if (validateAddress200ResponseData.AddressOption.IsSet && validateAddress200ResponseData.Address == null)
                throw new ArgumentNullException(nameof(validateAddress200ResponseData.Address), "Property is required for class ValidateAddress200ResponseData.");

            if (validateAddress200ResponseData.IsValidOption.IsSet)
                writer.WriteBoolean("isValid", validateAddress200ResponseData.IsValidOption.Value!.Value);

            if (validateAddress200ResponseData.CurrencyOption.IsSet)
                writer.WriteString("currency", validateAddress200ResponseData.Currency);

            if (validateAddress200ResponseData.AddressOption.IsSet)
                writer.WriteString("address", validateAddress200ResponseData.Address);
        }
    }
}
