...
namespace Mudbase.Sdk.Model
{
    ...
    /// </summary>
    public partial class ValidatePasswordResetToken200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ValidatePasswordResetToken200Response" /> class.
        /// </summary>
        /// <param name="valid">valid</param>
        [JsonConstructor]
        public ValidatePasswordResetToken200Response(Option<bool?> valid = default)
        {
            ValidOption = valid;
            OnCreated();
        }
    ...
    public class ValidatePasswordResetToken200ResponseJsonConverter : JsonConverter<ValidatePasswordResetToken200Response>
    {
        ...
        public override ValidatePasswordResetToken200Response Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (valid.IsSet && valid.Value == null)
                throw new ArgumentNullException(nameof(valid), "Property is not nullable for class ValidatePasswordResetToken200Response.");

            return new ValidatePasswordResetToken200Response(valid);
        }

        /// <summary>
        /// Serializes a <see cref="ValidatePasswordResetToken200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="validatePasswordResetToken200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ValidatePasswordResetToken200Response validatePasswordResetToken200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, validatePasswordResetToken200Response, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ValidatePasswordResetToken200Response" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="validatePasswordResetToken200Response"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ValidatePasswordResetToken200Response validatePasswordResetToken200Response, JsonSerializerOptions jsonSerializerOptions)
        {
            if (validatePasswordResetToken200Response.ValidOption.IsSet)
                writer.WriteBoolean("valid", validatePasswordResetToken200Response.ValidOption.Value!.Value);
        }
    }
}
