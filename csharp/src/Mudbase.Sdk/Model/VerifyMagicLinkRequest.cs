...
namespace Mudbase.Sdk.Model
{
    ...
    public partial class VerifyMagicLinkRequest : IValidatableObject
    {
        ...
        [JsonConstructor]
        public VerifyMagicLinkRequest(string token)
        {
            Token = token;
            OnCreated();
        }
    ...
    public class VerifyMagicLinkRequestJsonConverter : JsonConverter<VerifyMagicLinkRequest>
    {
        ...
        public override VerifyMagicLinkRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!token.IsSet)
                throw new ArgumentException("Property is required for class VerifyMagicLinkRequest.", nameof(token));

            if (token.IsSet && token.Value == null)
                throw new ArgumentNullException(nameof(token), "Property is not nullable for class VerifyMagicLinkRequest.");

            return new VerifyMagicLinkRequest(token.Value!);
        }

        /// <summary>
        /// Serializes a <see cref="VerifyMagicLinkRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="verifyMagicLinkRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, VerifyMagicLinkRequest verifyMagicLinkRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, verifyMagicLinkRequest, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="VerifyMagicLinkRequest" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="verifyMagicLinkRequest"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, VerifyMagicLinkRequest verifyMagicLinkRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            if (verifyMagicLinkRequest.Token == null)
                throw new ArgumentNullException(nameof(verifyMagicLinkRequest.Token), "Property is required for class VerifyMagicLinkRequest.");

            writer.WriteString("token", verifyMagicLinkRequest.Token);
        }
    }
}
