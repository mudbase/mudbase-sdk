...
namespace Mudbase.Sdk.Model
{
    ...
    public partial class WebhookListResponse : IValidatableObject
    {
        ...
        [JsonConstructor]
        public WebhookListResponse(Option<List<WebhookLog>?> webhooks = default, Option<int?> total = default, Option<int?> page = default, Option<int?> limit = default, Option<int?> totalPages = default)
        {
        ...
        public Option<List<WebhookLog>?> WebhooksOption { get; private set; }
    ...
    public class WebhookListResponseJsonConverter : JsonConverter<WebhookListResponse>
    {
        ...
        public override WebhookListResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<WebhookLog>?> webhooks = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "webhooks":
                            webhooks = new Option<List<WebhookLog>?>(JsonSerializer.Deserialize<List<WebhookLog>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "total":
            ...
            if (webhooks.IsSet && webhooks.Value == null)
                throw new ArgumentNullException(nameof(webhooks), "Property is not nullable for class WebhookListResponse.");

            if (total.IsSet && total.Value == null)
                throw new ArgumentNullException(nameof(total), "Property is not nullable for class WebhookListResponse.");

            if (page.IsSet && page.Value == null)
                throw new ArgumentNullException(nameof(page), "Property is not nullable for class WebhookListResponse.");

            if (limit.IsSet && limit.Value == null)
                throw new ArgumentNullException(nameof(limit), "Property is not nullable for class WebhookListResponse.");

            if (totalPages.IsSet && totalPages.Value == null)
                throw new ArgumentNullException(nameof(totalPages), "Property is not nullable for class WebhookListResponse.");

            return new WebhookListResponse(webhooks, total, page, limit, totalPages);
        }

        /// <summary>
        /// Serializes a <see cref="WebhookListResponse" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="webhookListResponse"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, WebhookListResponse webhookListResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, webhookListResponse, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="WebhookListResponse" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="webhookListResponse"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, WebhookListResponse webhookListResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            if (webhookListResponse.WebhooksOption.IsSet && webhookListResponse.Webhooks == null)
                throw new ArgumentNullException(nameof(webhookListResponse.Webhooks), "Property is required for class WebhookListResponse.");

            if (webhookListResponse.WebhooksOption.IsSet)
            {
                writer.WritePropertyName("webhooks");
                JsonSerializer.Serialize(writer, webhookListResponse.Webhooks, jsonSerializerOptions);
            }
            if (webhookListResponse.TotalOption.IsSet)
                writer.WriteNumber("total", webhookListResponse.TotalOption.Value!.Value);

            if (webhookListResponse.PageOption.IsSet)
                writer.WriteNumber("page", webhookListResponse.PageOption.Value!.Value);

            if (webhookListResponse.LimitOption.IsSet)
                writer.WriteNumber("limit", webhookListResponse.LimitOption.Value!.Value);

            if (webhookListResponse.TotalPagesOption.IsSet)
                writer.WriteNumber("totalPages", webhookListResponse.TotalPagesOption.Value!.Value);
        }
    }
}
