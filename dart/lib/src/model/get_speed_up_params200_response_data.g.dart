...
part of 'get_speed_up_params200_response_data.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$GetSpeedUpParams200ResponseData
    extends GetSpeedUpParams200ResponseData {
  @override
  final int? chainId;
  @override
  final String? from;
  ...
  factory _$GetSpeedUpParams200ResponseData(
          [void Function(GetSpeedUpParams200ResponseDataBuilder)? updates]) =>
      (GetSpeedUpParams200ResponseDataBuilder()..update(updates))._build();

  _$GetSpeedUpParams200ResponseData._(
      {this.chainId,
      this.from,
      this.nonce,
      this.to,
      ...
      : super._();
  @override
  GetSpeedUpParams200ResponseData rebuild(
          void Function(GetSpeedUpParams200ResponseDataBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  GetSpeedUpParams200ResponseDataBuilder toBuilder() =>
      GetSpeedUpParams200ResponseDataBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is GetSpeedUpParams200ResponseData &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'GetSpeedUpParams200ResponseData')
          ..add('chainId', chainId)
          ..add('from', from)
          ..add('nonce', nonce)
          ..add('to', to)
...
class GetSpeedUpParams200ResponseDataBuilder
    implements
        Builder<GetSpeedUpParams200ResponseData,
            GetSpeedUpParams200ResponseDataBuilder> {
  _$GetSpeedUpParams200ResponseData? _$v;
  ...
  GetSpeedUpParams200ResponseDataBuilder() {
    GetSpeedUpParams200ResponseData._defaults(this);
  }

  GetSpeedUpParams200ResponseDataBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _chainId = $v.chainId;
      _from = $v.from;
  ...
  @override
  void replace(GetSpeedUpParams200ResponseData other) {
    _$v = other as _$GetSpeedUpParams200ResponseData;
  }

  @override
  void update(void Function(GetSpeedUpParams200ResponseDataBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  GetSpeedUpParams200ResponseData build() => _build();

  _$GetSpeedUpParams200ResponseData _build() {
    final _$result = _$v ??
        _$GetSpeedUpParams200ResponseData._(
          chainId: chainId,
          from: from,
