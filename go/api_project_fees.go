...
func (r ApiCancelPayoutRequest) PlatformAdminDetachMemberRequest(platformAdminDetachMemberRequest PlatformAdminDetachMemberRequest) ApiCancelPayoutRequest {
	r.platformAdminDetachMemberRequest = &platformAdminDetachMemberRequest
	return r
}

func (r ApiCancelPayoutRequest) Execute() (*ApplyRoleFeaturePreset200Response, *http.Response, error) {
	return r.ApiService.CancelPayoutExecute(r)
}

/*
CancelPayout ~~Cancel payout (Admin)~~ (deprecated)
...
Deprecated
*/
func (a *ProjectFeesAPIService) CancelPayout(ctx context.Context, payoutId string) ApiCancelPayoutRequest {
	return ApiCancelPayoutRequest{
		ApiService: a,
		ctx: ctx,
		payoutId: payoutId,
...
// Deprecated
func (a *ProjectFeesAPIService) CancelPayoutExecute(r ApiCancelPayoutRequest) (*ApplyRoleFeaturePreset200Response, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ProjectFeesAPIService.CancelPayout")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/admin/payouts/{payoutId}/cancel"
...
type ApiGetAdminPayoutDashboardRequest struct {
	ctx context.Context
	ApiService *ProjectFeesAPIService
}

func (r ApiGetAdminPayoutDashboardRequest) Execute() (*GetAdminPayoutDashboard200Response, *http.Response, error) {
	return r.ApiService.GetAdminPayoutDashboardExecute(r)
}

/*
GetAdminPayoutDashboard ~~Get admin payout dashboard (Admin)~~ (deprecated)

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetAdminPayoutDashboardRequest

Deprecated
*/
func (a *ProjectFeesAPIService) GetAdminPayoutDashboard(ctx context.Context) ApiGetAdminPayoutDashboardRequest {
	return ApiGetAdminPayoutDashboardRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Deprecated
func (a *ProjectFeesAPIService) GetAdminPayoutDashboardExecute(r ApiGetAdminPayoutDashboardRequest) (*GetAdminPayoutDashboard200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetAdminPayoutDashboard200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ProjectFeesAPIService.GetAdminPayoutDashboard")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/admin/payouts/dashboard"
...
type ApiGetPendingPayoutsRequest struct {
	ctx context.Context
	ApiService *ProjectFeesAPIService
	status *string
	currency *string
...
func (r ApiGetPendingPayoutsRequest) Status(status string) ApiGetPendingPayoutsRequest {
	r.status = &status
	return r
}

func (r ApiGetPendingPayoutsRequest) Currency(currency string) ApiGetPendingPayoutsRequest {
	r.currency = &currency
	return r
}

func (r ApiGetPendingPayoutsRequest) Limit(limit int32) ApiGetPendingPayoutsRequest {
	r.limit = &limit
	return r
}

func (r ApiGetPendingPayoutsRequest) Page(page int32) ApiGetPendingPayoutsRequest {
	r.page = &page
	return r
}

func (r ApiGetPendingPayoutsRequest) Execute() (*GetPendingPayouts200Response, *http.Response, error) {
	return r.ApiService.GetPendingPayoutsExecute(r)
}

/*
GetPendingPayouts ~~Get all pending payouts (Admin)~~ (deprecated)

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetPendingPayoutsRequest

Deprecated
*/
func (a *ProjectFeesAPIService) GetPendingPayouts(ctx context.Context) ApiGetPendingPayoutsRequest {
	return ApiGetPendingPayoutsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Deprecated
func (a *ProjectFeesAPIService) GetPendingPayoutsExecute(r ApiGetPendingPayoutsRequest) (*GetPendingPayouts200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetPendingPayouts200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ProjectFeesAPIService.GetPendingPayouts")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/admin/payouts/pending"
...
type ApiProcessPayoutRequest struct {
	ctx context.Context
	ApiService *ProjectFeesAPIService
	payoutId string
}

func (r ApiProcessPayoutRequest) Execute() (*ApplyRoleFeaturePreset200Response, *http.Response, error) {
	return r.ApiService.ProcessPayoutExecute(r)
}

/*
ProcessPayout ~~Manually process payout (Admin)~~ (deprecated)

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param payoutId
 @return ApiProcessPayoutRequest

Deprecated
*/
func (a *ProjectFeesAPIService) ProcessPayout(ctx context.Context, payoutId string) ApiProcessPayoutRequest {
	return ApiProcessPayoutRequest{
		ApiService: a,
		ctx: ctx,
		payoutId: payoutId,
...
//  @return ApplyRoleFeaturePreset200Response
// Deprecated
func (a *ProjectFeesAPIService) ProcessPayoutExecute(r ApiProcessPayoutRequest) (*ApplyRoleFeaturePreset200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ProjectFeesAPIService.ProcessPayout")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/admin/payouts/{payoutId}/process"
	localVarPath = strings.Replace(localVarPath, "{"+"payoutId"+"}", url.PathEscape(parameterValueToString(r.payoutId, "payoutId")), -1)
