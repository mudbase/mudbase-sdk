...
`func (o *CreateRoleRequestCollectionPermissionsValue) GetActions() []string`

GetActions returns the Actions field if non-nil, zero value otherwise.

### GetActionsOk

`func (o *CreateRoleRequestCollectionPermissionsValue) GetActionsOk() (*[]string, bool)`
...
`func (o *CreateRoleRequestCollectionPermissionsValue) SetActions(v []string)`
