...
// checks if the GetDashboardOrganizations200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetDashboardOrganizations200Response{}

// GetDashboardOrganizations200Response struct for GetDashboardOrganizations200Response
type GetDashboardOrganizations200Response struct {
	Success *bool `json:"success,omitempty"`
	Organizations []GetDashboardOrganizations200ResponseOrganizationsInner `json:"organizations,omitempty"`
...
func NewGetDashboardOrganizations200Response() *GetDashboardOrganizations200Response {
	this := GetDashboardOrganizations200Response{}
	return &this
}
...
func (o *GetDashboardOrganizations200Response) GetOrganizations() []GetDashboardOrganizations200ResponseOrganizationsInner {
	if o == nil || IsNil(o.Organizations) {
		var ret []GetDashboardOrganizations200ResponseOrganizationsInner
		return ret
	}
...
// SetOrganizations gets a reference to the given []GetDashboardOrganizations200ResponseOrganizationsInner and assigns it to the Organizations field.
...
func (o GetDashboardOrganizations200Response) MarshalJSON() ([]byte, error) {
...
func (o GetDashboardOrganizations200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetDashboardOrganizations200Response struct {
	value *GetDashboardOrganizations200Response
	isSet bool
}

func (v NullableGetDashboardOrganizations200Response) Get() *GetDashboardOrganizations200Response {
	return v.value
}

func (v *NullableGetDashboardOrganizations200Response) Set(val *GetDashboardOrganizations200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetDashboardOrganizations200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetDashboardOrganizations200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetDashboardOrganizations200Response(val *GetDashboardOrganizations200Response) *NullableGetDashboardOrganizations200Response {
	return &NullableGetDashboardOrganizations200Response{value: val, isSet: true}
}

func (v NullableGetDashboardOrganizations200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetDashboardOrganizations200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
