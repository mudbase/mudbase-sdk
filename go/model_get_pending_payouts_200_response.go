...
// checks if the GetPendingPayouts200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetPendingPayouts200Response{}

// GetPendingPayouts200Response struct for GetPendingPayouts200Response
type GetPendingPayouts200Response struct {
	Success *bool `json:"success,omitempty"`
	Data []GetPendingPayouts200ResponseDataInner `json:"data,omitempty"`
...
func NewGetPendingPayouts200Response() *GetPendingPayouts200Response {
	this := GetPendingPayouts200Response{}
	return &this
}
...
func (o *GetPendingPayouts200Response) GetData() []GetPendingPayouts200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetPendingPayouts200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetPendingPayouts200ResponseDataInner and assigns it to the Data field.
...
func (o GetPendingPayouts200Response) MarshalJSON() ([]byte, error) {
...
func (o GetPendingPayouts200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetPendingPayouts200Response struct {
	value *GetPendingPayouts200Response
	isSet bool
}

func (v NullableGetPendingPayouts200Response) Get() *GetPendingPayouts200Response {
	return v.value
}

func (v *NullableGetPendingPayouts200Response) Set(val *GetPendingPayouts200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetPendingPayouts200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetPendingPayouts200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetPendingPayouts200Response(val *GetPendingPayouts200Response) *NullableGetPendingPayouts200Response {
	return &NullableGetPendingPayouts200Response{value: val, isSet: true}
}

func (v NullableGetPendingPayouts200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetPendingPayouts200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
