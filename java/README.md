...
```groovy
  repositories {
    mavenCentral()     // Needed if the 'mudbase-sdk' jar has been published to maven central.
    mavenLocal()       // Needed if the 'mudbase-sdk' jar has been published to the local maven repo.
  }

  dependencies {
     implementation "dev.mudbase:mudbase-sdk:2.0.0"
  }
```
