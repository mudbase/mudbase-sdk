...
import dev.mudbase.sdk.auth.Authentication;
import dev.mudbase.sdk.auth.HttpBasicAuth;
import dev.mudbase.sdk.auth.HttpBearerAuth;
import dev.mudbase.sdk.auth.ApiKeyAuth;
...
public class ApiClient {
    ...
    protected String basePath = "https://cloud.mudbase.dev";
    ...
    new ServerConfiguration(
      "https://connect--mudbase-server--c964r44kbjpw.code.run",
      "Staging server",
      new HashMap<String, ServerVariable>()
    ),
    new ServerConfiguration(
      "https://mudbase-server.onrender.com",
      "Alternative Staging server",
      new HashMap<String, ServerVariable>()
    ),
    new ServerConfiguration(
      "http://localhost:5000",
    ...
    public ApiClient() {
        ...
        authentications.put("OrgBearerAuth", new HttpBearerAuth("bearer"));
        authentications.put("ProjectBearerAuth", new HttpBearerAuth("bearer"));
        authentications.put("ApiKeyAuth", new ApiKeyAuth("header", "X-API-Key"));
        authentications.put("InternalApiKey", new ApiKeyAuth("header", "X-Internal-Api-Key"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://cloud.mudbase.dev)
     ...
     * @return a {@link dev.mudbase.sdk.ApiClient} object
     */
    ...
    */
     ...
     * @throws dev.mudbase.sdk.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws dev.mudbase.sdk.ApiException If fail to serialize the given object
     */
     ...
     * @throws dev.mudbase.sdk.ApiException If fail to read file content from response and write to disk
     ...
     * @throws dev.mudbase.sdk.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws dev.mudbase.sdk.ApiException If the response has an unsuccessful status code or
     ...
     * @throws dev.mudbase.sdk.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws dev.mudbase.sdk.ApiException If fails to update the parameters
     */
     ...
     * @throws dev.mudbase.sdk.ApiException If fail to serialize the request body object into a string
     */
