...
public class AddParticipantRequest {
  ...
  public AddParticipantRequest userId(@javax.annotation.Nonnull String userId) {
    this.userId = userId;
    return this;
  }
  ...
  public AddParticipantRequest role(@javax.annotation.Nullable RoleEnum role) {
    this.role = role;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddParticipantRequest addParticipantRequest = (AddParticipantRequest) o;
    return Objects.equals(this.userId, addParticipantRequest.userId) &&
        Objects.equals(this.role, addParticipantRequest.role);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddParticipantRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddParticipantRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AddParticipantRequest is not found in the empty JSON string", AddParticipantRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddParticipantRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AddParticipantRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddParticipantRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddParticipantRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddParticipantRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddParticipantRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddParticipantRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddParticipantRequest>() {
           @Override
           public void write(JsonWriter out, AddParticipantRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddParticipantRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddParticipantRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddParticipantRequest
   * @throws IOException if the JSON string is invalid with respect to AddParticipantRequest
   */
  public static AddParticipantRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddParticipantRequest.class);
  }

  /**
   * Convert an instance of AddParticipantRequest to an JSON string
   *
   * @return JSON string
   */
