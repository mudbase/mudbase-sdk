...
public class AddReaction200ResponseDataInner {
  ...
  public AddReaction200ResponseDataInner() {
  }

  public AddReaction200ResponseDataInner emoji(@javax.annotation.Nullable String emoji) {
    this.emoji = emoji;
    return this;
  }
  ...
  public AddReaction200ResponseDataInner users(@javax.annotation.Nullable List<String> users) {
    this.users = users;
    return this;
  }

  public AddReaction200ResponseDataInner addUsersItem(String usersItem) {
    if (this.users == null) {
  ...
  public boolean equals(Object o) {
    ...
    AddReaction200ResponseDataInner addReaction200ResponseDataInner = (AddReaction200ResponseDataInner) o;
    return Objects.equals(this.emoji, addReaction200ResponseDataInner.emoji) &&
        Objects.equals(this.users, addReaction200ResponseDataInner.users);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("emoji", "users"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddReaction200ResponseDataInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddReaction200ResponseDataInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AddReaction200ResponseDataInner is not found in the empty JSON string", AddReaction200ResponseDataInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddReaction200ResponseDataInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AddReaction200ResponseDataInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddReaction200ResponseDataInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddReaction200ResponseDataInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddReaction200ResponseDataInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddReaction200ResponseDataInner.class));

       return (TypeAdapter<T>) new TypeAdapter<AddReaction200ResponseDataInner>() {
           @Override
           public void write(JsonWriter out, AddReaction200ResponseDataInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddReaction200ResponseDataInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddReaction200ResponseDataInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddReaction200ResponseDataInner
   * @throws IOException if the JSON string is invalid with respect to AddReaction200ResponseDataInner
   */
  public static AddReaction200ResponseDataInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddReaction200ResponseDataInner.class);
  }

  /**
   * Convert an instance of AddReaction200ResponseDataInner to an JSON string
   *
   * @return JSON string
   */
