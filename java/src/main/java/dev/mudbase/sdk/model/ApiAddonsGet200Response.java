...
public class ApiAddonsGet200Response {
  ...
  public ApiAddonsGet200Response() {
  }

  public ApiAddonsGet200Response addons(@javax.annotation.Nullable List<Object> addons) {
    this.addons = addons;
    return this;
  }

  public ApiAddonsGet200Response addAddonsItem(Object addonsItem) {
    if (this.addons == null) {
  ...
  public void setAddons(@javax.annotation.Nullable List<Object> addons) {
    this.addons = addons;
  }
  ...
  public boolean equals(Object o) {
    ...
    ApiAddonsGet200Response apiAddonsGet200Response = (ApiAddonsGet200Response) o;
    return Objects.equals(this.addons, apiAddonsGet200Response.addons);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApiAddonsGet200Response {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("addons"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to ApiAddonsGet200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApiAddonsGet200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ApiAddonsGet200Response is not found in the empty JSON string", ApiAddonsGet200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApiAddonsGet200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ApiAddonsGet200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // ensure the optional json data is an array if present
      if (jsonObj.get("addons") != null && !jsonObj.get("addons").isJsonNull() && !jsonObj.get("addons").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `addons` to be an array in the JSON string but got `%s`", jsonObj.get("addons").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApiAddonsGet200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApiAddonsGet200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApiAddonsGet200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApiAddonsGet200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<ApiAddonsGet200Response>() {
           @Override
           public void write(JsonWriter out, ApiAddonsGet200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ApiAddonsGet200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ApiAddonsGet200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ApiAddonsGet200Response
   * @throws IOException if the JSON string is invalid with respect to ApiAddonsGet200Response
   */
  public static ApiAddonsGet200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApiAddonsGet200Response.class);
  }

  /**
   * Convert an instance of ApiAddonsGet200Response to an JSON string
   *
   * @return JSON string
   */
