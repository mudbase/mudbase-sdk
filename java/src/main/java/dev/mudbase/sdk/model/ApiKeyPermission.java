...
public class ApiKeyPermission {
  ...
  public ApiKeyPermission resource(@javax.annotation.Nonnull ResourceEnum resource) {
  ...
  public void setResource(@javax.annotation.Nonnull ResourceEnum resource) {
    this.resource = resource;
  }


  public ApiKeyPermission actions(@javax.annotation.Nonnull List<ActionsEnum> actions) {
    this.actions = actions;
    return this;
  }

  public ApiKeyPermission addActionsItem(ActionsEnum actionsItem) {
  ...
  public boolean equals(Object o) {
    ...
    ApiKeyPermission apiKeyPermission = (ApiKeyPermission) o;
    return Objects.equals(this.resource, apiKeyPermission.resource) &&
        Objects.equals(this.actions, apiKeyPermission.actions);
  }
  ...
  static {
    ...
    openapiRequiredFields = new HashSet<String>(Arrays.asList("resource", "actions"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ApiKeyPermission
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApiKeyPermission.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ApiKeyPermission is not found in the empty JSON string", ApiKeyPermission.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApiKeyPermission.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ApiKeyPermission` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ApiKeyPermission.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApiKeyPermission.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApiKeyPermission' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApiKeyPermission> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApiKeyPermission.class));

       return (TypeAdapter<T>) new TypeAdapter<ApiKeyPermission>() {
           @Override
           public void write(JsonWriter out, ApiKeyPermission value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ApiKeyPermission read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ApiKeyPermission given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ApiKeyPermission
   * @throws IOException if the JSON string is invalid with respect to ApiKeyPermission
   */
  public static ApiKeyPermission fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApiKeyPermission.class);
  }

  /**
   * Convert an instance of ApiKeyPermission to an JSON string
   *
   * @return JSON string
   */
