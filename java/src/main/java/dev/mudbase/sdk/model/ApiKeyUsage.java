...
public class ApiKeyUsage {
  ...
  public ApiKeyUsage lastUsed(@javax.annotation.Nullable OffsetDateTime lastUsed) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.requests, apiKeyUsage.requests) &&
        Objects.equals(this.lastUsed, apiKeyUsage.lastUsed);
  }

  @Override
  public int hashCode() {
    return Objects.hash(requests, lastUsed);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("requests", "lastUsed"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to ApiKeyUsage
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApiKeyUsage.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ApiKeyUsage is not found in the empty JSON string", ApiKeyUsage.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApiKeyUsage.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ApiKeyUsage` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApiKeyUsage.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApiKeyUsage' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApiKeyUsage> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApiKeyUsage.class));

       return (TypeAdapter<T>) new TypeAdapter<ApiKeyUsage>() {
           @Override
           public void write(JsonWriter out, ApiKeyUsage value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ApiKeyUsage read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ApiKeyUsage given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ApiKeyUsage
   * @throws IOException if the JSON string is invalid with respect to ApiKeyUsage
   */
  public static ApiKeyUsage fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApiKeyUsage.class);
  }

  /**
   * Convert an instance of ApiKeyUsage to an JSON string
   *
   * @return JSON string
   */
