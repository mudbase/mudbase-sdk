...
public class ApiKycSessionsPostRequest {
  public static final String SERIALIZED_NAME_LANGUAGE = "language";
  @SerializedName(SERIALIZED_NAME_LANGUAGE)
  @javax.annotation.Nullable
  private String language;

  public ApiKycSessionsPostRequest() {
  }

  public ApiKycSessionsPostRequest language(@javax.annotation.Nullable String language) {
  ...
  public boolean equals(Object o) {
    ...
    ApiKycSessionsPostRequest apiKycSessionsPostRequest = (ApiKycSessionsPostRequest) o;
    return Objects.equals(this.language, apiKycSessionsPostRequest.language);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("language"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to ApiKycSessionsPostRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApiKycSessionsPostRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ApiKycSessionsPostRequest is not found in the empty JSON string", ApiKycSessionsPostRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApiKycSessionsPostRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ApiKycSessionsPostRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApiKycSessionsPostRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApiKycSessionsPostRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApiKycSessionsPostRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApiKycSessionsPostRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ApiKycSessionsPostRequest>() {
           @Override
           public void write(JsonWriter out, ApiKycSessionsPostRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ApiKycSessionsPostRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ApiKycSessionsPostRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ApiKycSessionsPostRequest
   * @throws IOException if the JSON string is invalid with respect to ApiKycSessionsPostRequest
   */
  public static ApiKycSessionsPostRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApiKycSessionsPostRequest.class);
  }

  /**
   * Convert an instance of ApiKycSessionsPostRequest to an JSON string
   *
   * @return JSON string
   */
