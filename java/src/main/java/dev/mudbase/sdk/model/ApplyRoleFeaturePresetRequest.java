...
public class ApplyRoleFeaturePresetRequest {
  /**
   * Gets or Sets preset
   */
  ...
  public ApplyRoleFeaturePresetRequest() {
  }

  public ApplyRoleFeaturePresetRequest preset(@javax.annotation.Nonnull PresetEnum preset) {
    this.preset = preset;
    return this;
  }
  ...
  public void setPreset(@javax.annotation.Nonnull PresetEnum preset) {
    this.preset = preset;
  }
  ...
  public boolean equals(Object o) {
    ...
    ApplyRoleFeaturePresetRequest applyRoleFeaturePresetRequest = (ApplyRoleFeaturePresetRequest) o;
    return Objects.equals(this.preset, applyRoleFeaturePresetRequest.preset);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("preset"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("preset"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ApplyRoleFeaturePresetRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApplyRoleFeaturePresetRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ApplyRoleFeaturePresetRequest is not found in the empty JSON string", ApplyRoleFeaturePresetRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApplyRoleFeaturePresetRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ApplyRoleFeaturePresetRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ApplyRoleFeaturePresetRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApplyRoleFeaturePresetRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApplyRoleFeaturePresetRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApplyRoleFeaturePresetRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApplyRoleFeaturePresetRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ApplyRoleFeaturePresetRequest>() {
           @Override
           public void write(JsonWriter out, ApplyRoleFeaturePresetRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ApplyRoleFeaturePresetRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ApplyRoleFeaturePresetRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ApplyRoleFeaturePresetRequest
   * @throws IOException if the JSON string is invalid with respect to ApplyRoleFeaturePresetRequest
   */
  public static ApplyRoleFeaturePresetRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApplyRoleFeaturePresetRequest.class);
  }

  /**
   * Convert an instance of ApplyRoleFeaturePresetRequest to an JSON string
   *
   * @return JSON string
   */
