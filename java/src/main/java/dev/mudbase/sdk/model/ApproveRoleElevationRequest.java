...
public class ApproveRoleElevationRequest {
  ...
  public ApproveRoleElevationRequest() {
  }

  public ApproveRoleElevationRequest approved(@javax.annotation.Nonnull Boolean approved) {
  ...
  public ApproveRoleElevationRequest reason(@javax.annotation.Nullable String reason) {
    this.reason = reason;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ApproveRoleElevationRequest approveRoleElevationRequest = (ApproveRoleElevationRequest) o;
    return Objects.equals(this.approved, approveRoleElevationRequest.approved) &&
        Objects.equals(this.reason, approveRoleElevationRequest.reason);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("approved", "reason"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to ApproveRoleElevationRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ApproveRoleElevationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ApproveRoleElevationRequest is not found in the empty JSON string", ApproveRoleElevationRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ApproveRoleElevationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ApproveRoleElevationRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ApproveRoleElevationRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ApproveRoleElevationRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ApproveRoleElevationRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ApproveRoleElevationRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ApproveRoleElevationRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ApproveRoleElevationRequest>() {
           @Override
           public void write(JsonWriter out, ApproveRoleElevationRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ApproveRoleElevationRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ApproveRoleElevationRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ApproveRoleElevationRequest
   * @throws IOException if the JSON string is invalid with respect to ApproveRoleElevationRequest
   */
  public static ApproveRoleElevationRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ApproveRoleElevationRequest.class);
  }

  /**
   * Convert an instance of ApproveRoleElevationRequest to an JSON string
   *
   * @return JSON string
   */
