...
public class AssignRole200Response {
  ...
  public AssignRole200Response() {
  }

  public AssignRole200Response message(@javax.annotation.Nullable String message) {
  ...
  public AssignRole200Response user(@javax.annotation.Nullable Object user) {
    this.user = user;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AssignRole200Response assignRole200Response = (AssignRole200Response) o;
    return Objects.equals(this.message, assignRole200Response.message) &&
        Objects.equals(this.user, assignRole200Response.user);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AssignRole200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AssignRole200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AssignRole200Response is not found in the empty JSON string", AssignRole200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AssignRole200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AssignRole200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AssignRole200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AssignRole200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AssignRole200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AssignRole200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<AssignRole200Response>() {
           @Override
           public void write(JsonWriter out, AssignRole200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AssignRole200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AssignRole200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AssignRole200Response
   * @throws IOException if the JSON string is invalid with respect to AssignRole200Response
   */
  public static AssignRole200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AssignRole200Response.class);
  }

  /**
   * Convert an instance of AssignRole200Response to an JSON string
   *
   * @return JSON string
   */
