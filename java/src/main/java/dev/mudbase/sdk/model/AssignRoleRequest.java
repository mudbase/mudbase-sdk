...
public class AssignRoleRequest {
  ...
  public AssignRoleRequest roleSlug(@javax.annotation.Nonnull String roleSlug) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.roleSlug, assignRoleRequest.roleSlug);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AssignRoleRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AssignRoleRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AssignRoleRequest is not found in the empty JSON string", AssignRoleRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AssignRoleRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AssignRoleRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AssignRoleRequest.openapiRequiredFields) {
