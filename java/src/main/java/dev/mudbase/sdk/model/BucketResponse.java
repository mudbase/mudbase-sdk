...
import dev.mudbase.sdk.model.Bucket;
...
public class BucketResponse {
  ...
  public BucketResponse success(@javax.annotation.Nullable Boolean success) {
  ...
  public BucketResponse message(@javax.annotation.Nullable String message) {
  ...
  public BucketResponse bucket(@javax.annotation.Nullable Bucket bucket) {
    this.bucket = bucket;
    return this;
  }
  ...
  public void setBucket(@javax.annotation.Nullable Bucket bucket) {
    this.bucket = bucket;
  }
  ...
  public boolean equals(Object o) {
    ...
    BucketResponse bucketResponse = (BucketResponse) o;
    return Objects.equals(this.success, bucketResponse.success) &&
        Objects.equals(this.message, bucketResponse.message) &&
        Objects.equals(this.bucket, bucketResponse.bucket);
  }

  @Override
  public int hashCode() {
    return Objects.hash(success, message, bucket);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("success", "message", "bucket"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to BucketResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BucketResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in BucketResponse is not found in the empty JSON string", BucketResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BucketResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `BucketResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BucketResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BucketResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BucketResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BucketResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<BucketResponse>() {
           @Override
           public void write(JsonWriter out, BucketResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BucketResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BucketResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BucketResponse
   * @throws IOException if the JSON string is invalid with respect to BucketResponse
   */
  public static BucketResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BucketResponse.class);
  }

  /**
   * Convert an instance of BucketResponse to an JSON string
   *
   * @return JSON string
   */
