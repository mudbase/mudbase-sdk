...
public class CheckFeatureAccess200Response {
  ...
  public CheckFeatureAccess200Response() {
  }

  public CheckFeatureAccess200Response hasAccess(@javax.annotation.Nullable Boolean hasAccess) {
  ...
  public CheckFeatureAccess200Response reason(@javax.annotation.Nullable String reason) {
    this.reason = reason;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CheckFeatureAccess200Response checkFeatureAccess200Response = (CheckFeatureAccess200Response) o;
    return Objects.equals(this.hasAccess, checkFeatureAccess200Response.hasAccess) &&
        Objects.equals(this.reason, checkFeatureAccess200Response.reason);
  }

  @Override
  public int hashCode() {
    return Objects.hash(hasAccess, reason);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("hasAccess", "reason"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to CheckFeatureAccess200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CheckFeatureAccess200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CheckFeatureAccess200Response is not found in the empty JSON string", CheckFeatureAccess200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CheckFeatureAccess200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CheckFeatureAccess200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CheckFeatureAccess200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CheckFeatureAccess200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CheckFeatureAccess200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CheckFeatureAccess200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<CheckFeatureAccess200Response>() {
           @Override
           public void write(JsonWriter out, CheckFeatureAccess200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CheckFeatureAccess200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CheckFeatureAccess200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CheckFeatureAccess200Response
   * @throws IOException if the JSON string is invalid with respect to CheckFeatureAccess200Response
   */
  public static CheckFeatureAccess200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CheckFeatureAccess200Response.class);
  }

  /**
   * Convert an instance of CheckFeatureAccess200Response to an JSON string
   *
   * @return JSON string
   */
