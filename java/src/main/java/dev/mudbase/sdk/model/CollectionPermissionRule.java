...
public class CollectionPermissionRule {
  ...
  public CollectionPermissionRule() {
  }

  public CollectionPermissionRule actions(@javax.annotation.Nullable List<CollectionAction> actions) {
    this.actions = actions;
    return this;
  }

  public CollectionPermissionRule addActionsItem(CollectionAction actionsItem) {
  ...
  public void setActions(@javax.annotation.Nullable List<CollectionAction> actions) {
    this.actions = actions;
  }


  public CollectionPermissionRule conditions(@javax.annotation.Nullable Object conditions) {
  ...
  public boolean equals(Object o) {
    ...
    CollectionPermissionRule collectionPermissionRule = (CollectionPermissionRule) o;
    return Objects.equals(this.actions, collectionPermissionRule.actions) &&
        Objects.equals(this.conditions, collectionPermissionRule.conditions);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CollectionPermissionRule
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CollectionPermissionRule.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CollectionPermissionRule is not found in the empty JSON string", CollectionPermissionRule.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CollectionPermissionRule.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CollectionPermissionRule` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CollectionPermissionRule.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CollectionPermissionRule' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CollectionPermissionRule> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CollectionPermissionRule.class));

       return (TypeAdapter<T>) new TypeAdapter<CollectionPermissionRule>() {
           @Override
           public void write(JsonWriter out, CollectionPermissionRule value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CollectionPermissionRule read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CollectionPermissionRule given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CollectionPermissionRule
   * @throws IOException if the JSON string is invalid with respect to CollectionPermissionRule
   */
  public static CollectionPermissionRule fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CollectionPermissionRule.class);
  }

  /**
   * Convert an instance of CollectionPermissionRule to an JSON string
   *
   * @return JSON string
   */
