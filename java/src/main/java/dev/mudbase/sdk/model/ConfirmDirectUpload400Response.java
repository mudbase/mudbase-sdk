...
public class ConfirmDirectUpload400Response {
  ...
  public ConfirmDirectUpload400Response() {
  }

  public ConfirmDirectUpload400Response message(@javax.annotation.Nullable String message) {
  ...
  public ConfirmDirectUpload400Response details(@javax.annotation.Nullable Object details) {
  ...
  public boolean equals(Object o) {
    ...
    ConfirmDirectUpload400Response confirmDirectUpload400Response = (ConfirmDirectUpload400Response) o;
    return Objects.equals(this.message, confirmDirectUpload400Response.message) &&
        Objects.equals(this.details, confirmDirectUpload400Response.details);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ConfirmDirectUpload400Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConfirmDirectUpload400Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ConfirmDirectUpload400Response is not found in the empty JSON string", ConfirmDirectUpload400Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConfirmDirectUpload400Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ConfirmDirectUpload400Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConfirmDirectUpload400Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConfirmDirectUpload400Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConfirmDirectUpload400Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConfirmDirectUpload400Response.class));

       return (TypeAdapter<T>) new TypeAdapter<ConfirmDirectUpload400Response>() {
           @Override
           public void write(JsonWriter out, ConfirmDirectUpload400Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ConfirmDirectUpload400Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ConfirmDirectUpload400Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ConfirmDirectUpload400Response
   * @throws IOException if the JSON string is invalid with respect to ConfirmDirectUpload400Response
   */
  public static ConfirmDirectUpload400Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConfirmDirectUpload400Response.class);
  }

  /**
   * Convert an instance of ConfirmDirectUpload400Response to an JSON string
   *
   * @return JSON string
   */
