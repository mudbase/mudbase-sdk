...
import dev.mudbase.sdk.model.ConfirmUploadResponseScan;
...
public class ConfirmUploadResponse {
  ...
  @javax.annotation.Nullable
  private ConfirmUploadResponseScan scan;

  public ConfirmUploadResponse() {
  }

  public ConfirmUploadResponse fileId(@javax.annotation.Nullable String fileId) {
    this.fileId = fileId;
    return this;
  }
  ...
  public ConfirmUploadResponse status(@javax.annotation.Nullable StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public ConfirmUploadResponse scan(@javax.annotation.Nullable ConfirmUploadResponseScan scan) {
    this.scan = scan;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public ConfirmUploadResponseScan getScan() {
    return scan;
  }

  public void setScan(@javax.annotation.Nullable ConfirmUploadResponseScan scan) {
    this.scan = scan;
  }
  ...
  public boolean equals(Object o) {
    ...
    ConfirmUploadResponse confirmUploadResponse = (ConfirmUploadResponse) o;
    return Objects.equals(this.fileId, confirmUploadResponse.fileId) &&
        Objects.equals(this.status, confirmUploadResponse.status) &&
        Objects.equals(this.scan, confirmUploadResponse.scan);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fileId, status, scan);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("fileId", "status", "scan"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to ConfirmUploadResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConfirmUploadResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ConfirmUploadResponse is not found in the empty JSON string", ConfirmUploadResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConfirmUploadResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ConfirmUploadResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("scan") != null && !jsonObj.get("scan").isJsonNull()) {
        ConfirmUploadResponseScan.validateJsonElement(jsonObj.get("scan"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConfirmUploadResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConfirmUploadResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConfirmUploadResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConfirmUploadResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ConfirmUploadResponse>() {
           @Override
           public void write(JsonWriter out, ConfirmUploadResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ConfirmUploadResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ConfirmUploadResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ConfirmUploadResponse
   * @throws IOException if the JSON string is invalid with respect to ConfirmUploadResponse
   */
  public static ConfirmUploadResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConfirmUploadResponse.class);
  }

  /**
   * Convert an instance of ConfirmUploadResponse to an JSON string
   *
   * @return JSON string
   */
