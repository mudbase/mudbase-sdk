...
import dev.mudbase.sdk.model.ApiKeyWithSecret;
...
public class CreateApiKey201Response {
  ...
  public CreateApiKey201Response apiKey(@javax.annotation.Nullable ApiKeyWithSecret apiKey) {
    this.apiKey = apiKey;
    return this;
  }
  ...
  public void setApiKey(@javax.annotation.Nullable ApiKeyWithSecret apiKey) {
    this.apiKey = apiKey;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateApiKey201Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateApiKey201Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateApiKey201Response is not found in the empty JSON string", CreateApiKey201Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateApiKey201Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CreateApiKey201Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("apiKey") != null && !jsonObj.get("apiKey").isJsonNull()) {
        ApiKeyWithSecret.validateJsonElement(jsonObj.get("apiKey"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateApiKey201Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateApiKey201Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateApiKey201Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateApiKey201Response.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateApiKey201Response>() {
           @Override
           public void write(JsonWriter out, CreateApiKey201Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateApiKey201Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateApiKey201Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateApiKey201Response
   * @throws IOException if the JSON string is invalid with respect to CreateApiKey201Response
   */
  public static CreateApiKey201Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateApiKey201Response.class);
  }

  /**
   * Convert an instance of CreateApiKey201Response to an JSON string
   *
   * @return JSON string
   */
