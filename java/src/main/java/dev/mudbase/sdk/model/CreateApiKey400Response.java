...
public class CreateApiKey400Response {
  ...
  public CreateApiKey400Response error(@javax.annotation.Nullable String error) {
    this.error = error;
    return this;
  }
  ...
  public CreateApiKey400Response details(@javax.annotation.Nullable List<String> details) {
    this.details = details;
    return this;
  }

  public CreateApiKey400Response addDetailsItem(String detailsItem) {
  ...
  public void setDetails(@javax.annotation.Nullable List<String> details) {
    this.details = details;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateApiKey400Response createApiKey400Response = (CreateApiKey400Response) o;
    return Objects.equals(this.error, createApiKey400Response.error) &&
        Objects.equals(this.details, createApiKey400Response.details);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateApiKey400Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateApiKey400Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateApiKey400Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateApiKey400Response is not found in the empty JSON string", CreateApiKey400Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateApiKey400Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CreateApiKey400Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateApiKey400Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateApiKey400Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateApiKey400Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateApiKey400Response.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateApiKey400Response>() {
           @Override
           public void write(JsonWriter out, CreateApiKey400Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateApiKey400Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateApiKey400Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateApiKey400Response
   * @throws IOException if the JSON string is invalid with respect to CreateApiKey400Response
   */
  public static CreateApiKey400Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateApiKey400Response.class);
  }

  /**
   * Convert an instance of CreateApiKey400Response to an JSON string
   *
   * @return JSON string
   */
