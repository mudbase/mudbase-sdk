...
import dev.mudbase.sdk.model.CreateCheckoutSessionRequestCustomerInfo;
...
public class CreateCheckoutSessionRequest {
  ...
  @javax.annotation.Nonnull
  private CreateCheckoutSessionRequestCustomerInfo customerInfo;
  ...
  public CreateCheckoutSessionRequest planId(@javax.annotation.Nonnull String planId) {
    this.planId = planId;
    return this;
  }
  ...
  public CreateCheckoutSessionRequest billingCycle(@javax.annotation.Nonnull BillingCycleEnum billingCycle) {
  ...
  public CreateCheckoutSessionRequest customerInfo(@javax.annotation.Nonnull CreateCheckoutSessionRequestCustomerInfo customerInfo) {
   ...
   */
  @javax.annotation.Nonnull
  public CreateCheckoutSessionRequestCustomerInfo getCustomerInfo() {
    return customerInfo;
  }

  public void setCustomerInfo(@javax.annotation.Nonnull CreateCheckoutSessionRequestCustomerInfo customerInfo) {
    this.customerInfo = customerInfo;
  }


  public CreateCheckoutSessionRequest successUrl(@javax.annotation.Nullable URI successUrl) {
  ...
  public CreateCheckoutSessionRequest cancelUrl(@javax.annotation.Nullable URI cancelUrl) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.planId, createCheckoutSessionRequest.planId) &&
        Objects.equals(this.billingCycle, createCheckoutSessionRequest.billingCycle) &&
        Objects.equals(this.customerInfo, createCheckoutSessionRequest.customerInfo) &&
        Objects.equals(this.successUrl, createCheckoutSessionRequest.successUrl) &&
        Objects.equals(this.cancelUrl, createCheckoutSessionRequest.cancelUrl);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateCheckoutSessionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateCheckoutSessionRequest is not found in the empty JSON string", CreateCheckoutSessionRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateCheckoutSessionRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CreateCheckoutSessionRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      CreateCheckoutSessionRequestCustomerInfo.validateJsonElement(jsonObj.get("customerInfo"));
