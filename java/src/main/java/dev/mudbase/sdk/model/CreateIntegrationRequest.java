...
public class CreateIntegrationRequest {
  ...
  public CreateIntegrationRequest name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateIntegrationRequest provider(@javax.annotation.Nonnull String provider) {
  ...
  public CreateIntegrationRequest config(@javax.annotation.Nonnull Object config) {
    this.config = config;
    return this;
  }
  ...
  public CreateIntegrationRequest credentials(@javax.annotation.Nullable Object credentials) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, createIntegrationRequest.name) &&
        Objects.equals(this.provider, createIntegrationRequest.provider) &&
        Objects.equals(this.config, createIntegrationRequest.config) &&
        Objects.equals(this.credentials, createIntegrationRequest.credentials);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, provider, config, credentials);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("name", "provider", "config", "credentials"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("name", "provider", "config"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateIntegrationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateIntegrationRequest is not found in the empty JSON string", CreateIntegrationRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateIntegrationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CreateIntegrationRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
