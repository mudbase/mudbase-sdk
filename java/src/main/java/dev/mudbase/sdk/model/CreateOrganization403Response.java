...
public class CreateOrganization403Response {
  ...
  public CreateOrganization403Response() {
  }

  public CreateOrganization403Response error(@javax.annotation.Nullable String error) {
    this.error = error;
    return this;
  }
  ...
  public CreateOrganization403Response code(@javax.annotation.Nullable String code) {
    this.code = code;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateOrganization403Response createOrganization403Response = (CreateOrganization403Response) o;
    return Objects.equals(this.error, createOrganization403Response.error) &&
        Objects.equals(this.code, createOrganization403Response.code);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateOrganization403Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateOrganization403Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateOrganization403Response is not found in the empty JSON string", CreateOrganization403Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateOrganization403Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CreateOrganization403Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateOrganization403Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateOrganization403Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateOrganization403Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateOrganization403Response.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateOrganization403Response>() {
           @Override
           public void write(JsonWriter out, CreateOrganization403Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateOrganization403Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateOrganization403Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateOrganization403Response
   * @throws IOException if the JSON string is invalid with respect to CreateOrganization403Response
   */
  public static CreateOrganization403Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateOrganization403Response.class);
  }

  /**
   * Convert an instance of CreateOrganization403Response to an JSON string
   *
   * @return JSON string
   */
