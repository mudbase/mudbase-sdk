...
public class CreateOrganizationRequest {
  ...
  public static final String SERIALIZED_NAME_PARENT_ORG_ID = "parentOrgId";
  @SerializedName(SERIALIZED_NAME_PARENT_ORG_ID)
  @javax.annotation.Nullable
  ...
  public CreateOrganizationRequest description(@javax.annotation.Nullable String description) {
  ...
  public CreateOrganizationRequest logo(@javax.annotation.Nullable String logo) {
    this.logo = logo;
    return this;
  }
  ...
  public CreateOrganizationRequest website(@javax.annotation.Nullable String website) {
  ...
  public CreateOrganizationRequest parentOrgId(@javax.annotation.Nullable String parentOrgId) {
  ...
  public void setParentOrgId(@javax.annotation.Nullable String parentOrgId) {
    this.parentOrgId = parentOrgId;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, createOrganizationRequest.name) &&
        ...
        Objects.equals(this.logo, createOrganizationRequest.logo) &&
        Objects.equals(this.website, createOrganizationRequest.website) &&
        Objects.equals(this.parentOrgId, createOrganizationRequest.parentOrgId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, description, logo, website, parentOrgId);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("name", "description", "logo", "website", "parentOrgId"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateOrganizationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateOrganizationRequest is not found in the empty JSON string", CreateOrganizationRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateOrganizationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CreateOrganizationRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("parentOrgId") != null && !jsonObj.get("parentOrgId").isJsonNull()) && !jsonObj.get("parentOrgId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `parentOrgId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("parentOrgId").toString()));
      }
  }
