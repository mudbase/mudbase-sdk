...
public class CreatePlan201Response {
  ...
  public CreatePlan201Response() {
  }

  public CreatePlan201Response message(@javax.annotation.Nullable String message) {
  ...
  public CreatePlan201Response plan(@javax.annotation.Nullable Plan plan) {
    this.plan = plan;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreatePlan201Response createPlan201Response = (CreatePlan201Response) o;
    return Objects.equals(this.message, createPlan201Response.message) &&
        Objects.equals(this.plan, createPlan201Response.plan);
  }

  @Override
  public int hashCode() {
    return Objects.hash(message, plan);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("message", "plan"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreatePlan201Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreatePlan201Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreatePlan201Response is not found in the empty JSON string", CreatePlan201Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreatePlan201Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CreatePlan201Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreatePlan201Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreatePlan201Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreatePlan201Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreatePlan201Response.class));

       return (TypeAdapter<T>) new TypeAdapter<CreatePlan201Response>() {
           @Override
           public void write(JsonWriter out, CreatePlan201Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreatePlan201Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreatePlan201Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreatePlan201Response
   * @throws IOException if the JSON string is invalid with respect to CreatePlan201Response
   */
  public static CreatePlan201Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreatePlan201Response.class);
  }

  /**
   * Convert an instance of CreatePlan201Response to an JSON string
   *
   * @return JSON string
   */
