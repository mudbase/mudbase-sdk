...
public class CreateProject201Response {
  ...
  public CreateProject201Response message(@javax.annotation.Nullable String message) {
  ...
  public CreateProject201Response project(@javax.annotation.Nullable Project project) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.message, createProject201Response.message) &&
        Objects.equals(this.project, createProject201Response.project);
  }

  @Override
  public int hashCode() {
    return Objects.hash(message, project);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("message", "project"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateProject201Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateProject201Response is not found in the empty JSON string", CreateProject201Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateProject201Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CreateProject201Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
