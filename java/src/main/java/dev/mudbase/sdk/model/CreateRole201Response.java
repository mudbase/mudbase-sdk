...
import dev.mudbase.sdk.model.CreateRole201ResponseRole;
...
public class CreateRole201Response {
  ...
  @javax.annotation.Nullable
  private CreateRole201ResponseRole role;

  public CreateRole201Response() {
  }

  public CreateRole201Response message(@javax.annotation.Nullable String message) {
  ...
  public CreateRole201Response role(@javax.annotation.Nullable CreateRole201ResponseRole role) {
    this.role = role;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public CreateRole201ResponseRole getRole() {
    return role;
  }

  public void setRole(@javax.annotation.Nullable CreateRole201ResponseRole role) {
    this.role = role;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.message, createRole201Response.message) &&
        Objects.equals(this.role, createRole201Response.role);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateRole201Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateRole201Response is not found in the empty JSON string", CreateRole201Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateRole201Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CreateRole201Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("role") != null && !jsonObj.get("role").isJsonNull()) {
        CreateRole201ResponseRole.validateJsonElement(jsonObj.get("role"));
      }
  }
