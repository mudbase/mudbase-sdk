...
public class CreateRoleRequestPermissionsInner {
  /**
  ...
  public CreateRoleRequestPermissionsInner() {
  }

  public CreateRoleRequestPermissionsInner resource(@javax.annotation.Nullable ResourceEnum resource) {
  ...
  public void setResource(@javax.annotation.Nullable ResourceEnum resource) {
    this.resource = resource;
  }


  public CreateRoleRequestPermissionsInner actions(@javax.annotation.Nullable List<ActionsEnum> actions) {
    this.actions = actions;
    return this;
  }

  public CreateRoleRequestPermissionsInner addActionsItem(ActionsEnum actionsItem) {
  ...
  public CreateRoleRequestPermissionsInner conditions(@javax.annotation.Nullable Object conditions) {
  ...
  public boolean equals(Object o) {
    ...
    CreateRoleRequestPermissionsInner createRoleRequestPermissionsInner = (CreateRoleRequestPermissionsInner) o;
    return Objects.equals(this.resource, createRoleRequestPermissionsInner.resource) &&
        Objects.equals(this.actions, createRoleRequestPermissionsInner.actions) &&
        Objects.equals(this.conditions, createRoleRequestPermissionsInner.conditions);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateRoleRequestPermissionsInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateRoleRequestPermissionsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateRoleRequestPermissionsInner is not found in the empty JSON string", CreateRoleRequestPermissionsInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateRoleRequestPermissionsInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CreateRoleRequestPermissionsInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateRoleRequestPermissionsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateRoleRequestPermissionsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateRoleRequestPermissionsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateRoleRequestPermissionsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateRoleRequestPermissionsInner>() {
           @Override
           public void write(JsonWriter out, CreateRoleRequestPermissionsInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateRoleRequestPermissionsInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateRoleRequestPermissionsInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateRoleRequestPermissionsInner
   * @throws IOException if the JSON string is invalid with respect to CreateRoleRequestPermissionsInner
   */
  public static CreateRoleRequestPermissionsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateRoleRequestPermissionsInner.class);
  }

  /**
   * Convert an instance of CreateRoleRequestPermissionsInner to an JSON string
   *
   * @return JSON string
   */
