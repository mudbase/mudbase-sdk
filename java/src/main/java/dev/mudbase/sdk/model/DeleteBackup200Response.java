...
public class DeleteBackup200Response {
  public static final String SERIALIZED_NAME_MESSAGE = "message";
  @SerializedName(SERIALIZED_NAME_MESSAGE)
  @javax.annotation.Nullable
  private String message;

  public DeleteBackup200Response() {
  }

  public DeleteBackup200Response message(@javax.annotation.Nullable String message) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteBackup200Response deleteBackup200Response = (DeleteBackup200Response) o;
    return Objects.equals(this.message, deleteBackup200Response.message);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteBackup200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteBackup200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteBackup200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DeleteBackup200Response is not found in the empty JSON string", DeleteBackup200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteBackup200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DeleteBackup200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteBackup200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteBackup200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteBackup200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteBackup200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteBackup200Response>() {
           @Override
           public void write(JsonWriter out, DeleteBackup200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteBackup200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteBackup200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteBackup200Response
   * @throws IOException if the JSON string is invalid with respect to DeleteBackup200Response
   */
  public static DeleteBackup200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteBackup200Response.class);
  }

  /**
   * Convert an instance of DeleteBackup200Response to an JSON string
   *
   * @return JSON string
   */
