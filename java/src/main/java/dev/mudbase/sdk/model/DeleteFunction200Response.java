...
public class DeleteFunction200Response {
  ...
  public DeleteFunction200Response success(@javax.annotation.Nullable Boolean success) {
  ...
  public DeleteFunction200Response message(@javax.annotation.Nullable String message) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.success, deleteFunction200Response.success) &&
        Objects.equals(this.message, deleteFunction200Response.message);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteFunction200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DeleteFunction200Response is not found in the empty JSON string", DeleteFunction200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteFunction200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DeleteFunction200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
