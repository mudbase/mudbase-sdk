...
public class DeleteOrganization200Response {
  public static final String SERIALIZED_NAME_MESSAGE = "message";
  @SerializedName(SERIALIZED_NAME_MESSAGE)
  @javax.annotation.Nullable
  private String message;

  public DeleteOrganization200Response() {
  }

  public DeleteOrganization200Response message(@javax.annotation.Nullable String message) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteOrganization200Response deleteOrganization200Response = (DeleteOrganization200Response) o;
    return Objects.equals(this.message, deleteOrganization200Response.message);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteOrganization200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteOrganization200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DeleteOrganization200Response is not found in the empty JSON string", DeleteOrganization200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteOrganization200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DeleteOrganization200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteOrganization200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteOrganization200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteOrganization200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteOrganization200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteOrganization200Response>() {
           @Override
           public void write(JsonWriter out, DeleteOrganization200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteOrganization200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteOrganization200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteOrganization200Response
   * @throws IOException if the JSON string is invalid with respect to DeleteOrganization200Response
   */
  public static DeleteOrganization200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteOrganization200Response.class);
  }

  /**
   * Convert an instance of DeleteOrganization200Response to an JSON string
   *
   * @return JSON string
   */
