...
public class DeleteRole200Response {
  public static final String SERIALIZED_NAME_MESSAGE = "message";
  @SerializedName(SERIALIZED_NAME_MESSAGE)
  @javax.annotation.Nullable
  private String message;

  public DeleteRole200Response() {
  }

  public DeleteRole200Response message(@javax.annotation.Nullable String message) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteRole200Response deleteRole200Response = (DeleteRole200Response) o;
    return Objects.equals(this.message, deleteRole200Response.message);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteRole200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteRole200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteRole200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DeleteRole200Response is not found in the empty JSON string", DeleteRole200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteRole200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DeleteRole200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteRole200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteRole200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteRole200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteRole200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteRole200Response>() {
           @Override
           public void write(JsonWriter out, DeleteRole200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteRole200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteRole200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteRole200Response
   * @throws IOException if the JSON string is invalid with respect to DeleteRole200Response
   */
  public static DeleteRole200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteRole200Response.class);
  }

  /**
   * Convert an instance of DeleteRole200Response to an JSON string
   *
   * @return JSON string
   */
