...
public class DownloadBucketFile403Response {
  public static final String SERIALIZED_NAME_ERROR = "error";
  @SerializedName(SERIALIZED_NAME_ERROR)
  @javax.annotation.Nullable
  private String error;

  public DownloadBucketFile403Response() {
  }

  public DownloadBucketFile403Response error(@javax.annotation.Nullable String error) {
    this.error = error;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DownloadBucketFile403Response downloadBucketFile403Response = (DownloadBucketFile403Response) o;
    return Objects.equals(this.error, downloadBucketFile403Response.error);
  }
  ...
  public String toString() {
    ...
    sb.append("class DownloadBucketFile403Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DownloadBucketFile403Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DownloadBucketFile403Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DownloadBucketFile403Response is not found in the empty JSON string", DownloadBucketFile403Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DownloadBucketFile403Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DownloadBucketFile403Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DownloadBucketFile403Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DownloadBucketFile403Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DownloadBucketFile403Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DownloadBucketFile403Response.class));

       return (TypeAdapter<T>) new TypeAdapter<DownloadBucketFile403Response>() {
           @Override
           public void write(JsonWriter out, DownloadBucketFile403Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DownloadBucketFile403Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DownloadBucketFile403Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DownloadBucketFile403Response
   * @throws IOException if the JSON string is invalid with respect to DownloadBucketFile403Response
   */
  public static DownloadBucketFile403Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DownloadBucketFile403Response.class);
  }

  /**
   * Convert an instance of DownloadBucketFile403Response to an JSON string
   *
   * @return JSON string
   */
