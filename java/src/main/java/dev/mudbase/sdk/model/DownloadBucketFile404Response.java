...
public class DownloadBucketFile404Response {
  public static final String SERIALIZED_NAME_ERROR = "error";
  @SerializedName(SERIALIZED_NAME_ERROR)
  @javax.annotation.Nullable
  private String error;

  public DownloadBucketFile404Response() {
  }

  public DownloadBucketFile404Response error(@javax.annotation.Nullable String error) {
    this.error = error;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DownloadBucketFile404Response downloadBucketFile404Response = (DownloadBucketFile404Response) o;
    return Objects.equals(this.error, downloadBucketFile404Response.error);
  }
  ...
  public String toString() {
    ...
    sb.append("class DownloadBucketFile404Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DownloadBucketFile404Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DownloadBucketFile404Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DownloadBucketFile404Response is not found in the empty JSON string", DownloadBucketFile404Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DownloadBucketFile404Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DownloadBucketFile404Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DownloadBucketFile404Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DownloadBucketFile404Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DownloadBucketFile404Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DownloadBucketFile404Response.class));

       return (TypeAdapter<T>) new TypeAdapter<DownloadBucketFile404Response>() {
           @Override
           public void write(JsonWriter out, DownloadBucketFile404Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DownloadBucketFile404Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DownloadBucketFile404Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DownloadBucketFile404Response
   * @throws IOException if the JSON string is invalid with respect to DownloadBucketFile404Response
   */
  public static DownloadBucketFile404Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DownloadBucketFile404Response.class);
  }

  /**
   * Convert an instance of DownloadBucketFile404Response to an JSON string
   *
   * @return JSON string
   */
