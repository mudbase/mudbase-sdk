...
public class DownloadInvoice200Response {
  ...
  public DownloadInvoice200Response() {
  }

  public DownloadInvoice200Response url(@javax.annotation.Nullable URI url) {
    this.url = url;
    return this;
  }
  ...
  public DownloadInvoice200Response message(@javax.annotation.Nullable String message) {
  ...
  public boolean equals(Object o) {
    ...
    DownloadInvoice200Response downloadInvoice200Response = (DownloadInvoice200Response) o;
    return Objects.equals(this.url, downloadInvoice200Response.url) &&
        Objects.equals(this.message, downloadInvoice200Response.message);
  }
  ...
  public String toString() {
    ...
    sb.append("class DownloadInvoice200Response {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("url", "message"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to DownloadInvoice200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DownloadInvoice200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DownloadInvoice200Response is not found in the empty JSON string", DownloadInvoice200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DownloadInvoice200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DownloadInvoice200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DownloadInvoice200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DownloadInvoice200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DownloadInvoice200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DownloadInvoice200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<DownloadInvoice200Response>() {
           @Override
           public void write(JsonWriter out, DownloadInvoice200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DownloadInvoice200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DownloadInvoice200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DownloadInvoice200Response
   * @throws IOException if the JSON string is invalid with respect to DownloadInvoice200Response
   */
  public static DownloadInvoice200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DownloadInvoice200Response.class);
  }

  /**
   * Convert an instance of DownloadInvoice200Response to an JSON string
   *
   * @return JSON string
   */
