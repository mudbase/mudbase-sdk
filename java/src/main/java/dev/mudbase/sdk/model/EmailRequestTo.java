...
public class EmailRequestTo extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!EmailRequestTo.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'EmailRequestTo' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<EmailRequestTo>() {
                @Override
                public void write(JsonWriter out, EmailRequestTo value) throws IOException {
                ...
                @Override
                public EmailRequestTo read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        EmailRequestTo ret = new EmailRequestTo();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for EmailRequestTo: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public EmailRequestTo(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to EmailRequestTo
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for EmailRequestTo with oneOf schemas: List<String>, String. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of EmailRequestTo given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of EmailRequestTo
     * @throws IOException if the JSON string is invalid with respect to EmailRequestTo
     */
    public static EmailRequestTo fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, EmailRequestTo.class);
    }

    /**
     * Convert an instance of EmailRequestTo to an JSON string
     *
     * @return JSON string
     */
