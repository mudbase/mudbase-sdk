...
public class EstimateNetworkFee200Response {
  ...
  public EstimateNetworkFee200Response() {
  }

  public EstimateNetworkFee200Response success(@javax.annotation.Nullable Boolean success) {
  ...
  public EstimateNetworkFee200Response data(@javax.annotation.Nullable Object data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    EstimateNetworkFee200Response estimateNetworkFee200Response = (EstimateNetworkFee200Response) o;
    return Objects.equals(this.success, estimateNetworkFee200Response.success) &&
        Objects.equals(this.data, estimateNetworkFee200Response.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class EstimateNetworkFee200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EstimateNetworkFee200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EstimateNetworkFee200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EstimateNetworkFee200Response is not found in the empty JSON string", EstimateNetworkFee200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EstimateNetworkFee200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EstimateNetworkFee200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EstimateNetworkFee200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EstimateNetworkFee200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EstimateNetworkFee200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EstimateNetworkFee200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<EstimateNetworkFee200Response>() {
           @Override
           public void write(JsonWriter out, EstimateNetworkFee200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EstimateNetworkFee200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EstimateNetworkFee200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EstimateNetworkFee200Response
   * @throws IOException if the JSON string is invalid with respect to EstimateNetworkFee200Response
   */
  public static EstimateNetworkFee200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EstimateNetworkFee200Response.class);
  }

  /**
   * Convert an instance of EstimateNetworkFee200Response to an JSON string
   *
   * @return JSON string
   */
