...
public class EstimateNonCustodialGasRequestTransaction {
  ...
  public EstimateNonCustodialGasRequestTransaction() {
  }

  public EstimateNonCustodialGasRequestTransaction from(@javax.annotation.Nonnull String from) {
    this.from = from;
    return this;
  }
  ...
  public EstimateNonCustodialGasRequestTransaction to(@javax.annotation.Nullable String to) {
    this.to = to;
    return this;
  }
  ...
  public EstimateNonCustodialGasRequestTransaction value(@javax.annotation.Nullable String value) {
    this.value = value;
    return this;
  }
  ...
  public EstimateNonCustodialGasRequestTransaction data(@javax.annotation.Nullable String data) {
    this.data = data;
    return this;
  }
  ...
  public EstimateNonCustodialGasRequestTransaction tokenAddress(@javax.annotation.Nullable String tokenAddress) {
  ...
  public EstimateNonCustodialGasRequestTransaction amount(@javax.annotation.Nullable String amount) {
    this.amount = amount;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    EstimateNonCustodialGasRequestTransaction estimateNonCustodialGasRequestTransaction = (EstimateNonCustodialGasRequestTransaction) o;
    return Objects.equals(this.from, estimateNonCustodialGasRequestTransaction.from) &&
        Objects.equals(this.to, estimateNonCustodialGasRequestTransaction.to) &&
        Objects.equals(this.value, estimateNonCustodialGasRequestTransaction.value) &&
        Objects.equals(this.data, estimateNonCustodialGasRequestTransaction.data) &&
        Objects.equals(this.tokenAddress, estimateNonCustodialGasRequestTransaction.tokenAddress) &&
        Objects.equals(this.amount, estimateNonCustodialGasRequestTransaction.amount);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to EstimateNonCustodialGasRequestTransaction
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EstimateNonCustodialGasRequestTransaction.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EstimateNonCustodialGasRequestTransaction is not found in the empty JSON string", EstimateNonCustodialGasRequestTransaction.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EstimateNonCustodialGasRequestTransaction.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EstimateNonCustodialGasRequestTransaction` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EstimateNonCustodialGasRequestTransaction.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EstimateNonCustodialGasRequestTransaction.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EstimateNonCustodialGasRequestTransaction' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EstimateNonCustodialGasRequestTransaction> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EstimateNonCustodialGasRequestTransaction.class));

       return (TypeAdapter<T>) new TypeAdapter<EstimateNonCustodialGasRequestTransaction>() {
           @Override
           public void write(JsonWriter out, EstimateNonCustodialGasRequestTransaction value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EstimateNonCustodialGasRequestTransaction read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EstimateNonCustodialGasRequestTransaction given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EstimateNonCustodialGasRequestTransaction
   * @throws IOException if the JSON string is invalid with respect to EstimateNonCustodialGasRequestTransaction
   */
  public static EstimateNonCustodialGasRequestTransaction fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EstimateNonCustodialGasRequestTransaction.class);
  }

  /**
   * Convert an instance of EstimateNonCustodialGasRequestTransaction to an JSON string
   *
   * @return JSON string
   */
