...
public class ExecuteFunctionRequest {
  ...
  public ExecuteFunctionRequest payload(@javax.annotation.Nullable Object payload) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.payload, executeFunctionRequest.payload);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExecuteFunctionRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExecuteFunctionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ExecuteFunctionRequest is not found in the empty JSON string", ExecuteFunctionRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExecuteFunctionRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ExecuteFunctionRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExecuteFunctionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExecuteFunctionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExecuteFunctionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExecuteFunctionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ExecuteFunctionRequest>() {
           @Override
           public void write(JsonWriter out, ExecuteFunctionRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ExecuteFunctionRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ExecuteFunctionRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ExecuteFunctionRequest
   * @throws IOException if the JSON string is invalid with respect to ExecuteFunctionRequest
   */
  public static ExecuteFunctionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExecuteFunctionRequest.class);
  }

  /**
   * Convert an instance of ExecuteFunctionRequest to an JSON string
   *
   * @return JSON string
   */
