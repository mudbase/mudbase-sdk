...
public class ExecuteIntegrationRequest {
  ...
  public ExecuteIntegrationRequest endpoint(@javax.annotation.Nonnull String endpoint) {
  ...
  public ExecuteIntegrationRequest method(@javax.annotation.Nonnull MethodEnum method) {
    this.method = method;
    return this;
  }
  ...
  public ExecuteIntegrationRequest params(@javax.annotation.Nullable Object params) {
    this.params = params;
    return this;
  }
  ...
  public ExecuteIntegrationRequest body(@javax.annotation.Nullable Object body) {
    this.body = body;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ExecuteIntegrationRequest executeIntegrationRequest = (ExecuteIntegrationRequest) o;
    return Objects.equals(this.endpoint, executeIntegrationRequest.endpoint) &&
        Objects.equals(this.method, executeIntegrationRequest.method) &&
        Objects.equals(this.params, executeIntegrationRequest.params) &&
        Objects.equals(this.body, executeIntegrationRequest.body);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExecuteIntegrationRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExecuteIntegrationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ExecuteIntegrationRequest is not found in the empty JSON string", ExecuteIntegrationRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExecuteIntegrationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ExecuteIntegrationRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ExecuteIntegrationRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExecuteIntegrationRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExecuteIntegrationRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExecuteIntegrationRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExecuteIntegrationRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ExecuteIntegrationRequest>() {
           @Override
           public void write(JsonWriter out, ExecuteIntegrationRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ExecuteIntegrationRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ExecuteIntegrationRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ExecuteIntegrationRequest
   * @throws IOException if the JSON string is invalid with respect to ExecuteIntegrationRequest
   */
  public static ExecuteIntegrationRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExecuteIntegrationRequest.class);
  }

  /**
   * Convert an instance of ExecuteIntegrationRequest to an JSON string
   *
   * @return JSON string
   */
