...
import dev.mudbase.sdk.model.FileMetadata;
...
public class FileUploadResponse {
  ...
  public FileUploadResponse message(@javax.annotation.Nullable String message) {
  ...
  public FileUploadResponse _file(@javax.annotation.Nullable FileMetadata _file) {
    this._file = _file;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.message, fileUploadResponse.message) &&
        Objects.equals(this._file, fileUploadResponse._file);
  }

  @Override
  public int hashCode() {
    return Objects.hash(message, _file);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("message", "file"));
