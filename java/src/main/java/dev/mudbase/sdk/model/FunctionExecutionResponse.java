...
import dev.mudbase.sdk.model.FunctionExecutionResponseData;
...
public class FunctionExecutionResponse {
  ...
  @javax.annotation.Nullable
  private FunctionExecutionResponseData data;

  public FunctionExecutionResponse() {
  }

  public FunctionExecutionResponse success(@javax.annotation.Nullable Boolean success) {
  ...
  public FunctionExecutionResponse data(@javax.annotation.Nullable FunctionExecutionResponseData data) {
    this.data = data;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public FunctionExecutionResponseData getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable FunctionExecutionResponseData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    FunctionExecutionResponse functionExecutionResponse = (FunctionExecutionResponse) o;
    return Objects.equals(this.success, functionExecutionResponse.success) &&
        Objects.equals(this.data, functionExecutionResponse.data);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to FunctionExecutionResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FunctionExecutionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in FunctionExecutionResponse is not found in the empty JSON string", FunctionExecutionResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FunctionExecutionResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `FunctionExecutionResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `data`
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        FunctionExecutionResponseData.validateJsonElement(jsonObj.get("data"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FunctionExecutionResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FunctionExecutionResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FunctionExecutionResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FunctionExecutionResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<FunctionExecutionResponse>() {
           @Override
           public void write(JsonWriter out, FunctionExecutionResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FunctionExecutionResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FunctionExecutionResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FunctionExecutionResponse
   * @throws IOException if the JSON string is invalid with respect to FunctionExecutionResponse
   */
  public static FunctionExecutionResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FunctionExecutionResponse.class);
  }

  /**
   * Convert an instance of FunctionExecutionResponse to an JSON string
   *
   * @return JSON string
   */
