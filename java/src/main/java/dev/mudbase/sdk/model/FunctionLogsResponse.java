...
import dev.mudbase.sdk.model.FunctionLogsResponseData;
...
public class FunctionLogsResponse {
  ...
  @javax.annotation.Nullable
  private FunctionLogsResponseData data;

  public FunctionLogsResponse() {
  }

  public FunctionLogsResponse success(@javax.annotation.Nullable Boolean success) {
  ...
  public FunctionLogsResponse data(@javax.annotation.Nullable FunctionLogsResponseData data) {
    this.data = data;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public FunctionLogsResponseData getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable FunctionLogsResponseData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    FunctionLogsResponse functionLogsResponse = (FunctionLogsResponse) o;
    return Objects.equals(this.success, functionLogsResponse.success) &&
        Objects.equals(this.data, functionLogsResponse.data);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to FunctionLogsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FunctionLogsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in FunctionLogsResponse is not found in the empty JSON string", FunctionLogsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FunctionLogsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `FunctionLogsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `data`
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        FunctionLogsResponseData.validateJsonElement(jsonObj.get("data"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FunctionLogsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FunctionLogsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FunctionLogsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FunctionLogsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<FunctionLogsResponse>() {
           @Override
           public void write(JsonWriter out, FunctionLogsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FunctionLogsResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FunctionLogsResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FunctionLogsResponse
   * @throws IOException if the JSON string is invalid with respect to FunctionLogsResponse
   */
  public static FunctionLogsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FunctionLogsResponse.class);
  }

  /**
   * Convert an instance of FunctionLogsResponse to an JSON string
   *
   * @return JSON string
   */
