...
import dev.mudbase.sdk.model.Function;
...
public class FunctionResponse {
  ...
  public FunctionResponse success(@javax.annotation.Nullable Boolean success) {
  ...
  public FunctionResponse data(@javax.annotation.Nullable Function data) {
    this.data = data;
    return this;
  }
  ...
  public void setData(@javax.annotation.Nullable Function data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.success, functionResponse.success) &&
        Objects.equals(this.data, functionResponse.data);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FunctionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in FunctionResponse is not found in the empty JSON string", FunctionResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FunctionResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `FunctionResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `data`
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        Function.validateJsonElement(jsonObj.get("data"));
      }
  }
