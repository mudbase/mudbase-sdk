...
public class GeneratePrivateKeyRequest {
  /**
  ...
  public GeneratePrivateKeyRequest() {
  }

  public GeneratePrivateKeyRequest currency(@javax.annotation.Nonnull CurrencyEnum currency) {
  ...
  public boolean equals(Object o) {
    ...
    GeneratePrivateKeyRequest generatePrivateKeyRequest = (GeneratePrivateKeyRequest) o;
    return Objects.equals(this.currency, generatePrivateKeyRequest.currency);
  }
  ...
  public String toString() {
    ...
    sb.append("class GeneratePrivateKeyRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GeneratePrivateKeyRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GeneratePrivateKeyRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GeneratePrivateKeyRequest is not found in the empty JSON string", GeneratePrivateKeyRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GeneratePrivateKeyRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GeneratePrivateKeyRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GeneratePrivateKeyRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GeneratePrivateKeyRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GeneratePrivateKeyRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GeneratePrivateKeyRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GeneratePrivateKeyRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GeneratePrivateKeyRequest>() {
           @Override
           public void write(JsonWriter out, GeneratePrivateKeyRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GeneratePrivateKeyRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GeneratePrivateKeyRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GeneratePrivateKeyRequest
   * @throws IOException if the JSON string is invalid with respect to GeneratePrivateKeyRequest
   */
  public static GeneratePrivateKeyRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GeneratePrivateKeyRequest.class);
  }

  /**
   * Convert an instance of GeneratePrivateKeyRequest to an JSON string
   *
   * @return JSON string
   */
