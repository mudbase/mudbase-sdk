...
public class GenerateSignedUrlRequest {
  ...
  public GenerateSignedUrlRequest expiresIn(@javax.annotation.Nullable Integer expiresIn) {
  ...
  public boolean equals(Object o) {
    ...
    GenerateSignedUrlRequest generateSignedUrlRequest = (GenerateSignedUrlRequest) o;
    return Objects.equals(this.expiresIn, generateSignedUrlRequest.expiresIn);
  }
  ...
  public String toString() {
    ...
    sb.append("class GenerateSignedUrlRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GenerateSignedUrlRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GenerateSignedUrlRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GenerateSignedUrlRequest is not found in the empty JSON string", GenerateSignedUrlRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GenerateSignedUrlRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GenerateSignedUrlRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GenerateSignedUrlRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GenerateSignedUrlRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GenerateSignedUrlRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GenerateSignedUrlRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<GenerateSignedUrlRequest>() {
           @Override
           public void write(JsonWriter out, GenerateSignedUrlRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GenerateSignedUrlRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GenerateSignedUrlRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GenerateSignedUrlRequest
   * @throws IOException if the JSON string is invalid with respect to GenerateSignedUrlRequest
   */
  public static GenerateSignedUrlRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GenerateSignedUrlRequest.class);
  }

  /**
   * Convert an instance of GenerateSignedUrlRequest to an JSON string
   *
   * @return JSON string
   */
