...
public class GetCurrentUser200Response {
  ...
  public GetCurrentUser200Response user(@javax.annotation.Nullable User user) {
    this.user = user;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.user, getCurrentUser200Response.user);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetCurrentUser200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetCurrentUser200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GetCurrentUser200Response is not found in the empty JSON string", GetCurrentUser200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetCurrentUser200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetCurrentUser200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetCurrentUser200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetCurrentUser200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetCurrentUser200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetCurrentUser200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetCurrentUser200Response>() {
           @Override
           public void write(JsonWriter out, GetCurrentUser200Response value) throws IOException {
  ...
  /**
   * Create an instance of GetCurrentUser200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetCurrentUser200Response
   * @throws IOException if the JSON string is invalid with respect to GetCurrentUser200Response
   */
  public static GetCurrentUser200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetCurrentUser200Response.class);
  }

  /**
   * Convert an instance of GetCurrentUser200Response to an JSON string
   *
   * @return JSON string
   */
