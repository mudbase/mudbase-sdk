...
import dev.mudbase.sdk.model.GetInvoice200ResponseInvoice;
...
public class GetInvoice200Response {
  ...
  private GetInvoice200ResponseInvoice invoice;

  public GetInvoice200Response() {
  }

  public GetInvoice200Response invoice(@javax.annotation.Nullable GetInvoice200ResponseInvoice invoice) {
   ...
   */
  @javax.annotation.Nullable
  public GetInvoice200ResponseInvoice getInvoice() {
    return invoice;
  }

  public void setInvoice(@javax.annotation.Nullable GetInvoice200ResponseInvoice invoice) {
    this.invoice = invoice;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.invoice, getInvoice200Response.invoice);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("invoice"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetInvoice200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GetInvoice200Response is not found in the empty JSON string", GetInvoice200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetInvoice200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetInvoice200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `invoice`
      if (jsonObj.get("invoice") != null && !jsonObj.get("invoice").isJsonNull()) {
        GetInvoice200ResponseInvoice.validateJsonElement(jsonObj.get("invoice"));
      }
  }
