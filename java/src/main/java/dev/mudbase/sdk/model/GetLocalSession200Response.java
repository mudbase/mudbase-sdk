...
public class GetLocalSession200Response {
  ...
  public GetLocalSession200Response() {
  }

  public GetLocalSession200Response user(@javax.annotation.Nullable Object user) {
    this.user = user;
    return this;
  }
  ...
  public GetLocalSession200Response authenticated(@javax.annotation.Nullable Boolean authenticated) {
  ...
  public boolean equals(Object o) {
    ...
    GetLocalSession200Response getLocalSession200Response = (GetLocalSession200Response) o;
    return Objects.equals(this.user, getLocalSession200Response.user) &&
        Objects.equals(this.authenticated, getLocalSession200Response.authenticated);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetLocalSession200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetLocalSession200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetLocalSession200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GetLocalSession200Response is not found in the empty JSON string", GetLocalSession200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetLocalSession200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetLocalSession200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetLocalSession200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetLocalSession200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetLocalSession200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetLocalSession200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetLocalSession200Response>() {
           @Override
           public void write(JsonWriter out, GetLocalSession200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetLocalSession200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetLocalSession200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetLocalSession200Response
   * @throws IOException if the JSON string is invalid with respect to GetLocalSession200Response
   */
  public static GetLocalSession200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetLocalSession200Response.class);
  }

  /**
   * Convert an instance of GetLocalSession200Response to an JSON string
   *
   * @return JSON string
   */
