...
public class GetPlans200Response {
  ...
  public GetPlans200Response() {
  }

  public GetPlans200Response plans(@javax.annotation.Nullable List<Plan> plans) {
    this.plans = plans;
    return this;
  }

  public GetPlans200Response addPlansItem(Plan plansItem) {
    if (this.plans == null) {
  ...
  public GetPlans200Response total(@javax.annotation.Nullable Integer total) {
    this.total = total;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetPlans200Response getPlans200Response = (GetPlans200Response) o;
    return Objects.equals(this.plans, getPlans200Response.plans) &&
        Objects.equals(this.total, getPlans200Response.total);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("plans", "total"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetPlans200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetPlans200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GetPlans200Response is not found in the empty JSON string", GetPlans200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetPlans200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetPlans200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetPlans200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetPlans200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetPlans200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetPlans200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetPlans200Response>() {
           @Override
           public void write(JsonWriter out, GetPlans200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetPlans200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetPlans200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetPlans200Response
   * @throws IOException if the JSON string is invalid with respect to GetPlans200Response
   */
  public static GetPlans200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetPlans200Response.class);
  }

  /**
   * Convert an instance of GetPlans200Response to an JSON string
   *
   * @return JSON string
   */
