...
public class GetPublicPlans200Response {
  public static final String SERIALIZED_NAME_PLANS = "plans";
  @SerializedName(SERIALIZED_NAME_PLANS)
  @javax.annotation.Nullable
  private List<Plan> plans = new ArrayList<>();

  public GetPublicPlans200Response() {
  }

  public GetPublicPlans200Response plans(@javax.annotation.Nullable List<Plan> plans) {
    this.plans = plans;
    return this;
  }

  public GetPublicPlans200Response addPlansItem(Plan plansItem) {
    if (this.plans == null) {
  ...
  public boolean equals(Object o) {
    ...
    GetPublicPlans200Response getPublicPlans200Response = (GetPublicPlans200Response) o;
    return Objects.equals(this.plans, getPublicPlans200Response.plans);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetPublicPlans200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetPublicPlans200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetPublicPlans200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GetPublicPlans200Response is not found in the empty JSON string", GetPublicPlans200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetPublicPlans200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetPublicPlans200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetPublicPlans200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetPublicPlans200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetPublicPlans200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetPublicPlans200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetPublicPlans200Response>() {
           @Override
           public void write(JsonWriter out, GetPublicPlans200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetPublicPlans200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetPublicPlans200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetPublicPlans200Response
   * @throws IOException if the JSON string is invalid with respect to GetPublicPlans200Response
   */
  public static GetPublicPlans200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetPublicPlans200Response.class);
  }

  /**
   * Convert an instance of GetPublicPlans200Response to an JSON string
   *
   * @return JSON string
   */
