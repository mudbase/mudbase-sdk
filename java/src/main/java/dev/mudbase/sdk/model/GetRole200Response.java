...
public class GetRole200Response {
  ...
  public GetRole200Response role(@javax.annotation.Nullable Object role) {
    this.role = role;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetRole200Response getRole200Response = (GetRole200Response) o;
    return Objects.equals(this.role, getRole200Response.role);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetRole200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetRole200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetRole200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GetRole200Response is not found in the empty JSON string", GetRole200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetRole200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetRole200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetRole200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetRole200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetRole200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetRole200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetRole200Response>() {
           @Override
           public void write(JsonWriter out, GetRole200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetRole200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetRole200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetRole200Response
   * @throws IOException if the JSON string is invalid with respect to GetRole200Response
   */
  public static GetRole200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetRole200Response.class);
  }

  /**
   * Convert an instance of GetRole200Response to an JSON string
   *
   * @return JSON string
   */
