...
public class GetSearchSuggestions200Response {
  ...
  public GetSearchSuggestions200Response() {
  }

  public GetSearchSuggestions200Response suggestions(@javax.annotation.Nullable List<String> suggestions) {
    this.suggestions = suggestions;
    return this;
  }

  public GetSearchSuggestions200Response addSuggestionsItem(String suggestionsItem) {
  ...
  public boolean equals(Object o) {
    ...
    GetSearchSuggestions200Response getSearchSuggestions200Response = (GetSearchSuggestions200Response) o;
    return Objects.equals(this.suggestions, getSearchSuggestions200Response.suggestions);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetSearchSuggestions200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetSearchSuggestions200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GetSearchSuggestions200Response is not found in the empty JSON string", GetSearchSuggestions200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetSearchSuggestions200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetSearchSuggestions200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetSearchSuggestions200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetSearchSuggestions200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetSearchSuggestions200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetSearchSuggestions200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetSearchSuggestions200Response>() {
           @Override
           public void write(JsonWriter out, GetSearchSuggestions200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetSearchSuggestions200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetSearchSuggestions200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetSearchSuggestions200Response
   * @throws IOException if the JSON string is invalid with respect to GetSearchSuggestions200Response
   */
  public static GetSearchSuggestions200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetSearchSuggestions200Response.class);
  }

  /**
   * Convert an instance of GetSearchSuggestions200Response to an JSON string
   *
   * @return JSON string
   */
