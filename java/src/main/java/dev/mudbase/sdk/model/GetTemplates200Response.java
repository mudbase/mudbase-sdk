...
import dev.mudbase.sdk.model.GetTemplates200ResponseTemplatesInner;
...
public class GetTemplates200Response {
  ...
  private List<GetTemplates200ResponseTemplatesInner> templates = new ArrayList<>();

  public GetTemplates200Response() {
  }

  public GetTemplates200Response templates(@javax.annotation.Nullable List<GetTemplates200ResponseTemplatesInner> templates) {
    this.templates = templates;
    return this;
  }

  public GetTemplates200Response addTemplatesItem(GetTemplates200ResponseTemplatesInner templatesItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<GetTemplates200ResponseTemplatesInner> getTemplates() {
    return templates;
  }

  public void setTemplates(@javax.annotation.Nullable List<GetTemplates200ResponseTemplatesInner> templates) {
    this.templates = templates;
  }
      ...
      if (jsonObj.get("templates") != null && !jsonObj.get("templates").isJsonNull()) {
        ...
        if (jsonArraytemplates != null) {
          ...
          for (int i = 0; i < jsonArraytemplates.size(); i++) {
            GetTemplates200ResponseTemplatesInner.validateJsonElement(jsonArraytemplates.get(i));
          };
        }
      }
  }
