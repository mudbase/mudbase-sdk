...
public class GetUsersByRole200Response {
  ...
  public GetUsersByRole200Response() {
  }

  public GetUsersByRole200Response users(@javax.annotation.Nullable List<Object> users) {
    this.users = users;
    return this;
  }

  public GetUsersByRole200Response addUsersItem(Object usersItem) {
    if (this.users == null) {
  ...
  public GetUsersByRole200Response total(@javax.annotation.Nullable Integer total) {
    this.total = total;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetUsersByRole200Response getUsersByRole200Response = (GetUsersByRole200Response) o;
    return Objects.equals(this.users, getUsersByRole200Response.users) &&
        Objects.equals(this.total, getUsersByRole200Response.total);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetUsersByRole200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetUsersByRole200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetUsersByRole200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GetUsersByRole200Response is not found in the empty JSON string", GetUsersByRole200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetUsersByRole200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetUsersByRole200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetUsersByRole200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetUsersByRole200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetUsersByRole200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetUsersByRole200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetUsersByRole200Response>() {
           @Override
           public void write(JsonWriter out, GetUsersByRole200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetUsersByRole200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetUsersByRole200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetUsersByRole200Response
   * @throws IOException if the JSON string is invalid with respect to GetUsersByRole200Response
   */
  public static GetUsersByRole200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetUsersByRole200Response.class);
  }

  /**
   * Convert an instance of GetUsersByRole200Response to an JSON string
   *
   * @return JSON string
   */
