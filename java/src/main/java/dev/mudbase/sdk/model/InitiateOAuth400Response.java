...
public class InitiateOAuth400Response {
  public static final String SERIALIZED_NAME_ERROR = "error";
  @SerializedName(SERIALIZED_NAME_ERROR)
  @javax.annotation.Nullable
  private String error;

  public InitiateOAuth400Response() {
  }

  public InitiateOAuth400Response error(@javax.annotation.Nullable String error) {
    this.error = error;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    InitiateOAuth400Response initiateOAuth400Response = (InitiateOAuth400Response) o;
    return Objects.equals(this.error, initiateOAuth400Response.error);
  }
  ...
  public String toString() {
    ...
    sb.append("class InitiateOAuth400Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to InitiateOAuth400Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InitiateOAuth400Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in InitiateOAuth400Response is not found in the empty JSON string", InitiateOAuth400Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InitiateOAuth400Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `InitiateOAuth400Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InitiateOAuth400Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InitiateOAuth400Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InitiateOAuth400Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InitiateOAuth400Response.class));

       return (TypeAdapter<T>) new TypeAdapter<InitiateOAuth400Response>() {
           @Override
           public void write(JsonWriter out, InitiateOAuth400Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InitiateOAuth400Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InitiateOAuth400Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InitiateOAuth400Response
   * @throws IOException if the JSON string is invalid with respect to InitiateOAuth400Response
   */
  public static InitiateOAuth400Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InitiateOAuth400Response.class);
  }

  /**
   * Convert an instance of InitiateOAuth400Response to an JSON string
   *
   * @return JSON string
   */
