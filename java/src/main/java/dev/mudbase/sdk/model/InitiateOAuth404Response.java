...
public class InitiateOAuth404Response {
  public static final String SERIALIZED_NAME_ERROR = "error";
  @SerializedName(SERIALIZED_NAME_ERROR)
  @javax.annotation.Nullable
  private String error;

  public InitiateOAuth404Response() {
  }

  public InitiateOAuth404Response error(@javax.annotation.Nullable String error) {
    this.error = error;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    InitiateOAuth404Response initiateOAuth404Response = (InitiateOAuth404Response) o;
    return Objects.equals(this.error, initiateOAuth404Response.error);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to InitiateOAuth404Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InitiateOAuth404Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in InitiateOAuth404Response is not found in the empty JSON string", InitiateOAuth404Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InitiateOAuth404Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `InitiateOAuth404Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InitiateOAuth404Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InitiateOAuth404Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InitiateOAuth404Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InitiateOAuth404Response.class));

       return (TypeAdapter<T>) new TypeAdapter<InitiateOAuth404Response>() {
           @Override
           public void write(JsonWriter out, InitiateOAuth404Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InitiateOAuth404Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InitiateOAuth404Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InitiateOAuth404Response
   * @throws IOException if the JSON string is invalid with respect to InitiateOAuth404Response
   */
  public static InitiateOAuth404Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InitiateOAuth404Response.class);
  }

  /**
   * Convert an instance of InitiateOAuth404Response to an JSON string
   *
   * @return JSON string
   */
