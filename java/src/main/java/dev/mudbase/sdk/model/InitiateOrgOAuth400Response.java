...
public class InitiateOrgOAuth400Response {
  ...
  public InitiateOrgOAuth400Response() {
  }

  public InitiateOrgOAuth400Response error(@javax.annotation.Nullable String error) {
    this.error = error;
    return this;
  }
  ...
  public InitiateOrgOAuth400Response message(@javax.annotation.Nullable String message) {
  ...
  public boolean equals(Object o) {
    ...
    InitiateOrgOAuth400Response initiateOrgOAuth400Response = (InitiateOrgOAuth400Response) o;
    return Objects.equals(this.error, initiateOrgOAuth400Response.error) &&
        Objects.equals(this.message, initiateOrgOAuth400Response.message);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to InitiateOrgOAuth400Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InitiateOrgOAuth400Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in InitiateOrgOAuth400Response is not found in the empty JSON string", InitiateOrgOAuth400Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InitiateOrgOAuth400Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `InitiateOrgOAuth400Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InitiateOrgOAuth400Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InitiateOrgOAuth400Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InitiateOrgOAuth400Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InitiateOrgOAuth400Response.class));

       return (TypeAdapter<T>) new TypeAdapter<InitiateOrgOAuth400Response>() {
           @Override
           public void write(JsonWriter out, InitiateOrgOAuth400Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InitiateOrgOAuth400Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InitiateOrgOAuth400Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InitiateOrgOAuth400Response
   * @throws IOException if the JSON string is invalid with respect to InitiateOrgOAuth400Response
   */
  public static InitiateOrgOAuth400Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InitiateOrgOAuth400Response.class);
  }

  /**
   * Convert an instance of InitiateOrgOAuth400Response to an JSON string
   *
   * @return JSON string
   */
