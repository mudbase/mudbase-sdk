...
public class ListRoles200Response {
  ...
  public ListRoles200Response roles(@javax.annotation.Nullable List<Object> roles) {
    this.roles = roles;
    return this;
  }

  public ListRoles200Response addRolesItem(Object rolesItem) {
    if (this.roles == null) {
  ...
  public ListRoles200Response total(@javax.annotation.Nullable Integer total) {
    this.total = total;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.roles, listRoles200Response.roles) &&
        Objects.equals(this.total, listRoles200Response.total);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListRoles200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ListRoles200Response is not found in the empty JSON string", ListRoles200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListRoles200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ListRoles200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
