...
public class LogSecurityEvent200ResponseEvent {
  ...
  public LogSecurityEvent200ResponseEvent() {
  }

  public LogSecurityEvent200ResponseEvent id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public LogSecurityEvent200ResponseEvent eventType(@javax.annotation.Nullable String eventType) {
  ...
  public LogSecurityEvent200ResponseEvent severity(@javax.annotation.Nullable String severity) {
  ...
  public LogSecurityEvent200ResponseEvent timestamp(@javax.annotation.Nullable OffsetDateTime timestamp) {
  ...
  public boolean equals(Object o) {
    ...
    LogSecurityEvent200ResponseEvent logSecurityEvent200ResponseEvent = (LogSecurityEvent200ResponseEvent) o;
    return Objects.equals(this.id, logSecurityEvent200ResponseEvent.id) &&
        Objects.equals(this.eventType, logSecurityEvent200ResponseEvent.eventType) &&
        Objects.equals(this.severity, logSecurityEvent200ResponseEvent.severity) &&
        Objects.equals(this.timestamp, logSecurityEvent200ResponseEvent.timestamp);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to LogSecurityEvent200ResponseEvent
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LogSecurityEvent200ResponseEvent.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in LogSecurityEvent200ResponseEvent is not found in the empty JSON string", LogSecurityEvent200ResponseEvent.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LogSecurityEvent200ResponseEvent.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `LogSecurityEvent200ResponseEvent` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LogSecurityEvent200ResponseEvent.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LogSecurityEvent200ResponseEvent' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LogSecurityEvent200ResponseEvent> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LogSecurityEvent200ResponseEvent.class));

       return (TypeAdapter<T>) new TypeAdapter<LogSecurityEvent200ResponseEvent>() {
           @Override
           public void write(JsonWriter out, LogSecurityEvent200ResponseEvent value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LogSecurityEvent200ResponseEvent read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LogSecurityEvent200ResponseEvent given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LogSecurityEvent200ResponseEvent
   * @throws IOException if the JSON string is invalid with respect to LogSecurityEvent200ResponseEvent
   */
  public static LogSecurityEvent200ResponseEvent fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LogSecurityEvent200ResponseEvent.class);
  }

  /**
   * Convert an instance of LogSecurityEvent200ResponseEvent to an JSON string
   *
   * @return JSON string
   */
