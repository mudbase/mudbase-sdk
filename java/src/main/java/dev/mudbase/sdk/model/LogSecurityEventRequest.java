...
import dev.mudbase.sdk.model.LogSecurityEventRequestDetails;
...
public class LogSecurityEventRequest {
  ...
  private LogSecurityEventRequestDetails details;

  public LogSecurityEventRequest() {
  }

  public LogSecurityEventRequest eventType(@javax.annotation.Nonnull EventTypeEnum eventType) {
  ...
  public LogSecurityEventRequest severity(@javax.annotation.Nonnull SeverityEnum severity) {
  ...
  public LogSecurityEventRequest details(@javax.annotation.Nullable LogSecurityEventRequestDetails details) {
   ...
   */
  @javax.annotation.Nullable
  public LogSecurityEventRequestDetails getDetails() {
    return details;
  }

  public void setDetails(@javax.annotation.Nullable LogSecurityEventRequestDetails details) {
    this.details = details;
  }
  ...
  public boolean equals(Object o) {
    ...
    LogSecurityEventRequest logSecurityEventRequest = (LogSecurityEventRequest) o;
    return Objects.equals(this.eventType, logSecurityEventRequest.eventType) &&
        Objects.equals(this.severity, logSecurityEventRequest.severity) &&
        Objects.equals(this.details, logSecurityEventRequest.details);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to LogSecurityEventRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LogSecurityEventRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in LogSecurityEventRequest is not found in the empty JSON string", LogSecurityEventRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LogSecurityEventRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `LogSecurityEventRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LogSecurityEventRequest.openapiRequiredFields) {
      ...
      if (jsonObj.get("details") != null && !jsonObj.get("details").isJsonNull()) {
        LogSecurityEventRequestDetails.validateJsonElement(jsonObj.get("details"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LogSecurityEventRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LogSecurityEventRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LogSecurityEventRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LogSecurityEventRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<LogSecurityEventRequest>() {
           @Override
           public void write(JsonWriter out, LogSecurityEventRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LogSecurityEventRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LogSecurityEventRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LogSecurityEventRequest
   * @throws IOException if the JSON string is invalid with respect to LogSecurityEventRequest
   */
  public static LogSecurityEventRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LogSecurityEventRequest.class);
  }

  /**
   * Convert an instance of LogSecurityEventRequest to an JSON string
   *
   * @return JSON string
   */
