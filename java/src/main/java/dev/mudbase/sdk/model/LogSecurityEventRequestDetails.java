...
public class LogSecurityEventRequestDetails {
  ...
  public LogSecurityEventRequestDetails() {
  }

  public LogSecurityEventRequestDetails userId(@javax.annotation.Nullable String userId) {
    this.userId = userId;
    return this;
  }
  ...
  public LogSecurityEventRequestDetails resource(@javax.annotation.Nullable String resource) {
  ...
  public LogSecurityEventRequestDetails ipAddress(@javax.annotation.Nullable String ipAddress) {
  ...
  public LogSecurityEventRequestDetails userAgent(@javax.annotation.Nullable String userAgent) {
  ...
  public LogSecurityEventRequestDetails action(@javax.annotation.Nullable String action) {
    this.action = action;
    return this;
  }
  ...
  public LogSecurityEventRequestDetails reason(@javax.annotation.Nullable String reason) {
    this.reason = reason;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    LogSecurityEventRequestDetails logSecurityEventRequestDetails = (LogSecurityEventRequestDetails) o;
    return Objects.equals(this.userId, logSecurityEventRequestDetails.userId) &&
        Objects.equals(this.resource, logSecurityEventRequestDetails.resource) &&
        Objects.equals(this.ipAddress, logSecurityEventRequestDetails.ipAddress) &&
        Objects.equals(this.userAgent, logSecurityEventRequestDetails.userAgent) &&
        Objects.equals(this.action, logSecurityEventRequestDetails.action) &&
        Objects.equals(this.reason, logSecurityEventRequestDetails.reason);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to LogSecurityEventRequestDetails
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LogSecurityEventRequestDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in LogSecurityEventRequestDetails is not found in the empty JSON string", LogSecurityEventRequestDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LogSecurityEventRequestDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `LogSecurityEventRequestDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LogSecurityEventRequestDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LogSecurityEventRequestDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LogSecurityEventRequestDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LogSecurityEventRequestDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<LogSecurityEventRequestDetails>() {
           @Override
           public void write(JsonWriter out, LogSecurityEventRequestDetails value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LogSecurityEventRequestDetails read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LogSecurityEventRequestDetails given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LogSecurityEventRequestDetails
   * @throws IOException if the JSON string is invalid with respect to LogSecurityEventRequestDetails
   */
  public static LogSecurityEventRequestDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LogSecurityEventRequestDetails.class);
  }

  /**
   * Convert an instance of LogSecurityEventRequestDetails to an JSON string
   *
   * @return JSON string
   */
