...
public class LoginLocalUser403Response {
  ...
  public LoginLocalUser403Response() {
  }

  public LoginLocalUser403Response error(@javax.annotation.Nullable String error) {
    this.error = error;
    return this;
  }
  ...
  public LoginLocalUser403Response code(@javax.annotation.Nullable String code) {
    this.code = code;
    return this;
  }
  ...
  public LoginLocalUser403Response message(@javax.annotation.Nullable String message) {
  ...
  public boolean equals(Object o) {
    ...
    LoginLocalUser403Response loginLocalUser403Response = (LoginLocalUser403Response) o;
    return Objects.equals(this.error, loginLocalUser403Response.error) &&
        Objects.equals(this.code, loginLocalUser403Response.code) &&
        Objects.equals(this.message, loginLocalUser403Response.message);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to LoginLocalUser403Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LoginLocalUser403Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in LoginLocalUser403Response is not found in the empty JSON string", LoginLocalUser403Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LoginLocalUser403Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `LoginLocalUser403Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoginLocalUser403Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoginLocalUser403Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoginLocalUser403Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoginLocalUser403Response.class));

       return (TypeAdapter<T>) new TypeAdapter<LoginLocalUser403Response>() {
           @Override
           public void write(JsonWriter out, LoginLocalUser403Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LoginLocalUser403Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LoginLocalUser403Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LoginLocalUser403Response
   * @throws IOException if the JSON string is invalid with respect to LoginLocalUser403Response
   */
  public static LoginLocalUser403Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoginLocalUser403Response.class);
  }

  /**
   * Convert an instance of LoginLocalUser403Response to an JSON string
   *
   * @return JSON string
   */
