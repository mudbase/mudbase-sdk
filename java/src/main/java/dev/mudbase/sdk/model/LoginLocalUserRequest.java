...
public class LoginLocalUserRequest {
  ...
  public LoginLocalUserRequest() {
  }

  public LoginLocalUserRequest email(@javax.annotation.Nonnull String email) {
    this.email = email;
    return this;
  }
  ...
  public LoginLocalUserRequest password(@javax.annotation.Nonnull String password) {
  ...
  public LoginLocalUserRequest projectId(@javax.annotation.Nullable String projectId) {
  ...
  public boolean equals(Object o) {
    ...
    LoginLocalUserRequest loginLocalUserRequest = (LoginLocalUserRequest) o;
    return Objects.equals(this.email, loginLocalUserRequest.email) &&
        Objects.equals(this.password, loginLocalUserRequest.password) &&
        Objects.equals(this.projectId, loginLocalUserRequest.projectId);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to LoginLocalUserRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LoginLocalUserRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in LoginLocalUserRequest is not found in the empty JSON string", LoginLocalUserRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LoginLocalUserRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `LoginLocalUserRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LoginLocalUserRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoginLocalUserRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoginLocalUserRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoginLocalUserRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoginLocalUserRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<LoginLocalUserRequest>() {
           @Override
           public void write(JsonWriter out, LoginLocalUserRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LoginLocalUserRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LoginLocalUserRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LoginLocalUserRequest
   * @throws IOException if the JSON string is invalid with respect to LoginLocalUserRequest
   */
  public static LoginLocalUserRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoginLocalUserRequest.class);
  }

  /**
   * Convert an instance of LoginLocalUserRequest to an JSON string
   *
   * @return JSON string
   */
