...
import dev.mudbase.sdk.model.MessageSentResponseData;
...
public class MessageSentResponse {
  ...
  @javax.annotation.Nullable
  private MessageSentResponseData data;

  public MessageSentResponse() {
  }

  public MessageSentResponse success(@javax.annotation.Nullable Boolean success) {
  ...
  public MessageSentResponse data(@javax.annotation.Nullable MessageSentResponseData data) {
    this.data = data;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public MessageSentResponseData getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable MessageSentResponseData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.success, messageSentResponse.success) &&
        Objects.equals(this.data, messageSentResponse.data);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to MessageSentResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MessageSentResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in MessageSentResponse is not found in the empty JSON string", MessageSentResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MessageSentResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `MessageSentResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `data`
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        MessageSentResponseData.validateJsonElement(jsonObj.get("data"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MessageSentResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MessageSentResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MessageSentResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MessageSentResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<MessageSentResponse>() {
           @Override
           public void write(JsonWriter out, MessageSentResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MessageSentResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MessageSentResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MessageSentResponse
   * @throws IOException if the JSON string is invalid with respect to MessageSentResponse
   */
  public static MessageSentResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MessageSentResponse.class);
  }

  /**
   * Convert an instance of MessageSentResponse to an JSON string
   *
   * @return JSON string
   */
