...
import dev.mudbase.sdk.model.MessageStatsResponseData;
...
public class MessageStatsResponse {
  ...
  @javax.annotation.Nullable
  private MessageStatsResponseData data;

  public MessageStatsResponse() {
  }

  public MessageStatsResponse success(@javax.annotation.Nullable Boolean success) {
  ...
  public MessageStatsResponse data(@javax.annotation.Nullable MessageStatsResponseData data) {
    this.data = data;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public MessageStatsResponseData getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable MessageStatsResponseData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    MessageStatsResponse messageStatsResponse = (MessageStatsResponse) o;
    return Objects.equals(this.success, messageStatsResponse.success) &&
        Objects.equals(this.data, messageStatsResponse.data);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to MessageStatsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MessageStatsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in MessageStatsResponse is not found in the empty JSON string", MessageStatsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MessageStatsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `MessageStatsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `data`
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        MessageStatsResponseData.validateJsonElement(jsonObj.get("data"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MessageStatsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MessageStatsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MessageStatsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MessageStatsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<MessageStatsResponse>() {
           @Override
           public void write(JsonWriter out, MessageStatsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MessageStatsResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MessageStatsResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MessageStatsResponse
   * @throws IOException if the JSON string is invalid with respect to MessageStatsResponse
   */
  public static MessageStatsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MessageStatsResponse.class);
  }

  /**
   * Convert an instance of MessageStatsResponse to an JSON string
   *
   * @return JSON string
   */
