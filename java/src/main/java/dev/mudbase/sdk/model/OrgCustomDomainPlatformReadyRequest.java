...
public class OrgCustomDomainPlatformReadyRequest {
  public static final String SERIALIZED_NAME_NOTE = "note";
  @SerializedName(SERIALIZED_NAME_NOTE)
  @javax.annotation.Nullable
  private String note;

  public OrgCustomDomainPlatformReadyRequest() {
  }

  public OrgCustomDomainPlatformReadyRequest note(@javax.annotation.Nullable String note) {
    this.note = note;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    OrgCustomDomainPlatformReadyRequest orgCustomDomainPlatformReadyRequest = (OrgCustomDomainPlatformReadyRequest) o;
    return Objects.equals(this.note, orgCustomDomainPlatformReadyRequest.note);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to OrgCustomDomainPlatformReadyRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrgCustomDomainPlatformReadyRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in OrgCustomDomainPlatformReadyRequest is not found in the empty JSON string", OrgCustomDomainPlatformReadyRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrgCustomDomainPlatformReadyRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `OrgCustomDomainPlatformReadyRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrgCustomDomainPlatformReadyRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrgCustomDomainPlatformReadyRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrgCustomDomainPlatformReadyRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrgCustomDomainPlatformReadyRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<OrgCustomDomainPlatformReadyRequest>() {
           @Override
           public void write(JsonWriter out, OrgCustomDomainPlatformReadyRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OrgCustomDomainPlatformReadyRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OrgCustomDomainPlatformReadyRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OrgCustomDomainPlatformReadyRequest
   * @throws IOException if the JSON string is invalid with respect to OrgCustomDomainPlatformReadyRequest
   */
  public static OrgCustomDomainPlatformReadyRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrgCustomDomainPlatformReadyRequest.class);
  }

  /**
   * Convert an instance of OrgCustomDomainPlatformReadyRequest to an JSON string
   *
   * @return JSON string
   */
