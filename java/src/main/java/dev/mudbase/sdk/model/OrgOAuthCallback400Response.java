...
public class OrgOAuthCallback400Response {
  public static final String SERIALIZED_NAME_ERROR = "error";
  @SerializedName(SERIALIZED_NAME_ERROR)
  @javax.annotation.Nullable
  private String error;

  public OrgOAuthCallback400Response() {
  }

  public OrgOAuthCallback400Response error(@javax.annotation.Nullable String error) {
    this.error = error;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    OrgOAuthCallback400Response orgOAuthCallback400Response = (OrgOAuthCallback400Response) o;
    return Objects.equals(this.error, orgOAuthCallback400Response.error);
  }
  ...
  public String toString() {
    ...
    sb.append("class OrgOAuthCallback400Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to OrgOAuthCallback400Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrgOAuthCallback400Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in OrgOAuthCallback400Response is not found in the empty JSON string", OrgOAuthCallback400Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrgOAuthCallback400Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `OrgOAuthCallback400Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrgOAuthCallback400Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrgOAuthCallback400Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrgOAuthCallback400Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrgOAuthCallback400Response.class));

       return (TypeAdapter<T>) new TypeAdapter<OrgOAuthCallback400Response>() {
           @Override
           public void write(JsonWriter out, OrgOAuthCallback400Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OrgOAuthCallback400Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of OrgOAuthCallback400Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OrgOAuthCallback400Response
   * @throws IOException if the JSON string is invalid with respect to OrgOAuthCallback400Response
   */
  public static OrgOAuthCallback400Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrgOAuthCallback400Response.class);
  }

  /**
   * Convert an instance of OrgOAuthCallback400Response to an JSON string
   *
   * @return JSON string
   */
