...
public class OrganizationSummary {
  ...
  public OrganizationSummary id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public OrganizationSummary name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public OrganizationSummary slug(@javax.annotation.Nullable String slug) {
    this.slug = slug;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, organizationSummary.id) &&
        ...
        Objects.equals(this.slug, organizationSummary.slug);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrganizationSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in OrganizationSummary is not found in the empty JSON string", OrganizationSummary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OrganizationSummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `OrganizationSummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
