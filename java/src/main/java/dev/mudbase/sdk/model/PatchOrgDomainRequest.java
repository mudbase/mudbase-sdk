...
public class PatchOrgDomainRequest {
  /**
  ...
  public PatchOrgDomainRequest() {
  }

  public PatchOrgDomainRequest status(@javax.annotation.Nullable StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public PatchOrgDomainRequest regenerateToken(@javax.annotation.Nullable Boolean regenerateToken) {
  ...
  public boolean equals(Object o) {
    ...
    PatchOrgDomainRequest patchOrgDomainRequest = (PatchOrgDomainRequest) o;
    return Objects.equals(this.status, patchOrgDomainRequest.status) &&
        Objects.equals(this.regenerateToken, patchOrgDomainRequest.regenerateToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(status, regenerateToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PatchOrgDomainRequest {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("status", "regenerateToken"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to PatchOrgDomainRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PatchOrgDomainRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PatchOrgDomainRequest is not found in the empty JSON string", PatchOrgDomainRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PatchOrgDomainRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `PatchOrgDomainRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PatchOrgDomainRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PatchOrgDomainRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PatchOrgDomainRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PatchOrgDomainRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PatchOrgDomainRequest>() {
           @Override
           public void write(JsonWriter out, PatchOrgDomainRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PatchOrgDomainRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PatchOrgDomainRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PatchOrgDomainRequest
   * @throws IOException if the JSON string is invalid with respect to PatchOrgDomainRequest
   */
  public static PatchOrgDomainRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PatchOrgDomainRequest.class);
  }

  /**
   * Convert an instance of PatchOrgDomainRequest to an JSON string
   *
   * @return JSON string
   */
