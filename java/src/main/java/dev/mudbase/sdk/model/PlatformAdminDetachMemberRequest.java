...
public class PlatformAdminDetachMemberRequest {
  public static final String SERIALIZED_NAME_REASON = "reason";
  @SerializedName(SERIALIZED_NAME_REASON)
  @javax.annotation.Nullable
  private String reason;

  public PlatformAdminDetachMemberRequest() {
  }

  public PlatformAdminDetachMemberRequest reason(@javax.annotation.Nullable String reason) {
    this.reason = reason;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    PlatformAdminDetachMemberRequest platformAdminDetachMemberRequest = (PlatformAdminDetachMemberRequest) o;
    return Objects.equals(this.reason, platformAdminDetachMemberRequest.reason);
  }
  ...
  public String toString() {
    ...
    sb.append("class PlatformAdminDetachMemberRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PlatformAdminDetachMemberRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PlatformAdminDetachMemberRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PlatformAdminDetachMemberRequest is not found in the empty JSON string", PlatformAdminDetachMemberRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PlatformAdminDetachMemberRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `PlatformAdminDetachMemberRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PlatformAdminDetachMemberRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PlatformAdminDetachMemberRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PlatformAdminDetachMemberRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PlatformAdminDetachMemberRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PlatformAdminDetachMemberRequest>() {
           @Override
           public void write(JsonWriter out, PlatformAdminDetachMemberRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PlatformAdminDetachMemberRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PlatformAdminDetachMemberRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PlatformAdminDetachMemberRequest
   * @throws IOException if the JSON string is invalid with respect to PlatformAdminDetachMemberRequest
   */
  public static PlatformAdminDetachMemberRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PlatformAdminDetachMemberRequest.class);
  }

  /**
   * Convert an instance of PlatformAdminDetachMemberRequest to an JSON string
   *
   * @return JSON string
   */
