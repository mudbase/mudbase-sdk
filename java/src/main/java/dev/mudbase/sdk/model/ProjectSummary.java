...
public class ProjectSummary {
  ...
  public ProjectSummary id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public ProjectSummary name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public ProjectSummary slug(@javax.annotation.Nullable String slug) {
    this.slug = slug;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, projectSummary.id) &&
        ...
        Objects.equals(this.slug, projectSummary.slug);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProjectSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ProjectSummary is not found in the empty JSON string", ProjectSummary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProjectSummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ProjectSummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
