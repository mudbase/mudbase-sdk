...
public class ProjectUsageResponse {
  ...
  public ProjectUsageResponse usage(@javax.annotation.Nullable ProjectUsage usage) {
    this.usage = usage;
    return this;
  }
  ...
  public ProjectUsageResponse limits(@javax.annotation.Nullable Limits limits) {
    this.limits = limits;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ProjectUsageResponse projectUsageResponse = (ProjectUsageResponse) o;
    return Objects.equals(this.usage, projectUsageResponse.usage) &&
        Objects.equals(this.limits, projectUsageResponse.limits);
  }

  @Override
  public int hashCode() {
    return Objects.hash(usage, limits);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("usage", "limits"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProjectUsageResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProjectUsageResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ProjectUsageResponse is not found in the empty JSON string", ProjectUsageResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProjectUsageResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ProjectUsageResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProjectUsageResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProjectUsageResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProjectUsageResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProjectUsageResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ProjectUsageResponse>() {
           @Override
           public void write(JsonWriter out, ProjectUsageResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProjectUsageResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProjectUsageResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProjectUsageResponse
   * @throws IOException if the JSON string is invalid with respect to ProjectUsageResponse
   */
  public static ProjectUsageResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProjectUsageResponse.class);
  }

  /**
   * Convert an instance of ProjectUsageResponse to an JSON string
   *
   * @return JSON string
   */
