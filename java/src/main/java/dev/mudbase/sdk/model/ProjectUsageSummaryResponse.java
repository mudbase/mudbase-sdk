...
public class ProjectUsageSummaryResponse {
  ...
  public ProjectUsageSummaryResponse() {
  }

  public ProjectUsageSummaryResponse success(@javax.annotation.Nullable Boolean success) {
  ...
  public ProjectUsageSummaryResponse data(@javax.annotation.Nullable Object data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ProjectUsageSummaryResponse projectUsageSummaryResponse = (ProjectUsageSummaryResponse) o;
    return Objects.equals(this.success, projectUsageSummaryResponse.success) &&
        Objects.equals(this.data, projectUsageSummaryResponse.data);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProjectUsageSummaryResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProjectUsageSummaryResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ProjectUsageSummaryResponse is not found in the empty JSON string", ProjectUsageSummaryResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProjectUsageSummaryResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ProjectUsageSummaryResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProjectUsageSummaryResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProjectUsageSummaryResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProjectUsageSummaryResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProjectUsageSummaryResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ProjectUsageSummaryResponse>() {
           @Override
           public void write(JsonWriter out, ProjectUsageSummaryResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProjectUsageSummaryResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProjectUsageSummaryResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProjectUsageSummaryResponse
   * @throws IOException if the JSON string is invalid with respect to ProjectUsageSummaryResponse
   */
  public static ProjectUsageSummaryResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProjectUsageSummaryResponse.class);
  }

  /**
   * Convert an instance of ProjectUsageSummaryResponse to an JSON string
   *
   * @return JSON string
   */
