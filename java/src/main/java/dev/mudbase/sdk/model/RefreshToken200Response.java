...
public class RefreshToken200Response {
  ...
  public RefreshToken200Response message(@javax.annotation.Nullable String message) {
  ...
  public RefreshToken200Response token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public RefreshToken200Response refreshToken(@javax.annotation.Nullable String refreshToken) {
  ...
  public RefreshToken200Response expiresIn(@javax.annotation.Nullable Integer expiresIn) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.message, refreshToken200Response.message) &&
        Objects.equals(this.token, refreshToken200Response.token) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RefreshToken200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RefreshToken200Response is not found in the empty JSON string", RefreshToken200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RefreshToken200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RefreshToken200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
