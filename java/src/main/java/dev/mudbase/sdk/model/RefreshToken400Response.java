...
public class RefreshToken400Response {
  public static final String SERIALIZED_NAME_ERROR = "error";
  @SerializedName(SERIALIZED_NAME_ERROR)
  @javax.annotation.Nullable
  private String error;

  public RefreshToken400Response() {
  }

  public RefreshToken400Response error(@javax.annotation.Nullable String error) {
    this.error = error;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    RefreshToken400Response refreshToken400Response = (RefreshToken400Response) o;
    return Objects.equals(this.error, refreshToken400Response.error);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to RefreshToken400Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RefreshToken400Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RefreshToken400Response is not found in the empty JSON string", RefreshToken400Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RefreshToken400Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RefreshToken400Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RefreshToken400Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RefreshToken400Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RefreshToken400Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RefreshToken400Response.class));

       return (TypeAdapter<T>) new TypeAdapter<RefreshToken400Response>() {
           @Override
           public void write(JsonWriter out, RefreshToken400Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RefreshToken400Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RefreshToken400Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RefreshToken400Response
   * @throws IOException if the JSON string is invalid with respect to RefreshToken400Response
   */
  public static RefreshToken400Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RefreshToken400Response.class);
  }

  /**
   * Convert an instance of RefreshToken400Response to an JSON string
   *
   * @return JSON string
   */
