...
public class RegenerateApiKey200Response {
  ...
  public RegenerateApiKey200Response() {
  }

  public RegenerateApiKey200Response message(@javax.annotation.Nullable String message) {
  ...
  public RegenerateApiKey200Response secret(@javax.annotation.Nullable String secret) {
    this.secret = secret;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    RegenerateApiKey200Response regenerateApiKey200Response = (RegenerateApiKey200Response) o;
    return Objects.equals(this.message, regenerateApiKey200Response.message) &&
        Objects.equals(this.secret, regenerateApiKey200Response.secret);
  }

  @Override
  public int hashCode() {
    return Objects.hash(message, secret);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RegenerateApiKey200Response {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("message", "secret"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to RegenerateApiKey200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RegenerateApiKey200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RegenerateApiKey200Response is not found in the empty JSON string", RegenerateApiKey200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RegenerateApiKey200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RegenerateApiKey200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RegenerateApiKey200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RegenerateApiKey200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RegenerateApiKey200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RegenerateApiKey200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<RegenerateApiKey200Response>() {
           @Override
           public void write(JsonWriter out, RegenerateApiKey200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RegenerateApiKey200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RegenerateApiKey200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RegenerateApiKey200Response
   * @throws IOException if the JSON string is invalid with respect to RegenerateApiKey200Response
   */
  public static RegenerateApiKey200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RegenerateApiKey200Response.class);
  }

  /**
   * Convert an instance of RegenerateApiKey200Response to an JSON string
   *
   * @return JSON string
   */
