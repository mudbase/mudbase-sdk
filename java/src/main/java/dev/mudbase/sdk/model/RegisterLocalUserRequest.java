...
public class RegisterLocalUserRequest {
  ...
  public RegisterLocalUserRequest() {
  }

  public RegisterLocalUserRequest email(@javax.annotation.Nonnull String email) {
    this.email = email;
    return this;
  }
  ...
  public RegisterLocalUserRequest password(@javax.annotation.Nonnull String password) {
  ...
  public RegisterLocalUserRequest firstName(@javax.annotation.Nonnull String firstName) {
  ...
  public RegisterLocalUserRequest lastName(@javax.annotation.Nonnull String lastName) {
  ...
  public RegisterLocalUserRequest projectId(@javax.annotation.Nonnull String projectId) {
  ...
  public boolean equals(Object o) {
    ...
    RegisterLocalUserRequest registerLocalUserRequest = (RegisterLocalUserRequest) o;
    return Objects.equals(this.email, registerLocalUserRequest.email) &&
        Objects.equals(this.password, registerLocalUserRequest.password) &&
        Objects.equals(this.firstName, registerLocalUserRequest.firstName) &&
        Objects.equals(this.lastName, registerLocalUserRequest.lastName) &&
        Objects.equals(this.projectId, registerLocalUserRequest.projectId);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to RegisterLocalUserRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RegisterLocalUserRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RegisterLocalUserRequest is not found in the empty JSON string", RegisterLocalUserRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RegisterLocalUserRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RegisterLocalUserRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RegisterLocalUserRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RegisterLocalUserRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RegisterLocalUserRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RegisterLocalUserRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RegisterLocalUserRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<RegisterLocalUserRequest>() {
           @Override
           public void write(JsonWriter out, RegisterLocalUserRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RegisterLocalUserRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RegisterLocalUserRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RegisterLocalUserRequest
   * @throws IOException if the JSON string is invalid with respect to RegisterLocalUserRequest
   */
  public static RegisterLocalUserRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RegisterLocalUserRequest.class);
  }

  /**
   * Convert an instance of RegisterLocalUserRequest to an JSON string
   *
   * @return JSON string
   */
