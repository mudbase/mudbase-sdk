...
public class RegisterRequest {
  ...
  public RegisterRequest orgName(@javax.annotation.Nullable String orgName) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.email, registerRequest.email) &&
        ...
        Objects.equals(this.orgName, registerRequest.orgName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(email, password, firstName, lastName, orgName);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("email", "password", "firstName", "lastName", "orgName"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("orgName") != null && !jsonObj.get("orgName").isJsonNull()) && !jsonObj.get("orgName").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `orgName` to be a primitive type in the JSON string but got `%s`", jsonObj.get("orgName").toString()));
      }
  }
