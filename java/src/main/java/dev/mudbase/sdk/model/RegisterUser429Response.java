...
import dev.mudbase.sdk.model.ErrorDetails;
...
public class RegisterUser429Response {
  ...
  public RegisterUser429Response() {
  }

  public RegisterUser429Response error(@javax.annotation.Nullable String error) {
    this.error = error;
    return this;
  }
  ...
  public RegisterUser429Response code(@javax.annotation.Nullable String code) {
    this.code = code;
    return this;
  }
  ...
  public RegisterUser429Response details(@javax.annotation.Nullable ErrorDetails details) {
  ...
  public RegisterUser429Response timestamp(@javax.annotation.Nullable OffsetDateTime timestamp) {
  ...
  public RegisterUser429Response path(@javax.annotation.Nullable String path) {
    this.path = path;
    return this;
  }
  ...
  public RegisterUser429Response requestId(@javax.annotation.Nullable String requestId) {
  ...
  public RegisterUser429Response retryAfter(@javax.annotation.Nullable Integer retryAfter) {
  ...
  public boolean equals(Object o) {
    ...
    RegisterUser429Response registerUser429Response = (RegisterUser429Response) o;
    return Objects.equals(this.error, registerUser429Response.error) &&
        Objects.equals(this.code, registerUser429Response.code) &&
        Objects.equals(this.details, registerUser429Response.details) &&
        Objects.equals(this.timestamp, registerUser429Response.timestamp) &&
        Objects.equals(this.path, registerUser429Response.path) &&
        Objects.equals(this.requestId, registerUser429Response.requestId) &&
        Objects.equals(this.retryAfter, registerUser429Response.retryAfter);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to RegisterUser429Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RegisterUser429Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RegisterUser429Response is not found in the empty JSON string", RegisterUser429Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RegisterUser429Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RegisterUser429Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RegisterUser429Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RegisterUser429Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RegisterUser429Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RegisterUser429Response.class));

       return (TypeAdapter<T>) new TypeAdapter<RegisterUser429Response>() {
           @Override
           public void write(JsonWriter out, RegisterUser429Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RegisterUser429Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RegisterUser429Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RegisterUser429Response
   * @throws IOException if the JSON string is invalid with respect to RegisterUser429Response
   */
  public static RegisterUser429Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RegisterUser429Response.class);
  }

  /**
   * Convert an instance of RegisterUser429Response to an JSON string
   *
   * @return JSON string
   */
