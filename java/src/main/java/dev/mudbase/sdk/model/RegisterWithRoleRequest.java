...
public class RegisterWithRoleRequest {
  ...
  public RegisterWithRoleRequest email(@javax.annotation.Nonnull String email) {
    this.email = email;
    return this;
  }
  ...
  public RegisterWithRoleRequest password(@javax.annotation.Nonnull String password) {
  ...
  public RegisterWithRoleRequest firstName(@javax.annotation.Nonnull String firstName) {
  ...
  public RegisterWithRoleRequest lastName(@javax.annotation.Nonnull String lastName) {
  ...
  public RegisterWithRoleRequest projectId(@javax.annotation.Nonnull String projectId) {
  ...
  public boolean equals(Object o) {
    ...
    RegisterWithRoleRequest registerWithRoleRequest = (RegisterWithRoleRequest) o;
    return Objects.equals(this.email, registerWithRoleRequest.email) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to RegisterWithRoleRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RegisterWithRoleRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RegisterWithRoleRequest is not found in the empty JSON string", RegisterWithRoleRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RegisterWithRoleRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RegisterWithRoleRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RegisterWithRoleRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RegisterWithRoleRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RegisterWithRoleRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RegisterWithRoleRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RegisterWithRoleRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<RegisterWithRoleRequest>() {
           @Override
           public void write(JsonWriter out, RegisterWithRoleRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RegisterWithRoleRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RegisterWithRoleRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RegisterWithRoleRequest
   * @throws IOException if the JSON string is invalid with respect to RegisterWithRoleRequest
   */
  public static RegisterWithRoleRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RegisterWithRoleRequest.class);
  }

  /**
   * Convert an instance of RegisterWithRoleRequest to an JSON string
   *
   * @return JSON string
   */
