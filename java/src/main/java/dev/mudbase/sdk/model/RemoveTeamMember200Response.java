...
public class RemoveTeamMember200Response {
  ...
  public RemoveTeamMember200Response message(@javax.annotation.Nullable String message) {
  ...
  public boolean equals(Object o) {
    ...
    RemoveTeamMember200Response removeTeamMember200Response = (RemoveTeamMember200Response) o;
    return Objects.equals(this.message, removeTeamMember200Response.message);
  }
  ...
  public String toString() {
    ...
    sb.append("class RemoveTeamMember200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RemoveTeamMember200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RemoveTeamMember200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RemoveTeamMember200Response is not found in the empty JSON string", RemoveTeamMember200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RemoveTeamMember200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RemoveTeamMember200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RemoveTeamMember200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RemoveTeamMember200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RemoveTeamMember200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RemoveTeamMember200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<RemoveTeamMember200Response>() {
           @Override
           public void write(JsonWriter out, RemoveTeamMember200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RemoveTeamMember200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RemoveTeamMember200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RemoveTeamMember200Response
   * @throws IOException if the JSON string is invalid with respect to RemoveTeamMember200Response
   */
  public static RemoveTeamMember200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RemoveTeamMember200Response.class);
  }

  /**
   * Convert an instance of RemoveTeamMember200Response to an JSON string
   *
   * @return JSON string
   */
