...
public class RequestManualPayoutRequest {
  public static final String SERIALIZED_NAME_CURRENCY = "currency";
  @SerializedName(SERIALIZED_NAME_CURRENCY)
  @javax.annotation.Nonnull
  private String currency;

  public RequestManualPayoutRequest() {
  }

  public RequestManualPayoutRequest currency(@javax.annotation.Nonnull String currency) {
  ...
  public boolean equals(Object o) {
    ...
    RequestManualPayoutRequest requestManualPayoutRequest = (RequestManualPayoutRequest) o;
    return Objects.equals(this.currency, requestManualPayoutRequest.currency);
  }
  ...
  public String toString() {
    ...
    sb.append("class RequestManualPayoutRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RequestManualPayoutRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RequestManualPayoutRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RequestManualPayoutRequest is not found in the empty JSON string", RequestManualPayoutRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RequestManualPayoutRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RequestManualPayoutRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RequestManualPayoutRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RequestManualPayoutRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RequestManualPayoutRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RequestManualPayoutRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RequestManualPayoutRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<RequestManualPayoutRequest>() {
           @Override
           public void write(JsonWriter out, RequestManualPayoutRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RequestManualPayoutRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RequestManualPayoutRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RequestManualPayoutRequest
   * @throws IOException if the JSON string is invalid with respect to RequestManualPayoutRequest
   */
  public static RequestManualPayoutRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RequestManualPayoutRequest.class);
  }

  /**
   * Convert an instance of RequestManualPayoutRequest to an JSON string
   *
   * @return JSON string
   */
