...
public class RequestPasswordResetRequest {
  ...
  public RequestPasswordResetRequest email(@javax.annotation.Nonnull String email) {
    this.email = email;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.email, requestPasswordResetRequest.email);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RequestPasswordResetRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RequestPasswordResetRequest is not found in the empty JSON string", RequestPasswordResetRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RequestPasswordResetRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RequestPasswordResetRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
