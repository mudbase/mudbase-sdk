...
public class RequestRoleElevationRequest {
  ...
  public RequestRoleElevationRequest() {
  }

  public RequestRoleElevationRequest roleSlug(@javax.annotation.Nonnull String roleSlug) {
  ...
  public boolean equals(Object o) {
    ...
    RequestRoleElevationRequest requestRoleElevationRequest = (RequestRoleElevationRequest) o;
    return Objects.equals(this.roleSlug, requestRoleElevationRequest.roleSlug);
  }

  @Override
  public int hashCode() {
    return Objects.hash(roleSlug);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RequestRoleElevationRequest {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("roleSlug"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("roleSlug"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to RequestRoleElevationRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RequestRoleElevationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RequestRoleElevationRequest is not found in the empty JSON string", RequestRoleElevationRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RequestRoleElevationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RequestRoleElevationRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RequestRoleElevationRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RequestRoleElevationRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RequestRoleElevationRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RequestRoleElevationRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RequestRoleElevationRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<RequestRoleElevationRequest>() {
           @Override
           public void write(JsonWriter out, RequestRoleElevationRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RequestRoleElevationRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RequestRoleElevationRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RequestRoleElevationRequest
   * @throws IOException if the JSON string is invalid with respect to RequestRoleElevationRequest
   */
  public static RequestRoleElevationRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RequestRoleElevationRequest.class);
  }

  /**
   * Convert an instance of RequestRoleElevationRequest to an JSON string
   *
   * @return JSON string
   */
