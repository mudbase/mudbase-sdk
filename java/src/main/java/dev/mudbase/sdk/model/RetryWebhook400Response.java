...
public class RetryWebhook400Response {
  public static final String SERIALIZED_NAME_ERROR = "error";
  @SerializedName(SERIALIZED_NAME_ERROR)
  @javax.annotation.Nullable
  private String error;

  public RetryWebhook400Response() {
  }

  public RetryWebhook400Response error(@javax.annotation.Nullable String error) {
    this.error = error;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    RetryWebhook400Response retryWebhook400Response = (RetryWebhook400Response) o;
    return Objects.equals(this.error, retryWebhook400Response.error);
  }
  ...
  public String toString() {
    ...
    sb.append("class RetryWebhook400Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RetryWebhook400Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RetryWebhook400Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RetryWebhook400Response is not found in the empty JSON string", RetryWebhook400Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RetryWebhook400Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RetryWebhook400Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RetryWebhook400Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RetryWebhook400Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RetryWebhook400Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RetryWebhook400Response.class));

       return (TypeAdapter<T>) new TypeAdapter<RetryWebhook400Response>() {
           @Override
           public void write(JsonWriter out, RetryWebhook400Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RetryWebhook400Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RetryWebhook400Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RetryWebhook400Response
   * @throws IOException if the JSON string is invalid with respect to RetryWebhook400Response
   */
  public static RetryWebhook400Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RetryWebhook400Response.class);
  }

  /**
   * Convert an instance of RetryWebhook400Response to an JSON string
   *
   * @return JSON string
   */
