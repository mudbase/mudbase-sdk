...
public class RetryWebhookResponse {
  ...
  public RetryWebhookResponse() {
  }

  public RetryWebhookResponse message(@javax.annotation.Nonnull String message) {
  ...
  public RetryWebhookResponse webhookId(@javax.annotation.Nonnull String webhookId) {
  ...
  public boolean equals(Object o) {
    ...
    RetryWebhookResponse retryWebhookResponse = (RetryWebhookResponse) o;
    return Objects.equals(this.message, retryWebhookResponse.message) &&
        Objects.equals(this.webhookId, retryWebhookResponse.webhookId);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to RetryWebhookResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RetryWebhookResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RetryWebhookResponse is not found in the empty JSON string", RetryWebhookResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RetryWebhookResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RetryWebhookResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RetryWebhookResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RetryWebhookResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RetryWebhookResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RetryWebhookResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RetryWebhookResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<RetryWebhookResponse>() {
           @Override
           public void write(JsonWriter out, RetryWebhookResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RetryWebhookResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RetryWebhookResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RetryWebhookResponse
   * @throws IOException if the JSON string is invalid with respect to RetryWebhookResponse
   */
  public static RetryWebhookResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RetryWebhookResponse.class);
  }

  /**
   * Convert an instance of RetryWebhookResponse to an JSON string
   *
   * @return JSON string
   */
