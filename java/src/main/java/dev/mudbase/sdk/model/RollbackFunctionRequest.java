...
public class RollbackFunctionRequest {
  public static final String SERIALIZED_NAME_VERSION = "version";
  @SerializedName(SERIALIZED_NAME_VERSION)
  @javax.annotation.Nonnull
  private Integer version;

  public RollbackFunctionRequest() {
  }

  public RollbackFunctionRequest version(@javax.annotation.Nonnull Integer version) {
  ...
  public boolean equals(Object o) {
    ...
    RollbackFunctionRequest rollbackFunctionRequest = (RollbackFunctionRequest) o;
    return Objects.equals(this.version, rollbackFunctionRequest.version);
  }
  ...
  public String toString() {
    ...
    sb.append("class RollbackFunctionRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RollbackFunctionRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RollbackFunctionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RollbackFunctionRequest is not found in the empty JSON string", RollbackFunctionRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RollbackFunctionRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RollbackFunctionRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RollbackFunctionRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RollbackFunctionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RollbackFunctionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RollbackFunctionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RollbackFunctionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<RollbackFunctionRequest>() {
           @Override
           public void write(JsonWriter out, RollbackFunctionRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RollbackFunctionRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RollbackFunctionRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RollbackFunctionRequest
   * @throws IOException if the JSON string is invalid with respect to RollbackFunctionRequest
   */
  public static RollbackFunctionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RollbackFunctionRequest.class);
  }

  /**
   * Convert an instance of RollbackFunctionRequest to an JSON string
   *
   * @return JSON string
   */
