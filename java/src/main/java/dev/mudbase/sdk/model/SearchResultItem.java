...
public class SearchResultItem {
  ...
  public SearchResultItem id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public SearchResultItem score(@javax.annotation.Nullable BigDecimal score) {
    this.score = score;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, searchResultItem.id) &&
        Objects.equals(this.score, searchResultItem.score);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("_id", "score"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to SearchResultItem
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SearchResultItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SearchResultItem is not found in the empty JSON string", SearchResultItem.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SearchResultItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SearchResultItem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SearchResultItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SearchResultItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SearchResultItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SearchResultItem.class));

       return (TypeAdapter<T>) new TypeAdapter<SearchResultItem>() {
           @Override
           public void write(JsonWriter out, SearchResultItem value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SearchResultItem read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SearchResultItem given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SearchResultItem
   * @throws IOException if the JSON string is invalid with respect to SearchResultItem
   */
  public static SearchResultItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SearchResultItem.class);
  }

  /**
   * Convert an instance of SearchResultItem to an JSON string
   *
   * @return JSON string
   */
