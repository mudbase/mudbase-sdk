...
import dev.mudbase.sdk.model.SendMessageRequestE2ee;
...
public class SendMessageRequest {
  ...
  @javax.annotation.Nullable
  private SendMessageRequestE2ee e2ee;
  ...
  public SendMessageRequest type(@javax.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public SendMessageRequest content(@javax.annotation.Nullable String content) {
  ...
  public SendMessageRequest e2ee(@javax.annotation.Nullable SendMessageRequestE2ee e2ee) {
    this.e2ee = e2ee;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public SendMessageRequestE2ee getE2ee() {
    return e2ee;
  }

  public void setE2ee(@javax.annotation.Nullable SendMessageRequestE2ee e2ee) {
    this.e2ee = e2ee;
  }


  public SendMessageRequest replyTo(@javax.annotation.Nullable String replyTo) {
  ...
  public SendMessageRequest mentions(@javax.annotation.Nullable List<String> mentions) {
    this.mentions = mentions;
    return this;
  }

  public SendMessageRequest addMentionsItem(String mentionsItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, sendMessageRequest.type) &&
        Objects.equals(this.content, sendMessageRequest.content) &&
        Objects.equals(this.e2ee, sendMessageRequest.e2ee) &&
        Objects.equals(this.replyTo, sendMessageRequest.replyTo) &&
        Objects.equals(this.mentions, sendMessageRequest.mentions);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, content, e2ee, replyTo, mentions);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("type", "content", "e2ee", "replyTo", "mentions"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SendMessageRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SendMessageRequest is not found in the empty JSON string", SendMessageRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SendMessageRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SendMessageRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("e2ee") != null && !jsonObj.get("e2ee").isJsonNull()) {
        SendMessageRequestE2ee.validateJsonElement(jsonObj.get("e2ee"));
      }
      if ((jsonObj.get("replyTo") != null && !jsonObj.get("replyTo").isJsonNull()) && !jsonObj.get("replyTo").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `replyTo` to be a primitive type in the JSON string but got `%s`", jsonObj.get("replyTo").toString()));
      }
