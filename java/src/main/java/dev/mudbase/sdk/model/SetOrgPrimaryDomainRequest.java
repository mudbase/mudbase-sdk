...
public class SetOrgPrimaryDomainRequest {
  public static final String SERIALIZED_NAME_HOSTNAME = "hostname";
  @SerializedName(SERIALIZED_NAME_HOSTNAME)
  @javax.annotation.Nonnull
  private String hostname;

  public SetOrgPrimaryDomainRequest() {
  }

  public SetOrgPrimaryDomainRequest hostname(@javax.annotation.Nonnull String hostname) {
  ...
  public boolean equals(Object o) {
    ...
    SetOrgPrimaryDomainRequest setOrgPrimaryDomainRequest = (SetOrgPrimaryDomainRequest) o;
    return Objects.equals(this.hostname, setOrgPrimaryDomainRequest.hostname);
  }
  ...
  public String toString() {
    ...
    sb.append("class SetOrgPrimaryDomainRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SetOrgPrimaryDomainRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SetOrgPrimaryDomainRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SetOrgPrimaryDomainRequest is not found in the empty JSON string", SetOrgPrimaryDomainRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SetOrgPrimaryDomainRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SetOrgPrimaryDomainRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SetOrgPrimaryDomainRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SetOrgPrimaryDomainRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SetOrgPrimaryDomainRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SetOrgPrimaryDomainRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SetOrgPrimaryDomainRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<SetOrgPrimaryDomainRequest>() {
           @Override
           public void write(JsonWriter out, SetOrgPrimaryDomainRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SetOrgPrimaryDomainRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SetOrgPrimaryDomainRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SetOrgPrimaryDomainRequest
   * @throws IOException if the JSON string is invalid with respect to SetOrgPrimaryDomainRequest
   */
  public static SetOrgPrimaryDomainRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SetOrgPrimaryDomainRequest.class);
  }

  /**
   * Convert an instance of SetOrgPrimaryDomainRequest to an JSON string
   *
   * @return JSON string
   */
