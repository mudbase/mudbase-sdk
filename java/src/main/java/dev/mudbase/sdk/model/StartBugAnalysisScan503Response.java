...
public class StartBugAnalysisScan503Response {
  ...
  public StartBugAnalysisScan503Response() {
  }

  public StartBugAnalysisScan503Response success(@javax.annotation.Nullable Boolean success) {
  ...
  public StartBugAnalysisScan503Response code(@javax.annotation.Nullable String code) {
    this.code = code;
    return this;
  }
  ...
  public StartBugAnalysisScan503Response message(@javax.annotation.Nullable String message) {
  ...
  public boolean equals(Object o) {
    ...
    StartBugAnalysisScan503Response startBugAnalysisScan503Response = (StartBugAnalysisScan503Response) o;
    return Objects.equals(this.success, startBugAnalysisScan503Response.success) &&
        Objects.equals(this.code, startBugAnalysisScan503Response.code) &&
        Objects.equals(this.message, startBugAnalysisScan503Response.message);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("success", "code", "message"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartBugAnalysisScan503Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartBugAnalysisScan503Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in StartBugAnalysisScan503Response is not found in the empty JSON string", StartBugAnalysisScan503Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartBugAnalysisScan503Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `StartBugAnalysisScan503Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartBugAnalysisScan503Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartBugAnalysisScan503Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartBugAnalysisScan503Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartBugAnalysisScan503Response.class));

       return (TypeAdapter<T>) new TypeAdapter<StartBugAnalysisScan503Response>() {
           @Override
           public void write(JsonWriter out, StartBugAnalysisScan503Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartBugAnalysisScan503Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartBugAnalysisScan503Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartBugAnalysisScan503Response
   * @throws IOException if the JSON string is invalid with respect to StartBugAnalysisScan503Response
   */
  public static StartBugAnalysisScan503Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartBugAnalysisScan503Response.class);
  }

  /**
   * Convert an instance of StartBugAnalysisScan503Response to an JSON string
   *
   * @return JSON string
   */
