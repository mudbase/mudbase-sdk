...
public class StorageConfig {
  ...
  public StorageConfig buckets(@javax.annotation.Nullable List<String> buckets) {
    this.buckets = buckets;
    return this;
  }

  public StorageConfig addBucketsItem(String bucketsItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.buckets, storageConfig.buckets);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("buckets"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StorageConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in StorageConfig is not found in the empty JSON string", StorageConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StorageConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `StorageConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
