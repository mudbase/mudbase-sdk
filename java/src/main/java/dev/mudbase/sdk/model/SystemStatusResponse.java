...
import dev.mudbase.sdk.model.SystemStatusResponseData;
...
public class SystemStatusResponse {
  ...
  @javax.annotation.Nullable
  private SystemStatusResponseData data;

  public SystemStatusResponse() {
  }

  public SystemStatusResponse success(@javax.annotation.Nullable Boolean success) {
  ...
  public SystemStatusResponse data(@javax.annotation.Nullable SystemStatusResponseData data) {
    this.data = data;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public SystemStatusResponseData getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable SystemStatusResponseData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.success, systemStatusResponse.success) &&
        Objects.equals(this.data, systemStatusResponse.data);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SystemStatusResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SystemStatusResponse is not found in the empty JSON string", SystemStatusResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SystemStatusResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SystemStatusResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `data`
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        SystemStatusResponseData.validateJsonElement(jsonObj.get("data"));
      }
  }
