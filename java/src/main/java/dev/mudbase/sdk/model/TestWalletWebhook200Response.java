...
public class TestWalletWebhook200Response {
  ...
  public TestWalletWebhook200Response() {
  }

  public TestWalletWebhook200Response success(@javax.annotation.Nullable Boolean success) {
  ...
  public TestWalletWebhook200Response data(@javax.annotation.Nullable Object data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    TestWalletWebhook200Response testWalletWebhook200Response = (TestWalletWebhook200Response) o;
    return Objects.equals(this.success, testWalletWebhook200Response.success) &&
        Objects.equals(this.data, testWalletWebhook200Response.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class TestWalletWebhook200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TestWalletWebhook200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TestWalletWebhook200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TestWalletWebhook200Response is not found in the empty JSON string", TestWalletWebhook200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TestWalletWebhook200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `TestWalletWebhook200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TestWalletWebhook200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TestWalletWebhook200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TestWalletWebhook200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TestWalletWebhook200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<TestWalletWebhook200Response>() {
           @Override
           public void write(JsonWriter out, TestWalletWebhook200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TestWalletWebhook200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TestWalletWebhook200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TestWalletWebhook200Response
   * @throws IOException if the JSON string is invalid with respect to TestWalletWebhook200Response
   */
  public static TestWalletWebhook200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TestWalletWebhook200Response.class);
  }

  /**
   * Convert an instance of TestWalletWebhook200Response to an JSON string
   *
   * @return JSON string
   */
