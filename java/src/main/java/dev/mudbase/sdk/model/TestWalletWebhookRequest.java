...
public class TestWalletWebhookRequest {
  ...
  public TestWalletWebhookRequest() {
  }

  public TestWalletWebhookRequest url(@javax.annotation.Nonnull String url) {
    this.url = url;
    return this;
  }
  ...
  public TestWalletWebhookRequest secret(@javax.annotation.Nullable String secret) {
    this.secret = secret;
    return this;
  }
  ...
  public TestWalletWebhookRequest projectId(@javax.annotation.Nullable String projectId) {
  ...
  public TestWalletWebhookRequest event(@javax.annotation.Nullable String event) {
    this.event = event;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    TestWalletWebhookRequest testWalletWebhookRequest = (TestWalletWebhookRequest) o;
    return Objects.equals(this.url, testWalletWebhookRequest.url) &&
        Objects.equals(this.secret, testWalletWebhookRequest.secret) &&
        Objects.equals(this.projectId, testWalletWebhookRequest.projectId) &&
        Objects.equals(this.event, testWalletWebhookRequest.event);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to TestWalletWebhookRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TestWalletWebhookRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TestWalletWebhookRequest is not found in the empty JSON string", TestWalletWebhookRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TestWalletWebhookRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `TestWalletWebhookRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TestWalletWebhookRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TestWalletWebhookRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TestWalletWebhookRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TestWalletWebhookRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TestWalletWebhookRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<TestWalletWebhookRequest>() {
           @Override
           public void write(JsonWriter out, TestWalletWebhookRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TestWalletWebhookRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TestWalletWebhookRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TestWalletWebhookRequest
   * @throws IOException if the JSON string is invalid with respect to TestWalletWebhookRequest
   */
  public static TestWalletWebhookRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TestWalletWebhookRequest.class);
  }

  /**
   * Convert an instance of TestWalletWebhookRequest to an JSON string
   *
   * @return JSON string
   */
