...
public class ToggleRoleRequest {
  ...
  public ToggleRoleRequest isEnabled(@javax.annotation.Nonnull Boolean isEnabled) {
  ...
  public boolean equals(Object o) {
    ...
    ToggleRoleRequest toggleRoleRequest = (ToggleRoleRequest) o;
    return Objects.equals(this.isEnabled, toggleRoleRequest.isEnabled);
  }
  ...
  public String toString() {
    ...
    sb.append("class ToggleRoleRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ToggleRoleRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ToggleRoleRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ToggleRoleRequest is not found in the empty JSON string", ToggleRoleRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ToggleRoleRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ToggleRoleRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ToggleRoleRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ToggleRoleRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ToggleRoleRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ToggleRoleRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ToggleRoleRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ToggleRoleRequest>() {
           @Override
           public void write(JsonWriter out, ToggleRoleRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ToggleRoleRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ToggleRoleRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ToggleRoleRequest
   * @throws IOException if the JSON string is invalid with respect to ToggleRoleRequest
   */
  public static ToggleRoleRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ToggleRoleRequest.class);
  }

  /**
   * Convert an instance of ToggleRoleRequest to an JSON string
   *
   * @return JSON string
   */
