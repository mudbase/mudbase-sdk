...
public class UnlinkOAuthProvider200Response {
  ...
  public UnlinkOAuthProvider200Response() {
  }

  public UnlinkOAuthProvider200Response message(@javax.annotation.Nullable String message) {
  ...
  public UnlinkOAuthProvider200Response provider(@javax.annotation.Nullable String provider) {
  ...
  public boolean equals(Object o) {
    ...
    UnlinkOAuthProvider200Response unlinkOAuthProvider200Response = (UnlinkOAuthProvider200Response) o;
    return Objects.equals(this.message, unlinkOAuthProvider200Response.message) &&
        Objects.equals(this.provider, unlinkOAuthProvider200Response.provider);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UnlinkOAuthProvider200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UnlinkOAuthProvider200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UnlinkOAuthProvider200Response is not found in the empty JSON string", UnlinkOAuthProvider200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UnlinkOAuthProvider200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UnlinkOAuthProvider200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UnlinkOAuthProvider200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UnlinkOAuthProvider200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UnlinkOAuthProvider200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UnlinkOAuthProvider200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<UnlinkOAuthProvider200Response>() {
           @Override
           public void write(JsonWriter out, UnlinkOAuthProvider200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UnlinkOAuthProvider200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UnlinkOAuthProvider200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UnlinkOAuthProvider200Response
   * @throws IOException if the JSON string is invalid with respect to UnlinkOAuthProvider200Response
   */
  public static UnlinkOAuthProvider200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UnlinkOAuthProvider200Response.class);
  }

  /**
   * Convert an instance of UnlinkOAuthProvider200Response to an JSON string
   *
   * @return JSON string
   */
