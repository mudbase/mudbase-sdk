...
import dev.mudbase.sdk.model.ApiKey;
...
public class UpdateApiKey200Response {
  ...
  public UpdateApiKey200Response() {
  }

  public UpdateApiKey200Response message(@javax.annotation.Nullable String message) {
  ...
  public UpdateApiKey200Response apiKey(@javax.annotation.Nullable ApiKey apiKey) {
    this.apiKey = apiKey;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateApiKey200Response updateApiKey200Response = (UpdateApiKey200Response) o;
    return Objects.equals(this.message, updateApiKey200Response.message) &&
        Objects.equals(this.apiKey, updateApiKey200Response.apiKey);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("message", "apiKey"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateApiKey200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateApiKey200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UpdateApiKey200Response is not found in the empty JSON string", UpdateApiKey200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateApiKey200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UpdateApiKey200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateApiKey200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateApiKey200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateApiKey200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateApiKey200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateApiKey200Response>() {
           @Override
           public void write(JsonWriter out, UpdateApiKey200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateApiKey200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateApiKey200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateApiKey200Response
   * @throws IOException if the JSON string is invalid with respect to UpdateApiKey200Response
   */
  public static UpdateApiKey200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateApiKey200Response.class);
  }

  /**
   * Convert an instance of UpdateApiKey200Response to an JSON string
   *
   * @return JSON string
   */
