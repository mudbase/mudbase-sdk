...
import dev.mudbase.sdk.model.User;
...
public class UpdateMemberRole200Response {
  ...
  public UpdateMemberRole200Response() {
  }

  public UpdateMemberRole200Response message(@javax.annotation.Nullable String message) {
  ...
  public UpdateMemberRole200Response user(@javax.annotation.Nullable User user) {
    this.user = user;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateMemberRole200Response updateMemberRole200Response = (UpdateMemberRole200Response) o;
    return Objects.equals(this.message, updateMemberRole200Response.message) &&
        Objects.equals(this.user, updateMemberRole200Response.user);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateMemberRole200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateMemberRole200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UpdateMemberRole200Response is not found in the empty JSON string", UpdateMemberRole200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateMemberRole200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UpdateMemberRole200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateMemberRole200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateMemberRole200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateMemberRole200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateMemberRole200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateMemberRole200Response>() {
           @Override
           public void write(JsonWriter out, UpdateMemberRole200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateMemberRole200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateMemberRole200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateMemberRole200Response
   * @throws IOException if the JSON string is invalid with respect to UpdateMemberRole200Response
   */
  public static UpdateMemberRole200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateMemberRole200Response.class);
  }

  /**
   * Convert an instance of UpdateMemberRole200Response to an JSON string
   *
   * @return JSON string
   */
