...
public class UpdateMemberRoleRequest {
  ...
  public UpdateMemberRoleRequest role(@javax.annotation.Nonnull RoleEnum role) {
    this.role = role;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateMemberRoleRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateMemberRoleRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UpdateMemberRoleRequest is not found in the empty JSON string", UpdateMemberRoleRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateMemberRoleRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UpdateMemberRoleRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateMemberRoleRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateMemberRoleRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateMemberRoleRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateMemberRoleRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateMemberRoleRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateMemberRoleRequest>() {
           @Override
           public void write(JsonWriter out, UpdateMemberRoleRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateMemberRoleRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateMemberRoleRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateMemberRoleRequest
   * @throws IOException if the JSON string is invalid with respect to UpdateMemberRoleRequest
   */
  public static UpdateMemberRoleRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateMemberRoleRequest.class);
  }

  /**
   * Convert an instance of UpdateMemberRoleRequest to an JSON string
   *
   * @return JSON string
   */
