...
public class UpdateOrganizationPlanRequest {
  /**
   * Gets or Sets plan
   */
  ...
  public UpdateOrganizationPlanRequest() {
  }

  public UpdateOrganizationPlanRequest plan(@javax.annotation.Nonnull PlanEnum plan) {
    this.plan = plan;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateOrganizationPlanRequest updateOrganizationPlanRequest = (UpdateOrganizationPlanRequest) o;
    return Objects.equals(this.plan, updateOrganizationPlanRequest.plan);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateOrganizationPlanRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateOrganizationPlanRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UpdateOrganizationPlanRequest is not found in the empty JSON string", UpdateOrganizationPlanRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateOrganizationPlanRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UpdateOrganizationPlanRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateOrganizationPlanRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateOrganizationPlanRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateOrganizationPlanRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateOrganizationPlanRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateOrganizationPlanRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateOrganizationPlanRequest>() {
           @Override
           public void write(JsonWriter out, UpdateOrganizationPlanRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateOrganizationPlanRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateOrganizationPlanRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateOrganizationPlanRequest
   * @throws IOException if the JSON string is invalid with respect to UpdateOrganizationPlanRequest
   */
  public static UpdateOrganizationPlanRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateOrganizationPlanRequest.class);
  }

  /**
   * Convert an instance of UpdateOrganizationPlanRequest to an JSON string
   *
   * @return JSON string
   */
