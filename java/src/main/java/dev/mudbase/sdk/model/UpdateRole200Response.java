...
public class UpdateRole200Response {
  ...
  public UpdateRole200Response() {
  }

  public UpdateRole200Response message(@javax.annotation.Nullable String message) {
  ...
  public UpdateRole200Response role(@javax.annotation.Nullable Object role) {
    this.role = role;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateRole200Response updateRole200Response = (UpdateRole200Response) o;
    return Objects.equals(this.message, updateRole200Response.message) &&
        Objects.equals(this.role, updateRole200Response.role);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("message", "role"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateRole200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateRole200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UpdateRole200Response is not found in the empty JSON string", UpdateRole200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateRole200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UpdateRole200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateRole200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateRole200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateRole200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateRole200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateRole200Response>() {
           @Override
           public void write(JsonWriter out, UpdateRole200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateRole200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateRole200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateRole200Response
   * @throws IOException if the JSON string is invalid with respect to UpdateRole200Response
   */
  public static UpdateRole200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateRole200Response.class);
  }

  /**
   * Convert an instance of UpdateRole200Response to an JSON string
   *
   * @return JSON string
   */
