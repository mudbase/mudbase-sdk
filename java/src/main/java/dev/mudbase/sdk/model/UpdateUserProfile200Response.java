...
public class UpdateUserProfile200Response {
  ...
  public UpdateUserProfile200Response user(@javax.annotation.Nullable User user) {
    this.user = user;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.message, updateUserProfile200Response.message) &&
        Objects.equals(this.user, updateUserProfile200Response.user);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateUserProfile200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UpdateUserProfile200Response is not found in the empty JSON string", UpdateUserProfile200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateUserProfile200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UpdateUserProfile200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
