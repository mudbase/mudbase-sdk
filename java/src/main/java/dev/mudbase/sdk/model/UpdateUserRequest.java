...
public class UpdateUserRequest {
  ...
  public UpdateUserRequest avatar(@javax.annotation.Nullable String avatar) {
    this.avatar = avatar;
    return this;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(firstName, lastName, avatar);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("firstName", "lastName", "avatar"));
