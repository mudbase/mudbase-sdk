...
public class UpdateWalletWebhookRequest {
  ...
  public UpdateWalletWebhookRequest() {
  }

  public UpdateWalletWebhookRequest url(@javax.annotation.Nullable String url) {
    this.url = url;
    return this;
  }
  ...
  public UpdateWalletWebhookRequest events(@javax.annotation.Nullable List<String> events) {
    this.events = events;
    return this;
  }

  public UpdateWalletWebhookRequest addEventsItem(String eventsItem) {
    if (this.events == null) {
  ...
  public UpdateWalletWebhookRequest secret(@javax.annotation.Nullable String secret) {
    this.secret = secret;
    return this;
  }
  ...
  public UpdateWalletWebhookRequest filters(@javax.annotation.Nullable Object filters) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateWalletWebhookRequest updateWalletWebhookRequest = (UpdateWalletWebhookRequest) o;
    return Objects.equals(this.url, updateWalletWebhookRequest.url) &&
        Objects.equals(this.events, updateWalletWebhookRequest.events) &&
        Objects.equals(this.secret, updateWalletWebhookRequest.secret) &&
        Objects.equals(this.filters, updateWalletWebhookRequest.filters);
  }

  @Override
  public int hashCode() {
    return Objects.hash(url, events, secret, filters);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("url", "events", "secret", "filters"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateWalletWebhookRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateWalletWebhookRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UpdateWalletWebhookRequest is not found in the empty JSON string", UpdateWalletWebhookRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateWalletWebhookRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UpdateWalletWebhookRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateWalletWebhookRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateWalletWebhookRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateWalletWebhookRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateWalletWebhookRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateWalletWebhookRequest>() {
           @Override
           public void write(JsonWriter out, UpdateWalletWebhookRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateWalletWebhookRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateWalletWebhookRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateWalletWebhookRequest
   * @throws IOException if the JSON string is invalid with respect to UpdateWalletWebhookRequest
   */
  public static UpdateWalletWebhookRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateWalletWebhookRequest.class);
  }

  /**
   * Convert an instance of UpdateWalletWebhookRequest to an JSON string
   *
   * @return JSON string
   */
