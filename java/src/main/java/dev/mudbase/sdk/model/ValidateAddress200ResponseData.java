...
public class ValidateAddress200ResponseData {
  ...
  public ValidateAddress200ResponseData() {
  }

  public ValidateAddress200ResponseData isValid(@javax.annotation.Nullable Boolean isValid) {
  ...
  public ValidateAddress200ResponseData currency(@javax.annotation.Nullable String currency) {
  ...
  public ValidateAddress200ResponseData address(@javax.annotation.Nullable String address) {
  ...
  public boolean equals(Object o) {
    ...
    ValidateAddress200ResponseData validateAddress200ResponseData = (ValidateAddress200ResponseData) o;
    return Objects.equals(this.isValid, validateAddress200ResponseData.isValid) &&
        Objects.equals(this.currency, validateAddress200ResponseData.currency) &&
        Objects.equals(this.address, validateAddress200ResponseData.address);
  }

  @Override
  public int hashCode() {
    return Objects.hash(isValid, currency, address);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("isValid", "currency", "address"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to ValidateAddress200ResponseData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ValidateAddress200ResponseData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ValidateAddress200ResponseData is not found in the empty JSON string", ValidateAddress200ResponseData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ValidateAddress200ResponseData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ValidateAddress200ResponseData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ValidateAddress200ResponseData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ValidateAddress200ResponseData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ValidateAddress200ResponseData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ValidateAddress200ResponseData.class));

       return (TypeAdapter<T>) new TypeAdapter<ValidateAddress200ResponseData>() {
           @Override
           public void write(JsonWriter out, ValidateAddress200ResponseData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ValidateAddress200ResponseData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ValidateAddress200ResponseData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ValidateAddress200ResponseData
   * @throws IOException if the JSON string is invalid with respect to ValidateAddress200ResponseData
   */
  public static ValidateAddress200ResponseData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ValidateAddress200ResponseData.class);
  }

  /**
   * Convert an instance of ValidateAddress200ResponseData to an JSON string
   *
   * @return JSON string
   */
