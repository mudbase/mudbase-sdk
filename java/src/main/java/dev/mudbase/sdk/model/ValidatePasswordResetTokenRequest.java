...
public class ValidatePasswordResetTokenRequest {
  ...
  public ValidatePasswordResetTokenRequest token(@javax.annotation.Nonnull String token) {
    this.token = token;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ValidatePasswordResetTokenRequest validatePasswordResetTokenRequest = (ValidatePasswordResetTokenRequest) o;
    return Objects.equals(this.token, validatePasswordResetTokenRequest.token);
  }
  ...
  public String toString() {
    ...
    sb.append("class ValidatePasswordResetTokenRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ValidatePasswordResetTokenRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ValidatePasswordResetTokenRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ValidatePasswordResetTokenRequest is not found in the empty JSON string", ValidatePasswordResetTokenRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ValidatePasswordResetTokenRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ValidatePasswordResetTokenRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ValidatePasswordResetTokenRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ValidatePasswordResetTokenRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ValidatePasswordResetTokenRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ValidatePasswordResetTokenRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ValidatePasswordResetTokenRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ValidatePasswordResetTokenRequest>() {
           @Override
           public void write(JsonWriter out, ValidatePasswordResetTokenRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ValidatePasswordResetTokenRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ValidatePasswordResetTokenRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ValidatePasswordResetTokenRequest
   * @throws IOException if the JSON string is invalid with respect to ValidatePasswordResetTokenRequest
   */
  public static ValidatePasswordResetTokenRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ValidatePasswordResetTokenRequest.class);
  }

  /**
   * Convert an instance of ValidatePasswordResetTokenRequest to an JSON string
   *
   * @return JSON string
   */
