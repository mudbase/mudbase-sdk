...
public class VerifyEmailAuthRequest {
  ...
  public VerifyEmailAuthRequest() {
  }

  public VerifyEmailAuthRequest token(@javax.annotation.Nonnull String token) {
    this.token = token;
    return this;
  }
  ...
  public VerifyEmailAuthRequest projectId(@javax.annotation.Nullable String projectId) {
  ...
  public boolean equals(Object o) {
    ...
    VerifyEmailAuthRequest verifyEmailAuthRequest = (VerifyEmailAuthRequest) o;
    return Objects.equals(this.token, verifyEmailAuthRequest.token) &&
        Objects.equals(this.projectId, verifyEmailAuthRequest.projectId);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to VerifyEmailAuthRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VerifyEmailAuthRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in VerifyEmailAuthRequest is not found in the empty JSON string", VerifyEmailAuthRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VerifyEmailAuthRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `VerifyEmailAuthRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VerifyEmailAuthRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VerifyEmailAuthRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VerifyEmailAuthRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VerifyEmailAuthRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VerifyEmailAuthRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<VerifyEmailAuthRequest>() {
           @Override
           public void write(JsonWriter out, VerifyEmailAuthRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public VerifyEmailAuthRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of VerifyEmailAuthRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of VerifyEmailAuthRequest
   * @throws IOException if the JSON string is invalid with respect to VerifyEmailAuthRequest
   */
  public static VerifyEmailAuthRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VerifyEmailAuthRequest.class);
  }

  /**
   * Convert an instance of VerifyEmailAuthRequest to an JSON string
   *
   * @return JSON string
   */
