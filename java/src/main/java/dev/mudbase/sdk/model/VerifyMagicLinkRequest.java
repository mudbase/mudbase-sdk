...
public class VerifyMagicLinkRequest {
  ...
  public VerifyMagicLinkRequest token(@javax.annotation.Nonnull String token) {
    this.token = token;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    VerifyMagicLinkRequest verifyMagicLinkRequest = (VerifyMagicLinkRequest) o;
    return Objects.equals(this.token, verifyMagicLinkRequest.token);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to VerifyMagicLinkRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VerifyMagicLinkRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in VerifyMagicLinkRequest is not found in the empty JSON string", VerifyMagicLinkRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VerifyMagicLinkRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `VerifyMagicLinkRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VerifyMagicLinkRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VerifyMagicLinkRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VerifyMagicLinkRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VerifyMagicLinkRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VerifyMagicLinkRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<VerifyMagicLinkRequest>() {
           @Override
           public void write(JsonWriter out, VerifyMagicLinkRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public VerifyMagicLinkRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of VerifyMagicLinkRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of VerifyMagicLinkRequest
   * @throws IOException if the JSON string is invalid with respect to VerifyMagicLinkRequest
   */
  public static VerifyMagicLinkRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VerifyMagicLinkRequest.class);
  }

  /**
   * Convert an instance of VerifyMagicLinkRequest to an JSON string
   *
   * @return JSON string
   */
