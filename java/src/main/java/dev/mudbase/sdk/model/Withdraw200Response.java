...
import dev.mudbase.sdk.model.Withdraw200ResponseData;
...
public class Withdraw200Response {
  ...
  public Withdraw200Response success(@javax.annotation.Nullable Boolean success) {
  ...
  public Withdraw200Response message(@javax.annotation.Nullable String message) {
  ...
  public Withdraw200Response data(@javax.annotation.Nullable Withdraw200ResponseData data) {
    this.data = data;
    return this;
  }
  ...
  public void setData(@javax.annotation.Nullable Withdraw200ResponseData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.success, withdraw200Response.success) &&
        Objects.equals(this.message, withdraw200Response.message) &&
        Objects.equals(this.data, withdraw200Response.data);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Withdraw200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Withdraw200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Withdraw200Response is not found in the empty JSON string", Withdraw200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Withdraw200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Withdraw200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        Withdraw200ResponseData.validateJsonElement(jsonObj.get("data"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Withdraw200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Withdraw200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Withdraw200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Withdraw200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Withdraw200Response>() {
           @Override
           public void write(JsonWriter out, Withdraw200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Withdraw200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Withdraw200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Withdraw200Response
   * @throws IOException if the JSON string is invalid with respect to Withdraw200Response
   */
  public static Withdraw200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Withdraw200Response.class);
  }

  /**
   * Convert an instance of Withdraw200Response to an JSON string
   *
   * @return JSON string
   */
