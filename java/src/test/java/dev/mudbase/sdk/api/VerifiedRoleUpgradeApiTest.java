...
import dev.mudbase.sdk.model.VerifiedRoleUpgrade200Response;
import dev.mudbase.sdk.model.VerifiedRoleUpgradeRequest;
...
/**
 * API tests for VerifiedRoleUpgradeApi
 */
@Disabled
public class VerifiedRoleUpgradeApiTest {

    private final VerifiedRoleUpgradeApi api = new VerifiedRoleUpgradeApi();
     ...
     */
    @Test
    public void verifiedRoleUpgradeTest() throws ApiException {
        String orgId = null;
        String userId = null;
        VerifiedRoleUpgradeRequest verifiedRoleUpgradeRequest = null;
        VerifiedRoleUpgrade200Response response = api.verifiedRoleUpgrade(orgId, userId, verifiedRoleUpgradeRequest);
