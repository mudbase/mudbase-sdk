...
```php
createApiKey($create_api_key_request): \Mudbase\Sdk\Model\CreateApiKey201Response
```
...
| ------------- | ------------- | ------------- | ------------- |
| **create_api_key_request** | [**\Mudbase\Sdk\Model\CreateApiKeyRequest**](../Model/CreateApiKeyRequest.md)|  | |

### Return type

[**\Mudbase\Sdk\Model\CreateApiKey201Response**](../Model/CreateApiKey201Response.md)
...
```php
deleteApiKey($id): \Mudbase\Sdk\Model\MessageResponse
```
...
```php
getApiKeyUsage($id): \Mudbase\Sdk\Model\ApiKeyUsageResponse
```
...
[**\Mudbase\Sdk\Model\ApiKeyUsageResponse**](../Model/ApiKeyUsageResponse.md)
...
```php
listApiKeys(): \Mudbase\Sdk\Model\ListApiKeys200Response
```
...
[**\Mudbase\Sdk\Model\ListApiKeys200Response**](../Model/ListApiKeys200Response.md)
...
```php
regenerateApiKey($id): \Mudbase\Sdk\Model\RegenerateApiKey200Response
```
...
[**\Mudbase\Sdk\Model\RegenerateApiKey200Response**](../Model/RegenerateApiKey200Response.md)
...
```php
updateApiKey($id, $update_api_key_request): \Mudbase\Sdk\Model\UpdateApiKey200Response
```
...
$id = 'id_example'; // string
$update_api_key_request = {"name":"Updated API Key","permissions":[{"resource":"database","actions":["read","update"]},{"resource":"storage","actions":["read"]}],"isActive":true}; // \Mudbase\Sdk\Model\UpdateApiKeyRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **id** | **string**|  | |
| **update_api_key_request** | [**\Mudbase\Sdk\Model\UpdateApiKeyRequest**](../Model/UpdateApiKeyRequest.md)|  | |

### Return type

[**\Mudbase\Sdk\Model\UpdateApiKey200Response**](../Model/UpdateApiKey200Response.md)
