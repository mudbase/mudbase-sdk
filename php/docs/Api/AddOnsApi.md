...
```php
apiAddonsGet(): \Mudbase\Sdk\Model\ApiAddonsGet200Response
```
...
$apiInstance = new Mudbase\Sdk\Api\AddOnsApi(
...
[**\Mudbase\Sdk\Model\ApiAddonsGet200Response**](../Model/ApiAddonsGet200Response.md)
...
```php
apiProjectsProjectIdAddonsAddonInvokePost($project_id, $addon, $body): \Mudbase\Sdk\Model\ApiProjectsProjectIdAddonsAddonInvokePost200Response
```
...
[**\Mudbase\Sdk\Model\ApiProjectsProjectIdAddonsAddonInvokePost200Response**](../Model/ApiProjectsProjectIdAddonsAddonInvokePost200Response.md)
...
```php
apiProjectsProjectIdAddonsJobsIdGet($project_id, $id): \Mudbase\Sdk\Model\ApiProjectsProjectIdAddonsAddonInvokePost200Response
```
