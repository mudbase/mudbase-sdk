...
```php
acceptInvite($accept_invite_request): \Mudbase\Sdk\Model\AcceptInvite201Response
```
...
$apiInstance = new Mudbase\Sdk\Api\AuthenticationApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client()
);
$accept_invite_request = {"token":"a1b2c3d4e5f6...","password":"SecurePass123!","firstName":"Jane","lastName":"Doe"}; // \Mudbase\Sdk\Model\AcceptInviteRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **accept_invite_request** | [**\Mudbase\Sdk\Model\AcceptInviteRequest**](../Model/AcceptInviteRequest.md)|  | |

### Return type

[**\Mudbase\Sdk\Model\AcceptInvite201Response**](../Model/AcceptInvite201Response.md)
...
```php
confirmLocalPasswordResetWithOtp($confirm_local_password_reset_with_otp_request): \Mudbase\Sdk\Model\MessageResponse
```
...
$confirm_local_password_reset_with_otp_request = {"email":"user@example.com","projectId":"685ad30be129932fbb7a1047","otp":"123456","newPassword":"NewSecurePass123!"}; // \Mudbase\Sdk\Model\ConfirmLocalPasswordResetWithOtpRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **confirm_local_password_reset_with_otp_request** | [**\Mudbase\Sdk\Model\ConfirmLocalPasswordResetWithOtpRequest**](../Model/ConfirmLocalPasswordResetWithOtpRequest.md)|  | |

### Return type

[**\Mudbase\Sdk\Model\MessageResponse**](../Model/MessageResponse.md)
...
```php
convertAnonymousAccount($convert_anonymous_account_request): \Mudbase\Sdk\Model\ConvertAnonymousAccount200Response
```
...
$convert_anonymous_account_request = {"email":"user@example.com","password":"SecurePassword123!","firstName":"John","lastName":"Doe"}; // \Mudbase\Sdk\Model\ConvertAnonymousAccountRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **convert_anonymous_account_request** | [**\Mudbase\Sdk\Model\ConvertAnonymousAccountRequest**](../Model/ConvertAnonymousAccountRequest.md)|  | |

### Return type

[**\Mudbase\Sdk\Model\ConvertAnonymousAccount200Response**](../Model/ConvertAnonymousAccount200Response.md)
...
```php
createAnonymousSession($create_anonymous_session_request): \Mudbase\Sdk\Model\CreateAnonymousSession200Response
```
...
$create_anonymous_session_request = {"projectId":"685ad30be129932fbb7a1047","deviceId":"device-uuid-123"}; // \Mudbase\Sdk\Model\CreateAnonymousSessionRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **create_anonymous_session_request** | [**\Mudbase\Sdk\Model\CreateAnonymousSessionRequest**](../Model/CreateAnonymousSessionRequest.md)|  | [optional] |

### Return type

[**\Mudbase\Sdk\Model\CreateAnonymousSession200Response**](../Model/CreateAnonymousSession200Response.md)
...
```php
getAvailableOAuthProviders(): \Mudbase\Sdk\Model\GetAvailableOAuthProviders200Response
```
...
[**\Mudbase\Sdk\Model\GetAvailableOAuthProviders200Response**](../Model/GetAvailableOAuthProviders200Response.md)
...
```php
getCurrentSession(): \Mudbase\Sdk\Model\SessionResponse
```
...
[**\Mudbase\Sdk\Model\SessionResponse**](../Model/SessionResponse.md)
...
```php
getLocalSession($project_id): \Mudbase\Sdk\Model\GetLocalSession200Response
```
...
[**\Mudbase\Sdk\Model\GetLocalSession200Response**](../Model/GetLocalSession200Response.md)
...
```php
getOrgOAuthProviders(): \Mudbase\Sdk\Model\GetOrgOAuthProviders200Response
```
...
[**\Mudbase\Sdk\Model\GetOrgOAuthProviders200Response**](../Model/GetOrgOAuthProviders200Response.md)
...
```php
loginLocalUser($login_local_user_request): \Mudbase\Sdk\Model\LoginLocalUser200Response
```
...
$login_local_user_request = {"email":"sarah.chen@example.com","password":"SecurePass123!","projectId":"685ad30be129932fbb7a1047"}; // \Mudbase\Sdk\Model\LoginLocalUserRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **login_local_user_request** | [**\Mudbase\Sdk\Model\LoginLocalUserRequest**](../Model/LoginLocalUserRequest.md)|  | |

### Return type

[**\Mudbase\Sdk\Model\LoginLocalUser200Response**](../Model/LoginLocalUser200Response.md)
...
```php
loginUser($login_request): \Mudbase\Sdk\Model\AuthResponse
```
...
$login_request = {"email":"john.doe@mudbase.dev","password":"SecurePass123!"}; // \Mudbase\Sdk\Model\LoginRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **login_request** | [**\Mudbase\Sdk\Model\LoginRequest**](../Model/LoginRequest.md)|  | |

### Return type

[**\Mudbase\Sdk\Model\AuthResponse**](../Model/AuthResponse.md)
...
```php
logoutLocalUser(): \Mudbase\Sdk\Model\MessageResponse
```
...
```php
logoutUser(): \Mudbase\Sdk\Model\MessageResponse
```
...
```php
refreshToken($refresh_token_request): \Mudbase\Sdk\Model\RefreshToken200Response
```
...
$refresh_token_request = {"refreshToken":"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..."}; // \Mudbase\Sdk\Model\RefreshTokenRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **refresh_token_request** | [**\Mudbase\Sdk\Model\RefreshTokenRequest**](../Model/RefreshTokenRequest.md)|  | |

### Return type

[**\Mudbase\Sdk\Model\RefreshToken200Response**](../Model/RefreshToken200Response.md)
...
```php
registerLocalUser($register_local_user_request): \Mudbase\Sdk\Model\RegisterLocalUser201Response
```
...
$register_local_user_request = {"email":"sarah.chen@example.com","password":"SecurePass123!","firstName":"Sarah","lastName":"Chen","projectId":"685ad30be129932fbb7a1047"}; // \Mudbase\Sdk\Model\RegisterLocalUserRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **register_local_user_request** | [**\Mudbase\Sdk\Model\RegisterLocalUserRequest**](../Model/RegisterLocalUserRequest.md)|  | |

### Return type

[**\Mudbase\Sdk\Model\RegisterLocalUser201Response**](../Model/RegisterLocalUser201Response.md)
...
```php
registerUser($register_request): \Mudbase\Sdk\Model\AuthResponse
```
...
$register_request = {"email":"john.doe@mudbase.dev","password":"SecurePass123!","firstName":"John","lastName":"Doe","orgName":"Mudbase"}; // \Mudbase\Sdk\Model\RegisterRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **register_request** | [**\Mudbase\Sdk\Model\RegisterRequest**](../Model/RegisterRequest.md)|  | |
...
```php
requestLocalPasswordReset($request_local_password_reset_request): \Mudbase\Sdk\Model\MessageResponse
```
...
$request_local_password_reset_request = {"email":"user@example.com","projectId":"685ad30be129932fbb7a1047"}; // \Mudbase\Sdk\Model\RequestLocalPasswordResetRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **request_local_password_reset_request** | [**\Mudbase\Sdk\Model\RequestLocalPasswordResetRequest**](../Model/RequestLocalPasswordResetRequest.md)|  | |
...
```php
requestPasswordReset($request_password_reset_request): \Mudbase\Sdk\Model\MessageResponse
```
...
$request_password_reset_request = {"email":"john.doe@mudbase.dev"}; // \Mudbase\Sdk\Model\RequestPasswordResetRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **request_password_reset_request** | [**\Mudbase\Sdk\Model\RequestPasswordResetRequest**](../Model/RequestPasswordResetRequest.md)|  | |
...
```php
resendVerificationAuth($resend_verification_auth_request): \Mudbase\Sdk\Model\MessageResponse
```
...
$resend_verification_auth_request = {"email":"user@example.com"}; // \Mudbase\Sdk\Model\ResendVerificationAuthRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **resend_verification_auth_request** | [**\Mudbase\Sdk\Model\ResendVerificationAuthRequest**](../Model/ResendVerificationAuthRequest.md)|  | |
...
```php
resetLocalPassword($token, $reset_local_password_request): \Mudbase\Sdk\Model\MessageResponse
```
...
$reset_local_password_request = {"password":"NewSecurePass123!","projectId":"685ad30be129932fbb7a1047"}; // \Mudbase\Sdk\Model\ResetLocalPasswordRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **token** | **string**|  | |
| **reset_local_password_request** | [**\Mudbase\Sdk\Model\ResetLocalPasswordRequest**](../Model/ResetLocalPasswordRequest.md)|  | |
...
```php
resetPassword($token, $reset_password_request): \Mudbase\Sdk\Model\MessageResponse
```
...
$token = 'token_example'; // string
$reset_password_request = {"password":"NewSecurePass123!"}; // \Mudbase\Sdk\Model\ResetPasswordRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **token** | **string**|  | |
| **reset_password_request** | [**\Mudbase\Sdk\Model\ResetPasswordRequest**](../Model/ResetPasswordRequest.md)|  | |
...
```php
sendMagicLink($magic_link_request): \Mudbase\Sdk\Model\MessageResponse
```
...
$magic_link_request = {"email":"user@example.com","projectId":"685ad30be129932fbb7a1047","redirectUrl":"https://app.example.com/auth/callback"}; // \Mudbase\Sdk\Model\MagicLinkRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **magic_link_request** | [**\Mudbase\Sdk\Model\MagicLinkRequest**](../Model/MagicLinkRequest.md)|  | |
...
```php
sendOTP($otp_send_request): \Mudbase\Sdk\Model\MessageResponse
```
...
$otp_send_request = {"email":"user@example.com","projectId":"685ad30be129932fbb7a1047","method":"email"}; // \Mudbase\Sdk\Model\OTPSendRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **otp_send_request** | [**\Mudbase\Sdk\Model\OTPSendRequest**](../Model/OTPSendRequest.md)|  | |
...
```php
validatePasswordResetToken($validate_password_reset_token_request): \Mudbase\Sdk\Model\ValidatePasswordResetToken200Response
```
...
$validate_password_reset_token_request = {"token":"abc123..."}; // \Mudbase\Sdk\Model\ValidatePasswordResetTokenRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **validate_password_reset_token_request** | [**\Mudbase\Sdk\Model\ValidatePasswordResetTokenRequest**](../Model/ValidatePasswordResetTokenRequest.md)|  | |

### Return type

[**\Mudbase\Sdk\Model\ValidatePasswordResetToken200Response**](../Model/ValidatePasswordResetToken200Response.md)
...
```php
verifyEmailAuth($verify_email_auth_request): \Mudbase\Sdk\Model\MessageResponse
```
...
$verify_email_auth_request = {"token":"verification-token-from-email-link"}; // \Mudbase\Sdk\Model\VerifyEmailAuthRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **verify_email_auth_request** | [**\Mudbase\Sdk\Model\VerifyEmailAuthRequest**](../Model/VerifyEmailAuthRequest.md)|  | |
...
```php
verifyMagicLink($verify_magic_link_request): \Mudbase\Sdk\Model\AuthResponse
```
...
$verify_magic_link_request = {"token":"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6InVzZXJAZXhhbXBsZS5jb20iLCJwcm9qZWN0SWQiOiI2ODVhZDMwYmUxMjk5MzJmYmI3YTEwNDciLCJpYXQiOjE3NTA3ODA4OTgsImV4cCI6MTc1MDc4NDQ5OH0.example"}; // \Mudbase\Sdk\Model\VerifyMagicLinkRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **verify_magic_link_request** | [**\Mudbase\Sdk\Model\VerifyMagicLinkRequest**](../Model/VerifyMagicLinkRequest.md)|  | |
...
```php
verifyOTP($otp_verify_request): \Mudbase\Sdk\Model\AuthResponse
```
...
$otp_verify_request = {"identifier":"user@example.com","otp":"123456","projectId":"685ad30be129932fbb7a1047"}; // \Mudbase\Sdk\Model\OTPVerifyRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **otp_verify_request** | [**\Mudbase\Sdk\Model\OTPVerifyRequest**](../Model/OTPVerifyRequest.md)|  | |
