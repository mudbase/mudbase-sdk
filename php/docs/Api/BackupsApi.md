...
```php
createBackup($project_id, $create_backup_request): \Mudbase\Sdk\Model\CreateBackup201Response
```
...
$apiInstance = new Mudbase\Sdk\Api\BackupsApi(
...
$create_backup_request = {"description":"Pre-deployment backup","includeFiles":true,"includeWallets":false}; // \Mudbase\Sdk\Model\CreateBackupRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **project_id** | **string**|  | |
| **create_backup_request** | [**\Mudbase\Sdk\Model\CreateBackupRequest**](../Model/CreateBackupRequest.md)|  | [optional] |

### Return type

[**\Mudbase\Sdk\Model\CreateBackup201Response**](../Model/CreateBackup201Response.md)
...
```php
deleteBackup($project_id, $backup_id): \Mudbase\Sdk\Model\DeleteBackup200Response
```
...
[**\Mudbase\Sdk\Model\DeleteBackup200Response**](../Model/DeleteBackup200Response.md)
...
```php
listBackups($project_id): \Mudbase\Sdk\Model\ListBackups200Response
```
...
[**\Mudbase\Sdk\Model\ListBackups200Response**](../Model/ListBackups200Response.md)
...
```php
restoreBackup($project_id, $backup_id, $restore_backup_request): \Mudbase\Sdk\Model\RestoreBackup200Response
```
...
$project_id = 'project_id_example'; // string
$backup_id = 'backup_id_example'; // string
$restore_backup_request = {"restoreMode":"replace","collections":["products","orders"],"confirmation":"RESTORE_DATA"}; // \Mudbase\Sdk\Model\RestoreBackupRequest
...
| **project_id** | **string**|  | |
| **backup_id** | **string**|  | |
| **restore_backup_request** | [**\Mudbase\Sdk\Model\RestoreBackupRequest**](../Model/RestoreBackupRequest.md)|  | |

### Return type

[**\Mudbase\Sdk\Model\RestoreBackup200Response**](../Model/RestoreBackup200Response.md)
