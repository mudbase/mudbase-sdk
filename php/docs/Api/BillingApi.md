...
```php
cancelSubscription($subscription_id, $cancel_subscription_request): \Mudbase\Sdk\Model\DeleteRole200Response
```
...
$apiInstance = new Mudbase\Sdk\Api\BillingApi(
...
$cancel_subscription_request = {"cancelImmediately":false}; // \Mudbase\Sdk\Model\CancelSubscriptionRequest
...
| **cancel_subscription_request** | [**\Mudbase\Sdk\Model\CancelSubscriptionRequest**](../Model/CancelSubscriptionRequest.md)|  | [optional] |

### Return type

[**\Mudbase\Sdk\Model\DeleteRole200Response**](../Model/DeleteRole200Response.md)
...
```php
checkFeatureAccess($project_id, $email, $feature): \Mudbase\Sdk\Model\CheckFeatureAccess200Response
```
...
[**\Mudbase\Sdk\Model\CheckFeatureAccess200Response**](../Model/CheckFeatureAccess200Response.md)
...
```php
checkSubscription($project_id, $email): \Mudbase\Sdk\Model\CheckSubscription200Response
```
...
[**\Mudbase\Sdk\Model\CheckSubscription200Response**](../Model/CheckSubscription200Response.md)
...
```php
createCheckoutSession($project_id, $create_checkout_session_request): \Mudbase\Sdk\Model\CreateCheckoutSession200Response
```
...
$create_checkout_session_request = {"planId":"65a1b2c3d4e5f6789012345d","billingCycle":"monthly","customerInfo":{"email":"customer@example.com","name":"John Doe"},"successUrl":"https://app.example.com/success","cancelUrl":"https://app.example.com/cancel"}; // \Mudbase\Sdk\Model\CreateCheckoutSessionRequest
...
| **create_checkout_session_request** | [**\Mudbase\Sdk\Model\CreateCheckoutSessionRequest**](../Model/CreateCheckoutSessionRequest.md)|  | |

### Return type

[**\Mudbase\Sdk\Model\CreateCheckoutSession200Response**](../Model/CreateCheckoutSession200Response.md)
...
```php
createPlan($project_id, $create_plan_request): \Mudbase\Sdk\Model\CreatePlan201Response
```
...
$project_id = 'project_id_example'; // string
$create_plan_request = {"name":"Pro Plan","description":"Professional plan with advanced features","price":29.99,"currency":"USD","interval":"month","features":["Unlimited API calls","Priority support","Advanced analytics"]}; // \Mudbase\Sdk\Model\CreatePlanRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **project_id** | **string**|  | |
| **create_plan_request** | [**\Mudbase\Sdk\Model\CreatePlanRequest**](../Model/CreatePlanRequest.md)|  | |

### Return type

[**\Mudbase\Sdk\Model\CreatePlan201Response**](../Model/CreatePlan201Response.md)
...
```php
deletePlan($project_id, $plan_id): \Mudbase\Sdk\Model\MessageResponse
```
...
```php
enablePaymentProcessing($org_id, $enable_payment_processing_request): \Mudbase\Sdk\Model\EnablePaymentProcessing200Response
```
...
$enable_payment_processing_request = {"accountBank":"044","accountNumber":"0123456789","country":"US","businessName":"Acme Inc","businessMobile":"+1234567890"}; // \Mudbase\Sdk\Model\EnablePaymentProcessingRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **org_id** | **string**|  | |
| **enable_payment_processing_request** | [**\Mudbase\Sdk\Model\EnablePaymentProcessingRequest**](../Model/EnablePaymentProcessingRequest.md)|  | |

### Return type

[**\Mudbase\Sdk\Model\EnablePaymentProcessing200Response**](../Model/EnablePaymentProcessing200Response.md)
...
```php
exportInvoice($project_id, $invoice_id): \Mudbase\Sdk\Model\DownloadInvoice200Response
```
...
[**\Mudbase\Sdk\Model\DownloadInvoice200Response**](../Model/DownloadInvoice200Response.md)
...
```php
getBillingEstimate(): \Mudbase\Sdk\Model\GetBillingEstimate200Response
```
...
[**\Mudbase\Sdk\Model\GetBillingEstimate200Response**](../Model/GetBillingEstimate200Response.md)
...
```php
getDashboard($project_id): \Mudbase\Sdk\Model\GetDashboard200Response
```
...
[**\Mudbase\Sdk\Model\GetDashboard200Response**](../Model/GetDashboard200Response.md)
...
```php
getFeeBreakdown($org_id, $amount, $currency): \Mudbase\Sdk\Model\GetFeeBreakdown200Response
```
...
[**\Mudbase\Sdk\Model\GetFeeBreakdown200Response**](../Model/GetFeeBreakdown200Response.md)
...
```php
getInvoice($project_id, $invoice_id): \Mudbase\Sdk\Model\GetInvoice200Response
```
...
[**\Mudbase\Sdk\Model\GetInvoice200Response**](../Model/GetInvoice200Response.md)
...
```php
getInvoices($project_id): \Mudbase\Sdk\Model\GetInvoices200Response
```
...
[**\Mudbase\Sdk\Model\GetInvoices200Response**](../Model/GetInvoices200Response.md)
...
```php
getPaymentRecords($org_id, $page, $limit, $status): \Mudbase\Sdk\Model\GetPaymentRecords200Response
```
...
[**\Mudbase\Sdk\Model\GetPaymentRecords200Response**](../Model/GetPaymentRecords200Response.md)
...
```php
getPlans($project_id): \Mudbase\Sdk\Model\GetPlans200Response
```
...
[**\Mudbase\Sdk\Model\GetPlans200Response**](../Model/GetPlans200Response.md)
...
```php
getPublicPlans($project_id): \Mudbase\Sdk\Model\GetPublicPlans200Response
```
...
[**\Mudbase\Sdk\Model\GetPublicPlans200Response**](../Model/GetPublicPlans200Response.md)
...
```php
getSubscriptionTierById($plan_id): \Mudbase\Sdk\Model\GetSubscriptionTierById200Response
```
...
[**\Mudbase\Sdk\Model\GetSubscriptionTierById200Response**](../Model/GetSubscriptionTierById200Response.md)
...
```php
getSubscriptionTiers(): \Mudbase\Sdk\Model\GetSubscriptionTiers200Response
```
...
[**\Mudbase\Sdk\Model\GetSubscriptionTiers200Response**](../Model/GetSubscriptionTiers200Response.md)
...
```php
getSubscriptions($project_id): \Mudbase\Sdk\Model\GetSubscriptions200Response
```
...
[**\Mudbase\Sdk\Model\GetSubscriptions200Response**](../Model/GetSubscriptions200Response.md)
...
```php
handleFlutterwaveWebhook($handle_flutterwave_webhook_request): \Mudbase\Sdk\Model\HandleFlutterwaveWebhook200Response
```
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **handle_flutterwave_webhook_request** | [**\Mudbase\Sdk\Model\HandleFlutterwaveWebhookRequest**](../Model/HandleFlutterwaveWebhookRequest.md)|  | |

### Return type

[**\Mudbase\Sdk\Model\HandleFlutterwaveWebhook200Response**](../Model/HandleFlutterwaveWebhook200Response.md)
...
```php
initializeOrgPlanCheckout($initialize_org_plan_checkout_request): \Mudbase\Sdk\Model\InitializeOrgPlanCheckout200Response
```
...
$initialize_org_plan_checkout_request = {"planName":"starter","billingCycle":"monthly"}; // \Mudbase\Sdk\Model\InitializeOrgPlanCheckoutRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **initialize_org_plan_checkout_request** | [**\Mudbase\Sdk\Model\InitializeOrgPlanCheckoutRequest**](../Model/InitializeOrgPlanCheckoutRequest.md)|  | |

### Return type

[**\Mudbase\Sdk\Model\InitializeOrgPlanCheckout200Response**](../Model/InitializeOrgPlanCheckout200Response.md)
...
```php
initializePayment($org_id, $initialize_payment_request): \Mudbase\Sdk\Model\InitializePayment200Response
```
...
$org_id = 'org_id_example'; // string
$initialize_payment_request = {"amount":100,"currency":"USD","customer":{"email":"buyer@example.com","name":"Buyer Name"},"metadata":{"title":"Order #123","description":"Payment for order"}}; // \Mudbase\Sdk\Model\InitializePaymentRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **org_id** | **string**|  | |
| **initialize_payment_request** | [**\Mudbase\Sdk\Model\InitializePaymentRequest**](../Model/InitializePaymentRequest.md)|  | |

### Return type

[**\Mudbase\Sdk\Model\InitializePayment200Response**](../Model/InitializePayment200Response.md)
...
$project_id = 'project_id_example'; // string
$initialize_payment_for_project_request = {"amount":0.01,"customer":{"email":"email_example"}}; // \Mudbase\Sdk\Model\InitializePaymentForProjectRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **project_id** | **string**|  | |
| **initialize_payment_for_project_request** | [**\Mudbase\Sdk\Model\InitializePaymentForProjectRequest**](../Model/InitializePaymentForProjectRequest.md)|  | |
...
```php
recordUsage($project_id, $record_usage_request): \Mudbase\Sdk\Model\MessageResponse
```
...
$project_id = 'project_id_example'; // string
$record_usage_request = {"email":"customer@example.com","metric":"api_calls","quantity":150}; // \Mudbase\Sdk\Model\RecordUsageRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **project_id** | **string**|  | |
| **record_usage_request** | [**\Mudbase\Sdk\Model\RecordUsageRequest**](../Model/RecordUsageRequest.md)|  | |
...
```php
updatePlan($project_id, $plan_id, $update_plan_request): \Mudbase\Sdk\Model\CreatePlan201Response
```
...
$project_id = 'project_id_example'; // string
$plan_id = 'plan_id_example'; // string
$update_plan_request = {"name":"Pro Plan Updated","description":"Updated professional plan","price":39.99,"features":["Unlimited API calls","Priority support","Advanced analytics"]}; // \Mudbase\Sdk\Model\UpdatePlanRequest
...
| **project_id** | **string**|  | |
| **plan_id** | **string**|  | |
| **update_plan_request** | [**\Mudbase\Sdk\Model\UpdatePlanRequest**](../Model/UpdatePlanRequest.md)|  | |
...
```php
verifyOrgPlanPayment($tx_ref, $reference): \Mudbase\Sdk\Model\VerifyOrgPlanPayment200Response
```
...
[**\Mudbase\Sdk\Model\VerifyOrgPlanPayment200Response**](../Model/VerifyOrgPlanPayment200Response.md)
...
```php
verifyPayment($project_id, $reference): \Mudbase\Sdk\Model\VerifyPayment200Response
```
...
[**\Mudbase\Sdk\Model\VerifyPayment200Response**](../Model/VerifyPayment200Response.md)
