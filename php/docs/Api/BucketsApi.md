...
```php
createBucket($project_id, $create_bucket_request): \Mudbase\Sdk\Model\BucketResponse
```
...
$apiInstance = new Mudbase\Sdk\Api\BucketsApi(
...
$create_bucket_request = {"name":"my-bucket","isPublic":false,"settings":{}}; // \Mudbase\Sdk\Model\CreateBucketRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **project_id** | **string**|  | |
| **create_bucket_request** | [**\Mudbase\Sdk\Model\CreateBucketRequest**](../Model/CreateBucketRequest.md)|  | |

### Return type

[**\Mudbase\Sdk\Model\BucketResponse**](../Model/BucketResponse.md)
...
```php
deleteBucket($project_id, $bucket_id): \Mudbase\Sdk\Model\MessageResponse
```
...
```php
getBucket($project_id, $bucket_id): \Mudbase\Sdk\Model\BucketResponse
```
...
```php
listBuckets($project_id, $page, $limit, $search): \Mudbase\Sdk\Model\BucketListResponse
```
...
[**\Mudbase\Sdk\Model\BucketListResponse**](../Model/BucketListResponse.md)
...
```php
updateBucket($project_id, $bucket_id, $update_bucket_request): \Mudbase\Sdk\Model\BucketResponse
```
...
$project_id = 'project_id_example'; // string
$bucket_id = 'bucket_id_example'; // string
$update_bucket_request = {"name":"my-bucket-updated","isPublic":true,"settings":{}}; // \Mudbase\Sdk\Model\UpdateBucketRequest
...
| **project_id** | **string**|  | |
| **bucket_id** | **string**|  | |
| **update_bucket_request** | [**\Mudbase\Sdk\Model\UpdateBucketRequest**](../Model/UpdateBucketRequest.md)|  | |
