...
```php
apiGdprErasePost($api_gdpr_erase_post_request): \Mudbase\Sdk\Model\ApplyRoleFeaturePreset200Response
```
...
$apiInstance = new Mudbase\Sdk\Api\ComplianceApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client(),
    $config
);
$api_gdpr_erase_post_request = new \Mudbase\Sdk\Model\ApiGdprErasePostRequest(); // \Mudbase\Sdk\Model\ApiGdprErasePostRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **api_gdpr_erase_post_request** | [**\Mudbase\Sdk\Model\ApiGdprErasePostRequest**](../Model/ApiGdprErasePostRequest.md)|  | |
...
```php
generateAccessReview($generate_access_review_request): \Mudbase\Sdk\Model\GenerateAccessReview200Response
```
...
$generate_access_review_request = {"orgId":"685acbe0e129932fbb7a0fc3","reviewPeriod":{"start":"2024-10-01T00:00:00Z","end":"2024-12-31T23:59:59Z"}}; // \Mudbase\Sdk\Model\GenerateAccessReviewRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **generate_access_review_request** | [**\Mudbase\Sdk\Model\GenerateAccessReviewRequest**](../Model/GenerateAccessReviewRequest.md)|  | |

### Return type

[**\Mudbase\Sdk\Model\GenerateAccessReview200Response**](../Model/GenerateAccessReview200Response.md)
...
```php
generateDataProcessingRecord($generate_data_processing_record_request): \Mudbase\Sdk\Model\GenerateDataProcessingRecord200Response
```
...
$generate_data_processing_record_request = {"orgId":"685acbe0e129932fbb7a0fc3","recordDate":"2024-12-16T00:00:00Z"}; // \Mudbase\Sdk\Model\GenerateDataProcessingRecordRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **generate_data_processing_record_request** | [**\Mudbase\Sdk\Model\GenerateDataProcessingRecordRequest**](../Model/GenerateDataProcessingRecordRequest.md)|  | |

### Return type

[**\Mudbase\Sdk\Model\GenerateDataProcessingRecord200Response**](../Model/GenerateDataProcessingRecord200Response.md)
...
```php
getComplianceSummary(): \Mudbase\Sdk\Model\GetComplianceSummary200Response
```
...
[**\Mudbase\Sdk\Model\GetComplianceSummary200Response**](../Model/GetComplianceSummary200Response.md)
...
```php
logSecurityEvent($log_security_event_request): \Mudbase\Sdk\Model\LogSecurityEvent200Response
```
...
$log_security_event_request = {"eventType":"unauthorized_access_attempt","severity":"high","details":{"userId":"685acbe0e129932fbb7a0fc2","resource":"admin-panel","ipAddress":"192.168.1.100","action":"blocked","reason":"Insufficient permissions"}}; // \Mudbase\Sdk\Model\LogSecurityEventRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **log_security_event_request** | [**\Mudbase\Sdk\Model\LogSecurityEventRequest**](../Model/LogSecurityEventRequest.md)|  | |

### Return type

[**\Mudbase\Sdk\Model\LogSecurityEvent200Response**](../Model/LogSecurityEvent200Response.md)
