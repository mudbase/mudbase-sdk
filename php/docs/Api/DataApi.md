...
```php
createData($project_id, $collection_id, $body): \Mudbase\Sdk\Model\DataResponse
```
...
$apiInstance = new Mudbase\Sdk\Api\DataApi(
...
[**\Mudbase\Sdk\Model\DataResponse**](../Model/DataResponse.md)
...
```php
deleteData($project_id, $collection_id, $document_id): \Mudbase\Sdk\Model\MessageResponse
```
...
```php
getData($project_id, $collection_id, $document_id): \Mudbase\Sdk\Model\DataResponse
```
...
```php
listData($project_id, $collection_id, $page, $limit, $sort, $filter): \Mudbase\Sdk\Model\DataListResponse
```
...
[**\Mudbase\Sdk\Model\DataListResponse**](../Model/DataListResponse.md)
...
```php
updateData($project_id, $collection_id, $document_id, $body): \Mudbase\Sdk\Model\DataResponse
```
