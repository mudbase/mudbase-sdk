...
```php
enqueueProjectEmail($project_id, $project_email_send_request): \Mudbase\Sdk\Model\EnqueueProjectEmail202Response
```
...
$apiInstance = new Mudbase\Sdk\Api\EmailApi(
...
$project_email_send_request = {"template":"magicLink","to":"user@example.com","data":{"userName":"Alex","magicLinkUrl":"https://app.example.com/auth/verify?token=abc","expiresIn":"15 minutes"},"idempotencyKey":"proj123:magicLink:user@example.com"}; // \Mudbase\Sdk\Model\ProjectEmailSendRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **project_id** | **string**|  | |
| **project_email_send_request** | [**\Mudbase\Sdk\Model\ProjectEmailSendRequest**](../Model/ProjectEmailSendRequest.md)|  | |

### Return type

[**\Mudbase\Sdk\Model\EnqueueProjectEmail202Response**](../Model/EnqueueProjectEmail202Response.md)
...
```php
getProjectEmailAnalytics($project_id, $from, $to): \Mudbase\Sdk\Model\GetProjectEmailAnalytics200Response
```
...
[**\Mudbase\Sdk\Model\GetProjectEmailAnalytics200Response**](../Model/GetProjectEmailAnalytics200Response.md)
...
```php
getProjectEmailSmtp($project_id): \Mudbase\Sdk\Model\GetProjectEmailSmtp200Response
```
...
[**\Mudbase\Sdk\Model\GetProjectEmailSmtp200Response**](../Model/GetProjectEmailSmtp200Response.md)
...
```php
getProjectEmailTemplate($project_id, $name): \Mudbase\Sdk\Model\GetProjectEmailTemplate200Response
```
...
[**\Mudbase\Sdk\Model\GetProjectEmailTemplate200Response**](../Model/GetProjectEmailTemplate200Response.md)
...
```php
listProjectEmailTemplates($project_id): \Mudbase\Sdk\Model\ListProjectEmailTemplates200Response
```
...
[**\Mudbase\Sdk\Model\ListProjectEmailTemplates200Response**](../Model/ListProjectEmailTemplates200Response.md)
...
```php
patchProjectEmailSmtp($project_id, $project_smtp_patch_request): \Mudbase\Sdk\Model\GetProjectEmailSmtp200Response
```
...
$project_id = 'project_id_example'; // string
$project_smtp_patch_request = {"enabled":true,"host":"smtp.sendgrid.net","port":587,"secure":false,"authUser":"apikey","authPass":"SG.xxxx","fromName":"Acme App","fromEmail":"noreply@mail.example.com"}; // \Mudbase\Sdk\Model\ProjectSmtpPatchRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **project_id** | **string**|  | |
| **project_smtp_patch_request** | [**\Mudbase\Sdk\Model\ProjectSmtpPatchRequest**](../Model/ProjectSmtpPatchRequest.md)|  | |
...
$project_id = 'project_id_example'; // string
$name = 'name_example'; // string
$preview_project_email_template_request = {"sampleData":{}}; // \Mudbase\Sdk\Model\PreviewProjectEmailTemplateRequest
...
| **project_id** | **string**|  | |
| **name** | **string**|  | |
| **preview_project_email_template_request** | [**\Mudbase\Sdk\Model\PreviewProjectEmailTemplateRequest**](../Model/PreviewProjectEmailTemplateRequest.md)|  | [optional] |
...
```php
testProjectEmailSmtp($project_id, $project_smtp_test_request): \Mudbase\Sdk\Model\DeleteFunction200Response
```
...
$project_id = 'project_id_example'; // string
$project_smtp_test_request = {"to":"ops@example.com","useSaved":true}; // \Mudbase\Sdk\Model\ProjectSmtpTestRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **project_id** | **string**|  | |
| **project_smtp_test_request** | [**\Mudbase\Sdk\Model\ProjectSmtpTestRequest**](../Model/ProjectSmtpTestRequest.md)|  | |
...
$project_id = 'project_id_example'; // string
$name = 'name_example'; // string
$upsert_project_email_template_request = {"subject":"subject_example","htmlBody":"htmlBody_example"}; // \Mudbase\Sdk\Model\UpsertProjectEmailTemplateRequest
...
| **project_id** | **string**|  | |
| **name** | **string**|  | |
| **upsert_project_email_template_request** | [**\Mudbase\Sdk\Model\UpsertProjectEmailTemplateRequest**](../Model/UpsertProjectEmailTemplateRequest.md)|  | |
...
$project_id = 'project_id_example'; // string
$verify_project_email_smtp_domain_request = {"domain":"domain_example","fromEmail":"fromEmail_example","persist":true}; // \Mudbase\Sdk\Model\VerifyProjectEmailSmtpDomainRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **project_id** | **string**|  | |
| **verify_project_email_smtp_domain_request** | [**\Mudbase\Sdk\Model\VerifyProjectEmailSmtpDomainRequest**](../Model/VerifyProjectEmailSmtpDomainRequest.md)|  | [optional] |
