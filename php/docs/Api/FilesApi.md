...
```php
apiFilesDownloadFileIdGet($file_id, $expires_in): \Mudbase\Sdk\Model\ApiFilesDownloadFileIdGet200Response
```
...
$apiInstance = new Mudbase\Sdk\Api\FilesApi(
...
[**\Mudbase\Sdk\Model\ApiFilesDownloadFileIdGet200Response**](../Model/ApiFilesDownloadFileIdGet200Response.md)
...
```php
confirmDirectUpload($confirm_direct_upload_request): \Mudbase\Sdk\Model\ConfirmUploadResponse
```
...
$confirm_direct_upload_request = {"key":"65a1b2c3d4e5f6789012345a/default/abcd-1234-invoice.pdf","projectId":"65a1b2c3d4e5f6789012345a","originalName":"invoice.pdf","contentType":"application/pdf","size":52312,"isPublic":false}; // \Mudbase\Sdk\Model\ConfirmDirectUploadRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **confirm_direct_upload_request** | [**\Mudbase\Sdk\Model\ConfirmDirectUploadRequest**](../Model/ConfirmDirectUploadRequest.md)|  | |

### Return type

[**\Mudbase\Sdk\Model\ConfirmUploadResponse**](../Model/ConfirmUploadResponse.md)
...
```php
deleteFile($project_id, $bucket_id, $file_id): \Mudbase\Sdk\Model\MessageResponse
```
...
```php
downloadFile($file_id, $token): \Mudbase\Sdk\Model\SignedUrlResponse
```
...
[**\Mudbase\Sdk\Model\SignedUrlResponse**](../Model/SignedUrlResponse.md)
...
```php
generatePresignedUpload($generate_presigned_upload_request): \Mudbase\Sdk\Model\PresignedPostResponse
```
...
$generate_presigned_upload_request = {"projectId":"65a1b2c3d4e5f6789012345a","bucket":"default","originalName":"invoice.pdf","contentType":"application/pdf","isPublic":false}; // \Mudbase\Sdk\Model\GeneratePresignedUploadRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **generate_presigned_upload_request** | [**\Mudbase\Sdk\Model\GeneratePresignedUploadRequest**](../Model/GeneratePresignedUploadRequest.md)|  | |

### Return type

[**\Mudbase\Sdk\Model\PresignedPostResponse**](../Model/PresignedPostResponse.md)
...
```php
generateSignedUrl($project_id, $bucket_id, $file_id, $generate_signed_url_request): \Mudbase\Sdk\Model\SignedUrlResponse
```
...
$bucket_id = 'bucket_id_example'; // string
$file_id = 'file_id_example'; // string
$generate_signed_url_request = {"expiresIn":3600}; // \Mudbase\Sdk\Model\GenerateSignedUrlRequest
...
| **bucket_id** | **string**|  | |
| **file_id** | **string**|  | |
| **generate_signed_url_request** | [**\Mudbase\Sdk\Model\GenerateSignedUrlRequest**](../Model/GenerateSignedUrlRequest.md)|  | [optional] |
...
```php
getFile($project_id, $bucket_id, $file_id): \Mudbase\Sdk\Model\FileResponse
```
...
[**\Mudbase\Sdk\Model\FileResponse**](../Model/FileResponse.md)
...
```php
listFiles($project_id, $bucket_id, $page, $limit, $search, $type): \Mudbase\Sdk\Model\FileListResponse
```
...
[**\Mudbase\Sdk\Model\FileListResponse**](../Model/FileListResponse.md)
...
```php
uploadFiles($project_id, $bucket_id, $files): \Mudbase\Sdk\Model\FileUploadResponse
```
...
[**\Mudbase\Sdk\Model\FileUploadResponse**](../Model/FileUploadResponse.md)
