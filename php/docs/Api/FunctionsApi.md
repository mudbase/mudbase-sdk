...
```php
activateFunction($project_id, $function_id): \Mudbase\Sdk\Model\FunctionResponse
```
...
$apiInstance = new Mudbase\Sdk\Api\FunctionsApi(
...
[**\Mudbase\Sdk\Model\FunctionResponse**](../Model/FunctionResponse.md)
...
```php
createFunction($project_id, $create_function_request): \Mudbase\Sdk\Model\FunctionResponse
```
...
| ------------- | ------------- | ------------- | ------------- |
| **project_id** | **string**|  | |
| **create_function_request** | [**\Mudbase\Sdk\Model\CreateFunctionRequest**](../Model/CreateFunctionRequest.md)|  | |
...
```php
deactivateFunction($project_id, $function_id): \Mudbase\Sdk\Model\FunctionResponse
```
...
```php
deleteFunction($project_id, $function_id): \Mudbase\Sdk\Model\DeleteFunction200Response
```
...
```php
executeFunction($project_id, $function_id, $execute_function_request): \Mudbase\Sdk\Model\FunctionExecutionResponse
```
...
$project_id = 'project_id_example'; // string
$function_id = 'function_id_example'; // string
$execute_function_request = {"payload":{"userId":"685acbe0e129932fbb7a0fc2","action":"process"}}; // \Mudbase\Sdk\Model\ExecuteFunctionRequest
...
| **project_id** | **string**|  | |
| **function_id** | **string**|  | |
| **execute_function_request** | [**\Mudbase\Sdk\Model\ExecuteFunctionRequest**](../Model/ExecuteFunctionRequest.md)|  | [optional] |

### Return type

[**\Mudbase\Sdk\Model\FunctionExecutionResponse**](../Model/FunctionExecutionResponse.md)
...
```php
getFunction($project_id, $function_id): \Mudbase\Sdk\Model\FunctionResponse
```
...
```php
getFunctionExecution($project_id, $function_id, $execution_id): \Mudbase\Sdk\Model\FunctionExecutionStatusResponse
```
...
[**\Mudbase\Sdk\Model\FunctionExecutionStatusResponse**](../Model/FunctionExecutionStatusResponse.md)
...
```php
getFunctionLogs($project_id, $function_id, $limit, $offset): \Mudbase\Sdk\Model\FunctionLogsResponse
```
...
[**\Mudbase\Sdk\Model\FunctionLogsResponse**](../Model/FunctionLogsResponse.md)
...
```php
getFunctionVersions($project_id, $function_id): \Mudbase\Sdk\Model\GetFunctionVersions200Response
```
...
[**\Mudbase\Sdk\Model\GetFunctionVersions200Response**](../Model/GetFunctionVersions200Response.md)
...
```php
listFunctions($project_id, $page, $limit, $search, $trigger_type, $is_active): \Mudbase\Sdk\Model\FunctionListResponse
```
...
[**\Mudbase\Sdk\Model\FunctionListResponse**](../Model/FunctionListResponse.md)
...
```php
retryFunctionExecution($project_id, $function_id, $execution_index): \Mudbase\Sdk\Model\FunctionExecutionResponse
```
...
```php
rollbackFunction($project_id, $function_id, $rollback_function_request): \Mudbase\Sdk\Model\FunctionResponse
```
...
$project_id = 'project_id_example'; // string
$function_id = 'function_id_example'; // string
$rollback_function_request = {"version":2}; // \Mudbase\Sdk\Model\RollbackFunctionRequest
...
| **project_id** | **string**|  | |
| **function_id** | **string**|  | |
| **rollback_function_request** | [**\Mudbase\Sdk\Model\RollbackFunctionRequest**](../Model/RollbackFunctionRequest.md)|  | |
...
```php
simulateFunctionTrigger($project_id, $function_id, $simulate_function_trigger_request): \Mudbase\Sdk\Model\FunctionExecutionResponse
```
...
$project_id = 'project_id_example'; // string
$function_id = 'function_id_example'; // string
$simulate_function_trigger_request = {"trigger":{"type":"document","event":"create"},"eventContext":{"document":{"_id":"685ae1210136e73fa1dcaf36","collectionId":"685ada8fd9416ac02f171abf","data":{"name":"John","email":"john@example.com"}}}}; // \Mudbase\Sdk\Model\SimulateFunctionTriggerRequest
...
| **project_id** | **string**|  | |
| **function_id** | **string**|  | |
| **simulate_function_trigger_request** | [**\Mudbase\Sdk\Model\SimulateFunctionTriggerRequest**](../Model/SimulateFunctionTriggerRequest.md)|  | [optional] |
...
```php
triggerFunctionWebhook($project_id, $x_webhook_secret, $body): \Mudbase\Sdk\Model\TriggerFunctionWebhook200Response
```
...
[**\Mudbase\Sdk\Model\TriggerFunctionWebhook200Response**](../Model/TriggerFunctionWebhook200Response.md)
...
```php
updateFunction($project_id, $function_id, $update_function_request): \Mudbase\Sdk\Model\FunctionResponse
```
...
$project_id = 'project_id_example'; // string
$function_id = 'function_id_example'; // string
$update_function_request = {"name":"OnUserCreate v2","code":"return { version: 2 };\n","versionComment":"Add version tracking"}; // \Mudbase\Sdk\Model\UpdateFunctionRequest
...
| **project_id** | **string**|  | |
| **function_id** | **string**|  | |
| **update_function_request** | [**\Mudbase\Sdk\Model\UpdateFunctionRequest**](../Model/UpdateFunctionRequest.md)|  | [optional] |
