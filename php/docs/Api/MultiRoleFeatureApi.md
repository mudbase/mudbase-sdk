# Mudbase\Sdk\MultiRoleFeatureApi
...
```php
addCustomRole($project_id, $add_custom_role_request): \Mudbase\Sdk\Model\ApplyRoleFeaturePreset200Response
```
...
$apiInstance = new Mudbase\Sdk\Api\MultiRoleFeatureApi(
...
| ------------- | ------------- | ------------- | ------------- |
| **project_id** | **string**|  | |
| **add_custom_role_request** | [**\Mudbase\Sdk\Model\AddCustomRoleRequest**](../Model/AddCustomRoleRequest.md)|  | |
...
```php
applyRoleFeaturePreset($project_id, $role_slug, $apply_role_feature_preset_request): \Mudbase\Sdk\Model\ApplyRoleFeaturePreset200Response
```
...
$apply_role_feature_preset_request = {"preset":"admin"}; // \Mudbase\Sdk\Model\ApplyRoleFeaturePresetRequest
...
| **project_id** | **string**|  | |
| **role_slug** | **string**|  | |
| **apply_role_feature_preset_request** | [**\Mudbase\Sdk\Model\ApplyRoleFeaturePresetRequest**](../Model/ApplyRoleFeaturePresetRequest.md)|  | |
...
```php
getAvailableRoles($project_id): \Mudbase\Sdk\Model\GetAvailableRoles200Response
```
...
[**\Mudbase\Sdk\Model\GetAvailableRoles200Response**](../Model/GetAvailableRoles200Response.md)
...
```php
getMultiRoleConfig($project_id): \Mudbase\Sdk\Model\GetMultiRoleConfig200Response
```
...
[**\Mudbase\Sdk\Model\GetMultiRoleConfig200Response**](../Model/GetMultiRoleConfig200Response.md)
...
```php
getPermissionsMatrix($project_id): \Mudbase\Sdk\Model\GetPermissionsMatrix200Response
```
...
[**\Mudbase\Sdk\Model\GetPermissionsMatrix200Response**](../Model/GetPermissionsMatrix200Response.md)
...
| **register_with_role_request** | [**\Mudbase\Sdk\Model\RegisterWithRoleRequest**](../Model/RegisterWithRoleRequest.md)|  | |
...
```php
simulateAppPermissions($project_id, $simulate_app_permissions_request): \Mudbase\Sdk\Model\SimulateAppPermissions200Response
```
...
$project_id = 'project_id_example'; // string
$simulate_app_permissions_request = {"role":"customer","method":"POST","pathname":"/api/messaging/projects/685ad30be129932fbb7a1047/messaging/email"}; // \Mudbase\Sdk\Model\SimulateAppPermissionsRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **project_id** | **string**|  | |
| **simulate_app_permissions_request** | [**\Mudbase\Sdk\Model\SimulateAppPermissionsRequest**](../Model/SimulateAppPermissionsRequest.md)|  | |

### Return type

[**\Mudbase\Sdk\Model\SimulateAppPermissions200Response**](../Model/SimulateAppPermissions200Response.md)
...
```php
toggleRole($project_id, $role_slug, $toggle_role_request): \Mudbase\Sdk\Model\ApplyRoleFeaturePreset200Response
```
...
$toggle_role_request = {"isEnabled":true}; // \Mudbase\Sdk\Model\ToggleRoleRequest
...
| **toggle_role_request** | [**\Mudbase\Sdk\Model\ToggleRoleRequest**](../Model/ToggleRoleRequest.md)|  | |
...
```php
updateCollectionPermissions($project_id, $role_slug, $collection_id, $update_collection_permissions_request): \Mudbase\Sdk\Model\ApplyRoleFeaturePreset200Response
```
...
$update_collection_permissions_request = {"actions":["create","read","update","delete"],"conditions":{"status":"active"},"dataScope":"own"}; // \Mudbase\Sdk\Model\UpdateCollectionPermissionsRequest
...
| **update_collection_permissions_request** | [**\Mudbase\Sdk\Model\UpdateCollectionPermissionsRequest**](../Model/UpdateCollectionPermissionsRequest.md)|  | |
...
```php
updateMultiRoleSettings($project_id, $update_multi_role_settings_request): \Mudbase\Sdk\Model\UpdateMultiRoleSettings200Response
```
...
$project_id = 685ad30be129932fbb7a1047; // string
$update_multi_role_settings_request = {"isEnabled":true,"defaultRole":"customer","settings":{"allowMultipleRoles":false,"requireRoleSelection":false,"autoAssignDefault":true,"dataOwnerField":"createdBy"}}; // \Mudbase\Sdk\Model\UpdateMultiRoleSettingsRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **project_id** | **string**|  | |
| **update_multi_role_settings_request** | [**\Mudbase\Sdk\Model\UpdateMultiRoleSettingsRequest**](../Model/UpdateMultiRoleSettingsRequest.md)|  | |

### Return type

[**\Mudbase\Sdk\Model\UpdateMultiRoleSettings200Response**](../Model/UpdateMultiRoleSettings200Response.md)
...
```php
updateProjectRole($project_id, $role_slug, $update_project_role_request): \Mudbase\Sdk\Model\ApplyRoleFeaturePreset200Response
```
