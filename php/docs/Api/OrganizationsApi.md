...
```php
addOrgCustomDomain($org_id, $project_id, $add_org_domain_request): \Mudbase\Sdk\Model\OrgAddDomainResponse
```
...
$apiInstance = new Mudbase\Sdk\Api\OrganizationsApi(
...
$add_org_domain_request = {"hostname":"hostname_example"}; // \Mudbase\Sdk\Model\AddOrgDomainRequest
...
| **org_id** | **string**|  | |
| **project_id** | **string**|  | |
| **add_org_domain_request** | [**\Mudbase\Sdk\Model\AddOrgDomainRequest**](../Model/AddOrgDomainRequest.md)|  | |

### Return type

[**\Mudbase\Sdk\Model\OrgAddDomainResponse**](../Model/OrgAddDomainResponse.md)
...
$create_organization_request = {"name":"Mudbase Inc","description":"Main organization","logo":"https://example.com/logo.png","website":"https://mudbase.dev","parentOrgId":"685acbe0e129932fbb7a0fc3"}; // \Mudbase\Sdk\Model\CreateOrganizationRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **create_organization_request** | [**\Mudbase\Sdk\Model\CreateOrganizationRequest**](../Model/CreateOrganizationRequest.md)|  | |
...
```php
deleteOrganization($org_id): \Mudbase\Sdk\Model\DeleteOrganization200Response
```
...
[**\Mudbase\Sdk\Model\DeleteOrganization200Response**](../Model/DeleteOrganization200Response.md)
...
```php
deleteSubOrganization($org_id, $suborg_id): \Mudbase\Sdk\Model\DeleteSubOrganization200Response
```
...
[**\Mudbase\Sdk\Model\DeleteSubOrganization200Response**](../Model/DeleteSubOrganization200Response.md)
...
```php
getOrgCustomDomainDnsInstructions($org_id, $project_id, $hostname): \Mudbase\Sdk\Model\OrgDnsInstructionsResponse
```
...
[**\Mudbase\Sdk\Model\OrgDnsInstructionsResponse**](../Model/OrgDnsInstructionsResponse.md)
...
```php
getOrganization($org_id): \Mudbase\Sdk\Model\Organization
```
...
[**\Mudbase\Sdk\Model\Organization**](../Model/Organization.md)
...
```php
getOrganizationMembers($org_id): \Mudbase\Sdk\Model\GetOrganizationMembers200Response
```
...
[**\Mudbase\Sdk\Model\GetOrganizationMembers200Response**](../Model/GetOrganizationMembers200Response.md)
...
```php
getOrganizationUsage($org_id): \Mudbase\Sdk\Model\GetOrganizationUsage200Response
```
...
[**\Mudbase\Sdk\Model\GetOrganizationUsage200Response**](../Model/GetOrganizationUsage200Response.md)
...
```php
getOrganizationUsers($org_id, $status): \Mudbase\Sdk\Model\GetOrganizationUsers200Response
```
...
[**\Mudbase\Sdk\Model\GetOrganizationUsers200Response**](../Model/GetOrganizationUsers200Response.md)
...
```php
getProjectUsers($org_id, $project_id, $status): \Mudbase\Sdk\Model\GetProjectUsers200Response
```
...
[**\Mudbase\Sdk\Model\GetProjectUsers200Response**](../Model/GetProjectUsers200Response.md)
...
```php
getSubOrganizations($org_id): \Mudbase\Sdk\Model\GetSubOrganizations200Response
```
...
[**\Mudbase\Sdk\Model\GetSubOrganizations200Response**](../Model/GetSubOrganizations200Response.md)
...
```php
getUserOverview($org_id, $user_id): \Mudbase\Sdk\Model\GetUserOverview200Response
```
...
[**\Mudbase\Sdk\Model\GetUserOverview200Response**](../Model/GetUserOverview200Response.md)
...
$config = Mudbase\Sdk\Configuration::getDefaultConfiguration()->setApiKey('X-Internal-Api-Key', 'YOUR_API_KEY');
// Uncomment below to setup prefix (e.g. Bearer) for API key, if needed
// $config = Mudbase\Sdk\Configuration::getDefaultConfiguration()->setApiKeyPrefix('X-Internal-Api-Key', 'Bearer');
...
$internal_custom_domain_addon_request = {"orgId":"orgId_example","enabled":true}; // \Mudbase\Sdk\Model\InternalCustomDomainAddonRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **internal_custom_domain_addon_request** | [**\Mudbase\Sdk\Model\InternalCustomDomainAddonRequest**](../Model/InternalCustomDomainAddonRequest.md)|  | |
...
$internal_domain_dns_recheck_batch_request = {"maxOrgs":1,"recheckOlderThanHours":1}; // \Mudbase\Sdk\Model\InternalDomainDnsRecheckBatchRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **internal_domain_dns_recheck_batch_request** | [**\Mudbase\Sdk\Model\InternalDomainDnsRecheckBatchRequest**](../Model/InternalDomainDnsRecheckBatchRequest.md)|  | [optional] |
...
$provision_enterprise_request = {"orgId":"orgId_example","provisionRequestId":"provisionRequestId_example","apiBaseUrl":"apiBaseUrl_example","dbRef":"dbRef_example","serverId":"serverId_example"}; // \Mudbase\Sdk\Model\ProvisionEnterpriseRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **provision_enterprise_request** | [**\Mudbase\Sdk\Model\ProvisionEnterpriseRequest**](../Model/ProvisionEnterpriseRequest.md)|  | |
...
```php
inviteSubOrganizationMember($org_id, $suborg_id, $invite_member_request): \Mudbase\Sdk\Model\InviteSubOrganizationMember200Response
```
...
$org_id = 685acbe0e129932fbb7a0fc3; // string
$suborg_id = 685acbe0e129932fbb7a0fc4; // string
$invite_member_request = {"email":"user@suborg.example.com","role":"viewer"}; // \Mudbase\Sdk\Model\InviteMemberRequest
...
| **org_id** | **string**|  | |
| **suborg_id** | **string**|  | |
| **invite_member_request** | [**\Mudbase\Sdk\Model\InviteMemberRequest**](../Model/InviteMemberRequest.md)|  | |

### Return type

[**\Mudbase\Sdk\Model\InviteSubOrganizationMember200Response**](../Model/InviteSubOrganizationMember200Response.md)
...
```php
inviteTeamMember($org_id, $invite_member_request): \Mudbase\Sdk\Model\InviteTeamMember200Response
```
...
$org_id = 685acbe0e129932fbb7a0fc3; // string
$invite_member_request = {"email":"newuser@example.com","role":"member"}; // \Mudbase\Sdk\Model\InviteMemberRequest
...
[**\Mudbase\Sdk\Model\InviteTeamMember200Response**](../Model/InviteTeamMember200Response.md)
...
```php
listOrgCustomDomains($org_id, $project_id): \Mudbase\Sdk\Model\OrgDomainsListResponse
```
...
[**\Mudbase\Sdk\Model\OrgDomainsListResponse**](../Model/OrgDomainsListResponse.md)
...
```php
listOrganizations(): \Mudbase\Sdk\Model\ListOrganizations200Response
```
...
[**\Mudbase\Sdk\Model\ListOrganizations200Response**](../Model/ListOrganizations200Response.md)
...
$project_id = 'project_id_example'; // string
$hostname = 'hostname_example'; // string
$org_custom_domain_platform_ready_request = {"note":"note_example"}; // \Mudbase\Sdk\Model\OrgCustomDomainPlatformReadyRequest
...
| **project_id** | **string**|  | |
| **hostname** | **string**|  | |
| **org_custom_domain_platform_ready_request** | [**\Mudbase\Sdk\Model\OrgCustomDomainPlatformReadyRequest**](../Model/OrgCustomDomainPlatformReadyRequest.md)|  | [optional] |
...
```php
orgCustomDomainSubmitCname($org_id, $project_id, $hostname): \Mudbase\Sdk\Model\OrgPatchDomainResponse
```
...
[**\Mudbase\Sdk\Model\OrgPatchDomainResponse**](../Model/OrgPatchDomainResponse.md)
...
```php
orgCustomDomainSubmitPlatformDnsVerificationDeprecated($org_id, $project_id, $hostname): \Mudbase\Sdk\Model\OrgPatchDomainResponse
```
...
```php
orgCustomDomainVerifyPlatformDns($org_id, $project_id, $hostname): \Mudbase\Sdk\Model\OrgPatchDomainResponse
```
...
```php
patchOrgCustomDomain($org_id, $project_id, $hostname, $patch_org_domain_request): \Mudbase\Sdk\Model\OrgPatchDomainResponse
```
...
$project_id = 'project_id_example'; // string
$hostname = 'hostname_example'; // string
$patch_org_domain_request = {"status":"pending","regenerateToken":true}; // \Mudbase\Sdk\Model\PatchOrgDomainRequest
...
| **project_id** | **string**|  | |
| **hostname** | **string**|  | |
| **patch_org_domain_request** | [**\Mudbase\Sdk\Model\PatchOrgDomainRequest**](../Model/PatchOrgDomainRequest.md)|  | [optional] |
...
```php
removeSubOrganizationMember($org_id, $suborg_id, $user_id): \Mudbase\Sdk\Model\RemoveTeamMember200Response
```
...
[**\Mudbase\Sdk\Model\RemoveTeamMember200Response**](../Model/RemoveTeamMember200Response.md)
...
```php
removeTeamMember($org_id, $user_id): \Mudbase\Sdk\Model\RemoveTeamMember200Response
```
...
$org_id = 'org_id_example'; // string
$project_id = 'project_id_example'; // string
$set_org_primary_domain_request = {"hostname":"hostname_example"}; // \Mudbase\Sdk\Model\SetOrgPrimaryDomainRequest
...
| **org_id** | **string**|  | |
| **project_id** | **string**|  | |
| **set_org_primary_domain_request** | [**\Mudbase\Sdk\Model\SetOrgPrimaryDomainRequest**](../Model/SetOrgPrimaryDomainRequest.md)|  | |
...
```php
updateMemberRole($org_id, $user_id, $update_member_role_request): \Mudbase\Sdk\Model\UpdateMemberRole200Response
```
...
$org_id = 685acbe0e129932fbb7a0fc3; // string
$user_id = 685acbe0e129932fbb7a0fc2; // string
$update_member_role_request = {"role":"admin"}; // \Mudbase\Sdk\Model\UpdateMemberRoleRequest
...
| **org_id** | **string**|  | |
| **user_id** | **string**|  | |
| **update_member_role_request** | [**\Mudbase\Sdk\Model\UpdateMemberRoleRequest**](../Model/UpdateMemberRoleRequest.md)|  | |

### Return type

[**\Mudbase\Sdk\Model\UpdateMemberRole200Response**](../Model/UpdateMemberRole200Response.md)
...
```php
updateOrganization($org_id, $update_organization_request): \Mudbase\Sdk\Model\UpdateOrganization200Response
```
...
$org_id = 685acbe0e129932fbb7a0fc3; // string
$update_organization_request = {"name":"Mudbase Inc Updated","description":"Updated organization description","logo":"https://example.com/new-logo.png","website":"https://mudbase.dev"}; // \Mudbase\Sdk\Model\UpdateOrganizationRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **org_id** | **string**|  | |
| **update_organization_request** | [**\Mudbase\Sdk\Model\UpdateOrganizationRequest**](../Model/UpdateOrganizationRequest.md)|  | |

### Return type

[**\Mudbase\Sdk\Model\UpdateOrganization200Response**](../Model/UpdateOrganization200Response.md)
...
```php
updateOrganizationPlan($org_id, $update_organization_plan_request): \Mudbase\Sdk\Model\UpdateOrganizationPlan200Response
```
...
$org_id = 685acbe0e129932fbb7a0fc3; // string
$update_organization_plan_request = {"plan":"pro"}; // \Mudbase\Sdk\Model\UpdateOrganizationPlanRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **org_id** | **string**|  | |
| **update_organization_plan_request** | [**\Mudbase\Sdk\Model\UpdateOrganizationPlanRequest**](../Model/UpdateOrganizationPlanRequest.md)|  | |

### Return type

[**\Mudbase\Sdk\Model\UpdateOrganizationPlan200Response**](../Model/UpdateOrganizationPlan200Response.md)
...
```php
updateSubOrganization($org_id, $suborg_id, $update_organization_request): \Mudbase\Sdk\Model\UpdateSubOrganization200Response
```
...
$org_id = 685acbe0e129932fbb7a0fc3; // string
$suborg_id = 685acbe0e129932fbb7a0fc4; // string
$update_organization_request = {"name":"Sub-Organization Updated","description":"Updated sub-organization description","logo":"https://example.com/sub-logo.png","website":"https://sub.mudbase.dev"}; // \Mudbase\Sdk\Model\UpdateOrganizationRequest
...
[**\Mudbase\Sdk\Model\UpdateSubOrganization200Response**](../Model/UpdateSubOrganization200Response.md)
...
```php
updateSubOrganizationMemberRole($org_id, $suborg_id, $user_id, $update_member_role_request): \Mudbase\Sdk\Model\UpdateMemberRole200Response
```
...
```php
updateUserAccountStatus($org_id, $user_id, $update_user_account_status_request): \Mudbase\Sdk\Model\UpdateUserAccountStatus200Response
```
...
$org_id = 'org_id_example'; // string
$user_id = 'user_id_example'; // string
$update_user_account_status_request = {"accountStatus":"active"}; // \Mudbase\Sdk\Model\UpdateUserAccountStatusRequest
...
| **org_id** | **string**|  | |
| **user_id** | **string**|  | |
| **update_user_account_status_request** | [**\Mudbase\Sdk\Model\UpdateUserAccountStatusRequest**](../Model/UpdateUserAccountStatusRequest.md)|  | |

### Return type

[**\Mudbase\Sdk\Model\UpdateUserAccountStatus200Response**](../Model/UpdateUserAccountStatus200Response.md)
...
```php
verifyOrgCustomDomainDns($org_id, $project_id, $hostname): \Mudbase\Sdk\Model\OrgVerifyCustomDomainDnsSuccessResponse
```
...
[**\Mudbase\Sdk\Model\OrgVerifyCustomDomainDnsSuccessResponse**](../Model/OrgVerifyCustomDomainDnsSuccessResponse.md)
