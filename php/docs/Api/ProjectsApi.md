...
```php
configureOAuthProvider($project_id, $provider, $configure_o_auth_provider_request): \Mudbase\Sdk\Model\ConfigureOAuthProvider200Response
```
...
$apiInstance = new Mudbase\Sdk\Api\ProjectsApi(
...
$configure_o_auth_provider_request = {"enabled":true,"clientId":"123456789-abcdefghijklmnop.apps.googleusercontent.com","clientSecret":"GOCSPX-abcdefghijklmnopqrstuvwxyz","scope":["profile","email"],"displayName":"Sign in with Google"}; // \Mudbase\Sdk\Model\ConfigureOAuthProviderRequest
...
| **project_id** | **string**|  | |
| **provider** | **string**|  | |
| **configure_o_auth_provider_request** | [**\Mudbase\Sdk\Model\ConfigureOAuthProviderRequest**](../Model/ConfigureOAuthProviderRequest.md)|  | |

### Return type

[**\Mudbase\Sdk\Model\ConfigureOAuthProvider200Response**](../Model/ConfigureOAuthProvider200Response.md)
...
```php
createProject($org_id, $create_project_request): \Mudbase\Sdk\Model\CreateProject201Response
```
...
$create_project_request = {"name":"My New Project","description":"A new project description","orgId":"685acbe0e129932fbb7a0fc3"}; // \Mudbase\Sdk\Model\CreateProjectRequest
...
| **create_project_request** | [**\Mudbase\Sdk\Model\CreateProjectRequest**](../Model/CreateProjectRequest.md)|  | |

### Return type

[**\Mudbase\Sdk\Model\CreateProject201Response**](../Model/CreateProject201Response.md)
...
```php
deleteProject($org_id, $id): \Mudbase\Sdk\Model\MessageResponse
```
...
```php
getOAuthProviderConfig($project_id, $provider): \Mudbase\Sdk\Model\GetOAuthProviderConfig200Response
```
...
[**\Mudbase\Sdk\Model\GetOAuthProviderConfig200Response**](../Model/GetOAuthProviderConfig200Response.md)
...
```php
getProject($org_id, $id): \Mudbase\Sdk\Model\Project
```
...
[**\Mudbase\Sdk\Model\Project**](../Model/Project.md)
...
```php
getProjectCaptchaConfig($org_id, $id): \Mudbase\Sdk\Model\GetProjectCaptchaConfig200Response
```
...
[**\Mudbase\Sdk\Model\GetProjectCaptchaConfig200Response**](../Model/GetProjectCaptchaConfig200Response.md)
...
```php
getProjectDashboardOverview($project_id): \Mudbase\Sdk\Model\ProjectDashboardOverviewResponse
```
...
[**\Mudbase\Sdk\Model\ProjectDashboardOverviewResponse**](../Model/ProjectDashboardOverviewResponse.md)
...
```php
getProjectOAuthProviders($project_id): \Mudbase\Sdk\Model\GetProjectOAuthProviders200Response
```
...
[**\Mudbase\Sdk\Model\GetProjectOAuthProviders200Response**](../Model/GetProjectOAuthProviders200Response.md)
...
```php
getProjectUsage($org_id, $id): \Mudbase\Sdk\Model\ProjectUsageResponse
```
...
[**\Mudbase\Sdk\Model\ProjectUsageResponse**](../Model/ProjectUsageResponse.md)
...
```php
listProjects($org_id): \Mudbase\Sdk\Model\ListProjects200Response
```
...
[**\Mudbase\Sdk\Model\ListProjects200Response**](../Model/ListProjects200Response.md)
...
```php
updateOAuthProviderConfig($project_id, $provider, $update_o_auth_provider_config_request): \Mudbase\Sdk\Model\ConfigureOAuthProvider200Response
```
...
$project_id = 685ad30be129932fbb7a1047; // string
$provider = google; // string
$update_o_auth_provider_config_request = {"enabled":true,"clientId":"123456789-abcdefghijklmnop.apps.googleusercontent.com","clientSecret":"GOCSPX-abcdefghijklmnopqrstuvwxyz","scope":["profile","email"],"displayName":"Sign in with Google"}; // \Mudbase\Sdk\Model\UpdateOAuthProviderConfigRequest
...
| **project_id** | **string**|  | |
| **provider** | **string**|  | |
| **update_o_auth_provider_config_request** | [**\Mudbase\Sdk\Model\UpdateOAuthProviderConfigRequest**](../Model/UpdateOAuthProviderConfigRequest.md)|  | |
...
```php
updateProject($org_id, $id, $update_project_request): \Mudbase\Sdk\Model\CreateProject201Response
```
...
$org_id = 'org_id_example'; // string | Organization ID
$id = 'id_example'; // string | Project ID
$update_project_request = {"name":"Updated Project Name","description":"Updated project description","settings":{"requireEmailVerification":true,"requirePhoneVerification":false,"defaultUserAccountStatus":"active"}}; // \Mudbase\Sdk\Model\UpdateProjectRequest
...
| **org_id** | **string**| Organization ID | |
| **id** | **string**| Project ID | |
| **update_project_request** | [**\Mudbase\Sdk\Model\UpdateProjectRequest**](../Model/UpdateProjectRequest.md)|  | |
...
```php
uploadProjectLogo($id, $logo): \Mudbase\Sdk\Model\UploadProjectLogo200Response
```
...
[**\Mudbase\Sdk\Model\UploadProjectLogo200Response**](../Model/UploadProjectLogo200Response.md)
...
```php
uploadProjectLogoByOrg($org_id, $id, $logo): \Mudbase\Sdk\Model\UploadProjectLogo200Response
```
