...
```php
assignRole($org_id, $user_id, $assign_role_request): \Mudbase\Sdk\Model\AssignRole200Response
```
...
$apiInstance = new Mudbase\Sdk\Api\RolesApi(
...
$assign_role_request = {"roleSlug":"support_agent"}; // \Mudbase\Sdk\Model\AssignRoleRequest
...
| **org_id** | **string**|  | |
| **user_id** | **string**|  | |
| **assign_role_request** | [**\Mudbase\Sdk\Model\AssignRoleRequest**](../Model/AssignRoleRequest.md)|  | |

### Return type

[**\Mudbase\Sdk\Model\AssignRole200Response**](../Model/AssignRole200Response.md)
...
```php
checkPermissions($org_id, $user_id): \Mudbase\Sdk\Model\CheckPermissions200Response
```
...
[**\Mudbase\Sdk\Model\CheckPermissions200Response**](../Model/CheckPermissions200Response.md)
...
```php
createRole($org_id, $create_role_request): \Mudbase\Sdk\Model\CreateRole201Response
```
...
$org_id = 685acbe0e129932fbb7a0fc3; // string
$create_role_request = {"name":"Support Agent","description":"Customer support team member","hierarchy":40,"collectionPermissions":{"users":["create","read","update"],"products":["read"],"orders":{"actions":["create","read"],"conditions":{"status":"active"}}}}; // \Mudbase\Sdk\Model\CreateRoleRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **org_id** | **string**|  | |
| **create_role_request** | [**\Mudbase\Sdk\Model\CreateRoleRequest**](../Model/CreateRoleRequest.md)|  | |

### Return type

[**\Mudbase\Sdk\Model\CreateRole201Response**](../Model/CreateRole201Response.md)
...
```php
deleteRole($org_id, $role_id): \Mudbase\Sdk\Model\DeleteRole200Response
```
...
```php
getRole($org_id, $role_id): \Mudbase\Sdk\Model\GetRole200Response
```
...
[**\Mudbase\Sdk\Model\GetRole200Response**](../Model/GetRole200Response.md)
...
```php
getUsersByRole($org_id, $role_slug): \Mudbase\Sdk\Model\GetUsersByRole200Response
```
...
[**\Mudbase\Sdk\Model\GetUsersByRole200Response**](../Model/GetUsersByRole200Response.md)
...
```php
listRoles($org_id): \Mudbase\Sdk\Model\ListRoles200Response
```
...
[**\Mudbase\Sdk\Model\ListRoles200Response**](../Model/ListRoles200Response.md)
...
```php
removeRole($org_id, $user_id): \Mudbase\Sdk\Model\AssignRole200Response
```
...
```php
updateRole($org_id, $role_id, $update_role_request): \Mudbase\Sdk\Model\UpdateRole200Response
```
...
$org_id = 685acbe0e129932fbb7a0fc3; // string
$role_id = role123; // string
$update_role_request = {"name":"Support Agent","description":"Customer support team member with enhanced permissions","hierarchy":45,"isActive":true,"permissions":[{"resource":"data","actions":["read","update","delete"],"conditions":{"collection":["orders","customers","tickets"]}}]}; // \Mudbase\Sdk\Model\UpdateRoleRequest
...
| **org_id** | **string**|  | |
| **role_id** | **string**|  | |
| **update_role_request** | [**\Mudbase\Sdk\Model\UpdateRoleRequest**](../Model/UpdateRoleRequest.md)|  | |

### Return type

[**\Mudbase\Sdk\Model\UpdateRole200Response**](../Model/UpdateRole200Response.md)
