...
```php
getSearchAnalytics($project_id, $timeframe): \Mudbase\Sdk\Model\GetSearchAnalytics200Response
```
...
$apiInstance = new Mudbase\Sdk\Api\SearchApi(
...
[**\Mudbase\Sdk\Model\GetSearchAnalytics200Response**](../Model/GetSearchAnalytics200Response.md)
...
```php
getSearchSuggestions($project_id, $q, $limit): \Mudbase\Sdk\Model\GetSearchSuggestions200Response
```
...
[**\Mudbase\Sdk\Model\GetSearchSuggestions200Response**](../Model/GetSearchSuggestions200Response.md)
...
```php
searchData($project_id, $q, $collections, $fields, $limit, $page): \Mudbase\Sdk\Model\SearchResponse
```
...
[**\Mudbase\Sdk\Model\SearchResponse**](../Model/SearchResponse.md)
