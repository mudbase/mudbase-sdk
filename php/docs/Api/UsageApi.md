...
```php
getOverage(): \Mudbase\Sdk\Model\GetOverage200Response
```
...
$apiInstance = new Mudbase\Sdk\Api\UsageApi(
...
[**\Mudbase\Sdk\Model\GetOverage200Response**](../Model/GetOverage200Response.md)
...
```php
getProjectUsageStats($project_id, $period): \Mudbase\Sdk\Model\ProjectUsageStatsResponse
```
...
[**\Mudbase\Sdk\Model\ProjectUsageStatsResponse**](../Model/ProjectUsageStatsResponse.md)
...
```php
getProjectUsageSummary($project_id): \Mudbase\Sdk\Model\ProjectUsageSummaryResponse
```
...
[**\Mudbase\Sdk\Model\ProjectUsageSummaryResponse**](../Model/ProjectUsageSummaryResponse.md)
...
```php
getUsage($period, $start_date, $end_date): \Mudbase\Sdk\Model\UsageStatsResponse
```
...
[**\Mudbase\Sdk\Model\UsageStatsResponse**](../Model/UsageStatsResponse.md)
...
```php
getUsageTrends($days): \Mudbase\Sdk\Model\UsageTrendsResponse
```
...
[**\Mudbase\Sdk\Model\UsageTrendsResponse**](../Model/UsageTrendsResponse.md)
...
```php
getUsageWarnings(): \Mudbase\Sdk\Model\GetUsageWarnings200Response
```
...
[**\Mudbase\Sdk\Model\GetUsageWarnings200Response**](../Model/GetUsageWarnings200Response.md)
