...
```php
apiMeBootstrapGet(): \Mudbase\Sdk\Model\ApiMeBootstrapGet200Response
```
...
$apiInstance = new Mudbase\Sdk\Api\UsersApi(
...
[**\Mudbase\Sdk\Model\ApiMeBootstrapGet200Response**](../Model/ApiMeBootstrapGet200Response.md)
...
```php
changePassword($change_password_request): \Mudbase\Sdk\Model\MessageResponse
```
...
$change_password_request = {"currentPassword":"OldPassword123!","newPassword":"NewSecurePass123!"}; // \Mudbase\Sdk\Model\ChangePasswordRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **change_password_request** | [**\Mudbase\Sdk\Model\ChangePasswordRequest**](../Model/ChangePasswordRequest.md)|  | |
...
```php
disable2FA($disable2_fa_request): \Mudbase\Sdk\Model\MessageResponse
```
...
$disable2_fa_request = {"password":"SecurePass123!","token":"123456"}; // \Mudbase\Sdk\Model\Disable2FARequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **disable2_fa_request** | [**\Mudbase\Sdk\Model\Disable2FARequest**](../Model/Disable2FARequest.md)|  | |
...
```php
eraseUserData($erase_user_data_request): \Mudbase\Sdk\Model\EraseUserData200Response
```
...
$erase_user_data_request = {"confirm":"DELETE","currentPassword":"CurrentPassword123!"}; // \Mudbase\Sdk\Model\EraseUserDataRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **erase_user_data_request** | [**\Mudbase\Sdk\Model\EraseUserDataRequest**](../Model/EraseUserDataRequest.md)|  | |

### Return type

[**\Mudbase\Sdk\Model\EraseUserData200Response**](../Model/EraseUserData200Response.md)
...
```php
exportUserData(): \Mudbase\Sdk\Model\ExportUserData200Response
```
...
[**\Mudbase\Sdk\Model\ExportUserData200Response**](../Model/ExportUserData200Response.md)
...
```php
getCurrentUser(): \Mudbase\Sdk\Model\GetCurrentUser200Response
```
...
[**\Mudbase\Sdk\Model\GetCurrentUser200Response**](../Model/GetCurrentUser200Response.md)
...
```php
listOAuthProviders(): \Mudbase\Sdk\Model\ListOAuthProviders200Response
```
...
[**\Mudbase\Sdk\Model\ListOAuthProviders200Response**](../Model/ListOAuthProviders200Response.md)
...
```php
resendVerificationEmail(): \Mudbase\Sdk\Model\MessageResponse
```
...
```php
setup2FA(): \Mudbase\Sdk\Model\TwoFASetupResponse
```
...
[**\Mudbase\Sdk\Model\TwoFASetupResponse**](../Model/TwoFASetupResponse.md)
...
```php
unlinkOAuthProvider($provider): \Mudbase\Sdk\Model\UnlinkOAuthProvider200Response
```
...
[**\Mudbase\Sdk\Model\UnlinkOAuthProvider200Response**](../Model/UnlinkOAuthProvider200Response.md)
...
```php
updateUserProfile($update_user_request): \Mudbase\Sdk\Model\UpdateUserProfile200Response
```
...
$update_user_request = {"firstName":"John","lastName":"Doe","avatar":"https://example.com/avatar.jpg"}; // \Mudbase\Sdk\Model\UpdateUserRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **update_user_request** | [**\Mudbase\Sdk\Model\UpdateUserRequest**](../Model/UpdateUserRequest.md)|  | |

### Return type

[**\Mudbase\Sdk\Model\UpdateUserProfile200Response**](../Model/UpdateUserProfile200Response.md)
...
```php
verify2FA($verify2_fa_request): \Mudbase\Sdk\Model\MessageResponse
```
...
$verify2_fa_request = {"token":"123456"}; // \Mudbase\Sdk\Model\Verify2FARequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **verify2_fa_request** | [**\Mudbase\Sdk\Model\Verify2FARequest**](../Model/Verify2FARequest.md)|  | |
...
```php
verifyEmail($verify_email_auth_request): \Mudbase\Sdk\Model\MessageResponse
```
...
$verify_email_auth_request = {"token":"a1b2c3d4..."}; // \Mudbase\Sdk\Model\VerifyEmailAuthRequest
