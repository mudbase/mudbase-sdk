# Mudbase\Sdk\VerifiedRoleUpgradeApi
...
```php
verifiedRoleUpgrade($org_id, $user_id, $verified_role_upgrade_request): \Mudbase\Sdk\Model\VerifiedRoleUpgrade200Response
```
...
$apiInstance = new Mudbase\Sdk\Api\VerifiedRoleUpgradeApi(
...
$verified_role_upgrade_request = {"targetRole":"seller","paymentIntentId":"pi_abc123","verificationId":"kyc_xyz789"}; // \Mudbase\Sdk\Model\VerifiedRoleUpgradeRequest
...
| **org_id** | **string**|  | |
| **user_id** | **string**|  | |
| **verified_role_upgrade_request** | [**\Mudbase\Sdk\Model\VerifiedRoleUpgradeRequest**](../Model/VerifiedRoleUpgradeRequest.md)|  | |

### Return type

[**\Mudbase\Sdk\Model\VerifiedRoleUpgrade200Response**](../Model/VerifiedRoleUpgrade200Response.md)
