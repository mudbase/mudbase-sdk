...
```php
broadcastNonCustodialTransaction($broadcast_non_custodial_transaction_request): \Mudbase\Sdk\Model\BroadcastNonCustodialTransaction200Response
```
...
| ------------- | ------------- | ------------- | ------------- |
| **broadcast_non_custodial_transaction_request** | [**\Mudbase\Sdk\Model\BroadcastNonCustodialTransactionRequest**](../Model/BroadcastNonCustodialTransactionRequest.md)|  | |

### Return type

[**\Mudbase\Sdk\Model\BroadcastNonCustodialTransaction200Response**](../Model/BroadcastNonCustodialTransaction200Response.md)
...
```php
calculateWalletFee($estimate_network_fee_request, $fresh): \Mudbase\Sdk\Model\CalculateWalletFee200Response
```
...
$estimate_network_fee_request = {"currency":"BTC","amount":0.01}; // \Mudbase\Sdk\Model\EstimateNetworkFeeRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **estimate_network_fee_request** | [**\Mudbase\Sdk\Model\EstimateNetworkFeeRequest**](../Model/EstimateNetworkFeeRequest.md)|  | |
| **fresh** | **string**| Bypass cache and fetch current fee (use right before building tx for broadcast) | [optional] |

### Return type

[**\Mudbase\Sdk\Model\CalculateWalletFee200Response**](../Model/CalculateWalletFee200Response.md)
...
```php
createWallet($create_wallet_request): \Mudbase\Sdk\Model\CreateWallet201Response
```
...
$create_wallet_request = {"currency":"CELO","projectId":"6954562e2be74c6233ee53b9","label":"Main Wallet"}; // \Mudbase\Sdk\Model\CreateWalletRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **create_wallet_request** | [**\Mudbase\Sdk\Model\CreateWalletRequest**](../Model/CreateWalletRequest.md)|  | |

### Return type

[**\Mudbase\Sdk\Model\CreateWallet201Response**](../Model/CreateWallet201Response.md)
...
```php
createWalletWebhook($create_wallet_webhook_request): \Mudbase\Sdk\Model\CreateWalletWebhook201Response
```
...
$create_wallet_webhook_request = {"url":"https://your-app.com/webhooks/wallet","events":["wallet.balance.updated","wallet.transaction.confirmed","wallet.transaction.failed"],"secret":"whsec_abc123xyz789"}; // \Mudbase\Sdk\Model\CreateWalletWebhookRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **create_wallet_webhook_request** | [**\Mudbase\Sdk\Model\CreateWalletWebhookRequest**](../Model/CreateWalletWebhookRequest.md)|  | |

### Return type

[**\Mudbase\Sdk\Model\CreateWalletWebhook201Response**](../Model/CreateWalletWebhook201Response.md)
...
```php
deleteNonCustodialAddress($address_id, $permanent): \Mudbase\Sdk\Model\DeleteFunction200Response
```
...
[**\Mudbase\Sdk\Model\DeleteFunction200Response**](../Model/DeleteFunction200Response.md)
...
```php
deleteWalletWebhook($webhook_id): \Mudbase\Sdk\Model\DeleteFunction200Response
```
...
```php
estimateNetworkFee($estimate_network_fee_request, $fresh): \Mudbase\Sdk\Model\EstimateNetworkFee200Response
```
...
[**\Mudbase\Sdk\Model\EstimateNetworkFee200Response**](../Model/EstimateNetworkFee200Response.md)
...
```php
estimateNonCustodialGas($estimate_non_custodial_gas_request): \Mudbase\Sdk\Model\EstimateNonCustodialGas200Response
```
...
$estimate_non_custodial_gas_request = {"chain":"ethereum","transaction":{"from":"0x742d35Cc6634C0532925a3b844Bc454e4438f44e","to":"0x53d284357ec70cE289D6D64134DfAc8E511c8a3D","value":"1.0"}}; // \Mudbase\Sdk\Model\EstimateNonCustodialGasRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **estimate_non_custodial_gas_request** | [**\Mudbase\Sdk\Model\EstimateNonCustodialGasRequest**](../Model/EstimateNonCustodialGasRequest.md)|  | |

### Return type

[**\Mudbase\Sdk\Model\EstimateNonCustodialGas200Response**](../Model/EstimateNonCustodialGas200Response.md)
...
```php
generatePrivateKey($generate_private_key_request): \Mudbase\Sdk\Model\GeneratePrivateKey200Response
```
...
$generate_private_key_request = {"currency":"BTC"}; // \Mudbase\Sdk\Model\GeneratePrivateKeyRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **generate_private_key_request** | [**\Mudbase\Sdk\Model\GeneratePrivateKeyRequest**](../Model/GeneratePrivateKeyRequest.md)|  | |

### Return type

[**\Mudbase\Sdk\Model\GeneratePrivateKey200Response**](../Model/GeneratePrivateKey200Response.md)
...
```php
getAllFees(): \Mudbase\Sdk\Model\GetAllFees200Response
```
...
[**\Mudbase\Sdk\Model\GetAllFees200Response**](../Model/GetAllFees200Response.md)
...
```php
getBalance($wallet_id): \Mudbase\Sdk\Model\GetBalance200Response
```
...
[**\Mudbase\Sdk\Model\GetBalance200Response**](../Model/GetBalance200Response.md)
...
```php
getCancelParams($get_cancel_params_request): \Mudbase\Sdk\Model\GetCancelParams200Response
```
...
$get_cancel_params_request = {"txHash":"0xabc123...","chain":"ethereum"}; // \Mudbase\Sdk\Model\GetCancelParamsRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **get_cancel_params_request** | [**\Mudbase\Sdk\Model\GetCancelParamsRequest**](../Model/GetCancelParamsRequest.md)|  | |

### Return type

[**\Mudbase\Sdk\Model\GetCancelParams200Response**](../Model/GetCancelParams200Response.md)
...
```php
getNetworkStatus(): \Mudbase\Sdk\Model\GetNetworkStatus200Response
```
...
[**\Mudbase\Sdk\Model\GetNetworkStatus200Response**](../Model/GetNetworkStatus200Response.md)
...
```php
getNonCustodialAddress($address_id): \Mudbase\Sdk\Model\NonCustodialAddressResponse
```
...
[**\Mudbase\Sdk\Model\NonCustodialAddressResponse**](../Model/NonCustodialAddressResponse.md)
...
```php
getNonCustodialBalance($address_id): \Mudbase\Sdk\Model\GetNonCustodialBalance200Response
```
...
[**\Mudbase\Sdk\Model\GetNonCustodialBalance200Response**](../Model/GetNonCustodialBalance200Response.md)
...
```php
getNonCustodialTransactionByHash($tx_hash, $chain): \Mudbase\Sdk\Model\GetNonCustodialTransactionByHash200Response
```
...
[**\Mudbase\Sdk\Model\GetNonCustodialTransactionByHash200Response**](../Model/GetNonCustodialTransactionByHash200Response.md)
...
```php
getNonCustodialTransactions($address_id, $limit, $page): \Mudbase\Sdk\Model\GetNonCustodialTransactions200Response
```
...
[**\Mudbase\Sdk\Model\GetNonCustodialTransactions200Response**](../Model/GetNonCustodialTransactions200Response.md)
...
```php
getSpeedUpParams($get_speed_up_params_request): \Mudbase\Sdk\Model\GetSpeedUpParams200Response
```
...
$get_speed_up_params_request = {"txHash":"0xabc123...","chain":"ethereum"}; // \Mudbase\Sdk\Model\GetSpeedUpParamsRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **get_speed_up_params_request** | [**\Mudbase\Sdk\Model\GetSpeedUpParamsRequest**](../Model/GetSpeedUpParamsRequest.md)|  | |

### Return type

[**\Mudbase\Sdk\Model\GetSpeedUpParams200Response**](../Model/GetSpeedUpParams200Response.md)
...
```php
getSupportedCurrencies(): \Mudbase\Sdk\Model\GetSupportedCurrencies200Response
```
...
[**\Mudbase\Sdk\Model\GetSupportedCurrencies200Response**](../Model/GetSupportedCurrencies200Response.md)
...
```php
getTransaction($transaction_id): \Mudbase\Sdk\Model\GetTransaction200Response
```
...
[**\Mudbase\Sdk\Model\GetTransaction200Response**](../Model/GetTransaction200Response.md)
...
```php
getTransactionHistory($wallet_id, $limit, $page): \Mudbase\Sdk\Model\GetTransactionHistory200Response
```
...
[**\Mudbase\Sdk\Model\GetTransactionHistory200Response**](../Model/GetTransactionHistory200Response.md)
...
```php
getUserWallets($project_id, $currency): \Mudbase\Sdk\Model\GetUserWallets200Response
```
...
[**\Mudbase\Sdk\Model\GetUserWallets200Response**](../Model/GetUserWallets200Response.md)
...
```php
getWalletFeeConfig($project_id): \Mudbase\Sdk\Model\GetWalletFeeConfig200Response
```
...
[**\Mudbase\Sdk\Model\GetWalletFeeConfig200Response**](../Model/GetWalletFeeConfig200Response.md)
...
```php
getWalletPrivateKey($wallet_id): \Mudbase\Sdk\Model\GetWalletPrivateKey200Response
```
...
[**\Mudbase\Sdk\Model\GetWalletPrivateKey200Response**](../Model/GetWalletPrivateKey200Response.md)
...
```php
getWalletWebhookLogs($webhook_id, $limit): \Mudbase\Sdk\Model\GetWalletWebhookLogs200Response
```
...
[**\Mudbase\Sdk\Model\GetWalletWebhookLogs200Response**](../Model/GetWalletWebhookLogs200Response.md)
...
```php
listNonCustodialAddresses($chain, $project_id): \Mudbase\Sdk\Model\ListNonCustodialAddresses200Response
```
...
[**\Mudbase\Sdk\Model\ListNonCustodialAddresses200Response**](../Model/ListNonCustodialAddresses200Response.md)
...
```php
listWalletWebhooks($project_id): \Mudbase\Sdk\Model\ListWalletWebhooks200Response
```
...
[**\Mudbase\Sdk\Model\ListWalletWebhooks200Response**](../Model/ListWalletWebhooks200Response.md)
...
```php
registerNonCustodialAddress($register_non_custodial_address_request): \Mudbase\Sdk\Model\NonCustodialAddressResponse
```
...
$register_non_custodial_address_request = {"address":"0x742d35Cc6634C0532925a3b844Bc9e7595f0bEb","chain":"ethereum","derivationPath":"m/44'/60'/0'/0/5","label":"Main Ethereum Wallet"}; // \Mudbase\Sdk\Model\RegisterNonCustodialAddressRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **register_non_custodial_address_request** | [**\Mudbase\Sdk\Model\RegisterNonCustodialAddressRequest**](../Model/RegisterNonCustodialAddressRequest.md)|  | |
...
```php
testWalletWebhook($test_wallet_webhook_request): \Mudbase\Sdk\Model\TestWalletWebhook200Response
```
...
$test_wallet_webhook_request = {"url":"https://your-app.com/webhooks/test","secret":"whsec_test_abc123","projectId":"685ad30be129932fbb7a1047","event":"wallet.transaction.detected"}; // \Mudbase\Sdk\Model\TestWalletWebhookRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **test_wallet_webhook_request** | [**\Mudbase\Sdk\Model\TestWalletWebhookRequest**](../Model/TestWalletWebhookRequest.md)|  | |
...
```php
updateNonCustodialAddress($address_id, $update_non_custodial_address_request): \Mudbase\Sdk\Model\UpdateNonCustodialAddress200Response
```
...
$address_id = 'address_id_example'; // string
$update_non_custodial_address_request = {"label":"Main cold wallet","derivationPath":"m/44'/60'/0'/0/1"}; // \Mudbase\Sdk\Model\UpdateNonCustodialAddressRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **address_id** | **string**|  | |
| **update_non_custodial_address_request** | [**\Mudbase\Sdk\Model\UpdateNonCustodialAddressRequest**](../Model/UpdateNonCustodialAddressRequest.md)|  | [optional] |

### Return type

[**\Mudbase\Sdk\Model\UpdateNonCustodialAddress200Response**](../Model/UpdateNonCustodialAddress200Response.md)
...
```php
updateWalletFeeConfig($project_id, $update_wallet_fee_config_request): \Mudbase\Sdk\Model\UpdateWalletFeeConfig200Response
```
...
$project_id = 'project_id_example'; // string | Project ID
$update_wallet_fee_config_request = {"enabled":true,"feePercentage":0.01}; // \Mudbase\Sdk\Model\UpdateWalletFeeConfigRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **project_id** | **string**| Project ID | |
| **update_wallet_fee_config_request** | [**\Mudbase\Sdk\Model\UpdateWalletFeeConfigRequest**](../Model/UpdateWalletFeeConfigRequest.md)|  | [optional] |

### Return type

[**\Mudbase\Sdk\Model\UpdateWalletFeeConfig200Response**](../Model/UpdateWalletFeeConfig200Response.md)
...
```php
updateWalletWebhook($webhook_id, $update_wallet_webhook_request): \Mudbase\Sdk\Model\UpdateWalletWebhook200Response
```
...
$webhook_id = 'webhook_id_example'; // string
$update_wallet_webhook_request = {"url":"https://your-app.com/webhooks/updated","events":["wallet.transaction.confirmed","wallet.transaction.detected"],"secret":"whsec_newsecret123","filters":{"addresses":["65a1b2c3d4e5f6789012345a"],"chains":["celo","ethereum"]}}; // \Mudbase\Sdk\Model\UpdateWalletWebhookRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **webhook_id** | **string**|  | |
| **update_wallet_webhook_request** | [**\Mudbase\Sdk\Model\UpdateWalletWebhookRequest**](../Model/UpdateWalletWebhookRequest.md)|  | |

### Return type

[**\Mudbase\Sdk\Model\UpdateWalletWebhook200Response**](../Model/UpdateWalletWebhook200Response.md)
...
```php
validateAddress($validate_address_request): \Mudbase\Sdk\Model\ValidateAddress200Response
```
...
$validate_address_request = {"currency":"BTC","address":"bc1qxy2kgdygjrsqtzq2n0yrf2493p83kkfjhx0wlh"}; // \Mudbase\Sdk\Model\ValidateAddressRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **validate_address_request** | [**\Mudbase\Sdk\Model\ValidateAddressRequest**](../Model/ValidateAddressRequest.md)|  | |

### Return type

[**\Mudbase\Sdk\Model\ValidateAddress200Response**](../Model/ValidateAddress200Response.md)
...
```php
withdraw($wallet_id, $withdraw_request): \Mudbase\Sdk\Model\Withdraw200Response
```
...
$wallet_id = 'wallet_id_example'; // string
$withdraw_request = {"toAddress":"bc1qxy2kgdygjrsqtzq2n0yrf2493p83kkfjhx0wlh","amount":0.1}; // \Mudbase\Sdk\Model\WithdrawRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **wallet_id** | **string**|  | |
| **withdraw_request** | [**\Mudbase\Sdk\Model\WithdrawRequest**](../Model/WithdrawRequest.md)|  | |

### Return type

[**\Mudbase\Sdk\Model\Withdraw200Response**](../Model/Withdraw200Response.md)
