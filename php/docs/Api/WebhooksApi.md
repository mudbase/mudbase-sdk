...
```php
configureWebhook($project_id, $configure_webhook_request): \Mudbase\Sdk\Model\ConfigureWebhook200Response
```
...
$apiInstance = new Mudbase\Sdk\Api\WebhooksApi(
...
$configure_webhook_request = {"webhookUrl":"https://your-app.com/webhooks/mudbase","webhookSecret":"your-secret","webhookEvents":["collection.insert","collection.update","collection.delete"],"webhookVersion":"1.0","transformations":[]}; // \Mudbase\Sdk\Model\ConfigureWebhookRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **project_id** | **string**|  | |
| **configure_webhook_request** | [**\Mudbase\Sdk\Model\ConfigureWebhookRequest**](../Model/ConfigureWebhookRequest.md)|  | [optional] |

### Return type

[**\Mudbase\Sdk\Model\ConfigureWebhook200Response**](../Model/ConfigureWebhook200Response.md)
...
```php
getWebhookConfig($project_id): \Mudbase\Sdk\Model\GetWebhookConfig200Response
```
...
[**\Mudbase\Sdk\Model\GetWebhookConfig200Response**](../Model/GetWebhookConfig200Response.md)
...
```php
getWebhookStats($project_id, $days): \Mudbase\Sdk\Model\WebhookStatsResponse
```
...
[**\Mudbase\Sdk\Model\WebhookStatsResponse**](../Model/WebhookStatsResponse.md)
...
```php
listProjectWebhookLogs($project_id, $page, $limit, $status, $event): \Mudbase\Sdk\Model\WebhookListResponse
```
...
[**\Mudbase\Sdk\Model\WebhookListResponse**](../Model/WebhookListResponse.md)
...
```php
listWebhooks($page, $limit, $status, $event, $project_id): \Mudbase\Sdk\Model\WebhookListResponse
```
...
```php
retryWebhook($webhook_id): \Mudbase\Sdk\Model\RetryWebhookResponse
```
...
[**\Mudbase\Sdk\Model\RetryWebhookResponse**](../Model/RetryWebhookResponse.md)
...
```php
testWebhookTransformation($project_id, $test_webhook_transformation_request): \Mudbase\Sdk\Model\TestWebhookTransformation200Response
```
...
$project_id = 'project_id_example'; // string
$test_webhook_transformation_request = {"payload":{"event":"collection.insert","data":{"name":"Test"}},"transformations":[]}; // \Mudbase\Sdk\Model\TestWebhookTransformationRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **project_id** | **string**|  | |
| **test_webhook_transformation_request** | [**\Mudbase\Sdk\Model\TestWebhookTransformationRequest**](../Model/TestWebhookTransformationRequest.md)|  | |

### Return type

[**\Mudbase\Sdk\Model\TestWebhookTransformation200Response**](../Model/TestWebhookTransformation200Response.md)
...
```php
triggerWebhook($trigger_webhook_request): \Mudbase\Sdk\Model\TriggerWebhookResponse
```
...
$trigger_webhook_request = {"projectId":"65a1b2c3d4e5f6789012345b","url":"https://your-app.com/webhooks/mudbase","event":"manual.test","payload":{"message":"Hello from Mudbase"}}; // \Mudbase\Sdk\Model\TriggerWebhookRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **trigger_webhook_request** | [**\Mudbase\Sdk\Model\TriggerWebhookRequest**](../Model/TriggerWebhookRequest.md)|  | |

### Return type

[**\Mudbase\Sdk\Model\TriggerWebhookResponse**](../Model/TriggerWebhookResponse.md)
