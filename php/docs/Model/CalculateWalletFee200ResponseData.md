...
**fee_tiers** | [**array<string,\Mudbase\Sdk\Model\CalculateWalletFee200ResponseDataFeeTiersValue>**](CalculateWalletFee200ResponseDataFeeTiersValue.md) | (EVM only) slow / normal / fast tiers; each has gasPriceGwei, networkFee | [optional]
