...
**collection_permissions** | [**array<string,\Mudbase\Sdk\Model\CreateRoleRequestCollectionPermissionsValue>**](CreateRoleRequestCollectionPermissionsValue.md) | Per-collection CRUD map (same as POST add role). | [optional]
