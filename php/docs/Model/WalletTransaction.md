...
**token_transfers** | [**\Mudbase\Sdk\Model\WalletTransactionTokenTransfersInner[]**](WalletTransactionTokenTransfersInner.md) | Parsed token transfer list (incoming and outgoing) when available | [optional]
