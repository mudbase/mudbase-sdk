...
class HealthApi
{
     ...
     * @return \Mudbase\Sdk\Model\HealthResponse
     */
     ...
     * @throws \Mudbase\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Mudbase\Sdk\Model\HealthResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\Mudbase\Sdk\Model\HealthResponse';
        $request = $this->healthCheckRequest($contentType);
     ...
     * @throws \Mudbase\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Mudbase\Sdk\Model\SystemStatusResponse
     */
     ...
     * @throws \Mudbase\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Mudbase\Sdk\Model\SystemStatusResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\Mudbase\Sdk\Model\SystemStatusResponse';
        $request = $this->systemStatusRequest($contentType);
