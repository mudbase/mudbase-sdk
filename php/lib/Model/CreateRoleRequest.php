...
class CreateRoleRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'name' => 'string',
        'description' => 'string',
        'permissions' => '\Mudbase\Sdk\Model\CreateRoleRequestPermissionsInner[]',
        'hierarchy' => 'float',
    ...
    */
     ...
     * Gets permissions
     *
     * @return \Mudbase\Sdk\Model\CreateRoleRequestPermissionsInner[]|null
     */
     ...
     * Sets permissions
     *
     * @param \Mudbase\Sdk\Model\CreateRoleRequestPermissionsInner[]|null $permissions Legacy resource-level permissions. For data CRUD, prefer `collectionPermissions` below.
     *
     * @return self
     */
     ...
     *
     * @param array<string,\Mudbase\Sdk\Model\CreateRoleRequestCollectionPermissionsValue>|null $collection_permissions Per-collection CRUD map. Keys are collection slugs; value can be action array or object with actions + conditions.
     *
     * @return self
     */
