...
/**
 * GetAdminPayoutDashboard200ResponseData Class Doc Comment
 *
 * @category Class
 * @package  Mudbase\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class GetAdminPayoutDashboard200ResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getAdminPayoutDashboard_200_response_data';
    ...
    protected static $openAPITypes = [
        ...
        'total_completed' => 'int',
        'total_failed' => 'int',
        'by_currency' => '\Mudbase\Sdk\Model\GetAdminPayoutDashboard200ResponseDataByCurrencyInner[]'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('by_currency', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets total_pending
     *
     * @param int|null $total_pending total_pending
     *
     * @return self
     */
     ...
     * Gets by_currency
     *
     * @return \Mudbase\Sdk\Model\GetAdminPayoutDashboard200ResponseDataByCurrencyInner[]|null
     */
    public function getByCurrency()
    {
        return $this->container['by_currency'];
    }

    /**
     * Sets by_currency
     *
     * @param \Mudbase\Sdk\Model\GetAdminPayoutDashboard200ResponseDataByCurrencyInner[]|null $by_currency by_currency
     *
     * @return self
     */
    public function setByCurrency($by_currency)
    {
        if (is_null($by_currency)) {
            throw new \InvalidArgumentException('non-nullable by_currency cannot be null');
        }
        $this->container['by_currency'] = $by_currency;
