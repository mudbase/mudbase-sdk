...
/**
 * StartBugAnalysisScanByProjectRequest Class Doc Comment
 *
 * @category Class
 * @package  Mudbase\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class StartBugAnalysisScanByProjectRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'startBugAnalysisScanByProject_request';
    ...
    protected static $setters = [
        ...
        'runtime_minutes' => 'setRuntimeMinutes'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('runtime_minutes', $data ?? [], null);
    }
     ...
     * Sets upload_size
     *
     * @param float|null $upload_size upload_size
     *
     * @return self
     */
    ...
    /**
     * Gets runtime_minutes
     *
     * @return float|null
     */
    public function getRuntimeMinutes()
    {
        return $this->container['runtime_minutes'];
    }

    /**
     * Sets runtime_minutes
     *
     * @param float|null $runtime_minutes runtime_minutes
     *
     * @return self
     */
    public function setRuntimeMinutes($runtime_minutes)
    {
        if (is_null($runtime_minutes)) {
            throw new \InvalidArgumentException('non-nullable runtime_minutes cannot be null');
        }
        $this->container['runtime_minutes'] = $runtime_minutes;
