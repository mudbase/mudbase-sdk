...
class UpdateProjectRoleRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param array<string,\Mudbase\Sdk\Model\CreateRoleRequestCollectionPermissionsValue>|null $collection_permissions Per-collection CRUD map (same as POST add role).
     *
     * @return self
     */
