...
**chain** | **str** |  | [optional] 
**confirmed** | **str** | Confirmed balance (string to handle large numbers) | [optional] 
**unconfirmed** | **str** | Unconfirmed balance (string to handle large numbers) | [optional] 
**total** | **str** | Total balance (string to handle large numbers) | [optional] 
