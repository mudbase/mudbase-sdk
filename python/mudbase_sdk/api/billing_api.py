...
class BillingApi:
    ...
    def handle_flutterwave_webhook(
        self,
        handle_flutterwave_webhook_request: HandleFlutterwaveWebhookRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param handle_flutterwave_webhook_request: (required)
        :type handle_flutterwave_webhook_request: HandleFlutterwaveWebhookRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._handle_flutterwave_webhook_serialize(
            handle_flutterwave_webhook_request=handle_flutterwave_webhook_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "HandleFlutterwaveWebhook200Response",
            '400': "RefreshToken400Response",
            '500': "Error",
        }
        response_data = self.api_client.call_api(
    ...
    @validate_call
    def handle_flutterwave_webhook_with_http_info(
        self,
        handle_flutterwave_webhook_request: HandleFlutterwaveWebhookRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[HandleFlutterwaveWebhook200Response]:
        """Payment gateway webhook
    ...
    @validate_call
    def handle_flutterwave_webhook_without_preload_content(
        self,
        handle_flutterwave_webhook_request: HandleFlutterwaveWebhookRequest,
        _request_timeout: Union[
            None,
    ...
    def _handle_flutterwave_webhook_serialize(
        self,
        ...
        # process the form parameters
        # process the body parameter
        if handle_flutterwave_webhook_request is not None:
            _body_params = handle_flutterwave_webhook_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/billing/webhooks/flutterwave',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
