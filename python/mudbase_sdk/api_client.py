...
from mudbase_sdk.configuration import Configuration
from mudbase_sdk.api_response import ApiResponse, T as ApiResponseT
import mudbase_sdk.models
from mudbase_sdk import rest
from mudbase_sdk.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(mudbase_sdk.models, klass)
