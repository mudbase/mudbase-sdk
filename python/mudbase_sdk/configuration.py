...
conf = mudbase_sdk.Configuration(
    ...
    def __init__(
        ...
        *,
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("mudbase_sdk")
    ...
    def get_host_settings(self) -> List[HostSetting]:
        ...
        return [
            ...
            {
                'url': "https://connect--mudbase-server--c964r44kbjpw.code.run",
                'description': "Staging server",
            },
            {
                'url': "https://mudbase-server.onrender.com",
                'description': "Alternative Staging server",
            },
            {
