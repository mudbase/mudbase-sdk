...
class BroadcastNonCustodialTransaction200ResponseData(BaseModel):
    """
    ...
    currency: Optional[StrictStr] = Field(default=None, description="Native currency for the chain (ETH, BNB, MATIC, etc.)")
    __properties: ClassVar[List[str]] = ["txHash", "chain", "fromAddress", "currency"]
