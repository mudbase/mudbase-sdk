...
class BroadcastNonCustodialTransactionRequest(BaseModel):
    ...
    def chain_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['ethereum', 'polygon', 'arbitrum', 'optimism', 'base', 'bsc', 'binance', 'avalanche', 'celo', 'bitcoin', 'litecoin', 'dogecoin', 'tron', 'solana', 'ton', 'cardano']):
            raise ValueError("must be one of enum values ('ethereum', 'polygon', 'arbitrum', 'optimism', 'base', 'bsc', 'binance', 'avalanche', 'celo', 'bitcoin', 'litecoin', 'dogecoin', 'tron', 'solana', 'ton', 'cardano')")
        return value
