...
class CalculateWalletFee200ResponseDataFeeTiersValue(BaseModel):
    """
    CalculateWalletFee200ResponseDataFeeTiersValue
    """ # noqa: E501
    gas_price_gwei: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="gasPriceGwei")
    network_fee: Optional[StrictStr] = Field(default=None, alias="networkFee")
    __properties: ClassVar[List[str]] = ["gasPriceGwei", "networkFee"]
