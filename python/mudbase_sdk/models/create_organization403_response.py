...
class CreateOrganization403Response(BaseModel):
    ...
    """ # noqa: E501
    error: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["Creating organizations via API is disabled."]})
    code: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["ORG_CREATION_DISABLED"]})
