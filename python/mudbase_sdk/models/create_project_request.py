...
class CreateProjectRequest(BaseModel):
    ...
    """ # noqa: E501
    name: StrictStr = Field(json_schema_extra={"examples": ["Mudbase Platform"]})
    description: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["Main platform for Mudbase services"]})
    slug: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["mudbase-platform"]})
