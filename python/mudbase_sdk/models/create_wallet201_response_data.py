...
class CreateWallet201ResponseData(BaseModel):
    """
    ...
    is_custom_key: Optional[StrictBool] = Field(default=None, alias="isCustomKey")
    project: Optional[StrictStr] = None
    created_at: Optional[datetime] = Field(default=None, alias="createdAt")
    __properties: ClassVar[List[str]] = ["_id", "currency", "address", "balance", "isCustomKey", "project", "createdAt"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "isCustomKey": obj.get("isCustomKey"),
