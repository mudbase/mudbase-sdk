...
class CreateWalletWebhookRequestFilters(BaseModel):
    ...
    """ # noqa: E501
    addresses: Optional[List[StrictStr]] = Field(default=None, description="Filter by address IDs (optional)")
    chains: Optional[List[StrictStr]] = Field(default=None, description="Filter by chains (optional)")
