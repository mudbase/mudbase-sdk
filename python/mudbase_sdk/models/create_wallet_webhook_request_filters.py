...
class CreateWalletWebhookRequestFilters(BaseModel):
    """
    CreateWalletWebhookRequestFilters
    """ # noqa: E501
    addresses: Optional[List[StrictStr]] = Field(default=None, description="Filter by address IDs (optional)", json_schema_extra={"examples": [["65a1b2c3d4e5f6789012345a"]]})
    chains: Optional[List[StrictStr]] = Field(default=None, description="Filter by chains (optional)", json_schema_extra={"examples": [["ethereum", "bitcoin"]]})
    __properties: ClassVar[List[str]] = ["addresses", "chains"]
    ...
    def chains_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['ethereum', 'binance', 'bsc', 'polygon', 'arbitrum', 'optimism', 'base', 'avalanche', 'celo', 'bitcoin', 'litecoin', 'dogecoin', 'solana', 'tron', 'ripple', 'cardano', 'ton']):
                raise ValueError("each list item must be one of ('ethereum', 'binance', 'bsc', 'polygon', 'arbitrum', 'optimism', 'base', 'avalanche', 'celo', 'bitcoin', 'litecoin', 'dogecoin', 'solana', 'tron', 'ripple', 'cardano', 'ton')")
        return value
