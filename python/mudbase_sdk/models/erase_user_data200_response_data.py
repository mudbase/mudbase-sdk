...
class EraseUserData200ResponseData(BaseModel):
    ...
    """ # noqa: E501
    already_erased: Optional[StrictBool] = Field(default=None, alias="alreadyErased", json_schema_extra={"examples": [False]})
    subject_id: Optional[StrictStr] = Field(default=None, alias="subjectId", json_schema_extra={"examples": ["685acbe0e129932fbb7a0fc2"]})
    anonymized: Optional[StrictBool] = Field(default=None, json_schema_extra={"examples": [True]})
    sessions_revoked: Optional[StrictBool] = Field(default=None, alias="sessionsRevoked", json_schema_extra={"examples": [True]})
