...
class EstimateNetworkFee200Response(BaseModel):
    """
    EstimateNetworkFee200Response
    """ # noqa: E501
    success: Optional[StrictBool] = None
    data: Optional[Dict[str, Any]] = Field(default=None, description="Same shape as POST /api/wallet/calculate-fee response (chain, networkFee, estimatedTime, currency, and chain-specific fields).")
