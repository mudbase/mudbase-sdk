...
class FunctionTrigger(BaseModel):
    ...
    event: Optional[StrictStr] = Field(default=None, description="Event name (e.g. create, update, delete for document; uploaded, deleted for file; tx, balance for wallet)")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['http', 'event', 'document', 'file', 'webhook', 'wallet', 'cron', 'messaging']):
            raise ValueError("must be one of enum values ('http', 'event', 'document', 'file', 'webhook', 'wallet', 'cron', 'messaging')")
        return value
