...
class GenerateDataProcessingRecordRequest(BaseModel):
    ...
    """ # noqa: E501
    org_id: StrictStr = Field(alias="orgId", json_schema_extra={"examples": ["685acbe0e129932fbb7a0fc3"]})
    record_date: Optional[datetime] = Field(default=None, alias="recordDate", json_schema_extra={"examples": ["2024-12-16T00:00:00Z"]})
