...
class GetAdminPayoutDashboard200ResponseData(BaseModel):
    """
    GetAdminPayoutDashboard200ResponseData
    """ # noqa: E501
    total_pending: Optional[StrictInt] = Field(default=None, alias="totalPending")
    total_completed: Optional[StrictInt] = Field(default=None, alias="totalCompleted")
    total_failed: Optional[StrictInt] = Field(default=None, alias="totalFailed")
    by_currency: Optional[List[GetAdminPayoutDashboard200ResponseDataByCurrencyInner]] = Field(default=None, alias="byCurrency")
    __properties: ClassVar[List[str]] = ["totalPending", "totalCompleted", "totalFailed", "byCurrency"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in by_currency (list)
        _items = []
        if self.by_currency:
            for _item_by_currency in self.by_currency:
                if _item_by_currency:
                    _items.append(_item_by_currency.to_dict())
            _dict['byCurrency'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "totalPending": obj.get("totalPending"),
            "totalCompleted": obj.get("totalCompleted"),
            "totalFailed": obj.get("totalFailed"),
            "byCurrency": [GetAdminPayoutDashboard200ResponseDataByCurrencyInner.from_dict(_item) for _item in obj["byCurrency"]] if obj.get("byCurrency") is not None else None
        })
        return _obj
