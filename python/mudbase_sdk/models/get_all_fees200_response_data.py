...
class GetAllFees200ResponseData(BaseModel):
    """
    GetAllFees200ResponseData
    """ # noqa: E501
    fees: Optional[Dict[str, Dict[str, Any]]] = None
    updated_at: Optional[datetime] = Field(default=None, description="When the cache was last updated", alias="updatedAt")
    count: Optional[StrictInt] = Field(default=None, description="Number of chains with cached fees")
    __properties: ClassVar[List[str]] = ["fees", "updatedAt", "count"]
