...
class GetCancelParams200ResponseData(BaseModel):
    """
    ...
    to: Optional[StrictStr] = Field(default=None, description="Same as from (self)")
    value: Optional[StrictStr] = Field(default=None, description="0")
    data: Optional[StrictStr] = Field(default=None, description="0x")
    ...
    __properties: ClassVar[List[str]] = ["chainId", "from", "nonce", "to", "value", "data", "gasLimit", "maxFeePerGas", "maxPriorityFeePerGas", "gasPrice"]
