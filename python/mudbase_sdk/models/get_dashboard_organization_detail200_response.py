...
class GetDashboardOrganizationDetail200Response(BaseModel):
    """
    GetDashboardOrganizationDetail200Response
    """ # noqa: E501
    success: Optional[StrictBool] = None
    organization: Optional[GetDashboardOrganizationDetail200ResponseOrganization] = None
    __properties: ClassVar[List[str]] = ["success", "organization"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "organization": GetDashboardOrganizationDetail200ResponseOrganization.from_dict(obj["organization"]) if obj.get("organization") is not None else None
        })
        return _obj
