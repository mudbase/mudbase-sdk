...
class GetDashboardOrganizationDetail200ResponseOrganizationProjectsInner(BaseModel):
    """
    ...
    users: Optional[List[GetDashboardOrganizationDetail200ResponseOrganizationProjectsInnerUsersInner]] = None
    __properties: ClassVar[List[str]] = ["_id", "name", "slug", "description", "createdAt", "isArchived", "userCount", "users"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "users": [GetDashboardOrganizationDetail200ResponseOrganizationProjectsInnerUsersInner.from_dict(_item) for _item in obj["users"]] if obj.get("users") is not None else None
        })
        return _obj
