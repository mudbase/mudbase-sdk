...
class GetDashboardOrganizationDetail200ResponseOrganizationProjectsInnerUsersInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["_id", "firstName", "lastName", "email", "role", "lastLogin", "isActive", "createdAt"]
