...
class GetDashboardOrganizationDetail200ResponseOrganizationUsersInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["_id", "firstName", "lastName", "email", "role", "lastLogin", "isActive", "createdAt", "project"]
