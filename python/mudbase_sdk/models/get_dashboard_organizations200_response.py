...
class GetDashboardOrganizations200Response(BaseModel):
    """
    GetDashboardOrganizations200Response
    """ # noqa: E501
    success: Optional[StrictBool] = None
    organizations: Optional[List[GetDashboardOrganizations200ResponseOrganizationsInner]] = None
    total: Optional[StrictInt] = None
    page: Optional[StrictInt] = Field(default=None, description="Present when limit query was used")
    limit: Optional[StrictInt] = None
    pages: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["success", "organizations", "total", "page", "limit", "pages"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "organizations": [GetDashboardOrganizations200ResponseOrganizationsInner.from_dict(_item) for _item in obj["organizations"]] if obj.get("organizations") is not None else None,
            "total": obj.get("total"),
            "page": obj.get("page"),
            "limit": obj.get("limit"),
            "pages": obj.get("pages")
