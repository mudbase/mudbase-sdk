...
class GetDashboardOrganizations200ResponseOrganizationsInner(BaseModel):
    """
    ...
    dedicated_api_base_url: Optional[StrictStr] = Field(default=None, alias="dedicatedApiBaseUrl")
    is_active: Optional[StrictBool] = Field(default=None, alias="isActive")
    created_at: Optional[datetime] = Field(default=None, alias="createdAt")
    created_by: Optional[GetDashboardOrganizations200ResponseOrganizationsInnerCreatedBy] = Field(default=None, alias="createdBy")
    ...
    projects: Optional[List[GetOrganizationUsers200ResponseUsersInnerProject]] = None
    __properties: ClassVar[List[str]] = ["_id", "name", "slug", "description", "plan", "deploymentType", "dedicatedApiBaseUrl", "isActive", "createdAt", "createdBy", "projectCount", "userCount", "projects"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if dedicated_api_base_url (nullable) is None
        # and model_fields_set contains the field
        if self.dedicated_api_base_url is None and "dedicated_api_base_url" in self.model_fields_set:
            _dict['dedicatedApiBaseUrl'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dedicatedApiBaseUrl": obj.get("dedicatedApiBaseUrl"),
            "isActive": obj.get("isActive"),
            "createdAt": obj.get("createdAt"),
            "createdBy": GetDashboardOrganizations200ResponseOrganizationsInnerCreatedBy.from_dict(obj["createdBy"]) if obj.get("createdBy") is not None else None,
            "projectCount": obj.get("projectCount"),
            "userCount": obj.get("userCount"),
            "projects": [GetOrganizationUsers200ResponseUsersInnerProject.from_dict(_item) for _item in obj["projects"]] if obj.get("projects") is not None else None
        })
        return _obj
