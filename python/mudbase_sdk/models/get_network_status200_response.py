...
class GetNetworkStatus200Response(BaseModel):
    """
    GetNetworkStatus200Response
    """ # noqa: E501
    success: Optional[StrictBool] = None
    data: Optional[Dict[str, GetNetworkStatus200ResponseDataValue]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": dict(
                (_k, GetNetworkStatus200ResponseDataValue.from_dict(_v))
