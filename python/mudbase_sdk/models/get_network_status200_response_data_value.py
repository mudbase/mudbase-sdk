...
class GetNetworkStatus200ResponseDataValue(BaseModel):
    """
    GetNetworkStatus200ResponseDataValue
    """ # noqa: E501
    congestion: Optional[StrictStr] = None
    gas_price_gwei: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="EVM only", alias="gasPriceGwei")
    sat_per_vb: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="UTXO only", alias="satPerVb")
    network_fee: Optional[StrictStr] = Field(default=None, alias="networkFee")
    __properties: ClassVar[List[str]] = ["congestion", "gasPriceGwei", "satPerVb", "networkFee"]
