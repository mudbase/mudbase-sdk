...
class GetNonCustodialTransactionByHash200Response(BaseModel):
    """
    GetNonCustodialTransactionByHash200Response
    """ # noqa: E501
    success: Optional[StrictBool] = None
    data: Optional[WalletTransaction] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": WalletTransaction.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
