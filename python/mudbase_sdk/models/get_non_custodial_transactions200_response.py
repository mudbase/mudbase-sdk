...
class GetNonCustodialTransactions200Response(BaseModel):
    """
    GetNonCustodialTransactions200Response
    """ # noqa: E501
    success: Optional[StrictBool] = None
    data: Optional[List[WalletTransaction]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [WalletTransaction.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
