...
class GetPendingPayouts200Response(BaseModel):
    """
    GetPendingPayouts200Response
    """ # noqa: E501
    success: Optional[StrictBool] = None
    data: Optional[List[GetPendingPayouts200ResponseDataInner]] = None
    pagination: Optional[GetTransactionHistory200ResponsePagination] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [GetPendingPayouts200ResponseDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "pagination": GetTransactionHistory200ResponsePagination.from_dict(obj["pagination"]) if obj.get("pagination") is not None else None
        })
        return _obj
