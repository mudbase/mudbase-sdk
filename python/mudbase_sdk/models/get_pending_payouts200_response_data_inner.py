...
class GetPendingPayouts200ResponseDataInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["_id", "project", "currency", "grossAmount", "netAmount", "toAddress", "txHash", "status", "error", "retryCount", "scheduledAt", "processedAt", "createdAt"]
