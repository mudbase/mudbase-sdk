...
class GetScannerMetrics200Response(BaseModel):
    """
    GetScannerMetrics200Response
    """ # noqa: E501
    metrics: Optional[Dict[str, GetScannerMetrics200ResponseMetricsValue]] = None
    lag_alert_threshold: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Block lag threshold above which alerts are raised", alias="lagAlertThreshold")
    alerts: Optional[List[GetScannerMetrics200ResponseAlertsInner]] = None
    __properties: ClassVar[List[str]] = ["metrics", "lagAlertThreshold", "alerts"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "metrics": dict(
                (_k, GetScannerMetrics200ResponseMetricsValue.from_dict(_v))
                for _k, _v in obj["metrics"].items()
            )
            if obj.get("metrics") is not None
            else None,
            "lagAlertThreshold": obj.get("lagAlertThreshold"),
            "alerts": [GetScannerMetrics200ResponseAlertsInner.from_dict(_item) for _item in obj["alerts"]] if obj.get("alerts") is not None else None
        })
        return _obj
