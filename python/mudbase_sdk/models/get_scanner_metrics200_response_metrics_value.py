...
class GetScannerMetrics200ResponseMetricsValue(BaseModel):
    """
    GetScannerMetrics200ResponseMetricsValue
    """ # noqa: E501
    last_scanned_block: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="lastScannedBlock")
    current_block: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="currentBlock")
    lag: Optional[Union[StrictFloat, StrictInt]] = None
    last_updated: Optional[datetime] = Field(default=None, alias="lastUpdated")
    __properties: ClassVar[List[str]] = ["lastScannedBlock", "currentBlock", "lag", "lastUpdated"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if last_scanned_block (nullable) is None
        # and model_fields_set contains the field
        if self.last_scanned_block is None and "last_scanned_block" in self.model_fields_set:
            _dict['lastScannedBlock'] = None

        # set to None if current_block (nullable) is None
        # and model_fields_set contains the field
        if self.current_block is None and "current_block" in self.model_fields_set:
            _dict['currentBlock'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "lastScannedBlock": obj.get("lastScannedBlock"),
            "currentBlock": obj.get("currentBlock"),
            "lag": obj.get("lag"),
