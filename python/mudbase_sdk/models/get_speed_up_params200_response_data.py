...
class GetSpeedUpParams200ResponseData(BaseModel):
    """
    ...
    gas_price: Optional[StrictStr] = Field(default=None, description="Legacy; use when EIP-1559 not used", alias="gasPrice")
