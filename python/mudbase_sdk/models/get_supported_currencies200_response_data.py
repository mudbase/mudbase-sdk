...
class GetSupportedCurrencies200ResponseData(BaseModel):
    """
    GetSupportedCurrencies200ResponseData
    """ # noqa: E501
    currencies: Optional[List[GetSupportedCurrencies200ResponseDataCurrenciesInner]] = None
    count: Optional[StrictInt] = Field(default=None, description="Number of supported currencies/chains")
    __properties: ClassVar[List[str]] = ["currencies", "count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "currencies": [GetSupportedCurrencies200ResponseDataCurrenciesInner.from_dict(_item) for _item in obj["currencies"]] if obj.get("currencies") is not None else None,
            "count": obj.get("count")
        })
        return _obj
