...
class GetSupportedCurrencies200ResponseDataCurrenciesInner(BaseModel):
    """
    GetSupportedCurrencies200ResponseDataCurrenciesInner
    """ # noqa: E501
    code: Optional[StrictStr] = Field(default=None, description="Currency symbol (BTC, ETH, MATIC, BNB, etc.)")
    name: Optional[StrictStr] = Field(default=None, description="Display name (e.g. Bitcoin, Polygon, Arbitrum One)")
    chain: Optional[StrictStr] = Field(default=None, description="Chain id for API use (e.g. ethereum, polygon, arbitrum)")
    networks: Optional[List[StrictStr]] = Field(default=None, description="For USDT only; networks on which USDT is supported (ETH, BSC, TRX, SOL, POLYGON)")
    __properties: ClassVar[List[str]] = ["code", "name", "chain", "networks"]
