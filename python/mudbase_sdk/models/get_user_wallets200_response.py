...
class GetUserWallets200Response(BaseModel):
    """
    GetUserWallets200Response
    """ # noqa: E501
    success: Optional[StrictBool] = None
    data: Optional[List[CreateWallet201ResponseData]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [CreateWallet201ResponseData.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
