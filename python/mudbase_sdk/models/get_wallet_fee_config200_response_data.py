...
class GetWalletFeeConfig200ResponseData(BaseModel):
    """
    GetWalletFeeConfig200ResponseData
    """ # noqa: E501
    enabled: Optional[StrictBool] = Field(default=None, description="Whether project-level fee is enabled (for non-custodial fee display/calculation)")
    fee_percentage: Optional[Union[Annotated[float, Field(le=1, strict=True, ge=0)], Annotated[int, Field(le=1, strict=True, ge=0)]]] = Field(default=None, description="Project fee as decimal (e.g. 0.01 = 1%)", alias="feePercentage")
    __properties: ClassVar[List[str]] = ["enabled", "feePercentage"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "feePercentage": obj.get("feePercentage")
        })
        return _obj
