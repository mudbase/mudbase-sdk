...
class HandleFlutterwaveWebhookRequest(BaseModel):
    """
    HandleFlutterwaveWebhookRequest
    """ # noqa: E501
    event: Optional[StrictStr] = Field(default=None, description="Event type (e.g. charge.completed, payment.successful)")
    data: Optional[HandleFlutterwaveWebhookRequestData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "event": obj.get("event"),
            "data": HandleFlutterwaveWebhookRequestData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
