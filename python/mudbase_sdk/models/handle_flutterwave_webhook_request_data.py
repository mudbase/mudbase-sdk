...
class HandleFlutterwaveWebhookRequestData(BaseModel):
    """
    HandleFlutterwaveWebhookRequestData
    """ # noqa: E501
    id: Optional[Union[StrictFloat, StrictInt]] = None
    tx_ref: Optional[StrictStr] = None
    flw_ref: Optional[StrictStr] = None
    amount: Optional[Union[StrictFloat, StrictInt]] = None
    currency: Optional[StrictStr] = None
    status: Optional[StrictStr] = None
    customer: Optional[HandleFlutterwaveWebhookRequestDataCustomer] = None
    meta: Optional[Dict[str, Any]] = Field(default=None, description="orgId, projectId, planId, billingCycle; or isPaymentProcessing true for fiat payment-processing")
    __properties: ClassVar[List[str]] = ["id", "tx_ref", "flw_ref", "amount", "currency", "status", "customer", "meta"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "tx_ref": obj.get("tx_ref"),
            "flw_ref": obj.get("flw_ref"),
            "amount": obj.get("amount"),
            "currency": obj.get("currency"),
            "status": obj.get("status"),
            "customer": HandleFlutterwaveWebhookRequestDataCustomer.from_dict(obj["customer"]) if obj.get("customer") is not None else None,
            "meta": obj.get("meta")
        })
        return _obj
