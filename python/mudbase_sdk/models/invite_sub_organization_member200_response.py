...
class InviteSubOrganizationMember200Response(BaseModel):
    ...
    """ # noqa: E501
    message: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["Invitation sent successfully"]})
    email: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["user@suborg.example.com"]})
    role: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["viewer"]})
