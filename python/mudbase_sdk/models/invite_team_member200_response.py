...
class InviteTeamMember200Response(BaseModel):
    ...
    email: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["newuser@example.com"]})
    role: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["member"]})
