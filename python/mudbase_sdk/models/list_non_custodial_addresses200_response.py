...
class ListNonCustodialAddresses200Response(BaseModel):
    """
    ListNonCustodialAddresses200Response
    """ # noqa: E501
    success: Optional[StrictBool] = None
    data: Optional[List[NonCustodialAddress]] = None
    count: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["success", "data", "count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [NonCustodialAddress.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "count": obj.get("count")
        })
        return _obj
