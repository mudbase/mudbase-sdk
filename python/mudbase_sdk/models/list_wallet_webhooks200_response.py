...
class ListWalletWebhooks200Response(BaseModel):
    """
    ListWalletWebhooks200Response
    """ # noqa: E501
    success: Optional[StrictBool] = None
    data: Optional[List[WalletWebhook]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [WalletWebhook.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "count": obj.get("count")
        })
        return _obj
