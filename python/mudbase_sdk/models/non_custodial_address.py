...
class NonCustodialAddress(BaseModel):
    ...
    def chain_validate_enum(cls, value):
        ...
        if value not in set(['ethereum', 'binance', 'polygon', 'celo', 'bitcoin']):
            raise ValueError("must be one of enum values ('ethereum', 'binance', 'polygon', 'celo', 'bitcoin')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if derivation_path (nullable) is None
        # and model_fields_set contains the field
        if self.derivation_path is None and "derivation_path" in self.model_fields_set:
            _dict['derivationPath'] = None
