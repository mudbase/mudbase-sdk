...
class OrgCloudflareEdgeHints(BaseModel):
    ...
    ownership_verification: Optional[OrgCloudflareEdgeHintsOwnershipVerification] = Field(default=None, alias="ownershipVerification")
    ssl_validation_records: Optional[List[OrgCloudflareSslValidationRecord]] = Field(default=None, alias="sslValidationRecords")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ownershipVerification": OrgCloudflareEdgeHintsOwnershipVerification.from_dict(obj["ownershipVerification"]) if obj.get("ownershipVerification") is not None else None,
            "sslValidationRecords": [OrgCloudflareSslValidationRecord.from_dict(_item) for _item in obj["sslValidationRecords"]] if obj.get("sslValidationRecords") is not None else None,
