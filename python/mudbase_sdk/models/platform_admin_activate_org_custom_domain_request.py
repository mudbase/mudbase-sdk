...
class PlatformAdminActivateOrgCustomDomainRequest(BaseModel):
    """
    PlatformAdminActivateOrgCustomDomainRequest
    """ # noqa: E501
    notify_org: Optional[StrictBool] = Field(default=None, description="Email org billing contact when domain goes live (default true)", alias="notifyOrg")
    __properties: ClassVar[List[str]] = ["notifyOrg"]
