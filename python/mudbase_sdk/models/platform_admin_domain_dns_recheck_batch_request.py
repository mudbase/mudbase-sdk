...
class PlatformAdminDomainDnsRecheckBatchRequest(BaseModel):
    """
    PlatformAdminDomainDnsRecheckBatchRequest
    """ # noqa: E501
    max_orgs: Optional[Annotated[int, Field(le=5000, strict=True, ge=1)]] = Field(default=None, alias="maxOrgs")
    recheck_older_than_hours: Optional[Annotated[int, Field(le=8760, strict=True, ge=1)]] = Field(default=None, alias="recheckOlderThanHours")
