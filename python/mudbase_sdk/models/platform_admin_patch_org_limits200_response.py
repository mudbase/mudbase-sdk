...
class PlatformAdminPatchOrgLimits200Response(BaseModel):
    """
    ...
    limits: Dict[str, Any] = Field(description="Persisted `Org.limits` after merge")
    effective: Dict[str, Any] = Field(description="Full entitlement map from getEntitlements (plan + overrides)")
    __properties: ClassVar[List[str]] = ["success", "orgId", "limits", "effective"]
