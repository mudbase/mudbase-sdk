...
class PresignedPostResponse(BaseModel):
    ...
    """ # noqa: E501
    key: Optional[StrictStr] = Field(default=None, description="Object key (S3) clients should upload to")
    url: Optional[StrictStr] = Field(default=None, description="Presigned URL to PUT the file body to directly")
    method: Optional[StrictStr] = Field(default=None, description="HTTP method the client must use against `url` (always PUT - R2 does not implement the S3 POST Object API)")
