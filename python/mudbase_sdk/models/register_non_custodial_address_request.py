...
class RegisterNonCustodialAddressRequest(BaseModel):
    ...
    def chain_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['ethereum', 'binance', 'bsc', 'polygon', 'arbitrum', 'optimism', 'base', 'avalanche', 'celo', 'bitcoin', 'litecoin', 'dogecoin', 'solana', 'tron', 'ripple', 'cardano', 'ton']):
            raise ValueError("must be one of enum values ('ethereum', 'binance', 'bsc', 'polygon', 'arbitrum', 'optimism', 'base', 'avalanche', 'celo', 'bitcoin', 'litecoin', 'dogecoin', 'solana', 'tron', 'ripple', 'cardano', 'ton')")
        return value
