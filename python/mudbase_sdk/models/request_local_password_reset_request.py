...
class RequestLocalPasswordResetRequest(BaseModel):
    ...
    project_id: Optional[StrictStr] = Field(default=None, description="Required for project-based reset (sends OTP). Omit for org token link.", alias="projectId", json_schema_extra={"examples": ["685ad30be129932fbb7a1047"]})
