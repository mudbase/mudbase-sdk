...
class StartBugAnalysisScan503Response(BaseModel):
    """
    StartBugAnalysisScan503Response
    """ # noqa: E501
    success: Optional[StrictBool] = None
    code: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["COMING_SOON"]})
    message: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["success", "code", "message"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StartBugAnalysisScan503Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StartBugAnalysisScan503Response from a dict"""
        if obj is None:
            return None
