...
class StartBugAnalysisScanByProjectRequest(BaseModel):
    """
    StartBugAnalysisScanByProjectRequest
    """ # noqa: E501
    upload_size: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="uploadSize")
    runtime_minutes: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="runtimeMinutes")
    __properties: ClassVar[List[str]] = ["uploadSize", "runtimeMinutes"]
