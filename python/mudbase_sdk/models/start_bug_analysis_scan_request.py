...
class StartBugAnalysisScanRequest(BaseModel):
    """
    StartBugAnalysisScanRequest
    """ # noqa: E501
    project_id: Optional[StrictStr] = Field(default=None, alias="projectId")
    upload_size: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Bytes", alias="uploadSize")
    runtime_minutes: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="runtimeMinutes")
    __properties: ClassVar[List[str]] = ["projectId", "uploadSize", "runtimeMinutes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "uploadSize": obj.get("uploadSize"),
            "runtimeMinutes": obj.get("runtimeMinutes")
        })
        return _obj
