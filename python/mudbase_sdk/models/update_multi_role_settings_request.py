...
class UpdateMultiRoleSettingsRequest(BaseModel):
    ...
    """ # noqa: E501
    is_enabled: Optional[StrictBool] = Field(default=None, alias="isEnabled", json_schema_extra={"examples": [True]})
    default_role: Optional[StrictStr] = Field(default=None, alias="defaultRole", json_schema_extra={"examples": ["customer"]})
