...
class UpdateNonCustodialAddressRequest(BaseModel):
    """
    UpdateNonCustodialAddressRequest
    """ # noqa: E501
    label: Optional[Annotated[str, Field(strict=True, max_length=64)]] = Field(default=None, description="Human-readable label for the address")
    derivation_path: Optional[StrictStr] = Field(default=None, description="BIP derivation path (e.g. m/44'/60'/0'/0/0); can be set to null to clear", alias="derivationPath")
    __properties: ClassVar[List[str]] = ["label", "derivationPath"]
