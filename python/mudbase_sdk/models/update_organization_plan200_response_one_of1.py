...
class UpdateOrganizationPlan200ResponseOneOf1(BaseModel):
    ...
    """ # noqa: E501
    error: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["Plan upgrades must be done through the billing system"]})
    message: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["Please use /api/billing routes to upgrade your plan"]})
