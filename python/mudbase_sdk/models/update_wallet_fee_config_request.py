...
class UpdateWalletFeeConfigRequest(BaseModel):
    """
    UpdateWalletFeeConfigRequest
    """ # noqa: E501
    enabled: Optional[StrictBool] = Field(default=None, description="Enable or disable project-level fee (for non-custodial fee calculation)")
    fee_percentage: Optional[Union[Annotated[float, Field(le=1, strict=True, ge=0)], Annotated[int, Field(le=1, strict=True, ge=0)]]] = Field(default=None, description="Project fee as decimal (e.g. 0.01 = 1%, 0.005 = 0.5%)", alias="feePercentage")
