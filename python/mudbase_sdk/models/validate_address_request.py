...
class ValidateAddressRequest(BaseModel):
    ...
    currency: StrictStr
    address: StrictStr
    __properties: ClassVar[List[str]] = ["currency", "address"]

    @field_validator('currency')
    def currency_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['BTC', 'ETH', 'BNB', 'LTC', 'SOL', 'TRX', 'USDT']):
            raise ValueError("must be one of enum values ('BTC', 'ETH', 'BNB', 'LTC', 'SOL', 'TRX', 'USDT')")
        return value
