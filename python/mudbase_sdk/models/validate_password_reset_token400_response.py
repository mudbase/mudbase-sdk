...
class ValidatePasswordResetToken400Response(BaseModel):
    ...
    """ # noqa: E501
    valid: Optional[StrictBool] = Field(default=None, json_schema_extra={"examples": [False]})
    error: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["Invalid or expired reset token"]})
