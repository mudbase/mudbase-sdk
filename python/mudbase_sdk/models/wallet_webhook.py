...
class WalletWebhook(BaseModel):
    ...
    def events_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['wallet.balance.updated', 'wallet.transaction.confirmed', 'wallet.transaction.failed']):
                raise ValueError("each list item must be one of ('wallet.balance.updated', 'wallet.transaction.confirmed', 'wallet.transaction.failed')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "filters": WalletWebhookFilters.from_dict(obj["filters"]) if obj.get("filters") is not None else None,
            "isActive": obj.get("isActive"),
            "stats": WalletWebhookStats.from_dict(obj["stats"]) if obj.get("stats") is not None else None,
