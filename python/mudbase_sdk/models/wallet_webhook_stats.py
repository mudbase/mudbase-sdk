...
class WalletWebhookStats(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "totalDeliveries": obj.get("totalDeliveries"),
            "successfulDeliveries": obj.get("successfulDeliveries"),
            "failedDeliveries": obj.get("failedDeliveries"),
