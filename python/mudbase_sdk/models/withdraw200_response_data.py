...
class Withdraw200ResponseData(BaseModel):
    """
    Withdraw200ResponseData
    """ # noqa: E501
    transaction_id: Optional[StrictStr] = Field(default=None, alias="transactionId")
    status: Optional[StrictStr] = None
    signed_tx: Optional[StrictStr] = Field(default=None, description="Signed transaction (hex for EVM/UTXO, base64 for Solana, object for Tron). Send as-is in broadcast body.", alias="signedTx")
    chain: Optional[StrictStr] = Field(default=None, description="Chain id for broadcast (e.g. ethereum, bitcoin, solana).")
    from_address: Optional[StrictStr] = Field(default=None, description="Sender address; must be registered for org when broadcasting.", alias="fromAddress")
    currency: Optional[StrictStr] = None
    amount: Optional[Union[StrictFloat, StrictInt]] = None
    to_address: Optional[StrictStr] = Field(default=None, alias="toAddress")
    message: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["transactionId", "status", "signedTx", "chain", "fromAddress", "currency", "amount", "toAddress", "message"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['ready_to_broadcast']):
            raise ValueError("must be one of enum values ('ready_to_broadcast')")
        return value
