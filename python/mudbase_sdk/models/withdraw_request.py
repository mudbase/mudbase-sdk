...
class WithdrawRequest(BaseModel):
    ...
    WithdrawRequest
    """ # noqa: E501
    to_address: StrictStr = Field(description="Recipient address (chain-specific format).", alias="toAddress")
    amount: Union[StrictFloat, StrictInt] = Field(description="Amount to send (numeric; currency from wallet).")
    network: Optional[StrictStr] = Field(default=None, description="For USDT wallets only; ETH, BSC, TRX, SOL, or POLYGON.")
    options: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["toAddress", "amount", "network", "options"]
