    ...
    def make_instance(self, include_optional) -> AddParticipant200Response:
        ...
        if include_optional:
            return AddParticipant200Response(
                success = True,
                data = mudbase_sdk.models.add_participant_200_response_data.addParticipant_200_response_data(
                    participants = [
                        mudbase_sdk.models.add_participant_200_response_data_participants_inner.addParticipant_200_response_data_participants_inner(
                            user_id = '', 
                            role = '', 
