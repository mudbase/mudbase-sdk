...
class TestBroadcastNonCustodialTransaction200Response(unittest.TestCase):
    """BroadcastNonCustodialTransaction200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BroadcastNonCustodialTransaction200Response:
        """Test BroadcastNonCustodialTransaction200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BroadcastNonCustodialTransaction200Response`
        """
        model = BroadcastNonCustodialTransaction200Response()
        if include_optional:
            return BroadcastNonCustodialTransaction200Response(
                success = True,
                message = '',
                data = mudbase_sdk.models.broadcast_non_custodial_transaction_200_response_data.broadcastNonCustodialTransaction_200_response_data(
                    tx_hash = '', 
                    chain = '', 
                    from_address = '', 
                    currency = '', )
    ...
    def testBroadcastNonCustodialTransaction200Response(self):
        """Test BroadcastNonCustodialTransaction200Response"""
