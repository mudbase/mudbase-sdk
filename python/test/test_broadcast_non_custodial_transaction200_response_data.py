...
class TestBroadcastNonCustodialTransaction200ResponseData(unittest.TestCase):
    """BroadcastNonCustodialTransaction200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BroadcastNonCustodialTransaction200ResponseData:
        """Test BroadcastNonCustodialTransaction200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BroadcastNonCustodialTransaction200ResponseData`
        """
        model = BroadcastNonCustodialTransaction200ResponseData()
        if include_optional:
            return BroadcastNonCustodialTransaction200ResponseData(
                tx_hash = '',
                chain = '',
                from_address = '',
                currency = ''
    ...
    def testBroadcastNonCustodialTransaction200ResponseData(self):
        """Test BroadcastNonCustodialTransaction200ResponseData"""
