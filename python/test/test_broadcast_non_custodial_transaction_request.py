...
class TestBroadcastNonCustodialTransactionRequest(unittest.TestCase):
    """BroadcastNonCustodialTransactionRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BroadcastNonCustodialTransactionRequest:
        """Test BroadcastNonCustodialTransactionRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BroadcastNonCustodialTransactionRequest`
        """
        model = BroadcastNonCustodialTransactionRequest()
        if include_optional:
            return BroadcastNonCustodialTransactionRequest(
                chain = 'ethereum',
                signed_tx = '0x02f8...',
    ...
    def testBroadcastNonCustodialTransactionRequest(self):
        """Test BroadcastNonCustodialTransactionRequest"""
