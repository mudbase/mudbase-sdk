...
from mudbase_sdk.api.bug_analysis_api import BugAnalysisApi


class TestBugAnalysisApi(unittest.TestCase):
    """BugAnalysisApi unit test stubs"""

    def setUp(self) -> None:
        self.api = BugAnalysisApi()

    def tearDown(self) -> None:
        pass

    def test_start_bug_analysis_scan(self) -> None:
        """Test case for start_bug_analysis_scan

        Start bug analysis scan (org-level)
        """
        pass

    def test_start_bug_analysis_scan_by_project(self) -> None:
        """Test case for start_bug_analysis_scan_by_project
