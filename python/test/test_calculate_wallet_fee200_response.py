...
class TestCalculateWalletFee200Response(unittest.TestCase):
    """CalculateWalletFee200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalculateWalletFee200Response:
        """Test CalculateWalletFee200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalculateWalletFee200Response`
        """
        model = CalculateWalletFee200Response()
        if include_optional:
            return CalculateWalletFee200Response(
                success = True,
                data = mudbase_sdk.models.calculate_wallet_fee_200_response_data.calculateWalletFee_200_response_data(
                    currency = '', 
                    network = '', 
                    amount = 1.337, 
                    chain = '', 
                    ...
                    gas_limit = '', 
                    gas_price = '', 
                    gas_price_gwei = 1.337, 
                    estimated_cost = '', 
                    sat_per_vb = 56, 
                    fee_sat = 56, 
                    lamports = 56, 
                    fee_tiers = {
                        'key' : mudbase_sdk.models.calculate_wallet_fee_200_response_data_fee_tiers_value.calculateWalletFee_200_response_data_feeTiers_value(
                            gas_price_gwei = 1.337, 
                            network_fee = '', )
                        }, 
                    gas_spike_warning = True, )
            )
        else:
            return CalculateWalletFee200Response(
        )
    ...
    def testCalculateWalletFee200Response(self):
        """Test CalculateWalletFee200Response"""
