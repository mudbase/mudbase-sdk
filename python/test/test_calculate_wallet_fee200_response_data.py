...
class TestCalculateWalletFee200ResponseData(unittest.TestCase):
    """CalculateWalletFee200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalculateWalletFee200ResponseData:
        """Test CalculateWalletFee200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalculateWalletFee200ResponseData`
        """
        model = CalculateWalletFee200ResponseData()
        if include_optional:
            return CalculateWalletFee200ResponseData(
                currency = '',
                network = '',
                amount = 1.337,
                chain = '',
    ...
    def testCalculateWalletFee200ResponseData(self):
        """Test CalculateWalletFee200ResponseData"""
