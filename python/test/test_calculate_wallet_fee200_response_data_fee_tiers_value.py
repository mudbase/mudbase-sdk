...
class TestCalculateWalletFee200ResponseDataFeeTiersValue(unittest.TestCase):
    """CalculateWalletFee200ResponseDataFeeTiersValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalculateWalletFee200ResponseDataFeeTiersValue:
        """Test CalculateWalletFee200ResponseDataFeeTiersValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalculateWalletFee200ResponseDataFeeTiersValue`
        """
        model = CalculateWalletFee200ResponseDataFeeTiersValue()
        if include_optional:
            return CalculateWalletFee200ResponseDataFeeTiersValue(
    ...
    def testCalculateWalletFee200ResponseDataFeeTiersValue(self):
        """Test CalculateWalletFee200ResponseDataFeeTiersValue"""
