    ...
    def make_instance(self, include_optional) -> ConfigureWebhook200Response:
        ...
        if include_optional:
            return ConfigureWebhook200Response(
                success = True,
                message = '',
                data = mudbase_sdk.models.configure_webhook_200_response_data.configureWebhook_200_response_data(
                    webhook_url = '', 
                    webhook_events = [
                        ''
                        ], 
                    webhook_version = '', 
                    transformations = [
                        mudbase_sdk.models.configure_webhook_200_response_data_transformations_inner.configureWebhook_200_response_data_transformations_inner(
                            type = 'jsonPath', 
