    ...
    def make_instance(self, include_optional) -> CreateCollection201Response:
        ...
        if include_optional:
            return CreateCollection201Response(
                message = '',
                collection = mudbase_sdk.models.collection.Collection(
                    _id = '', 
                    name = '', 
                    slug = '', 
                    project = '', 
                    fields = [
                        mudbase_sdk.models.field.Field(
                            name = '', 
                            type = 'string', 
                            required = True, 
                            unique = True, 
                            default = null, 
                            validation = mudbase_sdk.models.validation.validation(), 
                            ui = mudbase_sdk.models.ui.ui(), )
                        ], 
                    permissions = [
                        mudbase_sdk.models.permission.Permission(
                            role = '', 
                            actions = [
                                'create'
                                ], 
                            condition = mudbase_sdk.models.condition.condition(), )
                        ], 
