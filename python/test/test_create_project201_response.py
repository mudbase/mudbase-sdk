    ...
    def make_instance(self, include_optional) -> CreateProject201Response:
        ...
        if include_optional:
            return CreateProject201Response(
                message = '',
                project = mudbase_sdk.models.project.Project(
                    _id = '', 
                    name = '', 
                    description = '', 
                    slug = '', 
                    org = '', 
                    auth = mudbase_sdk.models.auth_config.AuthConfig(
                        providers = [
                            mudbase_sdk.models.auth_provider.AuthProvider(
                                name = '', 
                                enabled = True, 
                                config = mudbase_sdk.models.config.config(), )
                            ], 
                        notify_on_new_sign_in = True, ), 
                    database = mudbase_sdk.models.database_config.DatabaseConfig(
                        collections = [
                            ''
                            ], ), 
                    storage = mudbase_sdk.models.storage_config.StorageConfig(
                        buckets = [
                            ''
                            ], ), 
                    settings = mudbase_sdk.models.project_settings.ProjectSettings(
                    ...
                    usage = mudbase_sdk.models.project_usage.ProjectUsage(
                        api_calls = 56, 
                        bandwidth = 56, 
                        db_reads = 56, 
                        db_writes = 56, ), 
