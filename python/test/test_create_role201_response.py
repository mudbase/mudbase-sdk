    ...
    def make_instance(self, include_optional) -> CreateRole201Response:
        ...
        if include_optional:
            return CreateRole201Response(
                ...
                role = mudbase_sdk.models.create_role_201_response_role.createRole_201_response_role(
                    _id = '', 
                    name = '', 
                    slug = '', 
                    description = '', 
                    permissions = [
                        mudbase_sdk.models.create_role_201_response_role_permissions_inner.createRole_201_response_role_permissions_inner(
                            resource = '', 
                            actions = [
                                ''
                                ], 
                            conditions = mudbase_sdk.models.conditions.conditions(), )
                        ], 
                    hierarchy = 1.337, 
                    is_system = True, 
                    is_active = True, )
