...
class TestCreateRoleRequestCollectionPermissionsValueOneOf(unittest.TestCase):
    """CreateRoleRequestCollectionPermissionsValueOneOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateRoleRequestCollectionPermissionsValueOneOf:
        """Test CreateRoleRequestCollectionPermissionsValueOneOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateRoleRequestCollectionPermissionsValueOneOf`
        """
        model = CreateRoleRequestCollectionPermissionsValueOneOf()
        if include_optional:
            return CreateRoleRequestCollectionPermissionsValueOneOf(
                actions = [
                    'create'
                    ],
                conditions = None
    ...
    def testCreateRoleRequestCollectionPermissionsValueOneOf(self):
        """Test CreateRoleRequestCollectionPermissionsValueOneOf"""
