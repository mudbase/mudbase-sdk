...
class TestCreateWallet201Response(unittest.TestCase):
    """CreateWallet201Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateWallet201Response:
        """Test CreateWallet201Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateWallet201Response`
        """
        model = CreateWallet201Response()
        if include_optional:
            return CreateWallet201Response(
                success = True,
                data = mudbase_sdk.models.create_wallet_201_response_data.createWallet_201_response_data(
                    _id = '', 
                    currency = '', 
                    address = '', 
                    balance = '', 
    ...
    def testCreateWallet201Response(self):
        """Test CreateWallet201Response"""
