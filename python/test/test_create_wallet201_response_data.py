...
class TestCreateWallet201ResponseData(unittest.TestCase):
    """CreateWallet201ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateWallet201ResponseData:
        """Test CreateWallet201ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateWallet201ResponseData`
        """
        model = CreateWallet201ResponseData()
        if include_optional:
            return CreateWallet201ResponseData(
                id = '',
                currency = '',
                address = '',
                balance = '',
    ...
    def testCreateWallet201ResponseData(self):
        """Test CreateWallet201ResponseData"""
