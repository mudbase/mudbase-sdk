...
class TestCreateWalletWebhookRequest(unittest.TestCase):
    """CreateWalletWebhookRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateWalletWebhookRequest:
        """Test CreateWalletWebhookRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateWalletWebhookRequest`
        """
        model = CreateWalletWebhookRequest()
        if include_optional:
            return CreateWalletWebhookRequest(
                url = 'https://your-app.com/webhooks/wallet',
                events = ["wallet.balance.updated","wallet.transaction.confirmed"],
                secret = 'whsec_abc123xyz789',
                filters = mudbase_sdk.models.create_wallet_webhook_request_filters.createWalletWebhook_request_filters(
    ...
    def testCreateWalletWebhookRequest(self):
        """Test CreateWalletWebhookRequest"""
