...
class TestCreateWalletWebhookRequestFilters(unittest.TestCase):
    """CreateWalletWebhookRequestFilters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateWalletWebhookRequestFilters:
        """Test CreateWalletWebhookRequestFilters
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateWalletWebhookRequestFilters`
        """
        model = CreateWalletWebhookRequestFilters()
        if include_optional:
            return CreateWalletWebhookRequestFilters(
    ...
    def testCreateWalletWebhookRequestFilters(self):
        """Test CreateWalletWebhookRequestFilters"""
