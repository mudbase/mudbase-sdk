...
class TestEstimateNetworkFeeRequest(unittest.TestCase):
    """EstimateNetworkFeeRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EstimateNetworkFeeRequest:
        """Test EstimateNetworkFeeRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EstimateNetworkFeeRequest`
        """
        model = EstimateNetworkFeeRequest()
        if include_optional:
            return EstimateNetworkFeeRequest(
                currency = 'BTC',
                amount = 0,
                network = 'ETH'
            )
    ...
    def testEstimateNetworkFeeRequest(self):
        """Test EstimateNetworkFeeRequest"""
