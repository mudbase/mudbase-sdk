...
class TestEstimateNonCustodialGas200Response(unittest.TestCase):
    """EstimateNonCustodialGas200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EstimateNonCustodialGas200Response:
        """Test EstimateNonCustodialGas200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EstimateNonCustodialGas200Response`
        """
        model = EstimateNonCustodialGas200Response()
        if include_optional:
            return EstimateNonCustodialGas200Response(
                success = True,
                data = mudbase_sdk.models.estimate_non_custodial_gas_200_response_data.estimateNonCustodialGas_200_response_data(
                    chain = '', 
                    gas_limit = '21000', 
    ...
    def testEstimateNonCustodialGas200Response(self):
        """Test EstimateNonCustodialGas200Response"""
