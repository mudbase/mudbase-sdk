...
class TestEstimateNonCustodialGas200ResponseData(unittest.TestCase):
    """EstimateNonCustodialGas200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EstimateNonCustodialGas200ResponseData:
        """Test EstimateNonCustodialGas200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EstimateNonCustodialGas200ResponseData`
        """
        model = EstimateNonCustodialGas200ResponseData()
        if include_optional:
            return EstimateNonCustodialGas200ResponseData(
                chain = '',
                gas_limit = '21000',
    ...
    def testEstimateNonCustodialGas200ResponseData(self):
        """Test EstimateNonCustodialGas200ResponseData"""
