...
class TestEstimateNonCustodialGasRequest(unittest.TestCase):
    """EstimateNonCustodialGasRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EstimateNonCustodialGasRequest:
        """Test EstimateNonCustodialGasRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EstimateNonCustodialGasRequest`
        """
        model = EstimateNonCustodialGasRequest()
        if include_optional:
            return EstimateNonCustodialGasRequest(
                chain = 'ethereum',
                transaction = mudbase_sdk.models.estimate_non_custodial_gas_request_transaction.estimateNonCustodialGas_request_transaction(
    ...
    def testEstimateNonCustodialGasRequest(self):
        """Test EstimateNonCustodialGasRequest"""
