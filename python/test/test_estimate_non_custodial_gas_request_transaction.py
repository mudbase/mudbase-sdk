...
class TestEstimateNonCustodialGasRequestTransaction(unittest.TestCase):
    """EstimateNonCustodialGasRequestTransaction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EstimateNonCustodialGasRequestTransaction:
        """Test EstimateNonCustodialGasRequestTransaction
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EstimateNonCustodialGasRequestTransaction`
        """
        model = EstimateNonCustodialGasRequestTransaction()
        if include_optional:
            return EstimateNonCustodialGasRequestTransaction(
    ...
    def testEstimateNonCustodialGasRequestTransaction(self):
        """Test EstimateNonCustodialGasRequestTransaction"""
