    ...
    def make_instance(self, include_optional) -> FunctionExecutionStatusResponse:
        ...
        if include_optional:
            return FunctionExecutionStatusResponse(
                success = True,
                data = mudbase_sdk.models.function_execution_status_response_data.FunctionExecutionStatusResponse_data(
                    execution_id = '', 
                    status = 'queued', 
                    duration_ms = 56, 
                    result = mudbase_sdk.models.result.result(), 
                    error = '', 
                    error_class = '', 
                    logs = mudbase_sdk.models.function_execution_status_response_data_logs.FunctionExecutionStatusResponse_data_logs(
                        stdout = '', 
                        stderr = '', 
                        truncated = True, 
                        bytes = 56, ), 
                    machine = mudbase_sdk.models.machine.machine(), 
