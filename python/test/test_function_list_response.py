    ...
    def make_instance(self, include_optional) -> FunctionListResponse:
        ...
        if include_optional:
            return FunctionListResponse(
                success = True,
                data = mudbase_sdk.models.function_list_response_data.FunctionListResponse_data(
                    functions = [
                        mudbase_sdk.models.function.Function(
                            _id = '', 
                            name = '', 
                            description = '', 
                            project_id = '', 
                            trigger = mudbase_sdk.models.function_trigger.FunctionTrigger(
                                type = 'http', 
                                event = '', 
                                schedule = '', 
                                path = '', 
                                ...
                                collection_id = '', 
                                bucket_id = '', ), 
                            stats = mudbase_sdk.models.function_stats.FunctionStats(
                                total_executions = 56, 
                    ...
                    pagination = mudbase_sdk.models.pagination.Pagination(
                        page = 56, 
                        limit = 56, 
                        total = 56, 
                        total_pages = 56, ), )
