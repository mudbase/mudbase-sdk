    ...
    def make_instance(self, include_optional) -> GenerateAccessReview200Response:
        ...
        if include_optional:
            return GenerateAccessReview200Response(
                report = mudbase_sdk.models.generate_access_review_200_response_report.generateAccessReview_200_response_report(
                    org_id = '', 
                    review_period = mudbase_sdk.models.review_period.reviewPeriod(), 
                    users = [
                        None
                        ], 
                    summary = mudbase_sdk.models.summary.summary(), 
                    recommendations = [
                        ''
                        ], 
