    ...
    def make_instance(self, include_optional) -> GenerateDataProcessingRecord200Response:
        ...
        if include_optional:
            return GenerateDataProcessingRecord200Response(
                record = mudbase_sdk.models.generate_data_processing_record_200_response_record.generateDataProcessingRecord_200_response_record(
                    org_id = '', 
                    record_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    data_controller = mudbase_sdk.models.data_controller.dataController(), 
