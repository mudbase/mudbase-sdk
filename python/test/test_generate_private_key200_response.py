...
class TestGeneratePrivateKey200Response(unittest.TestCase):
    """GeneratePrivateKey200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GeneratePrivateKey200Response:
        """Test GeneratePrivateKey200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GeneratePrivateKey200Response`
        """
        model = GeneratePrivateKey200Response()
        if include_optional:
            return GeneratePrivateKey200Response(
                success = True,
                data = mudbase_sdk.models.generate_private_key_200_response_data.generatePrivateKey_200_response_data(
                    currency = '', 
                    private_key = '', 
                    public_key = '', 
                    warning = '', )
    ...
    def testGeneratePrivateKey200Response(self):
        """Test GeneratePrivateKey200Response"""
