...
class TestGeneratePrivateKey200ResponseData(unittest.TestCase):
    """GeneratePrivateKey200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GeneratePrivateKey200ResponseData:
        """Test GeneratePrivateKey200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GeneratePrivateKey200ResponseData`
        """
        model = GeneratePrivateKey200ResponseData()
        if include_optional:
            return GeneratePrivateKey200ResponseData(
                currency = '',
                private_key = '',
                public_key = '',
                warning = ''
    ...
    def testGeneratePrivateKey200ResponseData(self):
        """Test GeneratePrivateKey200ResponseData"""
