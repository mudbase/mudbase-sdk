...
class TestGeneratePrivateKeyRequest(unittest.TestCase):
    """GeneratePrivateKeyRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GeneratePrivateKeyRequest:
        """Test GeneratePrivateKeyRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GeneratePrivateKeyRequest`
        """
        model = GeneratePrivateKeyRequest()
        if include_optional:
            return GeneratePrivateKeyRequest(
                currency = 'BTC'
            )
        else:
            return GeneratePrivateKeyRequest(
    ...
    def testGeneratePrivateKeyRequest(self):
        """Test GeneratePrivateKeyRequest"""
