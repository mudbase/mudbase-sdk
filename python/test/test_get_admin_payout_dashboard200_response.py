...
class TestGetAdminPayoutDashboard200Response(unittest.TestCase):
    """GetAdminPayoutDashboard200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAdminPayoutDashboard200Response:
        """Test GetAdminPayoutDashboard200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAdminPayoutDashboard200Response`
        """
        model = GetAdminPayoutDashboard200Response()
        if include_optional:
            return GetAdminPayoutDashboard200Response(
                success = True,
                data = mudbase_sdk.models.get_admin_payout_dashboard_200_response_data.getAdminPayoutDashboard_200_response_data(
                    total_pending = 56, 
                    total_completed = 56, 
                    total_failed = 56, 
                    by_currency = [
                        mudbase_sdk.models.get_admin_payout_dashboard_200_response_data_by_currency_inner.getAdminPayoutDashboard_200_response_data_byCurrency_inner(
                            currency = '', 
                            pending = 56, 
                            completed = 56, 
                            failed = 56, )
    ...
    def testGetAdminPayoutDashboard200Response(self):
        """Test GetAdminPayoutDashboard200Response"""
