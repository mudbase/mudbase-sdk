...
class TestGetAdminPayoutDashboard200ResponseData(unittest.TestCase):
    """GetAdminPayoutDashboard200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAdminPayoutDashboard200ResponseData:
        """Test GetAdminPayoutDashboard200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAdminPayoutDashboard200ResponseData`
        """
        model = GetAdminPayoutDashboard200ResponseData()
        if include_optional:
            return GetAdminPayoutDashboard200ResponseData(
                total_pending = 56,
                total_completed = 56,
                total_failed = 56,
                by_currency = [
    ...
    def testGetAdminPayoutDashboard200ResponseData(self):
        """Test GetAdminPayoutDashboard200ResponseData"""
