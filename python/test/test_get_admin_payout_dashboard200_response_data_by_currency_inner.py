...
class TestGetAdminPayoutDashboard200ResponseDataByCurrencyInner(unittest.TestCase):
    """GetAdminPayoutDashboard200ResponseDataByCurrencyInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAdminPayoutDashboard200ResponseDataByCurrencyInner:
        """Test GetAdminPayoutDashboard200ResponseDataByCurrencyInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAdminPayoutDashboard200ResponseDataByCurrencyInner`
        """
        model = GetAdminPayoutDashboard200ResponseDataByCurrencyInner()
        if include_optional:
            return GetAdminPayoutDashboard200ResponseDataByCurrencyInner(
                currency = '',
                pending = 56,
                completed = 56,
                failed = 56
    ...
    def testGetAdminPayoutDashboard200ResponseDataByCurrencyInner(self):
        """Test GetAdminPayoutDashboard200ResponseDataByCurrencyInner"""
