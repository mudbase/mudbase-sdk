...
class TestGetAllFees200Response(unittest.TestCase):
    """GetAllFees200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAllFees200Response:
        """Test GetAllFees200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAllFees200Response`
        """
        model = GetAllFees200Response()
        if include_optional:
            return GetAllFees200Response(
                success = True,
                data = mudbase_sdk.models.get_all_fees_200_response_data.getAllFees_200_response_data(
                    fees = {
                        'key' : None
                        }, 
    ...
    def testGetAllFees200Response(self):
        """Test GetAllFees200Response"""
