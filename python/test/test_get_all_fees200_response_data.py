...
class TestGetAllFees200ResponseData(unittest.TestCase):
    """GetAllFees200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAllFees200ResponseData:
        """Test GetAllFees200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAllFees200ResponseData`
        """
        model = GetAllFees200ResponseData()
        if include_optional:
            return GetAllFees200ResponseData(
                fees = {
                    'key' : None
                    },
    ...
    def testGetAllFees200ResponseData(self):
        """Test GetAllFees200ResponseData"""
