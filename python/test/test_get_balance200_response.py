...
class TestGetBalance200Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetBalance200Response:
        """Test GetBalance200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetBalance200Response`
        """
        model = GetBalance200Response()
        if include_optional:
            return GetBalance200Response(
                success = True,
                data = mudbase_sdk.models.get_balance_200_response_data.getBalance_200_response_data(
                    wallet_id = '', 
                    currency = '', 
                    address = '', 
                    balance = '', 
    ...
    def testGetBalance200Response(self):
        """Test GetBalance200Response"""
