...
class TestGetBalance200ResponseData(unittest.TestCase):
    """GetBalance200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetBalance200ResponseData:
        """Test GetBalance200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetBalance200ResponseData`
        """
        model = GetBalance200ResponseData()
        if include_optional:
            return GetBalance200ResponseData(
                wallet_id = '',
                currency = '',
                address = '',
                balance = '',
    ...
    def testGetBalance200ResponseData(self):
        """Test GetBalance200ResponseData"""
