    ...
    def make_instance(self, include_optional) -> GetBillingEstimate200Response:
        ...
        if include_optional:
            return GetBillingEstimate200Response(
                period = '',
                line_items = [
                    mudbase_sdk.models.get_billing_estimate_200_response_line_items_inner.getBillingEstimate_200_response_lineItems_inner(
                        resource = '', 
                        units = 1.337, 
                        amount = 1.337, 
                        currency = '', 
                ...
                message = '',
                spend_limits = mudbase_sdk.models.get_billing_estimate_200_response_spend_limits.getBillingEstimate_200_response_spendLimits(
