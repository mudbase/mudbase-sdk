...
class TestGetCancelParams200Response(unittest.TestCase):
    """GetCancelParams200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCancelParams200Response:
        """Test GetCancelParams200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCancelParams200Response`
        """
        model = GetCancelParams200Response()
        if include_optional:
            return GetCancelParams200Response(
                success = True,
                data = mudbase_sdk.models.get_cancel_params_200_response_data.getCancelParams_200_response_data(
                    chain_id = 56, 
                    from = '', 
                    nonce = 56, 
                    to = '', 
    ...
    def testGetCancelParams200Response(self):
        """Test GetCancelParams200Response"""
