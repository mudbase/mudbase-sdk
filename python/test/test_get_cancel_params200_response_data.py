...
class TestGetCancelParams200ResponseData(unittest.TestCase):
    """GetCancelParams200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCancelParams200ResponseData:
        """Test GetCancelParams200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCancelParams200ResponseData`
        """
        model = GetCancelParams200ResponseData()
        if include_optional:
            return GetCancelParams200ResponseData(
                chain_id = 56,
                var_from = '',
                nonce = 56,
                to = '',
    ...
    def testGetCancelParams200ResponseData(self):
        """Test GetCancelParams200ResponseData"""
