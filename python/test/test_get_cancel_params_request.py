...
class TestGetCancelParamsRequest(unittest.TestCase):
    """GetCancelParamsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetCancelParamsRequest:
        """Test GetCancelParamsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetCancelParamsRequest`
        """
        model = GetCancelParamsRequest()
        if include_optional:
    ...
    def testGetCancelParamsRequest(self):
        """Test GetCancelParamsRequest"""
