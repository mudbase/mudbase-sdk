    ...
    def make_instance(self, include_optional) -> GetChatDetails200Response:
        ...
        if include_optional:
            return GetChatDetails200Response(
                success = True,
                data = mudbase_sdk.models.get_chat_details_200_response_data.getChatDetails_200_response_data(
                    _id = '', 
                    name = '', 
                    participants = [
                        mudbase_sdk.models.get_chat_details_200_response_data_participants_inner.getChatDetails_200_response_data_participants_inner(
                            user_id = '', 
                            role = '', )
                        ], )
            )
