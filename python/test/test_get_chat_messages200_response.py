    ...
    def make_instance(self, include_optional) -> GetChatMessages200Response:
        ...
        if include_optional:
            return GetChatMessages200Response(
                success = True,
                data = mudbase_sdk.models.get_chat_messages_200_response_data.getChatMessages_200_response_data(
                    messages = [
                        mudbase_sdk.models.get_chat_messages_200_response_data_messages_inner.getChatMessages_200_response_data_messages_inner(
                            _id = '', 
                            content = '', 
                            sender = mudbase_sdk.models.get_chat_messages_200_response_data_messages_inner_sender.getChatMessages_200_response_data_messages_inner_sender(
                                _id = '', 
                                first_name = '', ), 
