    ...
    def make_instance(self, include_optional) -> GetComplianceSummary200Response:
        ...
        if include_optional:
            return GetComplianceSummary200Response(
                compliance = mudbase_sdk.models.get_compliance_summary_200_response_compliance.getComplianceSummary_200_response_compliance(
                    gdpr = mudbase_sdk.models.get_compliance_summary_200_response_compliance_gdpr.getComplianceSummary_200_response_compliance_gdpr(
                        data_export_enabled = True, 
                        data_erasure_enabled = True, 
                        consent_management = True, ), 
                    soc2 = mudbase_sdk.models.get_compliance_summary_200_response_compliance_soc2.getComplianceSummary_200_response_compliance_soc2(
                        access_reviews_enabled = True, 
                        audit_logging_enabled = True, 
                        encryption_enabled = True, ), 
                    security = mudbase_sdk.models.get_compliance_summary_200_response_compliance_security.getComplianceSummary_200_response_compliance_security(
                        password_policy = '', 
                        virus_scanning = True, 
