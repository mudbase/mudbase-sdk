...
class TestGetDashboardOrganizationDetail200ResponseOrganization(unittest.TestCase):
    """GetDashboardOrganizationDetail200ResponseOrganization unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetDashboardOrganizationDetail200ResponseOrganization:
        """Test GetDashboardOrganizationDetail200ResponseOrganization
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetDashboardOrganizationDetail200ResponseOrganization`
        """
        model = GetDashboardOrganizationDetail200ResponseOrganization()
        if include_optional:
            return GetDashboardOrganizationDetail200ResponseOrganization(
                id = '',
                name = '',
                slug = '',
                description = '',
    ...
    def testGetDashboardOrganizationDetail200ResponseOrganization(self):
        """Test GetDashboardOrganizationDetail200ResponseOrganization"""
