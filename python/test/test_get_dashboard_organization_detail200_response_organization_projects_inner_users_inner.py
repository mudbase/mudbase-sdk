...
class TestGetDashboardOrganizationDetail200ResponseOrganizationProjectsInnerUsersInner(unittest.TestCase):
    """GetDashboardOrganizationDetail200ResponseOrganizationProjectsInnerUsersInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetDashboardOrganizationDetail200ResponseOrganizationProjectsInnerUsersInner:
        """Test GetDashboardOrganizationDetail200ResponseOrganizationProjectsInnerUsersInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetDashboardOrganizationDetail200ResponseOrganizationProjectsInnerUsersInner`
        """
        model = GetDashboardOrganizationDetail200ResponseOrganizationProjectsInnerUsersInner()
        if include_optional:
            return GetDashboardOrganizationDetail200ResponseOrganizationProjectsInnerUsersInner(
                id = '',
                first_name = '',
                last_name = '',
                email = '',
    ...
    def testGetDashboardOrganizationDetail200ResponseOrganizationProjectsInnerUsersInner(self):
        """Test GetDashboardOrganizationDetail200ResponseOrganizationProjectsInnerUsersInner"""
