...
class TestGetDashboardOrganizationDetail200ResponseOrganizationUsersInner(unittest.TestCase):
    """GetDashboardOrganizationDetail200ResponseOrganizationUsersInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetDashboardOrganizationDetail200ResponseOrganizationUsersInner:
        """Test GetDashboardOrganizationDetail200ResponseOrganizationUsersInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetDashboardOrganizationDetail200ResponseOrganizationUsersInner`
        """
        model = GetDashboardOrganizationDetail200ResponseOrganizationUsersInner()
        if include_optional:
            return GetDashboardOrganizationDetail200ResponseOrganizationUsersInner(
                id = '',
                first_name = '',
                last_name = '',
                email = '',
    ...
    def testGetDashboardOrganizationDetail200ResponseOrganizationUsersInner(self):
        """Test GetDashboardOrganizationDetail200ResponseOrganizationUsersInner"""
