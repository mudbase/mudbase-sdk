...
class TestGetDashboardOrganizations200Response(unittest.TestCase):
    """GetDashboardOrganizations200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetDashboardOrganizations200Response:
        """Test GetDashboardOrganizations200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetDashboardOrganizations200Response`
        """
        model = GetDashboardOrganizations200Response()
        if include_optional:
            return GetDashboardOrganizations200Response(
                success = True,
                organizations = [
                    mudbase_sdk.models.get_dashboard_organizations_200_response_organizations_inner.getDashboardOrganizations_200_response_organizations_inner(
                        _id = '', 
                        name = '', 
                        slug = '', 
                        description = '', 
    ...
    def testGetDashboardOrganizations200Response(self):
        """Test GetDashboardOrganizations200Response"""
