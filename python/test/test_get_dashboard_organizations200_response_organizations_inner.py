...
class TestGetDashboardOrganizations200ResponseOrganizationsInner(unittest.TestCase):
    """GetDashboardOrganizations200ResponseOrganizationsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetDashboardOrganizations200ResponseOrganizationsInner:
        """Test GetDashboardOrganizations200ResponseOrganizationsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetDashboardOrganizations200ResponseOrganizationsInner`
        """
        model = GetDashboardOrganizations200ResponseOrganizationsInner()
        if include_optional:
            return GetDashboardOrganizations200ResponseOrganizationsInner(
                id = '',
                name = '',
                slug = '',
                description = '',
                ...
                created_by = mudbase_sdk.models.get_dashboard_organizations_200_response_organizations_inner_created_by.getDashboardOrganizations_200_response_organizations_inner_createdBy(
                    _id = '', 
                    first_name = '', 
                    last_name = '', 
                    email = '', ),
                ...
                user_count = 56,
                projects = [
                    mudbase_sdk.models.get_organization_users_200_response_users_inner_project.getOrganizationUsers_200_response_users_inner_project(
                        _id = '', 
                        name = '', 
                        slug = '', )
                    ]
    ...
    def testGetDashboardOrganizations200ResponseOrganizationsInner(self):
        """Test GetDashboardOrganizations200ResponseOrganizationsInner"""
