...
class TestGetDashboardOrganizations200ResponseOrganizationsInnerCreatedBy(unittest.TestCase):
    """GetDashboardOrganizations200ResponseOrganizationsInnerCreatedBy unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetDashboardOrganizations200ResponseOrganizationsInnerCreatedBy:
        """Test GetDashboardOrganizations200ResponseOrganizationsInnerCreatedBy
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetDashboardOrganizations200ResponseOrganizationsInnerCreatedBy`
        """
        model = GetDashboardOrganizations200ResponseOrganizationsInnerCreatedBy()
        if include_optional:
            return GetDashboardOrganizations200ResponseOrganizationsInnerCreatedBy(
                id = '',
                first_name = '',
                last_name = '',
                email = ''
    ...
    def testGetDashboardOrganizations200ResponseOrganizationsInnerCreatedBy(self):
        """Test GetDashboardOrganizations200ResponseOrganizationsInnerCreatedBy"""
