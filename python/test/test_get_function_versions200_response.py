    ...
    def make_instance(self, include_optional) -> GetFunctionVersions200Response:
        ...
        if include_optional:
            return GetFunctionVersions200Response(
                success = True,
                data = mudbase_sdk.models.get_function_versions_200_response_data.getFunctionVersions_200_response_data(
                    versions = [
                        mudbase_sdk.models.get_function_versions_200_response_data_versions_inner.getFunctionVersions_200_response_data_versions_inner(
                            _id = '', 
                            code = '', 
                            version = 56, 
