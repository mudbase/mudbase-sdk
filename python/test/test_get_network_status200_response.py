...
class TestGetNetworkStatus200Response(unittest.TestCase):
    """GetNetworkStatus200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetNetworkStatus200Response:
        """Test GetNetworkStatus200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetNetworkStatus200Response`
        """
        model = GetNetworkStatus200Response()
        if include_optional:
            return GetNetworkStatus200Response(
                success = True,
                data = {
                    'key' : mudbase_sdk.models.get_network_status_200_response_data_value.getNetworkStatus_200_response_data_value(
                        congestion = 'low', 
    ...
    def testGetNetworkStatus200Response(self):
        """Test GetNetworkStatus200Response"""
