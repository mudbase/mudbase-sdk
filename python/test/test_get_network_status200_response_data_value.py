...
class TestGetNetworkStatus200ResponseDataValue(unittest.TestCase):
    """GetNetworkStatus200ResponseDataValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetNetworkStatus200ResponseDataValue:
        """Test GetNetworkStatus200ResponseDataValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetNetworkStatus200ResponseDataValue`
        """
        model = GetNetworkStatus200ResponseDataValue()
        if include_optional:
            return GetNetworkStatus200ResponseDataValue(
                congestion = 'low',
    ...
    def testGetNetworkStatus200ResponseDataValue(self):
        """Test GetNetworkStatus200ResponseDataValue"""
