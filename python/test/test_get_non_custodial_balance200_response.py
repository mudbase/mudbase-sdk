...
class TestGetNonCustodialBalance200Response(unittest.TestCase):
    """GetNonCustodialBalance200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetNonCustodialBalance200Response:
        """Test GetNonCustodialBalance200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetNonCustodialBalance200Response`
        """
        model = GetNonCustodialBalance200Response()
        if include_optional:
            return GetNonCustodialBalance200Response(
                success = True,
                data = mudbase_sdk.models.wallet_balance.WalletBalance(
    ...
    def testGetNonCustodialBalance200Response(self):
        """Test GetNonCustodialBalance200Response"""
