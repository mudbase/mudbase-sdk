...
class TestGetNonCustodialTransactions200Response(unittest.TestCase):
    """GetNonCustodialTransactions200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetNonCustodialTransactions200Response:
        """Test GetNonCustodialTransactions200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetNonCustodialTransactions200Response`
        """
        model = GetNonCustodialTransactions200Response()
        if include_optional:
            return GetNonCustodialTransactions200Response(
                success = True,
                data = [
                    mudbase_sdk.models.wallet_transaction.WalletTransaction(
                        ...
                        token_transfers = [
                            mudbase_sdk.models.wallet_transaction_token_transfers_inner.WalletTransaction_tokenTransfers_inner(
                ...
                pagination = mudbase_sdk.models.get_transaction_history_200_response_pagination.getTransactionHistory_200_response_pagination(
                    page = 56, 
                    limit = 56, 
                    count = 56, 
                    total = 56, 
    ...
    def testGetNonCustodialTransactions200Response(self):
        """Test GetNonCustodialTransactions200Response"""
