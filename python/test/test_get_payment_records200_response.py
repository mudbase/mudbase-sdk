    ...
    def make_instance(self, include_optional) -> GetPaymentRecords200Response:
        ...
        if include_optional:
            return GetPaymentRecords200Response(
                success = True,
                data = mudbase_sdk.models.get_payment_records_200_response_data.getPaymentRecords_200_response_data(
                    records = [
                        mudbase_sdk.models.get_payment_records_200_response_data_records_inner.getPaymentRecords_200_response_data_records_inner(
                            tx_ref = '', 
                            amount = 1.337, 
                            org_receives = 1.337, 
                            status = '', 
                    ...
                    pagination = mudbase_sdk.models.get_payment_records_200_response_data_pagination.getPaymentRecords_200_response_data_pagination(
                        page = 56, 
                        limit = 56, 
                        total = 56, 
                        pages = 56, ), )
