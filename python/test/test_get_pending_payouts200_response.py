...
class TestGetPendingPayouts200Response(unittest.TestCase):
    """GetPendingPayouts200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPendingPayouts200Response:
        """Test GetPendingPayouts200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPendingPayouts200Response`
        """
        model = GetPendingPayouts200Response()
        if include_optional:
            return GetPendingPayouts200Response(
                success = True,
                data = [
                    mudbase_sdk.models.get_pending_payouts_200_response_data_inner.getPendingPayouts_200_response_data_inner(
                        _id = '', 
                        project = '', 
                        currency = '', 
                        gross_amount = 1.337, 
    ...
    def testGetPendingPayouts200Response(self):
        """Test GetPendingPayouts200Response"""
