...
class TestGetPendingPayouts200ResponseDataInner(unittest.TestCase):
    """GetPendingPayouts200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPendingPayouts200ResponseDataInner:
        """Test GetPendingPayouts200ResponseDataInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPendingPayouts200ResponseDataInner`
        """
        model = GetPendingPayouts200ResponseDataInner()
        if include_optional:
            return GetPendingPayouts200ResponseDataInner(
                id = '',
                project = '',
                currency = '',
                gross_amount = 1.337,
    ...
    def testGetPendingPayouts200ResponseDataInner(self):
        """Test GetPendingPayouts200ResponseDataInner"""
