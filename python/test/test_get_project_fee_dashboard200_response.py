    ...
    def make_instance(self, include_optional) -> GetProjectFeeDashboard200Response:
        ...
        if include_optional:
            return GetProjectFeeDashboard200Response(
                success = True,
                data = mudbase_sdk.models.get_project_fee_dashboard_200_response_data.getProjectFeeDashboard_200_response_data(
                    fee_settings = mudbase_sdk.models.fee_settings.feeSettings(), 
                    balances = [
                        mudbase_sdk.models.get_project_fee_dashboard_200_response_data_balances_inner.getProjectFeeDashboard_200_response_data_balances_inner(
                            currency = '', 
                            balance = '', 
                            pending = '', )
                        ], 
                    recent_payouts = [
                        mudbase_sdk.models.get_project_fee_dashboard_200_response_data_recent_payouts_inner.getProjectFeeDashboard_200_response_data_recentPayouts_inner(
                            _id = '', 
                            amount = '', 
                            currency = '', 
                            status = '', 
