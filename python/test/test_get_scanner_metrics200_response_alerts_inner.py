...
class TestGetScannerMetrics200ResponseAlertsInner(unittest.TestCase):
    """GetScannerMetrics200ResponseAlertsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetScannerMetrics200ResponseAlertsInner:
        """Test GetScannerMetrics200ResponseAlertsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetScannerMetrics200ResponseAlertsInner`
        """
        model = GetScannerMetrics200ResponseAlertsInner()
        if include_optional:
            return GetScannerMetrics200ResponseAlertsInner(
                chain = '',
                lag = 1.337,
                threshold = 1.337
            )
    ...
    def testGetScannerMetrics200ResponseAlertsInner(self):
        """Test GetScannerMetrics200ResponseAlertsInner"""
