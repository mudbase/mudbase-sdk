...
class TestGetScannerMetrics200ResponseMetricsValue(unittest.TestCase):
    """GetScannerMetrics200ResponseMetricsValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetScannerMetrics200ResponseMetricsValue:
        """Test GetScannerMetrics200ResponseMetricsValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetScannerMetrics200ResponseMetricsValue`
        """
        model = GetScannerMetrics200ResponseMetricsValue()
        if include_optional:
            return GetScannerMetrics200ResponseMetricsValue(
    ...
    def testGetScannerMetrics200ResponseMetricsValue(self):
        """Test GetScannerMetrics200ResponseMetricsValue"""
