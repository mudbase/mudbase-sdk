...
class TestGetSpeedUpParams200Response(unittest.TestCase):
    """GetSpeedUpParams200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSpeedUpParams200Response:
        """Test GetSpeedUpParams200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSpeedUpParams200Response`
        """
        model = GetSpeedUpParams200Response()
        if include_optional:
            return GetSpeedUpParams200Response(
                success = True,
                data = mudbase_sdk.models.get_speed_up_params_200_response_data.getSpeedUpParams_200_response_data(
                    chain_id = 56, 
                    from = '', 
                    nonce = 56, 
                    to = '', 
    ...
    def testGetSpeedUpParams200Response(self):
        """Test GetSpeedUpParams200Response"""
