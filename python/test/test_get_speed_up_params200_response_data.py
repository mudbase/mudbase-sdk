...
class TestGetSpeedUpParams200ResponseData(unittest.TestCase):
    """GetSpeedUpParams200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSpeedUpParams200ResponseData:
        """Test GetSpeedUpParams200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSpeedUpParams200ResponseData`
        """
        model = GetSpeedUpParams200ResponseData()
        if include_optional:
            return GetSpeedUpParams200ResponseData(
                chain_id = 56,
                var_from = '',
                nonce = 56,
                to = '',
    ...
    def testGetSpeedUpParams200ResponseData(self):
        """Test GetSpeedUpParams200ResponseData"""
