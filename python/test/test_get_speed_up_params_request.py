...
class TestGetSpeedUpParamsRequest(unittest.TestCase):
    """GetSpeedUpParamsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSpeedUpParamsRequest:
        """Test GetSpeedUpParamsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSpeedUpParamsRequest`
        """
        model = GetSpeedUpParamsRequest()
        if include_optional:
            return GetSpeedUpParamsRequest(
                tx_id = '',
                tx_hash = '',
                chain = 'ethereum'
            )
    ...
    def testGetSpeedUpParamsRequest(self):
        """Test GetSpeedUpParamsRequest"""
