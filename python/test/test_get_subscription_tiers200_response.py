    ...
    def make_instance(self, include_optional) -> GetSubscriptionTiers200Response:
        ...
        if include_optional:
            return GetSubscriptionTiers200Response(
                plans = [
                    mudbase_sdk.models.get_subscription_tiers_200_response_plans_inner.getSubscriptionTiers_200_response_plans_inner(
                        id = 'starter', 
                        name = 'Starter', 
                        description = '', 
                        price = 2900, 
                        ...
                        overages = mudbase_sdk.models.overages.overages(), 
                        enforcement = mudbase_sdk.models.enforcement.enforcement(), )
                    ]
            )
        else:
            return GetSubscriptionTiers200Response(
