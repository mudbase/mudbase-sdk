...
class TestGetSupportedCurrencies200Response(unittest.TestCase):
    """GetSupportedCurrencies200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSupportedCurrencies200Response:
        """Test GetSupportedCurrencies200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSupportedCurrencies200Response`
        """
        model = GetSupportedCurrencies200Response()
        if include_optional:
            return GetSupportedCurrencies200Response(
                success = True,
                data = mudbase_sdk.models.get_supported_currencies_200_response_data.getSupportedCurrencies_200_response_data(
                    currencies = [
                        mudbase_sdk.models.get_supported_currencies_200_response_data_currencies_inner.getSupportedCurrencies_200_response_data_currencies_inner(
                            code = '', 
                            name = '', 
                            chain = '', 
                            networks = [
    ...
    def testGetSupportedCurrencies200Response(self):
        """Test GetSupportedCurrencies200Response"""
