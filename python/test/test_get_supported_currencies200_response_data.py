...
class TestGetSupportedCurrencies200ResponseData(unittest.TestCase):
    """GetSupportedCurrencies200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSupportedCurrencies200ResponseData:
        """Test GetSupportedCurrencies200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSupportedCurrencies200ResponseData`
        """
        model = GetSupportedCurrencies200ResponseData()
        if include_optional:
            return GetSupportedCurrencies200ResponseData(
                currencies = [
    ...
    def testGetSupportedCurrencies200ResponseData(self):
        """Test GetSupportedCurrencies200ResponseData"""
