...
class TestGetSupportedCurrencies200ResponseDataCurrenciesInner(unittest.TestCase):
    """GetSupportedCurrencies200ResponseDataCurrenciesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSupportedCurrencies200ResponseDataCurrenciesInner:
        """Test GetSupportedCurrencies200ResponseDataCurrenciesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSupportedCurrencies200ResponseDataCurrenciesInner`
        """
        model = GetSupportedCurrencies200ResponseDataCurrenciesInner()
        if include_optional:
            return GetSupportedCurrencies200ResponseDataCurrenciesInner(
                code = '',
                name = '',
                chain = '',
                networks = [
    ...
    def testGetSupportedCurrencies200ResponseDataCurrenciesInner(self):
        """Test GetSupportedCurrencies200ResponseDataCurrenciesInner"""
