...
class TestGetTransaction200Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetTransaction200Response:
        ...
        """
        model = GetTransaction200Response()
        if include_optional:
            return GetTransaction200Response(
                success = True,
                data = mudbase_sdk.models.get_transaction_200_response_data.getTransaction_200_response_data(
                    _id = '', 
                    type = 'withdrawal', 
                    currency = '', 
                    amount = 1.337, 
