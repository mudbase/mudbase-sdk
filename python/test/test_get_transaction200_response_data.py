...
class TestGetTransaction200ResponseData(unittest.TestCase):
    """GetTransaction200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetTransaction200ResponseData:
        """Test GetTransaction200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetTransaction200ResponseData`
        """
        model = GetTransaction200ResponseData()
        if include_optional:
            return GetTransaction200ResponseData(
                id = '',
                type = 'withdrawal',
                currency = '',
                amount = 1.337,
    ...
    def testGetTransaction200ResponseData(self):
        """Test GetTransaction200ResponseData"""
