    ...
    def make_instance(self, include_optional) -> GetUserChats200Response:
        ...
        if include_optional:
            return GetUserChats200Response(
                success = True,
                data = mudbase_sdk.models.get_user_chats_200_response_data.getUserChats_200_response_data(
                    chats = [
                        mudbase_sdk.models.get_user_chats_200_response_data_chats_inner.getUserChats_200_response_data_chats_inner(
                            _id = '', 
                            name = '', 
                            type = '', 
                            last_message = mudbase_sdk.models.get_user_chats_200_response_data_chats_inner_last_message.getUserChats_200_response_data_chats_inner_lastMessage(
                                content = '', ), 
                            unread_count = 56, )
                        ], 
                    total = 56, )
