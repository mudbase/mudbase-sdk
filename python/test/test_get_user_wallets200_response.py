...
class TestGetUserWallets200Response(unittest.TestCase):
    """GetUserWallets200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetUserWallets200Response:
        """Test GetUserWallets200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetUserWallets200Response`
        """
        model = GetUserWallets200Response()
        if include_optional:
            return GetUserWallets200Response(
                success = True,
                data = [
                    mudbase_sdk.models.create_wallet_201_response_data.createWallet_201_response_data(
                        _id = '', 
                        currency = '', 
                        address = '', 
                        balance = '', 
    ...
    def testGetUserWallets200Response(self):
        """Test GetUserWallets200Response"""
