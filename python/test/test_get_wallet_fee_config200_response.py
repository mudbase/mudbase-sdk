...
class TestGetWalletFeeConfig200Response(unittest.TestCase):
    """GetWalletFeeConfig200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetWalletFeeConfig200Response:
        """Test GetWalletFeeConfig200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetWalletFeeConfig200Response`
        """
        model = GetWalletFeeConfig200Response()
        if include_optional:
            return GetWalletFeeConfig200Response(
                success = True,
                data = mudbase_sdk.models.get_wallet_fee_config_200_response_data.getWalletFeeConfig_200_response_data(
                    enabled = True, 
                    fee_percentage = 0, )
            )
        else:
    ...
    def testGetWalletFeeConfig200Response(self):
        """Test GetWalletFeeConfig200Response"""
