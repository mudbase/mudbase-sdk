...
class TestGetWalletFeeConfig200ResponseData(unittest.TestCase):
    """GetWalletFeeConfig200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetWalletFeeConfig200ResponseData:
        """Test GetWalletFeeConfig200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetWalletFeeConfig200ResponseData`
        """
        model = GetWalletFeeConfig200ResponseData()
        if include_optional:
            return GetWalletFeeConfig200ResponseData(
                enabled = True,
                fee_percentage = 0
            )
        else:
    ...
    def testGetWalletFeeConfig200ResponseData(self):
        """Test GetWalletFeeConfig200ResponseData"""
