...
class TestGetWalletPrivateKey200Response(unittest.TestCase):
    """GetWalletPrivateKey200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetWalletPrivateKey200Response:
        """Test GetWalletPrivateKey200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetWalletPrivateKey200Response`
        """
        model = GetWalletPrivateKey200Response()
        if include_optional:
            return GetWalletPrivateKey200Response(
                success = True,
                data = mudbase_sdk.models.get_wallet_private_key_200_response_data.getWalletPrivateKey_200_response_data(
                    wallet_id = '', 
                    currency = '', 
                    address = '', 
                    private_key = '', 
    ...
    def testGetWalletPrivateKey200Response(self):
        """Test GetWalletPrivateKey200Response"""
