...
class TestGetWalletPrivateKey200ResponseData(unittest.TestCase):
    """GetWalletPrivateKey200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetWalletPrivateKey200ResponseData:
        """Test GetWalletPrivateKey200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetWalletPrivateKey200ResponseData`
        """
        model = GetWalletPrivateKey200ResponseData()
        if include_optional:
            return GetWalletPrivateKey200ResponseData(
                wallet_id = '',
                currency = '',
                address = '',
                private_key = '',
    ...
    def testGetWalletPrivateKey200ResponseData(self):
        """Test GetWalletPrivateKey200ResponseData"""
