...
class TestGetWalletWebhookLogs200Response(unittest.TestCase):
    """GetWalletWebhookLogs200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetWalletWebhookLogs200Response:
        """Test GetWalletWebhookLogs200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetWalletWebhookLogs200Response`
        """
        model = GetWalletWebhookLogs200Response()
        if include_optional:
            return GetWalletWebhookLogs200Response(
                success = True,
                data = [
                    mudbase_sdk.models.webhook_log.WebhookLog(
                        _id = '', 
                        org = '', 
                        project = '', 
                        webhook_id = '', 
                        ...
                        event = '', 
                        status = 'pending', 
                        payload = mudbase_sdk.models.payload.payload(), 
                        headers = mudbase_sdk.models.headers.headers(), 
                        response = mudbase_sdk.models.webhook_log_response.WebhookLog_response(
                            status = 56, 
                            body = mudbase_sdk.models.body.body(), 
                            headers = mudbase_sdk.models.headers.headers(), ), 
                        duration = 56, 
                        attempts = 56, 
                        max_attempts = 56, 
    ...
    def testGetWalletWebhookLogs200Response(self):
        """Test GetWalletWebhookLogs200Response"""
