...
class TestHandleFlutterwaveWebhookRequest(unittest.TestCase):
    """HandleFlutterwaveWebhookRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HandleFlutterwaveWebhookRequest:
        """Test HandleFlutterwaveWebhookRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HandleFlutterwaveWebhookRequest`
        """
        model = HandleFlutterwaveWebhookRequest()
        if include_optional:
            return HandleFlutterwaveWebhookRequest(
                event = '',
                data = mudbase_sdk.models.handle_flutterwave_webhook_request_data.handleFlutterwaveWebhook_request_data(
                    id = 1.337, 
                    tx_ref = '', 
                    flw_ref = '', 
                    amount = 1.337, 
                    currency = '', 
                    status = '', 
                    customer = mudbase_sdk.models.handle_flutterwave_webhook_request_data_customer.handleFlutterwaveWebhook_request_data_customer(
                        email = '', 
                        name = '', ), 
                    meta = mudbase_sdk.models.meta.meta(), )
            )
        else:
            return HandleFlutterwaveWebhookRequest(
        )
    ...
    def testHandleFlutterwaveWebhookRequest(self):
        """Test HandleFlutterwaveWebhookRequest"""
