...
class TestHandleFlutterwaveWebhookRequestData(unittest.TestCase):
    """HandleFlutterwaveWebhookRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HandleFlutterwaveWebhookRequestData:
        """Test HandleFlutterwaveWebhookRequestData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HandleFlutterwaveWebhookRequestData`
        """
        model = HandleFlutterwaveWebhookRequestData()
        if include_optional:
            return HandleFlutterwaveWebhookRequestData(
                id = 1.337,
                tx_ref = '',
                flw_ref = '',
                amount = 1.337,
    ...
    def testHandleFlutterwaveWebhookRequestData(self):
        """Test HandleFlutterwaveWebhookRequestData"""
