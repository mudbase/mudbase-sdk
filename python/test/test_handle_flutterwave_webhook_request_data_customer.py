...
class TestHandleFlutterwaveWebhookRequestDataCustomer(unittest.TestCase):
    """HandleFlutterwaveWebhookRequestDataCustomer unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HandleFlutterwaveWebhookRequestDataCustomer:
        """Test HandleFlutterwaveWebhookRequestDataCustomer
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HandleFlutterwaveWebhookRequestDataCustomer`
        """
        model = HandleFlutterwaveWebhookRequestDataCustomer()
        if include_optional:
            return HandleFlutterwaveWebhookRequestDataCustomer(
                email = '',
                name = ''
            )
        else:
    ...
    def testHandleFlutterwaveWebhookRequestDataCustomer(self):
        """Test HandleFlutterwaveWebhookRequestDataCustomer"""
