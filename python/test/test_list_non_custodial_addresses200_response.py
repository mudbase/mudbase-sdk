...
class TestListNonCustodialAddresses200Response(unittest.TestCase):
    """ListNonCustodialAddresses200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListNonCustodialAddresses200Response:
        """Test ListNonCustodialAddresses200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListNonCustodialAddresses200Response`
        """
        model = ListNonCustodialAddresses200Response()
        if include_optional:
            return ListNonCustodialAddresses200Response(
                success = True,
                data = [
                    mudbase_sdk.models.non_custodial_address.NonCustodialAddress(
    ...
    def testListNonCustodialAddresses200Response(self):
        """Test ListNonCustodialAddresses200Response"""
