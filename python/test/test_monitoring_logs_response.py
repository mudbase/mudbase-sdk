    ...
    def make_instance(self, include_optional) -> MonitoringLogsResponse:
        ...
        if include_optional:
            return MonitoringLogsResponse(
                logs = [
                    mudbase_sdk.models.monitoring_logs_response_logs_inner.MonitoringLogsResponse_logs_inner(
                        id = '', 
                        ...
                        activity_title = '', 
                        activity_detail = '', 
                        user = mudbase_sdk.models.monitoring_logs_response_logs_inner_user.MonitoringLogsResponse_logs_inner_user(
                            id = '', 
                            email = '', ), 
                        project = mudbase_sdk.models.project.project(), 
                        metadata = mudbase_sdk.models.metadata.metadata(), )
                    ],
                count = 56,
                page = 56,
                limit = 56,
