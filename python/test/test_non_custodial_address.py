...
class TestNonCustodialAddress(unittest.TestCase):
    """NonCustodialAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NonCustodialAddress:
        """Test NonCustodialAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NonCustodialAddress`
        """
        model = NonCustodialAddress()
        if include_optional:
            return NonCustodialAddress(
    ...
    def testNonCustodialAddress(self):
        """Test NonCustodialAddress"""
