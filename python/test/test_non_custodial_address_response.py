...
class TestNonCustodialAddressResponse(unittest.TestCase):
    """NonCustodialAddressResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NonCustodialAddressResponse:
        """Test NonCustodialAddressResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NonCustodialAddressResponse`
        """
        model = NonCustodialAddressResponse()
        if include_optional:
    ...
    def testNonCustodialAddressResponse(self):
        """Test NonCustodialAddressResponse"""
