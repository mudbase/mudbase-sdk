...
class TestOrgCloudflareEdgeHints(unittest.TestCase):
    """OrgCloudflareEdgeHints unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrgCloudflareEdgeHints:
        """Test OrgCloudflareEdgeHints
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrgCloudflareEdgeHints`
        """
        model = OrgCloudflareEdgeHints()
        if include_optional:
            return OrgCloudflareEdgeHints(
    ...
    def testOrgCloudflareEdgeHints(self):
        """Test OrgCloudflareEdgeHints"""
