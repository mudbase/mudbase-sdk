...
class TestOrgCloudflareEdgeHintsOwnershipVerification(unittest.TestCase):
    """OrgCloudflareEdgeHintsOwnershipVerification unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrgCloudflareEdgeHintsOwnershipVerification:
        """Test OrgCloudflareEdgeHintsOwnershipVerification
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrgCloudflareEdgeHintsOwnershipVerification`
        """
        model = OrgCloudflareEdgeHintsOwnershipVerification()
        if include_optional:
            return OrgCloudflareEdgeHintsOwnershipVerification(
                name = '',
                type = '',
                value = ''
            )
    ...
    def testOrgCloudflareEdgeHintsOwnershipVerification(self):
        """Test OrgCloudflareEdgeHintsOwnershipVerification"""
