...
class TestOrgCloudflareSslValidationRecord(unittest.TestCase):
    """OrgCloudflareSslValidationRecord unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrgCloudflareSslValidationRecord:
        """Test OrgCloudflareSslValidationRecord
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrgCloudflareSslValidationRecord`
        """
        model = OrgCloudflareSslValidationRecord()
        if include_optional:
            return OrgCloudflareSslValidationRecord(
                txt_name = '',
                txt_value = '',
                http_url = '',
                http_body = '',
    ...
    def testOrgCloudflareSslValidationRecord(self):
        """Test OrgCloudflareSslValidationRecord"""
