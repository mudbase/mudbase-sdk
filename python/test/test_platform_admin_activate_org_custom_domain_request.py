...
class TestPlatformAdminActivateOrgCustomDomainRequest(unittest.TestCase):
    """PlatformAdminActivateOrgCustomDomainRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlatformAdminActivateOrgCustomDomainRequest:
        """Test PlatformAdminActivateOrgCustomDomainRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PlatformAdminActivateOrgCustomDomainRequest`
        """
        model = PlatformAdminActivateOrgCustomDomainRequest()
        if include_optional:
            return PlatformAdminActivateOrgCustomDomainRequest(
                notify_org = True
            )
        else:
            return PlatformAdminActivateOrgCustomDomainRequest(
    ...
    def testPlatformAdminActivateOrgCustomDomainRequest(self):
        """Test PlatformAdminActivateOrgCustomDomainRequest"""
