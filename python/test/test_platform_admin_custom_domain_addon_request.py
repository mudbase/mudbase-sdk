...
class TestPlatformAdminCustomDomainAddonRequest(unittest.TestCase):
    """PlatformAdminCustomDomainAddonRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlatformAdminCustomDomainAddonRequest:
        """Test PlatformAdminCustomDomainAddonRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PlatformAdminCustomDomainAddonRequest`
        """
        model = PlatformAdminCustomDomainAddonRequest()
        if include_optional:
            return PlatformAdminCustomDomainAddonRequest(
                enabled = True
            )
        else:
            return PlatformAdminCustomDomainAddonRequest(
    ...
    def testPlatformAdminCustomDomainAddonRequest(self):
        """Test PlatformAdminCustomDomainAddonRequest"""
