...
class TestPlatformAdminDetachMemberRequest(unittest.TestCase):
    """PlatformAdminDetachMemberRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlatformAdminDetachMemberRequest:
        """Test PlatformAdminDetachMemberRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PlatformAdminDetachMemberRequest`
        """
        model = PlatformAdminDetachMemberRequest()
        if include_optional:
            return PlatformAdminDetachMemberRequest(
                reason = ''
            )
        else:
            return PlatformAdminDetachMemberRequest(
    ...
    def testPlatformAdminDetachMemberRequest(self):
        """Test PlatformAdminDetachMemberRequest"""
