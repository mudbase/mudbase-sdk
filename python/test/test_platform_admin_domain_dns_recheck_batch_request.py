...
class TestPlatformAdminDomainDnsRecheckBatchRequest(unittest.TestCase):
    """PlatformAdminDomainDnsRecheckBatchRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlatformAdminDomainDnsRecheckBatchRequest:
        """Test PlatformAdminDomainDnsRecheckBatchRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PlatformAdminDomainDnsRecheckBatchRequest`
        """
        model = PlatformAdminDomainDnsRecheckBatchRequest()
        if include_optional:
            return PlatformAdminDomainDnsRecheckBatchRequest(
                max_orgs = 1,
                recheck_older_than_hours = 1
            )
        else:
            return PlatformAdminDomainDnsRecheckBatchRequest(
        )
    ...
    def testPlatformAdminDomainDnsRecheckBatchRequest(self):
        """Test PlatformAdminDomainDnsRecheckBatchRequest"""
