    ...
    def make_instance(self, include_optional) -> ProjectDashboardOverviewResponse:
        ...
        if include_optional:
            return ProjectDashboardOverviewResponse(
                success = True,
                data = mudbase_sdk.models.dashboard_overview_data.DashboardOverviewData(
                    project = mudbase_sdk.models.dashboard_overview_data_project.DashboardOverviewData_project(
                        id = '', 
                        name = '', 
                        slug = '', ), 
                    requests = mudbase_sdk.models.dashboard_overview_data_requests.DashboardOverviewData_requests(
                        today = 56, 
                        yesterday = 56, 
                        ...
                        change_pct = 1.337, 
                        direction = 'up', ), 
                    active_users = mudbase_sdk.models.dashboard_overview_data_active_users.DashboardOverviewData_activeUsers(
                        last24h = 56, 
                        last7d = 56, 
                        last30d = 56, 
                        change_pct7d = 1.337, 
                    ...
                    latency = mudbase_sdk.models.dashboard_overview_data_latency.DashboardOverviewData_latency(
                        ...
                        interpretation = '', 
                        instance_rollup = mudbase_sdk.models.dashboard_overview_data_latency_instance_rollup.DashboardOverviewData_latency_instanceRollup(
                        ...
                        top_routes_by_impact_hint = [
                            mudbase_sdk.models.dashboard_overview_data_latency_top_routes_by_impact_hint_inner.DashboardOverviewData_latency_topRoutesByImpactHint_inner(
                                route_key = '', 
                                p50_ms = 56, 
                                p95_ms = 56, 
                                count = 56, 
                    ...
                    uptime = mudbase_sdk.models.dashboard_overview_data_uptime.DashboardOverviewData_uptime(
                        scope = 'organization', 
                        ...
                        help = '', ), 
                    request_volume14d = [
                        mudbase_sdk.models.dashboard_overview_data_request_volume14d_inner.DashboardOverviewData_requestVolume14d_inner(
                            date = '2025-03-18', 
                            api_calls = 56, 
                            latency_tracked = 56, )
                        ], 
                    recent_activity = [
                        mudbase_sdk.models.dashboard_activity_item.DashboardActivityItem(
                            id = '', 
