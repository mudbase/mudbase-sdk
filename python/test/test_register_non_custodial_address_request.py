...
class TestRegisterNonCustodialAddressRequest(unittest.TestCase):
    """RegisterNonCustodialAddressRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RegisterNonCustodialAddressRequest:
        """Test RegisterNonCustodialAddressRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RegisterNonCustodialAddressRequest`
        """
        model = RegisterNonCustodialAddressRequest()
        if include_optional:
            return RegisterNonCustodialAddressRequest(
    ...
    def testRegisterNonCustodialAddressRequest(self):
        """Test RegisterNonCustodialAddressRequest"""
