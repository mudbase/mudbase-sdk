    ...
    def make_instance(self, include_optional) -> RegisterWithRole201Response:
        ...
        if include_optional:
            return RegisterWithRole201Response(
                ...
                refresh_token = '',
                expires_in = 56,
                user = mudbase_sdk.models.register_with_role_201_response_user.registerWithRole_201_response_user(
                    id = '', 
                    email = '', 
                    first_name = '', 
                    last_name = '', 
                    ...
                    custom_role = '', 
                    email_verified = True, ),
                role = mudbase_sdk.models.register_with_role_201_response_role.registerWithRole_201_response_role(
                    slug = '', 
                    name = '', 
                    description = '', )
            )
