    ...
    def make_instance(self, include_optional) -> SearchResponse:
        ...
        if include_optional:
            return SearchResponse(
                success = True,
                data = mudbase_sdk.models.search_response_data.SearchResponse_data(
                    results = [
                        mudbase_sdk.models.search_result.SearchResult(
                            collection = '', 
                            item = mudbase_sdk.models.search_result_item.SearchResult_item(
                                _id = '', 
                                score = 1.337, ), 
                            highlight = mudbase_sdk.models.highlight.highlight(), )
                        ], 
