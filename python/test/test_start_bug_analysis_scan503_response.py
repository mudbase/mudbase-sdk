...
class TestStartBugAnalysisScan503Response(unittest.TestCase):
    """StartBugAnalysisScan503Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StartBugAnalysisScan503Response:
        """Test StartBugAnalysisScan503Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StartBugAnalysisScan503Response`
        """
        model = StartBugAnalysisScan503Response()
        if include_optional:
            return StartBugAnalysisScan503Response(
                success = True,
                code = 'COMING_SOON',
                message = ''
            )
    ...
    def testStartBugAnalysisScan503Response(self):
        """Test StartBugAnalysisScan503Response"""
