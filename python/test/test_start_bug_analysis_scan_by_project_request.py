...
class TestStartBugAnalysisScanByProjectRequest(unittest.TestCase):
    """StartBugAnalysisScanByProjectRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StartBugAnalysisScanByProjectRequest:
        """Test StartBugAnalysisScanByProjectRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StartBugAnalysisScanByProjectRequest`
        """
        model = StartBugAnalysisScanByProjectRequest()
        if include_optional:
            return StartBugAnalysisScanByProjectRequest(
                upload_size = 1.337,
                runtime_minutes = 1.337
            )
        else:
            return StartBugAnalysisScanByProjectRequest(
        )
    ...
    def testStartBugAnalysisScanByProjectRequest(self):
        """Test StartBugAnalysisScanByProjectRequest"""
