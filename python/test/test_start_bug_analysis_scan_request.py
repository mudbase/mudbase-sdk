...
class TestStartBugAnalysisScanRequest(unittest.TestCase):
    """StartBugAnalysisScanRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StartBugAnalysisScanRequest:
        """Test StartBugAnalysisScanRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StartBugAnalysisScanRequest`
        """
        model = StartBugAnalysisScanRequest()
        if include_optional:
            return StartBugAnalysisScanRequest(
                project_id = '',
                upload_size = 1.337,
    ...
    def testStartBugAnalysisScanRequest(self):
        """Test StartBugAnalysisScanRequest"""
