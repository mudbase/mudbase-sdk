...
class TestTestWalletWebhookRequest(unittest.TestCase):
    """TestWalletWebhookRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TestWalletWebhookRequest:
        """Test TestWalletWebhookRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TestWalletWebhookRequest`
        """
        model = TestWalletWebhookRequest()
        if include_optional:
            return TestWalletWebhookRequest(
                url = '',
                secret = '',
                project_id = '',
                event = ''
    ...
    def testTestWalletWebhookRequest(self):
        """Test TestWalletWebhookRequest"""
