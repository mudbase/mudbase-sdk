    ...
    def make_instance(self, include_optional) -> TestWebhookTransformation200Response:
        ...
        if include_optional:
            return TestWebhookTransformation200Response(
                success = True,
                data = mudbase_sdk.models.test_webhook_transformation_200_response_data.testWebhookTransformation_200_response_data(
                    original = mudbase_sdk.models.original.original(), 
                    transformed = mudbase_sdk.models.transformed.transformed(), )
            )
        else:
            return TestWebhookTransformation200Response(
        )
