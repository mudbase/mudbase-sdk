    ...
    def make_instance(self, include_optional) -> UpdateApiKey200Response:
        ...
        if include_optional:
            return UpdateApiKey200Response(
                message = '',
                api_key = mudbase_sdk.models.api_key.ApiKey(
                    _id = '', 
                    name = '', 
                    project = mudbase_sdk.models.project_summary.ProjectSummary(
                        _id = '', 
                        name = '', 
                        slug = '', ), 
                    permissions = [
                        mudbase_sdk.models.api_key_permission.ApiKeyPermission(
                            resource = 'auth', 
                            actions = [
                                'create'
                                ], )
                        ], 
                    rate_limit = mudbase_sdk.models.rate_limit.RateLimit(
                        requests = 56, 
                        window = 56, ), 
                    usage = mudbase_sdk.models.api_key_usage.ApiKeyUsage(
                        requests = 56, 
                        last_used = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ), 
                    is_active = True, 
                    expires_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    created_by = mudbase_sdk.models.user_summary.UserSummary(
                        _id = '', 
                        first_name = '', 
                        last_name = '', 
                        email = '', ), 
