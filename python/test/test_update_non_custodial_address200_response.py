...
class TestUpdateNonCustodialAddress200Response(unittest.TestCase):
    """UpdateNonCustodialAddress200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateNonCustodialAddress200Response:
        """Test UpdateNonCustodialAddress200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateNonCustodialAddress200Response`
        """
        model = UpdateNonCustodialAddress200Response()
        if include_optional:
            return UpdateNonCustodialAddress200Response(
                success = True,
                message = '',
                data = mudbase_sdk.models.non_custodial_address_response.NonCustodialAddressResponse(
                    success = True, 
                    message = 'Address registered successfully', 
                    data = mudbase_sdk.models.non_custodial_address.NonCustodialAddress(
    ...
    def testUpdateNonCustodialAddress200Response(self):
        """Test UpdateNonCustodialAddress200Response"""
