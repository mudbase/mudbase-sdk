...
class TestUpdateNonCustodialAddressRequest(unittest.TestCase):
    """UpdateNonCustodialAddressRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateNonCustodialAddressRequest:
        """Test UpdateNonCustodialAddressRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateNonCustodialAddressRequest`
        """
        model = UpdateNonCustodialAddressRequest()
        if include_optional:
            return UpdateNonCustodialAddressRequest(
                label = '',
                derivation_path = ''
            )
        else:
    ...
    def testUpdateNonCustodialAddressRequest(self):
        """Test UpdateNonCustodialAddressRequest"""
