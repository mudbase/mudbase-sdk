    ...
    def make_instance(self, include_optional) -> UpdateOrganizationPlan200Response:
        ...
        if include_optional:
            return UpdateOrganizationPlan200Response(
                ...
                org = mudbase_sdk.models.organization.Organization(
                    _id = '', 
                    name = '', 
                    slug = '', 
                    description = '', 
                    logo = '', 
                    website = '', 
                    plan = mudbase_sdk.models.plan.Plan(
                        name = '', 
                        price = 1.337, 
                        currency = '', 
                        interval = '', 
                    ...
                    billing = mudbase_sdk.models.billing.Billing(
                        ...
                        payment_method = '', 
                        last_payment = mudbase_sdk.models.billing_last_payment.Billing_lastPayment(
                            amount = 1.337, 
