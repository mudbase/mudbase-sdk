...
class TestUpdateWalletFeeConfig200Response(unittest.TestCase):
    """UpdateWalletFeeConfig200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateWalletFeeConfig200Response:
        """Test UpdateWalletFeeConfig200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateWalletFeeConfig200Response`
        """
        model = UpdateWalletFeeConfig200Response()
        if include_optional:
            return UpdateWalletFeeConfig200Response(
                success = True,
                message = '',
                data = mudbase_sdk.models.update_wallet_fee_config_200_response_data.updateWalletFeeConfig_200_response_data(
                    enabled = True, 
    ...
    def testUpdateWalletFeeConfig200Response(self):
        """Test UpdateWalletFeeConfig200Response"""
