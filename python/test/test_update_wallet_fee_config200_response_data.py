...
class TestUpdateWalletFeeConfig200ResponseData(unittest.TestCase):
    """UpdateWalletFeeConfig200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateWalletFeeConfig200ResponseData:
        """Test UpdateWalletFeeConfig200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateWalletFeeConfig200ResponseData`
        """
        model = UpdateWalletFeeConfig200ResponseData()
        if include_optional:
            return UpdateWalletFeeConfig200ResponseData(
                enabled = True,
    ...
    def testUpdateWalletFeeConfig200ResponseData(self):
        """Test UpdateWalletFeeConfig200ResponseData"""
