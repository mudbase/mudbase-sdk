...
class TestUpdateWalletFeeConfigRequest(unittest.TestCase):
    """UpdateWalletFeeConfigRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateWalletFeeConfigRequest:
        """Test UpdateWalletFeeConfigRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateWalletFeeConfigRequest`
        """
        model = UpdateWalletFeeConfigRequest()
        if include_optional:
            return UpdateWalletFeeConfigRequest(
                enabled = True,
                fee_percentage = 0
            )
        else:
    ...
    def testUpdateWalletFeeConfigRequest(self):
        """Test UpdateWalletFeeConfigRequest"""
