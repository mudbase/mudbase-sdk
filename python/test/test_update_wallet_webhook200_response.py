...
class TestUpdateWalletWebhook200Response(unittest.TestCase):
    """UpdateWalletWebhook200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateWalletWebhook200Response:
        """Test UpdateWalletWebhook200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateWalletWebhook200Response`
        """
        model = UpdateWalletWebhook200Response()
        if include_optional:
            return UpdateWalletWebhook200Response(
                success = True,
                data = mudbase_sdk.models.wallet_webhook.WalletWebhook(
                    ...
                    filters = mudbase_sdk.models.wallet_webhook_filters.WalletWebhook_filters(
                        addresses = ["65a1b2c3d4e5f6789012345a"], 
                        chains = ["ethereum"], ), 
                    is_active = True, 
                    stats = mudbase_sdk.models.wallet_webhook_stats.WalletWebhook_stats(
    ...
    def testUpdateWalletWebhook200Response(self):
        """Test UpdateWalletWebhook200Response"""
