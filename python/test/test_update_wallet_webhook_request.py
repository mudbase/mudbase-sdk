...
class TestUpdateWalletWebhookRequest(unittest.TestCase):
    """UpdateWalletWebhookRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateWalletWebhookRequest:
        """Test UpdateWalletWebhookRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateWalletWebhookRequest`
        """
        model = UpdateWalletWebhookRequest()
        if include_optional:
            return UpdateWalletWebhookRequest(
                url = '',
                events = [
                    ''
                    ],
    ...
    def testUpdateWalletWebhookRequest(self):
        """Test UpdateWalletWebhookRequest"""
