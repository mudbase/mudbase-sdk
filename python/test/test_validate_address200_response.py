...
class TestValidateAddress200Response(unittest.TestCase):
    """ValidateAddress200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValidateAddress200Response:
        """Test ValidateAddress200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidateAddress200Response`
        """
        model = ValidateAddress200Response()
        if include_optional:
            return ValidateAddress200Response(
                success = True,
                data = mudbase_sdk.models.validate_address_200_response_data.validateAddress_200_response_data(
                    is_valid = True, 
                    currency = '', 
                    address = '', )
            )
    ...
    def testValidateAddress200Response(self):
        """Test ValidateAddress200Response"""
