...
class TestValidateAddress200ResponseData(unittest.TestCase):
    """ValidateAddress200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValidateAddress200ResponseData:
        """Test ValidateAddress200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidateAddress200ResponseData`
        """
        model = ValidateAddress200ResponseData()
        if include_optional:
            return ValidateAddress200ResponseData(
                is_valid = True,
                currency = '',
                address = ''
            )
    ...
    def testValidateAddress200ResponseData(self):
        """Test ValidateAddress200ResponseData"""
