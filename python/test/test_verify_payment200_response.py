    ...
    def make_instance(self, include_optional) -> VerifyPayment200Response:
        ...
        if include_optional:
            return VerifyPayment200Response(
                success = True,
                message = '',
                data = mudbase_sdk.models.verify_payment_200_response_data.verifyPayment_200_response_data(
                    subscription = mudbase_sdk.models.verify_payment_200_response_data_subscription.verifyPayment_200_response_data_subscription(
                        _id = '', 
                        status = 'active', 
                        plan = '', 
