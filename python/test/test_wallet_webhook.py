...
class TestWalletWebhook(unittest.TestCase):
    """WalletWebhook unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WalletWebhook:
        """Test WalletWebhook
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WalletWebhook`
        """
        model = WalletWebhook()
        if include_optional:
