...
class TestWalletWebhookFilters(unittest.TestCase):
    """WalletWebhookFilters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WalletWebhookFilters:
        """Test WalletWebhookFilters
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WalletWebhookFilters`
        """
        model = WalletWebhookFilters()
        if include_optional:
            return WalletWebhookFilters(
    ...
    def testWalletWebhookFilters(self):
        """Test WalletWebhookFilters"""
