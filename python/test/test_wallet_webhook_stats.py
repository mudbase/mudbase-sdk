...
class TestWalletWebhookStats(unittest.TestCase):
    """WalletWebhookStats unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WalletWebhookStats:
        """Test WalletWebhookStats
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WalletWebhookStats`
        """
        model = WalletWebhookStats()
        if include_optional:
            return WalletWebhookStats(
    ...
    def testWalletWebhookStats(self):
        """Test WalletWebhookStats"""
