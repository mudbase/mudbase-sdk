    ...
    def make_instance(self, include_optional) -> WebhookStatsResponse:
        ...
        if include_optional:
            return WebhookStatsResponse(
                status_stats = [
                    mudbase_sdk.models.webhook_stats_response_status_stats_inner.WebhookStatsResponse_statusStats_inner(
                        _id = '', 
                        count = 56, 
                        avg_duration = 1.337, )
                    ],
                event_stats = [
                    mudbase_sdk.models.webhook_stats_response_event_stats_inner.WebhookStatsResponse_eventStats_inner(
                        _id = '', 
                        count = 56, 
                        success_rate = 1.337, )
                    ],
