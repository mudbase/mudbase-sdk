...
class TestWithdraw200ResponseData(unittest.TestCase):
    """Withdraw200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Withdraw200ResponseData:
        """Test Withdraw200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Withdraw200ResponseData`
        """
        model = Withdraw200ResponseData()
        if include_optional:
            return Withdraw200ResponseData(
                transaction_id = '',
    ...
    def testWithdraw200ResponseData(self):
        """Test Withdraw200ResponseData"""
