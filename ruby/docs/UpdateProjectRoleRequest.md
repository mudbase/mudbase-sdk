...
| **collection_permissions** | [**Hash&lt;String, CreateRoleRequestCollectionPermissionsValue&gt;**](CreateRoleRequestCollectionPermissionsValue.md) | Per-collection CRUD map (same as POST add role). | [optional] |
...
instance = MudbaseSDK::UpdateProjectRoleRequest.new(
  name: App user,
