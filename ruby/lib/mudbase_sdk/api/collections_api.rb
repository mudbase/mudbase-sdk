...
module MudbaseSDK
  class CollectionsApi
    ...
    def create_collection(project_id, create_collection_request, opts = {})
      data, _status_code, _headers = create_collection_with_http_info(project_id, create_collection_request, opts)
      data
    end
    ...
    # @param create_collection_request [CreateCollectionRequest] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(CreateCollection201Response, Integer, Hash)>] CreateCollection201Response data, response status code and response headers
    def create_collection_with_http_info(project_id, create_collection_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CollectionsApi.create_collection ...'
      end
      # verify the required parameter 'project_id' is set
      if @api_client.config.client_side_validation && project_id.nil?
        fail ArgumentError, "Missing the required parameter 'project_id' when calling CollectionsApi.create_collection"
      end
      ...
      # resource path
      local_var_path = '/api/schemas/projects/{projectId}/collections'.sub('{' + 'projectId' + '}', CGI.escape(project_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'CreateCollection201Response'
    ...
    def delete_collection(project_id, collection_id, opts = {})
      data, _status_code, _headers = delete_collection_with_http_info(project_id, collection_id, opts)
      data
    end
    ...
    def delete_collection_with_http_info(project_id, collection_id, opts = {})
      if @api_client.config.debugging
      ...
      # resource path
      local_var_path = '/api/schemas/projects/{projectId}/collections/{collectionId}'.sub('{' + 'projectId' + '}', CGI.escape(project_id.to_s)).sub('{' + 'collectionId' + '}', CGI.escape(collection_id.to_s))
    ...
    # @param [Hash] opts the optional parameters
    # @return [Collection]
    def get_collection(project_id, collection_id, opts = {})
      data, _status_code, _headers = get_collection_with_http_info(project_id, collection_id, opts)
      data
    end
    ...
    def get_collection_with_http_info(project_id, collection_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CollectionsApi.get_collection ...'
      end
      # verify the required parameter 'project_id' is set
      if @api_client.config.client_side_validation && project_id.nil?
        fail ArgumentError, "Missing the required parameter 'project_id' when calling CollectionsApi.get_collection"
      end
      # verify the required parameter 'collection_id' is set
      if @api_client.config.client_side_validation && collection_id.nil?
    ...
    def list_collections(project_id, opts = {})
      data, _status_code, _headers = list_collections_with_http_info(project_id, opts)
      data
    end
    ...
    # @param project_id [String] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(ListCollections200Response, Integer, Hash)>] ListCollections200Response data, response status code and response headers
    def list_collections_with_http_info(project_id, opts = {})
      ...
      # verify the required parameter 'project_id' is set
      if @api_client.config.client_side_validation && project_id.nil?
        fail ArgumentError, "Missing the required parameter 'project_id' when calling CollectionsApi.list_collections"
      end
      # resource path
      local_var_path = '/api/schemas/projects/{projectId}/collections'.sub('{' + 'projectId' + '}', CGI.escape(project_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ListCollections200Response'
    ...
    # @param [Hash] opts the optional parameters
    # @return [CreateCollection201Response]
    def update_collection(project_id, collection_id, update_collection_request, opts = {})
      data, _status_code, _headers = update_collection_with_http_info(project_id, collection_id, update_collection_request, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(CreateCollection201Response, Integer, Hash)>] CreateCollection201Response data, response status code and response headers
    def update_collection_with_http_info(project_id, collection_id, update_collection_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CollectionsApi.update_collection ...'
      end
      # verify the required parameter 'project_id' is set
      if @api_client.config.client_side_validation && project_id.nil?
        fail ArgumentError, "Missing the required parameter 'project_id' when calling CollectionsApi.update_collection"
      end
      # verify the required parameter 'collection_id' is set
      if @api_client.config.client_side_validation && collection_id.nil?
