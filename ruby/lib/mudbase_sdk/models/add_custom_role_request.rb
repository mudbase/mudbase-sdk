...
module MudbaseSDK
  class AddCustomRoleRequest < ApiModelBase
    attr_accessor :slug
    ...
    def self.openapi_types
      {
        ...
        :'default_permissions' => :'Array<AddCustomRoleRequestDefaultPermissionsInner>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MudbaseSDK::AddCustomRoleRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MudbaseSDK::AddCustomRoleRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @signup_endpoint.nil?
        invalid_properties.push('invalid value for "signup_endpoint", signup_endpoint cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @signup_endpoint.nil?
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] signup_endpoint Value to be assigned
    def signup_endpoint=(signup_endpoint)
      if signup_endpoint.nil?
        fail ArgumentError, 'signup_endpoint cannot be nil'
      end
    ...
    def hash
      [slug, name, description, signup_endpoint, requires_approval, requires_payment, requires_kyc, default_permissions, collection_permissions, metadata, feature_permissions].hash
    end
