...
module MudbaseSDK
  class AdminOrgStatusPatchRequest < ApiModelBase
    attr_accessor :is_active

    attr_accessor :platform_suspended_reason

    attr_accessor :platform_admin_note
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MudbaseSDK::AdminOrgStatusPatchRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MudbaseSDK::AdminOrgStatusPatchRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'platform_suspended_reason')
        self.platform_suspended_reason = attributes[:'platform_suspended_reason']
      end

      if attributes.key?(:'platform_admin_note')
        self.platform_admin_note = attributes[:'platform_admin_note']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          platform_suspended_reason == o.platform_suspended_reason &&
          platform_admin_note == o.platform_admin_note &&
          reason == o.reason
    end
    ...
    def hash
      [is_active, platform_suspended_reason, platform_admin_note, reason].hash
    end
