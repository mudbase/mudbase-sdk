...
module MudbaseSDK
  class ApiKycWebhookConfigPutRequest < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MudbaseSDK::ApiKycWebhookConfigPutRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MudbaseSDK::ApiKycWebhookConfigPutRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'generate_secret')
        self.generate_secret = attributes[:'generate_secret']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          generate_secret == o.generate_secret
    end
    ...
    def hash
      [webhook_url, webhook_secret, generate_secret].hash
    end
