...
module MudbaseSDK
  class AuthConfig < ApiModelBase
    ...
    attr_accessor :notify_on_new_sign_in
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MudbaseSDK::AuthConfig` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MudbaseSDK::AuthConfig`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'notify_on_new_sign_in')
        self.notify_on_new_sign_in = attributes[:'notify_on_new_sign_in']
      else
        self.notify_on_new_sign_in = false
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          notify_on_new_sign_in == o.notify_on_new_sign_in
    end
    ...
    def hash
      [providers, notify_on_new_sign_in].hash
    end
