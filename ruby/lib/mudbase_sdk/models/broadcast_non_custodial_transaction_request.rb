...
module MudbaseSDK
  class BroadcastNonCustodialTransactionRequest < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MudbaseSDK::BroadcastNonCustodialTransactionRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MudbaseSDK::BroadcastNonCustodialTransactionRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @signed_tx.nil?
        invalid_properties.push('invalid value for "signed_tx", signed_tx cannot be nil.')
      end
    ...
    def valid?
      ...
      chain_validator = EnumAttributeValidator.new('String', ["ethereum", "polygon", "arbitrum", "optimism", "base", "bsc", "binance", "avalanche", "celo", "bitcoin", "litecoin", "dogecoin", "tron", "solana", "ton", "cardano"])
      return false unless chain_validator.valid?(@chain)
      return false if @signed_tx.nil?
    ...
    def chain=(chain)
      validator = EnumAttributeValidator.new('String', ["ethereum", "polygon", "arbitrum", "optimism", "base", "bsc", "binance", "avalanche", "celo", "bitcoin", "litecoin", "dogecoin", "tron", "solana", "ton", "cardano"])
    ...
    # @param [Object] signed_tx Value to be assigned
    def signed_tx=(signed_tx)
      if signed_tx.nil?
        fail ArgumentError, 'signed_tx cannot be nil'
      end
    ...
    def hash
      [chain, signed_tx, from_address].hash
    end
