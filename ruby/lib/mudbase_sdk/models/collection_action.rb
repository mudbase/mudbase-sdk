...
module MudbaseSDK
  class CollectionAction
    ...
    def self.all_vars
      @all_vars ||= [CREATE, READ, UPDATE, DELETE].freeze
    end
    ...
    def build_from_hash(value)
      return value if CollectionAction.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #CollectionAction"
    end
  end
end
