...
module MudbaseSDK
  class CreateBackupRequest < ApiModelBase
    attr_accessor :description

    attr_accessor :include_files

    attr_accessor :include_wallets
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MudbaseSDK::CreateBackupRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MudbaseSDK::CreateBackupRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'include_files')
        self.include_files = attributes[:'include_files']
      else
        self.include_files = true
      end

      if attributes.key?(:'include_wallets')
        self.include_wallets = attributes[:'include_wallets']
      else
        self.include_wallets = false
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          include_wallets == o.include_wallets
    end
    ...
    def hash
      [description, include_files, include_wallets].hash
    end
