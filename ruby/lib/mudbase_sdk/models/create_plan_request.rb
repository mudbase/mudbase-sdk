...
module MudbaseSDK
  ...
  class CreatePlanRequest < ApiModelBase
    ...
    def self.openapi_types
      {
        ...
        :'currency' => :'String',
        :'interval' => :'String',
        :'features' => :'Array<CreatePlanRequestFeaturesInner>',
        :'limits' => :'CreatePlanRequestLimits',
        :'trial' => :'CreatePlanRequestTrial',
        :'is_active' => :'Boolean',
        :'is_default' => :'Boolean',
        :'sort_order' => :'Float',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MudbaseSDK::CreatePlanRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MudbaseSDK::CreatePlanRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      interval_validator = EnumAttributeValidator.new('String', ["month", "year"])
    ...
    def hash
      [name, description, price, currency, interval, features, limits, trial, is_active, is_default, sort_order, metadata].hash
    end
