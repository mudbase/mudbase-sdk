...
module MudbaseSDK
  class CreateRole201ResponseRole < ApiModelBase
    attr_accessor :_id
    ...
    def self.openapi_types
      {
        ...
        :'slug' => :'String',
        :'description' => :'String',
        :'permissions' => :'Array<CreateRole201ResponseRolePermissionsInner>',
        :'hierarchy' => :'Float',
        :'is_system' => :'Boolean',
        :'is_active' => :'Boolean'
      }
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MudbaseSDK::CreateRole201ResponseRole` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MudbaseSDK::CreateRole201ResponseRole`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [_id, name, slug, description, permissions, hierarchy, is_system, is_active].hash
    end
