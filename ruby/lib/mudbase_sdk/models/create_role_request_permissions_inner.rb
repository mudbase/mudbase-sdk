...
module MudbaseSDK
  class CreateRoleRequestPermissionsInner < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MudbaseSDK::CreateRoleRequestPermissionsInner` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MudbaseSDK::CreateRoleRequestPermissionsInner`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      resource_validator = EnumAttributeValidator.new('String', ["project", "collection", "data", "file", "api_key", "org", "member", "role"])
    ...
    def resource=(resource)
      validator = EnumAttributeValidator.new('String', ["project", "collection", "data", "file", "api_key", "org", "member", "role"])
    ...
    def hash
      [resource, actions, conditions].hash
    end
