...
module MudbaseSDK
  class CreateWalletRequest < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MudbaseSDK::CreateWalletRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MudbaseSDK::CreateWalletRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      currency_validator = EnumAttributeValidator.new('String', ["BTC", "LTC", "DOGE", "ETH", "CELO", "SOL", "TRX", "TON", "MATIC", "BNB", "AVAX", "ADA", "USDT"])
    ...
    def currency=(currency)
      validator = EnumAttributeValidator.new('String', ["BTC", "LTC", "DOGE", "ETH", "CELO", "SOL", "TRX", "TON", "MATIC", "BNB", "AVAX", "ADA", "USDT"])
    ...
    def hash
      [currency, project_id, network, private_key, label].hash
    end
