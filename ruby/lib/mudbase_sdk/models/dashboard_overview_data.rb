...
module MudbaseSDK
  class DashboardOverviewData < ApiModelBase
    ...
    attr_accessor :request_volume14d

    attr_accessor :recent_activity
    ...
    def self.openapi_types
      {
        :'project' => :'DashboardOverviewDataProject',
        :'requests' => :'DashboardOverviewDataRequests',
        :'active_users' => :'DashboardOverviewDataActiveUsers',
        :'latency' => :'DashboardOverviewDataLatency',
        :'uptime' => :'DashboardOverviewDataUptime',
        :'request_volume14d' => :'Array<DashboardOverviewDataRequestVolume14dInner>',
        :'recent_activity' => :'Array<DashboardActivityItem>',
        :'generated_at' => :'Time'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MudbaseSDK::DashboardOverviewData` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MudbaseSDK::DashboardOverviewData`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'request_volume14d')
        if (value = attributes[:'request_volume14d']).is_a?(Array)
          self.request_volume14d = value
        end
      end

      if attributes.key?(:'recent_activity')
        if (value = attributes[:'recent_activity']).is_a?(Array)
          self.recent_activity = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          latency == o.latency &&
          uptime == o.uptime &&
          request_volume14d == o.request_volume14d &&
    ...
    def hash
      [project, requests, active_users, latency, uptime, request_volume14d, recent_activity, generated_at].hash
    end
