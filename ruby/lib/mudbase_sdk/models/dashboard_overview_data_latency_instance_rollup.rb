...
module MudbaseSDK
  ...
  class DashboardOverviewDataLatencyInstanceRollup < ApiModelBase
    attr_accessor :scope
    ...
    attr_accessor :p99_ms

    attr_accessor :mean_ms

    attr_accessor :samples_approx

    attr_accessor :templates_tracked
    ...
    def self.openapi_types
      {
        ...
        :'p99_ms' => :'Integer',
        :'mean_ms' => :'Integer',
        :'samples_approx' => :'Integer',
        :'templates_tracked' => :'Integer'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MudbaseSDK::DashboardOverviewDataLatencyInstanceRollup` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MudbaseSDK::DashboardOverviewDataLatencyInstanceRollup`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'p99_ms')
        self.p99_ms = attributes[:'p99_ms']
      end

      if attributes.key?(:'mean_ms')
        self.mean_ms = attributes[:'mean_ms']
      end

      if attributes.key?(:'samples_approx')
        self.samples_approx = attributes[:'samples_approx']
      end

      if attributes.key?(:'templates_tracked')
        self.templates_tracked = attributes[:'templates_tracked']
      end
    end
    ...
    def valid?
      ...
      scope_validator = EnumAttributeValidator.new('String', ["instance_recent"])
    ...
    def scope=(scope)
      validator = EnumAttributeValidator.new('String', ["instance_recent"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          p99_ms == o.p99_ms &&
          mean_ms == o.mean_ms &&
          samples_approx == o.samples_approx &&
          templates_tracked == o.templates_tracked
    end
    ...
    def hash
      [scope, p50_ms, p95_ms, p99_ms, mean_ms, samples_approx, templates_tracked].hash
    end
