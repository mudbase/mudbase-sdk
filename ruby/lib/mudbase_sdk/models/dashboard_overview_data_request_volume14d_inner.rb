...
module MudbaseSDK
  class DashboardOverviewDataRequestVolume14dInner < ApiModelBase
    attr_accessor :date

    attr_accessor :api_calls

    # Middleware-metered responses that day (UsageStat latencyCount)
    attr_accessor :latency_tracked
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MudbaseSDK::DashboardOverviewDataRequestVolume14dInner` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MudbaseSDK::DashboardOverviewDataRequestVolume14dInner`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'latency_tracked')
        self.latency_tracked = attributes[:'latency_tracked']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          latency_tracked == o.latency_tracked
    end
    ...
    def hash
      [date, api_calls, latency_tracked].hash
    end
