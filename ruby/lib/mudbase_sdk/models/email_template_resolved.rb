...
module MudbaseSDK
  ...
  class EmailTemplateResolved < ApiModelBase
    attr_accessor :name
    ...
    attr_accessor :is_project_override
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MudbaseSDK::EmailTemplateResolved` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MudbaseSDK::EmailTemplateResolved`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'is_project_override')
        self.is_project_override = attributes[:'is_project_override']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          version == o.version &&
          is_project_override == o.is_project_override &&
    ...
    def hash
      [name, subject, html_body, text_body, variables, updated_at, version, is_project_override, effective_source].hash
    end
