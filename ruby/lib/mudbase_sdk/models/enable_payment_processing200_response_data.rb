...
module MudbaseSDK
  class EnablePaymentProcessing200ResponseData < ApiModelBase
    attr_accessor :subaccount_id

    attr_accessor :already_enabled
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MudbaseSDK::EnablePaymentProcessing200ResponseData` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MudbaseSDK::EnablePaymentProcessing200ResponseData`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'already_enabled')
        self.already_enabled = attributes[:'already_enabled']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          already_enabled == o.already_enabled
    end
    ...
    def hash
      [subaccount_id, already_enabled].hash
    end
