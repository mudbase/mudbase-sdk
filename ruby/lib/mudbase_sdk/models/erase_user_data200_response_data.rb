...
module MudbaseSDK
  class EraseUserData200ResponseData < ApiModelBase
    ...
    attr_accessor :sessions_revoked
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MudbaseSDK::EraseUserData200ResponseData` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MudbaseSDK::EraseUserData200ResponseData`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'sessions_revoked')
        self.sessions_revoked = attributes[:'sessions_revoked']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          sessions_revoked == o.sessions_revoked
    end
    ...
    def hash
      [already_erased, subject_id, anonymized, sessions_revoked].hash
    end
