...
module MudbaseSDK
  class EstimateNetworkFeeRequest < ApiModelBase
    # Currency code
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MudbaseSDK::EstimateNetworkFeeRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MudbaseSDK::EstimateNetworkFeeRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @amount <= 0
        invalid_properties.push('invalid value for "amount", must be greater than 0.')
      end
    ...
    def valid?
      ...
      currency_validator = EnumAttributeValidator.new('String', ["BTC", "ETH", "BNB", "LTC", "SOL", "TRX", "USDT", "MATIC", "AVAX", "CELO", "DOGE", "TON", "ADA"])
      return false unless currency_validator.valid?(@currency)
      return false if @amount.nil?
      return false if @amount <= 0
      network_validator = EnumAttributeValidator.new('String', ["ETH", "BSC", "TRX", "SOL", "POLYGON"])
    ...
    def currency=(currency)
      validator = EnumAttributeValidator.new('String', ["BTC", "ETH", "BNB", "LTC", "SOL", "TRX", "USDT", "MATIC", "AVAX", "CELO", "DOGE", "TON", "ADA"])
    ...
    def amount=(amount)
      ...
      if amount <= 0
        fail ArgumentError, 'invalid value for "amount", must be greater than 0.'
      end
    ...
    def network=(network)
      validator = EnumAttributeValidator.new('String', ["ETH", "BSC", "TRX", "SOL", "POLYGON"])
