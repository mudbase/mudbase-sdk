...
module MudbaseSDK
  class FunctionExecutionStatusResponseData < ApiModelBase
    ...
    def self.openapi_types
      {
        ...
        :'error' => :'String',
        :'error_class' => :'String',
        :'logs' => :'FunctionExecutionStatusResponseDataLogs',
        :'machine' => :'Object',
        :'created_at' => :'Time',
        :'started_at' => :'Time',
        :'completed_at' => :'Time'
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MudbaseSDK::FunctionExecutionStatusResponseData` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MudbaseSDK::FunctionExecutionStatusResponseData`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      status_validator = EnumAttributeValidator.new('String', ["queued", "provisioning", "running", "success", "failed", "timeout"])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ["queued", "provisioning", "running", "success", "failed", "timeout"])
    ...
    def hash
      [execution_id, status, duration_ms, result, error, error_class, logs, machine, created_at, started_at, completed_at].hash
    end
