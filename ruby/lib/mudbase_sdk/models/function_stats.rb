...
module MudbaseSDK
  class FunctionStats < ApiModelBase
    attr_accessor :total_executions

    attr_accessor :successful_executions

    attr_accessor :failed_executions

    attr_accessor :avg_execution_time
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MudbaseSDK::FunctionStats` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MudbaseSDK::FunctionStats`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'total_executions')
        self.total_executions = attributes[:'total_executions']
      end

      if attributes.key?(:'successful_executions')
        self.successful_executions = attributes[:'successful_executions']
      end

      if attributes.key?(:'failed_executions')
        self.failed_executions = attributes[:'failed_executions']
      end

      if attributes.key?(:'avg_execution_time')
        self.avg_execution_time = attributes[:'avg_execution_time']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          avg_execution_time == o.avg_execution_time &&
    ...
    def hash
      [total_executions, successful_executions, failed_executions, avg_execution_time, last_execution].hash
    end
