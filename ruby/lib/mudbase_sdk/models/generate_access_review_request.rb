...
module MudbaseSDK
  class GenerateAccessReviewRequest < ApiModelBase
    ...
    def self.openapi_types
      {
        :'org_id' => :'String',
        :'review_period' => :'GenerateAccessReviewRequestReviewPeriod'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MudbaseSDK::GenerateAccessReviewRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MudbaseSDK::GenerateAccessReviewRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'review_period')
        self.review_period = attributes[:'review_period']
      else
        self.review_period = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @review_period.nil?
        invalid_properties.push('invalid value for "review_period", review_period cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @review_period.nil?
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] review_period Value to be assigned
    def review_period=(review_period)
      if review_period.nil?
        fail ArgumentError, 'review_period cannot be nil'
      end
