...
module MudbaseSDK
  class GenerateDataProcessingRecord200ResponseRecord < ApiModelBase
    attr_accessor :org_id

    attr_accessor :record_date

    attr_accessor :data_controller

    attr_accessor :processing_activities

    attr_accessor :data_subjects
    ...
    def self.openapi_types
      {
        ...
        :'processing_activities' => :'Array<Object>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MudbaseSDK::GenerateDataProcessingRecord200ResponseRecord` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MudbaseSDK::GenerateDataProcessingRecord200ResponseRecord`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'data_controller')
        self.data_controller = attributes[:'data_controller']
      end

      if attributes.key?(:'processing_activities')
        if (value = attributes[:'processing_activities']).is_a?(Array)
          self.processing_activities = value
        end
      end

      if attributes.key?(:'data_subjects')
        if (value = attributes[:'data_subjects']).is_a?(Array)
          self.data_subjects = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          processing_activities == o.processing_activities &&
          data_subjects == o.data_subjects &&
    ...
    def hash
      [org_id, record_date, data_controller, processing_activities, data_subjects, generated_at].hash
    end
