...
module MudbaseSDK
  class GeneratePrivateKeyRequest < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MudbaseSDK::GeneratePrivateKeyRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MudbaseSDK::GeneratePrivateKeyRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      currency_validator = EnumAttributeValidator.new('String', ["BTC", "ETH", "BNB", "LTC", "SOL", "TRX", "USDT"])
    ...
    def currency=(currency)
      validator = EnumAttributeValidator.new('String', ["BTC", "ETH", "BNB", "LTC", "SOL", "TRX", "USDT"])
