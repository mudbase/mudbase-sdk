...
module MudbaseSDK
  class GetComplianceSummary200ResponseCompliance < ApiModelBase
    attr_accessor :gdpr
    ...
    def self.openapi_types
      {
        :'gdpr' => :'GetComplianceSummary200ResponseComplianceGdpr',
        :'soc2' => :'GetComplianceSummary200ResponseComplianceSoc2',
        :'security' => :'GetComplianceSummary200ResponseComplianceSecurity'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MudbaseSDK::GetComplianceSummary200ResponseCompliance` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MudbaseSDK::GetComplianceSummary200ResponseCompliance`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'gdpr')
        self.gdpr = attributes[:'gdpr']
      end

      if attributes.key?(:'soc2')
        self.soc2 = attributes[:'soc2']
      end
