...
module MudbaseSDK
  class GetComplianceSummary200ResponseComplianceSecurity < ApiModelBase
    attr_accessor :password_policy

    attr_accessor :virus_scanning
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MudbaseSDK::GetComplianceSummary200ResponseComplianceSecurity` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MudbaseSDK::GetComplianceSummary200ResponseComplianceSecurity`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'virus_scanning')
        self.virus_scanning = attributes[:'virus_scanning']
      end

      if attributes.key?(:'encryption_at_rest')
        self.encryption_at_rest = attributes[:'encryption_at_rest']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          virus_scanning == o.virus_scanning &&
          encryption_at_rest == o.encryption_at_rest
    end
    ...
    def hash
      [password_policy, virus_scanning, encryption_at_rest].hash
    end
