...
module MudbaseSDK
  class GetComplianceSummary200ResponseComplianceSoc2 < ApiModelBase
    attr_accessor :access_reviews_enabled
    ...
    def self.openapi_types
      {
        :'access_reviews_enabled' => :'Boolean',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MudbaseSDK::GetComplianceSummary200ResponseComplianceSoc2` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MudbaseSDK::GetComplianceSummary200ResponseComplianceSoc2`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'access_reviews_enabled')
        self.access_reviews_enabled = attributes[:'access_reviews_enabled']
      end

      if attributes.key?(:'audit_logging_enabled')
        self.audit_logging_enabled = attributes[:'audit_logging_enabled']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          access_reviews_enabled == o.access_reviews_enabled &&
          audit_logging_enabled == o.audit_logging_enabled &&
    ...
    def hash
      [access_reviews_enabled, audit_logging_enabled, encryption_enabled].hash
    end
