...
module MudbaseSDK
  class GetDashboardOrganizations200ResponseOrganizationsInner < ApiModelBase
    attr_accessor :_id
    ...
    attr_accessor :dedicated_api_base_url
    ...
    def self.openapi_types
      {
        ...
        :'is_active' => :'Boolean',
        :'created_at' => :'Time',
        :'created_by' => :'GetDashboardOrganizations200ResponseOrganizationsInnerCreatedBy',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MudbaseSDK::GetDashboardOrganizations200ResponseOrganizationsInner` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MudbaseSDK::GetDashboardOrganizations200ResponseOrganizationsInner`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'dedicated_api_base_url')
        self.dedicated_api_base_url = attributes[:'dedicated_api_base_url']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          dedicated_api_base_url == o.dedicated_api_base_url &&
    ...
    def hash
      [_id, name, slug, description, plan, deployment_type, dedicated_api_base_url, is_active, created_at, created_by, project_count, user_count, projects].hash
    end
