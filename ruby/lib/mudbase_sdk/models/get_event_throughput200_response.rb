...
module MudbaseSDK
  class GetEventThroughput200Response < ApiModelBase
    attr_accessor :window_ms

    attr_accessor :total_events

    attr_accessor :events_per_second
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MudbaseSDK::GetEventThroughput200Response` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MudbaseSDK::GetEventThroughput200Response`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'window_ms')
        self.window_ms = attributes[:'window_ms']
      end
      ...
      if attributes.key?(:'events_per_second')
        self.events_per_second = attributes[:'events_per_second']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          events_per_second == o.events_per_second &&
          by_type == o.by_type &&
    ...
    def hash
      [window_ms, total_events, events_per_second, by_type, timestamp].hash
    end
