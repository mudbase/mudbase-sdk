...
module MudbaseSDK
  class GetFeeBalances200ResponseDataInner < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MudbaseSDK::GetFeeBalances200ResponseDataInner` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MudbaseSDK::GetFeeBalances200ResponseDataInner`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'total_collected')
        self.total_collected = attributes[:'total_collected']
      end

      if attributes.key?(:'total_paid_out')
        self.total_paid_out = attributes[:'total_paid_out']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          total_paid_out == o.total_paid_out
    end
    ...
    def hash
      [currency, collected_amount, threshold, status, total_collected, total_paid_out].hash
    end
