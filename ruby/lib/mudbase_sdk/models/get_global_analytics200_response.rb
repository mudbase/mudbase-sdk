...
module MudbaseSDK
  class GetGlobalAnalytics200Response < ApiModelBase
    ...
    attr_accessor :events_per_minute
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MudbaseSDK::GetGlobalAnalytics200Response` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MudbaseSDK::GetGlobalAnalytics200Response`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'events_per_minute')
        self.events_per_minute = attributes[:'events_per_minute']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          events_per_minute == o.events_per_minute
    end
    ...
    def hash
      [active_connections, peak_connections, total_events, events_per_minute].hash
    end
