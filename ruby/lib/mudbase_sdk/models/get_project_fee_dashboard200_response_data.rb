...
module MudbaseSDK
  class GetProjectFeeDashboard200ResponseData < ApiModelBase
    attr_accessor :fee_settings

    attr_accessor :balances

    attr_accessor :recent_payouts

    attr_accessor :total_earned
    ...
    def self.openapi_types
      {
        :'fee_settings' => :'Object',
        :'balances' => :'Array<GetProjectFeeDashboard200ResponseDataBalancesInner>',
        :'recent_payouts' => :'Array<GetProjectFeeDashboard200ResponseDataRecentPayoutsInner>',
        :'total_earned' => :'Float'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MudbaseSDK::GetProjectFeeDashboard200ResponseData` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MudbaseSDK::GetProjectFeeDashboard200ResponseData`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'fee_settings')
        self.fee_settings = attributes[:'fee_settings']
      end
      ...
      if attributes.key?(:'recent_payouts')
        if (value = attributes[:'recent_payouts']).is_a?(Array)
          self.recent_payouts = value
        end
      end

      if attributes.key?(:'total_earned')
        self.total_earned = attributes[:'total_earned']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          fee_settings == o.fee_settings &&
          balances == o.balances &&
          recent_payouts == o.recent_payouts &&
    ...
    def hash
      [fee_settings, balances, recent_payouts, total_earned].hash
    end
