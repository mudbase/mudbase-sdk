...
module MudbaseSDK
  class GetScannerMetrics200Response < ApiModelBase
    attr_accessor :metrics

    # Block lag threshold above which alerts are raised
    attr_accessor :lag_alert_threshold
    ...
    def self.openapi_types
      {
        :'metrics' => :'Hash<String, GetScannerMetrics200ResponseMetricsValue>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MudbaseSDK::GetScannerMetrics200Response` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MudbaseSDK::GetScannerMetrics200Response`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'lag_alert_threshold')
        self.lag_alert_threshold = attributes[:'lag_alert_threshold']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          metrics == o.metrics &&
          lag_alert_threshold == o.lag_alert_threshold &&
          alerts == o.alerts
    end
    ...
    def hash
      [metrics, lag_alert_threshold, alerts].hash
    end
