...
module MudbaseSDK
  class GetSearchAnalytics200Response < ApiModelBase
    attr_accessor :total_searches

    attr_accessor :top_queries

    attr_accessor :searches_by_collection
    ...
    def self.openapi_types
      {
        ...
        :'top_queries' => :'Array<GetSearchAnalytics200ResponseTopQueriesInner>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MudbaseSDK::GetSearchAnalytics200Response` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MudbaseSDK::GetSearchAnalytics200Response`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'top_queries')
        if (value = attributes[:'top_queries']).is_a?(Array)
          self.top_queries = value
        end
      end

      if attributes.key?(:'searches_by_collection')
        self.searches_by_collection = attributes[:'searches_by_collection']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          top_queries == o.top_queries &&
          searches_by_collection == o.searches_by_collection &&
    ...
    def hash
      [total_searches, top_queries, searches_by_collection, average_response_time].hash
    end
