...
module MudbaseSDK
  class GetUsageStats200ResponseStats < ApiModelBase
    attr_accessor :total_calls

    attr_accessor :success_calls

    attr_accessor :failed_calls
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MudbaseSDK::GetUsageStats200ResponseStats` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MudbaseSDK::GetUsageStats200ResponseStats`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'success_calls')
        self.success_calls = attributes[:'success_calls']
      end

      if attributes.key?(:'failed_calls')
        self.failed_calls = attributes[:'failed_calls']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          success_calls == o.success_calls &&
          failed_calls == o.failed_calls
    end
    ...
    def hash
      [total_calls, success_calls, failed_calls].hash
    end
