...
module MudbaseSDK
  class GetUserChats200ResponseDataChatsInner < ApiModelBase
    attr_accessor :_id
    ...
    def self.openapi_types
      {
        ...
        :'name' => :'String',
        :'type' => :'String',
        :'last_message' => :'GetUserChats200ResponseDataChatsInnerLastMessage',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MudbaseSDK::GetUserChats200ResponseDataChatsInner` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MudbaseSDK::GetUserChats200ResponseDataChatsInner`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [_id, name, type, last_message, unread_count].hash
    end
