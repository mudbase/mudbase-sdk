...
module MudbaseSDK
  class GetUserOverview200ResponseFootprint < ApiModelBase
    ...
    attr_accessor :api_key_count

    attr_accessor :collections_in_project
    ...
    def self.openapi_types
      {
        ...
        :'collections_in_project' => :'Integer',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MudbaseSDK::GetUserOverview200ResponseFootprint` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MudbaseSDK::GetUserOverview200ResponseFootprint`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'storage_used')
      ...
      if attributes.key?(:'api_key_count')
        self.api_key_count = attributes[:'api_key_count']
      end

      if attributes.key?(:'collections_in_project')
        self.collections_in_project = attributes[:'collections_in_project']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          api_key_count == o.api_key_count &&
          collections_in_project == o.collections_in_project &&
    ...
    def hash
      [file_count, storage_used, session_count, api_key_count, collections_in_project, collections].hash
    end
