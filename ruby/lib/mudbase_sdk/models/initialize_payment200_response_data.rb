...
module MudbaseSDK
  class InitializePayment200ResponseData < ApiModelBase
    attr_accessor :link

    attr_accessor :tx_ref

    attr_accessor :provider_ref

    attr_accessor :amount

    attr_accessor :currency

    attr_accessor :org_receives

    attr_accessor :platform_percent

    attr_accessor :platform_fixed
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MudbaseSDK::InitializePayment200ResponseData` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MudbaseSDK::InitializePayment200ResponseData`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'tx_ref')
        self.tx_ref = attributes[:'tx_ref']
      end

      if attributes.key?(:'provider_ref')
        self.provider_ref = attributes[:'provider_ref']
      end
      ...
      if attributes.key?(:'org_receives')
        self.org_receives = attributes[:'org_receives']
      end

      if attributes.key?(:'platform_percent')
        self.platform_percent = attributes[:'platform_percent']
      end

      if attributes.key?(:'platform_fixed')
        self.platform_fixed = attributes[:'platform_fixed']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          amount == o.amount &&
          currency == o.currency &&
          org_receives == o.org_receives &&
          platform_percent == o.platform_percent &&
          platform_fixed == o.platform_fixed
    end
    ...
    def hash
      [link, tx_ref, provider_ref, amount, currency, org_receives, platform_percent, platform_fixed].hash
    end
