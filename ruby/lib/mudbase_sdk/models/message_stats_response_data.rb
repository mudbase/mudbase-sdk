...
module MudbaseSDK
  class MessageStatsResponseData < ApiModelBase
    ...
    def self.openapi_types
      {
        ...
        :'by_type' => :'MessageStatsResponseDataByType',
        :'by_status' => :'MessageStatsResponseDataByStatus',
        :'success_rate' => :'Float',
        :'period' => :'MessageStatsResponseDataPeriod'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MudbaseSDK::MessageStatsResponseData` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MudbaseSDK::MessageStatsResponseData`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [total_messages, by_type, by_status, success_rate, period].hash
    end
