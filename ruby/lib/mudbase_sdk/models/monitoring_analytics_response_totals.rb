...
module MudbaseSDK
  class MonitoringAnalyticsResponseTotals < ApiModelBase
    attr_accessor :total_api_calls

    attr_accessor :total_db_reads

    attr_accessor :total_db_writes

    attr_accessor :total_storage

    attr_accessor :total_bandwidth
    ...
    def self.openapi_types
      {
        ...
        :'total_db_reads' => :'Integer',
        :'total_db_writes' => :'Integer',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MudbaseSDK::MonitoringAnalyticsResponseTotals` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MudbaseSDK::MonitoringAnalyticsResponseTotals`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'total_api_calls')
        self.total_api_calls = attributes[:'total_api_calls']
      end

      if attributes.key?(:'total_db_reads')
        self.total_db_reads = attributes[:'total_db_reads']
      end

      if attributes.key?(:'total_db_writes')
        self.total_db_writes = attributes[:'total_db_writes']
      end
      ...
      if attributes.key?(:'total_bandwidth')
        self.total_bandwidth = attributes[:'total_bandwidth']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          total_api_calls == o.total_api_calls &&
          total_db_reads == o.total_db_reads &&
          total_db_writes == o.total_db_writes &&
          total_storage == o.total_storage &&
          total_bandwidth == o.total_bandwidth
    end
    ...
    def hash
      [total_api_calls, total_db_reads, total_db_writes, total_storage, total_bandwidth].hash
    end
