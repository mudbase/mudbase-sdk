...
module MudbaseSDK
  class MonitoringLogsResponse < ApiModelBase
    attr_accessor :logs
    ...
    def self.openapi_types
      {
        :'logs' => :'Array<MonitoringLogsResponseLogsInner>',
        :'count' => :'Integer',
        :'page' => :'Integer',
        :'limit' => :'Integer',
        :'total' => :'Integer',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MudbaseSDK::MonitoringLogsResponse` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MudbaseSDK::MonitoringLogsResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [logs, count, page, limit, total, total_pages].hash
    end
