...
module MudbaseSDK
  class MonitoringPerformanceResponseMetrics < ApiModelBase
    attr_accessor :total_requests

    attr_accessor :avg_response_time

    attr_accessor :min_response_time
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MudbaseSDK::MonitoringPerformanceResponseMetrics` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MudbaseSDK::MonitoringPerformanceResponseMetrics`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'avg_response_time')
        self.avg_response_time = attributes[:'avg_response_time']
      end

      if attributes.key?(:'min_response_time')
        self.min_response_time = attributes[:'min_response_time']
      end

      if attributes.key?(:'max_response_time')
        self.max_response_time = attributes[:'max_response_time']
      end
      ...
      if attributes.key?(:'latency_source')
        self.latency_source = attributes[:'latency_source']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          avg_response_time == o.avg_response_time &&
          min_response_time == o.min_response_time &&
          max_response_time == o.max_response_time &&
          error_count == o.error_count &&
          success_count == o.success_count &&
          success_rate == o.success_rate &&
          error_rate == o.error_rate &&
          latency_source == o.latency_source
    end
    ...
    def hash
      [total_requests, avg_response_time, min_response_time, max_response_time, error_count, success_count, success_rate, error_rate, latency_source].hash
    end
