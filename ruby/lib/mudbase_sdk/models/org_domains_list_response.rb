...
module MudbaseSDK
  class OrgDomainsListResponse < ApiModelBase
    ...
    attr_accessor :dns_verification_instructions

    attr_accessor :primary_hostname

    attr_accessor :api_base_url

    attr_accessor :max_domains

    attr_accessor :custom_domain_allowed
    ...
    def self.openapi_types
      {
        :'domains' => :'Array<OrgDomainEntryOrgConsole>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MudbaseSDK::OrgDomainsListResponse` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MudbaseSDK::OrgDomainsListResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'dns_verification_instructions')
        self.dns_verification_instructions = attributes[:'dns_verification_instructions']
      end

      if attributes.key?(:'primary_hostname')
        self.primary_hostname = attributes[:'primary_hostname']
      end
      ...
      if attributes.key?(:'custom_domain_allowed')
        self.custom_domain_allowed = attributes[:'custom_domain_allowed']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          domains == o.domains &&
          dns_verification_instructions == o.dns_verification_instructions &&
          primary_hostname == o.primary_hostname &&
          api_base_url == o.api_base_url &&
          max_domains == o.max_domains &&
          custom_domain_allowed == o.custom_domain_allowed
    end
    ...
    def hash
      [domains, dns_verification_instructions, primary_hostname, api_base_url, max_domains, custom_domain_allowed].hash
    end
