...
module MudbaseSDK
  class PatchOrgDomainRequest < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MudbaseSDK::PatchOrgDomainRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MudbaseSDK::PatchOrgDomainRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'regenerate_token')
        self.regenerate_token = attributes[:'regenerate_token']
      end
    end
    ...
    def valid?
      ...
      status_validator = EnumAttributeValidator.new('String', ["pending", "failed"])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ["pending", "failed"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          status == o.status &&
          regenerate_token == o.regenerate_token
    end
