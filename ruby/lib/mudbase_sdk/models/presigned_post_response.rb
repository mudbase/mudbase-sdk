...
module MudbaseSDK
  class PresignedPostResponse < ApiModelBase
    ...
    attr_accessor :max_file_upload_bytes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MudbaseSDK::PresignedPostResponse` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MudbaseSDK::PresignedPostResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'max_file_upload_bytes')
        self.max_file_upload_bytes = attributes[:'max_file_upload_bytes']
      end
    end
    ...
    def valid?
      ...
      method_validator = EnumAttributeValidator.new('String', ["PUT"])
    ...
    def method=(method)
      validator = EnumAttributeValidator.new('String', ["PUT"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          max_file_upload_bytes == o.max_file_upload_bytes
    end
    ...
    def hash
      [key, url, method, headers, expires_in, max_file_upload_bytes].hash
    end
