...
module MudbaseSDK
  ...
  class ProjectEmailSendRequest < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MudbaseSDK::ProjectEmailSendRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MudbaseSDK::ProjectEmailSendRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'branding_scope')
        self.branding_scope = attributes[:'branding_scope']
      end
    end
    ...
    def valid?
      ...
      branding_scope_validator = EnumAttributeValidator.new('String', ["platform", "project"])
      return false unless branding_scope_validator.valid?(@branding_scope)
      true
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] branding_scope Object to be assigned
    def branding_scope=(branding_scope)
      validator = EnumAttributeValidator.new('String', ["platform", "project"])
      unless validator.valid?(branding_scope)
        fail ArgumentError, "invalid value for \"branding_scope\", must be one of #{validator.allowable_values}."
      end
      @branding_scope = branding_scope
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          branding_scope == o.branding_scope
    end
    ...
    def hash
      [template, to, data, subject, html, idempotency_key, branding_scope].hash
    end
