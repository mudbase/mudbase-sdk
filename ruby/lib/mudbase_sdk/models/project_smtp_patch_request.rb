...
module MudbaseSDK
  class ProjectSmtpPatchRequest < ApiModelBase
    ...
    attr_accessor :domain_verified_at
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MudbaseSDK::ProjectSmtpPatchRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MudbaseSDK::ProjectSmtpPatchRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'auth_user')
        self.auth_user = attributes[:'auth_user']
      end

      if attributes.key?(:'auth_pass')
        self.auth_pass = attributes[:'auth_pass']
      end
      ...
      if attributes.key?(:'domain_verified_at')
        self.domain_verified_at = attributes[:'domain_verified_at']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          auth_pass == o.auth_pass &&
          from_name == o.from_name &&
          from_email == o.from_email &&
          domain_verified_at == o.domain_verified_at
    end
    ...
    def hash
      [enabled, host, port, secure, auth_user, auth_pass, from_name, from_email, domain_verified_at].hash
    end
