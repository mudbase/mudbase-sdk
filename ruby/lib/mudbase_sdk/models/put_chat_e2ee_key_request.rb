...
module MudbaseSDK
  class PutChatE2eeKeyRequest < ApiModelBase
    # Base64-encoded public key (algorithm defined by client; opaque to server)
    attr_accessor :identity_public_key
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MudbaseSDK::PutChatE2eeKeyRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MudbaseSDK::PutChatE2eeKeyRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'identity_public_key')
        self.identity_public_key = attributes[:'identity_public_key']
      else
        self.identity_public_key = nil
      end
    ...
    def list_invalid_properties
      ...
      if @identity_public_key.nil?
        invalid_properties.push('invalid value for "identity_public_key", identity_public_key cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @identity_public_key.nil?
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] identity_public_key Value to be assigned
    def identity_public_key=(identity_public_key)
      if identity_public_key.nil?
        fail ArgumentError, 'identity_public_key cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          identity_public_key == o.identity_public_key &&
    ...
    def hash
      [identity_public_key, key_version].hash
    end
