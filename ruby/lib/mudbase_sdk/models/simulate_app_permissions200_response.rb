...
module MudbaseSDK
  class SimulateAppPermissions200Response < ApiModelBase
    ...
    def self.openapi_types
      {
        ...
        :'allowed' => :'Boolean',
        :'reason' => :'String',
        :'evaluated' => :'SimulateAppPermissions200ResponseEvaluated'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MudbaseSDK::SimulateAppPermissions200Response` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MudbaseSDK::SimulateAppPermissions200Response`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      reason_validator = EnumAttributeValidator.new('String', ["allowed", "feature_not_allowed", "no_feature_gate_for_path", "no_feature_gate_for_operation_id"])
    ...
    def reason=(reason)
      validator = EnumAttributeValidator.new('String', ["allowed", "feature_not_allowed", "no_feature_gate_for_path", "no_feature_gate_for_operation_id"])
    ...
    def hash
      [success, allowed, reason, evaluated].hash
    end
