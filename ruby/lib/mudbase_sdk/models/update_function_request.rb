  ...
  class UpdateFunctionRequest < ApiModelBase
    ...
    def self.openapi_types
      {
        ...
        :'environment' => :'Object',
        :'is_active' => :'Boolean',
        :'limits' => :'UpdateFunctionRequestLimits',
        :'retry_policy' => :'UpdateFunctionRequestRetryPolicy',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MudbaseSDK::UpdateFunctionRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MudbaseSDK::UpdateFunctionRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'version_comment')
        self.version_comment = attributes[:'version_comment']
      end
    end
    ...
    def hash
      [name, description, code, trigger, environment, is_active, limits, retry_policy, version_comment].hash
    end
