...
module MudbaseSDK
  class UpdateFunctionRequestLimits < ApiModelBase
    ...
    attr_accessor :max_executions_per_minute

    attr_accessor :max_executions_per_hour
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MudbaseSDK::UpdateFunctionRequestLimits` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MudbaseSDK::UpdateFunctionRequestLimits`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'max_executions_per_minute')
        self.max_executions_per_minute = attributes[:'max_executions_per_minute']
      end

      if attributes.key?(:'max_executions_per_hour')
        self.max_executions_per_hour = attributes[:'max_executions_per_hour']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          max_executions_per_minute == o.max_executions_per_minute &&
          max_executions_per_hour == o.max_executions_per_hour
    end
    ...
    def hash
      [timeout, max_payload_size, max_executions_per_minute, max_executions_per_hour].hash
    end
