  ...
  class UpdateMultiRoleSettingsRequestSettings < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MudbaseSDK::UpdateMultiRoleSettingsRequestSettings` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MudbaseSDK::UpdateMultiRoleSettingsRequestSettings`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'allow_multiple_roles')
        self.allow_multiple_roles = attributes[:'allow_multiple_roles']
      end

      if attributes.key?(:'require_role_selection')
        self.require_role_selection = attributes[:'require_role_selection']
      end

      if attributes.key?(:'auto_assign_default')
        self.auto_assign_default = attributes[:'auto_assign_default']
      end

      if attributes.key?(:'data_owner_field')
        self.data_owner_field = attributes[:'data_owner_field']
      else
        self.data_owner_field = 'createdBy'
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          allow_multiple_roles == o.allow_multiple_roles &&
          require_role_selection == o.require_role_selection &&
          auto_assign_default == o.auto_assign_default &&
          data_owner_field == o.data_owner_field
    end
    ...
    def hash
      [allow_multiple_roles, require_role_selection, auto_assign_default, data_owner_field].hash
    end
