...
module MudbaseSDK
  class UploadVerificationDocumentsRequest < ApiModelBase
    ...
    def self.openapi_types
      {
        :'role_slug' => :'String',
        :'documents' => :'Array<UploadVerificationDocumentsRequestDocumentsInner>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MudbaseSDK::UploadVerificationDocumentsRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MudbaseSDK::UploadVerificationDocumentsRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'role_slug')
        self.role_slug = attributes[:'role_slug']
      else
        self.role_slug = nil
      end
    ...
    def list_invalid_properties
      ...
      if @role_slug.nil?
        invalid_properties.push('invalid value for "role_slug", role_slug cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @role_slug.nil?
      return false if @documents.nil?
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] role_slug Value to be assigned
    def role_slug=(role_slug)
      if role_slug.nil?
        fail ArgumentError, 'role_slug cannot be nil'
      end
