...
module MudbaseSDK
  class UsageTrendsResponseTrendsInner < ApiModelBase
    attr_accessor :_id
    ...
    attr_accessor :db_reads

    attr_accessor :db_writes
    ...
    def self.openapi_types
      {
        :'_id' => :'UsageTrendsResponseTrendsInnerId',
        :'api_calls' => :'Integer',
        :'storage' => :'Integer',
        :'bandwidth' => :'Integer',
        :'db_reads' => :'Integer',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MudbaseSDK::UsageTrendsResponseTrendsInner` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MudbaseSDK::UsageTrendsResponseTrendsInner`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'db_reads')
        self.db_reads = attributes[:'db_reads']
      end

      if attributes.key?(:'db_writes')
        self.db_writes = attributes[:'db_writes']
      end
    end
    ...
    def hash
      [_id, api_calls, storage, bandwidth, db_reads, db_writes].hash
    end
