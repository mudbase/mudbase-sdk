...
module MudbaseSDK
  class VerifiedRoleUpgrade200Response < ApiModelBase
    attr_accessor :message

    attr_accessor :role

    attr_accessor :previous_role

    attr_accessor :upgrade_log
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MudbaseSDK::VerifiedRoleUpgrade200Response` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MudbaseSDK::VerifiedRoleUpgrade200Response`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'previous_role')
        self.previous_role = attributes[:'previous_role']
      end

      if attributes.key?(:'upgrade_log')
        self.upgrade_log = attributes[:'upgrade_log']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          message == o.message &&
          role == o.role &&
          previous_role == o.previous_role &&
          upgrade_log == o.upgrade_log
    end
    ...
    def hash
      [message, role, previous_role, upgrade_log].hash
    end
