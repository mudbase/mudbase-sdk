...
# Unit tests for MudbaseSDK::BackupsApi
...
describe 'BackupsApi' do
  ...
  describe 'test an instance of BackupsApi' do
    it 'should create an instance of BackupsApi' do
      expect(@api_instance).to be_instance_of(MudbaseSDK::BackupsApi)
    end
  end

  # unit tests for create_backup
  ...
  describe 'create_backup test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for delete_backup
  # Delete backup
  ...
  # @param project_id 
  # @param backup_id 
  # @param restore_backup_request 
  # @param [Hash] opts the optional parameters
  # @return [RestoreBackup200Response]
  describe 'restore_backup test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
