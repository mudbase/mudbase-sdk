...
# Unit tests for MudbaseSDK::HealthApi
...
describe 'HealthApi' do
  ...
  describe 'test an instance of HealthApi' do
    it 'should create an instance of HealthApi' do
      expect(@api_instance).to be_instance_of(MudbaseSDK::HealthApi)
    end
  end
  ...
  # unit tests for system_status
  # System status
  # @param [Hash] opts the optional parameters
  # @return [SystemStatusResponse]
  describe 'system_status test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
