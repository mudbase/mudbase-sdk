...
# Unit tests for MudbaseSDK::SearchApi
...
describe 'SearchApi' do
  ...
  describe 'test an instance of SearchApi' do
    it 'should create an instance of SearchApi' do
      expect(@api_instance).to be_instance_of(MudbaseSDK::SearchApi)
    end
  end
  ...
  # unit tests for get_search_suggestions
  ...
  describe 'get_search_suggestions test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
