...
# Unit tests for MudbaseSDK::UsageApi
...
describe 'UsageApi' do
  ...
  describe 'test an instance of UsageApi' do
    it 'should create an instance of UsageApi' do
      expect(@api_instance).to be_instance_of(MudbaseSDK::UsageApi)
    end
  end

  # unit tests for get_overage
  ...
  describe 'get_overage test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_project_usage_stats
  # Get project usage
  ...
  describe 'get_project_usage_stats test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_project_usage_summary
  ...
  describe 'get_project_usage_summary test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  # unit tests for get_usage_trends
  # Get usage trends
  ...
  describe 'get_usage_trends test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_usage_warnings
  # Get usage warnings
  ...
  describe 'get_usage_warnings test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
