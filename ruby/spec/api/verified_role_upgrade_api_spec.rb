...
# Unit tests for MudbaseSDK::VerifiedRoleUpgradeApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'VerifiedRoleUpgradeApi' do
  before do
  ...
  describe 'test an instance of VerifiedRoleUpgradeApi' do
    it 'should create an instance of VerifiedRoleUpgradeApi' do
      expect(@api_instance).to be_instance_of(MudbaseSDK::VerifiedRoleUpgradeApi)
    end
  end

  # unit tests for verified_role_upgrade
  # Verified role upgrade with payment verification
  # Upgrade user role after verifying payment and KYC. Prevents replay attacks.
  # @param org_id 
  # @param user_id 
  # @param verified_role_upgrade_request 
  # @param [Hash] opts the optional parameters
  # @return [VerifiedRoleUpgrade200Response]
  describe 'verified_role_upgrade test' do
    it 'should work' do
