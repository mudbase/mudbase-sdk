...
# Unit tests for MudbaseSDK::AcceptInvite201Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::AcceptInvite201Response do
  #let(:instance) { MudbaseSDK::AcceptInvite201Response.new }

  describe 'test an instance of AcceptInvite201Response' do
    it 'should create an instance of AcceptInvite201Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::AcceptInvite201Response)
    end
  end
