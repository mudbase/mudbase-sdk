...
# Unit tests for MudbaseSDK::AcceptInvite201ResponseUser
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::AcceptInvite201ResponseUser do
  #let(:instance) { MudbaseSDK::AcceptInvite201ResponseUser.new }

  describe 'test an instance of AcceptInvite201ResponseUser' do
    it 'should create an instance of AcceptInvite201ResponseUser' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::AcceptInvite201ResponseUser)
    end
  end
