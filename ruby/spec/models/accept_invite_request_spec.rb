...
# Unit tests for MudbaseSDK::AcceptInviteRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::AcceptInviteRequest do
  #let(:instance) { MudbaseSDK::AcceptInviteRequest.new }

  describe 'test an instance of AcceptInviteRequest' do
    it 'should create an instance of AcceptInviteRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::AcceptInviteRequest)
    end
  end
