...
# Unit tests for MudbaseSDK::AddCustomRoleRequestDefaultPermissionsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::AddCustomRoleRequestDefaultPermissionsInner do
  #let(:instance) { MudbaseSDK::AddCustomRoleRequestDefaultPermissionsInner.new }
  ...
  describe 'test an instance of AddCustomRoleRequestDefaultPermissionsInner' do
    it 'should create an instance of AddCustomRoleRequestDefaultPermissionsInner' do
      ...
      #expect(instance).to be_instance_of(MudbaseSDK::AddCustomRoleRequestDefaultPermissionsInner)
    end
  end
