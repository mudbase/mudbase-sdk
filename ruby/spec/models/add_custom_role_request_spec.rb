...
# Unit tests for MudbaseSDK::AddCustomRoleRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::AddCustomRoleRequest do
  #let(:instance) { MudbaseSDK::AddCustomRoleRequest.new }

  describe 'test an instance of AddCustomRoleRequest' do
    it 'should create an instance of AddCustomRoleRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::AddCustomRoleRequest)
    end
  end
