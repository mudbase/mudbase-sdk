...
# Unit tests for MudbaseSDK::AddOrgDomainRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::AddOrgDomainRequest do
  #let(:instance) { MudbaseSDK::AddOrgDomainRequest.new }

  describe 'test an instance of AddOrgDomainRequest' do
    it 'should create an instance of AddOrgDomainRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::AddOrgDomainRequest)
    end
  end
  ...
  describe 'test attribute "set_primary"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
