...
# Unit tests for MudbaseSDK::AddParticipant200ResponseDataParticipantsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::AddParticipant200ResponseDataParticipantsInner do
  #let(:instance) { MudbaseSDK::AddParticipant200ResponseDataParticipantsInner.new }
  ...
  describe 'test an instance of AddParticipant200ResponseDataParticipantsInner' do
    it 'should create an instance of AddParticipant200ResponseDataParticipantsInner' do
      ...
      #expect(instance).to be_instance_of(MudbaseSDK::AddParticipant200ResponseDataParticipantsInner)
    end
  end
