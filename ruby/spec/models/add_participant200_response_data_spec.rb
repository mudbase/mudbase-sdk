...
# Unit tests for MudbaseSDK::AddParticipant200ResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::AddParticipant200ResponseData do
  #let(:instance) { MudbaseSDK::AddParticipant200ResponseData.new }

  describe 'test an instance of AddParticipant200ResponseData' do
    it 'should create an instance of AddParticipant200ResponseData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::AddParticipant200ResponseData)
    end
  end
