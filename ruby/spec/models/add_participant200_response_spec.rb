...
# Unit tests for MudbaseSDK::AddParticipant200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::AddParticipant200Response do
  #let(:instance) { MudbaseSDK::AddParticipant200Response.new }

  describe 'test an instance of AddParticipant200Response' do
    it 'should create an instance of AddParticipant200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::AddParticipant200Response)
    end
  end
