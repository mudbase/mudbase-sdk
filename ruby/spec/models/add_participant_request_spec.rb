...
# Unit tests for MudbaseSDK::AddParticipantRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::AddParticipantRequest do
  #let(:instance) { MudbaseSDK::AddParticipantRequest.new }

  describe 'test an instance of AddParticipantRequest' do
    it 'should create an instance of AddParticipantRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::AddParticipantRequest)
    end
  end
