...
# Unit tests for MudbaseSDK::AddReaction200ResponseDataInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::AddReaction200ResponseDataInner do
  #let(:instance) { MudbaseSDK::AddReaction200ResponseDataInner.new }

  describe 'test an instance of AddReaction200ResponseDataInner' do
    it 'should create an instance of AddReaction200ResponseDataInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::AddReaction200ResponseDataInner)
    end
  end
