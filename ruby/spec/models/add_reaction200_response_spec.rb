...
# Unit tests for MudbaseSDK::AddReaction200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::AddReaction200Response do
  #let(:instance) { MudbaseSDK::AddReaction200Response.new }

  describe 'test an instance of AddReaction200Response' do
    it 'should create an instance of AddReaction200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::AddReaction200Response)
    end
  end
