...
# Unit tests for MudbaseSDK::AddReactionRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::AddReactionRequest do
  #let(:instance) { MudbaseSDK::AddReactionRequest.new }

  describe 'test an instance of AddReactionRequest' do
    it 'should create an instance of AddReactionRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::AddReactionRequest)
    end
  end
