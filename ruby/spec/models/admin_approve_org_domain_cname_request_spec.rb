...
# Unit tests for MudbaseSDK::AdminApproveOrgDomainCnameRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::AdminApproveOrgDomainCnameRequest do
  #let(:instance) { MudbaseSDK::AdminApproveOrgDomainCnameRequest.new }

  describe 'test an instance of AdminApproveOrgDomainCnameRequest' do
    it 'should create an instance of AdminApproveOrgDomainCnameRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::AdminApproveOrgDomainCnameRequest)
    end
  end

  describe 'test attribute "verify_dns"' do
    it 'should work' do
