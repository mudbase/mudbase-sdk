...
# Unit tests for MudbaseSDK::AdminBillingCheckoutLinkRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::AdminBillingCheckoutLinkRequest do
  #let(:instance) { MudbaseSDK::AdminBillingCheckoutLinkRequest.new }

  describe 'test an instance of AdminBillingCheckoutLinkRequest' do
    it 'should create an instance of AdminBillingCheckoutLinkRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::AdminBillingCheckoutLinkRequest)
    end
  end
  ...
  describe 'test attribute "billing_cycle"' do
    it 'should work' do
      ...
      # validator.allowable_values.each do |value|
      #   expect { instance.billing_cycle = value }.not_to raise_error
      # end
    end
  end
  ...
  describe 'test attribute "charge_amount_cents"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
