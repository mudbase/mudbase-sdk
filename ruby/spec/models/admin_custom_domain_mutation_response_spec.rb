...
# Unit tests for MudbaseSDK::AdminCustomDomainMutationResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::AdminCustomDomainMutationResponse do
  #let(:instance) { MudbaseSDK::AdminCustomDomainMutationResponse.new }

  describe 'test an instance of AdminCustomDomainMutationResponse' do
    it 'should create an instance of AdminCustomDomainMutationResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::AdminCustomDomainMutationResponse)
    end
  end
