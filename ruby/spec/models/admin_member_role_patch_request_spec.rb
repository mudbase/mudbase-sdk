...
# Unit tests for MudbaseSDK::AdminMemberRolePatchRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::AdminMemberRolePatchRequest do
  #let(:instance) { MudbaseSDK::AdminMemberRolePatchRequest.new }

  describe 'test an instance of AdminMemberRolePatchRequest' do
    it 'should create an instance of AdminMemberRolePatchRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::AdminMemberRolePatchRequest)
    end
  end
  ...
  describe 'test attribute "role"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["owner", "admin", "developer", "viewer"])
