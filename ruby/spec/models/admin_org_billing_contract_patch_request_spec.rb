...
# Unit tests for MudbaseSDK::AdminOrgBillingContractPatchRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::AdminOrgBillingContractPatchRequest do
  #let(:instance) { MudbaseSDK::AdminOrgBillingContractPatchRequest.new }

  describe 'test an instance of AdminOrgBillingContractPatchRequest' do
    it 'should create an instance of AdminOrgBillingContractPatchRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::AdminOrgBillingContractPatchRequest)
    end
  end

  describe 'test attribute "contract_amount_cents"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "contract_currency"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "contract_billing_interval"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["monthly", "yearly"])
      # validator.allowable_values.each do |value|
      #   expect { instance.contract_billing_interval = value }.not_to raise_error
      # end
    end
  end

  describe 'test attribute "contract_effective_from"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "contract_notes"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
