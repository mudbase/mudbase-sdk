...
# Unit tests for MudbaseSDK::AdminOrgLimitsPatchRequestBugAnalysis
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::AdminOrgLimitsPatchRequestBugAnalysis do
  #let(:instance) { MudbaseSDK::AdminOrgLimitsPatchRequestBugAnalysis.new }

  describe 'test an instance of AdminOrgLimitsPatchRequestBugAnalysis' do
    it 'should create an instance of AdminOrgLimitsPatchRequestBugAnalysis' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::AdminOrgLimitsPatchRequestBugAnalysis)
    end
  end

  describe 'test attribute "scans_per_month"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "max_upload_bytes"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "max_runtime_minutes"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "queue_type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["none", "standard", "priority", "dedicated"])
      # validator.allowable_values.each do |value|
      #   expect { instance.queue_type = value }.not_to raise_error
      # end
    end
  end

  describe 'test attribute "log_retention_days"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
