...
# Unit tests for MudbaseSDK::AdminOrgPlanPatchRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::AdminOrgPlanPatchRequest do
  #let(:instance) { MudbaseSDK::AdminOrgPlanPatchRequest.new }

  describe 'test an instance of AdminOrgPlanPatchRequest' do
    it 'should create an instance of AdminOrgPlanPatchRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::AdminOrgPlanPatchRequest)
    end
  end
  ...
  describe 'test attribute "plan"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["free", "basic", "starter", "growth", "scale", "enterprise"])
  ...
  describe 'test attribute "tx_plan"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["starter", "growth", "scale", "enterprise"])
      # validator.allowable_values.each do |value|
      #   expect { instance.tx_plan = value }.not_to raise_error
      # end
    end
  end
