...
# Unit tests for MudbaseSDK::AdminOrgStatusPatchRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::AdminOrgStatusPatchRequest do
  #let(:instance) { MudbaseSDK::AdminOrgStatusPatchRequest.new }

  describe 'test an instance of AdminOrgStatusPatchRequest' do
    it 'should create an instance of AdminOrgStatusPatchRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::AdminOrgStatusPatchRequest)
    end
  end
  ...
  describe 'test attribute "platform_suspended_reason"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "platform_admin_note"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
