...
# Unit tests for MudbaseSDK::AdminPlatformDnsVerificationPatchRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::AdminPlatformDnsVerificationPatchRequest do
  #let(:instance) { MudbaseSDK::AdminPlatformDnsVerificationPatchRequest.new }

  describe 'test an instance of AdminPlatformDnsVerificationPatchRequest' do
    it 'should create an instance of AdminPlatformDnsVerificationPatchRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::AdminPlatformDnsVerificationPatchRequest)
    end
  end
  ...
  describe 'test attribute "reset_customer_platform_dns_submission"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "notify_org"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
