...
# Unit tests for MudbaseSDK::AdminProjectPatchRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::AdminProjectPatchRequest do
  #let(:instance) { MudbaseSDK::AdminProjectPatchRequest.new }

  describe 'test an instance of AdminProjectPatchRequest' do
    it 'should create an instance of AdminProjectPatchRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::AdminProjectPatchRequest)
    end
  end
