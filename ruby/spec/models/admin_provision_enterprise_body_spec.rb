...
# Unit tests for MudbaseSDK::AdminProvisionEnterpriseBody
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::AdminProvisionEnterpriseBody do
  #let(:instance) { MudbaseSDK::AdminProvisionEnterpriseBody.new }

  describe 'test an instance of AdminProvisionEnterpriseBody' do
    it 'should create an instance of AdminProvisionEnterpriseBody' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::AdminProvisionEnterpriseBody)
    end
  end

  describe 'test attribute "provision_request_id"' do
    it 'should work' do
  ...
  describe 'test attribute "db_ref"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "force_override"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
