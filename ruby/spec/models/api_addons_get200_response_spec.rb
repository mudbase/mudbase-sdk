...
# Unit tests for MudbaseSDK::ApiAddonsGet200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ApiAddonsGet200Response do
  #let(:instance) { MudbaseSDK::ApiAddonsGet200Response.new }

  describe 'test an instance of ApiAddonsGet200Response' do
    it 'should create an instance of ApiAddonsGet200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ApiAddonsGet200Response)
    end
  end
