...
# Unit tests for MudbaseSDK::ApiFilesDownloadFileIdGet200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ApiFilesDownloadFileIdGet200Response do
  #let(:instance) { MudbaseSDK::ApiFilesDownloadFileIdGet200Response.new }

  describe 'test an instance of ApiFilesDownloadFileIdGet200Response' do
    it 'should create an instance of ApiFilesDownloadFileIdGet200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ApiFilesDownloadFileIdGet200Response)
    end
  end
