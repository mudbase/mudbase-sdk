...
# Unit tests for MudbaseSDK::ApiGdprErasePostRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ApiGdprErasePostRequest do
  #let(:instance) { MudbaseSDK::ApiGdprErasePostRequest.new }

  describe 'test an instance of ApiGdprErasePostRequest' do
    it 'should create an instance of ApiGdprErasePostRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ApiGdprErasePostRequest)
    end
  end
  ...
  describe 'test attribute "confirm"' do
    it 'should work' do
      ...
      #   expect { instance.confirm = value }.not_to raise_error
      # end
    end
  end
