...
# Unit tests for MudbaseSDK::ApiKeyPermission
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ApiKeyPermission do
  #let(:instance) { MudbaseSDK::ApiKeyPermission.new }

  describe 'test an instance of ApiKeyPermission' do
    it 'should create an instance of ApiKeyPermission' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ApiKeyPermission)
    end
  end
  ...
  describe 'test attribute "resource"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["auth", "database", "storage", "functions", "realtime", "messaging"])
