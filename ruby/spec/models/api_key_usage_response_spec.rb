...
# Unit tests for MudbaseSDK::ApiKeyUsageResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ApiKeyUsageResponse do
  #let(:instance) { MudbaseSDK::ApiKeyUsageResponse.new }

  describe 'test an instance of ApiKeyUsageResponse' do
    it 'should create an instance of ApiKeyUsageResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ApiKeyUsageResponse)
    end
  end
