...
# Unit tests for MudbaseSDK::ApiKeyUsage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ApiKeyUsage do
  #let(:instance) { MudbaseSDK::ApiKeyUsage.new }

  describe 'test an instance of ApiKeyUsage' do
    it 'should create an instance of ApiKeyUsage' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ApiKeyUsage)
    end
  end
