...
# Unit tests for MudbaseSDK::ApiKeyWithSecret
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ApiKeyWithSecret do
  #let(:instance) { MudbaseSDK::ApiKeyWithSecret.new }

  describe 'test an instance of ApiKeyWithSecret' do
    it 'should create an instance of ApiKeyWithSecret' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ApiKeyWithSecret)
    end
  end
