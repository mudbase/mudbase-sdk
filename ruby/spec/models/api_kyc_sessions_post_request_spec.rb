...
# Unit tests for MudbaseSDK::ApiKycSessionsPostRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ApiKycSessionsPostRequest do
  #let(:instance) { MudbaseSDK::ApiKycSessionsPostRequest.new }

  describe 'test an instance of ApiKycSessionsPostRequest' do
    it 'should create an instance of ApiKycSessionsPostRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ApiKycSessionsPostRequest)
    end
  end
