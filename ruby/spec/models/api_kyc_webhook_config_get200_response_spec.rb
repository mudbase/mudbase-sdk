...
# Unit tests for MudbaseSDK::ApiKycWebhookConfigGet200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ApiKycWebhookConfigGet200Response do
  #let(:instance) { MudbaseSDK::ApiKycWebhookConfigGet200Response.new }

  describe 'test an instance of ApiKycWebhookConfigGet200Response' do
    it 'should create an instance of ApiKycWebhookConfigGet200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ApiKycWebhookConfigGet200Response)
    end
  end
