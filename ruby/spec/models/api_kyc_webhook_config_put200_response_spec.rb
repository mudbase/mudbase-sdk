...
# Unit tests for MudbaseSDK::ApiKycWebhookConfigPut200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ApiKycWebhookConfigPut200Response do
  #let(:instance) { MudbaseSDK::ApiKycWebhookConfigPut200Response.new }

  describe 'test an instance of ApiKycWebhookConfigPut200Response' do
    it 'should create an instance of ApiKycWebhookConfigPut200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ApiKycWebhookConfigPut200Response)
    end
  end
