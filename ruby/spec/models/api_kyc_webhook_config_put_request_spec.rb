...
# Unit tests for MudbaseSDK::ApiKycWebhookConfigPutRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ApiKycWebhookConfigPutRequest do
  #let(:instance) { MudbaseSDK::ApiKycWebhookConfigPutRequest.new }

  describe 'test an instance of ApiKycWebhookConfigPutRequest' do
    it 'should create an instance of ApiKycWebhookConfigPutRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ApiKycWebhookConfigPutRequest)
    end
  end
  ...
  describe 'test attribute "generate_secret"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
