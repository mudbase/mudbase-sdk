...
# Unit tests for MudbaseSDK::ApiMeBootstrapGet200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ApiMeBootstrapGet200Response do
  #let(:instance) { MudbaseSDK::ApiMeBootstrapGet200Response.new }

  describe 'test an instance of ApiMeBootstrapGet200Response' do
    it 'should create an instance of ApiMeBootstrapGet200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ApiMeBootstrapGet200Response)
    end
  end
  ...
  describe 'test attribute "default_org"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
