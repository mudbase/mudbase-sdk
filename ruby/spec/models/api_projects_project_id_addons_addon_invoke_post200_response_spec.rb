...
# Unit tests for MudbaseSDK::ApiProjectsProjectIdAddonsAddonInvokePost200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ApiProjectsProjectIdAddonsAddonInvokePost200Response do
  #let(:instance) { MudbaseSDK::ApiProjectsProjectIdAddonsAddonInvokePost200Response.new }

  describe 'test an instance of ApiProjectsProjectIdAddonsAddonInvokePost200Response' do
    it 'should create an instance of ApiProjectsProjectIdAddonsAddonInvokePost200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ApiProjectsProjectIdAddonsAddonInvokePost200Response)
    end
  end
