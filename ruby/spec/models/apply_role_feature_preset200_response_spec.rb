...
# Unit tests for MudbaseSDK::ApplyRoleFeaturePreset200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ApplyRoleFeaturePreset200Response do
  #let(:instance) { MudbaseSDK::ApplyRoleFeaturePreset200Response.new }

  describe 'test an instance of ApplyRoleFeaturePreset200Response' do
    it 'should create an instance of ApplyRoleFeaturePreset200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ApplyRoleFeaturePreset200Response)
    end
  end
