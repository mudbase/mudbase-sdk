...
# Unit tests for MudbaseSDK::ApplyRoleFeaturePresetRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ApplyRoleFeaturePresetRequest do
  #let(:instance) { MudbaseSDK::ApplyRoleFeaturePresetRequest.new }

  describe 'test an instance of ApplyRoleFeaturePresetRequest' do
    it 'should create an instance of ApplyRoleFeaturePresetRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ApplyRoleFeaturePresetRequest)
    end
  end
  ...
  describe 'test attribute "preset"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["admin", "user", "viewer"])
