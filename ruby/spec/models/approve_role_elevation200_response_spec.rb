...
# Unit tests for MudbaseSDK::ApproveRoleElevation200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ApproveRoleElevation200Response do
  #let(:instance) { MudbaseSDK::ApproveRoleElevation200Response.new }

  describe 'test an instance of ApproveRoleElevation200Response' do
    it 'should create an instance of ApproveRoleElevation200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ApproveRoleElevation200Response)
    end
  end
