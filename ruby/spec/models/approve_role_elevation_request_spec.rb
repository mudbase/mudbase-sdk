...
# Unit tests for MudbaseSDK::ApproveRoleElevationRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ApproveRoleElevationRequest do
  #let(:instance) { MudbaseSDK::ApproveRoleElevationRequest.new }

  describe 'test an instance of ApproveRoleElevationRequest' do
    it 'should create an instance of ApproveRoleElevationRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ApproveRoleElevationRequest)
    end
  end
