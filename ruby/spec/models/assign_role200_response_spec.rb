...
# Unit tests for MudbaseSDK::AssignRole200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::AssignRole200Response do
  #let(:instance) { MudbaseSDK::AssignRole200Response.new }

  describe 'test an instance of AssignRole200Response' do
    it 'should create an instance of AssignRole200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::AssignRole200Response)
    end
  end
