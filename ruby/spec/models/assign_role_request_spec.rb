...
# Unit tests for MudbaseSDK::AssignRoleRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::AssignRoleRequest do
  #let(:instance) { MudbaseSDK::AssignRoleRequest.new }

  describe 'test an instance of AssignRoleRequest' do
    it 'should create an instance of AssignRoleRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::AssignRoleRequest)
    end
  end
