...
# Unit tests for MudbaseSDK::AuthConfig
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::AuthConfig do
  #let(:instance) { MudbaseSDK::AuthConfig.new }

  describe 'test an instance of AuthConfig' do
    it 'should create an instance of AuthConfig' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::AuthConfig)
    end
  end
  ...
  describe 'test attribute "notify_on_new_sign_in"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
