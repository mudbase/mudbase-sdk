...
# Unit tests for MudbaseSDK::AuthProvider
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::AuthProvider do
  #let(:instance) { MudbaseSDK::AuthProvider.new }

  describe 'test an instance of AuthProvider' do
    it 'should create an instance of AuthProvider' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::AuthProvider)
    end
  end
