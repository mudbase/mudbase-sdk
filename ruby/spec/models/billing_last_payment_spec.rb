...
# Unit tests for MudbaseSDK::BillingLastPayment
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::BillingLastPayment do
  #let(:instance) { MudbaseSDK::BillingLastPayment.new }

  describe 'test an instance of BillingLastPayment' do
    it 'should create an instance of BillingLastPayment' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::BillingLastPayment)
    end
  end
