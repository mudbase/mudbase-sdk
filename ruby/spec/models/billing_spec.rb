...
# Unit tests for MudbaseSDK::Billing
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::Billing do
  #let(:instance) { MudbaseSDK::Billing.new }

  describe 'test an instance of Billing' do
    it 'should create an instance of Billing' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::Billing)
    end
  end
