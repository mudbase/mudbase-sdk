...
# Unit tests for MudbaseSDK::BroadcastNonCustodialTransaction200ResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::BroadcastNonCustodialTransaction200ResponseData do
  #let(:instance) { MudbaseSDK::BroadcastNonCustodialTransaction200ResponseData.new }

  describe 'test an instance of BroadcastNonCustodialTransaction200ResponseData' do
    it 'should create an instance of BroadcastNonCustodialTransaction200ResponseData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::BroadcastNonCustodialTransaction200ResponseData)
    end
  end
