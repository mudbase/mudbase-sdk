...
# Unit tests for MudbaseSDK::BroadcastNonCustodialTransaction200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::BroadcastNonCustodialTransaction200Response do
  #let(:instance) { MudbaseSDK::BroadcastNonCustodialTransaction200Response.new }

  describe 'test an instance of BroadcastNonCustodialTransaction200Response' do
    it 'should create an instance of BroadcastNonCustodialTransaction200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::BroadcastNonCustodialTransaction200Response)
    end
  end
