...
# Unit tests for MudbaseSDK::BroadcastNonCustodialTransactionRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::BroadcastNonCustodialTransactionRequest do
  #let(:instance) { MudbaseSDK::BroadcastNonCustodialTransactionRequest.new }

  describe 'test an instance of BroadcastNonCustodialTransactionRequest' do
    it 'should create an instance of BroadcastNonCustodialTransactionRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::BroadcastNonCustodialTransactionRequest)
    end
  end
  ...
  describe 'test attribute "chain"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["ethereum", "polygon", "arbitrum", "optimism", "base", "bsc", "binance", "avalanche", "celo", "bitcoin", "litecoin", "dogecoin", "tron", "solana", "ton", "cardano"])
  ...
  describe 'test attribute "signed_tx"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
