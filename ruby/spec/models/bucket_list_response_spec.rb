...
# Unit tests for MudbaseSDK::BucketListResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::BucketListResponse do
  #let(:instance) { MudbaseSDK::BucketListResponse.new }

  describe 'test an instance of BucketListResponse' do
    it 'should create an instance of BucketListResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::BucketListResponse)
    end
  end
