...
# Unit tests for MudbaseSDK::BucketResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::BucketResponse do
  #let(:instance) { MudbaseSDK::BucketResponse.new }

  describe 'test an instance of BucketResponse' do
    it 'should create an instance of BucketResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::BucketResponse)
    end
  end
