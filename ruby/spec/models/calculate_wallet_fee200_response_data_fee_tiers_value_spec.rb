...
# Unit tests for MudbaseSDK::CalculateWalletFee200ResponseDataFeeTiersValue
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::CalculateWalletFee200ResponseDataFeeTiersValue do
  #let(:instance) { MudbaseSDK::CalculateWalletFee200ResponseDataFeeTiersValue.new }

  describe 'test an instance of CalculateWalletFee200ResponseDataFeeTiersValue' do
    it 'should create an instance of CalculateWalletFee200ResponseDataFeeTiersValue' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::CalculateWalletFee200ResponseDataFeeTiersValue)
    end
  end
