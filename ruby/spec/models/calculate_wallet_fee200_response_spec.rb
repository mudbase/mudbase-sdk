...
# Unit tests for MudbaseSDK::CalculateWalletFee200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::CalculateWalletFee200Response do
  #let(:instance) { MudbaseSDK::CalculateWalletFee200Response.new }

  describe 'test an instance of CalculateWalletFee200Response' do
    it 'should create an instance of CalculateWalletFee200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::CalculateWalletFee200Response)
    end
  end
