...
# Unit tests for MudbaseSDK::CancelSubscriptionRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::CancelSubscriptionRequest do
  #let(:instance) { MudbaseSDK::CancelSubscriptionRequest.new }
  ...
  describe 'test an instance of CancelSubscriptionRequest' do
    it 'should create an instance of CancelSubscriptionRequest' do
      ...
      #expect(instance).to be_instance_of(MudbaseSDK::CancelSubscriptionRequest)
    end
  end

  describe 'test attribute "cancel_immediately"' do
    it 'should work' do
