...
# Unit tests for MudbaseSDK::ChangePasswordRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ChangePasswordRequest do
  #let(:instance) { MudbaseSDK::ChangePasswordRequest.new }

  describe 'test an instance of ChangePasswordRequest' do
    it 'should create an instance of ChangePasswordRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ChangePasswordRequest)
    end
  end
