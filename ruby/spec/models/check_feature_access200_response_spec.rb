...
# Unit tests for MudbaseSDK::CheckFeatureAccess200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::CheckFeatureAccess200Response do
  #let(:instance) { MudbaseSDK::CheckFeatureAccess200Response.new }

  describe 'test an instance of CheckFeatureAccess200Response' do
    it 'should create an instance of CheckFeatureAccess200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::CheckFeatureAccess200Response)
    end
  end
