...
# Unit tests for MudbaseSDK::CheckPermissions200ResponsePermissions
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::CheckPermissions200ResponsePermissions do
  #let(:instance) { MudbaseSDK::CheckPermissions200ResponsePermissions.new }

  describe 'test an instance of CheckPermissions200ResponsePermissions' do
    it 'should create an instance of CheckPermissions200ResponsePermissions' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::CheckPermissions200ResponsePermissions)
    end
  end
  ...
  describe 'test attribute "combined"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
