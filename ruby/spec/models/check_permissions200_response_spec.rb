...
# Unit tests for MudbaseSDK::CheckPermissions200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::CheckPermissions200Response do
  #let(:instance) { MudbaseSDK::CheckPermissions200Response.new }

  describe 'test an instance of CheckPermissions200Response' do
    it 'should create an instance of CheckPermissions200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::CheckPermissions200Response)
    end
  end
