...
# Unit tests for MudbaseSDK::CheckSubscription200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::CheckSubscription200Response do
  #let(:instance) { MudbaseSDK::CheckSubscription200Response.new }

  describe 'test an instance of CheckSubscription200Response' do
    it 'should create an instance of CheckSubscription200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::CheckSubscription200Response)
    end
  end

  describe 'test attribute "has_subscription"' do
    it 'should work' do
