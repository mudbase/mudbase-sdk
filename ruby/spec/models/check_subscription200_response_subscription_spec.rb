...
# Unit tests for MudbaseSDK::CheckSubscription200ResponseSubscription
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::CheckSubscription200ResponseSubscription do
  #let(:instance) { MudbaseSDK::CheckSubscription200ResponseSubscription.new }

  describe 'test an instance of CheckSubscription200ResponseSubscription' do
    it 'should create an instance of CheckSubscription200ResponseSubscription' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::CheckSubscription200ResponseSubscription)
    end
  end
