...
# Unit tests for MudbaseSDK::CheckUserPresence200ResponsePresenceValue
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::CheckUserPresence200ResponsePresenceValue do
  #let(:instance) { MudbaseSDK::CheckUserPresence200ResponsePresenceValue.new }

  describe 'test an instance of CheckUserPresence200ResponsePresenceValue' do
    it 'should create an instance of CheckUserPresence200ResponsePresenceValue' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::CheckUserPresence200ResponsePresenceValue)
    end
  end
