...
# Unit tests for MudbaseSDK::CheckUserPresence200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::CheckUserPresence200Response do
  #let(:instance) { MudbaseSDK::CheckUserPresence200Response.new }

  describe 'test an instance of CheckUserPresence200Response' do
    it 'should create an instance of CheckUserPresence200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::CheckUserPresence200Response)
    end
  end
