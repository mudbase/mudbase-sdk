...
# Unit tests for MudbaseSDK::CheckUserPresenceRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::CheckUserPresenceRequest do
  #let(:instance) { MudbaseSDK::CheckUserPresenceRequest.new }

  describe 'test an instance of CheckUserPresenceRequest' do
    it 'should create an instance of CheckUserPresenceRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::CheckUserPresenceRequest)
    end
  end
