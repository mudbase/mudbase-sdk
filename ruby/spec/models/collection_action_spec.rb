...
# Unit tests for MudbaseSDK::CollectionAction
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::CollectionAction do
  #let(:instance) { MudbaseSDK::CollectionAction.new }

  describe 'test an instance of CollectionAction' do
    it 'should create an instance of CollectionAction' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::CollectionAction)
    end
  end
