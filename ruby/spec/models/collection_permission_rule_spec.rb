...
# Unit tests for MudbaseSDK::CollectionPermissionRule
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::CollectionPermissionRule do
  #let(:instance) { MudbaseSDK::CollectionPermissionRule.new }

  describe 'test an instance of CollectionPermissionRule' do
    it 'should create an instance of CollectionPermissionRule' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::CollectionPermissionRule)
    end
  end
