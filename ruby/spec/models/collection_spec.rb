...
# Unit tests for MudbaseSDK::Collection
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::Collection do
  #let(:instance) { MudbaseSDK::Collection.new }

  describe 'test an instance of Collection' do
    it 'should create an instance of Collection' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::Collection)
    end
  end
