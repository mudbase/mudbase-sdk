...
# Unit tests for MudbaseSDK::ConfigureOAuthProvider200ResponseProvider
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ConfigureOAuthProvider200ResponseProvider do
  #let(:instance) { MudbaseSDK::ConfigureOAuthProvider200ResponseProvider.new }

  describe 'test an instance of ConfigureOAuthProvider200ResponseProvider' do
    it 'should create an instance of ConfigureOAuthProvider200ResponseProvider' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ConfigureOAuthProvider200ResponseProvider)
    end
  end
