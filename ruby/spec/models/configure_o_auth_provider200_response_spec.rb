...
# Unit tests for MudbaseSDK::ConfigureOAuthProvider200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ConfigureOAuthProvider200Response do
  #let(:instance) { MudbaseSDK::ConfigureOAuthProvider200Response.new }

  describe 'test an instance of ConfigureOAuthProvider200Response' do
    it 'should create an instance of ConfigureOAuthProvider200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ConfigureOAuthProvider200Response)
    end
  end
