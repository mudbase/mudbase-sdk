...
# Unit tests for MudbaseSDK::ConfigureOAuthProviderRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ConfigureOAuthProviderRequest do
  #let(:instance) { MudbaseSDK::ConfigureOAuthProviderRequest.new }

  describe 'test an instance of ConfigureOAuthProviderRequest' do
    it 'should create an instance of ConfigureOAuthProviderRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ConfigureOAuthProviderRequest)
    end
  end
