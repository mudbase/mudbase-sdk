...
# Unit tests for MudbaseSDK::ConfigureWebhook200ResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ConfigureWebhook200ResponseData do
  #let(:instance) { MudbaseSDK::ConfigureWebhook200ResponseData.new }

  describe 'test an instance of ConfigureWebhook200ResponseData' do
    it 'should create an instance of ConfigureWebhook200ResponseData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ConfigureWebhook200ResponseData)
    end
  end
