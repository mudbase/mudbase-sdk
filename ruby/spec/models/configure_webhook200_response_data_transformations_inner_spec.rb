...
# Unit tests for MudbaseSDK::ConfigureWebhook200ResponseDataTransformationsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ConfigureWebhook200ResponseDataTransformationsInner do
  #let(:instance) { MudbaseSDK::ConfigureWebhook200ResponseDataTransformationsInner.new }

  describe 'test an instance of ConfigureWebhook200ResponseDataTransformationsInner' do
    it 'should create an instance of ConfigureWebhook200ResponseDataTransformationsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ConfigureWebhook200ResponseDataTransformationsInner)
    end
  end
