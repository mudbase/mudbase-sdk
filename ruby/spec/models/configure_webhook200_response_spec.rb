...
# Unit tests for MudbaseSDK::ConfigureWebhook200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ConfigureWebhook200Response do
  #let(:instance) { MudbaseSDK::ConfigureWebhook200Response.new }

  describe 'test an instance of ConfigureWebhook200Response' do
    it 'should create an instance of ConfigureWebhook200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ConfigureWebhook200Response)
    end
  end
