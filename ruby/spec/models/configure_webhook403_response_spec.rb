...
# Unit tests for MudbaseSDK::ConfigureWebhook403Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ConfigureWebhook403Response do
  #let(:instance) { MudbaseSDK::ConfigureWebhook403Response.new }

  describe 'test an instance of ConfigureWebhook403Response' do
    it 'should create an instance of ConfigureWebhook403Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ConfigureWebhook403Response)
    end
  end
