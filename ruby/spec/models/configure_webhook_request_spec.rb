...
# Unit tests for MudbaseSDK::ConfigureWebhookRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ConfigureWebhookRequest do
  #let(:instance) { MudbaseSDK::ConfigureWebhookRequest.new }

  describe 'test an instance of ConfigureWebhookRequest' do
    it 'should create an instance of ConfigureWebhookRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ConfigureWebhookRequest)
    end
  end
