...
# Unit tests for MudbaseSDK::ConfirmAddressVerification200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ConfirmAddressVerification200Response do
  #let(:instance) { MudbaseSDK::ConfirmAddressVerification200Response.new }

  describe 'test an instance of ConfirmAddressVerification200Response' do
    it 'should create an instance of ConfirmAddressVerification200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ConfirmAddressVerification200Response)
    end
  end
