...
# Unit tests for MudbaseSDK::ConfirmAddressVerificationRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ConfirmAddressVerificationRequest do
  #let(:instance) { MudbaseSDK::ConfirmAddressVerificationRequest.new }

  describe 'test an instance of ConfirmAddressVerificationRequest' do
    it 'should create an instance of ConfirmAddressVerificationRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ConfirmAddressVerificationRequest)
    end
  end
