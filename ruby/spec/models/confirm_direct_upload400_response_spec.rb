...
# Unit tests for MudbaseSDK::ConfirmDirectUpload400Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ConfirmDirectUpload400Response do
  #let(:instance) { MudbaseSDK::ConfirmDirectUpload400Response.new }

  describe 'test an instance of ConfirmDirectUpload400Response' do
    it 'should create an instance of ConfirmDirectUpload400Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ConfirmDirectUpload400Response)
    end
  end
