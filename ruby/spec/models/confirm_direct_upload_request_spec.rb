...
# Unit tests for MudbaseSDK::ConfirmDirectUploadRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ConfirmDirectUploadRequest do
  #let(:instance) { MudbaseSDK::ConfirmDirectUploadRequest.new }

  describe 'test an instance of ConfirmDirectUploadRequest' do
    it 'should create an instance of ConfirmDirectUploadRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ConfirmDirectUploadRequest)
    end
  end
