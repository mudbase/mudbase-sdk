...
# Unit tests for MudbaseSDK::ConfirmLocalPasswordResetWithOtpRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ConfirmLocalPasswordResetWithOtpRequest do
  #let(:instance) { MudbaseSDK::ConfirmLocalPasswordResetWithOtpRequest.new }

  describe 'test an instance of ConfirmLocalPasswordResetWithOtpRequest' do
    it 'should create an instance of ConfirmLocalPasswordResetWithOtpRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ConfirmLocalPasswordResetWithOtpRequest)
    end
  end
