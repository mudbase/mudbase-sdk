...
# Unit tests for MudbaseSDK::ConfirmUploadResponseScan
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ConfirmUploadResponseScan do
  #let(:instance) { MudbaseSDK::ConfirmUploadResponseScan.new }

  describe 'test an instance of ConfirmUploadResponseScan' do
    it 'should create an instance of ConfirmUploadResponseScan' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ConfirmUploadResponseScan)
    end
  end
