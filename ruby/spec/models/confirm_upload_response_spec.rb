...
# Unit tests for MudbaseSDK::ConfirmUploadResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ConfirmUploadResponse do
  #let(:instance) { MudbaseSDK::ConfirmUploadResponse.new }

  describe 'test an instance of ConfirmUploadResponse' do
    it 'should create an instance of ConfirmUploadResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ConfirmUploadResponse)
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["ok", "quarantined", "error"])
