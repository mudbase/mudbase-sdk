...
# Unit tests for MudbaseSDK::ConvertAnonymousAccount200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ConvertAnonymousAccount200Response do
  #let(:instance) { MudbaseSDK::ConvertAnonymousAccount200Response.new }

  describe 'test an instance of ConvertAnonymousAccount200Response' do
    it 'should create an instance of ConvertAnonymousAccount200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ConvertAnonymousAccount200Response)
    end
  end
