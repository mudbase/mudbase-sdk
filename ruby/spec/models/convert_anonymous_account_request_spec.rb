...
# Unit tests for MudbaseSDK::ConvertAnonymousAccountRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ConvertAnonymousAccountRequest do
  #let(:instance) { MudbaseSDK::ConvertAnonymousAccountRequest.new }

  describe 'test an instance of ConvertAnonymousAccountRequest' do
    it 'should create an instance of ConvertAnonymousAccountRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ConvertAnonymousAccountRequest)
    end
  end
