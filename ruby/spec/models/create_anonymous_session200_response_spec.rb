...
# Unit tests for MudbaseSDK::CreateAnonymousSession200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::CreateAnonymousSession200Response do
  #let(:instance) { MudbaseSDK::CreateAnonymousSession200Response.new }

  describe 'test an instance of CreateAnonymousSession200Response' do
    it 'should create an instance of CreateAnonymousSession200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::CreateAnonymousSession200Response)
    end
  end
