...
# Unit tests for MudbaseSDK::CreateAnonymousSession200ResponseUser
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::CreateAnonymousSession200ResponseUser do
  #let(:instance) { MudbaseSDK::CreateAnonymousSession200ResponseUser.new }

  describe 'test an instance of CreateAnonymousSession200ResponseUser' do
    it 'should create an instance of CreateAnonymousSession200ResponseUser' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::CreateAnonymousSession200ResponseUser)
    end
  end
