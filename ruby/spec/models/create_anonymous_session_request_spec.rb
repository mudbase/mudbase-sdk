...
# Unit tests for MudbaseSDK::CreateAnonymousSessionRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::CreateAnonymousSessionRequest do
  #let(:instance) { MudbaseSDK::CreateAnonymousSessionRequest.new }

  describe 'test an instance of CreateAnonymousSessionRequest' do
    it 'should create an instance of CreateAnonymousSessionRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::CreateAnonymousSessionRequest)
    end
  end
