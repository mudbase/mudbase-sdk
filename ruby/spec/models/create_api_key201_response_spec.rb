...
# Unit tests for MudbaseSDK::CreateApiKey201Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::CreateApiKey201Response do
  #let(:instance) { MudbaseSDK::CreateApiKey201Response.new }
  ...
  describe 'test an instance of CreateApiKey201Response' do
    it 'should create an instance of CreateApiKey201Response' do
      ...
      #expect(instance).to be_instance_of(MudbaseSDK::CreateApiKey201Response)
    end
  end
