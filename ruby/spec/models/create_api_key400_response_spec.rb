...
# Unit tests for MudbaseSDK::CreateApiKey400Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::CreateApiKey400Response do
  #let(:instance) { MudbaseSDK::CreateApiKey400Response.new }

  describe 'test an instance of CreateApiKey400Response' do
    it 'should create an instance of CreateApiKey400Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::CreateApiKey400Response)
    end
  end
