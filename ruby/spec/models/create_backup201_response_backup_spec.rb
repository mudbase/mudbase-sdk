...
# Unit tests for MudbaseSDK::CreateBackup201ResponseBackup
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::CreateBackup201ResponseBackup do
  #let(:instance) { MudbaseSDK::CreateBackup201ResponseBackup.new }

  describe 'test an instance of CreateBackup201ResponseBackup' do
    it 'should create an instance of CreateBackup201ResponseBackup' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::CreateBackup201ResponseBackup)
    end
  end
