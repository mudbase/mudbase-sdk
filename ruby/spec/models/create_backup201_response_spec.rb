...
# Unit tests for MudbaseSDK::CreateBackup201Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::CreateBackup201Response do
  #let(:instance) { MudbaseSDK::CreateBackup201Response.new }

  describe 'test an instance of CreateBackup201Response' do
    it 'should create an instance of CreateBackup201Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::CreateBackup201Response)
    end
  end
