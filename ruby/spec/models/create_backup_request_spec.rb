...
# Unit tests for MudbaseSDK::CreateBackupRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::CreateBackupRequest do
  #let(:instance) { MudbaseSDK::CreateBackupRequest.new }

  describe 'test an instance of CreateBackupRequest' do
    it 'should create an instance of CreateBackupRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::CreateBackupRequest)
    end
  end
  ...
  describe 'test attribute "include_files"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "include_wallets"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
