...
# Unit tests for MudbaseSDK::CreateBucketRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::CreateBucketRequest do
  #let(:instance) { MudbaseSDK::CreateBucketRequest.new }

  describe 'test an instance of CreateBucketRequest' do
    it 'should create an instance of CreateBucketRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::CreateBucketRequest)
    end
  end
