...
# Unit tests for MudbaseSDK::CreateChat201ResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::CreateChat201ResponseData do
  #let(:instance) { MudbaseSDK::CreateChat201ResponseData.new }

  describe 'test an instance of CreateChat201ResponseData' do
    it 'should create an instance of CreateChat201ResponseData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::CreateChat201ResponseData)
    end
  end
