...
# Unit tests for MudbaseSDK::CreateChat201Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::CreateChat201Response do
  #let(:instance) { MudbaseSDK::CreateChat201Response.new }

  describe 'test an instance of CreateChat201Response' do
    it 'should create an instance of CreateChat201Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::CreateChat201Response)
    end
  end
