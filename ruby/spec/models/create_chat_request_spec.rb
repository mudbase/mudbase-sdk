...
# Unit tests for MudbaseSDK::CreateChatRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::CreateChatRequest do
  #let(:instance) { MudbaseSDK::CreateChatRequest.new }

  describe 'test an instance of CreateChatRequest' do
    it 'should create an instance of CreateChatRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::CreateChatRequest)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["direct", "group", "channel", "broadcast"])
