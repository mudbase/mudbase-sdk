...
# Unit tests for MudbaseSDK::CreateCheckoutSession200ResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::CreateCheckoutSession200ResponseData do
  #let(:instance) { MudbaseSDK::CreateCheckoutSession200ResponseData.new }

  describe 'test an instance of CreateCheckoutSession200ResponseData' do
    it 'should create an instance of CreateCheckoutSession200ResponseData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::CreateCheckoutSession200ResponseData)
    end
  end
