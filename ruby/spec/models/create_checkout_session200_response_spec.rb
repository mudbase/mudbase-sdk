...
# Unit tests for MudbaseSDK::CreateCheckoutSession200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::CreateCheckoutSession200Response do
  #let(:instance) { MudbaseSDK::CreateCheckoutSession200Response.new }

  describe 'test an instance of CreateCheckoutSession200Response' do
    it 'should create an instance of CreateCheckoutSession200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::CreateCheckoutSession200Response)
    end
  end
