...
# Unit tests for MudbaseSDK::CreateCheckoutSessionRequestCustomerInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::CreateCheckoutSessionRequestCustomerInfo do
  #let(:instance) { MudbaseSDK::CreateCheckoutSessionRequestCustomerInfo.new }

  describe 'test an instance of CreateCheckoutSessionRequestCustomerInfo' do
    it 'should create an instance of CreateCheckoutSessionRequestCustomerInfo' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::CreateCheckoutSessionRequestCustomerInfo)
    end
  end
