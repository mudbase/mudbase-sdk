...
# Unit tests for MudbaseSDK::CreateCheckoutSessionRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::CreateCheckoutSessionRequest do
  #let(:instance) { MudbaseSDK::CreateCheckoutSessionRequest.new }

  describe 'test an instance of CreateCheckoutSessionRequest' do
    it 'should create an instance of CreateCheckoutSessionRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::CreateCheckoutSessionRequest)
    end
  end
