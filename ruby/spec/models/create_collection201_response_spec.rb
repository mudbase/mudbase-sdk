...
# Unit tests for MudbaseSDK::CreateCollection201Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::CreateCollection201Response do
  #let(:instance) { MudbaseSDK::CreateCollection201Response.new }

  describe 'test an instance of CreateCollection201Response' do
    it 'should create an instance of CreateCollection201Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::CreateCollection201Response)
    end
  end
