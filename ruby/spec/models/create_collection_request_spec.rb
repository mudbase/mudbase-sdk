...
# Unit tests for MudbaseSDK::CreateCollectionRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::CreateCollectionRequest do
  #let(:instance) { MudbaseSDK::CreateCollectionRequest.new }

  describe 'test an instance of CreateCollectionRequest' do
    it 'should create an instance of CreateCollectionRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::CreateCollectionRequest)
    end
  end
