...
# Unit tests for MudbaseSDK::CreateFromTemplateRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::CreateFromTemplateRequest do
  #let(:instance) { MudbaseSDK::CreateFromTemplateRequest.new }

  describe 'test an instance of CreateFromTemplateRequest' do
    it 'should create an instance of CreateFromTemplateRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::CreateFromTemplateRequest)
    end
  end
