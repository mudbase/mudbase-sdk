...
# Unit tests for MudbaseSDK::CreateFunctionRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::CreateFunctionRequest do
  #let(:instance) { MudbaseSDK::CreateFunctionRequest.new }

  describe 'test an instance of CreateFunctionRequest' do
    it 'should create an instance of CreateFunctionRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::CreateFunctionRequest)
    end
  end
