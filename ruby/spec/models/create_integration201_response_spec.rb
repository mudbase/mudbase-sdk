...
# Unit tests for MudbaseSDK::CreateIntegration201Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::CreateIntegration201Response do
  #let(:instance) { MudbaseSDK::CreateIntegration201Response.new }

  describe 'test an instance of CreateIntegration201Response' do
    it 'should create an instance of CreateIntegration201Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::CreateIntegration201Response)
    end
  end
