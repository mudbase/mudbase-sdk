...
# Unit tests for MudbaseSDK::CreateIntegrationRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::CreateIntegrationRequest do
  #let(:instance) { MudbaseSDK::CreateIntegrationRequest.new }

  describe 'test an instance of CreateIntegrationRequest' do
    it 'should create an instance of CreateIntegrationRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::CreateIntegrationRequest)
    end
  end
