...
# Unit tests for MudbaseSDK::CreateMonitoringAlertRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::CreateMonitoringAlertRequest do
  #let(:instance) { MudbaseSDK::CreateMonitoringAlertRequest.new }

  describe 'test an instance of CreateMonitoringAlertRequest' do
    it 'should create an instance of CreateMonitoringAlertRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::CreateMonitoringAlertRequest)
    end
  end
