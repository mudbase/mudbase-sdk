...
# Unit tests for MudbaseSDK::CreateOrUpdateFeeSettingsRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::CreateOrUpdateFeeSettingsRequest do
  #let(:instance) { MudbaseSDK::CreateOrUpdateFeeSettingsRequest.new }

  describe 'test an instance of CreateOrUpdateFeeSettingsRequest' do
    it 'should create an instance of CreateOrUpdateFeeSettingsRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::CreateOrUpdateFeeSettingsRequest)
    end
  end
  ...
  describe 'test attribute "currency"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["BTC", "ETH", "BNB", "LTC", "SOL", "TRX", "USDT-ETH", "USDT-BSC", "USDT-TRX", "USDT-SOL"])
  ...
  describe 'test attribute "payout_address"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
