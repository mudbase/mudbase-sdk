...
# Unit tests for MudbaseSDK::CreateOrganization403Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::CreateOrganization403Response do
  #let(:instance) { MudbaseSDK::CreateOrganization403Response.new }

  describe 'test an instance of CreateOrganization403Response' do
    it 'should create an instance of CreateOrganization403Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::CreateOrganization403Response)
    end
  end
