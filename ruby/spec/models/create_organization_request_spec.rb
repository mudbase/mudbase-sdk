...
# Unit tests for MudbaseSDK::CreateOrganizationRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::CreateOrganizationRequest do
  #let(:instance) { MudbaseSDK::CreateOrganizationRequest.new }
  ...
  describe 'test an instance of CreateOrganizationRequest' do
    it 'should create an instance of CreateOrganizationRequest' do
      ...
      #expect(instance).to be_instance_of(MudbaseSDK::CreateOrganizationRequest)
    end
  end
  ...
  describe 'test attribute "parent_org_id"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
