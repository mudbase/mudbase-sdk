...
# Unit tests for MudbaseSDK::CreatePlan201Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::CreatePlan201Response do
  #let(:instance) { MudbaseSDK::CreatePlan201Response.new }

  describe 'test an instance of CreatePlan201Response' do
    it 'should create an instance of CreatePlan201Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::CreatePlan201Response)
    end
  end
