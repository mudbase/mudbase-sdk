...
# Unit tests for MudbaseSDK::CreatePlanRequestFeaturesInnerOneOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::CreatePlanRequestFeaturesInnerOneOf do
  #let(:instance) { MudbaseSDK::CreatePlanRequestFeaturesInnerOneOf.new }

  describe 'test an instance of CreatePlanRequestFeaturesInnerOneOf' do
    it 'should create an instance of CreatePlanRequestFeaturesInnerOneOf' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::CreatePlanRequestFeaturesInnerOneOf)
    end
  end
