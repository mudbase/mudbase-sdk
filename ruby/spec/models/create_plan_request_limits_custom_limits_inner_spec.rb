...
# Unit tests for MudbaseSDK::CreatePlanRequestLimitsCustomLimitsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::CreatePlanRequestLimitsCustomLimitsInner do
  #let(:instance) { MudbaseSDK::CreatePlanRequestLimitsCustomLimitsInner.new }

  describe 'test an instance of CreatePlanRequestLimitsCustomLimitsInner' do
    it 'should create an instance of CreatePlanRequestLimitsCustomLimitsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::CreatePlanRequestLimitsCustomLimitsInner)
    end
  end
