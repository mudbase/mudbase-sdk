...
# Unit tests for MudbaseSDK::CreatePlanRequestLimits
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::CreatePlanRequestLimits do
  #let(:instance) { MudbaseSDK::CreatePlanRequestLimits.new }

  describe 'test an instance of CreatePlanRequestLimits' do
    it 'should create an instance of CreatePlanRequestLimits' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::CreatePlanRequestLimits)
    end
  end
