...
# Unit tests for MudbaseSDK::CreatePlanRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::CreatePlanRequest do
  #let(:instance) { MudbaseSDK::CreatePlanRequest.new }

  describe 'test an instance of CreatePlanRequest' do
    it 'should create an instance of CreatePlanRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::CreatePlanRequest)
    end
  end
