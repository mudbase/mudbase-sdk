...
# Unit tests for MudbaseSDK::CreatePlanRequestTrial
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::CreatePlanRequestTrial do
  #let(:instance) { MudbaseSDK::CreatePlanRequestTrial.new }

  describe 'test an instance of CreatePlanRequestTrial' do
    it 'should create an instance of CreatePlanRequestTrial' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::CreatePlanRequestTrial)
    end
  end
