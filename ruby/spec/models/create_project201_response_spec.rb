...
# Unit tests for MudbaseSDK::CreateProject201Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::CreateProject201Response do
  #let(:instance) { MudbaseSDK::CreateProject201Response.new }

  describe 'test an instance of CreateProject201Response' do
    it 'should create an instance of CreateProject201Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::CreateProject201Response)
    end
  end
