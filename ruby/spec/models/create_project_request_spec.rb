...
# Unit tests for MudbaseSDK::CreateProjectRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::CreateProjectRequest do
  #let(:instance) { MudbaseSDK::CreateProjectRequest.new }

  describe 'test an instance of CreateProjectRequest' do
    it 'should create an instance of CreateProjectRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::CreateProjectRequest)
    end
  end
