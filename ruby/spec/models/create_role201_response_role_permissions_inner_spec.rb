...
# Unit tests for MudbaseSDK::CreateRole201ResponseRolePermissionsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::CreateRole201ResponseRolePermissionsInner do
  #let(:instance) { MudbaseSDK::CreateRole201ResponseRolePermissionsInner.new }

  describe 'test an instance of CreateRole201ResponseRolePermissionsInner' do
    it 'should create an instance of CreateRole201ResponseRolePermissionsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::CreateRole201ResponseRolePermissionsInner)
    end
  end
