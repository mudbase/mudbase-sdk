...
# Unit tests for MudbaseSDK::CreateRole201ResponseRole
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::CreateRole201ResponseRole do
  #let(:instance) { MudbaseSDK::CreateRole201ResponseRole.new }

  describe 'test an instance of CreateRole201ResponseRole' do
    it 'should create an instance of CreateRole201ResponseRole' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::CreateRole201ResponseRole)
    end
  end
