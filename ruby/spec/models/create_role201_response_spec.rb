...
# Unit tests for MudbaseSDK::CreateRole201Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::CreateRole201Response do
  #let(:instance) { MudbaseSDK::CreateRole201Response.new }

  describe 'test an instance of CreateRole201Response' do
    it 'should create an instance of CreateRole201Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::CreateRole201Response)
    end
  end
