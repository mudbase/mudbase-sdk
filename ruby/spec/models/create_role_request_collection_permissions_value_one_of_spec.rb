...
# Unit tests for MudbaseSDK::CreateRoleRequestCollectionPermissionsValueOneOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::CreateRoleRequestCollectionPermissionsValueOneOf do
  #let(:instance) { MudbaseSDK::CreateRoleRequestCollectionPermissionsValueOneOf.new }

  describe 'test an instance of CreateRoleRequestCollectionPermissionsValueOneOf' do
    it 'should create an instance of CreateRoleRequestCollectionPermissionsValueOneOf' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::CreateRoleRequestCollectionPermissionsValueOneOf)
    end
  end
