...
# Unit tests for MudbaseSDK::CreateRoleRequestPermissionsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::CreateRoleRequestPermissionsInner do
  #let(:instance) { MudbaseSDK::CreateRoleRequestPermissionsInner.new }

  describe 'test an instance of CreateRoleRequestPermissionsInner' do
    it 'should create an instance of CreateRoleRequestPermissionsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::CreateRoleRequestPermissionsInner)
    end
  end
  ...
  describe 'test attribute "resource"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["project", "collection", "data", "file", "api_key", "org", "member", "role"])
  ...
  describe 'test attribute "actions"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('Array<String>', ["create", "read", "update", "delete", "manage"])
      # validator.allowable_values.each do |value|
