...
# Unit tests for MudbaseSDK::CreateRoleRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::CreateRoleRequest do
  #let(:instance) { MudbaseSDK::CreateRoleRequest.new }

  describe 'test an instance of CreateRoleRequest' do
    it 'should create an instance of CreateRoleRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::CreateRoleRequest)
    end
  end
