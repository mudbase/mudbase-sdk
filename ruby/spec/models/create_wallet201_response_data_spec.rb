...
# Unit tests for MudbaseSDK::CreateWallet201ResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::CreateWallet201ResponseData do
  #let(:instance) { MudbaseSDK::CreateWallet201ResponseData.new }

  describe 'test an instance of CreateWallet201ResponseData' do
    it 'should create an instance of CreateWallet201ResponseData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::CreateWallet201ResponseData)
    end
  end
