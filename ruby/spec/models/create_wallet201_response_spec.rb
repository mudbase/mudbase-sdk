...
# Unit tests for MudbaseSDK::CreateWallet201Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::CreateWallet201Response do
  #let(:instance) { MudbaseSDK::CreateWallet201Response.new }

  describe 'test an instance of CreateWallet201Response' do
    it 'should create an instance of CreateWallet201Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::CreateWallet201Response)
    end
  end
