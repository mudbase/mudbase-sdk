...
# Unit tests for MudbaseSDK::CreateWalletRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::CreateWalletRequest do
  #let(:instance) { MudbaseSDK::CreateWalletRequest.new }

  describe 'test an instance of CreateWalletRequest' do
    it 'should create an instance of CreateWalletRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::CreateWalletRequest)
    end
  end
  ...
  describe 'test attribute "currency"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["BTC", "LTC", "DOGE", "ETH", "CELO", "SOL", "TRX", "TON", "MATIC", "BNB", "AVAX", "ADA", "USDT"])
