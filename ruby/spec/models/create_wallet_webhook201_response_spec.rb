...
# Unit tests for MudbaseSDK::CreateWalletWebhook201Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::CreateWalletWebhook201Response do
  #let(:instance) { MudbaseSDK::CreateWalletWebhook201Response.new }

  describe 'test an instance of CreateWalletWebhook201Response' do
    it 'should create an instance of CreateWalletWebhook201Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::CreateWalletWebhook201Response)
    end
  end
