...
# Unit tests for MudbaseSDK::CreateWalletWebhookRequestFilters
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::CreateWalletWebhookRequestFilters do
  #let(:instance) { MudbaseSDK::CreateWalletWebhookRequestFilters.new }

  describe 'test an instance of CreateWalletWebhookRequestFilters' do
    it 'should create an instance of CreateWalletWebhookRequestFilters' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::CreateWalletWebhookRequestFilters)
    end
  end
  ...
  describe 'test attribute "chains"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('Array<String>', ["ethereum", "binance", "bsc", "polygon", "arbitrum", "optimism", "base", "avalanche", "celo", "bitcoin", "litecoin", "dogecoin", "solana", "tron", "ripple", "cardano", "ton"])
      # validator.allowable_values.each do |value|
      #   expect { instance.chains = value }.not_to raise_error
      # end
    end
  end
