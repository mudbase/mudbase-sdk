...
# Unit tests for MudbaseSDK::CreateWalletWebhookRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::CreateWalletWebhookRequest do
  #let(:instance) { MudbaseSDK::CreateWalletWebhookRequest.new }

  describe 'test an instance of CreateWalletWebhookRequest' do
    it 'should create an instance of CreateWalletWebhookRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::CreateWalletWebhookRequest)
    end
  end
  ...
  describe 'test attribute "events"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('Array<String>', ["wallet.balance.updated", "wallet.transaction.confirmed", "wallet.transaction.failed", "wallet.transaction.detected", "wallet.transaction.broadcast", "wallet.token.balance.updated", "wallet.address.created", "wallet.address.deactivated"])
