...
# Unit tests for MudbaseSDK::DashboardActivityItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::DashboardActivityItem do
  #let(:instance) { MudbaseSDK::DashboardActivityItem.new }

  describe 'test an instance of DashboardActivityItem' do
    it 'should create an instance of DashboardActivityItem' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::DashboardActivityItem)
    end
  end
