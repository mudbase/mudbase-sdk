...
# Unit tests for MudbaseSDK::DashboardOverviewDataLatencyInstanceRollup
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::DashboardOverviewDataLatencyInstanceRollup do
  #let(:instance) { MudbaseSDK::DashboardOverviewDataLatencyInstanceRollup.new }

  describe 'test an instance of DashboardOverviewDataLatencyInstanceRollup' do
    it 'should create an instance of DashboardOverviewDataLatencyInstanceRollup' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::DashboardOverviewDataLatencyInstanceRollup)
    end
  end
  ...
  describe 'test attribute "scope"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["instance_recent"])
  ...
  describe 'test attribute "p99_ms"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "mean_ms"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "samples_approx"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "templates_tracked"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
