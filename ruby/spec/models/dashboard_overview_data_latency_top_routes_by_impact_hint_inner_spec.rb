...
# Unit tests for MudbaseSDK::DashboardOverviewDataLatencyTopRoutesByImpactHintInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::DashboardOverviewDataLatencyTopRoutesByImpactHintInner do
  #let(:instance) { MudbaseSDK::DashboardOverviewDataLatencyTopRoutesByImpactHintInner.new }

  describe 'test an instance of DashboardOverviewDataLatencyTopRoutesByImpactHintInner' do
    it 'should create an instance of DashboardOverviewDataLatencyTopRoutesByImpactHintInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::DashboardOverviewDataLatencyTopRoutesByImpactHintInner)
    end
  end

  describe 'test attribute "route_key"' do
    it 'should work' do
