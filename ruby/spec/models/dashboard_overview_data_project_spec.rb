...
# Unit tests for MudbaseSDK::DashboardOverviewDataProject
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::DashboardOverviewDataProject do
  #let(:instance) { MudbaseSDK::DashboardOverviewDataProject.new }

  describe 'test an instance of DashboardOverviewDataProject' do
    it 'should create an instance of DashboardOverviewDataProject' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::DashboardOverviewDataProject)
    end
  end
