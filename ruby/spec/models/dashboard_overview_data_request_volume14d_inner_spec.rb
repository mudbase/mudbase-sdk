...
# Unit tests for MudbaseSDK::DashboardOverviewDataRequestVolume14dInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::DashboardOverviewDataRequestVolume14dInner do
  #let(:instance) { MudbaseSDK::DashboardOverviewDataRequestVolume14dInner.new }

  describe 'test an instance of DashboardOverviewDataRequestVolume14dInner' do
    it 'should create an instance of DashboardOverviewDataRequestVolume14dInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::DashboardOverviewDataRequestVolume14dInner)
    end
  end
  ...
  describe 'test attribute "latency_tracked"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
