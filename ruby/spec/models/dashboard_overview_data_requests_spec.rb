...
# Unit tests for MudbaseSDK::DashboardOverviewDataRequests
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::DashboardOverviewDataRequests do
  #let(:instance) { MudbaseSDK::DashboardOverviewDataRequests.new }

  describe 'test an instance of DashboardOverviewDataRequests' do
    it 'should create an instance of DashboardOverviewDataRequests' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::DashboardOverviewDataRequests)
    end
  end

  describe 'test attribute "today"' do
    it 'should work' do
  ...
  describe 'test attribute "latency_tracked_today"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "latency_tracked_yesterday"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "metering_note"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "direction"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["up", "down", "flat"])
