...
# Unit tests for MudbaseSDK::DashboardOverviewData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::DashboardOverviewData do
  #let(:instance) { MudbaseSDK::DashboardOverviewData.new }

  describe 'test an instance of DashboardOverviewData' do
    it 'should create an instance of DashboardOverviewData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::DashboardOverviewData)
    end
  end
  ...
  describe 'test attribute "request_volume14d"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "recent_activity"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
