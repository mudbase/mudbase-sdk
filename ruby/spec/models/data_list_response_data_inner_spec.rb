...
# Unit tests for MudbaseSDK::DataListResponseDataInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::DataListResponseDataInner do
  #let(:instance) { MudbaseSDK::DataListResponseDataInner.new }

  describe 'test an instance of DataListResponseDataInner' do
    it 'should create an instance of DataListResponseDataInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::DataListResponseDataInner)
    end
  end
