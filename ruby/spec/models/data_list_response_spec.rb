...
# Unit tests for MudbaseSDK::DataListResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::DataListResponse do
  #let(:instance) { MudbaseSDK::DataListResponse.new }

  describe 'test an instance of DataListResponse' do
    it 'should create an instance of DataListResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::DataListResponse)
    end
  end
