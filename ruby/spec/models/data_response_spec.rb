...
# Unit tests for MudbaseSDK::DataResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::DataResponse do
  #let(:instance) { MudbaseSDK::DataResponse.new }

  describe 'test an instance of DataResponse' do
    it 'should create an instance of DataResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::DataResponse)
    end
  end
