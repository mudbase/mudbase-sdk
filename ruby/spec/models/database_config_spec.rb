...
# Unit tests for MudbaseSDK::DatabaseConfig
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::DatabaseConfig do
  #let(:instance) { MudbaseSDK::DatabaseConfig.new }

  describe 'test an instance of DatabaseConfig' do
    it 'should create an instance of DatabaseConfig' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::DatabaseConfig)
    end
  end
