...
# Unit tests for MudbaseSDK::DeleteBackup200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::DeleteBackup200Response do
  #let(:instance) { MudbaseSDK::DeleteBackup200Response.new }

  describe 'test an instance of DeleteBackup200Response' do
    it 'should create an instance of DeleteBackup200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::DeleteBackup200Response)
    end
  end
