...
# Unit tests for MudbaseSDK::DeleteFunction200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::DeleteFunction200Response do
  #let(:instance) { MudbaseSDK::DeleteFunction200Response.new }

  describe 'test an instance of DeleteFunction200Response' do
    it 'should create an instance of DeleteFunction200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::DeleteFunction200Response)
    end
  end
