...
# Unit tests for MudbaseSDK::DeleteOrganization200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::DeleteOrganization200Response do
  #let(:instance) { MudbaseSDK::DeleteOrganization200Response.new }

  describe 'test an instance of DeleteOrganization200Response' do
    it 'should create an instance of DeleteOrganization200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::DeleteOrganization200Response)
    end
  end
