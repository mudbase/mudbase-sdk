...
# Unit tests for MudbaseSDK::DeleteRole200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::DeleteRole200Response do
  #let(:instance) { MudbaseSDK::DeleteRole200Response.new }

  describe 'test an instance of DeleteRole200Response' do
    it 'should create an instance of DeleteRole200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::DeleteRole200Response)
    end
  end
