...
# Unit tests for MudbaseSDK::DeleteSubOrganization200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::DeleteSubOrganization200Response do
  #let(:instance) { MudbaseSDK::DeleteSubOrganization200Response.new }

  describe 'test an instance of DeleteSubOrganization200Response' do
    it 'should create an instance of DeleteSubOrganization200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::DeleteSubOrganization200Response)
    end
  end
