...
# Unit tests for MudbaseSDK::Disable2FARequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::Disable2FARequest do
  #let(:instance) { MudbaseSDK::Disable2FARequest.new }

  describe 'test an instance of Disable2FARequest' do
    it 'should create an instance of Disable2FARequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::Disable2FARequest)
    end
  end
