...
# Unit tests for MudbaseSDK::DownloadBucketFile403Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::DownloadBucketFile403Response do
  #let(:instance) { MudbaseSDK::DownloadBucketFile403Response.new }

  describe 'test an instance of DownloadBucketFile403Response' do
    it 'should create an instance of DownloadBucketFile403Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::DownloadBucketFile403Response)
    end
  end
