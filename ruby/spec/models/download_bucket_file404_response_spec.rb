...
# Unit tests for MudbaseSDK::DownloadBucketFile404Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::DownloadBucketFile404Response do
  #let(:instance) { MudbaseSDK::DownloadBucketFile404Response.new }

  describe 'test an instance of DownloadBucketFile404Response' do
    it 'should create an instance of DownloadBucketFile404Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::DownloadBucketFile404Response)
    end
  end
