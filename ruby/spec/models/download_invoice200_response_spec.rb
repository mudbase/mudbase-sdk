...
# Unit tests for MudbaseSDK::DownloadInvoice200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::DownloadInvoice200Response do
  #let(:instance) { MudbaseSDK::DownloadInvoice200Response.new }

  describe 'test an instance of DownloadInvoice200Response' do
    it 'should create an instance of DownloadInvoice200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::DownloadInvoice200Response)
    end
  end
