...
# Unit tests for MudbaseSDK::EditMessage200ResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::EditMessage200ResponseData do
  #let(:instance) { MudbaseSDK::EditMessage200ResponseData.new }

  describe 'test an instance of EditMessage200ResponseData' do
    it 'should create an instance of EditMessage200ResponseData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::EditMessage200ResponseData)
    end
  end
  ...
  describe 'test attribute "is_e2ee"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "e2ee"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
