...
# Unit tests for MudbaseSDK::EditMessage200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::EditMessage200Response do
  #let(:instance) { MudbaseSDK::EditMessage200Response.new }

  describe 'test an instance of EditMessage200Response' do
    it 'should create an instance of EditMessage200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::EditMessage200Response)
    end
  end
