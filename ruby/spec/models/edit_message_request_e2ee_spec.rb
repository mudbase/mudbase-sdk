...
# Unit tests for MudbaseSDK::EditMessageRequestE2ee
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::EditMessageRequestE2ee do
  #let(:instance) { MudbaseSDK::EditMessageRequestE2ee.new }

  describe 'test an instance of EditMessageRequestE2ee' do
    it 'should create an instance of EditMessageRequestE2ee' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::EditMessageRequestE2ee)
    end
  end
  ...
  describe 'test attribute "sender_key_id"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
