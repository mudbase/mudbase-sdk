...
# Unit tests for MudbaseSDK::EditMessageRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::EditMessageRequest do
  #let(:instance) { MudbaseSDK::EditMessageRequest.new }

  describe 'test an instance of EditMessageRequest' do
    it 'should create an instance of EditMessageRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::EditMessageRequest)
    end
  end
