...
# Unit tests for MudbaseSDK::EmailRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::EmailRequest do
  #let(:instance) { MudbaseSDK::EmailRequest.new }

  describe 'test an instance of EmailRequest' do
    it 'should create an instance of EmailRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::EmailRequest)
    end
  end
