...
# Unit tests for MudbaseSDK::EmailTemplateCatalogItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::EmailTemplateCatalogItem do
  #let(:instance) { MudbaseSDK::EmailTemplateCatalogItem.new }

  describe 'test an instance of EmailTemplateCatalogItem' do
    it 'should create an instance of EmailTemplateCatalogItem' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::EmailTemplateCatalogItem)
    end
  end
  ...
  describe 'test attribute "is_customized"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "effective_source"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["project", "global", "builtin"])
      # validator.allowable_values.each do |value|
      #   expect { instance.effective_source = value }.not_to raise_error
      # end
    end
  end

  describe 'test attribute "subject_snippet"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
