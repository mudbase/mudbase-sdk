...
# Unit tests for MudbaseSDK::EmailTemplateResolved
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::EmailTemplateResolved do
  #let(:instance) { MudbaseSDK::EmailTemplateResolved.new }

  describe 'test an instance of EmailTemplateResolved' do
    it 'should create an instance of EmailTemplateResolved' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::EmailTemplateResolved)
    end
  end
  ...
  describe 'test attribute "is_project_override"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
