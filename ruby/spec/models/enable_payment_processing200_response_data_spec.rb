...
# Unit tests for MudbaseSDK::EnablePaymentProcessing200ResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::EnablePaymentProcessing200ResponseData do
  #let(:instance) { MudbaseSDK::EnablePaymentProcessing200ResponseData.new }

  describe 'test an instance of EnablePaymentProcessing200ResponseData' do
    it 'should create an instance of EnablePaymentProcessing200ResponseData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::EnablePaymentProcessing200ResponseData)
    end
  end
  ...
  describe 'test attribute "already_enabled"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
