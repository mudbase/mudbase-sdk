...
# Unit tests for MudbaseSDK::EnablePaymentProcessing200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::EnablePaymentProcessing200Response do
  #let(:instance) { MudbaseSDK::EnablePaymentProcessing200Response.new }

  describe 'test an instance of EnablePaymentProcessing200Response' do
    it 'should create an instance of EnablePaymentProcessing200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::EnablePaymentProcessing200Response)
    end
  end
