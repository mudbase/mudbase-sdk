...
# Unit tests for MudbaseSDK::EnablePaymentProcessingRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::EnablePaymentProcessingRequest do
  #let(:instance) { MudbaseSDK::EnablePaymentProcessingRequest.new }

  describe 'test an instance of EnablePaymentProcessingRequest' do
    it 'should create an instance of EnablePaymentProcessingRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::EnablePaymentProcessingRequest)
    end
  end

  describe 'test attribute "account_bank"' do
    it 'should work' do
  ...
  describe 'test attribute "business_mobile"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "bvn"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
