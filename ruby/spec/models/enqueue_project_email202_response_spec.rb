...
# Unit tests for MudbaseSDK::EnqueueProjectEmail202Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::EnqueueProjectEmail202Response do
  #let(:instance) { MudbaseSDK::EnqueueProjectEmail202Response.new }

  describe 'test an instance of EnqueueProjectEmail202Response' do
    it 'should create an instance of EnqueueProjectEmail202Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::EnqueueProjectEmail202Response)
    end
  end
