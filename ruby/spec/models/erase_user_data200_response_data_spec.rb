...
# Unit tests for MudbaseSDK::EraseUserData200ResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::EraseUserData200ResponseData do
  #let(:instance) { MudbaseSDK::EraseUserData200ResponseData.new }

  describe 'test an instance of EraseUserData200ResponseData' do
    it 'should create an instance of EraseUserData200ResponseData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::EraseUserData200ResponseData)
    end
  end

  describe 'test attribute "already_erased"' do
    it 'should work' do
  ...
  describe 'test attribute "anonymized"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "sessions_revoked"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
