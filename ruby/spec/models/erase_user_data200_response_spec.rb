...
# Unit tests for MudbaseSDK::EraseUserData200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::EraseUserData200Response do
  #let(:instance) { MudbaseSDK::EraseUserData200Response.new }

  describe 'test an instance of EraseUserData200Response' do
    it 'should create an instance of EraseUserData200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::EraseUserData200Response)
    end
  end
