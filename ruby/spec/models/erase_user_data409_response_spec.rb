...
# Unit tests for MudbaseSDK::EraseUserData409Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::EraseUserData409Response do
  #let(:instance) { MudbaseSDK::EraseUserData409Response.new }

  describe 'test an instance of EraseUserData409Response' do
    it 'should create an instance of EraseUserData409Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::EraseUserData409Response)
    end
  end
  ...
  describe 'test attribute "sole_owned_orgs"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
