...
# Unit tests for MudbaseSDK::EraseUserDataRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::EraseUserDataRequest do
  #let(:instance) { MudbaseSDK::EraseUserDataRequest.new }

  describe 'test an instance of EraseUserDataRequest' do
    it 'should create an instance of EraseUserDataRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::EraseUserDataRequest)
    end
  end
