...
# Unit tests for MudbaseSDK::EstimateNetworkFee200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::EstimateNetworkFee200Response do
  #let(:instance) { MudbaseSDK::EstimateNetworkFee200Response.new }

  describe 'test an instance of EstimateNetworkFee200Response' do
    it 'should create an instance of EstimateNetworkFee200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::EstimateNetworkFee200Response)
    end
  end
