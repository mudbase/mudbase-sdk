...
# Unit tests for MudbaseSDK::EstimateNetworkFeeRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::EstimateNetworkFeeRequest do
  #let(:instance) { MudbaseSDK::EstimateNetworkFeeRequest.new }

  describe 'test an instance of EstimateNetworkFeeRequest' do
    it 'should create an instance of EstimateNetworkFeeRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::EstimateNetworkFeeRequest)
    end
  end
  ...
  describe 'test attribute "currency"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["BTC", "ETH", "BNB", "LTC", "SOL", "TRX", "USDT", "MATIC", "AVAX", "CELO", "DOGE", "TON", "ADA"])
  ...
  describe 'test attribute "network"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["ETH", "BSC", "TRX", "SOL", "POLYGON"])
      # validator.allowable_values.each do |value|
