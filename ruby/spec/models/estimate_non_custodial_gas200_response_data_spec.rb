...
# Unit tests for MudbaseSDK::EstimateNonCustodialGas200ResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::EstimateNonCustodialGas200ResponseData do
  #let(:instance) { MudbaseSDK::EstimateNonCustodialGas200ResponseData.new }

  describe 'test an instance of EstimateNonCustodialGas200ResponseData' do
    it 'should create an instance of EstimateNonCustodialGas200ResponseData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::EstimateNonCustodialGas200ResponseData)
    end
  end
