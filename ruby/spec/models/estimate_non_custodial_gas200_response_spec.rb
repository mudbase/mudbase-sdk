...
# Unit tests for MudbaseSDK::EstimateNonCustodialGas200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::EstimateNonCustodialGas200Response do
  #let(:instance) { MudbaseSDK::EstimateNonCustodialGas200Response.new }

  describe 'test an instance of EstimateNonCustodialGas200Response' do
    it 'should create an instance of EstimateNonCustodialGas200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::EstimateNonCustodialGas200Response)
    end
  end
