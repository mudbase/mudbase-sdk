...
# Unit tests for MudbaseSDK::EstimateNonCustodialGasRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::EstimateNonCustodialGasRequest do
  #let(:instance) { MudbaseSDK::EstimateNonCustodialGasRequest.new }

  describe 'test an instance of EstimateNonCustodialGasRequest' do
    it 'should create an instance of EstimateNonCustodialGasRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::EstimateNonCustodialGasRequest)
    end
  end
  ...
  describe 'test attribute "chain"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["ethereum", "binance", "bsc", "polygon", "arbitrum", "optimism", "base", "avalanche", "celo", "bitcoin", "litecoin", "dogecoin", "solana", "tron", "ton", "cardano"])
