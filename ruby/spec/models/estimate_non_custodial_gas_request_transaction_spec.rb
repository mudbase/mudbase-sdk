...
# Unit tests for MudbaseSDK::EstimateNonCustodialGasRequestTransaction
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::EstimateNonCustodialGasRequestTransaction do
  #let(:instance) { MudbaseSDK::EstimateNonCustodialGasRequestTransaction.new }

  describe 'test an instance of EstimateNonCustodialGasRequestTransaction' do
    it 'should create an instance of EstimateNonCustodialGasRequestTransaction' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::EstimateNonCustodialGasRequestTransaction)
    end
  end
