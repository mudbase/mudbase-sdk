...
# Unit tests for MudbaseSDK::ExecuteFunctionRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ExecuteFunctionRequest do
  #let(:instance) { MudbaseSDK::ExecuteFunctionRequest.new }

  describe 'test an instance of ExecuteFunctionRequest' do
    it 'should create an instance of ExecuteFunctionRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ExecuteFunctionRequest)
    end
  end
