...
# Unit tests for MudbaseSDK::ExecuteIntegrationRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ExecuteIntegrationRequest do
  #let(:instance) { MudbaseSDK::ExecuteIntegrationRequest.new }

  describe 'test an instance of ExecuteIntegrationRequest' do
    it 'should create an instance of ExecuteIntegrationRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ExecuteIntegrationRequest)
    end
  end
