...
# Unit tests for MudbaseSDK::ExportUserData200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ExportUserData200Response do
  #let(:instance) { MudbaseSDK::ExportUserData200Response.new }

  describe 'test an instance of ExportUserData200Response' do
    it 'should create an instance of ExportUserData200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ExportUserData200Response)
    end
  end
