...
# Unit tests for MudbaseSDK::FeatureNotAllowedError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::FeatureNotAllowedError do
  #let(:instance) { MudbaseSDK::FeatureNotAllowedError.new }

  describe 'test an instance of FeatureNotAllowedError' do
    it 'should create an instance of FeatureNotAllowedError' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::FeatureNotAllowedError)
    end
  end
