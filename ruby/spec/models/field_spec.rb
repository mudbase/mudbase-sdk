...
# Unit tests for MudbaseSDK::Field
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::Field do
  #let(:instance) { MudbaseSDK::Field.new }

  describe 'test an instance of Field' do
    it 'should create an instance of Field' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::Field)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["string", "number", "boolean", "date", "datetime", "email", "url", "text", "array", "object", "reference", "file", "enum", "json"])
