...
# Unit tests for MudbaseSDK::FileListResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::FileListResponse do
  #let(:instance) { MudbaseSDK::FileListResponse.new }

  describe 'test an instance of FileListResponse' do
    it 'should create an instance of FileListResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::FileListResponse)
    end
  end
