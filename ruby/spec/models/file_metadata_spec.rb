...
# Unit tests for MudbaseSDK::FileMetadata
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::FileMetadata do
  #let(:instance) { MudbaseSDK::FileMetadata.new }

  describe 'test an instance of FileMetadata' do
    it 'should create an instance of FileMetadata' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::FileMetadata)
    end
  end
