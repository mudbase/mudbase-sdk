...
# Unit tests for MudbaseSDK::FileResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::FileResponse do
  #let(:instance) { MudbaseSDK::FileResponse.new }

  describe 'test an instance of FileResponse' do
    it 'should create an instance of FileResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::FileResponse)
    end
  end
