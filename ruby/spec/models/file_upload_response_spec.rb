...
# Unit tests for MudbaseSDK::FileUploadResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::FileUploadResponse do
  #let(:instance) { MudbaseSDK::FileUploadResponse.new }

  describe 'test an instance of FileUploadResponse' do
    it 'should create an instance of FileUploadResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::FileUploadResponse)
    end
  end
