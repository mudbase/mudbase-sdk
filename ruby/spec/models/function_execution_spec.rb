...
# Unit tests for MudbaseSDK::FunctionExecution
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::FunctionExecution do
  #let(:instance) { MudbaseSDK::FunctionExecution.new }

  describe 'test an instance of FunctionExecution' do
    it 'should create an instance of FunctionExecution' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::FunctionExecution)
    end
  end
  ...
  describe 'test attribute "invoked_by"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["manual", "api_key", "trigger", "cron"])
      # validator.allowable_values.each do |value|
      #   expect { instance.invoked_by = value }.not_to raise_error
      # end
    end
  end
