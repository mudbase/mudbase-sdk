...
# Unit tests for MudbaseSDK::FunctionExecutionStatusResponseDataLogs
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::FunctionExecutionStatusResponseDataLogs do
  #let(:instance) { MudbaseSDK::FunctionExecutionStatusResponseDataLogs.new }

  describe 'test an instance of FunctionExecutionStatusResponseDataLogs' do
    it 'should create an instance of FunctionExecutionStatusResponseDataLogs' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::FunctionExecutionStatusResponseDataLogs)
    end
  end
