...
# Unit tests for MudbaseSDK::FunctionExecutionStatusResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::FunctionExecutionStatusResponseData do
  #let(:instance) { MudbaseSDK::FunctionExecutionStatusResponseData.new }

  describe 'test an instance of FunctionExecutionStatusResponseData' do
    it 'should create an instance of FunctionExecutionStatusResponseData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::FunctionExecutionStatusResponseData)
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["queued", "provisioning", "running", "success", "failed", "timeout"])
