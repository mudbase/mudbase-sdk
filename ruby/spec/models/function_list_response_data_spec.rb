...
# Unit tests for MudbaseSDK::FunctionListResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::FunctionListResponseData do
  #let(:instance) { MudbaseSDK::FunctionListResponseData.new }

  describe 'test an instance of FunctionListResponseData' do
    it 'should create an instance of FunctionListResponseData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::FunctionListResponseData)
    end
  end
