...
# Unit tests for MudbaseSDK::FunctionListResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::FunctionListResponse do
  #let(:instance) { MudbaseSDK::FunctionListResponse.new }

  describe 'test an instance of FunctionListResponse' do
    it 'should create an instance of FunctionListResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::FunctionListResponse)
    end
  end
