...
# Unit tests for MudbaseSDK::FunctionLogsResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::FunctionLogsResponseData do
  #let(:instance) { MudbaseSDK::FunctionLogsResponseData.new }

  describe 'test an instance of FunctionLogsResponseData' do
    it 'should create an instance of FunctionLogsResponseData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::FunctionLogsResponseData)
    end
  end
