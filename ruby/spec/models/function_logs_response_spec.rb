...
# Unit tests for MudbaseSDK::FunctionLogsResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::FunctionLogsResponse do
  #let(:instance) { MudbaseSDK::FunctionLogsResponse.new }

  describe 'test an instance of FunctionLogsResponse' do
    it 'should create an instance of FunctionLogsResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::FunctionLogsResponse)
    end
  end
