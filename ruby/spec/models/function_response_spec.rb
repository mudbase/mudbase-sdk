...
# Unit tests for MudbaseSDK::FunctionResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::FunctionResponse do
  #let(:instance) { MudbaseSDK::FunctionResponse.new }

  describe 'test an instance of FunctionResponse' do
    it 'should create an instance of FunctionResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::FunctionResponse)
    end
  end
