...
# Unit tests for MudbaseSDK::Function
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::Function do
  #let(:instance) { MudbaseSDK::Function.new }

  describe 'test an instance of Function' do
    it 'should create an instance of Function' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::Function)
    end
  end
