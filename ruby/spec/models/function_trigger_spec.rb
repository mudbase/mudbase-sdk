...
# Unit tests for MudbaseSDK::FunctionTrigger
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::FunctionTrigger do
  #let(:instance) { MudbaseSDK::FunctionTrigger.new }

  describe 'test an instance of FunctionTrigger' do
    it 'should create an instance of FunctionTrigger' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::FunctionTrigger)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["http", "event", "document", "file", "webhook", "wallet", "cron", "messaging"])
