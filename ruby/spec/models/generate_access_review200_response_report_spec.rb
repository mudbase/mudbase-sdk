...
# Unit tests for MudbaseSDK::GenerateAccessReview200ResponseReport
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GenerateAccessReview200ResponseReport do
  #let(:instance) { MudbaseSDK::GenerateAccessReview200ResponseReport.new }

  describe 'test an instance of GenerateAccessReview200ResponseReport' do
    it 'should create an instance of GenerateAccessReview200ResponseReport' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GenerateAccessReview200ResponseReport)
    end
  end
  ...
  describe 'test attribute "review_period"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
