...
# Unit tests for MudbaseSDK::GenerateAccessReview200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GenerateAccessReview200Response do
  #let(:instance) { MudbaseSDK::GenerateAccessReview200Response.new }

  describe 'test an instance of GenerateAccessReview200Response' do
    it 'should create an instance of GenerateAccessReview200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GenerateAccessReview200Response)
    end
  end
