...
# Unit tests for MudbaseSDK::GenerateAccessReviewRequestReviewPeriod
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GenerateAccessReviewRequestReviewPeriod do
  #let(:instance) { MudbaseSDK::GenerateAccessReviewRequestReviewPeriod.new }

  describe 'test an instance of GenerateAccessReviewRequestReviewPeriod' do
    it 'should create an instance of GenerateAccessReviewRequestReviewPeriod' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GenerateAccessReviewRequestReviewPeriod)
    end
  end
