...
# Unit tests for MudbaseSDK::GenerateAccessReviewRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GenerateAccessReviewRequest do
  #let(:instance) { MudbaseSDK::GenerateAccessReviewRequest.new }

  describe 'test an instance of GenerateAccessReviewRequest' do
    it 'should create an instance of GenerateAccessReviewRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GenerateAccessReviewRequest)
    end
  end
