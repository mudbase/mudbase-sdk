...
# Unit tests for MudbaseSDK::GenerateDataProcessingRecord200ResponseRecord
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GenerateDataProcessingRecord200ResponseRecord do
  #let(:instance) { MudbaseSDK::GenerateDataProcessingRecord200ResponseRecord.new }

  describe 'test an instance of GenerateDataProcessingRecord200ResponseRecord' do
    it 'should create an instance of GenerateDataProcessingRecord200ResponseRecord' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GenerateDataProcessingRecord200ResponseRecord)
    end
  end
  ...
  describe 'test attribute "data_controller"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "processing_activities"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "data_subjects"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
