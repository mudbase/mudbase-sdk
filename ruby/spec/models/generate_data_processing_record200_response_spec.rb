...
# Unit tests for MudbaseSDK::GenerateDataProcessingRecord200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GenerateDataProcessingRecord200Response do
  #let(:instance) { MudbaseSDK::GenerateDataProcessingRecord200Response.new }

  describe 'test an instance of GenerateDataProcessingRecord200Response' do
    it 'should create an instance of GenerateDataProcessingRecord200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GenerateDataProcessingRecord200Response)
    end
  end
