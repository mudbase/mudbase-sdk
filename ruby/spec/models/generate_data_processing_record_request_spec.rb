...
# Unit tests for MudbaseSDK::GenerateDataProcessingRecordRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GenerateDataProcessingRecordRequest do
  #let(:instance) { MudbaseSDK::GenerateDataProcessingRecordRequest.new }

  describe 'test an instance of GenerateDataProcessingRecordRequest' do
    it 'should create an instance of GenerateDataProcessingRecordRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GenerateDataProcessingRecordRequest)
    end
  end
