...
# Unit tests for MudbaseSDK::GeneratePresignedUploadRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GeneratePresignedUploadRequest do
  #let(:instance) { MudbaseSDK::GeneratePresignedUploadRequest.new }

  describe 'test an instance of GeneratePresignedUploadRequest' do
    it 'should create an instance of GeneratePresignedUploadRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GeneratePresignedUploadRequest)
    end
  end
