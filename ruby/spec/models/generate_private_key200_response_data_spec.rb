...
# Unit tests for MudbaseSDK::GeneratePrivateKey200ResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GeneratePrivateKey200ResponseData do
  #let(:instance) { MudbaseSDK::GeneratePrivateKey200ResponseData.new }

  describe 'test an instance of GeneratePrivateKey200ResponseData' do
    it 'should create an instance of GeneratePrivateKey200ResponseData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GeneratePrivateKey200ResponseData)
    end
  end
