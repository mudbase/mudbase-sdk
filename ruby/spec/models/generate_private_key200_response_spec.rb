...
# Unit tests for MudbaseSDK::GeneratePrivateKey200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GeneratePrivateKey200Response do
  #let(:instance) { MudbaseSDK::GeneratePrivateKey200Response.new }

  describe 'test an instance of GeneratePrivateKey200Response' do
    it 'should create an instance of GeneratePrivateKey200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GeneratePrivateKey200Response)
    end
  end
