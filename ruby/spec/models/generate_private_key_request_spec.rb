...
# Unit tests for MudbaseSDK::GeneratePrivateKeyRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GeneratePrivateKeyRequest do
  #let(:instance) { MudbaseSDK::GeneratePrivateKeyRequest.new }

  describe 'test an instance of GeneratePrivateKeyRequest' do
    it 'should create an instance of GeneratePrivateKeyRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GeneratePrivateKeyRequest)
    end
  end
  ...
  describe 'test attribute "currency"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["BTC", "ETH", "BNB", "LTC", "SOL", "TRX", "USDT"])
