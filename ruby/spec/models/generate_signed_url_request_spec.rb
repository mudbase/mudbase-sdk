...
# Unit tests for MudbaseSDK::GenerateSignedUrlRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GenerateSignedUrlRequest do
  #let(:instance) { MudbaseSDK::GenerateSignedUrlRequest.new }

  describe 'test an instance of GenerateSignedUrlRequest' do
    it 'should create an instance of GenerateSignedUrlRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GenerateSignedUrlRequest)
    end
  end
