...
# Unit tests for MudbaseSDK::GetActiveUsers200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetActiveUsers200Response do
  #let(:instance) { MudbaseSDK::GetActiveUsers200Response.new }

  describe 'test an instance of GetActiveUsers200Response' do
    it 'should create an instance of GetActiveUsers200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetActiveUsers200Response)
    end
  end
