...
# Unit tests for MudbaseSDK::GetActiveUsers200ResponseUsersInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetActiveUsers200ResponseUsersInner do
  #let(:instance) { MudbaseSDK::GetActiveUsers200ResponseUsersInner.new }

  describe 'test an instance of GetActiveUsers200ResponseUsersInner' do
    it 'should create an instance of GetActiveUsers200ResponseUsersInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetActiveUsers200ResponseUsersInner)
    end
  end
