...
# Unit tests for MudbaseSDK::GetAdminAuditEvents200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetAdminAuditEvents200Response do
  #let(:instance) { MudbaseSDK::GetAdminAuditEvents200Response.new }

  describe 'test an instance of GetAdminAuditEvents200Response' do
    it 'should create an instance of GetAdminAuditEvents200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetAdminAuditEvents200Response)
    end
  end
