...
# Unit tests for MudbaseSDK::GetAdminPayoutDashboard200ResponseDataByCurrencyInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetAdminPayoutDashboard200ResponseDataByCurrencyInner do
  #let(:instance) { MudbaseSDK::GetAdminPayoutDashboard200ResponseDataByCurrencyInner.new }

  describe 'test an instance of GetAdminPayoutDashboard200ResponseDataByCurrencyInner' do
    it 'should create an instance of GetAdminPayoutDashboard200ResponseDataByCurrencyInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetAdminPayoutDashboard200ResponseDataByCurrencyInner)
    end
  end
