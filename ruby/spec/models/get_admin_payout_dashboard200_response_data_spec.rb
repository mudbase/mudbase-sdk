...
# Unit tests for MudbaseSDK::GetAdminPayoutDashboard200ResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetAdminPayoutDashboard200ResponseData do
  #let(:instance) { MudbaseSDK::GetAdminPayoutDashboard200ResponseData.new }

  describe 'test an instance of GetAdminPayoutDashboard200ResponseData' do
    it 'should create an instance of GetAdminPayoutDashboard200ResponseData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetAdminPayoutDashboard200ResponseData)
    end
  end

  describe 'test attribute "total_pending"' do
    it 'should work' do
  ...
  describe 'test attribute "by_currency"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
