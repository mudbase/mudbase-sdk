...
# Unit tests for MudbaseSDK::GetAdminPayoutDashboard200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetAdminPayoutDashboard200Response do
  #let(:instance) { MudbaseSDK::GetAdminPayoutDashboard200Response.new }

  describe 'test an instance of GetAdminPayoutDashboard200Response' do
    it 'should create an instance of GetAdminPayoutDashboard200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetAdminPayoutDashboard200Response)
    end
  end
