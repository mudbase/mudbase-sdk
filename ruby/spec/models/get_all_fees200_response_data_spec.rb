...
# Unit tests for MudbaseSDK::GetAllFees200ResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetAllFees200ResponseData do
  #let(:instance) { MudbaseSDK::GetAllFees200ResponseData.new }

  describe 'test an instance of GetAllFees200ResponseData' do
    it 'should create an instance of GetAllFees200ResponseData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetAllFees200ResponseData)
    end
  end
