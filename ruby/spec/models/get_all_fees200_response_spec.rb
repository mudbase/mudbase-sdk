...
# Unit tests for MudbaseSDK::GetAllFees200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetAllFees200Response do
  #let(:instance) { MudbaseSDK::GetAllFees200Response.new }

  describe 'test an instance of GetAllFees200Response' do
    it 'should create an instance of GetAllFees200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetAllFees200Response)
    end
  end
