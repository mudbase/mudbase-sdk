...
# Unit tests for MudbaseSDK::GetAvailableOAuthProviders200ResponseProvidersInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetAvailableOAuthProviders200ResponseProvidersInner do
  #let(:instance) { MudbaseSDK::GetAvailableOAuthProviders200ResponseProvidersInner.new }

  describe 'test an instance of GetAvailableOAuthProviders200ResponseProvidersInner' do
    it 'should create an instance of GetAvailableOAuthProviders200ResponseProvidersInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetAvailableOAuthProviders200ResponseProvidersInner)
    end
  end
  ...
  describe 'test attribute "default_scope"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
