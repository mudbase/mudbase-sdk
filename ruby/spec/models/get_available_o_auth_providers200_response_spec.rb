...
# Unit tests for MudbaseSDK::GetAvailableOAuthProviders200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetAvailableOAuthProviders200Response do
  #let(:instance) { MudbaseSDK::GetAvailableOAuthProviders200Response.new }

  describe 'test an instance of GetAvailableOAuthProviders200Response' do
    it 'should create an instance of GetAvailableOAuthProviders200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetAvailableOAuthProviders200Response)
    end
  end
