...
# Unit tests for MudbaseSDK::GetAvailableRoles200ResponseDataInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetAvailableRoles200ResponseDataInner do
  #let(:instance) { MudbaseSDK::GetAvailableRoles200ResponseDataInner.new }

  describe 'test an instance of GetAvailableRoles200ResponseDataInner' do
    it 'should create an instance of GetAvailableRoles200ResponseDataInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetAvailableRoles200ResponseDataInner)
    end
  end
