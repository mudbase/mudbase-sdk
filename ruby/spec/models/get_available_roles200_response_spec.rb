...
# Unit tests for MudbaseSDK::GetAvailableRoles200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetAvailableRoles200Response do
  #let(:instance) { MudbaseSDK::GetAvailableRoles200Response.new }

  describe 'test an instance of GetAvailableRoles200Response' do
    it 'should create an instance of GetAvailableRoles200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetAvailableRoles200Response)
    end
  end
