...
# Unit tests for MudbaseSDK::GetBalance200ResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetBalance200ResponseData do
  #let(:instance) { MudbaseSDK::GetBalance200ResponseData.new }

  describe 'test an instance of GetBalance200ResponseData' do
    it 'should create an instance of GetBalance200ResponseData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetBalance200ResponseData)
    end
  end
