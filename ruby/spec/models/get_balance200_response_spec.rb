...
# Unit tests for MudbaseSDK::GetBalance200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetBalance200Response do
  #let(:instance) { MudbaseSDK::GetBalance200Response.new }

  describe 'test an instance of GetBalance200Response' do
    it 'should create an instance of GetBalance200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetBalance200Response)
    end
  end
