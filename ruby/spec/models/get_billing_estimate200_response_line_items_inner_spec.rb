...
# Unit tests for MudbaseSDK::GetBillingEstimate200ResponseLineItemsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetBillingEstimate200ResponseLineItemsInner do
  #let(:instance) { MudbaseSDK::GetBillingEstimate200ResponseLineItemsInner.new }

  describe 'test an instance of GetBillingEstimate200ResponseLineItemsInner' do
    it 'should create an instance of GetBillingEstimate200ResponseLineItemsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetBillingEstimate200ResponseLineItemsInner)
    end
  end
