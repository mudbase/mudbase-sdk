...
# Unit tests for MudbaseSDK::GetBillingEstimate200ResponseSpendLimits
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetBillingEstimate200ResponseSpendLimits do
  #let(:instance) { MudbaseSDK::GetBillingEstimate200ResponseSpendLimits.new }

  describe 'test an instance of GetBillingEstimate200ResponseSpendLimits' do
    it 'should create an instance of GetBillingEstimate200ResponseSpendLimits' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetBillingEstimate200ResponseSpendLimits)
    end
  end

  describe 'test attribute "soft_limit_cents"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "hard_limit_cents"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "spend_blocked"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
