...
# Unit tests for MudbaseSDK::GetCancelParams200ResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetCancelParams200ResponseData do
  #let(:instance) { MudbaseSDK::GetCancelParams200ResponseData.new }

  describe 'test an instance of GetCancelParams200ResponseData' do
    it 'should create an instance of GetCancelParams200ResponseData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetCancelParams200ResponseData)
    end
  end
