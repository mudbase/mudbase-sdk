...
# Unit tests for MudbaseSDK::GetCancelParams200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetCancelParams200Response do
  #let(:instance) { MudbaseSDK::GetCancelParams200Response.new }

  describe 'test an instance of GetCancelParams200Response' do
    it 'should create an instance of GetCancelParams200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetCancelParams200Response)
    end
  end
