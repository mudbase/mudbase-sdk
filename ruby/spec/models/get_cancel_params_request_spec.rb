...
# Unit tests for MudbaseSDK::GetCancelParamsRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetCancelParamsRequest do
  #let(:instance) { MudbaseSDK::GetCancelParamsRequest.new }

  describe 'test an instance of GetCancelParamsRequest' do
    it 'should create an instance of GetCancelParamsRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetCancelParamsRequest)
    end
  end
