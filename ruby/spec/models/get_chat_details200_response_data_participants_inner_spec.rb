...
# Unit tests for MudbaseSDK::GetChatDetails200ResponseDataParticipantsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetChatDetails200ResponseDataParticipantsInner do
  #let(:instance) { MudbaseSDK::GetChatDetails200ResponseDataParticipantsInner.new }

  describe 'test an instance of GetChatDetails200ResponseDataParticipantsInner' do
    it 'should create an instance of GetChatDetails200ResponseDataParticipantsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetChatDetails200ResponseDataParticipantsInner)
    end
  end
