...
# Unit tests for MudbaseSDK::GetChatDetails200ResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetChatDetails200ResponseData do
  #let(:instance) { MudbaseSDK::GetChatDetails200ResponseData.new }

  describe 'test an instance of GetChatDetails200ResponseData' do
    it 'should create an instance of GetChatDetails200ResponseData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetChatDetails200ResponseData)
    end
  end
