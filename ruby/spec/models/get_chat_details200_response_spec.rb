...
# Unit tests for MudbaseSDK::GetChatDetails200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetChatDetails200Response do
  #let(:instance) { MudbaseSDK::GetChatDetails200Response.new }

  describe 'test an instance of GetChatDetails200Response' do
    it 'should create an instance of GetChatDetails200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetChatDetails200Response)
    end
  end
