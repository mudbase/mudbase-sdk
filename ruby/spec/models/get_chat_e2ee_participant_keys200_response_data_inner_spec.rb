...
# Unit tests for MudbaseSDK::GetChatE2eeParticipantKeys200ResponseDataInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetChatE2eeParticipantKeys200ResponseDataInner do
  #let(:instance) { MudbaseSDK::GetChatE2eeParticipantKeys200ResponseDataInner.new }

  describe 'test an instance of GetChatE2eeParticipantKeys200ResponseDataInner' do
    it 'should create an instance of GetChatE2eeParticipantKeys200ResponseDataInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetChatE2eeParticipantKeys200ResponseDataInner)
    end
  end
  ...
  describe 'test attribute "identity_public_key"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
