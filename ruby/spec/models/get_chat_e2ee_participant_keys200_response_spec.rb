...
# Unit tests for MudbaseSDK::GetChatE2eeParticipantKeys200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetChatE2eeParticipantKeys200Response do
  #let(:instance) { MudbaseSDK::GetChatE2eeParticipantKeys200Response.new }

  describe 'test an instance of GetChatE2eeParticipantKeys200Response' do
    it 'should create an instance of GetChatE2eeParticipantKeys200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetChatE2eeParticipantKeys200Response)
    end
  end
