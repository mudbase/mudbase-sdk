...
# Unit tests for MudbaseSDK::GetChatMessages200ResponseDataMessagesInnerSender
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetChatMessages200ResponseDataMessagesInnerSender do
  #let(:instance) { MudbaseSDK::GetChatMessages200ResponseDataMessagesInnerSender.new }

  describe 'test an instance of GetChatMessages200ResponseDataMessagesInnerSender' do
    it 'should create an instance of GetChatMessages200ResponseDataMessagesInnerSender' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetChatMessages200ResponseDataMessagesInnerSender)
    end
  end
