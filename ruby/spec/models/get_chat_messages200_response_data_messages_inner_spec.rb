...
# Unit tests for MudbaseSDK::GetChatMessages200ResponseDataMessagesInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetChatMessages200ResponseDataMessagesInner do
  #let(:instance) { MudbaseSDK::GetChatMessages200ResponseDataMessagesInner.new }

  describe 'test an instance of GetChatMessages200ResponseDataMessagesInner' do
    it 'should create an instance of GetChatMessages200ResponseDataMessagesInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetChatMessages200ResponseDataMessagesInner)
    end
  end
