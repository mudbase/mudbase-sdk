...
# Unit tests for MudbaseSDK::GetChatMessages200ResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetChatMessages200ResponseData do
  #let(:instance) { MudbaseSDK::GetChatMessages200ResponseData.new }

  describe 'test an instance of GetChatMessages200ResponseData' do
    it 'should create an instance of GetChatMessages200ResponseData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetChatMessages200ResponseData)
    end
  end
