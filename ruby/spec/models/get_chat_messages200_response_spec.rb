...
# Unit tests for MudbaseSDK::GetChatMessages200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetChatMessages200Response do
  #let(:instance) { MudbaseSDK::GetChatMessages200Response.new }

  describe 'test an instance of GetChatMessages200Response' do
    it 'should create an instance of GetChatMessages200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetChatMessages200Response)
    end
  end
