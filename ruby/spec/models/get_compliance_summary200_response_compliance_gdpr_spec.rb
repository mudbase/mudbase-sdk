...
# Unit tests for MudbaseSDK::GetComplianceSummary200ResponseComplianceGdpr
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetComplianceSummary200ResponseComplianceGdpr do
  #let(:instance) { MudbaseSDK::GetComplianceSummary200ResponseComplianceGdpr.new }

  describe 'test an instance of GetComplianceSummary200ResponseComplianceGdpr' do
    it 'should create an instance of GetComplianceSummary200ResponseComplianceGdpr' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetComplianceSummary200ResponseComplianceGdpr)
    end
  end

  describe 'test attribute "data_export_enabled"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "data_erasure_enabled"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "consent_management"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
