...
# Unit tests for MudbaseSDK::GetComplianceSummary200ResponseComplianceSecurity
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetComplianceSummary200ResponseComplianceSecurity do
  #let(:instance) { MudbaseSDK::GetComplianceSummary200ResponseComplianceSecurity.new }

  describe 'test an instance of GetComplianceSummary200ResponseComplianceSecurity' do
    it 'should create an instance of GetComplianceSummary200ResponseComplianceSecurity' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetComplianceSummary200ResponseComplianceSecurity)
    end
  end
  ...
  describe 'test attribute "virus_scanning"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "encryption_at_rest"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
