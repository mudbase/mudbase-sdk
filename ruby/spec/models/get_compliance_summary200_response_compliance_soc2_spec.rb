...
# Unit tests for MudbaseSDK::GetComplianceSummary200ResponseComplianceSoc2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetComplianceSummary200ResponseComplianceSoc2 do
  #let(:instance) { MudbaseSDK::GetComplianceSummary200ResponseComplianceSoc2.new }

  describe 'test an instance of GetComplianceSummary200ResponseComplianceSoc2' do
    it 'should create an instance of GetComplianceSummary200ResponseComplianceSoc2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetComplianceSummary200ResponseComplianceSoc2)
    end
  end

  describe 'test attribute "access_reviews_enabled"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "audit_logging_enabled"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
