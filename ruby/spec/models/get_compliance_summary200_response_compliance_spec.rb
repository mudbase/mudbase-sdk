...
# Unit tests for MudbaseSDK::GetComplianceSummary200ResponseCompliance
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetComplianceSummary200ResponseCompliance do
  #let(:instance) { MudbaseSDK::GetComplianceSummary200ResponseCompliance.new }

  describe 'test an instance of GetComplianceSummary200ResponseCompliance' do
    it 'should create an instance of GetComplianceSummary200ResponseCompliance' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetComplianceSummary200ResponseCompliance)
    end
  end
  ...
  describe 'test attribute "soc2"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
