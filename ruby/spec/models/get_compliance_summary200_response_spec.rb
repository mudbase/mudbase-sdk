...
# Unit tests for MudbaseSDK::GetComplianceSummary200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetComplianceSummary200Response do
  #let(:instance) { MudbaseSDK::GetComplianceSummary200Response.new }

  describe 'test an instance of GetComplianceSummary200Response' do
    it 'should create an instance of GetComplianceSummary200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetComplianceSummary200Response)
    end
  end
