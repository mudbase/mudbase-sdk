...
# Unit tests for MudbaseSDK::GetCurrencyFeeBalance200ResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetCurrencyFeeBalance200ResponseData do
  #let(:instance) { MudbaseSDK::GetCurrencyFeeBalance200ResponseData.new }

  describe 'test an instance of GetCurrencyFeeBalance200ResponseData' do
    it 'should create an instance of GetCurrencyFeeBalance200ResponseData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetCurrencyFeeBalance200ResponseData)
    end
  end
