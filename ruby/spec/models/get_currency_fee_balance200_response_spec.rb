...
# Unit tests for MudbaseSDK::GetCurrencyFeeBalance200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetCurrencyFeeBalance200Response do
  #let(:instance) { MudbaseSDK::GetCurrencyFeeBalance200Response.new }

  describe 'test an instance of GetCurrencyFeeBalance200Response' do
    it 'should create an instance of GetCurrencyFeeBalance200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetCurrencyFeeBalance200Response)
    end
  end
