...
# Unit tests for MudbaseSDK::GetCurrentUser200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetCurrentUser200Response do
  #let(:instance) { MudbaseSDK::GetCurrentUser200Response.new }

  describe 'test an instance of GetCurrentUser200Response' do
    it 'should create an instance of GetCurrentUser200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetCurrentUser200Response)
    end
  end
