...
# Unit tests for MudbaseSDK::GetDashboard200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetDashboard200Response do
  #let(:instance) { MudbaseSDK::GetDashboard200Response.new }

  describe 'test an instance of GetDashboard200Response' do
    it 'should create an instance of GetDashboard200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetDashboard200Response)
    end
  end
  ...
  describe 'test attribute "active_plans"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
