...
# Unit tests for MudbaseSDK::GetDashboardOrganizationDetail200ResponseOrganizationProjectsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetDashboardOrganizationDetail200ResponseOrganizationProjectsInner do
  #let(:instance) { MudbaseSDK::GetDashboardOrganizationDetail200ResponseOrganizationProjectsInner.new }

  describe 'test an instance of GetDashboardOrganizationDetail200ResponseOrganizationProjectsInner' do
    it 'should create an instance of GetDashboardOrganizationDetail200ResponseOrganizationProjectsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetDashboardOrganizationDetail200ResponseOrganizationProjectsInner)
    end
  end
