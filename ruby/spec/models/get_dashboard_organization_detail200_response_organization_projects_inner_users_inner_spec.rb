...
# Unit tests for MudbaseSDK::GetDashboardOrganizationDetail200ResponseOrganizationProjectsInnerUsersInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetDashboardOrganizationDetail200ResponseOrganizationProjectsInnerUsersInner do
  #let(:instance) { MudbaseSDK::GetDashboardOrganizationDetail200ResponseOrganizationProjectsInnerUsersInner.new }

  describe 'test an instance of GetDashboardOrganizationDetail200ResponseOrganizationProjectsInnerUsersInner' do
    it 'should create an instance of GetDashboardOrganizationDetail200ResponseOrganizationProjectsInnerUsersInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetDashboardOrganizationDetail200ResponseOrganizationProjectsInnerUsersInner)
    end
  end
