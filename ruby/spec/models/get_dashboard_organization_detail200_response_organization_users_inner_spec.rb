...
# Unit tests for MudbaseSDK::GetDashboardOrganizationDetail200ResponseOrganizationUsersInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetDashboardOrganizationDetail200ResponseOrganizationUsersInner do
  #let(:instance) { MudbaseSDK::GetDashboardOrganizationDetail200ResponseOrganizationUsersInner.new }

  describe 'test an instance of GetDashboardOrganizationDetail200ResponseOrganizationUsersInner' do
    it 'should create an instance of GetDashboardOrganizationDetail200ResponseOrganizationUsersInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetDashboardOrganizationDetail200ResponseOrganizationUsersInner)
    end
  end
