...
# Unit tests for MudbaseSDK::GetDashboardOrganizationDetail200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetDashboardOrganizationDetail200Response do
  #let(:instance) { MudbaseSDK::GetDashboardOrganizationDetail200Response.new }

  describe 'test an instance of GetDashboardOrganizationDetail200Response' do
    it 'should create an instance of GetDashboardOrganizationDetail200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetDashboardOrganizationDetail200Response)
    end
  end
