...
# Unit tests for MudbaseSDK::GetDashboardOrganizations200ResponseOrganizationsInnerCreatedBy
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetDashboardOrganizations200ResponseOrganizationsInnerCreatedBy do
  #let(:instance) { MudbaseSDK::GetDashboardOrganizations200ResponseOrganizationsInnerCreatedBy.new }

  describe 'test an instance of GetDashboardOrganizations200ResponseOrganizationsInnerCreatedBy' do
    it 'should create an instance of GetDashboardOrganizations200ResponseOrganizationsInnerCreatedBy' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetDashboardOrganizations200ResponseOrganizationsInnerCreatedBy)
    end
  end
