...
# Unit tests for MudbaseSDK::GetDashboardOrganizations200ResponseOrganizationsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetDashboardOrganizations200ResponseOrganizationsInner do
  #let(:instance) { MudbaseSDK::GetDashboardOrganizations200ResponseOrganizationsInner.new }

  describe 'test an instance of GetDashboardOrganizations200ResponseOrganizationsInner' do
    it 'should create an instance of GetDashboardOrganizations200ResponseOrganizationsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetDashboardOrganizations200ResponseOrganizationsInner)
    end
  end
  ...
  describe 'test attribute "dedicated_api_base_url"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
