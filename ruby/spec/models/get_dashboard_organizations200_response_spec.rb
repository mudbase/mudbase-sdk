...
# Unit tests for MudbaseSDK::GetDashboardOrganizations200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetDashboardOrganizations200Response do
  #let(:instance) { MudbaseSDK::GetDashboardOrganizations200Response.new }

  describe 'test an instance of GetDashboardOrganizations200Response' do
    it 'should create an instance of GetDashboardOrganizations200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetDashboardOrganizations200Response)
    end
  end
