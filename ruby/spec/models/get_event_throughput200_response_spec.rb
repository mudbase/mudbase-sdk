...
# Unit tests for MudbaseSDK::GetEventThroughput200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetEventThroughput200Response do
  #let(:instance) { MudbaseSDK::GetEventThroughput200Response.new }

  describe 'test an instance of GetEventThroughput200Response' do
    it 'should create an instance of GetEventThroughput200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetEventThroughput200Response)
    end
  end

  describe 'test attribute "window_ms"' do
    it 'should work' do
  ...
  describe 'test attribute "events_per_second"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
