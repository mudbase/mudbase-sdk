...
# Unit tests for MudbaseSDK::GetFeeBalances200ResponseDataInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetFeeBalances200ResponseDataInner do
  #let(:instance) { MudbaseSDK::GetFeeBalances200ResponseDataInner.new }

  describe 'test an instance of GetFeeBalances200ResponseDataInner' do
    it 'should create an instance of GetFeeBalances200ResponseDataInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetFeeBalances200ResponseDataInner)
    end
  end
  ...
  describe 'test attribute "total_collected"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "total_paid_out"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
