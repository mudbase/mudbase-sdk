...
# Unit tests for MudbaseSDK::GetFeeBalances200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetFeeBalances200Response do
  #let(:instance) { MudbaseSDK::GetFeeBalances200Response.new }

  describe 'test an instance of GetFeeBalances200Response' do
    it 'should create an instance of GetFeeBalances200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetFeeBalances200Response)
    end
  end
