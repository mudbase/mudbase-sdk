...
# Unit tests for MudbaseSDK::GetFeeBreakdown200ResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetFeeBreakdown200ResponseData do
  #let(:instance) { MudbaseSDK::GetFeeBreakdown200ResponseData.new }

  describe 'test an instance of GetFeeBreakdown200ResponseData' do
    it 'should create an instance of GetFeeBreakdown200ResponseData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetFeeBreakdown200ResponseData)
    end
  end
