...
# Unit tests for MudbaseSDK::GetFeeBreakdown200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetFeeBreakdown200Response do
  #let(:instance) { MudbaseSDK::GetFeeBreakdown200Response.new }

  describe 'test an instance of GetFeeBreakdown200Response' do
    it 'should create an instance of GetFeeBreakdown200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetFeeBreakdown200Response)
    end
  end
