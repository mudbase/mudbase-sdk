...
# Unit tests for MudbaseSDK::GetFunctionVersions200ResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetFunctionVersions200ResponseData do
  #let(:instance) { MudbaseSDK::GetFunctionVersions200ResponseData.new }

  describe 'test an instance of GetFunctionVersions200ResponseData' do
    it 'should create an instance of GetFunctionVersions200ResponseData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetFunctionVersions200ResponseData)
    end
  end
