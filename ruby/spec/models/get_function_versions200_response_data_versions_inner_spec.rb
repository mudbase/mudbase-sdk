...
# Unit tests for MudbaseSDK::GetFunctionVersions200ResponseDataVersionsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetFunctionVersions200ResponseDataVersionsInner do
  #let(:instance) { MudbaseSDK::GetFunctionVersions200ResponseDataVersionsInner.new }

  describe 'test an instance of GetFunctionVersions200ResponseDataVersionsInner' do
    it 'should create an instance of GetFunctionVersions200ResponseDataVersionsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetFunctionVersions200ResponseDataVersionsInner)
    end
  end
