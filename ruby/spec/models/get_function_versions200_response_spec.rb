...
# Unit tests for MudbaseSDK::GetFunctionVersions200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetFunctionVersions200Response do
  #let(:instance) { MudbaseSDK::GetFunctionVersions200Response.new }

  describe 'test an instance of GetFunctionVersions200Response' do
    it 'should create an instance of GetFunctionVersions200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetFunctionVersions200Response)
    end
  end
