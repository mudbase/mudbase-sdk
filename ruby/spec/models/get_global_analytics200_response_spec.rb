...
# Unit tests for MudbaseSDK::GetGlobalAnalytics200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetGlobalAnalytics200Response do
  #let(:instance) { MudbaseSDK::GetGlobalAnalytics200Response.new }

  describe 'test an instance of GetGlobalAnalytics200Response' do
    it 'should create an instance of GetGlobalAnalytics200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetGlobalAnalytics200Response)
    end
  end
  ...
  describe 'test attribute "peak_connections"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "events_per_minute"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
