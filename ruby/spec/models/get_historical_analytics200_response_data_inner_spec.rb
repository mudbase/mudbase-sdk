...
# Unit tests for MudbaseSDK::GetHistoricalAnalytics200ResponseDataInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetHistoricalAnalytics200ResponseDataInner do
  #let(:instance) { MudbaseSDK::GetHistoricalAnalytics200ResponseDataInner.new }

  describe 'test an instance of GetHistoricalAnalytics200ResponseDataInner' do
    it 'should create an instance of GetHistoricalAnalytics200ResponseDataInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetHistoricalAnalytics200ResponseDataInner)
    end
  end
