...
# Unit tests for MudbaseSDK::GetHistoricalAnalytics200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetHistoricalAnalytics200Response do
  #let(:instance) { MudbaseSDK::GetHistoricalAnalytics200Response.new }

  describe 'test an instance of GetHistoricalAnalytics200Response' do
    it 'should create an instance of GetHistoricalAnalytics200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetHistoricalAnalytics200Response)
    end
  end
