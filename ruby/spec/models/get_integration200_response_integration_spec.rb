...
# Unit tests for MudbaseSDK::GetIntegration200ResponseIntegration
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetIntegration200ResponseIntegration do
  #let(:instance) { MudbaseSDK::GetIntegration200ResponseIntegration.new }

  describe 'test an instance of GetIntegration200ResponseIntegration' do
    it 'should create an instance of GetIntegration200ResponseIntegration' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetIntegration200ResponseIntegration)
    end
  end
