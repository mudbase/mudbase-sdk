...
# Unit tests for MudbaseSDK::GetIntegration200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetIntegration200Response do
  #let(:instance) { MudbaseSDK::GetIntegration200Response.new }

  describe 'test an instance of GetIntegration200Response' do
    it 'should create an instance of GetIntegration200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetIntegration200Response)
    end
  end
