...
# Unit tests for MudbaseSDK::GetIntegrations200ResponseIntegrationsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetIntegrations200ResponseIntegrationsInner do
  #let(:instance) { MudbaseSDK::GetIntegrations200ResponseIntegrationsInner.new }

  describe 'test an instance of GetIntegrations200ResponseIntegrationsInner' do
    it 'should create an instance of GetIntegrations200ResponseIntegrationsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetIntegrations200ResponseIntegrationsInner)
    end
  end
