...
# Unit tests for MudbaseSDK::GetIntegrations200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetIntegrations200Response do
  #let(:instance) { MudbaseSDK::GetIntegrations200Response.new }

  describe 'test an instance of GetIntegrations200Response' do
    it 'should create an instance of GetIntegrations200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetIntegrations200Response)
    end
  end
