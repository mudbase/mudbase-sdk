...
# Unit tests for MudbaseSDK::GetInvoice200ResponseInvoice
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetInvoice200ResponseInvoice do
  #let(:instance) { MudbaseSDK::GetInvoice200ResponseInvoice.new }

  describe 'test an instance of GetInvoice200ResponseInvoice' do
    it 'should create an instance of GetInvoice200ResponseInvoice' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetInvoice200ResponseInvoice)
    end
  end
