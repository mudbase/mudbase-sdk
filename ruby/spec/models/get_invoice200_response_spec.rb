...
# Unit tests for MudbaseSDK::GetInvoice200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetInvoice200Response do
  #let(:instance) { MudbaseSDK::GetInvoice200Response.new }

  describe 'test an instance of GetInvoice200Response' do
    it 'should create an instance of GetInvoice200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetInvoice200Response)
    end
  end
