...
# Unit tests for MudbaseSDK::GetInvoices200ResponseInvoicesInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetInvoices200ResponseInvoicesInner do
  #let(:instance) { MudbaseSDK::GetInvoices200ResponseInvoicesInner.new }

  describe 'test an instance of GetInvoices200ResponseInvoicesInner' do
    it 'should create an instance of GetInvoices200ResponseInvoicesInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetInvoices200ResponseInvoicesInner)
    end
  end
