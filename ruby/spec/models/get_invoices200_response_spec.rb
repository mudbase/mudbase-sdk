...
# Unit tests for MudbaseSDK::GetInvoices200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetInvoices200Response do
  #let(:instance) { MudbaseSDK::GetInvoices200Response.new }

  describe 'test an instance of GetInvoices200Response' do
    it 'should create an instance of GetInvoices200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetInvoices200Response)
    end
  end
