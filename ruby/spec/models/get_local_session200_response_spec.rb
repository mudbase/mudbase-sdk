...
# Unit tests for MudbaseSDK::GetLocalSession200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetLocalSession200Response do
  #let(:instance) { MudbaseSDK::GetLocalSession200Response.new }

  describe 'test an instance of GetLocalSession200Response' do
    it 'should create an instance of GetLocalSession200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetLocalSession200Response)
    end
  end
