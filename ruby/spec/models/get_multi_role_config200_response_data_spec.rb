...
# Unit tests for MudbaseSDK::GetMultiRoleConfig200ResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetMultiRoleConfig200ResponseData do
  #let(:instance) { MudbaseSDK::GetMultiRoleConfig200ResponseData.new }

  describe 'test an instance of GetMultiRoleConfig200ResponseData' do
    it 'should create an instance of GetMultiRoleConfig200ResponseData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetMultiRoleConfig200ResponseData)
    end
  end
