...
# Unit tests for MudbaseSDK::GetMultiRoleConfig200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetMultiRoleConfig200Response do
  #let(:instance) { MudbaseSDK::GetMultiRoleConfig200Response.new }

  describe 'test an instance of GetMultiRoleConfig200Response' do
    it 'should create an instance of GetMultiRoleConfig200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetMultiRoleConfig200Response)
    end
  end
