...
# Unit tests for MudbaseSDK::GetNetworkStatus200ResponseDataValue
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetNetworkStatus200ResponseDataValue do
  #let(:instance) { MudbaseSDK::GetNetworkStatus200ResponseDataValue.new }

  describe 'test an instance of GetNetworkStatus200ResponseDataValue' do
    it 'should create an instance of GetNetworkStatus200ResponseDataValue' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetNetworkStatus200ResponseDataValue)
    end
  end
