...
# Unit tests for MudbaseSDK::GetNetworkStatus200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetNetworkStatus200Response do
  #let(:instance) { MudbaseSDK::GetNetworkStatus200Response.new }

  describe 'test an instance of GetNetworkStatus200Response' do
    it 'should create an instance of GetNetworkStatus200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetNetworkStatus200Response)
    end
  end
