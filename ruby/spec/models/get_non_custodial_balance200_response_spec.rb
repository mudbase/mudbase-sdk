...
# Unit tests for MudbaseSDK::GetNonCustodialBalance200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetNonCustodialBalance200Response do
  #let(:instance) { MudbaseSDK::GetNonCustodialBalance200Response.new }

  describe 'test an instance of GetNonCustodialBalance200Response' do
    it 'should create an instance of GetNonCustodialBalance200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetNonCustodialBalance200Response)
    end
  end
