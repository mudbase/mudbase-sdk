...
# Unit tests for MudbaseSDK::GetNonCustodialTransactionByHash200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetNonCustodialTransactionByHash200Response do
  #let(:instance) { MudbaseSDK::GetNonCustodialTransactionByHash200Response.new }

  describe 'test an instance of GetNonCustodialTransactionByHash200Response' do
    it 'should create an instance of GetNonCustodialTransactionByHash200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetNonCustodialTransactionByHash200Response)
    end
  end
