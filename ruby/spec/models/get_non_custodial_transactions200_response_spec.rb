...
# Unit tests for MudbaseSDK::GetNonCustodialTransactions200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetNonCustodialTransactions200Response do
  #let(:instance) { MudbaseSDK::GetNonCustodialTransactions200Response.new }

  describe 'test an instance of GetNonCustodialTransactions200Response' do
    it 'should create an instance of GetNonCustodialTransactions200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetNonCustodialTransactions200Response)
    end
  end
