...
# Unit tests for MudbaseSDK::GetOAuthProviderConfig200ResponseConfig
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetOAuthProviderConfig200ResponseConfig do
  #let(:instance) { MudbaseSDK::GetOAuthProviderConfig200ResponseConfig.new }

  describe 'test an instance of GetOAuthProviderConfig200ResponseConfig' do
    it 'should create an instance of GetOAuthProviderConfig200ResponseConfig' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetOAuthProviderConfig200ResponseConfig)
    end
  end
