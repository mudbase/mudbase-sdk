...
# Unit tests for MudbaseSDK::GetOAuthProviderConfig200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetOAuthProviderConfig200Response do
  #let(:instance) { MudbaseSDK::GetOAuthProviderConfig200Response.new }

  describe 'test an instance of GetOAuthProviderConfig200Response' do
    it 'should create an instance of GetOAuthProviderConfig200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetOAuthProviderConfig200Response)
    end
  end
