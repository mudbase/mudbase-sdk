...
# Unit tests for MudbaseSDK::GetOrgOAuthProviders200ResponseProvidersInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetOrgOAuthProviders200ResponseProvidersInner do
  #let(:instance) { MudbaseSDK::GetOrgOAuthProviders200ResponseProvidersInner.new }

  describe 'test an instance of GetOrgOAuthProviders200ResponseProvidersInner' do
    it 'should create an instance of GetOrgOAuthProviders200ResponseProvidersInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetOrgOAuthProviders200ResponseProvidersInner)
    end
  end
