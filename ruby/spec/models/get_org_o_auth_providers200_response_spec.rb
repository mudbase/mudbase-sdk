...
# Unit tests for MudbaseSDK::GetOrgOAuthProviders200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetOrgOAuthProviders200Response do
  #let(:instance) { MudbaseSDK::GetOrgOAuthProviders200Response.new }

  describe 'test an instance of GetOrgOAuthProviders200Response' do
    it 'should create an instance of GetOrgOAuthProviders200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetOrgOAuthProviders200Response)
    end
  end
