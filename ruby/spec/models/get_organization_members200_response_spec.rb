...
# Unit tests for MudbaseSDK::GetOrganizationMembers200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetOrganizationMembers200Response do
  #let(:instance) { MudbaseSDK::GetOrganizationMembers200Response.new }

  describe 'test an instance of GetOrganizationMembers200Response' do
    it 'should create an instance of GetOrganizationMembers200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetOrganizationMembers200Response)
    end
  end
