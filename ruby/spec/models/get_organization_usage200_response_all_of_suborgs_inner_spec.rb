...
# Unit tests for MudbaseSDK::GetOrganizationUsage200ResponseAllOfSuborgsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetOrganizationUsage200ResponseAllOfSuborgsInner do
  #let(:instance) { MudbaseSDK::GetOrganizationUsage200ResponseAllOfSuborgsInner.new }

  describe 'test an instance of GetOrganizationUsage200ResponseAllOfSuborgsInner' do
    it 'should create an instance of GetOrganizationUsage200ResponseAllOfSuborgsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetOrganizationUsage200ResponseAllOfSuborgsInner)
    end
  end
