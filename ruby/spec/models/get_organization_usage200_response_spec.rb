...
# Unit tests for MudbaseSDK::GetOrganizationUsage200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetOrganizationUsage200Response do
  #let(:instance) { MudbaseSDK::GetOrganizationUsage200Response.new }

  describe 'test an instance of GetOrganizationUsage200Response' do
    it 'should create an instance of GetOrganizationUsage200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetOrganizationUsage200Response)
    end
  end
  ...
  describe 'test attribute "suborgs"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
