...
# Unit tests for MudbaseSDK::GetOrganizationUsers200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetOrganizationUsers200Response do
  #let(:instance) { MudbaseSDK::GetOrganizationUsers200Response.new }
  ...
  describe 'test an instance of GetOrganizationUsers200Response' do
    it 'should create an instance of GetOrganizationUsers200Response' do
      ...
      #expect(instance).to be_instance_of(MudbaseSDK::GetOrganizationUsers200Response)
    end
  end
