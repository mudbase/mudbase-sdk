...
# Unit tests for MudbaseSDK::GetOrganizationUsers200ResponseUsersInnerProject
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetOrganizationUsers200ResponseUsersInnerProject do
  #let(:instance) { MudbaseSDK::GetOrganizationUsers200ResponseUsersInnerProject.new }

  describe 'test an instance of GetOrganizationUsers200ResponseUsersInnerProject' do
    it 'should create an instance of GetOrganizationUsers200ResponseUsersInnerProject' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetOrganizationUsers200ResponseUsersInnerProject)
    end
  end
