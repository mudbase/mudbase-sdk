...
# Unit tests for MudbaseSDK::GetOrganizationUsers200ResponseUsersInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetOrganizationUsers200ResponseUsersInner do
  #let(:instance) { MudbaseSDK::GetOrganizationUsers200ResponseUsersInner.new }

  describe 'test an instance of GetOrganizationUsers200ResponseUsersInner' do
    it 'should create an instance of GetOrganizationUsers200ResponseUsersInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetOrganizationUsers200ResponseUsersInner)
    end
  end
  ...
  describe 'test attribute "custom_role"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "account_status"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["pending", "active", "suspended"])
