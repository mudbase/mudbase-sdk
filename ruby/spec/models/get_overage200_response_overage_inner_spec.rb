...
# Unit tests for MudbaseSDK::GetOverage200ResponseOverageInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetOverage200ResponseOverageInner do
  #let(:instance) { MudbaseSDK::GetOverage200ResponseOverageInner.new }

  describe 'test an instance of GetOverage200ResponseOverageInner' do
    it 'should create an instance of GetOverage200ResponseOverageInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetOverage200ResponseOverageInner)
    end
  end
