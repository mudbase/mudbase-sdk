...
# Unit tests for MudbaseSDK::GetOverage200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetOverage200Response do
  #let(:instance) { MudbaseSDK::GetOverage200Response.new }

  describe 'test an instance of GetOverage200Response' do
    it 'should create an instance of GetOverage200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetOverage200Response)
    end
  end
