...
# Unit tests for MudbaseSDK::GetPaymentRecords200ResponseDataPagination
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetPaymentRecords200ResponseDataPagination do
  #let(:instance) { MudbaseSDK::GetPaymentRecords200ResponseDataPagination.new }

  describe 'test an instance of GetPaymentRecords200ResponseDataPagination' do
    it 'should create an instance of GetPaymentRecords200ResponseDataPagination' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetPaymentRecords200ResponseDataPagination)
    end
  end
