...
# Unit tests for MudbaseSDK::GetPaymentRecords200ResponseDataRecordsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetPaymentRecords200ResponseDataRecordsInner do
  #let(:instance) { MudbaseSDK::GetPaymentRecords200ResponseDataRecordsInner.new }

  describe 'test an instance of GetPaymentRecords200ResponseDataRecordsInner' do
    it 'should create an instance of GetPaymentRecords200ResponseDataRecordsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetPaymentRecords200ResponseDataRecordsInner)
    end
  end
