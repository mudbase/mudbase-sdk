...
# Unit tests for MudbaseSDK::GetPaymentRecords200ResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetPaymentRecords200ResponseData do
  #let(:instance) { MudbaseSDK::GetPaymentRecords200ResponseData.new }

  describe 'test an instance of GetPaymentRecords200ResponseData' do
    it 'should create an instance of GetPaymentRecords200ResponseData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetPaymentRecords200ResponseData)
    end
  end
