...
# Unit tests for MudbaseSDK::GetPaymentRecords200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetPaymentRecords200Response do
  #let(:instance) { MudbaseSDK::GetPaymentRecords200Response.new }

  describe 'test an instance of GetPaymentRecords200Response' do
    it 'should create an instance of GetPaymentRecords200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetPaymentRecords200Response)
    end
  end
