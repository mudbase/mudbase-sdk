...
# Unit tests for MudbaseSDK::GetPayoutHistory200ResponseDataInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetPayoutHistory200ResponseDataInner do
  #let(:instance) { MudbaseSDK::GetPayoutHistory200ResponseDataInner.new }

  describe 'test an instance of GetPayoutHistory200ResponseDataInner' do
    it 'should create an instance of GetPayoutHistory200ResponseDataInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetPayoutHistory200ResponseDataInner)
    end
  end
