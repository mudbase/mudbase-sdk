...
# Unit tests for MudbaseSDK::GetPayoutHistory200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetPayoutHistory200Response do
  #let(:instance) { MudbaseSDK::GetPayoutHistory200Response.new }

  describe 'test an instance of GetPayoutHistory200Response' do
    it 'should create an instance of GetPayoutHistory200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetPayoutHistory200Response)
    end
  end
