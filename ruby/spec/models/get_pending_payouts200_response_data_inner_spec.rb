...
# Unit tests for MudbaseSDK::GetPendingPayouts200ResponseDataInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetPendingPayouts200ResponseDataInner do
  #let(:instance) { MudbaseSDK::GetPendingPayouts200ResponseDataInner.new }

  describe 'test an instance of GetPendingPayouts200ResponseDataInner' do
    it 'should create an instance of GetPendingPayouts200ResponseDataInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetPendingPayouts200ResponseDataInner)
    end
  end
