...
# Unit tests for MudbaseSDK::GetPendingPayouts200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetPendingPayouts200Response do
  #let(:instance) { MudbaseSDK::GetPendingPayouts200Response.new }

  describe 'test an instance of GetPendingPayouts200Response' do
    it 'should create an instance of GetPendingPayouts200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetPendingPayouts200Response)
    end
  end
