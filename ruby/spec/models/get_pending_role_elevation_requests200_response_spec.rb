...
# Unit tests for MudbaseSDK::GetPendingRoleElevationRequests200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetPendingRoleElevationRequests200Response do
  #let(:instance) { MudbaseSDK::GetPendingRoleElevationRequests200Response.new }

  describe 'test an instance of GetPendingRoleElevationRequests200Response' do
    it 'should create an instance of GetPendingRoleElevationRequests200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetPendingRoleElevationRequests200Response)
    end
  end
