...
# Unit tests for MudbaseSDK::GetPermissionsMatrix200ResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetPermissionsMatrix200ResponseData do
  #let(:instance) { MudbaseSDK::GetPermissionsMatrix200ResponseData.new }

  describe 'test an instance of GetPermissionsMatrix200ResponseData' do
    it 'should create an instance of GetPermissionsMatrix200ResponseData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetPermissionsMatrix200ResponseData)
    end
  end
