...
# Unit tests for MudbaseSDK::GetPermissionsMatrix200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetPermissionsMatrix200Response do
  #let(:instance) { MudbaseSDK::GetPermissionsMatrix200Response.new }

  describe 'test an instance of GetPermissionsMatrix200Response' do
    it 'should create an instance of GetPermissionsMatrix200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetPermissionsMatrix200Response)
    end
  end
