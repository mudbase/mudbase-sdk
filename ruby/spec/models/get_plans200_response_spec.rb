...
# Unit tests for MudbaseSDK::GetPlans200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetPlans200Response do
  #let(:instance) { MudbaseSDK::GetPlans200Response.new }

  describe 'test an instance of GetPlans200Response' do
    it 'should create an instance of GetPlans200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetPlans200Response)
    end
  end
