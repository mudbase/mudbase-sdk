...
# Unit tests for MudbaseSDK::GetProjectAnalytics200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetProjectAnalytics200Response do
  #let(:instance) { MudbaseSDK::GetProjectAnalytics200Response.new }

  describe 'test an instance of GetProjectAnalytics200Response' do
    it 'should create an instance of GetProjectAnalytics200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetProjectAnalytics200Response)
    end
  end
