...
# Unit tests for MudbaseSDK::GetProjectCaptchaConfig200ResponseCaptcha
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetProjectCaptchaConfig200ResponseCaptcha do
  #let(:instance) { MudbaseSDK::GetProjectCaptchaConfig200ResponseCaptcha.new }

  describe 'test an instance of GetProjectCaptchaConfig200ResponseCaptcha' do
    it 'should create an instance of GetProjectCaptchaConfig200ResponseCaptcha' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetProjectCaptchaConfig200ResponseCaptcha)
    end
  end
  ...
  describe 'test attribute "version"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["v2", "v3"])
