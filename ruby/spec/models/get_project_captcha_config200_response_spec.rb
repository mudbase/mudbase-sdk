...
# Unit tests for MudbaseSDK::GetProjectCaptchaConfig200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetProjectCaptchaConfig200Response do
  #let(:instance) { MudbaseSDK::GetProjectCaptchaConfig200Response.new }

  describe 'test an instance of GetProjectCaptchaConfig200Response' do
    it 'should create an instance of GetProjectCaptchaConfig200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetProjectCaptchaConfig200Response)
    end
  end
