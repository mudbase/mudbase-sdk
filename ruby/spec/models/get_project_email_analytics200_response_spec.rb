...
# Unit tests for MudbaseSDK::GetProjectEmailAnalytics200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetProjectEmailAnalytics200Response do
  #let(:instance) { MudbaseSDK::GetProjectEmailAnalytics200Response.new }

  describe 'test an instance of GetProjectEmailAnalytics200Response' do
    it 'should create an instance of GetProjectEmailAnalytics200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetProjectEmailAnalytics200Response)
    end
  end
