...
# Unit tests for MudbaseSDK::GetProjectEmailSmtp200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetProjectEmailSmtp200Response do
  #let(:instance) { MudbaseSDK::GetProjectEmailSmtp200Response.new }

  describe 'test an instance of GetProjectEmailSmtp200Response' do
    it 'should create an instance of GetProjectEmailSmtp200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetProjectEmailSmtp200Response)
    end
  end
