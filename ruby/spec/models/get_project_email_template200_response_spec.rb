...
# Unit tests for MudbaseSDK::GetProjectEmailTemplate200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetProjectEmailTemplate200Response do
  #let(:instance) { MudbaseSDK::GetProjectEmailTemplate200Response.new }

  describe 'test an instance of GetProjectEmailTemplate200Response' do
    it 'should create an instance of GetProjectEmailTemplate200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetProjectEmailTemplate200Response)
    end
  end
