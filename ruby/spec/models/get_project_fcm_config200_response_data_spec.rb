...
# Unit tests for MudbaseSDK::GetProjectFcmConfig200ResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetProjectFcmConfig200ResponseData do
  #let(:instance) { MudbaseSDK::GetProjectFcmConfig200ResponseData.new }

  describe 'test an instance of GetProjectFcmConfig200ResponseData' do
    it 'should create an instance of GetProjectFcmConfig200ResponseData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetProjectFcmConfig200ResponseData)
    end
  end
