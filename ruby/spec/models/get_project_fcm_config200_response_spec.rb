...
# Unit tests for MudbaseSDK::GetProjectFcmConfig200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetProjectFcmConfig200Response do
  #let(:instance) { MudbaseSDK::GetProjectFcmConfig200Response.new }

  describe 'test an instance of GetProjectFcmConfig200Response' do
    it 'should create an instance of GetProjectFcmConfig200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetProjectFcmConfig200Response)
    end
  end
