...
# Unit tests for MudbaseSDK::GetProjectFeeDashboard200ResponseDataBalancesInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetProjectFeeDashboard200ResponseDataBalancesInner do
  #let(:instance) { MudbaseSDK::GetProjectFeeDashboard200ResponseDataBalancesInner.new }

  describe 'test an instance of GetProjectFeeDashboard200ResponseDataBalancesInner' do
    it 'should create an instance of GetProjectFeeDashboard200ResponseDataBalancesInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetProjectFeeDashboard200ResponseDataBalancesInner)
    end
  end
