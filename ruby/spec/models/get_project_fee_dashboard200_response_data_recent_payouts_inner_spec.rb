...
# Unit tests for MudbaseSDK::GetProjectFeeDashboard200ResponseDataRecentPayoutsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetProjectFeeDashboard200ResponseDataRecentPayoutsInner do
  #let(:instance) { MudbaseSDK::GetProjectFeeDashboard200ResponseDataRecentPayoutsInner.new }

  describe 'test an instance of GetProjectFeeDashboard200ResponseDataRecentPayoutsInner' do
    it 'should create an instance of GetProjectFeeDashboard200ResponseDataRecentPayoutsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetProjectFeeDashboard200ResponseDataRecentPayoutsInner)
    end
  end
