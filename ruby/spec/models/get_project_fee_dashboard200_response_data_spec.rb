...
# Unit tests for MudbaseSDK::GetProjectFeeDashboard200ResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetProjectFeeDashboard200ResponseData do
  #let(:instance) { MudbaseSDK::GetProjectFeeDashboard200ResponseData.new }

  describe 'test an instance of GetProjectFeeDashboard200ResponseData' do
    it 'should create an instance of GetProjectFeeDashboard200ResponseData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetProjectFeeDashboard200ResponseData)
    end
  end

  describe 'test attribute "fee_settings"' do
    it 'should work' do
  ...
  describe 'test attribute "recent_payouts"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "total_earned"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
