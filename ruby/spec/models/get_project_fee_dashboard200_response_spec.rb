...
# Unit tests for MudbaseSDK::GetProjectFeeDashboard200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetProjectFeeDashboard200Response do
  #let(:instance) { MudbaseSDK::GetProjectFeeDashboard200Response.new }

  describe 'test an instance of GetProjectFeeDashboard200Response' do
    it 'should create an instance of GetProjectFeeDashboard200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetProjectFeeDashboard200Response)
    end
  end
