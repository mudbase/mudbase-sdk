...
# Unit tests for MudbaseSDK::GetProjectOAuthProviders200ResponseProvidersInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetProjectOAuthProviders200ResponseProvidersInner do
  #let(:instance) { MudbaseSDK::GetProjectOAuthProviders200ResponseProvidersInner.new }

  describe 'test an instance of GetProjectOAuthProviders200ResponseProvidersInner' do
    it 'should create an instance of GetProjectOAuthProviders200ResponseProvidersInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetProjectOAuthProviders200ResponseProvidersInner)
    end
  end
