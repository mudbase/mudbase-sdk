...
# Unit tests for MudbaseSDK::GetProjectOAuthProviders200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetProjectOAuthProviders200Response do
  #let(:instance) { MudbaseSDK::GetProjectOAuthProviders200Response.new }

  describe 'test an instance of GetProjectOAuthProviders200Response' do
    it 'should create an instance of GetProjectOAuthProviders200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetProjectOAuthProviders200Response)
    end
  end
