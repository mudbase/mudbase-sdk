...
# Unit tests for MudbaseSDK::GetProjectSmsByo200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetProjectSmsByo200Response do
  #let(:instance) { MudbaseSDK::GetProjectSmsByo200Response.new }

  describe 'test an instance of GetProjectSmsByo200Response' do
    it 'should create an instance of GetProjectSmsByo200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetProjectSmsByo200Response)
    end
  end
