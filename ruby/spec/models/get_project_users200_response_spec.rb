...
# Unit tests for MudbaseSDK::GetProjectUsers200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetProjectUsers200Response do
  #let(:instance) { MudbaseSDK::GetProjectUsers200Response.new }

  describe 'test an instance of GetProjectUsers200Response' do
    it 'should create an instance of GetProjectUsers200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetProjectUsers200Response)
    end
  end
