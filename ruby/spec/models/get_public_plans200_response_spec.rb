...
# Unit tests for MudbaseSDK::GetPublicPlans200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetPublicPlans200Response do
  #let(:instance) { MudbaseSDK::GetPublicPlans200Response.new }

  describe 'test an instance of GetPublicPlans200Response' do
    it 'should create an instance of GetPublicPlans200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetPublicPlans200Response)
    end
  end
