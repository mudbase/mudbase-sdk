...
# Unit tests for MudbaseSDK::GetRole200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetRole200Response do
  #let(:instance) { MudbaseSDK::GetRole200Response.new }

  describe 'test an instance of GetRole200Response' do
    it 'should create an instance of GetRole200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetRole200Response)
    end
  end
