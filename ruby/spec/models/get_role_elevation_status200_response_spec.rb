...
# Unit tests for MudbaseSDK::GetRoleElevationStatus200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetRoleElevationStatus200Response do
  #let(:instance) { MudbaseSDK::GetRoleElevationStatus200Response.new }

  describe 'test an instance of GetRoleElevationStatus200Response' do
    it 'should create an instance of GetRoleElevationStatus200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetRoleElevationStatus200Response)
    end
  end
