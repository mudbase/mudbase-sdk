...
# Unit tests for MudbaseSDK::GetScannerMetrics200ResponseAlertsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetScannerMetrics200ResponseAlertsInner do
  #let(:instance) { MudbaseSDK::GetScannerMetrics200ResponseAlertsInner.new }

  describe 'test an instance of GetScannerMetrics200ResponseAlertsInner' do
    it 'should create an instance of GetScannerMetrics200ResponseAlertsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetScannerMetrics200ResponseAlertsInner)
    end
  end
