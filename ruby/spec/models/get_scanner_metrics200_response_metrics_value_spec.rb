...
# Unit tests for MudbaseSDK::GetScannerMetrics200ResponseMetricsValue
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetScannerMetrics200ResponseMetricsValue do
  #let(:instance) { MudbaseSDK::GetScannerMetrics200ResponseMetricsValue.new }

  describe 'test an instance of GetScannerMetrics200ResponseMetricsValue' do
    it 'should create an instance of GetScannerMetrics200ResponseMetricsValue' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetScannerMetrics200ResponseMetricsValue)
    end
  end

  describe 'test attribute "last_scanned_block"' do
    it 'should work' do
