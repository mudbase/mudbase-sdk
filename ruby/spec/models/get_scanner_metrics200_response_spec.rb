...
# Unit tests for MudbaseSDK::GetScannerMetrics200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetScannerMetrics200Response do
  #let(:instance) { MudbaseSDK::GetScannerMetrics200Response.new }

  describe 'test an instance of GetScannerMetrics200Response' do
    it 'should create an instance of GetScannerMetrics200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetScannerMetrics200Response)
    end
  end
  ...
  describe 'test attribute "lag_alert_threshold"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
