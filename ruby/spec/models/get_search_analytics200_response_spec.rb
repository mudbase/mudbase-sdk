...
# Unit tests for MudbaseSDK::GetSearchAnalytics200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetSearchAnalytics200Response do
  #let(:instance) { MudbaseSDK::GetSearchAnalytics200Response.new }

  describe 'test an instance of GetSearchAnalytics200Response' do
    it 'should create an instance of GetSearchAnalytics200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetSearchAnalytics200Response)
    end
  end
  ...
  describe 'test attribute "top_queries"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "searches_by_collection"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
