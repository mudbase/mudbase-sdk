...
# Unit tests for MudbaseSDK::GetSearchAnalytics200ResponseTopQueriesInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetSearchAnalytics200ResponseTopQueriesInner do
  #let(:instance) { MudbaseSDK::GetSearchAnalytics200ResponseTopQueriesInner.new }

  describe 'test an instance of GetSearchAnalytics200ResponseTopQueriesInner' do
    it 'should create an instance of GetSearchAnalytics200ResponseTopQueriesInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetSearchAnalytics200ResponseTopQueriesInner)
    end
  end
