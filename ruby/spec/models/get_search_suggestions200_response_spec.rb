...
# Unit tests for MudbaseSDK::GetSearchSuggestions200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetSearchSuggestions200Response do
  #let(:instance) { MudbaseSDK::GetSearchSuggestions200Response.new }

  describe 'test an instance of GetSearchSuggestions200Response' do
    it 'should create an instance of GetSearchSuggestions200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetSearchSuggestions200Response)
    end
  end
