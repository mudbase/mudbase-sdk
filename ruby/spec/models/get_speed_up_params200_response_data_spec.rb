...
# Unit tests for MudbaseSDK::GetSpeedUpParams200ResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetSpeedUpParams200ResponseData do
  #let(:instance) { MudbaseSDK::GetSpeedUpParams200ResponseData.new }

  describe 'test an instance of GetSpeedUpParams200ResponseData' do
    it 'should create an instance of GetSpeedUpParams200ResponseData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetSpeedUpParams200ResponseData)
    end
  end
