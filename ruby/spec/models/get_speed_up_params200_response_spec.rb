...
# Unit tests for MudbaseSDK::GetSpeedUpParams200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetSpeedUpParams200Response do
  #let(:instance) { MudbaseSDK::GetSpeedUpParams200Response.new }

  describe 'test an instance of GetSpeedUpParams200Response' do
    it 'should create an instance of GetSpeedUpParams200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetSpeedUpParams200Response)
    end
  end
