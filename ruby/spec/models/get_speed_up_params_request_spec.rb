...
# Unit tests for MudbaseSDK::GetSpeedUpParamsRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetSpeedUpParamsRequest do
  #let(:instance) { MudbaseSDK::GetSpeedUpParamsRequest.new }

  describe 'test an instance of GetSpeedUpParamsRequest' do
    it 'should create an instance of GetSpeedUpParamsRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetSpeedUpParamsRequest)
    end
  end
  ...
  describe 'test attribute "chain"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["ethereum", "polygon", "arbitrum", "optimism", "base", "bsc", "binance", "avalanche", "celo"])
