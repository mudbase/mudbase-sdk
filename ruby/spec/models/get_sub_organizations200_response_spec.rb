...
# Unit tests for MudbaseSDK::GetSubOrganizations200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetSubOrganizations200Response do
  #let(:instance) { MudbaseSDK::GetSubOrganizations200Response.new }

  describe 'test an instance of GetSubOrganizations200Response' do
    it 'should create an instance of GetSubOrganizations200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetSubOrganizations200Response)
    end
  end
