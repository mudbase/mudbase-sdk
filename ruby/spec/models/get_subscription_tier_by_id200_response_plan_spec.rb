...
# Unit tests for MudbaseSDK::GetSubscriptionTierById200ResponsePlan
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetSubscriptionTierById200ResponsePlan do
  #let(:instance) { MudbaseSDK::GetSubscriptionTierById200ResponsePlan.new }

  describe 'test an instance of GetSubscriptionTierById200ResponsePlan' do
    it 'should create an instance of GetSubscriptionTierById200ResponsePlan' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetSubscriptionTierById200ResponsePlan)
    end
  end
