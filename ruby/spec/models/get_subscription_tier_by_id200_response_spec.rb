...
# Unit tests for MudbaseSDK::GetSubscriptionTierById200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetSubscriptionTierById200Response do
  #let(:instance) { MudbaseSDK::GetSubscriptionTierById200Response.new }

  describe 'test an instance of GetSubscriptionTierById200Response' do
    it 'should create an instance of GetSubscriptionTierById200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetSubscriptionTierById200Response)
    end
  end
