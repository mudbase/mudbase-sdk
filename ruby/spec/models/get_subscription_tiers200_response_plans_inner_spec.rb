...
# Unit tests for MudbaseSDK::GetSubscriptionTiers200ResponsePlansInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetSubscriptionTiers200ResponsePlansInner do
  #let(:instance) { MudbaseSDK::GetSubscriptionTiers200ResponsePlansInner.new }

  describe 'test an instance of GetSubscriptionTiers200ResponsePlansInner' do
    it 'should create an instance of GetSubscriptionTiers200ResponsePlansInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetSubscriptionTiers200ResponsePlansInner)
    end
  end
  ...
  describe 'test attribute "price_yearly"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "overages"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
