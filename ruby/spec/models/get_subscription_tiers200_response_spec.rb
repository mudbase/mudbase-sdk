...
# Unit tests for MudbaseSDK::GetSubscriptionTiers200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetSubscriptionTiers200Response do
  #let(:instance) { MudbaseSDK::GetSubscriptionTiers200Response.new }

  describe 'test an instance of GetSubscriptionTiers200Response' do
    it 'should create an instance of GetSubscriptionTiers200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetSubscriptionTiers200Response)
    end
  end
