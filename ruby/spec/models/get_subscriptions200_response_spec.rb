...
# Unit tests for MudbaseSDK::GetSubscriptions200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetSubscriptions200Response do
  #let(:instance) { MudbaseSDK::GetSubscriptions200Response.new }
  ...
  describe 'test an instance of GetSubscriptions200Response' do
    it 'should create an instance of GetSubscriptions200Response' do
      ...
      #expect(instance).to be_instance_of(MudbaseSDK::GetSubscriptions200Response)
    end
  end
