...
# Unit tests for MudbaseSDK::GetSubscriptions200ResponseSubscriptionsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetSubscriptions200ResponseSubscriptionsInner do
  #let(:instance) { MudbaseSDK::GetSubscriptions200ResponseSubscriptionsInner.new }

  describe 'test an instance of GetSubscriptions200ResponseSubscriptionsInner' do
    it 'should create an instance of GetSubscriptions200ResponseSubscriptionsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetSubscriptions200ResponseSubscriptionsInner)
    end
  end
