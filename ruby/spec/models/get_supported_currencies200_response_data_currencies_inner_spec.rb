...
# Unit tests for MudbaseSDK::GetSupportedCurrencies200ResponseDataCurrenciesInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetSupportedCurrencies200ResponseDataCurrenciesInner do
  #let(:instance) { MudbaseSDK::GetSupportedCurrencies200ResponseDataCurrenciesInner.new }

  describe 'test an instance of GetSupportedCurrencies200ResponseDataCurrenciesInner' do
    it 'should create an instance of GetSupportedCurrencies200ResponseDataCurrenciesInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetSupportedCurrencies200ResponseDataCurrenciesInner)
    end
  end
