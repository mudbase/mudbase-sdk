...
# Unit tests for MudbaseSDK::GetSupportedCurrencies200ResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetSupportedCurrencies200ResponseData do
  #let(:instance) { MudbaseSDK::GetSupportedCurrencies200ResponseData.new }

  describe 'test an instance of GetSupportedCurrencies200ResponseData' do
    it 'should create an instance of GetSupportedCurrencies200ResponseData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetSupportedCurrencies200ResponseData)
    end
  end
