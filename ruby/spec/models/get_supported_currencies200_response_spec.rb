...
# Unit tests for MudbaseSDK::GetSupportedCurrencies200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetSupportedCurrencies200Response do
  #let(:instance) { MudbaseSDK::GetSupportedCurrencies200Response.new }

  describe 'test an instance of GetSupportedCurrencies200Response' do
    it 'should create an instance of GetSupportedCurrencies200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetSupportedCurrencies200Response)
    end
  end
