...
# Unit tests for MudbaseSDK::GetTemplates200ResponseTemplatesInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetTemplates200ResponseTemplatesInner do
  #let(:instance) { MudbaseSDK::GetTemplates200ResponseTemplatesInner.new }
  ...
  describe 'test an instance of GetTemplates200ResponseTemplatesInner' do
    it 'should create an instance of GetTemplates200ResponseTemplatesInner' do
      ...
      #expect(instance).to be_instance_of(MudbaseSDK::GetTemplates200ResponseTemplatesInner)
    end
  end
