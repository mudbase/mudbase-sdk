...
# Unit tests for MudbaseSDK::GetTransaction200ResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetTransaction200ResponseData do
  #let(:instance) { MudbaseSDK::GetTransaction200ResponseData.new }

  describe 'test an instance of GetTransaction200ResponseData' do
    it 'should create an instance of GetTransaction200ResponseData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetTransaction200ResponseData)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["withdrawal", "deposit", "fee_refund", "platform_fee_deduction"])
  ...
  describe 'test attribute "main_tx_hash"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "main_tx_status"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["pending", "broadcast", "confirmed", "failed"])
      # validator.allowable_values.each do |value|
      #   expect { instance.main_tx_status = value }.not_to raise_error
      # end
    end
  end
  ...
  describe 'test attribute "project_fee"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "refund_tx_hash"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["processing", "completed", "partial", "failed"])
      # validator.allowable_values.each do |value|
