...
# Unit tests for MudbaseSDK::GetTransaction200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetTransaction200Response do
  #let(:instance) { MudbaseSDK::GetTransaction200Response.new }

  describe 'test an instance of GetTransaction200Response' do
    it 'should create an instance of GetTransaction200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetTransaction200Response)
    end
  end
