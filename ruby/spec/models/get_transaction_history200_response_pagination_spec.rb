...
# Unit tests for MudbaseSDK::GetTransactionHistory200ResponsePagination
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetTransactionHistory200ResponsePagination do
  #let(:instance) { MudbaseSDK::GetTransactionHistory200ResponsePagination.new }

  describe 'test an instance of GetTransactionHistory200ResponsePagination' do
    it 'should create an instance of GetTransactionHistory200ResponsePagination' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetTransactionHistory200ResponsePagination)
    end
  end
