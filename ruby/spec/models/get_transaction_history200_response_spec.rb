...
# Unit tests for MudbaseSDK::GetTransactionHistory200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetTransactionHistory200Response do
  #let(:instance) { MudbaseSDK::GetTransactionHistory200Response.new }

  describe 'test an instance of GetTransactionHistory200Response' do
    it 'should create an instance of GetTransactionHistory200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetTransactionHistory200Response)
    end
  end
