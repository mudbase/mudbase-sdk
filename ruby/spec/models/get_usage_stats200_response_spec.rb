...
# Unit tests for MudbaseSDK::GetUsageStats200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetUsageStats200Response do
  #let(:instance) { MudbaseSDK::GetUsageStats200Response.new }

  describe 'test an instance of GetUsageStats200Response' do
    it 'should create an instance of GetUsageStats200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetUsageStats200Response)
    end
  end
