...
# Unit tests for MudbaseSDK::GetUsageStats200ResponseStats
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetUsageStats200ResponseStats do
  #let(:instance) { MudbaseSDK::GetUsageStats200ResponseStats.new }

  describe 'test an instance of GetUsageStats200ResponseStats' do
    it 'should create an instance of GetUsageStats200ResponseStats' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetUsageStats200ResponseStats)
    end
  end
  ...
  describe 'test attribute "success_calls"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "failed_calls"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
