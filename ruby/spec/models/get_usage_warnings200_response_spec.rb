...
# Unit tests for MudbaseSDK::GetUsageWarnings200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetUsageWarnings200Response do
  #let(:instance) { MudbaseSDK::GetUsageWarnings200Response.new }

  describe 'test an instance of GetUsageWarnings200Response' do
    it 'should create an instance of GetUsageWarnings200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetUsageWarnings200Response)
    end
  end
