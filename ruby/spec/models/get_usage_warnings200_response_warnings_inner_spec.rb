...
# Unit tests for MudbaseSDK::GetUsageWarnings200ResponseWarningsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetUsageWarnings200ResponseWarningsInner do
  #let(:instance) { MudbaseSDK::GetUsageWarnings200ResponseWarningsInner.new }

  describe 'test an instance of GetUsageWarnings200ResponseWarningsInner' do
    it 'should create an instance of GetUsageWarnings200ResponseWarningsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetUsageWarnings200ResponseWarningsInner)
    end
  end
