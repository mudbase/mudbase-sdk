...
# Unit tests for MudbaseSDK::GetUserChats200ResponseDataChatsInnerLastMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetUserChats200ResponseDataChatsInnerLastMessage do
  #let(:instance) { MudbaseSDK::GetUserChats200ResponseDataChatsInnerLastMessage.new }

  describe 'test an instance of GetUserChats200ResponseDataChatsInnerLastMessage' do
    it 'should create an instance of GetUserChats200ResponseDataChatsInnerLastMessage' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetUserChats200ResponseDataChatsInnerLastMessage)
    end
  end
