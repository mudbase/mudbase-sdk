...
# Unit tests for MudbaseSDK::GetUserChats200ResponseDataChatsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetUserChats200ResponseDataChatsInner do
  #let(:instance) { MudbaseSDK::GetUserChats200ResponseDataChatsInner.new }

  describe 'test an instance of GetUserChats200ResponseDataChatsInner' do
    it 'should create an instance of GetUserChats200ResponseDataChatsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetUserChats200ResponseDataChatsInner)
    end
  end
