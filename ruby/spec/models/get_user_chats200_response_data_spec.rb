...
# Unit tests for MudbaseSDK::GetUserChats200ResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetUserChats200ResponseData do
  #let(:instance) { MudbaseSDK::GetUserChats200ResponseData.new }

  describe 'test an instance of GetUserChats200ResponseData' do
    it 'should create an instance of GetUserChats200ResponseData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetUserChats200ResponseData)
    end
  end
