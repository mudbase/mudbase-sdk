...
# Unit tests for MudbaseSDK::GetUserChats200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetUserChats200Response do
  #let(:instance) { MudbaseSDK::GetUserChats200Response.new }

  describe 'test an instance of GetUserChats200Response' do
    it 'should create an instance of GetUserChats200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetUserChats200Response)
    end
  end
