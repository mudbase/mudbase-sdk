...
# Unit tests for MudbaseSDK::GetUserOverview200ResponseFootprint
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetUserOverview200ResponseFootprint do
  #let(:instance) { MudbaseSDK::GetUserOverview200ResponseFootprint.new }

  describe 'test an instance of GetUserOverview200ResponseFootprint' do
    it 'should create an instance of GetUserOverview200ResponseFootprint' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetUserOverview200ResponseFootprint)
    end
  end
  ...
  describe 'test attribute "api_key_count"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "collections_in_project"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
