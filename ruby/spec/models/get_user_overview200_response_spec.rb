...
# Unit tests for MudbaseSDK::GetUserOverview200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetUserOverview200Response do
  #let(:instance) { MudbaseSDK::GetUserOverview200Response.new }

  describe 'test an instance of GetUserOverview200Response' do
    it 'should create an instance of GetUserOverview200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetUserOverview200Response)
    end
  end
  ...
  describe 'test attribute "footprint"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
