...
# Unit tests for MudbaseSDK::GetUserWallets200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetUserWallets200Response do
  #let(:instance) { MudbaseSDK::GetUserWallets200Response.new }

  describe 'test an instance of GetUserWallets200Response' do
    it 'should create an instance of GetUserWallets200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetUserWallets200Response)
    end
  end
