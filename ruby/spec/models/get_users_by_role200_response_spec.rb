...
# Unit tests for MudbaseSDK::GetUsersByRole200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetUsersByRole200Response do
  #let(:instance) { MudbaseSDK::GetUsersByRole200Response.new }

  describe 'test an instance of GetUsersByRole200Response' do
    it 'should create an instance of GetUsersByRole200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetUsersByRole200Response)
    end
  end
