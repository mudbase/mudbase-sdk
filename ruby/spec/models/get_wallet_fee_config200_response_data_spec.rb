...
# Unit tests for MudbaseSDK::GetWalletFeeConfig200ResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetWalletFeeConfig200ResponseData do
  #let(:instance) { MudbaseSDK::GetWalletFeeConfig200ResponseData.new }

  describe 'test an instance of GetWalletFeeConfig200ResponseData' do
    it 'should create an instance of GetWalletFeeConfig200ResponseData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetWalletFeeConfig200ResponseData)
    end
  end
