...
# Unit tests for MudbaseSDK::GetWalletFeeConfig200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetWalletFeeConfig200Response do
  #let(:instance) { MudbaseSDK::GetWalletFeeConfig200Response.new }

  describe 'test an instance of GetWalletFeeConfig200Response' do
    it 'should create an instance of GetWalletFeeConfig200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetWalletFeeConfig200Response)
    end
  end
