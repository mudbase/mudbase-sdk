...
# Unit tests for MudbaseSDK::GetWalletPrivateKey200ResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetWalletPrivateKey200ResponseData do
  #let(:instance) { MudbaseSDK::GetWalletPrivateKey200ResponseData.new }

  describe 'test an instance of GetWalletPrivateKey200ResponseData' do
    it 'should create an instance of GetWalletPrivateKey200ResponseData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetWalletPrivateKey200ResponseData)
    end
  end
  ...
  describe 'test attribute "is_custom_key"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
