...
# Unit tests for MudbaseSDK::GetWalletPrivateKey200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetWalletPrivateKey200Response do
  #let(:instance) { MudbaseSDK::GetWalletPrivateKey200Response.new }

  describe 'test an instance of GetWalletPrivateKey200Response' do
    it 'should create an instance of GetWalletPrivateKey200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetWalletPrivateKey200Response)
    end
  end
