...
# Unit tests for MudbaseSDK::GetWalletWebhookLogs200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetWalletWebhookLogs200Response do
  #let(:instance) { MudbaseSDK::GetWalletWebhookLogs200Response.new }

  describe 'test an instance of GetWalletWebhookLogs200Response' do
    it 'should create an instance of GetWalletWebhookLogs200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetWalletWebhookLogs200Response)
    end
  end
