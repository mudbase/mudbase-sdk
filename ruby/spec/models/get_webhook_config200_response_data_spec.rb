...
# Unit tests for MudbaseSDK::GetWebhookConfig200ResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetWebhookConfig200ResponseData do
  #let(:instance) { MudbaseSDK::GetWebhookConfig200ResponseData.new }

  describe 'test an instance of GetWebhookConfig200ResponseData' do
    it 'should create an instance of GetWebhookConfig200ResponseData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetWebhookConfig200ResponseData)
    end
  end
