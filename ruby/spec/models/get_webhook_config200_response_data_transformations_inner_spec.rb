...
# Unit tests for MudbaseSDK::GetWebhookConfig200ResponseDataTransformationsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetWebhookConfig200ResponseDataTransformationsInner do
  #let(:instance) { MudbaseSDK::GetWebhookConfig200ResponseDataTransformationsInner.new }

  describe 'test an instance of GetWebhookConfig200ResponseDataTransformationsInner' do
    it 'should create an instance of GetWebhookConfig200ResponseDataTransformationsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetWebhookConfig200ResponseDataTransformationsInner)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["jsonPath", "template", "fieldMap", "filter", "flatten", "version"])
