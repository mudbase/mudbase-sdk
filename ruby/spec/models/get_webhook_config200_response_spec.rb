...
# Unit tests for MudbaseSDK::GetWebhookConfig200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetWebhookConfig200Response do
  #let(:instance) { MudbaseSDK::GetWebhookConfig200Response.new }

  describe 'test an instance of GetWebhookConfig200Response' do
    it 'should create an instance of GetWebhookConfig200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetWebhookConfig200Response)
    end
  end
