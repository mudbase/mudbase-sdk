...
# Unit tests for MudbaseSDK::GetWebhookConfig404Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::GetWebhookConfig404Response do
  #let(:instance) { MudbaseSDK::GetWebhookConfig404Response.new }

  describe 'test an instance of GetWebhookConfig404Response' do
    it 'should create an instance of GetWebhookConfig404Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::GetWebhookConfig404Response)
    end
  end
