...
# Unit tests for MudbaseSDK::HandleFlutterwaveWebhook200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::HandleFlutterwaveWebhook200Response do
  #let(:instance) { MudbaseSDK::HandleFlutterwaveWebhook200Response.new }

  describe 'test an instance of HandleFlutterwaveWebhook200Response' do
    it 'should create an instance of HandleFlutterwaveWebhook200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::HandleFlutterwaveWebhook200Response)
    end
  end
