...
# Unit tests for MudbaseSDK::HandleFlutterwaveWebhookRequestDataCustomer
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::HandleFlutterwaveWebhookRequestDataCustomer do
  #let(:instance) { MudbaseSDK::HandleFlutterwaveWebhookRequestDataCustomer.new }

  describe 'test an instance of HandleFlutterwaveWebhookRequestDataCustomer' do
    it 'should create an instance of HandleFlutterwaveWebhookRequestDataCustomer' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::HandleFlutterwaveWebhookRequestDataCustomer)
    end
  end
