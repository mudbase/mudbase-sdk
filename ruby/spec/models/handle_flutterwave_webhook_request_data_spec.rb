...
# Unit tests for MudbaseSDK::HandleFlutterwaveWebhookRequestData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::HandleFlutterwaveWebhookRequestData do
  #let(:instance) { MudbaseSDK::HandleFlutterwaveWebhookRequestData.new }

  describe 'test an instance of HandleFlutterwaveWebhookRequestData' do
    it 'should create an instance of HandleFlutterwaveWebhookRequestData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::HandleFlutterwaveWebhookRequestData)
    end
  end
  ...
  describe 'test attribute "flw_ref"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
