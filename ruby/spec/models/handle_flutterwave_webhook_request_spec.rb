...
# Unit tests for MudbaseSDK::HandleFlutterwaveWebhookRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::HandleFlutterwaveWebhookRequest do
  #let(:instance) { MudbaseSDK::HandleFlutterwaveWebhookRequest.new }

  describe 'test an instance of HandleFlutterwaveWebhookRequest' do
    it 'should create an instance of HandleFlutterwaveWebhookRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::HandleFlutterwaveWebhookRequest)
    end
  end
