...
# Unit tests for MudbaseSDK::HealthResponseServices
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::HealthResponseServices do
  #let(:instance) { MudbaseSDK::HealthResponseServices.new }

  describe 'test an instance of HealthResponseServices' do
    it 'should create an instance of HealthResponseServices' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::HealthResponseServices)
    end
  end
