...
# Unit tests for MudbaseSDK::HealthResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::HealthResponse do
  #let(:instance) { MudbaseSDK::HealthResponse.new }

  describe 'test an instance of HealthResponse' do
    it 'should create an instance of HealthResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::HealthResponse)
    end
  end
