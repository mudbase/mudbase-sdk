...
# Unit tests for MudbaseSDK::ImportIntegrationRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ImportIntegrationRequest do
  #let(:instance) { MudbaseSDK::ImportIntegrationRequest.new }

  describe 'test an instance of ImportIntegrationRequest' do
    it 'should create an instance of ImportIntegrationRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ImportIntegrationRequest)
    end
  end
