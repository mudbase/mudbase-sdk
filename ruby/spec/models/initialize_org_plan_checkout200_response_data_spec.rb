...
# Unit tests for MudbaseSDK::InitializeOrgPlanCheckout200ResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::InitializeOrgPlanCheckout200ResponseData do
  #let(:instance) { MudbaseSDK::InitializeOrgPlanCheckout200ResponseData.new }

  describe 'test an instance of InitializeOrgPlanCheckout200ResponseData' do
    it 'should create an instance of InitializeOrgPlanCheckout200ResponseData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::InitializeOrgPlanCheckout200ResponseData)
    end
  end
