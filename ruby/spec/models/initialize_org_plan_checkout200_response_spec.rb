...
# Unit tests for MudbaseSDK::InitializeOrgPlanCheckout200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::InitializeOrgPlanCheckout200Response do
  #let(:instance) { MudbaseSDK::InitializeOrgPlanCheckout200Response.new }

  describe 'test an instance of InitializeOrgPlanCheckout200Response' do
    it 'should create an instance of InitializeOrgPlanCheckout200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::InitializeOrgPlanCheckout200Response)
    end
  end
