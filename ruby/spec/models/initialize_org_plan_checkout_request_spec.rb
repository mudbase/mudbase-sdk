...
# Unit tests for MudbaseSDK::InitializeOrgPlanCheckoutRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::InitializeOrgPlanCheckoutRequest do
  #let(:instance) { MudbaseSDK::InitializeOrgPlanCheckoutRequest.new }

  describe 'test an instance of InitializeOrgPlanCheckoutRequest' do
    it 'should create an instance of InitializeOrgPlanCheckoutRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::InitializeOrgPlanCheckoutRequest)
    end
  end
  ...
  describe 'test attribute "plan_name"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["starter", "growth", "scale"])
      # validator.allowable_values.each do |value|
      #   expect { instance.plan_name = value }.not_to raise_error
      # end
    end
  end
