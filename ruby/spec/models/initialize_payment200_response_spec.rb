...
# Unit tests for MudbaseSDK::InitializePayment200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::InitializePayment200Response do
  #let(:instance) { MudbaseSDK::InitializePayment200Response.new }

  describe 'test an instance of InitializePayment200Response' do
    it 'should create an instance of InitializePayment200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::InitializePayment200Response)
    end
  end
