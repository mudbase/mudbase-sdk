...
# Unit tests for MudbaseSDK::InitializePaymentForProjectRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::InitializePaymentForProjectRequest do
  #let(:instance) { MudbaseSDK::InitializePaymentForProjectRequest.new }

  describe 'test an instance of InitializePaymentForProjectRequest' do
    it 'should create an instance of InitializePaymentForProjectRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::InitializePaymentForProjectRequest)
    end
  end
