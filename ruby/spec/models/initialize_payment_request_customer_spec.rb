...
# Unit tests for MudbaseSDK::InitializePaymentRequestCustomer
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::InitializePaymentRequestCustomer do
  #let(:instance) { MudbaseSDK::InitializePaymentRequestCustomer.new }

  describe 'test an instance of InitializePaymentRequestCustomer' do
    it 'should create an instance of InitializePaymentRequestCustomer' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::InitializePaymentRequestCustomer)
    end
  end
