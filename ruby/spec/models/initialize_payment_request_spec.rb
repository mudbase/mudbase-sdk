...
# Unit tests for MudbaseSDK::InitializePaymentRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::InitializePaymentRequest do
  #let(:instance) { MudbaseSDK::InitializePaymentRequest.new }

  describe 'test an instance of InitializePaymentRequest' do
    it 'should create an instance of InitializePaymentRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::InitializePaymentRequest)
    end
  end
