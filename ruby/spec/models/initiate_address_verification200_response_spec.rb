...
# Unit tests for MudbaseSDK::InitiateAddressVerification200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::InitiateAddressVerification200Response do
  #let(:instance) { MudbaseSDK::InitiateAddressVerification200Response.new }

  describe 'test an instance of InitiateAddressVerification200Response' do
    it 'should create an instance of InitiateAddressVerification200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::InitiateAddressVerification200Response)
    end
  end
