...
# Unit tests for MudbaseSDK::InitiateOAuth400Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::InitiateOAuth400Response do
  #let(:instance) { MudbaseSDK::InitiateOAuth400Response.new }

  describe 'test an instance of InitiateOAuth400Response' do
    it 'should create an instance of InitiateOAuth400Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::InitiateOAuth400Response)
    end
  end
