...
# Unit tests for MudbaseSDK::InitiateOAuth404Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::InitiateOAuth404Response do
  #let(:instance) { MudbaseSDK::InitiateOAuth404Response.new }

  describe 'test an instance of InitiateOAuth404Response' do
    it 'should create an instance of InitiateOAuth404Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::InitiateOAuth404Response)
    end
  end
