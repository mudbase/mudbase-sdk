...
# Unit tests for MudbaseSDK::InitiateOrgOAuth400Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::InitiateOrgOAuth400Response do
  #let(:instance) { MudbaseSDK::InitiateOrgOAuth400Response.new }

  describe 'test an instance of InitiateOrgOAuth400Response' do
    it 'should create an instance of InitiateOrgOAuth400Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::InitiateOrgOAuth400Response)
    end
  end
