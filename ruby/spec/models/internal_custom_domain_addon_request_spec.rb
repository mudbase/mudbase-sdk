...
# Unit tests for MudbaseSDK::InternalCustomDomainAddonRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::InternalCustomDomainAddonRequest do
  #let(:instance) { MudbaseSDK::InternalCustomDomainAddonRequest.new }

  describe 'test an instance of InternalCustomDomainAddonRequest' do
    it 'should create an instance of InternalCustomDomainAddonRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::InternalCustomDomainAddonRequest)
    end
  end
