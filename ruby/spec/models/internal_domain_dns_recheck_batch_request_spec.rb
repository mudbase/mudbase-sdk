...
# Unit tests for MudbaseSDK::InternalDomainDnsRecheckBatchRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::InternalDomainDnsRecheckBatchRequest do
  #let(:instance) { MudbaseSDK::InternalDomainDnsRecheckBatchRequest.new }

  describe 'test an instance of InternalDomainDnsRecheckBatchRequest' do
    it 'should create an instance of InternalDomainDnsRecheckBatchRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::InternalDomainDnsRecheckBatchRequest)
    end
  end
