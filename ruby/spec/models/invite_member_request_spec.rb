...
# Unit tests for MudbaseSDK::InviteMemberRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::InviteMemberRequest do
  #let(:instance) { MudbaseSDK::InviteMemberRequest.new }

  describe 'test an instance of InviteMemberRequest' do
    it 'should create an instance of InviteMemberRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::InviteMemberRequest)
    end
  end
