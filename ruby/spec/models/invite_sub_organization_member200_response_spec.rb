...
# Unit tests for MudbaseSDK::InviteSubOrganizationMember200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::InviteSubOrganizationMember200Response do
  #let(:instance) { MudbaseSDK::InviteSubOrganizationMember200Response.new }

  describe 'test an instance of InviteSubOrganizationMember200Response' do
    it 'should create an instance of InviteSubOrganizationMember200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::InviteSubOrganizationMember200Response)
    end
  end
