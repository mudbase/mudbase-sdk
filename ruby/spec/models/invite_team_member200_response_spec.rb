...
# Unit tests for MudbaseSDK::InviteTeamMember200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::InviteTeamMember200Response do
  #let(:instance) { MudbaseSDK::InviteTeamMember200Response.new }

  describe 'test an instance of InviteTeamMember200Response' do
    it 'should create an instance of InviteTeamMember200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::InviteTeamMember200Response)
    end
  end
