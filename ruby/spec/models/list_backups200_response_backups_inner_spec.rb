...
# Unit tests for MudbaseSDK::ListBackups200ResponseBackupsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ListBackups200ResponseBackupsInner do
  #let(:instance) { MudbaseSDK::ListBackups200ResponseBackupsInner.new }

  describe 'test an instance of ListBackups200ResponseBackupsInner' do
    it 'should create an instance of ListBackups200ResponseBackupsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ListBackups200ResponseBackupsInner)
    end
  end
