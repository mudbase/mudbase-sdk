...
# Unit tests for MudbaseSDK::ListBackups200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ListBackups200Response do
  #let(:instance) { MudbaseSDK::ListBackups200Response.new }

  describe 'test an instance of ListBackups200Response' do
    it 'should create an instance of ListBackups200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ListBackups200Response)
    end
  end
