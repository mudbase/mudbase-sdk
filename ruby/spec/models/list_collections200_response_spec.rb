...
# Unit tests for MudbaseSDK::ListCollections200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ListCollections200Response do
  #let(:instance) { MudbaseSDK::ListCollections200Response.new }

  describe 'test an instance of ListCollections200Response' do
    it 'should create an instance of ListCollections200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ListCollections200Response)
    end
  end
