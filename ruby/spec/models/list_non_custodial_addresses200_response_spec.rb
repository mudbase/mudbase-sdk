...
# Unit tests for MudbaseSDK::ListNonCustodialAddresses200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ListNonCustodialAddresses200Response do
  #let(:instance) { MudbaseSDK::ListNonCustodialAddresses200Response.new }

  describe 'test an instance of ListNonCustodialAddresses200Response' do
    it 'should create an instance of ListNonCustodialAddresses200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ListNonCustodialAddresses200Response)
    end
  end
