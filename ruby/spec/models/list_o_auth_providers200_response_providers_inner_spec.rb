...
# Unit tests for MudbaseSDK::ListOAuthProviders200ResponseProvidersInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ListOAuthProviders200ResponseProvidersInner do
  #let(:instance) { MudbaseSDK::ListOAuthProviders200ResponseProvidersInner.new }

  describe 'test an instance of ListOAuthProviders200ResponseProvidersInner' do
    it 'should create an instance of ListOAuthProviders200ResponseProvidersInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ListOAuthProviders200ResponseProvidersInner)
    end
  end
  ...
  describe 'test attribute "linked_at"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
