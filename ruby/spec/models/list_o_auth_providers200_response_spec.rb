...
# Unit tests for MudbaseSDK::ListOAuthProviders200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ListOAuthProviders200Response do
  #let(:instance) { MudbaseSDK::ListOAuthProviders200Response.new }

  describe 'test an instance of ListOAuthProviders200Response' do
    it 'should create an instance of ListOAuthProviders200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ListOAuthProviders200Response)
    end
  end
