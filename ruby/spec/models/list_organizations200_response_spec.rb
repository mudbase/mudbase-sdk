...
# Unit tests for MudbaseSDK::ListOrganizations200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ListOrganizations200Response do
  #let(:instance) { MudbaseSDK::ListOrganizations200Response.new }
  ...
  describe 'test an instance of ListOrganizations200Response' do
    it 'should create an instance of ListOrganizations200Response' do
      ...
      #expect(instance).to be_instance_of(MudbaseSDK::ListOrganizations200Response)
    end
  end
