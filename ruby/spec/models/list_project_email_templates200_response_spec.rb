...
# Unit tests for MudbaseSDK::ListProjectEmailTemplates200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ListProjectEmailTemplates200Response do
  #let(:instance) { MudbaseSDK::ListProjectEmailTemplates200Response.new }

  describe 'test an instance of ListProjectEmailTemplates200Response' do
    it 'should create an instance of ListProjectEmailTemplates200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ListProjectEmailTemplates200Response)
    end
  end
