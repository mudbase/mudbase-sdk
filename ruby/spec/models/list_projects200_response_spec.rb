...
# Unit tests for MudbaseSDK::ListProjects200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ListProjects200Response do
  #let(:instance) { MudbaseSDK::ListProjects200Response.new }
  ...
  describe 'test an instance of ListProjects200Response' do
    it 'should create an instance of ListProjects200Response' do
      ...
      #expect(instance).to be_instance_of(MudbaseSDK::ListProjects200Response)
    end
  end
