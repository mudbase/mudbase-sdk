...
# Unit tests for MudbaseSDK::ListRoles200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ListRoles200Response do
  #let(:instance) { MudbaseSDK::ListRoles200Response.new }

  describe 'test an instance of ListRoles200Response' do
    it 'should create an instance of ListRoles200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ListRoles200Response)
    end
  end
