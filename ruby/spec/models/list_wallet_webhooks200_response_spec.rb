...
# Unit tests for MudbaseSDK::ListWalletWebhooks200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ListWalletWebhooks200Response do
  #let(:instance) { MudbaseSDK::ListWalletWebhooks200Response.new }

  describe 'test an instance of ListWalletWebhooks200Response' do
    it 'should create an instance of ListWalletWebhooks200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ListWalletWebhooks200Response)
    end
  end
