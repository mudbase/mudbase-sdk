...
# Unit tests for MudbaseSDK::LogSecurityEvent200ResponseEvent
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::LogSecurityEvent200ResponseEvent do
  #let(:instance) { MudbaseSDK::LogSecurityEvent200ResponseEvent.new }

  describe 'test an instance of LogSecurityEvent200ResponseEvent' do
    it 'should create an instance of LogSecurityEvent200ResponseEvent' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::LogSecurityEvent200ResponseEvent)
    end
  end
