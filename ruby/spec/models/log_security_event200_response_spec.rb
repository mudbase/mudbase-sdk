...
# Unit tests for MudbaseSDK::LogSecurityEvent200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::LogSecurityEvent200Response do
  #let(:instance) { MudbaseSDK::LogSecurityEvent200Response.new }

  describe 'test an instance of LogSecurityEvent200Response' do
    it 'should create an instance of LogSecurityEvent200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::LogSecurityEvent200Response)
    end
  end
