...
# Unit tests for MudbaseSDK::LogSecurityEventRequestDetails
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::LogSecurityEventRequestDetails do
  #let(:instance) { MudbaseSDK::LogSecurityEventRequestDetails.new }

  describe 'test an instance of LogSecurityEventRequestDetails' do
    it 'should create an instance of LogSecurityEventRequestDetails' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::LogSecurityEventRequestDetails)
    end
  end
