...
# Unit tests for MudbaseSDK::LogSecurityEventRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::LogSecurityEventRequest do
  #let(:instance) { MudbaseSDK::LogSecurityEventRequest.new }

  describe 'test an instance of LogSecurityEventRequest' do
    it 'should create an instance of LogSecurityEventRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::LogSecurityEventRequest)
    end
  end
  ...
  describe 'test attribute "event_type"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["unauthorized_access_attempt", "brute_force_attempt", "suspicious_api_activity", "private_key_export", "bulk_data_export", "admin_privilege_escalation", "data_breach_detected", "mfa_bypass_attempt"])
