...
# Unit tests for MudbaseSDK::LoginLocalUser200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::LoginLocalUser200Response do
  #let(:instance) { MudbaseSDK::LoginLocalUser200Response.new }

  describe 'test an instance of LoginLocalUser200Response' do
    it 'should create an instance of LoginLocalUser200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::LoginLocalUser200Response)
    end
  end
