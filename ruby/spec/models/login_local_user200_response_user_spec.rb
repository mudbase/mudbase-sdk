...
# Unit tests for MudbaseSDK::LoginLocalUser200ResponseUser
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::LoginLocalUser200ResponseUser do
  #let(:instance) { MudbaseSDK::LoginLocalUser200ResponseUser.new }

  describe 'test an instance of LoginLocalUser200ResponseUser' do
    it 'should create an instance of LoginLocalUser200ResponseUser' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::LoginLocalUser200ResponseUser)
    end
  end
