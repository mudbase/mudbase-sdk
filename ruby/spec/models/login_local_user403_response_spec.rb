...
# Unit tests for MudbaseSDK::LoginLocalUser403Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::LoginLocalUser403Response do
  #let(:instance) { MudbaseSDK::LoginLocalUser403Response.new }

  describe 'test an instance of LoginLocalUser403Response' do
    it 'should create an instance of LoginLocalUser403Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::LoginLocalUser403Response)
    end
  end
