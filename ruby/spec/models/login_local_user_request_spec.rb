...
# Unit tests for MudbaseSDK::LoginLocalUserRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::LoginLocalUserRequest do
  #let(:instance) { MudbaseSDK::LoginLocalUserRequest.new }

  describe 'test an instance of LoginLocalUserRequest' do
    it 'should create an instance of LoginLocalUserRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::LoginLocalUserRequest)
    end
  end
