...
# Unit tests for MudbaseSDK::MagicLinkRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::MagicLinkRequest do
  #let(:instance) { MudbaseSDK::MagicLinkRequest.new }

  describe 'test an instance of MagicLinkRequest' do
    it 'should create an instance of MagicLinkRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::MagicLinkRequest)
    end
  end
