...
# Unit tests for MudbaseSDK::MarkMessagesAsRead200ResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::MarkMessagesAsRead200ResponseData do
  #let(:instance) { MudbaseSDK::MarkMessagesAsRead200ResponseData.new }

  describe 'test an instance of MarkMessagesAsRead200ResponseData' do
    it 'should create an instance of MarkMessagesAsRead200ResponseData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::MarkMessagesAsRead200ResponseData)
    end
  end
