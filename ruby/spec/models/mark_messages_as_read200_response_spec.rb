...
# Unit tests for MudbaseSDK::MarkMessagesAsRead200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::MarkMessagesAsRead200Response do
  #let(:instance) { MudbaseSDK::MarkMessagesAsRead200Response.new }

  describe 'test an instance of MarkMessagesAsRead200Response' do
    it 'should create an instance of MarkMessagesAsRead200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::MarkMessagesAsRead200Response)
    end
  end
