...
# Unit tests for MudbaseSDK::MarkMessagesAsReadRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::MarkMessagesAsReadRequest do
  #let(:instance) { MudbaseSDK::MarkMessagesAsReadRequest.new }

  describe 'test an instance of MarkMessagesAsReadRequest' do
    it 'should create an instance of MarkMessagesAsReadRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::MarkMessagesAsReadRequest)
    end
  end
