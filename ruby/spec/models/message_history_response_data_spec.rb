...
# Unit tests for MudbaseSDK::MessageHistoryResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::MessageHistoryResponseData do
  #let(:instance) { MudbaseSDK::MessageHistoryResponseData.new }

  describe 'test an instance of MessageHistoryResponseData' do
    it 'should create an instance of MessageHistoryResponseData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::MessageHistoryResponseData)
    end
  end
