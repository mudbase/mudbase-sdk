...
# Unit tests for MudbaseSDK::MessageHistoryResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::MessageHistoryResponse do
  #let(:instance) { MudbaseSDK::MessageHistoryResponse.new }

  describe 'test an instance of MessageHistoryResponse' do
    it 'should create an instance of MessageHistoryResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::MessageHistoryResponse)
    end
  end
