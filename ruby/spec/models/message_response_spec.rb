...
# Unit tests for MudbaseSDK::MessageResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::MessageResponse do
  #let(:instance) { MudbaseSDK::MessageResponse.new }

  describe 'test an instance of MessageResponse' do
    it 'should create an instance of MessageResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::MessageResponse)
    end
  end
