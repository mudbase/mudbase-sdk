...
# Unit tests for MudbaseSDK::MessageSentResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::MessageSentResponseData do
  #let(:instance) { MudbaseSDK::MessageSentResponseData.new }

  describe 'test an instance of MessageSentResponseData' do
    it 'should create an instance of MessageSentResponseData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::MessageSentResponseData)
    end
  end
