...
# Unit tests for MudbaseSDK::MessageSentResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::MessageSentResponse do
  #let(:instance) { MudbaseSDK::MessageSentResponse.new }

  describe 'test an instance of MessageSentResponse' do
    it 'should create an instance of MessageSentResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::MessageSentResponse)
    end
  end
