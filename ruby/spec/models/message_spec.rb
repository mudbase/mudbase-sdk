...
# Unit tests for MudbaseSDK::Message
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::Message do
  #let(:instance) { MudbaseSDK::Message.new }

  describe 'test an instance of Message' do
    it 'should create an instance of Message' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::Message)
    end
  end
