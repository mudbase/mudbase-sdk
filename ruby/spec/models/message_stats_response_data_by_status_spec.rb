...
# Unit tests for MudbaseSDK::MessageStatsResponseDataByStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::MessageStatsResponseDataByStatus do
  #let(:instance) { MudbaseSDK::MessageStatsResponseDataByStatus.new }

  describe 'test an instance of MessageStatsResponseDataByStatus' do
    it 'should create an instance of MessageStatsResponseDataByStatus' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::MessageStatsResponseDataByStatus)
    end
  end
