...
# Unit tests for MudbaseSDK::MessageStatsResponseDataByType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::MessageStatsResponseDataByType do
  #let(:instance) { MudbaseSDK::MessageStatsResponseDataByType.new }

  describe 'test an instance of MessageStatsResponseDataByType' do
    it 'should create an instance of MessageStatsResponseDataByType' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::MessageStatsResponseDataByType)
    end
  end
