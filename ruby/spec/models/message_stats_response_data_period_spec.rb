...
# Unit tests for MudbaseSDK::MessageStatsResponseDataPeriod
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::MessageStatsResponseDataPeriod do
  #let(:instance) { MudbaseSDK::MessageStatsResponseDataPeriod.new }

  describe 'test an instance of MessageStatsResponseDataPeriod' do
    it 'should create an instance of MessageStatsResponseDataPeriod' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::MessageStatsResponseDataPeriod)
    end
  end
