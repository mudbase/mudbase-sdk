...
# Unit tests for MudbaseSDK::MessageStatsResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::MessageStatsResponseData do
  #let(:instance) { MudbaseSDK::MessageStatsResponseData.new }

  describe 'test an instance of MessageStatsResponseData' do
    it 'should create an instance of MessageStatsResponseData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::MessageStatsResponseData)
    end
  end
