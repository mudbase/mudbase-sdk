...
# Unit tests for MudbaseSDK::MessageStatsResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::MessageStatsResponse do
  #let(:instance) { MudbaseSDK::MessageStatsResponse.new }

  describe 'test an instance of MessageStatsResponse' do
    it 'should create an instance of MessageStatsResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::MessageStatsResponse)
    end
  end
