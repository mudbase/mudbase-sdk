...
# Unit tests for MudbaseSDK::MonitoringAnalyticsResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::MonitoringAnalyticsResponse do
  #let(:instance) { MudbaseSDK::MonitoringAnalyticsResponse.new }

  describe 'test an instance of MonitoringAnalyticsResponse' do
    it 'should create an instance of MonitoringAnalyticsResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::MonitoringAnalyticsResponse)
    end
  end
