...
# Unit tests for MudbaseSDK::MonitoringAnalyticsResponseStatsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::MonitoringAnalyticsResponseStatsInner do
  #let(:instance) { MudbaseSDK::MonitoringAnalyticsResponseStatsInner.new }

  describe 'test an instance of MonitoringAnalyticsResponseStatsInner' do
    it 'should create an instance of MonitoringAnalyticsResponseStatsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::MonitoringAnalyticsResponseStatsInner)
    end
  end
  ...
  describe 'test attribute "db_reads"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "db_writes"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
