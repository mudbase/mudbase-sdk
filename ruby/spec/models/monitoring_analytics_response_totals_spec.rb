...
# Unit tests for MudbaseSDK::MonitoringAnalyticsResponseTotals
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::MonitoringAnalyticsResponseTotals do
  #let(:instance) { MudbaseSDK::MonitoringAnalyticsResponseTotals.new }

  describe 'test an instance of MonitoringAnalyticsResponseTotals' do
    it 'should create an instance of MonitoringAnalyticsResponseTotals' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::MonitoringAnalyticsResponseTotals)
    end
  end
  ...
  describe 'test attribute "total_db_reads"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "total_db_writes"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "total_bandwidth"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
