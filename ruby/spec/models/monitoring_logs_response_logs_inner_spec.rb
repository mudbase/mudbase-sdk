...
# Unit tests for MudbaseSDK::MonitoringLogsResponseLogsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::MonitoringLogsResponseLogsInner do
  #let(:instance) { MudbaseSDK::MonitoringLogsResponseLogsInner.new }

  describe 'test an instance of MonitoringLogsResponseLogsInner' do
    it 'should create an instance of MonitoringLogsResponseLogsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::MonitoringLogsResponseLogsInner)
    end
  end
  ...
  describe 'test attribute "activity_detail"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
