...
# Unit tests for MudbaseSDK::MonitoringLogsResponseLogsInnerUser
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::MonitoringLogsResponseLogsInnerUser do
  #let(:instance) { MudbaseSDK::MonitoringLogsResponseLogsInnerUser.new }

  describe 'test an instance of MonitoringLogsResponseLogsInnerUser' do
    it 'should create an instance of MonitoringLogsResponseLogsInnerUser' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::MonitoringLogsResponseLogsInnerUser)
    end
  end
