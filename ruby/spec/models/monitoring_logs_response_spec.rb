...
# Unit tests for MudbaseSDK::MonitoringLogsResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::MonitoringLogsResponse do
  #let(:instance) { MudbaseSDK::MonitoringLogsResponse.new }

  describe 'test an instance of MonitoringLogsResponse' do
    it 'should create an instance of MonitoringLogsResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::MonitoringLogsResponse)
    end
  end
