...
# Unit tests for MudbaseSDK::MonitoringPerformanceResponseMetrics
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::MonitoringPerformanceResponseMetrics do
  #let(:instance) { MudbaseSDK::MonitoringPerformanceResponseMetrics.new }

  describe 'test an instance of MonitoringPerformanceResponseMetrics' do
    it 'should create an instance of MonitoringPerformanceResponseMetrics' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::MonitoringPerformanceResponseMetrics)
    end
  end
  ...
  describe 'test attribute "avg_response_time"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "min_response_time"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "max_response_time"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "latency_source"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
