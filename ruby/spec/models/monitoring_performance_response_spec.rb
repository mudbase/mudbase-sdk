...
# Unit tests for MudbaseSDK::MonitoringPerformanceResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::MonitoringPerformanceResponse do
  #let(:instance) { MudbaseSDK::MonitoringPerformanceResponse.new }

  describe 'test an instance of MonitoringPerformanceResponse' do
    it 'should create an instance of MonitoringPerformanceResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::MonitoringPerformanceResponse)
    end
  end
  ...
  describe 'test attribute "top_endpoints"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
