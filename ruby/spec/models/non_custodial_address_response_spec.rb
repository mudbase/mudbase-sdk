...
# Unit tests for MudbaseSDK::NonCustodialAddressResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::NonCustodialAddressResponse do
  #let(:instance) { MudbaseSDK::NonCustodialAddressResponse.new }

  describe 'test an instance of NonCustodialAddressResponse' do
    it 'should create an instance of NonCustodialAddressResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::NonCustodialAddressResponse)
    end
  end
