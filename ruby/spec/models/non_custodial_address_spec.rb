...
# Unit tests for MudbaseSDK::NonCustodialAddress
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::NonCustodialAddress do
  #let(:instance) { MudbaseSDK::NonCustodialAddress.new }

  describe 'test an instance of NonCustodialAddress' do
    it 'should create an instance of NonCustodialAddress' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::NonCustodialAddress)
    end
  end
  ...
  describe 'test attribute "chain"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["ethereum", "binance", "polygon", "celo", "bitcoin"])
