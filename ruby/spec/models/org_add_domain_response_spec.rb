...
# Unit tests for MudbaseSDK::OrgAddDomainResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::OrgAddDomainResponse do
  #let(:instance) { MudbaseSDK::OrgAddDomainResponse.new }

  describe 'test an instance of OrgAddDomainResponse' do
    it 'should create an instance of OrgAddDomainResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::OrgAddDomainResponse)
    end
  end
