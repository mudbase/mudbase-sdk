...
# Unit tests for MudbaseSDK::OrgCloudflareEdgeHintsOwnershipVerification
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::OrgCloudflareEdgeHintsOwnershipVerification do
  #let(:instance) { MudbaseSDK::OrgCloudflareEdgeHintsOwnershipVerification.new }

  describe 'test an instance of OrgCloudflareEdgeHintsOwnershipVerification' do
    it 'should create an instance of OrgCloudflareEdgeHintsOwnershipVerification' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::OrgCloudflareEdgeHintsOwnershipVerification)
    end
  end
