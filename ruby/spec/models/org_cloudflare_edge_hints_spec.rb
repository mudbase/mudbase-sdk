...
# Unit tests for MudbaseSDK::OrgCloudflareEdgeHints
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::OrgCloudflareEdgeHints do
  #let(:instance) { MudbaseSDK::OrgCloudflareEdgeHints.new }

  describe 'test an instance of OrgCloudflareEdgeHints' do
    it 'should create an instance of OrgCloudflareEdgeHints' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::OrgCloudflareEdgeHints)
    end
  end

  describe 'test attribute "saas_integration_enabled"' do
    it 'should work' do
  ...
  describe 'test attribute "hostname_status"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "ownership_verification"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "ssl_validation_records"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
