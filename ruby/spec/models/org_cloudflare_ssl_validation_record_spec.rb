...
# Unit tests for MudbaseSDK::OrgCloudflareSslValidationRecord
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::OrgCloudflareSslValidationRecord do
  #let(:instance) { MudbaseSDK::OrgCloudflareSslValidationRecord.new }

  describe 'test an instance of OrgCloudflareSslValidationRecord' do
    it 'should create an instance of OrgCloudflareSslValidationRecord' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::OrgCloudflareSslValidationRecord)
    end
  end

  describe 'test attribute "txt_name"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "txt_value"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
