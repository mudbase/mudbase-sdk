...
# Unit tests for MudbaseSDK::OrgCustomDomainPlatformReadyRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::OrgCustomDomainPlatformReadyRequest do
  #let(:instance) { MudbaseSDK::OrgCustomDomainPlatformReadyRequest.new }

  describe 'test an instance of OrgCustomDomainPlatformReadyRequest' do
    it 'should create an instance of OrgCustomDomainPlatformReadyRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::OrgCustomDomainPlatformReadyRequest)
    end
  end
