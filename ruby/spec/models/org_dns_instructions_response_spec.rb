...
# Unit tests for MudbaseSDK::OrgDnsInstructionsResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::OrgDnsInstructionsResponse do
  #let(:instance) { MudbaseSDK::OrgDnsInstructionsResponse.new }

  describe 'test an instance of OrgDnsInstructionsResponse' do
    it 'should create an instance of OrgDnsInstructionsResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::OrgDnsInstructionsResponse)
    end
  end
