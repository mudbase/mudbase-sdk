...
# Unit tests for MudbaseSDK::OrgDnsRecord
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::OrgDnsRecord do
  #let(:instance) { MudbaseSDK::OrgDnsRecord.new }

  describe 'test an instance of OrgDnsRecord' do
    it 'should create an instance of OrgDnsRecord' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::OrgDnsRecord)
    end
  end
