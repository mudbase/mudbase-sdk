...
# Unit tests for MudbaseSDK::OrgDomainEntryOrgConsole
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::OrgDomainEntryOrgConsole do
  #let(:instance) { MudbaseSDK::OrgDomainEntryOrgConsole.new }

  describe 'test an instance of OrgDomainEntryOrgConsole' do
    it 'should create an instance of OrgDomainEntryOrgConsole' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::OrgDomainEntryOrgConsole)
    end
  end
