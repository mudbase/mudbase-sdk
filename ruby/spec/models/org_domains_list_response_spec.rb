...
# Unit tests for MudbaseSDK::OrgDomainsListResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::OrgDomainsListResponse do
  #let(:instance) { MudbaseSDK::OrgDomainsListResponse.new }

  describe 'test an instance of OrgDomainsListResponse' do
    it 'should create an instance of OrgDomainsListResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::OrgDomainsListResponse)
    end
  end
  ...
  describe 'test attribute "dns_verification_instructions"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "primary_hostname"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "custom_domain_allowed"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
