...
# Unit tests for MudbaseSDK::OrgOAuthCallback400Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::OrgOAuthCallback400Response do
  #let(:instance) { MudbaseSDK::OrgOAuthCallback400Response.new }

  describe 'test an instance of OrgOAuthCallback400Response' do
    it 'should create an instance of OrgOAuthCallback400Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::OrgOAuthCallback400Response)
    end
  end
