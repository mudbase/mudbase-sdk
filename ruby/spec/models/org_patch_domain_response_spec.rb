...
# Unit tests for MudbaseSDK::OrgPatchDomainResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::OrgPatchDomainResponse do
  #let(:instance) { MudbaseSDK::OrgPatchDomainResponse.new }

  describe 'test an instance of OrgPatchDomainResponse' do
    it 'should create an instance of OrgPatchDomainResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::OrgPatchDomainResponse)
    end
  end
