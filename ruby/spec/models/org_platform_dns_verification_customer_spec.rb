...
# Unit tests for MudbaseSDK::OrgPlatformDnsVerificationCustomer
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::OrgPlatformDnsVerificationCustomer do
  #let(:instance) { MudbaseSDK::OrgPlatformDnsVerificationCustomer.new }

  describe 'test an instance of OrgPlatformDnsVerificationCustomer' do
    it 'should create an instance of OrgPlatformDnsVerificationCustomer' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::OrgPlatformDnsVerificationCustomer)
    end
  end
