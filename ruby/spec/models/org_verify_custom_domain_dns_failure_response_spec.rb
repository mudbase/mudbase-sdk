...
# Unit tests for MudbaseSDK::OrgVerifyCustomDomainDnsFailureResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::OrgVerifyCustomDomainDnsFailureResponse do
  #let(:instance) { MudbaseSDK::OrgVerifyCustomDomainDnsFailureResponse.new }

  describe 'test an instance of OrgVerifyCustomDomainDnsFailureResponse' do
    it 'should create an instance of OrgVerifyCustomDomainDnsFailureResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::OrgVerifyCustomDomainDnsFailureResponse)
    end
  end
