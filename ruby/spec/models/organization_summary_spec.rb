...
# Unit tests for MudbaseSDK::OrganizationSummary
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::OrganizationSummary do
  #let(:instance) { MudbaseSDK::OrganizationSummary.new }

  describe 'test an instance of OrganizationSummary' do
    it 'should create an instance of OrganizationSummary' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::OrganizationSummary)
    end
  end
