...
# Unit tests for MudbaseSDK::OTPSendRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::OTPSendRequest do
  #let(:instance) { MudbaseSDK::OTPSendRequest.new }

  describe 'test an instance of OTPSendRequest' do
    it 'should create an instance of OTPSendRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::OTPSendRequest)
    end
  end
