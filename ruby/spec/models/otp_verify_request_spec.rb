...
# Unit tests for MudbaseSDK::OTPVerifyRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::OTPVerifyRequest do
  #let(:instance) { MudbaseSDK::OTPVerifyRequest.new }

  describe 'test an instance of OTPVerifyRequest' do
    it 'should create an instance of OTPVerifyRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::OTPVerifyRequest)
    end
  end
