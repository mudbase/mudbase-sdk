...
# Unit tests for MudbaseSDK::Pagination
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::Pagination do
  #let(:instance) { MudbaseSDK::Pagination.new }

  describe 'test an instance of Pagination' do
    it 'should create an instance of Pagination' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::Pagination)
    end
  end
