...
# Unit tests for MudbaseSDK::PatchOrgDomainRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::PatchOrgDomainRequest do
  #let(:instance) { MudbaseSDK::PatchOrgDomainRequest.new }

  describe 'test an instance of PatchOrgDomainRequest' do
    it 'should create an instance of PatchOrgDomainRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::PatchOrgDomainRequest)
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["pending", "failed"])
  ...
  describe 'test attribute "regenerate_token"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
