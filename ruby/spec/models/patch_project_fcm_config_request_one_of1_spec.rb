...
# Unit tests for MudbaseSDK::PatchProjectFcmConfigRequestOneOf1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::PatchProjectFcmConfigRequestOneOf1 do
  #let(:instance) { MudbaseSDK::PatchProjectFcmConfigRequestOneOf1.new }

  describe 'test an instance of PatchProjectFcmConfigRequestOneOf1' do
    it 'should create an instance of PatchProjectFcmConfigRequestOneOf1' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::PatchProjectFcmConfigRequestOneOf1)
    end
  end

  describe 'test attribute "clear"' do
    it 'should work' do
