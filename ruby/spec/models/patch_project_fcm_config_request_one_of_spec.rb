...
# Unit tests for MudbaseSDK::PatchProjectFcmConfigRequestOneOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::PatchProjectFcmConfigRequestOneOf do
  #let(:instance) { MudbaseSDK::PatchProjectFcmConfigRequestOneOf.new }

  describe 'test an instance of PatchProjectFcmConfigRequestOneOf' do
    it 'should create an instance of PatchProjectFcmConfigRequestOneOf' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::PatchProjectFcmConfigRequestOneOf)
    end
  end

  describe 'test attribute "service_account_json"' do
    it 'should work' do
