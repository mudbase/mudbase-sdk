...
# Unit tests for MudbaseSDK::Permission
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::Permission do
  #let(:instance) { MudbaseSDK::Permission.new }

  describe 'test an instance of Permission' do
    it 'should create an instance of Permission' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::Permission)
    end
  end
