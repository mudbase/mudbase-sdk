...
# Unit tests for MudbaseSDK::PlatformAdminActivateOrgCustomDomainRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::PlatformAdminActivateOrgCustomDomainRequest do
  #let(:instance) { MudbaseSDK::PlatformAdminActivateOrgCustomDomainRequest.new }

  describe 'test an instance of PlatformAdminActivateOrgCustomDomainRequest' do
    it 'should create an instance of PlatformAdminActivateOrgCustomDomainRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::PlatformAdminActivateOrgCustomDomainRequest)
    end
  end
