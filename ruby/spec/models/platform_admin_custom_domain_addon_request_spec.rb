...
# Unit tests for MudbaseSDK::PlatformAdminCustomDomainAddonRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::PlatformAdminCustomDomainAddonRequest do
  #let(:instance) { MudbaseSDK::PlatformAdminCustomDomainAddonRequest.new }

  describe 'test an instance of PlatformAdminCustomDomainAddonRequest' do
    it 'should create an instance of PlatformAdminCustomDomainAddonRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::PlatformAdminCustomDomainAddonRequest)
    end
  end
