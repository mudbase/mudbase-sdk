...
# Unit tests for MudbaseSDK::PlatformAdminDetachMemberRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::PlatformAdminDetachMemberRequest do
  #let(:instance) { MudbaseSDK::PlatformAdminDetachMemberRequest.new }

  describe 'test an instance of PlatformAdminDetachMemberRequest' do
    it 'should create an instance of PlatformAdminDetachMemberRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::PlatformAdminDetachMemberRequest)
    end
  end
