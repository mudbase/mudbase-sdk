...
# Unit tests for MudbaseSDK::PlatformAdminDomainDnsRecheckBatchRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::PlatformAdminDomainDnsRecheckBatchRequest do
  #let(:instance) { MudbaseSDK::PlatformAdminDomainDnsRecheckBatchRequest.new }

  describe 'test an instance of PlatformAdminDomainDnsRecheckBatchRequest' do
    it 'should create an instance of PlatformAdminDomainDnsRecheckBatchRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::PlatformAdminDomainDnsRecheckBatchRequest)
    end
  end

  describe 'test attribute "max_orgs"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "recheck_older_than_hours"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
