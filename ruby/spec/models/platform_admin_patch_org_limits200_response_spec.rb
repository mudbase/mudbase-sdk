...
# Unit tests for MudbaseSDK::PlatformAdminPatchOrgLimits200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::PlatformAdminPatchOrgLimits200Response do
  #let(:instance) { MudbaseSDK::PlatformAdminPatchOrgLimits200Response.new }

  describe 'test an instance of PlatformAdminPatchOrgLimits200Response' do
    it 'should create an instance of PlatformAdminPatchOrgLimits200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::PlatformAdminPatchOrgLimits200Response)
    end
  end
