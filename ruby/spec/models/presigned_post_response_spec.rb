...
# Unit tests for MudbaseSDK::PresignedPostResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::PresignedPostResponse do
  #let(:instance) { MudbaseSDK::PresignedPostResponse.new }

  describe 'test an instance of PresignedPostResponse' do
    it 'should create an instance of PresignedPostResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::PresignedPostResponse)
    end
  end
  ...
  describe 'test attribute "method"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["PUT"])
  ...
  describe 'test attribute "max_file_upload_bytes"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
