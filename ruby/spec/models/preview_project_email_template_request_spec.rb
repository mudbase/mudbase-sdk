...
# Unit tests for MudbaseSDK::PreviewProjectEmailTemplateRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::PreviewProjectEmailTemplateRequest do
  #let(:instance) { MudbaseSDK::PreviewProjectEmailTemplateRequest.new }

  describe 'test an instance of PreviewProjectEmailTemplateRequest' do
    it 'should create an instance of PreviewProjectEmailTemplateRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::PreviewProjectEmailTemplateRequest)
    end
  end
