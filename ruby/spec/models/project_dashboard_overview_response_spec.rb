...
# Unit tests for MudbaseSDK::ProjectDashboardOverviewResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ProjectDashboardOverviewResponse do
  #let(:instance) { MudbaseSDK::ProjectDashboardOverviewResponse.new }

  describe 'test an instance of ProjectDashboardOverviewResponse' do
    it 'should create an instance of ProjectDashboardOverviewResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ProjectDashboardOverviewResponse)
    end
  end
