...
# Unit tests for MudbaseSDK::ProjectEmailSendRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ProjectEmailSendRequest do
  #let(:instance) { MudbaseSDK::ProjectEmailSendRequest.new }

  describe 'test an instance of ProjectEmailSendRequest' do
    it 'should create an instance of ProjectEmailSendRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ProjectEmailSendRequest)
    end
  end
  ...
  describe 'test attribute "branding_scope"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["platform", "project"])
      # validator.allowable_values.each do |value|
      #   expect { instance.branding_scope = value }.not_to raise_error
      # end
    end
  end
