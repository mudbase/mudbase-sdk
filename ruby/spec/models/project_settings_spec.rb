...
# Unit tests for MudbaseSDK::ProjectSettings
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ProjectSettings do
  #let(:instance) { MudbaseSDK::ProjectSettings.new }

  describe 'test an instance of ProjectSettings' do
    it 'should create an instance of ProjectSettings' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ProjectSettings)
    end
  end

  describe 'test attribute "allow_anonymous_auth"' do
    it 'should work' do
  ...
  describe 'test attribute "require_phone_verification"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "default_user_account_status"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["pending", "active"])
      # validator.allowable_values.each do |value|
      #   expect { instance.default_user_account_status = value }.not_to raise_error
      # end
    end
  end

  describe 'test attribute "enable_realtime"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "enable_storage"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "enable_functions"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
