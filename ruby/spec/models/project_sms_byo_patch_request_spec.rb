...
# Unit tests for MudbaseSDK::ProjectSmsByoPatchRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ProjectSmsByoPatchRequest do
  #let(:instance) { MudbaseSDK::ProjectSmsByoPatchRequest.new }

  describe 'test an instance of ProjectSmsByoPatchRequest' do
    it 'should create an instance of ProjectSmsByoPatchRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ProjectSmsByoPatchRequest)
    end
  end
