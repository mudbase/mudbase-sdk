...
# Unit tests for MudbaseSDK::ProjectSmsByoPublic
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ProjectSmsByoPublic do
  #let(:instance) { MudbaseSDK::ProjectSmsByoPublic.new }

  describe 'test an instance of ProjectSmsByoPublic' do
    it 'should create an instance of ProjectSmsByoPublic' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ProjectSmsByoPublic)
    end
  end
  ...
  describe 'test attribute "provider"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["twilio", "termii", "africastalking", "none"])
  ...
  describe 'test attribute "has_credentials"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
