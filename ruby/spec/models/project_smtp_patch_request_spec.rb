...
# Unit tests for MudbaseSDK::ProjectSmtpPatchRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ProjectSmtpPatchRequest do
  #let(:instance) { MudbaseSDK::ProjectSmtpPatchRequest.new }

  describe 'test an instance of ProjectSmtpPatchRequest' do
    it 'should create an instance of ProjectSmtpPatchRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ProjectSmtpPatchRequest)
    end
  end
  ...
  describe 'test attribute "auth_user"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "auth_pass"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "domain_verified_at"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
