...
# Unit tests for MudbaseSDK::ProjectSmtpSettingsPublic
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ProjectSmtpSettingsPublic do
  #let(:instance) { MudbaseSDK::ProjectSmtpSettingsPublic.new }

  describe 'test an instance of ProjectSmtpSettingsPublic' do
    it 'should create an instance of ProjectSmtpSettingsPublic' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ProjectSmtpSettingsPublic)
    end
  end
