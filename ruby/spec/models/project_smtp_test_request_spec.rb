...
# Unit tests for MudbaseSDK::ProjectSmtpTestRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ProjectSmtpTestRequest do
  #let(:instance) { MudbaseSDK::ProjectSmtpTestRequest.new }

  describe 'test an instance of ProjectSmtpTestRequest' do
    it 'should create an instance of ProjectSmtpTestRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ProjectSmtpTestRequest)
    end
  end
  ...
  describe 'test attribute "use_saved"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
