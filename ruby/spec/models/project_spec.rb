...
# Unit tests for MudbaseSDK::Project
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::Project do
  #let(:instance) { MudbaseSDK::Project.new }

  describe 'test an instance of Project' do
    it 'should create an instance of Project' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::Project)
    end
  end
