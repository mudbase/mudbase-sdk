...
# Unit tests for MudbaseSDK::ProjectSummary
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ProjectSummary do
  #let(:instance) { MudbaseSDK::ProjectSummary.new }

  describe 'test an instance of ProjectSummary' do
    it 'should create an instance of ProjectSummary' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ProjectSummary)
    end
  end
