...
# Unit tests for MudbaseSDK::ProjectUsageResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ProjectUsageResponse do
  #let(:instance) { MudbaseSDK::ProjectUsageResponse.new }

  describe 'test an instance of ProjectUsageResponse' do
    it 'should create an instance of ProjectUsageResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ProjectUsageResponse)
    end
  end
