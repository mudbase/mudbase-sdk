...
# Unit tests for MudbaseSDK::ProjectUsage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ProjectUsage do
  #let(:instance) { MudbaseSDK::ProjectUsage.new }

  describe 'test an instance of ProjectUsage' do
    it 'should create an instance of ProjectUsage' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ProjectUsage)
    end
  end
