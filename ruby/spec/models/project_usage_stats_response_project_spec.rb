...
# Unit tests for MudbaseSDK::ProjectUsageStatsResponseProject
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ProjectUsageStatsResponseProject do
  #let(:instance) { MudbaseSDK::ProjectUsageStatsResponseProject.new }

  describe 'test an instance of ProjectUsageStatsResponseProject' do
    it 'should create an instance of ProjectUsageStatsResponseProject' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ProjectUsageStatsResponseProject)
    end
  end
