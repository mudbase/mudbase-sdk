...
# Unit tests for MudbaseSDK::ProjectUsageStatsResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ProjectUsageStatsResponse do
  #let(:instance) { MudbaseSDK::ProjectUsageStatsResponse.new }

  describe 'test an instance of ProjectUsageStatsResponse' do
    it 'should create an instance of ProjectUsageStatsResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ProjectUsageStatsResponse)
    end
  end
