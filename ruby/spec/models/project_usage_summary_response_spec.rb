...
# Unit tests for MudbaseSDK::ProjectUsageSummaryResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ProjectUsageSummaryResponse do
  #let(:instance) { MudbaseSDK::ProjectUsageSummaryResponse.new }

  describe 'test an instance of ProjectUsageSummaryResponse' do
    it 'should create an instance of ProjectUsageSummaryResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ProjectUsageSummaryResponse)
    end
  end
