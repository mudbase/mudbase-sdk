...
# Unit tests for MudbaseSDK::ProvisionEnterpriseRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ProvisionEnterpriseRequest do
  #let(:instance) { MudbaseSDK::ProvisionEnterpriseRequest.new }

  describe 'test an instance of ProvisionEnterpriseRequest' do
    it 'should create an instance of ProvisionEnterpriseRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ProvisionEnterpriseRequest)
    end
  end
