...
# Unit tests for MudbaseSDK::PushNotificationRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::PushNotificationRequest do
  #let(:instance) { MudbaseSDK::PushNotificationRequest.new }

  describe 'test an instance of PushNotificationRequest' do
    it 'should create an instance of PushNotificationRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::PushNotificationRequest)
    end
  end
