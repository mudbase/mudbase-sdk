...
# Unit tests for MudbaseSDK::PutChatE2eeKey200ResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::PutChatE2eeKey200ResponseData do
  #let(:instance) { MudbaseSDK::PutChatE2eeKey200ResponseData.new }

  describe 'test an instance of PutChatE2eeKey200ResponseData' do
    it 'should create an instance of PutChatE2eeKey200ResponseData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::PutChatE2eeKey200ResponseData)
    end
  end
