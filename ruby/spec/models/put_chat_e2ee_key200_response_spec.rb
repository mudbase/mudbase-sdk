...
# Unit tests for MudbaseSDK::PutChatE2eeKey200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::PutChatE2eeKey200Response do
  #let(:instance) { MudbaseSDK::PutChatE2eeKey200Response.new }

  describe 'test an instance of PutChatE2eeKey200Response' do
    it 'should create an instance of PutChatE2eeKey200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::PutChatE2eeKey200Response)
    end
  end
