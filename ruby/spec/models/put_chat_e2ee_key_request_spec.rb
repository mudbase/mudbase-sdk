...
# Unit tests for MudbaseSDK::PutChatE2eeKeyRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::PutChatE2eeKeyRequest do
  #let(:instance) { MudbaseSDK::PutChatE2eeKeyRequest.new }

  describe 'test an instance of PutChatE2eeKeyRequest' do
    it 'should create an instance of PutChatE2eeKeyRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::PutChatE2eeKeyRequest)
    end
  end
