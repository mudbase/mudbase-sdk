...
# Unit tests for MudbaseSDK::RateLimit
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::RateLimit do
  #let(:instance) { MudbaseSDK::RateLimit.new }

  describe 'test an instance of RateLimit' do
    it 'should create an instance of RateLimit' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::RateLimit)
    end
  end
