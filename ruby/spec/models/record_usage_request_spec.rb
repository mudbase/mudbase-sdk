...
# Unit tests for MudbaseSDK::RecordUsageRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::RecordUsageRequest do
  #let(:instance) { MudbaseSDK::RecordUsageRequest.new }

  describe 'test an instance of RecordUsageRequest' do
    it 'should create an instance of RecordUsageRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::RecordUsageRequest)
    end
  end
