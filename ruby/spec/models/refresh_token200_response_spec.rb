...
# Unit tests for MudbaseSDK::RefreshToken200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::RefreshToken200Response do
  #let(:instance) { MudbaseSDK::RefreshToken200Response.new }

  describe 'test an instance of RefreshToken200Response' do
    it 'should create an instance of RefreshToken200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::RefreshToken200Response)
    end
  end
