...
# Unit tests for MudbaseSDK::RefreshToken400Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::RefreshToken400Response do
  #let(:instance) { MudbaseSDK::RefreshToken400Response.new }

  describe 'test an instance of RefreshToken400Response' do
    it 'should create an instance of RefreshToken400Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::RefreshToken400Response)
    end
  end
