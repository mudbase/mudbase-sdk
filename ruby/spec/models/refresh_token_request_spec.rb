...
# Unit tests for MudbaseSDK::RefreshTokenRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::RefreshTokenRequest do
  #let(:instance) { MudbaseSDK::RefreshTokenRequest.new }

  describe 'test an instance of RefreshTokenRequest' do
    it 'should create an instance of RefreshTokenRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::RefreshTokenRequest)
    end
  end
