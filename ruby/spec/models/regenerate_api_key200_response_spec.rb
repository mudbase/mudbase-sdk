...
# Unit tests for MudbaseSDK::RegenerateApiKey200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::RegenerateApiKey200Response do
  #let(:instance) { MudbaseSDK::RegenerateApiKey200Response.new }

  describe 'test an instance of RegenerateApiKey200Response' do
    it 'should create an instance of RegenerateApiKey200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::RegenerateApiKey200Response)
    end
  end
