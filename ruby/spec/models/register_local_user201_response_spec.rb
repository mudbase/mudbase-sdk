...
# Unit tests for MudbaseSDK::RegisterLocalUser201Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::RegisterLocalUser201Response do
  #let(:instance) { MudbaseSDK::RegisterLocalUser201Response.new }

  describe 'test an instance of RegisterLocalUser201Response' do
    it 'should create an instance of RegisterLocalUser201Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::RegisterLocalUser201Response)
    end
  end
