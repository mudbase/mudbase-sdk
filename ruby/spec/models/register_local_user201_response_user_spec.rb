...
# Unit tests for MudbaseSDK::RegisterLocalUser201ResponseUser
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::RegisterLocalUser201ResponseUser do
  #let(:instance) { MudbaseSDK::RegisterLocalUser201ResponseUser.new }

  describe 'test an instance of RegisterLocalUser201ResponseUser' do
    it 'should create an instance of RegisterLocalUser201ResponseUser' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::RegisterLocalUser201ResponseUser)
    end
  end
