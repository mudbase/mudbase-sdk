...
# Unit tests for MudbaseSDK::RegisterLocalUserRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::RegisterLocalUserRequest do
  #let(:instance) { MudbaseSDK::RegisterLocalUserRequest.new }

  describe 'test an instance of RegisterLocalUserRequest' do
    it 'should create an instance of RegisterLocalUserRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::RegisterLocalUserRequest)
    end
  end
