...
# Unit tests for MudbaseSDK::RegisterNonCustodialAddressRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::RegisterNonCustodialAddressRequest do
  #let(:instance) { MudbaseSDK::RegisterNonCustodialAddressRequest.new }

  describe 'test an instance of RegisterNonCustodialAddressRequest' do
    it 'should create an instance of RegisterNonCustodialAddressRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::RegisterNonCustodialAddressRequest)
    end
  end
  ...
  describe 'test attribute "chain"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["ethereum", "binance", "bsc", "polygon", "arbitrum", "optimism", "base", "avalanche", "celo", "bitcoin", "litecoin", "dogecoin", "solana", "tron", "ripple", "cardano", "ton"])
