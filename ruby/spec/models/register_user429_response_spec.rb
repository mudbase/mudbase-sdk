...
# Unit tests for MudbaseSDK::RegisterUser429Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::RegisterUser429Response do
  #let(:instance) { MudbaseSDK::RegisterUser429Response.new }

  describe 'test an instance of RegisterUser429Response' do
    it 'should create an instance of RegisterUser429Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::RegisterUser429Response)
    end
  end
