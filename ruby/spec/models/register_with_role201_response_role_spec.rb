...
# Unit tests for MudbaseSDK::RegisterWithRole201ResponseRole
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::RegisterWithRole201ResponseRole do
  #let(:instance) { MudbaseSDK::RegisterWithRole201ResponseRole.new }

  describe 'test an instance of RegisterWithRole201ResponseRole' do
    it 'should create an instance of RegisterWithRole201ResponseRole' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::RegisterWithRole201ResponseRole)
    end
  end
