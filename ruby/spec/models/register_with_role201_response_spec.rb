...
# Unit tests for MudbaseSDK::RegisterWithRole201Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::RegisterWithRole201Response do
  #let(:instance) { MudbaseSDK::RegisterWithRole201Response.new }

  describe 'test an instance of RegisterWithRole201Response' do
    it 'should create an instance of RegisterWithRole201Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::RegisterWithRole201Response)
    end
  end
