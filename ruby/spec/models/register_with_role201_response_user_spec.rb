...
# Unit tests for MudbaseSDK::RegisterWithRole201ResponseUser
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::RegisterWithRole201ResponseUser do
  #let(:instance) { MudbaseSDK::RegisterWithRole201ResponseUser.new }

  describe 'test an instance of RegisterWithRole201ResponseUser' do
    it 'should create an instance of RegisterWithRole201ResponseUser' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::RegisterWithRole201ResponseUser)
    end
  end
