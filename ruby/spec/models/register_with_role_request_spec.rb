...
# Unit tests for MudbaseSDK::RegisterWithRoleRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::RegisterWithRoleRequest do
  #let(:instance) { MudbaseSDK::RegisterWithRoleRequest.new }

  describe 'test an instance of RegisterWithRoleRequest' do
    it 'should create an instance of RegisterWithRoleRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::RegisterWithRoleRequest)
    end
  end
