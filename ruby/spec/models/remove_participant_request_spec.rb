...
# Unit tests for MudbaseSDK::RemoveParticipantRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::RemoveParticipantRequest do
  #let(:instance) { MudbaseSDK::RemoveParticipantRequest.new }

  describe 'test an instance of RemoveParticipantRequest' do
    it 'should create an instance of RemoveParticipantRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::RemoveParticipantRequest)
    end
  end
