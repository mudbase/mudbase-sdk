...
# Unit tests for MudbaseSDK::RemoveReaction200ResponseDataInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::RemoveReaction200ResponseDataInner do
  #let(:instance) { MudbaseSDK::RemoveReaction200ResponseDataInner.new }

  describe 'test an instance of RemoveReaction200ResponseDataInner' do
    it 'should create an instance of RemoveReaction200ResponseDataInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::RemoveReaction200ResponseDataInner)
    end
  end
