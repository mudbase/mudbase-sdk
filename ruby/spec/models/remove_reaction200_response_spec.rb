...
# Unit tests for MudbaseSDK::RemoveReaction200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::RemoveReaction200Response do
  #let(:instance) { MudbaseSDK::RemoveReaction200Response.new }

  describe 'test an instance of RemoveReaction200Response' do
    it 'should create an instance of RemoveReaction200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::RemoveReaction200Response)
    end
  end
