...
# Unit tests for MudbaseSDK::RemoveTeamMember200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::RemoveTeamMember200Response do
  #let(:instance) { MudbaseSDK::RemoveTeamMember200Response.new }

  describe 'test an instance of RemoveTeamMember200Response' do
    it 'should create an instance of RemoveTeamMember200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::RemoveTeamMember200Response)
    end
  end
