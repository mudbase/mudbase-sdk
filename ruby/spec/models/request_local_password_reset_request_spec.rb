...
# Unit tests for MudbaseSDK::RequestLocalPasswordResetRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::RequestLocalPasswordResetRequest do
  #let(:instance) { MudbaseSDK::RequestLocalPasswordResetRequest.new }

  describe 'test an instance of RequestLocalPasswordResetRequest' do
    it 'should create an instance of RequestLocalPasswordResetRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::RequestLocalPasswordResetRequest)
    end
  end
