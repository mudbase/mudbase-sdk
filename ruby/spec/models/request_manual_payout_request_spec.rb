...
# Unit tests for MudbaseSDK::RequestManualPayoutRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::RequestManualPayoutRequest do
  #let(:instance) { MudbaseSDK::RequestManualPayoutRequest.new }

  describe 'test an instance of RequestManualPayoutRequest' do
    it 'should create an instance of RequestManualPayoutRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::RequestManualPayoutRequest)
    end
  end
