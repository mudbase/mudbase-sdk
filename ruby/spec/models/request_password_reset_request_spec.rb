...
# Unit tests for MudbaseSDK::RequestPasswordResetRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::RequestPasswordResetRequest do
  #let(:instance) { MudbaseSDK::RequestPasswordResetRequest.new }

  describe 'test an instance of RequestPasswordResetRequest' do
    it 'should create an instance of RequestPasswordResetRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::RequestPasswordResetRequest)
    end
  end
