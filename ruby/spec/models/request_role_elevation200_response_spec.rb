...
# Unit tests for MudbaseSDK::RequestRoleElevation200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::RequestRoleElevation200Response do
  #let(:instance) { MudbaseSDK::RequestRoleElevation200Response.new }

  describe 'test an instance of RequestRoleElevation200Response' do
    it 'should create an instance of RequestRoleElevation200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::RequestRoleElevation200Response)
    end
  end
  ...
  describe 'test attribute "workflow"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["auto_approved", "pending_admin_approval", "pending_requirements", "manual_approval"])
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["approved", "pending"])
      # validator.allowable_values.each do |value|
  ...
  describe 'test attribute "estimated_approval_time"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
