...
# Unit tests for MudbaseSDK::RequestRoleElevationRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::RequestRoleElevationRequest do
  #let(:instance) { MudbaseSDK::RequestRoleElevationRequest.new }

  describe 'test an instance of RequestRoleElevationRequest' do
    it 'should create an instance of RequestRoleElevationRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::RequestRoleElevationRequest)
    end
  end
