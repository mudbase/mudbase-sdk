...
# Unit tests for MudbaseSDK::ResendVerificationAuthRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ResendVerificationAuthRequest do
  #let(:instance) { MudbaseSDK::ResendVerificationAuthRequest.new }

  describe 'test an instance of ResendVerificationAuthRequest' do
    it 'should create an instance of ResendVerificationAuthRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ResendVerificationAuthRequest)
    end
  end
