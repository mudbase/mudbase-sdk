...
# Unit tests for MudbaseSDK::ResetLocalPasswordRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ResetLocalPasswordRequest do
  #let(:instance) { MudbaseSDK::ResetLocalPasswordRequest.new }

  describe 'test an instance of ResetLocalPasswordRequest' do
    it 'should create an instance of ResetLocalPasswordRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ResetLocalPasswordRequest)
    end
  end
