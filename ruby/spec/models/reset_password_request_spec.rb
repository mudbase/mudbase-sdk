...
# Unit tests for MudbaseSDK::ResetPasswordRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ResetPasswordRequest do
  #let(:instance) { MudbaseSDK::ResetPasswordRequest.new }

  describe 'test an instance of ResetPasswordRequest' do
    it 'should create an instance of ResetPasswordRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ResetPasswordRequest)
    end
  end
