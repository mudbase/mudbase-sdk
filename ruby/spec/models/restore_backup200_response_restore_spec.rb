...
# Unit tests for MudbaseSDK::RestoreBackup200ResponseRestore
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::RestoreBackup200ResponseRestore do
  #let(:instance) { MudbaseSDK::RestoreBackup200ResponseRestore.new }

  describe 'test an instance of RestoreBackup200ResponseRestore' do
    it 'should create an instance of RestoreBackup200ResponseRestore' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::RestoreBackup200ResponseRestore)
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["in_progress", "completed", "failed"])
  ...
  describe 'test attribute "restore_mode"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "estimated_completion"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
