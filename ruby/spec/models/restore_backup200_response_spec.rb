...
# Unit tests for MudbaseSDK::RestoreBackup200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::RestoreBackup200Response do
  #let(:instance) { MudbaseSDK::RestoreBackup200Response.new }

  describe 'test an instance of RestoreBackup200Response' do
    it 'should create an instance of RestoreBackup200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::RestoreBackup200Response)
    end
  end
