...
# Unit tests for MudbaseSDK::RestoreBackupRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::RestoreBackupRequest do
  #let(:instance) { MudbaseSDK::RestoreBackupRequest.new }

  describe 'test an instance of RestoreBackupRequest' do
    it 'should create an instance of RestoreBackupRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::RestoreBackupRequest)
    end
  end
  ...
  describe 'test attribute "restore_mode"' do
    it 'should work' do
      ...
      #   expect { instance.restore_mode = value }.not_to raise_error
      # end
    end
  end
  ...
  describe 'test attribute "confirmation"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["RESTORE_DATA"])
      # validator.allowable_values.each do |value|
