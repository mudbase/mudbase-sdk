...
# Unit tests for MudbaseSDK::RetryWebhook400Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::RetryWebhook400Response do
  #let(:instance) { MudbaseSDK::RetryWebhook400Response.new }

  describe 'test an instance of RetryWebhook400Response' do
    it 'should create an instance of RetryWebhook400Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::RetryWebhook400Response)
    end
  end
