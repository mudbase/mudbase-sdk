...
# Unit tests for MudbaseSDK::RetryWebhookResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::RetryWebhookResponse do
  #let(:instance) { MudbaseSDK::RetryWebhookResponse.new }

  describe 'test an instance of RetryWebhookResponse' do
    it 'should create an instance of RetryWebhookResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::RetryWebhookResponse)
    end
  end
