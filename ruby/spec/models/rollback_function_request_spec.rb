...
# Unit tests for MudbaseSDK::RollbackFunctionRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::RollbackFunctionRequest do
  #let(:instance) { MudbaseSDK::RollbackFunctionRequest.new }

  describe 'test an instance of RollbackFunctionRequest' do
    it 'should create an instance of RollbackFunctionRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::RollbackFunctionRequest)
    end
  end
