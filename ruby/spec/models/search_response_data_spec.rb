...
# Unit tests for MudbaseSDK::SearchResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::SearchResponseData do
  #let(:instance) { MudbaseSDK::SearchResponseData.new }

  describe 'test an instance of SearchResponseData' do
    it 'should create an instance of SearchResponseData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::SearchResponseData)
    end
  end
  ...
  describe 'test attribute "search_time"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
