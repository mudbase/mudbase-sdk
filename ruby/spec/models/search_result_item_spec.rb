...
# Unit tests for MudbaseSDK::SearchResultItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::SearchResultItem do
  #let(:instance) { MudbaseSDK::SearchResultItem.new }

  describe 'test an instance of SearchResultItem' do
    it 'should create an instance of SearchResultItem' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::SearchResultItem)
    end
  end
