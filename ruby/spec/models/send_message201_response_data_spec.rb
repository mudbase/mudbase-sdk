...
# Unit tests for MudbaseSDK::SendMessage201ResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::SendMessage201ResponseData do
  #let(:instance) { MudbaseSDK::SendMessage201ResponseData.new }

  describe 'test an instance of SendMessage201ResponseData' do
    it 'should create an instance of SendMessage201ResponseData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::SendMessage201ResponseData)
    end
  end
