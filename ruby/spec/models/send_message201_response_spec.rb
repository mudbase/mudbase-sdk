...
# Unit tests for MudbaseSDK::SendMessage201Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::SendMessage201Response do
  #let(:instance) { MudbaseSDK::SendMessage201Response.new }

  describe 'test an instance of SendMessage201Response' do
    it 'should create an instance of SendMessage201Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::SendMessage201Response)
    end
  end
