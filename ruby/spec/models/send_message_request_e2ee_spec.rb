...
# Unit tests for MudbaseSDK::SendMessageRequestE2ee
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::SendMessageRequestE2ee do
  #let(:instance) { MudbaseSDK::SendMessageRequestE2ee.new }

  describe 'test an instance of SendMessageRequestE2ee' do
    it 'should create an instance of SendMessageRequestE2ee' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::SendMessageRequestE2ee)
    end
  end
