...
# Unit tests for MudbaseSDK::SendMessageRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::SendMessageRequest do
  #let(:instance) { MudbaseSDK::SendMessageRequest.new }

  describe 'test an instance of SendMessageRequest' do
    it 'should create an instance of SendMessageRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::SendMessageRequest)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["text", "image", "video", "audio", "file", "location", "contact"])
