...
# Unit tests for MudbaseSDK::SendPushNotification429Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::SendPushNotification429Response do
  #let(:instance) { MudbaseSDK::SendPushNotification429Response.new }

  describe 'test an instance of SendPushNotification429Response' do
    it 'should create an instance of SendPushNotification429Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::SendPushNotification429Response)
    end
  end
