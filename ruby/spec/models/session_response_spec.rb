...
# Unit tests for MudbaseSDK::SessionResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::SessionResponse do
  #let(:instance) { MudbaseSDK::SessionResponse.new }

  describe 'test an instance of SessionResponse' do
    it 'should create an instance of SessionResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::SessionResponse)
    end
  end
