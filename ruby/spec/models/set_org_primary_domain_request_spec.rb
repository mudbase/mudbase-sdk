...
# Unit tests for MudbaseSDK::SetOrgPrimaryDomainRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::SetOrgPrimaryDomainRequest do
  #let(:instance) { MudbaseSDK::SetOrgPrimaryDomainRequest.new }

  describe 'test an instance of SetOrgPrimaryDomainRequest' do
    it 'should create an instance of SetOrgPrimaryDomainRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::SetOrgPrimaryDomainRequest)
    end
  end
