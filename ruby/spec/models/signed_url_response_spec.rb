...
# Unit tests for MudbaseSDK::SignedUrlResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::SignedUrlResponse do
  #let(:instance) { MudbaseSDK::SignedUrlResponse.new }

  describe 'test an instance of SignedUrlResponse' do
    it 'should create an instance of SignedUrlResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::SignedUrlResponse)
    end
  end
