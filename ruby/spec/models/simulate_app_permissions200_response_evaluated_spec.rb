...
# Unit tests for MudbaseSDK::SimulateAppPermissions200ResponseEvaluated
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::SimulateAppPermissions200ResponseEvaluated do
  #let(:instance) { MudbaseSDK::SimulateAppPermissions200ResponseEvaluated.new }

  describe 'test an instance of SimulateAppPermissions200ResponseEvaluated' do
    it 'should create an instance of SimulateAppPermissions200ResponseEvaluated' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::SimulateAppPermissions200ResponseEvaluated)
    end
  end
  ...
  describe 'test attribute "pathname"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
