...
# Unit tests for MudbaseSDK::SimulateAppPermissions200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::SimulateAppPermissions200Response do
  #let(:instance) { MudbaseSDK::SimulateAppPermissions200Response.new }

  describe 'test an instance of SimulateAppPermissions200Response' do
    it 'should create an instance of SimulateAppPermissions200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::SimulateAppPermissions200Response)
    end
  end
  ...
  describe 'test attribute "reason"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["allowed", "feature_not_allowed", "no_feature_gate_for_path", "no_feature_gate_for_operation_id"])
