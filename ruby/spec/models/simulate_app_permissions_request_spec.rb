...
# Unit tests for MudbaseSDK::SimulateAppPermissionsRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::SimulateAppPermissionsRequest do
  #let(:instance) { MudbaseSDK::SimulateAppPermissionsRequest.new }

  describe 'test an instance of SimulateAppPermissionsRequest' do
    it 'should create an instance of SimulateAppPermissionsRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::SimulateAppPermissionsRequest)
    end
  end
  ...
  describe 'test attribute "role_slug"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
