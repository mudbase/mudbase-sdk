...
# Unit tests for MudbaseSDK::SimulateFunctionTriggerRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::SimulateFunctionTriggerRequest do
  #let(:instance) { MudbaseSDK::SimulateFunctionTriggerRequest.new }

  describe 'test an instance of SimulateFunctionTriggerRequest' do
    it 'should create an instance of SimulateFunctionTriggerRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::SimulateFunctionTriggerRequest)
    end
  end
