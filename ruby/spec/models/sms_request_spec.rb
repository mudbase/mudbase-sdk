...
# Unit tests for MudbaseSDK::SMSRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::SMSRequest do
  #let(:instance) { MudbaseSDK::SMSRequest.new }

  describe 'test an instance of SMSRequest' do
    it 'should create an instance of SMSRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::SMSRequest)
    end
  end
