...
# Unit tests for MudbaseSDK::StartBugAnalysisScan503Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::StartBugAnalysisScan503Response do
  #let(:instance) { MudbaseSDK::StartBugAnalysisScan503Response.new }

  describe 'test an instance of StartBugAnalysisScan503Response' do
    it 'should create an instance of StartBugAnalysisScan503Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::StartBugAnalysisScan503Response)
    end
  end
