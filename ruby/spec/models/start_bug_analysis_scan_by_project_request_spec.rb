...
# Unit tests for MudbaseSDK::StartBugAnalysisScanByProjectRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::StartBugAnalysisScanByProjectRequest do
  #let(:instance) { MudbaseSDK::StartBugAnalysisScanByProjectRequest.new }

  describe 'test an instance of StartBugAnalysisScanByProjectRequest' do
    it 'should create an instance of StartBugAnalysisScanByProjectRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::StartBugAnalysisScanByProjectRequest)
    end
  end

  describe 'test attribute "upload_size"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "runtime_minutes"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
