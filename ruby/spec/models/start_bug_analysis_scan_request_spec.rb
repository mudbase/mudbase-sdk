...
# Unit tests for MudbaseSDK::StartBugAnalysisScanRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::StartBugAnalysisScanRequest do
  #let(:instance) { MudbaseSDK::StartBugAnalysisScanRequest.new }

  describe 'test an instance of StartBugAnalysisScanRequest' do
    it 'should create an instance of StartBugAnalysisScanRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::StartBugAnalysisScanRequest)
    end
  end
