...
# Unit tests for MudbaseSDK::StorageConfig
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::StorageConfig do
  #let(:instance) { MudbaseSDK::StorageConfig.new }

  describe 'test an instance of StorageConfig' do
    it 'should create an instance of StorageConfig' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::StorageConfig)
    end
  end
