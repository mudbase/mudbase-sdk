...
# Unit tests for MudbaseSDK::SystemStatusResponseDataCpu
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::SystemStatusResponseDataCpu do
  #let(:instance) { MudbaseSDK::SystemStatusResponseDataCpu.new }

  describe 'test an instance of SystemStatusResponseDataCpu' do
    it 'should create an instance of SystemStatusResponseDataCpu' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::SystemStatusResponseDataCpu)
    end
  end
