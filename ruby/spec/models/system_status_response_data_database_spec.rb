...
# Unit tests for MudbaseSDK::SystemStatusResponseDataDatabase
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::SystemStatusResponseDataDatabase do
  #let(:instance) { MudbaseSDK::SystemStatusResponseDataDatabase.new }

  describe 'test an instance of SystemStatusResponseDataDatabase' do
    it 'should create an instance of SystemStatusResponseDataDatabase' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::SystemStatusResponseDataDatabase)
    end
  end
