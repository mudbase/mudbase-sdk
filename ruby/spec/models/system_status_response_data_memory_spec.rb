...
# Unit tests for MudbaseSDK::SystemStatusResponseDataMemory
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::SystemStatusResponseDataMemory do
  #let(:instance) { MudbaseSDK::SystemStatusResponseDataMemory.new }

  describe 'test an instance of SystemStatusResponseDataMemory' do
    it 'should create an instance of SystemStatusResponseDataMemory' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::SystemStatusResponseDataMemory)
    end
  end
