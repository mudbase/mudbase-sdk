...
# Unit tests for MudbaseSDK::SystemStatusResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::SystemStatusResponseData do
  #let(:instance) { MudbaseSDK::SystemStatusResponseData.new }

  describe 'test an instance of SystemStatusResponseData' do
    it 'should create an instance of SystemStatusResponseData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::SystemStatusResponseData)
    end
  end
