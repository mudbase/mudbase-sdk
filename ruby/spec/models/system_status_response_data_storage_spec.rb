...
# Unit tests for MudbaseSDK::SystemStatusResponseDataStorage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::SystemStatusResponseDataStorage do
  #let(:instance) { MudbaseSDK::SystemStatusResponseDataStorage.new }

  describe 'test an instance of SystemStatusResponseDataStorage' do
    it 'should create an instance of SystemStatusResponseDataStorage' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::SystemStatusResponseDataStorage)
    end
  end
