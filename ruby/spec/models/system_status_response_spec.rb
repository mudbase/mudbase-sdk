...
# Unit tests for MudbaseSDK::SystemStatusResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::SystemStatusResponse do
  #let(:instance) { MudbaseSDK::SystemStatusResponse.new }

  describe 'test an instance of SystemStatusResponse' do
    it 'should create an instance of SystemStatusResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::SystemStatusResponse)
    end
  end
