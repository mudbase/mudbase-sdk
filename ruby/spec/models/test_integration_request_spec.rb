...
# Unit tests for MudbaseSDK::TestIntegrationRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::TestIntegrationRequest do
  #let(:instance) { MudbaseSDK::TestIntegrationRequest.new }

  describe 'test an instance of TestIntegrationRequest' do
    it 'should create an instance of TestIntegrationRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::TestIntegrationRequest)
    end
  end
