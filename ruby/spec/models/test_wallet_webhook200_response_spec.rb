...
# Unit tests for MudbaseSDK::TestWalletWebhook200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::TestWalletWebhook200Response do
  #let(:instance) { MudbaseSDK::TestWalletWebhook200Response.new }

  describe 'test an instance of TestWalletWebhook200Response' do
    it 'should create an instance of TestWalletWebhook200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::TestWalletWebhook200Response)
    end
  end
