...
# Unit tests for MudbaseSDK::TestWalletWebhookRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::TestWalletWebhookRequest do
  #let(:instance) { MudbaseSDK::TestWalletWebhookRequest.new }

  describe 'test an instance of TestWalletWebhookRequest' do
    it 'should create an instance of TestWalletWebhookRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::TestWalletWebhookRequest)
    end
  end
