...
# Unit tests for MudbaseSDK::TestWebhookTransformation200ResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::TestWebhookTransformation200ResponseData do
  #let(:instance) { MudbaseSDK::TestWebhookTransformation200ResponseData.new }

  describe 'test an instance of TestWebhookTransformation200ResponseData' do
    it 'should create an instance of TestWebhookTransformation200ResponseData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::TestWebhookTransformation200ResponseData)
    end
  end
  ...
  describe 'test attribute "transformed"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
