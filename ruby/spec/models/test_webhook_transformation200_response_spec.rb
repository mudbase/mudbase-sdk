...
# Unit tests for MudbaseSDK::TestWebhookTransformation200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::TestWebhookTransformation200Response do
  #let(:instance) { MudbaseSDK::TestWebhookTransformation200Response.new }

  describe 'test an instance of TestWebhookTransformation200Response' do
    it 'should create an instance of TestWebhookTransformation200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::TestWebhookTransformation200Response)
    end
  end
