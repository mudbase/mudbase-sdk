...
# Unit tests for MudbaseSDK::TestWebhookTransformationRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::TestWebhookTransformationRequest do
  #let(:instance) { MudbaseSDK::TestWebhookTransformationRequest.new }

  describe 'test an instance of TestWebhookTransformationRequest' do
    it 'should create an instance of TestWebhookTransformationRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::TestWebhookTransformationRequest)
    end
  end
