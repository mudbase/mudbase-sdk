...
# Unit tests for MudbaseSDK::ToggleRoleRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ToggleRoleRequest do
  #let(:instance) { MudbaseSDK::ToggleRoleRequest.new }

  describe 'test an instance of ToggleRoleRequest' do
    it 'should create an instance of ToggleRoleRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ToggleRoleRequest)
    end
  end
