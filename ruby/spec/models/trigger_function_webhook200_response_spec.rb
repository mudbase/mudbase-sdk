...
# Unit tests for MudbaseSDK::TriggerFunctionWebhook200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::TriggerFunctionWebhook200Response do
  #let(:instance) { MudbaseSDK::TriggerFunctionWebhook200Response.new }

  describe 'test an instance of TriggerFunctionWebhook200Response' do
    it 'should create an instance of TriggerFunctionWebhook200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::TriggerFunctionWebhook200Response)
    end
  end
