...
# Unit tests for MudbaseSDK::TriggerFunctionWebhook400Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::TriggerFunctionWebhook400Response do
  #let(:instance) { MudbaseSDK::TriggerFunctionWebhook400Response.new }

  describe 'test an instance of TriggerFunctionWebhook400Response' do
    it 'should create an instance of TriggerFunctionWebhook400Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::TriggerFunctionWebhook400Response)
    end
  end
