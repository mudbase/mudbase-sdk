...
# Unit tests for MudbaseSDK::TriggerFunctionWebhook401Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::TriggerFunctionWebhook401Response do
  #let(:instance) { MudbaseSDK::TriggerFunctionWebhook401Response.new }

  describe 'test an instance of TriggerFunctionWebhook401Response' do
    it 'should create an instance of TriggerFunctionWebhook401Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::TriggerFunctionWebhook401Response)
    end
  end
