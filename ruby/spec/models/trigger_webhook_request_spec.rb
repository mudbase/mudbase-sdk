...
# Unit tests for MudbaseSDK::TriggerWebhookRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::TriggerWebhookRequest do
  #let(:instance) { MudbaseSDK::TriggerWebhookRequest.new }

  describe 'test an instance of TriggerWebhookRequest' do
    it 'should create an instance of TriggerWebhookRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::TriggerWebhookRequest)
    end
  end
