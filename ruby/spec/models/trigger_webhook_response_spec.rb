...
# Unit tests for MudbaseSDK::TriggerWebhookResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::TriggerWebhookResponse do
  #let(:instance) { MudbaseSDK::TriggerWebhookResponse.new }

  describe 'test an instance of TriggerWebhookResponse' do
    it 'should create an instance of TriggerWebhookResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::TriggerWebhookResponse)
    end
  end
