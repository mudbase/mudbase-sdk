...
# Unit tests for MudbaseSDK::TwoFASetupResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::TwoFASetupResponse do
  #let(:instance) { MudbaseSDK::TwoFASetupResponse.new }

  describe 'test an instance of TwoFASetupResponse' do
    it 'should create an instance of TwoFASetupResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::TwoFASetupResponse)
    end
  end
