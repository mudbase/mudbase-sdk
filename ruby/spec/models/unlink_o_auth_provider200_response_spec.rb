...
# Unit tests for MudbaseSDK::UnlinkOAuthProvider200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::UnlinkOAuthProvider200Response do
  #let(:instance) { MudbaseSDK::UnlinkOAuthProvider200Response.new }

  describe 'test an instance of UnlinkOAuthProvider200Response' do
    it 'should create an instance of UnlinkOAuthProvider200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::UnlinkOAuthProvider200Response)
    end
  end
