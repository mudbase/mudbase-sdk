...
# Unit tests for MudbaseSDK::UpdateApiKey200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::UpdateApiKey200Response do
  #let(:instance) { MudbaseSDK::UpdateApiKey200Response.new }

  describe 'test an instance of UpdateApiKey200Response' do
    it 'should create an instance of UpdateApiKey200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::UpdateApiKey200Response)
    end
  end
