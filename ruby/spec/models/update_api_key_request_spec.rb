...
# Unit tests for MudbaseSDK::UpdateApiKeyRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::UpdateApiKeyRequest do
  #let(:instance) { MudbaseSDK::UpdateApiKeyRequest.new }

  describe 'test an instance of UpdateApiKeyRequest' do
    it 'should create an instance of UpdateApiKeyRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::UpdateApiKeyRequest)
    end
  end
