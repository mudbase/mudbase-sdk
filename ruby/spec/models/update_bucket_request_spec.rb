...
# Unit tests for MudbaseSDK::UpdateBucketRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::UpdateBucketRequest do
  #let(:instance) { MudbaseSDK::UpdateBucketRequest.new }

  describe 'test an instance of UpdateBucketRequest' do
    it 'should create an instance of UpdateBucketRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::UpdateBucketRequest)
    end
  end
