...
# Unit tests for MudbaseSDK::UpdateCollectionPermissionsRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::UpdateCollectionPermissionsRequest do
  #let(:instance) { MudbaseSDK::UpdateCollectionPermissionsRequest.new }

  describe 'test an instance of UpdateCollectionPermissionsRequest' do
    it 'should create an instance of UpdateCollectionPermissionsRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::UpdateCollectionPermissionsRequest)
    end
  end
  ...
  describe 'test attribute "actions"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('Array<String>', ["create", "read", "update", "delete"])
  ...
  describe 'test attribute "data_scope"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["all", "own"])
      # validator.allowable_values.each do |value|
      #   expect { instance.data_scope = value }.not_to raise_error
      # end
    end
  end

  describe 'test attribute "owner_field"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
