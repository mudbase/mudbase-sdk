...
# Unit tests for MudbaseSDK::UpdateCollectionRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::UpdateCollectionRequest do
  #let(:instance) { MudbaseSDK::UpdateCollectionRequest.new }

  describe 'test an instance of UpdateCollectionRequest' do
    it 'should create an instance of UpdateCollectionRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::UpdateCollectionRequest)
    end
  end
