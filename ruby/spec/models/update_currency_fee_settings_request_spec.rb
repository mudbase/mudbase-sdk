...
# Unit tests for MudbaseSDK::UpdateCurrencyFeeSettingsRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::UpdateCurrencyFeeSettingsRequest do
  #let(:instance) { MudbaseSDK::UpdateCurrencyFeeSettingsRequest.new }

  describe 'test an instance of UpdateCurrencyFeeSettingsRequest' do
    it 'should create an instance of UpdateCurrencyFeeSettingsRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::UpdateCurrencyFeeSettingsRequest)
    end
  end
