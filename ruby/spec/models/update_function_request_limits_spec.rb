...
# Unit tests for MudbaseSDK::UpdateFunctionRequestLimits
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::UpdateFunctionRequestLimits do
  #let(:instance) { MudbaseSDK::UpdateFunctionRequestLimits.new }

  describe 'test an instance of UpdateFunctionRequestLimits' do
    it 'should create an instance of UpdateFunctionRequestLimits' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::UpdateFunctionRequestLimits)
    end
  end
  ...
  describe 'test attribute "max_executions_per_minute"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "max_executions_per_hour"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
