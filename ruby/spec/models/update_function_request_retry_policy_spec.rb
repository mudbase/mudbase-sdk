...
# Unit tests for MudbaseSDK::UpdateFunctionRequestRetryPolicy
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::UpdateFunctionRequestRetryPolicy do
  #let(:instance) { MudbaseSDK::UpdateFunctionRequestRetryPolicy.new }

  describe 'test an instance of UpdateFunctionRequestRetryPolicy' do
    it 'should create an instance of UpdateFunctionRequestRetryPolicy' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::UpdateFunctionRequestRetryPolicy)
    end
  end
  ...
  describe 'test attribute "backoff_ms"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
