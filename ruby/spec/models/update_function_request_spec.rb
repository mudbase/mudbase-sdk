...
# Unit tests for MudbaseSDK::UpdateFunctionRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::UpdateFunctionRequest do
  #let(:instance) { MudbaseSDK::UpdateFunctionRequest.new }

  describe 'test an instance of UpdateFunctionRequest' do
    it 'should create an instance of UpdateFunctionRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::UpdateFunctionRequest)
    end
  end
