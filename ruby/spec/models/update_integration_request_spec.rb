...
# Unit tests for MudbaseSDK::UpdateIntegrationRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::UpdateIntegrationRequest do
  #let(:instance) { MudbaseSDK::UpdateIntegrationRequest.new }

  describe 'test an instance of UpdateIntegrationRequest' do
    it 'should create an instance of UpdateIntegrationRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::UpdateIntegrationRequest)
    end
  end
