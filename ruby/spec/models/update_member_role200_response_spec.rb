...
# Unit tests for MudbaseSDK::UpdateMemberRole200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::UpdateMemberRole200Response do
  #let(:instance) { MudbaseSDK::UpdateMemberRole200Response.new }

  describe 'test an instance of UpdateMemberRole200Response' do
    it 'should create an instance of UpdateMemberRole200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::UpdateMemberRole200Response)
    end
  end
