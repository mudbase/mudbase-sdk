...
# Unit tests for MudbaseSDK::UpdateMemberRoleRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::UpdateMemberRoleRequest do
  #let(:instance) { MudbaseSDK::UpdateMemberRoleRequest.new }

  describe 'test an instance of UpdateMemberRoleRequest' do
    it 'should create an instance of UpdateMemberRoleRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::UpdateMemberRoleRequest)
    end
  end
