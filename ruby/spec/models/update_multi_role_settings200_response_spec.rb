...
# Unit tests for MudbaseSDK::UpdateMultiRoleSettings200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::UpdateMultiRoleSettings200Response do
  #let(:instance) { MudbaseSDK::UpdateMultiRoleSettings200Response.new }

  describe 'test an instance of UpdateMultiRoleSettings200Response' do
    it 'should create an instance of UpdateMultiRoleSettings200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::UpdateMultiRoleSettings200Response)
    end
  end
