...
# Unit tests for MudbaseSDK::UpdateMultiRoleSettingsRequestSettings
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::UpdateMultiRoleSettingsRequestSettings do
  #let(:instance) { MudbaseSDK::UpdateMultiRoleSettingsRequestSettings.new }

  describe 'test an instance of UpdateMultiRoleSettingsRequestSettings' do
    it 'should create an instance of UpdateMultiRoleSettingsRequestSettings' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::UpdateMultiRoleSettingsRequestSettings)
    end
  end

  describe 'test attribute "allow_multiple_roles"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "require_role_selection"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "auto_assign_default"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "data_owner_field"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
