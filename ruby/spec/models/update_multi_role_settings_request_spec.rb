...
# Unit tests for MudbaseSDK::UpdateMultiRoleSettingsRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::UpdateMultiRoleSettingsRequest do
  #let(:instance) { MudbaseSDK::UpdateMultiRoleSettingsRequest.new }

  describe 'test an instance of UpdateMultiRoleSettingsRequest' do
    it 'should create an instance of UpdateMultiRoleSettingsRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::UpdateMultiRoleSettingsRequest)
    end
  end
