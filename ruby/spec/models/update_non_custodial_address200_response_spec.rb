...
# Unit tests for MudbaseSDK::UpdateNonCustodialAddress200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::UpdateNonCustodialAddress200Response do
  #let(:instance) { MudbaseSDK::UpdateNonCustodialAddress200Response.new }

  describe 'test an instance of UpdateNonCustodialAddress200Response' do
    it 'should create an instance of UpdateNonCustodialAddress200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::UpdateNonCustodialAddress200Response)
    end
  end
