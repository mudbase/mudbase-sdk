...
# Unit tests for MudbaseSDK::UpdateNonCustodialAddressRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::UpdateNonCustodialAddressRequest do
  #let(:instance) { MudbaseSDK::UpdateNonCustodialAddressRequest.new }

  describe 'test an instance of UpdateNonCustodialAddressRequest' do
    it 'should create an instance of UpdateNonCustodialAddressRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::UpdateNonCustodialAddressRequest)
    end
  end
