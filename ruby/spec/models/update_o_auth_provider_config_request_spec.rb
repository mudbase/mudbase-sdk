...
# Unit tests for MudbaseSDK::UpdateOAuthProviderConfigRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::UpdateOAuthProviderConfigRequest do
  #let(:instance) { MudbaseSDK::UpdateOAuthProviderConfigRequest.new }

  describe 'test an instance of UpdateOAuthProviderConfigRequest' do
    it 'should create an instance of UpdateOAuthProviderConfigRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::UpdateOAuthProviderConfigRequest)
    end
  end
