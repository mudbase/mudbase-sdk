...
# Unit tests for MudbaseSDK::UpdateOrganization200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::UpdateOrganization200Response do
  #let(:instance) { MudbaseSDK::UpdateOrganization200Response.new }

  describe 'test an instance of UpdateOrganization200Response' do
    it 'should create an instance of UpdateOrganization200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::UpdateOrganization200Response)
    end
  end
