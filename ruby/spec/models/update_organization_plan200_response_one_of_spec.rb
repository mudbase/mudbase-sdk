...
# Unit tests for MudbaseSDK::UpdateOrganizationPlan200ResponseOneOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::UpdateOrganizationPlan200ResponseOneOf do
  #let(:instance) { MudbaseSDK::UpdateOrganizationPlan200ResponseOneOf.new }

  describe 'test an instance of UpdateOrganizationPlan200ResponseOneOf' do
    it 'should create an instance of UpdateOrganizationPlan200ResponseOneOf' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::UpdateOrganizationPlan200ResponseOneOf)
    end
  end
