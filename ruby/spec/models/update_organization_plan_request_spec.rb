...
# Unit tests for MudbaseSDK::UpdateOrganizationPlanRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::UpdateOrganizationPlanRequest do
  #let(:instance) { MudbaseSDK::UpdateOrganizationPlanRequest.new }

  describe 'test an instance of UpdateOrganizationPlanRequest' do
    it 'should create an instance of UpdateOrganizationPlanRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::UpdateOrganizationPlanRequest)
    end
  end
  ...
  describe 'test attribute "plan"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["free", "pro"])
