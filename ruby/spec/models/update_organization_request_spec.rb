...
# Unit tests for MudbaseSDK::UpdateOrganizationRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::UpdateOrganizationRequest do
  #let(:instance) { MudbaseSDK::UpdateOrganizationRequest.new }
  ...
  describe 'test an instance of UpdateOrganizationRequest' do
    it 'should create an instance of UpdateOrganizationRequest' do
      ...
      #expect(instance).to be_instance_of(MudbaseSDK::UpdateOrganizationRequest)
    end
  end
