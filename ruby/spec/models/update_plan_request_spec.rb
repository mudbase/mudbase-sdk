...
# Unit tests for MudbaseSDK::UpdatePlanRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::UpdatePlanRequest do
  #let(:instance) { MudbaseSDK::UpdatePlanRequest.new }

  describe 'test an instance of UpdatePlanRequest' do
    it 'should create an instance of UpdatePlanRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::UpdatePlanRequest)
    end
  end
