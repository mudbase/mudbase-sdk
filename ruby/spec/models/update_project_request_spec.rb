...
# Unit tests for MudbaseSDK::UpdateProjectRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::UpdateProjectRequest do
  #let(:instance) { MudbaseSDK::UpdateProjectRequest.new }

  describe 'test an instance of UpdateProjectRequest' do
    it 'should create an instance of UpdateProjectRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::UpdateProjectRequest)
    end
  end
