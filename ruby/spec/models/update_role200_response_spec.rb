...
# Unit tests for MudbaseSDK::UpdateRole200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::UpdateRole200Response do
  #let(:instance) { MudbaseSDK::UpdateRole200Response.new }

  describe 'test an instance of UpdateRole200Response' do
    it 'should create an instance of UpdateRole200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::UpdateRole200Response)
    end
  end
