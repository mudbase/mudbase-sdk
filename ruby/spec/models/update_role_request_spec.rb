...
# Unit tests for MudbaseSDK::UpdateRoleRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::UpdateRoleRequest do
  #let(:instance) { MudbaseSDK::UpdateRoleRequest.new }

  describe 'test an instance of UpdateRoleRequest' do
    it 'should create an instance of UpdateRoleRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::UpdateRoleRequest)
    end
  end
