...
# Unit tests for MudbaseSDK::UpdateSubOrganization200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::UpdateSubOrganization200Response do
  #let(:instance) { MudbaseSDK::UpdateSubOrganization200Response.new }

  describe 'test an instance of UpdateSubOrganization200Response' do
    it 'should create an instance of UpdateSubOrganization200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::UpdateSubOrganization200Response)
    end
  end
