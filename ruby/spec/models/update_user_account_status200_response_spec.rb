...
# Unit tests for MudbaseSDK::UpdateUserAccountStatus200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::UpdateUserAccountStatus200Response do
  #let(:instance) { MudbaseSDK::UpdateUserAccountStatus200Response.new }

  describe 'test an instance of UpdateUserAccountStatus200Response' do
    it 'should create an instance of UpdateUserAccountStatus200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::UpdateUserAccountStatus200Response)
    end
  end
