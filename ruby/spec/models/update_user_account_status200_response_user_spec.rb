...
# Unit tests for MudbaseSDK::UpdateUserAccountStatus200ResponseUser
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::UpdateUserAccountStatus200ResponseUser do
  #let(:instance) { MudbaseSDK::UpdateUserAccountStatus200ResponseUser.new }

  describe 'test an instance of UpdateUserAccountStatus200ResponseUser' do
    it 'should create an instance of UpdateUserAccountStatus200ResponseUser' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::UpdateUserAccountStatus200ResponseUser)
    end
  end
