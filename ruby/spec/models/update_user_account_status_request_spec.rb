...
# Unit tests for MudbaseSDK::UpdateUserAccountStatusRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::UpdateUserAccountStatusRequest do
  #let(:instance) { MudbaseSDK::UpdateUserAccountStatusRequest.new }

  describe 'test an instance of UpdateUserAccountStatusRequest' do
    it 'should create an instance of UpdateUserAccountStatusRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::UpdateUserAccountStatusRequest)
    end
  end
