...
# Unit tests for MudbaseSDK::UpdateUserProfile200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::UpdateUserProfile200Response do
  #let(:instance) { MudbaseSDK::UpdateUserProfile200Response.new }

  describe 'test an instance of UpdateUserProfile200Response' do
    it 'should create an instance of UpdateUserProfile200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::UpdateUserProfile200Response)
    end
  end
