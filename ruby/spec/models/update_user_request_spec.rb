...
# Unit tests for MudbaseSDK::UpdateUserRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::UpdateUserRequest do
  #let(:instance) { MudbaseSDK::UpdateUserRequest.new }

  describe 'test an instance of UpdateUserRequest' do
    it 'should create an instance of UpdateUserRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::UpdateUserRequest)
    end
  end
