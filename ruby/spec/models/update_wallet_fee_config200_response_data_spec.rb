...
# Unit tests for MudbaseSDK::UpdateWalletFeeConfig200ResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::UpdateWalletFeeConfig200ResponseData do
  #let(:instance) { MudbaseSDK::UpdateWalletFeeConfig200ResponseData.new }

  describe 'test an instance of UpdateWalletFeeConfig200ResponseData' do
    it 'should create an instance of UpdateWalletFeeConfig200ResponseData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::UpdateWalletFeeConfig200ResponseData)
    end
  end
  ...
  describe 'test attribute "fee_percentage"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
