...
# Unit tests for MudbaseSDK::UpdateWalletFeeConfig200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::UpdateWalletFeeConfig200Response do
  #let(:instance) { MudbaseSDK::UpdateWalletFeeConfig200Response.new }

  describe 'test an instance of UpdateWalletFeeConfig200Response' do
    it 'should create an instance of UpdateWalletFeeConfig200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::UpdateWalletFeeConfig200Response)
    end
  end
