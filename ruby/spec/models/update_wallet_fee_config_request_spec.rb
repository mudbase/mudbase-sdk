...
# Unit tests for MudbaseSDK::UpdateWalletFeeConfigRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::UpdateWalletFeeConfigRequest do
  #let(:instance) { MudbaseSDK::UpdateWalletFeeConfigRequest.new }

  describe 'test an instance of UpdateWalletFeeConfigRequest' do
    it 'should create an instance of UpdateWalletFeeConfigRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::UpdateWalletFeeConfigRequest)
    end
  end
