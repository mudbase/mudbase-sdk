...
# Unit tests for MudbaseSDK::UpdateWalletWebhook200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::UpdateWalletWebhook200Response do
  #let(:instance) { MudbaseSDK::UpdateWalletWebhook200Response.new }

  describe 'test an instance of UpdateWalletWebhook200Response' do
    it 'should create an instance of UpdateWalletWebhook200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::UpdateWalletWebhook200Response)
    end
  end
