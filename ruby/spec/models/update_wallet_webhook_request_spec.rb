...
# Unit tests for MudbaseSDK::UpdateWalletWebhookRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::UpdateWalletWebhookRequest do
  #let(:instance) { MudbaseSDK::UpdateWalletWebhookRequest.new }

  describe 'test an instance of UpdateWalletWebhookRequest' do
    it 'should create an instance of UpdateWalletWebhookRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::UpdateWalletWebhookRequest)
    end
  end
