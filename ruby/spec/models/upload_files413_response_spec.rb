...
# Unit tests for MudbaseSDK::UploadFiles413Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::UploadFiles413Response do
  #let(:instance) { MudbaseSDK::UploadFiles413Response.new }

  describe 'test an instance of UploadFiles413Response' do
    it 'should create an instance of UploadFiles413Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::UploadFiles413Response)
    end
  end
