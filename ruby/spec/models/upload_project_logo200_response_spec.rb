...
# Unit tests for MudbaseSDK::UploadProjectLogo200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::UploadProjectLogo200Response do
  #let(:instance) { MudbaseSDK::UploadProjectLogo200Response.new }

  describe 'test an instance of UploadProjectLogo200Response' do
    it 'should create an instance of UploadProjectLogo200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::UploadProjectLogo200Response)
    end
  end
