...
# Unit tests for MudbaseSDK::UploadVerificationDocumentsRequestDocumentsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::UploadVerificationDocumentsRequestDocumentsInner do
  #let(:instance) { MudbaseSDK::UploadVerificationDocumentsRequestDocumentsInner.new }

  describe 'test an instance of UploadVerificationDocumentsRequestDocumentsInner' do
    it 'should create an instance of UploadVerificationDocumentsRequestDocumentsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::UploadVerificationDocumentsRequestDocumentsInner)
    end
  end
