...
# Unit tests for MudbaseSDK::UploadVerificationDocumentsRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::UploadVerificationDocumentsRequest do
  #let(:instance) { MudbaseSDK::UploadVerificationDocumentsRequest.new }

  describe 'test an instance of UploadVerificationDocumentsRequest' do
    it 'should create an instance of UploadVerificationDocumentsRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::UploadVerificationDocumentsRequest)
    end
  end
