...
# Unit tests for MudbaseSDK::UpsertProjectEmailTemplateRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::UpsertProjectEmailTemplateRequest do
  #let(:instance) { MudbaseSDK::UpsertProjectEmailTemplateRequest.new }

  describe 'test an instance of UpsertProjectEmailTemplateRequest' do
    it 'should create an instance of UpsertProjectEmailTemplateRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::UpsertProjectEmailTemplateRequest)
    end
  end
