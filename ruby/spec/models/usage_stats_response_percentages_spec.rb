...
# Unit tests for MudbaseSDK::UsageStatsResponsePercentages
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::UsageStatsResponsePercentages do
  #let(:instance) { MudbaseSDK::UsageStatsResponsePercentages.new }

  describe 'test an instance of UsageStatsResponsePercentages' do
    it 'should create an instance of UsageStatsResponsePercentages' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::UsageStatsResponsePercentages)
    end
  end
