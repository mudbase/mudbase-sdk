...
# Unit tests for MudbaseSDK::UsageStatsResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::UsageStatsResponse do
  #let(:instance) { MudbaseSDK::UsageStatsResponse.new }

  describe 'test an instance of UsageStatsResponse' do
    it 'should create an instance of UsageStatsResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::UsageStatsResponse)
    end
  end
