...
# Unit tests for MudbaseSDK::UsageTrendsResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::UsageTrendsResponse do
  #let(:instance) { MudbaseSDK::UsageTrendsResponse.new }

  describe 'test an instance of UsageTrendsResponse' do
    it 'should create an instance of UsageTrendsResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::UsageTrendsResponse)
    end
  end
