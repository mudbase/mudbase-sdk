...
# Unit tests for MudbaseSDK::UsageTrendsResponseTrendsInnerId
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::UsageTrendsResponseTrendsInnerId do
  #let(:instance) { MudbaseSDK::UsageTrendsResponseTrendsInnerId.new }

  describe 'test an instance of UsageTrendsResponseTrendsInnerId' do
    it 'should create an instance of UsageTrendsResponseTrendsInnerId' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::UsageTrendsResponseTrendsInnerId)
    end
  end
