...
# Unit tests for MudbaseSDK::UsageTrendsResponseTrendsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::UsageTrendsResponseTrendsInner do
  #let(:instance) { MudbaseSDK::UsageTrendsResponseTrendsInner.new }

  describe 'test an instance of UsageTrendsResponseTrendsInner' do
    it 'should create an instance of UsageTrendsResponseTrendsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::UsageTrendsResponseTrendsInner)
    end
  end
