...
# Unit tests for MudbaseSDK::UserSummary
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::UserSummary do
  #let(:instance) { MudbaseSDK::UserSummary.new }

  describe 'test an instance of UserSummary' do
    it 'should create an instance of UserSummary' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::UserSummary)
    end
  end
