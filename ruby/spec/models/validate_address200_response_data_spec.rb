...
# Unit tests for MudbaseSDK::ValidateAddress200ResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ValidateAddress200ResponseData do
  #let(:instance) { MudbaseSDK::ValidateAddress200ResponseData.new }

  describe 'test an instance of ValidateAddress200ResponseData' do
    it 'should create an instance of ValidateAddress200ResponseData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ValidateAddress200ResponseData)
    end
  end
