...
# Unit tests for MudbaseSDK::ValidateAddress200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ValidateAddress200Response do
  #let(:instance) { MudbaseSDK::ValidateAddress200Response.new }

  describe 'test an instance of ValidateAddress200Response' do
    it 'should create an instance of ValidateAddress200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ValidateAddress200Response)
    end
  end
