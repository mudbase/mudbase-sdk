...
# Unit tests for MudbaseSDK::ValidateAddressRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ValidateAddressRequest do
  #let(:instance) { MudbaseSDK::ValidateAddressRequest.new }

  describe 'test an instance of ValidateAddressRequest' do
    it 'should create an instance of ValidateAddressRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ValidateAddressRequest)
    end
  end
