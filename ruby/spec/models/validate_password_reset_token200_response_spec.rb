...
# Unit tests for MudbaseSDK::ValidatePasswordResetToken200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ValidatePasswordResetToken200Response do
  #let(:instance) { MudbaseSDK::ValidatePasswordResetToken200Response.new }

  describe 'test an instance of ValidatePasswordResetToken200Response' do
    it 'should create an instance of ValidatePasswordResetToken200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ValidatePasswordResetToken200Response)
    end
  end
