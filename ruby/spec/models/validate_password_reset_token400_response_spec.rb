...
# Unit tests for MudbaseSDK::ValidatePasswordResetToken400Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ValidatePasswordResetToken400Response do
  #let(:instance) { MudbaseSDK::ValidatePasswordResetToken400Response.new }

  describe 'test an instance of ValidatePasswordResetToken400Response' do
    it 'should create an instance of ValidatePasswordResetToken400Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ValidatePasswordResetToken400Response)
    end
  end
