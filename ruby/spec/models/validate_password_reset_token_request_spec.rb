...
# Unit tests for MudbaseSDK::ValidatePasswordResetTokenRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::ValidatePasswordResetTokenRequest do
  #let(:instance) { MudbaseSDK::ValidatePasswordResetTokenRequest.new }

  describe 'test an instance of ValidatePasswordResetTokenRequest' do
    it 'should create an instance of ValidatePasswordResetTokenRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::ValidatePasswordResetTokenRequest)
    end
  end
