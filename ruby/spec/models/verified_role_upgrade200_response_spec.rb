...
# Unit tests for MudbaseSDK::VerifiedRoleUpgrade200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::VerifiedRoleUpgrade200Response do
  #let(:instance) { MudbaseSDK::VerifiedRoleUpgrade200Response.new }

  describe 'test an instance of VerifiedRoleUpgrade200Response' do
    it 'should create an instance of VerifiedRoleUpgrade200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::VerifiedRoleUpgrade200Response)
    end
  end
  ...
  describe 'test attribute "previous_role"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "upgrade_log"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
