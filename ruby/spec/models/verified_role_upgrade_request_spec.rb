...
# Unit tests for MudbaseSDK::VerifiedRoleUpgradeRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::VerifiedRoleUpgradeRequest do
  #let(:instance) { MudbaseSDK::VerifiedRoleUpgradeRequest.new }

  describe 'test an instance of VerifiedRoleUpgradeRequest' do
    it 'should create an instance of VerifiedRoleUpgradeRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::VerifiedRoleUpgradeRequest)
    end
  end

  describe 'test attribute "target_role"' do
    it 'should work' do
