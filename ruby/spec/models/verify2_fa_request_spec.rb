...
# Unit tests for MudbaseSDK::Verify2FARequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::Verify2FARequest do
  #let(:instance) { MudbaseSDK::Verify2FARequest.new }

  describe 'test an instance of Verify2FARequest' do
    it 'should create an instance of Verify2FARequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::Verify2FARequest)
    end
  end
