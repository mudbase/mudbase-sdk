...
# Unit tests for MudbaseSDK::VerifyEmailAuthRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::VerifyEmailAuthRequest do
  #let(:instance) { MudbaseSDK::VerifyEmailAuthRequest.new }

  describe 'test an instance of VerifyEmailAuthRequest' do
    it 'should create an instance of VerifyEmailAuthRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::VerifyEmailAuthRequest)
    end
  end
