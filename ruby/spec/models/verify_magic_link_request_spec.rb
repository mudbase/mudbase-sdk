...
# Unit tests for MudbaseSDK::VerifyMagicLinkRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::VerifyMagicLinkRequest do
  #let(:instance) { MudbaseSDK::VerifyMagicLinkRequest.new }

  describe 'test an instance of VerifyMagicLinkRequest' do
    it 'should create an instance of VerifyMagicLinkRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::VerifyMagicLinkRequest)
    end
  end
