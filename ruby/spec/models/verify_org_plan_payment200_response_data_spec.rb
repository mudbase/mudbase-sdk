...
# Unit tests for MudbaseSDK::VerifyOrgPlanPayment200ResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::VerifyOrgPlanPayment200ResponseData do
  #let(:instance) { MudbaseSDK::VerifyOrgPlanPayment200ResponseData.new }

  describe 'test an instance of VerifyOrgPlanPayment200ResponseData' do
    it 'should create an instance of VerifyOrgPlanPayment200ResponseData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::VerifyOrgPlanPayment200ResponseData)
    end
  end
