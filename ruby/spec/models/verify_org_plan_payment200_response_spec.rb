...
# Unit tests for MudbaseSDK::VerifyOrgPlanPayment200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::VerifyOrgPlanPayment200Response do
  #let(:instance) { MudbaseSDK::VerifyOrgPlanPayment200Response.new }

  describe 'test an instance of VerifyOrgPlanPayment200Response' do
    it 'should create an instance of VerifyOrgPlanPayment200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::VerifyOrgPlanPayment200Response)
    end
  end
