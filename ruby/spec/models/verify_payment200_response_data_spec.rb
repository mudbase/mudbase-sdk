...
# Unit tests for MudbaseSDK::VerifyPayment200ResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::VerifyPayment200ResponseData do
  #let(:instance) { MudbaseSDK::VerifyPayment200ResponseData.new }

  describe 'test an instance of VerifyPayment200ResponseData' do
    it 'should create an instance of VerifyPayment200ResponseData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::VerifyPayment200ResponseData)
    end
  end
