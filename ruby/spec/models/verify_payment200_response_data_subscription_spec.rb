...
# Unit tests for MudbaseSDK::VerifyPayment200ResponseDataSubscription
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::VerifyPayment200ResponseDataSubscription do
  #let(:instance) { MudbaseSDK::VerifyPayment200ResponseDataSubscription.new }

  describe 'test an instance of VerifyPayment200ResponseDataSubscription' do
    it 'should create an instance of VerifyPayment200ResponseDataSubscription' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::VerifyPayment200ResponseDataSubscription)
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["active", "cancelled", "past_due"])
