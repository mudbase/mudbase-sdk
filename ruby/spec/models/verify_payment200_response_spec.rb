...
# Unit tests for MudbaseSDK::VerifyPayment200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::VerifyPayment200Response do
  #let(:instance) { MudbaseSDK::VerifyPayment200Response.new }

  describe 'test an instance of VerifyPayment200Response' do
    it 'should create an instance of VerifyPayment200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::VerifyPayment200Response)
    end
  end
