...
# Unit tests for MudbaseSDK::VerifyProjectEmailSmtpDomainRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::VerifyProjectEmailSmtpDomainRequest do
  #let(:instance) { MudbaseSDK::VerifyProjectEmailSmtpDomainRequest.new }

  describe 'test an instance of VerifyProjectEmailSmtpDomainRequest' do
    it 'should create an instance of VerifyProjectEmailSmtpDomainRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::VerifyProjectEmailSmtpDomainRequest)
    end
  end
