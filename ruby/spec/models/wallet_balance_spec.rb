...
# Unit tests for MudbaseSDK::WalletBalance
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::WalletBalance do
  #let(:instance) { MudbaseSDK::WalletBalance.new }

  describe 'test an instance of WalletBalance' do
    it 'should create an instance of WalletBalance' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::WalletBalance)
    end
  end
