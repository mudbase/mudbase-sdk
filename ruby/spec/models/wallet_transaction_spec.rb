...
# Unit tests for MudbaseSDK::WalletTransaction
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::WalletTransaction do
  #let(:instance) { MudbaseSDK::WalletTransaction.new }

  describe 'test an instance of WalletTransaction' do
    it 'should create an instance of WalletTransaction' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::WalletTransaction)
    end
  end
  ...
  describe 'test attribute "main_tx_status"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["pending", "confirmed", "failed"])
      # validator.allowable_values.each do |value|
  ...
  describe 'test attribute "main_tx_confirmed_at"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "token_transfers"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
