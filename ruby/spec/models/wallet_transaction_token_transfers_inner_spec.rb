...
# Unit tests for MudbaseSDK::WalletTransactionTokenTransfersInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::WalletTransactionTokenTransfersInner do
  #let(:instance) { MudbaseSDK::WalletTransactionTokenTransfersInner.new }

  describe 'test an instance of WalletTransactionTokenTransfersInner' do
    it 'should create an instance of WalletTransactionTokenTransfersInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::WalletTransactionTokenTransfersInner)
    end
  end
  ...
  describe 'test attribute "is_incoming"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
