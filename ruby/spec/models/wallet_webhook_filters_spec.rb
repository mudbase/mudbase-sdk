...
# Unit tests for MudbaseSDK::WalletWebhookFilters
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::WalletWebhookFilters do
  #let(:instance) { MudbaseSDK::WalletWebhookFilters.new }

  describe 'test an instance of WalletWebhookFilters' do
    it 'should create an instance of WalletWebhookFilters' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::WalletWebhookFilters)
    end
  end
  ...
  describe 'test attribute "chains"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('Array<String>', ["ethereum", "binance", "polygon", "celo", "bitcoin"])
