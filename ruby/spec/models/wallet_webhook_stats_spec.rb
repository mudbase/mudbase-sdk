...
# Unit tests for MudbaseSDK::WalletWebhookStats
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::WalletWebhookStats do
  #let(:instance) { MudbaseSDK::WalletWebhookStats.new }

  describe 'test an instance of WalletWebhookStats' do
    it 'should create an instance of WalletWebhookStats' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::WalletWebhookStats)
    end
  end
