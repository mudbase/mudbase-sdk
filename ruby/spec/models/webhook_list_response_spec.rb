...
# Unit tests for MudbaseSDK::WebhookListResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::WebhookListResponse do
  #let(:instance) { MudbaseSDK::WebhookListResponse.new }

  describe 'test an instance of WebhookListResponse' do
    it 'should create an instance of WebhookListResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::WebhookListResponse)
    end
  end
