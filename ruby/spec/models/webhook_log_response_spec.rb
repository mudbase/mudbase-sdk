...
# Unit tests for MudbaseSDK::WebhookLogResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::WebhookLogResponse do
  #let(:instance) { MudbaseSDK::WebhookLogResponse.new }

  describe 'test an instance of WebhookLogResponse' do
    it 'should create an instance of WebhookLogResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::WebhookLogResponse)
    end
  end
