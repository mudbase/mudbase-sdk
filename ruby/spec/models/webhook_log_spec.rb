...
# Unit tests for MudbaseSDK::WebhookLog
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::WebhookLog do
  #let(:instance) { MudbaseSDK::WebhookLog.new }

  describe 'test an instance of WebhookLog' do
    it 'should create an instance of WebhookLog' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::WebhookLog)
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["pending", "success", "failed", "retrying"])
      # validator.allowable_values.each do |value|
  ...
  describe 'test attribute "next_retry"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
