...
# Unit tests for MudbaseSDK::WebhookStatsResponseEventStatsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::WebhookStatsResponseEventStatsInner do
  #let(:instance) { MudbaseSDK::WebhookStatsResponseEventStatsInner.new }

  describe 'test an instance of WebhookStatsResponseEventStatsInner' do
    it 'should create an instance of WebhookStatsResponseEventStatsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::WebhookStatsResponseEventStatsInner)
    end
  end
