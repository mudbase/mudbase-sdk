...
# Unit tests for MudbaseSDK::WebhookStatsResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::WebhookStatsResponse do
  #let(:instance) { MudbaseSDK::WebhookStatsResponse.new }

  describe 'test an instance of WebhookStatsResponse' do
    it 'should create an instance of WebhookStatsResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::WebhookStatsResponse)
    end
  end

  describe 'test attribute "status_stats"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "event_stats"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
