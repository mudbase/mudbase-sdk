...
# Unit tests for MudbaseSDK::WebhookStatsResponseStatusStatsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::WebhookStatsResponseStatusStatsInner do
  #let(:instance) { MudbaseSDK::WebhookStatsResponseStatusStatsInner.new }

  describe 'test an instance of WebhookStatsResponseStatusStatsInner' do
    it 'should create an instance of WebhookStatsResponseStatusStatsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::WebhookStatsResponseStatusStatsInner)
    end
  end
  ...
  describe 'test attribute "avg_duration"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
