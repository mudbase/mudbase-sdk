...
# Unit tests for MudbaseSDK::Withdraw200ResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::Withdraw200ResponseData do
  #let(:instance) { MudbaseSDK::Withdraw200ResponseData.new }

  describe 'test an instance of Withdraw200ResponseData' do
    it 'should create an instance of Withdraw200ResponseData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::Withdraw200ResponseData)
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["ready_to_broadcast"])
