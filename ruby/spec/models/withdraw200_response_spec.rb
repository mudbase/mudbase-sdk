...
# Unit tests for MudbaseSDK::Withdraw200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::Withdraw200Response do
  #let(:instance) { MudbaseSDK::Withdraw200Response.new }

  describe 'test an instance of Withdraw200Response' do
    it 'should create an instance of Withdraw200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::Withdraw200Response)
    end
  end
