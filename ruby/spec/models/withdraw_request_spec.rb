...
# Unit tests for MudbaseSDK::WithdrawRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MudbaseSDK::WithdrawRequest do
  #let(:instance) { MudbaseSDK::WithdrawRequest.new }

  describe 'test an instance of WithdrawRequest' do
    it 'should create an instance of WithdrawRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(MudbaseSDK::WithdrawRequest)
    end
  end
