...
open class MudbaseSDKAPIConfiguration: @unchecked Sendable {
    ...
    public init(
        basePath: String = "https://cloud.mudbase.dev",
    ...
    public static let shared = MudbaseSDKAPIConfiguration()
}
...
open class RequestBuilder<T>: @unchecked Sendable, Identifiable {
    ...
    public let apiConfiguration: MudbaseSDKAPIConfiguration

    /// Optional block to obtain a reference to the request's progress instance when available.
    public var onProgressReady: ((Progress) -> Void)?

    required public init(method: String, URLString: String, parameters: [String: any Sendable]?, headers: [String: String] = [:], requiresAuthentication: Bool, apiConfiguration: MudbaseSDKAPIConfiguration = MudbaseSDKAPIConfiguration.shared) {
        self.method = method
