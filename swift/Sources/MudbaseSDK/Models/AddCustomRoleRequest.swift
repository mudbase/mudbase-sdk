...
public struct AddCustomRoleRequest: Sendable, Codable, Hashable {
    ...
    public var defaultPermissions: [AddCustomRoleRequestDefaultPermissionsInner]?
    ...
    public init(slug: String, name: String, description: String? = nil, signupEndpoint: String, requiresApproval: Bool? = nil, requiresPayment: Bool? = nil, requiresKYC: Bool? = nil, defaultPermissions: [AddCustomRoleRequestDefaultPermissionsInner]? = nil, collectionPermissions: [String: CreateRoleRequestCollectionPermissionsValue]? = nil, metadata: JSONValue? = nil, featurePermissions: [String: [String: Bool]]? = nil) {
        self.slug = slug
        self.name = name
