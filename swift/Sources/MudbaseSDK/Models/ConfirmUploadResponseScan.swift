...
public struct ConfirmUploadResponseScan: Sendable, Codable, Hashable {

    public var status: String?
    public var provider: String?
    public var detections: Int?
    /** Raw analysis object returned by the scanner (e.g., VirusTotal) */
    public var analysis: JSONValue?

    public init(status: String? = nil, provider: String? = nil, detections: Int? = nil, analysis: JSONValue? = nil) {
        self.status = status
