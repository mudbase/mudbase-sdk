...
public struct CreateCheckoutSessionRequest: Sendable, Codable, Hashable {
    ...
    public enum BillingCycle: String, Sendable, Codable, CaseIterable {
    ...
    public var customerInfo: CreateCheckoutSessionRequestCustomerInfo
    /** Redirect URL after successful payment */
    public var successUrl: String?
    /** Redirect URL if user cancels */
    public var cancelUrl: String?

    public init(planId: String, billingCycle: BillingCycle, customerInfo: CreateCheckoutSessionRequestCustomerInfo, successUrl: String? = nil, cancelUrl: String? = nil) {
        self.planId = planId
