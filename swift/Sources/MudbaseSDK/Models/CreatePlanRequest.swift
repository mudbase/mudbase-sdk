...
public struct CreatePlanRequest: Sendable, Codable, Hashable {
    ...
    public init(name: String, description: String? = nil, price: Double, currency: String, interval: Interval, features: [CreatePlanRequestFeaturesInner]? = nil, limits: CreatePlanRequestLimits? = nil, trial: CreatePlanRequestTrial? = nil, isActive: Bool? = true, isDefault: Bool? = false, sortOrder: Double? = nil, metadata: [String: JSONValue]? = nil) {
        self.name = name
