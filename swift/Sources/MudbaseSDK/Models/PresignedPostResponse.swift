...
public struct PresignedPostResponse: Sendable, Codable, Hashable {
    ...
    public init(key: String? = nil, url: String? = nil, method: Method? = nil, headers: JSONValue? = nil, expiresIn: Int? = nil, maxFileUploadBytes: Int64? = nil) {
        self.key = key
        self.url = url
        self.method = method
