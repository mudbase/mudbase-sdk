...
public struct ProjectSmsByoPatchRequest: Sendable, Codable, Hashable {
    ...
    public init(enabled: Bool? = nil, provider: Provider? = nil, defaultFrom: String? = nil, config: [String: JSONValue]? = nil) {
