...
public struct TriggerWebhookRequest: Sendable, Codable, Hashable {
    ...
    public init(projectId: String, url: String, event: String, payload: JSONValue, method: Method? = .post) {
