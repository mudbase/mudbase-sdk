...
public struct WebhookLog: Sendable, Codable, Hashable {
    ...
    public init(id: String? = nil, org: String? = nil, project: String? = nil, webhookId: String? = nil, url: String? = nil, method: Method? = nil, event: String? = nil, status: Status? = nil, payload: JSONValue? = nil, headers: JSONValue? = nil, response: WebhookLogResponse? = nil, duration: Int? = nil, attempts: Int? = nil, maxAttempts: Int? = nil, error: String? = nil, nextRetry: Date? = nil, createdAt: Date? = nil, updatedAt: Date? = nil) {
        self.id = id
        self.org = org
