...
```swift
    open class func apiProjectsProjectIdAddonsAddonInvokePost(projectId: String, addon: String, body: JSONValue? = nil, completion: @escaping (_ data: ApiProjectsProjectIdAddonsAddonInvokePost200Response?, _ error: Error?) -> Void)
```
...
let body = "TODO" // JSONValue |  (optional)
