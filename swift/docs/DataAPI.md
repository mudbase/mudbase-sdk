...
# **createData**
```swift
    open class func createData(projectId: String, collectionId: String, body: JSONValue, completion: @escaping (_ data: DataResponse?, _ error: Error?) -> Void)
```
...
# **updateData**
```swift
    open class func updateData(projectId: String, collectionId: String, documentId: String, body: JSONValue, completion: @escaping (_ data: DataResponse?, _ error: Error?) -> Void)
```
