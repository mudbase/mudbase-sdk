...
```swift
    open class func triggerFunctionWebhook(projectId: String, xWebhookSecret: String? = nil, body: JSONValue? = nil, completion: @escaping (_ data: TriggerFunctionWebhook200Response?, _ error: Error?) -> Void)
```
