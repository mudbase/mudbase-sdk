...
# **cancelPayout**
```swift
    open class func cancelPayout(payoutId: String, platformAdminDetachMemberRequest: PlatformAdminDetachMemberRequest? = nil, completion: @escaping (_ data: ApplyRoleFeaturePreset200Response?, _ error: Error?) -> Void)
```
...
// ~~Cancel payout (Admin)~~ (deprecated)
ProjectFeesAPI.cancelPayout(payoutId: payoutId, platformAdminDetachMemberRequest: platformAdminDetachMemberRequest) { (response, error) in
...
```swift
    open class func getAdminPayoutDashboard(completion: @escaping (_ data: GetAdminPayoutDashboard200Response?, _ error: Error?) -> Void)
```
...
// ~~Get admin payout dashboard (Admin)~~ (deprecated)
ProjectFeesAPI.getAdminPayoutDashboard() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **getPendingPayouts**
```swift
    open class func getPendingPayouts(status: String? = nil, currency: String? = nil, limit: Int? = nil, page: Int? = nil, completion: @escaping (_ data: GetPendingPayouts200Response?, _ error: Error?) -> Void)
```
...
// ~~Get all pending payouts (Admin)~~ (deprecated)
ProjectFeesAPI.getPendingPayouts(status: status, currency: currency, limit: limit, page: page) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
# **processPayout**
```swift
    open class func processPayout(payoutId: String, completion: @escaping (_ data: ApplyRoleFeaturePreset200Response?, _ error: Error?) -> Void)
```
...
// ~~Manually process payout (Admin)~~ (deprecated)
ProjectFeesAPI.processPayout(payoutId: payoutId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
