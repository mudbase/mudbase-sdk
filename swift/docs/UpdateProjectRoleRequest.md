...
**defaultPermissions** | **[JSONValue]** |  | [optional] 
**collectionPermissions** | [String: CreateRoleRequestCollectionPermissionsValue] | Per-collection CRUD map (same as POST add role). | [optional] 
